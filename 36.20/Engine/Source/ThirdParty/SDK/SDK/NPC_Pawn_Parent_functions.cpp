...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    Despawns                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ANPC_Pawn_Parent_C::DespawnsOnInstantDeath(bool* Despawns)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("DespawnsOnInstantDeath");

	Params::NPC_Pawn_Parent_C_DespawnsOnInstantDeath Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Despawns != nullptr)
		*Despawns = Parms.Despawns;
}
...
void ANPC_Pawn_Parent_C::ForceUpdateCustomDepth()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ForceUpdateCustomDepth");
...
void ANPC_Pawn_Parent_C::On_NPC_PawnInteractedWith(class AActor* AIPawn, class AFortPlayerPawn* InteractingPlayerPawn, EInteractionBeingAttempted InteractionBeingAttempted)
{
	static class UFunction* Func = nullptr;
...
void ANPC_Pawn_Parent_C::OnEndDeepWaterInteraction(const struct FVector& PreviousWaterSurfaceLocation, float WaterDepth, class AWaterBody* WaterBody)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEndDeepWaterInteraction");
...
void ANPC_Pawn_Parent_C::OnEnteredWaterBodyClient(class AFortWaterBodyActor* WaterBody, bool bIsFirstBody)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEnteredWaterBodyClient");
...
void ANPC_Pawn_Parent_C::OnExitedWaterBodyClient(class AFortWaterBodyActor* WaterBody, bool bIsLastBody)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnExitedWaterBodyClient");
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FGameplayTagContainer            DeathTags_0                                            (BlueprintVisible, BlueprintReadOnly, Parm)
...
void ANPC_Pawn_Parent_C::ShouldRunInstantDeathCue(const struct FGameplayTagContainer& DeathTags_0, class AActor* Instigator_0, class AActor* DamageCauser, bool* Result)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldRunInstantDeathCue");
