...
static_assert(sizeof(FMidiEventListenerParams) == 0x000008, "Wrong size on FMidiEventListenerParams");
...
static_assert(offsetof(FMidiEventListenerParams, InitBroadcast) == 0x000004, "Member 'FMidiEventListenerParams::InitBroadcast' has a wrong offset!");
