...
void UGroomBindingAsset::SetSourceMeshRequestedLOD(int32 InSourceMeshRequestedLOD)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSourceMeshRequestedLOD");
...
void UGroomBindingAsset::SetSourceMeshUsedLOD(int32 InSourceMeshUsedLOD)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSourceMeshUsedLOD");
...
void UGroomBindingAsset::SetTargetBindingAttribute(class FName InAttributeName)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetTargetBindingAttribute");
...
void UGroomBindingAsset::SetTargetMeshRequestedMinLOD(int32 InTargetMeshRequestedMinLOD)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetTargetMeshRequestedMinLOD");
...
void UGroomBindingAsset::SetTargetMeshUsedMinLOD(int32 InTargetMeshUsedMinLOD)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetTargetMeshUsedMinLOD");
...
int32 UGroomBindingAsset::GetSourceMeshRequestedLOD() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSourceMeshRequestedLOD");
...
int32 UGroomBindingAsset::GetSourceMeshUsedLOD() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSourceMeshUsedLOD");
...
class FName UGroomBindingAsset::GetTargetBindingAttribute() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTargetBindingAttribute");
...
int32 UGroomBindingAsset::GetTargetMeshRequestedMinLOD() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTargetMeshRequestedMinLOD");
...
int32 UGroomBindingAsset::GetTargetMeshUsedMinLOD() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetTargetMeshUsedMinLOD");
...
bool UGroomBlueprintLibrary::IsHairStrandsSupportedInWorld(const class UObject* WorldContextObject)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("IsHairStrandsSupportedInWorld");
...
void UGroomComponent::SetGroomCache(class UGroomCache* InGroomCache)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetGroomCache");
