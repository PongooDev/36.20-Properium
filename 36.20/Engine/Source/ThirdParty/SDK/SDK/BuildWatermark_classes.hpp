...
static_assert(sizeof(UBuildWatermark_C) == 0x000390, "Wrong size on UBuildWatermark_C");
static_assert(offsetof(UBuildWatermark_C, UberGraphFrame) == 0x000388, "Member 'UBuildWatermark_C::UberGraphFrame' has a wrong offset!");
