...
{
public:
	struct FValueOrBBKey_GameplayTagContainer     Value;                                             // 0x0000(0x0028)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer) == 0x000050, "Wrong size on ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer");
...
static_assert(offsetof(ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer, BehaviorTreeComp) == 0x000028, "Member 'ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer::BehaviorTreeComp' has a wrong offset!");
static_assert(offsetof(ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer, ReturnValue) == 0x000030, "Member 'ValueOrBBKey_GameplayTagBlueprintUtility_GetTagContainer::ReturnValue' has a wrong offset!");
