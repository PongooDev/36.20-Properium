...
static_assert(sizeof(FAssembledComponentReferences) == 0x000020, "Wrong size on FAssembledComponentReferences");
...
static_assert(offsetof(FAssembledMeshSchemaData_Icons, FullScreenImage) == 0x000060, "Member 'FAssembledMeshSchemaData_Icons::FullScreenImage' has a wrong offset!");
