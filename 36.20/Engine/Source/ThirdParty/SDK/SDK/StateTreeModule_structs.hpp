...
static_assert(alignof(FStateTreeActiveStates) == 0x000004, "Wrong alignment on FStateTreeActiveStates");
...
static_assert(sizeof(FStateTreePropertyFunctionBase) == 0x000018, "Wrong size on FStateTreePropertyFunctionBase");
...
static_assert(sizeof(FStateTreePropertyFunctionCommonBase) == 0x000018, "Wrong size on FStateTreePropertyFunctionCommonBase");
...
static_assert(sizeof(FStateTreeBooleanAndPropertyFunction) == 0x000018, "Wrong size on FStateTreeBooleanAndPropertyFunction");
...
static_assert(sizeof(FStateTreeAddFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeAddFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeBooleanOrPropertyFunction) == 0x000018, "Wrong size on FStateTreeBooleanOrPropertyFunction");
...
static_assert(sizeof(FStateTreeBooleanXOrPropertyFunction) == 0x000018, "Wrong size on FStateTreeBooleanXOrPropertyFunction");
...
static_assert(sizeof(FStateTreeBooleanNotPropertyFunction) == 0x000018, "Wrong size on FStateTreeBooleanNotPropertyFunction");
...
static_assert(alignof(FStateTreeDelegateDispatcher) == 0x000004, "Wrong alignment on FStateTreeDelegateDispatcher");
...
static_assert(alignof(FStateTreeExecutionExtension) == 0x000008, "Wrong alignment on FStateTreeExecutionExtension");
...
static_assert(alignof(FStateTreeTransitionRequest) == 0x000004, "Wrong alignment on FStateTreeTransitionRequest");
...
static_assert(alignof(FStateTreeTransitionSource) == 0x000004, "Wrong alignment on FStateTreeTransitionSource");
...
static_assert(alignof(FStateTreeTasksCompletionStatus) == 0x000008, "Wrong alignment on FStateTreeTasksCompletionStatus");
...
static_assert(sizeof(FStateTreeSubtractFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeSubtractFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeMultiplyFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeMultiplyFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeDivideFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeDivideFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeInvertFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeInvertFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeAbsoluteFloatPropertyFunction) == 0x000018, "Wrong size on FStateTreeAbsoluteFloatPropertyFunction");
...
static_assert(sizeof(FStateTreeMakeIntervalPropertyFunction) == 0x000018, "Wrong size on FStateTreeMakeIntervalPropertyFunction");
...
static_assert(sizeof(FStateTreeAddIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeAddIntPropertyFunction");
...
static_assert(sizeof(FStateTreeSubtractIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeSubtractIntPropertyFunction");
...
static_assert(sizeof(FStateTreeMultiplyIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeMultiplyIntPropertyFunction");
...
static_assert(sizeof(FStateTreeDivideIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeDivideIntPropertyFunction");
...
static_assert(sizeof(FStateTreeInvertIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeInvertIntPropertyFunction");
...
static_assert(sizeof(FStateTreeAbsoluteIntPropertyFunction) == 0x000018, "Wrong size on FStateTreeAbsoluteIntPropertyFunction");
...
static_assert(alignof(FStateTreeRunParallelStateTreeExecutionExtension) == 0x000008, "Wrong alignment on FStateTreeRunParallelStateTreeExecutionExtension");
...
{
public:
	uint8                                         BitPad_18_0 : 7;                                   // 0x0018(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bTaskEnabled : 1;                                  // 0x0018(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FStateTreeTaskBase, TransitionHandlingPriority) == 0x000019, "Member 'FStateTreeTaskBase::TransitionHandlingPriority' has a wrong offset!");
...
static_assert(sizeof(FStateTreeRunParallelStateTreeTask) == 0x000028, "Wrong size on FStateTreeRunParallelStateTreeTask");
static_assert(offsetof(FStateTreeRunParallelStateTreeTask, StateTreeOverrideTag) == 0x000020, "Member 'FStateTreeRunParallelStateTreeTask::StateTreeOverrideTag' has a wrong offset!");
...
{
public:
	EStateTreeExpressionOperand                   Operand;                                           // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FStateTreeConsiderationBase) == 0x000020, "Wrong size on FStateTreeConsiderationBase");
static_assert(offsetof(FStateTreeConsiderationBase, Operand) == 0x000018, "Member 'FStateTreeConsiderationBase::Operand' has a wrong offset!");
static_assert(offsetof(FStateTreeConsiderationBase, DeltaIndent) == 0x000019, "Member 'FStateTreeConsiderationBase::DeltaIndent' has a wrong offset!");
...
{
public:
	TSubclassOf<class UStateTreeConsiderationBlueprintBase> ConsiderationClass;                                // 0x0020(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FStateTreeBlueprintConsiderationWrapper) == 0x000028, "Wrong size on FStateTreeBlueprintConsiderationWrapper");
static_assert(offsetof(FStateTreeBlueprintConsiderationWrapper, ConsiderationClass) == 0x000020, "Member 'FStateTreeBlueprintConsiderationWrapper::ConsiderationClass' has a wrong offset!");
...
public:
	...
	uint8                                         TaskFlags;                                         // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FStateTreeBlueprintTaskWrapper, TaskFlags) == 0x000028, "Member 'FStateTreeBlueprintTaskWrapper::TaskFlags' has a wrong offset!");
...
static_assert(sizeof(FStateTreeConsiderationCommonBase) == 0x000020, "Wrong size on FStateTreeConsiderationCommonBase");
...
static_assert(sizeof(FStateTreeConstantConsideration) == 0x000020, "Wrong size on FStateTreeConstantConsideration");
...
{
public:
	struct FStateTreeConsiderationResponseCurve   ResponseCurve;                                     // 0x0020(0x0088)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FStateTreeFloatInputConsideration) == 0x000008, "Wrong alignment on FStateTreeFloatInputConsideration");
static_assert(sizeof(FStateTreeFloatInputConsideration) == 0x0000A8, "Wrong size on FStateTreeFloatInputConsideration");
static_assert(offsetof(FStateTreeFloatInputConsideration, ResponseCurve) == 0x000020, "Member 'FStateTreeFloatInputConsideration::ResponseCurve' has a wrong offset!");
...
{
public:
	struct FStateTreeEnumValueScorePairs          EnumValueScorePairs;                               // 0x0020(0x0010)(Edit, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FStateTreeEnumInputConsideration) == 0x000008, "Wrong alignment on FStateTreeEnumInputConsideration");
static_assert(sizeof(FStateTreeEnumInputConsideration) == 0x000030, "Wrong size on FStateTreeEnumInputConsideration");
static_assert(offsetof(FStateTreeEnumInputConsideration, EnumValueScorePairs) == 0x000020, "Member 'FStateTreeEnumInputConsideration::EnumValueScorePairs' has a wrong offset!");
...
static_assert(alignof(FStateTreePropertyBindings) == 0x000010, "Wrong alignment on FStateTreePropertyBindings");
...
static_assert(alignof(FCompactStateTreeFrame) == 0x000002, "Wrong alignment on FCompactStateTreeFrame");
...
public:
	...
	uint16                                        UtilityConsiderationsBegin;                        // 0x002A(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        TransitionsBegin;                                  // 0x002C(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint16                                        TasksBegin;                                        // 0x002E(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      ParameterTemplateIndex;                            // 0x0030(0x0002)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeDataHandle                   ParameterDataHandle;                               // 0x0032(0x0006)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      ParameterBindingsBatch;                            // 0x0038(0x0002)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FStateTreeIndex16                      EventDataIndex;                                    // 0x003A(0x0002)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Weight;                                            // 0x003C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CustomTickRate;                                    // 0x0040(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32                                        CompletionTasksMask;                               // 0x0044(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         CompletionTasksMaskBufferIndex;                    // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         CompletionTasksMaskBitsOffset;                     // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EStateTreeTaskCompletionType                  CompletionTasksControl;                            // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         EnterConditionsNum;                                // 0x004B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         UtilityConsiderationsNum;                          // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TransitionsNum;                                    // 0x004D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         TasksNum;                                          // 0x004E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         EnabledTasksNum;                                   // 0x004F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         InstanceDataNum;                                   // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Depth;                                             // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EStateTreeStateType                           Type;                                              // 0x0052(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EStateTreeStateSelectionBehavior              SelectionBehavior;                                 // 0x0053(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bHasTransitionTasks : 1;                           // 0x0054(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasStateChangeConditions : 1;                     // 0x0054(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         BitPad_54_2 : 4;                                   // 0x0054(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	uint8                                         bHasTickTriggerTransitions : 1;                    // 0x0054(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasEventTriggerTransitions : 1;                   // 0x0054(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasDelegateTriggerTransitions : 1;                // 0x0055(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasCompletedTriggerTransitions : 1;               // 0x0055(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasSucceededTriggerTransitions : 1;               // 0x0055(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasFailedTriggerTransitions : 1;                  // 0x0055(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bCheckPrerequisitesWhenActivatingChildDirectly : 1; // 0x0055(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnabled : 1;                                      // 0x0055(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bConsumeEventOnSelect : 1;                         // 0x0055(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bHasCustomTickRate : 1;                            // 0x0055(0x0001)(BitIndex: 0x07, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FCompactStateTreeState, Tag) == 0x000014, "Member 'FCompactStateTreeState::Tag' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, LinkedAsset) == 0x000018, "Member 'FCompactStateTreeState::LinkedAsset' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, LinkedState) == 0x000020, "Member 'FCompactStateTreeState::LinkedState' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Parent) == 0x000022, "Member 'FCompactStateTreeState::Parent' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenBegin) == 0x000024, "Member 'FCompactStateTreeState::ChildrenBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ChildrenEnd) == 0x000026, "Member 'FCompactStateTreeState::ChildrenEnd' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsBegin) == 0x000028, "Member 'FCompactStateTreeState::EnterConditionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, UtilityConsiderationsBegin) == 0x00002A, "Member 'FCompactStateTreeState::UtilityConsiderationsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsBegin) == 0x00002C, "Member 'FCompactStateTreeState::TransitionsBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksBegin) == 0x00002E, "Member 'FCompactStateTreeState::TasksBegin' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterTemplateIndex) == 0x000030, "Member 'FCompactStateTreeState::ParameterTemplateIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterDataHandle) == 0x000032, "Member 'FCompactStateTreeState::ParameterDataHandle' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, ParameterBindingsBatch) == 0x000038, "Member 'FCompactStateTreeState::ParameterBindingsBatch' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EventDataIndex) == 0x00003A, "Member 'FCompactStateTreeState::EventDataIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Weight) == 0x00003C, "Member 'FCompactStateTreeState::Weight' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, CustomTickRate) == 0x000040, "Member 'FCompactStateTreeState::CustomTickRate' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, CompletionTasksMask) == 0x000044, "Member 'FCompactStateTreeState::CompletionTasksMask' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, CompletionTasksMaskBufferIndex) == 0x000048, "Member 'FCompactStateTreeState::CompletionTasksMaskBufferIndex' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, CompletionTasksMaskBitsOffset) == 0x000049, "Member 'FCompactStateTreeState::CompletionTasksMaskBitsOffset' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, CompletionTasksControl) == 0x00004A, "Member 'FCompactStateTreeState::CompletionTasksControl' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnterConditionsNum) == 0x00004B, "Member 'FCompactStateTreeState::EnterConditionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, UtilityConsiderationsNum) == 0x00004C, "Member 'FCompactStateTreeState::UtilityConsiderationsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TransitionsNum) == 0x00004D, "Member 'FCompactStateTreeState::TransitionsNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, TasksNum) == 0x00004E, "Member 'FCompactStateTreeState::TasksNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, EnabledTasksNum) == 0x00004F, "Member 'FCompactStateTreeState::EnabledTasksNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, InstanceDataNum) == 0x000050, "Member 'FCompactStateTreeState::InstanceDataNum' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Depth) == 0x000051, "Member 'FCompactStateTreeState::Depth' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, Type) == 0x000052, "Member 'FCompactStateTreeState::Type' has a wrong offset!");
static_assert(offsetof(FCompactStateTreeState, SelectionBehavior) == 0x000053, "Member 'FCompactStateTreeState::SelectionBehavior' has a wrong offset!");
