...
static_assert(offsetof(FPhysicsControlModifierData, bUseSkeletalAnimation) == 0x00000C, "Member 'FPhysicsControlModifierData::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(FPhysicsControlModifierData, bUpdateKinematicFromSimulation) == 0x00000D, "Member 'FPhysicsControlModifierData::bUpdateKinematicFromSimulation' has a wrong offset!");
...
static_assert(offsetof(FPhysicsControlData, bEnabled) == 0x000048, "Member 'FPhysicsControlData::bEnabled' has a wrong offset!");
static_assert(offsetof(FPhysicsControlData, bUseCustomControlPoint) == 0x000049, "Member 'FPhysicsControlData::bUseCustomControlPoint' has a wrong offset!");
static_assert(offsetof(FPhysicsControlData, bUseSkeletalAnimation) == 0x00004A, "Member 'FPhysicsControlData::bUseSkeletalAnimation' has a wrong offset!");
static_assert(offsetof(FPhysicsControlData, bDisableCollision) == 0x00004B, "Member 'FPhysicsControlData::bDisableCollision' has a wrong offset!");
static_assert(offsetof(FPhysicsControlData, bOnlyControlChildObject) == 0x00004C, "Member 'FPhysicsControlData::bOnlyControlChildObject' has a wrong offset!");
...
public:
	...
	struct FBoneReference                         BaseBoneRef;                                       // 0x02F0(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         bCalculateVelocitiesForWorldGeometry : 1;          // 0x02FE(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bForceDisableCollisionBetweenConstraintBodies : 1; // 0x02FE(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseExternalClothCollision : 1;                    // 0x02FE(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMakeKinematicConstraints : 1;                     // 0x02FE(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         BitPad_2FE_4 : 4;                                  // 0x02FE(0x0001)(Fixing Bit-Field Size For New Byte [ Dumper-7 ])
	uint8                                         Pad_2FF[0x1];                                      // 0x02FF(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bEnableWorldGeometry : 1;                          // 0x0300(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideWorldGravity : 1;                         // 0x0300(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTransferBoneVelocities : 1;                       // 0x0300(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFreezeIncomingPoseOnStart : 1;                    // 0x0300(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	EMapConstraintsBehaviorType                   PhysicsAssetConditioningConstraintPosition;        // 0x0301(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMapConstraintsBehaviorType                   PhysicsAssetConditioningConstraintOrientation;     // 0x0302(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bEnableControls;                                   // 0x030C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_30D[0x3];                                      // 0x030D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UPhysicsControlAsset*                   PhysicsControlAsset;                               // 0x0310(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class USkeletalMesh*                          PhysicsAssetAuthoredSkeletalMesh;                  // 0x0620(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ConstraintProfile;                                 // 0x0628(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ControlProfile;                                    // 0x062C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_630[0x1];                                      // 0x0630(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	ESimulationTiming                             SimulationTiming;                                  // 0x0631(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_632[0x7BE];                                    // 0x0632(0x07BE)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBodyWithControl) == 0x000010, "Wrong alignment on FAnimNode_RigidBodyWithControl");
static_assert(sizeof(FAnimNode_RigidBodyWithControl) == 0x000DF0, "Wrong size on FAnimNode_RigidBodyWithControl");
...
static_assert(offsetof(FAnimNode_RigidBodyWithControl, CachedBoundsScale) == 0x0002E8, "Member 'FAnimNode_RigidBodyWithControl::CachedBoundsScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, bUpdateCacheEveryFrame) == 0x0002EC, "Member 'FAnimNode_RigidBodyWithControl::bUpdateCacheEveryFrame' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, BaseBoneRef) == 0x0002F0, "Member 'FAnimNode_RigidBodyWithControl::BaseBoneRef' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, OverlapChannel) == 0x0002FC, "Member 'FAnimNode_RigidBodyWithControl::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, SimulationSpace) == 0x0002FD, "Member 'FAnimNode_RigidBodyWithControl::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, PhysicsAssetConditioningConstraintPosition) == 0x000301, "Member 'FAnimNode_RigidBodyWithControl::PhysicsAssetConditioningConstraintPosition' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, PhysicsAssetConditioningConstraintOrientation) == 0x000302, "Member 'FAnimNode_RigidBodyWithControl::PhysicsAssetConditioningConstraintOrientation' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, WorldSpaceMinimumScale) == 0x000304, "Member 'FAnimNode_RigidBodyWithControl::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, EvaluationResetTime) == 0x000308, "Member 'FAnimNode_RigidBodyWithControl::EvaluationResetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, bEnableControls) == 0x00030C, "Member 'FAnimNode_RigidBodyWithControl::bEnableControls' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, PhysicsControlAsset) == 0x000310, "Member 'FAnimNode_RigidBodyWithControl::PhysicsControlAsset' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_RigidBodyWithControl, ControlProfile) == 0x00062C, "Member 'FAnimNode_RigidBodyWithControl::ControlProfile' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBodyWithControl, SimulationTiming) == 0x000631, "Member 'FAnimNode_RigidBodyWithControl::SimulationTiming' has a wrong offset!");
