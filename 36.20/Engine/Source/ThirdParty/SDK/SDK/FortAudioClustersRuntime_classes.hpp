...
// Class FortAudioClustersRuntime.GameFeatureAction_AddAudioClusterSettings
// 0x00A0 (0x00C8 - 0x0028)
class UGameFeatureAction_AddAudioClusterSettings final : public UGameFeatureAction
{
public:
	TMap<struct FGameplayTag, double>             SettingsMap;                                       // 0x0028(0x0050)(Edit, NativeAccessSpecifierPrivate)
	uint8                                         Pad_78[0x50];                                      // 0x0078(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"GameFeatureAction_AddAudioClusterSettings">();
	}
	static class UGameFeatureAction_AddAudioClusterSettings* GetDefaultObj()
	{
		return GetDefaultObjImpl<UGameFeatureAction_AddAudioClusterSettings>();
	}
};
static_assert(alignof(UGameFeatureAction_AddAudioClusterSettings) == 0x000008, "Wrong alignment on UGameFeatureAction_AddAudioClusterSettings");
static_assert(sizeof(UGameFeatureAction_AddAudioClusterSettings) == 0x0000C8, "Wrong size on UGameFeatureAction_AddAudioClusterSettings");
static_assert(offsetof(UGameFeatureAction_AddAudioClusterSettings, SettingsMap) == 0x000028, "Member 'UGameFeatureAction_AddAudioClusterSettings::SettingsMap' has a wrong offset!");
