...
struct FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart final
{
public:
	class FString                                 OpenedUrl;                                         // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart) == 0x000008, "Wrong alignment on FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart");
static_assert(sizeof(FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart) == 0x000010, "Wrong size on FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart");
static_assert(offsetof(FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart, OpenedUrl) == 0x000000, "Member 'FortCreativeStreamingMusicalReactivityComponent_HandleStreamingStart::OpenedUrl' has a wrong offset!");
