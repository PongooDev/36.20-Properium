...
// Function MotorcycleRuntime.FortMotorcycleVehicle.SetRuntimeBoostInfoOnServer
// 0x0018 (0x0018 - 0x0000)
struct FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer final
{
public:
	struct FMotorcycleRuntimeBoostInfo            NewBoostInfo;                                      // 0x0000(0x0018)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer) == 0x000004, "Wrong alignment on FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer");
static_assert(sizeof(FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer) == 0x000018, "Wrong size on FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer");
static_assert(offsetof(FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer, NewBoostInfo) == 0x000000, "Member 'FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer::NewBoostInfo' has a wrong offset!");
