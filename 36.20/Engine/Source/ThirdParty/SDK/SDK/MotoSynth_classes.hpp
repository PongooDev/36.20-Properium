...
// 0x01A0 (0x0A40 - 0x08A0)
class USynthComponentMoto : public USynthComponent
{
public:
	class UMotoSynthPreset*                       MotoSynthPreset;                                   // 0x08A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RPM;                                               // 0x08A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8AC[0x194];                                    // 0x08AC(0x0194)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USynthComponentMoto) == 0x000A40, "Wrong size on USynthComponentMoto");
static_assert(offsetof(USynthComponentMoto, MotoSynthPreset) == 0x0008A0, "Member 'USynthComponentMoto::MotoSynthPreset' has a wrong offset!");
static_assert(offsetof(USynthComponentMoto, RPM) == 0x0008A8, "Member 'USynthComponentMoto::RPM' has a wrong offset!");
