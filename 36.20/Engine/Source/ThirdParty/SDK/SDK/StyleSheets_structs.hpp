...
static_assert(sizeof(FStyleRulePreviewInfo) == 0x000028, "Wrong size on FStyleRulePreviewInfo");
static_assert(offsetof(FStyleRulePreviewInfo, StyleDescription) == 0x000000, "Member 'FStyleRulePreviewInfo::StyleDescription' has a wrong offset!");
static_assert(offsetof(FStyleRulePreviewInfo, PreviewWidgetClass) == 0x000010, "Member 'FStyleRulePreviewInfo::PreviewWidgetClass' has a wrong offset!");
static_assert(offsetof(FStyleRulePreviewInfo, PreviewPropertyBag) == 0x000018, "Member 'FStyleRulePreviewInfo::PreviewPropertyBag' has a wrong offset!");
