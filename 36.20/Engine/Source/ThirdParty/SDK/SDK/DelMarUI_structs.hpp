...
{
public:
	struct FSlateBrush                            IconBrush;                                         // 0x0000(0x00B0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateBrush                            BackgroundBrush;                                   // 0x00B0(0x00B0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	ESlateVisibility                              ButtonVisibility;                                  // 0x0160(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCancelInputOnEnter;                               // 0x0161(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCancelInputOnLeave;                               // 0x0162(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDelMarTouchActionButtonStateData) == 0x000170, "Wrong size on FDelMarTouchActionButtonStateData");
...
static_assert(offsetof(FDelMarTouchActionButtonStateData, BackgroundBrush) == 0x0000B0, "Member 'FDelMarTouchActionButtonStateData::BackgroundBrush' has a wrong offset!");
static_assert(offsetof(FDelMarTouchActionButtonStateData, ButtonVisibility) == 0x000160, "Member 'FDelMarTouchActionButtonStateData::ButtonVisibility' has a wrong offset!");
static_assert(offsetof(FDelMarTouchActionButtonStateData, bCancelInputOnEnter) == 0x000161, "Member 'FDelMarTouchActionButtonStateData::bCancelInputOnEnter' has a wrong offset!");
static_assert(offsetof(FDelMarTouchActionButtonStateData, bCancelInputOnLeave) == 0x000162, "Member 'FDelMarTouchActionButtonStateData::bCancelInputOnLeave' has a wrong offset!");
