...
{
public:
	TMap<class FString, struct FVector>           SubPoints;                                         // 0x05E0(0x0050)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bVisualizePointsInEditor;                          // 0x0630(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_631[0x3];                                      // 0x0631(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         PointVisualizationScale;                           // 0x0634(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECalibrationPointVisualization                VisualizationShape;                                // 0x0638(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UCalibrationPointComponent, SubPoints) == 0x0005E0, "Member 'UCalibrationPointComponent::SubPoints' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, bVisualizePointsInEditor) == 0x000630, "Member 'UCalibrationPointComponent::bVisualizePointsInEditor' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, PointVisualizationScale) == 0x000634, "Member 'UCalibrationPointComponent::PointVisualizationScale' has a wrong offset!");
static_assert(offsetof(UCalibrationPointComponent, VisualizationShape) == 0x000638, "Member 'UCalibrationPointComponent::VisualizationShape' has a wrong offset!");
...
{
public:
	class USceneComponent*                        Root;                                              // 0x02A8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             TopLeft;                                           // 0x02B0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             TopRight;                                          // 0x02B8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             BottomLeft;                                        // 0x02C0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             BottomRight;                                       // 0x02C8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UCalibrationPointComponent*             Center;                                            // 0x02D0(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UStaticMesh*                            CubeMesh;                                          // 0x02E8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     OddCubeMaterial;                                   // 0x02F0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UMaterialInterface*                     EvenCubeMaterial;                                  // 0x02F8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ACameraCalibrationCheckerboard) == 0x000300, "Wrong size on ACameraCalibrationCheckerboard");
static_assert(offsetof(ACameraCalibrationCheckerboard, Root) == 0x0002A8, "Member 'ACameraCalibrationCheckerboard::Root' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopLeft) == 0x0002B0, "Member 'ACameraCalibrationCheckerboard::TopLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, TopRight) == 0x0002B8, "Member 'ACameraCalibrationCheckerboard::TopRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomLeft) == 0x0002C0, "Member 'ACameraCalibrationCheckerboard::BottomLeft' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, BottomRight) == 0x0002C8, "Member 'ACameraCalibrationCheckerboard::BottomRight' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Center) == 0x0002D0, "Member 'ACameraCalibrationCheckerboard::Center' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerRows) == 0x0002D8, "Member 'ACameraCalibrationCheckerboard::NumCornerRows' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, NumCornerCols) == 0x0002DC, "Member 'ACameraCalibrationCheckerboard::NumCornerCols' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, SquareSideLength) == 0x0002E0, "Member 'ACameraCalibrationCheckerboard::SquareSideLength' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, Thickness) == 0x0002E4, "Member 'ACameraCalibrationCheckerboard::Thickness' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, CubeMesh) == 0x0002E8, "Member 'ACameraCalibrationCheckerboard::CubeMesh' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, OddCubeMaterial) == 0x0002F0, "Member 'ACameraCalibrationCheckerboard::OddCubeMaterial' has a wrong offset!");
static_assert(offsetof(ACameraCalibrationCheckerboard, EvenCubeMaterial) == 0x0002F8, "Member 'ACameraCalibrationCheckerboard::EvenCubeMaterial' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class ULensFile>               StartupLensFile;                                   // 0x0030(0x0020)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FIntPoint                              DisplacementMapResolution;                         // 0x0050(0x0008)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CalibrationInputTolerance;                         // 0x0058(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CheckerboardDetectionTimeout;                      // 0x005C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TMap<TSubclassOf<class ULensDistortionModelHandlerBase>, TSoftObjectPtr<class UMaterialInterface>> DefaultUndistortionDisplacementMaterials;          // 0x0060(0x0050)(Config, UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<TSubclassOf<class ULensDistortionModelHandlerBase>, TSoftObjectPtr<class UMaterialInterface>> DefaultDistortionDisplacementMaterials;            // 0x00B0(0x0050)(Config, UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<TSubclassOf<class ULensDistortionModelHandlerBase>, TSoftObjectPtr<class UMaterialInterface>> DefaultDistortionMaterials;                        // 0x0100(0x0050)(Config, UObjectWrapper, NativeAccessSpecifierPrivate)
	bool                                          bEnableCalibrationDatasetImportExport;             // 0x0150(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UCameraCalibrationSettings, StartupLensFile) == 0x000030, "Member 'UCameraCalibrationSettings::StartupLensFile' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, DisplacementMapResolution) == 0x000050, "Member 'UCameraCalibrationSettings::DisplacementMapResolution' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, CalibrationInputTolerance) == 0x000058, "Member 'UCameraCalibrationSettings::CalibrationInputTolerance' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, CheckerboardDetectionTimeout) == 0x00005C, "Member 'UCameraCalibrationSettings::CheckerboardDetectionTimeout' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, DefaultUndistortionDisplacementMaterials) == 0x000060, "Member 'UCameraCalibrationSettings::DefaultUndistortionDisplacementMaterials' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, DefaultDistortionDisplacementMaterials) == 0x0000B0, "Member 'UCameraCalibrationSettings::DefaultDistortionDisplacementMaterials' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, DefaultDistortionMaterials) == 0x000100, "Member 'UCameraCalibrationSettings::DefaultDistortionMaterials' has a wrong offset!");
static_assert(offsetof(UCameraCalibrationSettings, bEnableCalibrationDatasetImportExport) == 0x000150, "Member 'UCameraCalibrationSettings::bEnableCalibrationDatasetImportExport' has a wrong offset!");
...
static_assert(sizeof(UCameraCalibrationEditorSettings) == 0x000030, "Wrong size on UCameraCalibrationEditorSettings");
