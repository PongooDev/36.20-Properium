...
// Parameters:
// bool                                    bWasCardPurchased                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_Athena_SCMachine_Pickup_C::OnDestroyPickup(bool bWasCardPurchased)
{
	static class UFunction* Func = nullptr;
	...
	Params::BGA_Athena_SCMachine_Pickup_C_OnDestroyPickup Parms{};

	Parms.bWasCardPurchased = bWasCardPurchased;
