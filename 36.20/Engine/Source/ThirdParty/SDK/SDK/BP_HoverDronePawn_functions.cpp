...
// Parameters:
// int32                                   bone                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_HoverDronePawn_C::AttachToBone(int32 bone)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("AttachToBone");

	Params::BP_HoverDronePawn_C_AttachToBone Parms{};
