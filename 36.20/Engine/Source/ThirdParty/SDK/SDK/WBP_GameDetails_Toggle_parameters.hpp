...
static_assert(sizeof(WBP_GameDetails_Toggle_C_Set_Toggle) == 0x000040, "Wrong size on WBP_GameDetails_Toggle_C_Set_Toggle");
...
static_assert(offsetof(WBP_GameDetails_Toggle_C_Set_Toggle, CallFunc_PlayAnimation_ReturnValue_1) == 0x000030, "Member 'WBP_GameDetails_Toggle_C_Set_Toggle::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
