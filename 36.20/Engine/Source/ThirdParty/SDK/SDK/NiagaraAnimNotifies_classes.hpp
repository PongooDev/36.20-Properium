...
public:
	...
	class FName                                   NotifyProgressUserParameter;                       // 0x0094(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnimNotifyState_TimedNiagaraEffectAdvanced) == 0x0000F8, "Wrong size on UAnimNotifyState_TimedNiagaraEffectAdvanced");
...
static_assert(offsetof(UAnimNotifyState_TimedNiagaraEffectAdvanced, AnimCurves) == 0x000098, "Member 'UAnimNotifyState_TimedNiagaraEffectAdvanced::AnimCurves' has a wrong offset!");
