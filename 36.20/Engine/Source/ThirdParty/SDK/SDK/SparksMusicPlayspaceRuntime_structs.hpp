...
// ScriptStruct SparksMusicPlayspaceRuntime.SparksPlayspaceEvent_OnPlayerPawnSet
// 0x0038 (0x0038 - 0x0000)
struct FSparksPlayspaceEvent_OnPlayerPawnSet final
{
public:
	...
	TWeakObjectPtr<class APawn>                   PlayerPawn;                                        // 0x0030(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSparksPlayspaceEvent_OnPlayerPawnSet) == 0x000008, "Wrong alignment on FSparksPlayspaceEvent_OnPlayerPawnSet");
static_assert(sizeof(FSparksPlayspaceEvent_OnPlayerPawnSet) == 0x000038, "Wrong size on FSparksPlayspaceEvent_OnPlayerPawnSet");
static_assert(offsetof(FSparksPlayspaceEvent_OnPlayerPawnSet, PlayerId) == 0x000000, "Member 'FSparksPlayspaceEvent_OnPlayerPawnSet::PlayerId' has a wrong offset!");
static_assert(offsetof(FSparksPlayspaceEvent_OnPlayerPawnSet, PlayerPawn) == 0x000030, "Member 'FSparksPlayspaceEvent_OnPlayerPawnSet::PlayerPawn' has a wrong offset!");

// ScriptStruct SparksMusicPlayspaceRuntime.SparksPlayspaceInteractor
// 0x0018 (0x0018 - 0x0000)
struct alignas(0x08) FSparksPlayspaceInteractor final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class AActor>                  AddedForActor;                                     // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FSparksPlayspaceInteractor) == 0x000008, "Wrong alignment on FSparksPlayspaceInteractor");
static_assert(sizeof(FSparksPlayspaceInteractor) == 0x000018, "Wrong size on FSparksPlayspaceInteractor");
static_assert(offsetof(FSparksPlayspaceInteractor, AddedForActor) == 0x000010, "Member 'FSparksPlayspaceInteractor::AddedForActor' has a wrong offset!");
