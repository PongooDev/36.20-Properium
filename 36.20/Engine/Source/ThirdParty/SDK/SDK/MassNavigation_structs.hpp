...
static_assert(alignof(FMassAvoidanceEntitiesToIgnoreFragment) == 0x000008, "Wrong alignment on FMassAvoidanceEntitiesToIgnoreFragment");
...
static_assert(alignof(FNavigationRelevantFragment) == 0x000008, "Wrong alignment on FNavigationRelevantFragment");
...
static_assert(alignof(FMassTargetLocation) == 0x000008, "Wrong alignment on FMassTargetLocation");
