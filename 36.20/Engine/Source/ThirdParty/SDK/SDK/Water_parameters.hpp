...
static_assert(offsetof(WaterBodyComponent_GetWaterSurfaceInfoAtLocation, ReturnValue) == 0x000065, "Member 'WaterBodyComponent_GetWaterSurfaceInfoAtLocation::ReturnValue' has a wrong offset!");
...
static_assert(alignof(WaterBodyComponent_GetWaterVelocityVectorAtSplineInputKey) == 0x000008, "Wrong alignment on WaterBodyComponent_GetWaterVelocityVectorAtSplineInputKey");
