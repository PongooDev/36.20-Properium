...
static_assert(offsetof(FortEventMoreInfoGroup_OnSetGroupText, Body) == 0x000010, "Member 'FortEventMoreInfoGroup_OnSetGroupText::Body' has a wrong offset!");
...
static_assert(alignof(FortEventMoreInfoModal_OnKeyArtLoaded) == 0x000008, "Wrong alignment on FortEventMoreInfoModal_OnKeyArtLoaded");
static_assert(sizeof(FortEventMoreInfoModal_OnKeyArtLoaded) == 0x000008, "Wrong size on FortEventMoreInfoModal_OnKeyArtLoaded");
static_assert(offsetof(FortEventMoreInfoModal_OnKeyArtLoaded, Icon) == 0x000000, "Member 'FortEventMoreInfoModal_OnKeyArtLoaded::Icon' has a wrong offset!");
...
static_assert(offsetof(FortEventMoreInfoModal_SetModalText, SubHeader) == 0x000010, "Member 'FortEventMoreInfoModal_SetModalText::SubHeader' has a wrong offset!");
static_assert(offsetof(FortEventMoreInfoModal_SetModalText, Legal) == 0x000020, "Member 'FortEventMoreInfoModal_SetModalText::Legal' has a wrong offset!");
...
static_assert(offsetof(FortEventPurchasePremiumTrackModal_OnCMSTextApplied, LegalText) == 0x000010, "Member 'FortEventPurchasePremiumTrackModal_OnCMSTextApplied::LegalText' has a wrong offset!");
...
// Function EventScreenBase.FortEventScreenBase.SetCurrentView
// 0x0001 (0x0001 - 0x0000)
struct FortEventScreenBase_SetCurrentView final
{
public:
	EEventScreenView                              View;                                              // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortEventScreenBase_SetCurrentView) == 0x000001, "Wrong alignment on FortEventScreenBase_SetCurrentView");
static_assert(sizeof(FortEventScreenBase_SetCurrentView) == 0x000001, "Wrong size on FortEventScreenBase_SetCurrentView");
static_assert(offsetof(FortEventScreenBase_SetCurrentView, View) == 0x000000, "Member 'FortEventScreenBase_SetCurrentView::View' has a wrong offset!");
...
static_assert(alignof(FortEventScreenBase_GetVaultWorld) == 0x000008, "Wrong alignment on FortEventScreenBase_GetVaultWorld");
static_assert(sizeof(FortEventScreenBase_GetVaultWorld) == 0x000008, "Wrong size on FortEventScreenBase_GetVaultWorld");
static_assert(offsetof(FortEventScreenBase_GetVaultWorld, ReturnValue) == 0x000000, "Member 'FortEventScreenBase_GetVaultWorld::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FortEventTrackerModule_EventDetails_OnPopulateEventDetailsText, OutEventDescription) == 0x000010, "Member 'FortEventTrackerModule_EventDetails_OnPopulateEventDetailsText::OutEventDescription' has a wrong offset!");
...
static_assert(offsetof(FortEventTrackerModule_EventDetails_UpdateEventTimeRemaining, TimeRemaining) == 0x000010, "Member 'FortEventTrackerModule_EventDetails_UpdateEventTimeRemaining::TimeRemaining' has a wrong offset!");
...
static_assert(offsetof(FortEventTrackerModule_Header_OnPopulateEventResourceHeader, ResourceValue) == 0x000010, "Member 'FortEventTrackerModule_Header_OnPopulateEventResourceHeader::ResourceValue' has a wrong offset!");
...
static_assert(offsetof(FortEventTrackerModule_PremiumUpsell_OnPopulateText, BodyText) == 0x000010, "Member 'FortEventTrackerModule_PremiumUpsell_OnPopulateText::BodyText' has a wrong offset!");
