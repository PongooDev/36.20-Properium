...
static_assert(alignof(FRigVMExecutePin) == 0x000008, "Wrong alignment on FRigVMExecutePin");
...
static_assert(alignof(FRigVMStructMutable) == 0x000008, "Wrong alignment on FRigVMStructMutable");
...
static_assert(alignof(FRigVMFunction_DebugBaseMutable) == 0x000008, "Wrong alignment on FRigVMFunction_DebugBaseMutable");
...
public:
	...
	class FName                                   Category;                                          // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	ESceneDepthPriorityGroup                      DepthPriority;                                     // 0x0090(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         Lifetime;                                          // 0x0094(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigVMDrawInstruction, DepthPriority) == 0x000090, "Member 'FRigVMDrawInstruction::DepthPriority' has a wrong offset!");
static_assert(offsetof(FRigVMDrawInstruction, Lifetime) == 0x000094, "Member 'FRigVMDrawInstruction::Lifetime' has a wrong offset!");
...
{
public:
	uint8                                         Pad_8[0xF8];                                       // 0x0008(0x00F8)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	struct FSoftObjectPath                        ObjectPath;                                        // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMVariant                          Variant;                                           // 0x0018(0x0020)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMVariantRef) == 0x000008, "Wrong alignment on FRigVMVariantRef");
static_assert(sizeof(FRigVMVariantRef) == 0x000038, "Wrong size on FRigVMVariantRef");
static_assert(offsetof(FRigVMVariantRef, ObjectPath) == 0x000000, "Member 'FRigVMVariantRef::ObjectPath' has a wrong offset!");
static_assert(offsetof(FRigVMVariantRef, Variant) == 0x000018, "Member 'FRigVMVariantRef::Variant' has a wrong offset!");
...
static_assert(alignof(FRigVMFunction_MathMutableBase) == 0x000008, "Wrong alignment on FRigVMFunction_MathMutableBase");
...
static_assert(alignof(FRigVMFunction_SimBaseMutable) == 0x000008, "Wrong alignment on FRigVMFunction_SimBaseMutable");
...
static_assert(alignof(FRigVMFunction_VisualLogCapsule) == 0x000010, "Wrong alignment on FRigVMFunction_VisualLogCapsule");
...
static_assert(alignof(FRigVMFunction_VisualLogOrientedBox) == 0x000010, "Wrong alignment on FRigVMFunction_VisualLogOrientedBox");
...
public:
	...
	class FString                                 LibraryNodePath;                                   // 0x0018(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FRigVMGraphFunctionIdentifier, LibraryNodePath) == 0x000018, "Member 'FRigVMGraphFunctionIdentifier::LibraryNodePath' has a wrong offset!");
...
public:
	...
	struct FRigVMVariant                          Variant;                                           // 0x0040(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	class FName                                   Name;                                              // 0x0060(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 NodeTitle;                                         // 0x0068(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           NodeColor;                                         // 0x0078(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   ToolTip;                                           // 0x0088(0x0010)(Deprecated, NativeAccessSpecifierPublic)
	class FString                                 Description;                                       // 0x0098(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Category;                                          // 0x00A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Keywords;                                          // 0x00B8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FRigVMGraphFunctionArgument>    Arguments;                                         // 0x00C8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TMap<struct FRigVMGraphFunctionIdentifier, uint32> Dependencies;                                      // 0x00D8(0x0050)(NativeAccessSpecifierPublic)
	TArray<struct FRigVMExternalVariable>         ExternalVariables;                                 // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	struct FRigVMNodeLayout                       Layout;                                            // 0x0138(0x00B0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMGraphFunctionHeader) == 0x000008, "Wrong alignment on FRigVMGraphFunctionHeader");
static_assert(sizeof(FRigVMGraphFunctionHeader) == 0x0001E8, "Wrong size on FRigVMGraphFunctionHeader");
...
static_assert(offsetof(FRigVMGraphFunctionHeader, Variant) == 0x000040, "Member 'FRigVMGraphFunctionHeader::Variant' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Name) == 0x000060, "Member 'FRigVMGraphFunctionHeader::Name' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeTitle) == 0x000068, "Member 'FRigVMGraphFunctionHeader::NodeTitle' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, NodeColor) == 0x000078, "Member 'FRigVMGraphFunctionHeader::NodeColor' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ToolTip) == 0x000088, "Member 'FRigVMGraphFunctionHeader::ToolTip' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Description) == 0x000098, "Member 'FRigVMGraphFunctionHeader::Description' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Category) == 0x0000A8, "Member 'FRigVMGraphFunctionHeader::Category' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Keywords) == 0x0000B8, "Member 'FRigVMGraphFunctionHeader::Keywords' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Arguments) == 0x0000C8, "Member 'FRigVMGraphFunctionHeader::Arguments' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Dependencies) == 0x0000D8, "Member 'FRigVMGraphFunctionHeader::Dependencies' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, ExternalVariables) == 0x000128, "Member 'FRigVMGraphFunctionHeader::ExternalVariables' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionHeader, Layout) == 0x000138, "Member 'FRigVMGraphFunctionHeader::Layout' has a wrong offset!");
...
public:
	...
	int32                                         FirstInstruction;                                  // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LastInstruction;                                   // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FRigVMBranchInfo, LastInstruction) == 0x000014, "Member 'FRigVMBranchInfo::LastInstruction' has a wrong offset!");
...
public:
	...
	struct FTopLevelAssetPath                     PublicContextAssetPath;                            // 0x0048(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FRigVMByteCode) == 0x0000A8, "Wrong size on FRigVMByteCode");
...
{
public:
	struct FRigVMByteCode                         ByteCode;                                          // 0x0000(0x00A8)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FName>                           FunctionNames;                                     // 0x00A8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> WorkPropertyDescriptions;                          // 0x00B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> WorkPropertyPathDescriptions;                      // 0x00C8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> LiteralPropertyDescriptions;                       // 0x00D8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> LiteralPropertyPathDescriptions;                   // 0x00E8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> DebugPropertyDescriptions;                         // 0x00F8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> DebugPropertyPathDescriptions;                     // 0x0108(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyDescription> ExternalPropertyDescriptions;                      // 0x0118(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FRigVMFunctionCompilationPropertyPath> ExternalPropertyPathDescriptions;                  // 0x0128(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<int32, class FName>                      ExternalRegisterIndexToVariable;                   // 0x0138(0x0050)(NativeAccessSpecifierPublic)
	TMap<class FString, struct FRigVMOperand>     Operands;                                          // 0x0188(0x0050)(NativeAccessSpecifierPublic)
	uint32                                        Hash;                                              // 0x01D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEncounteredSurpressedErrors;                      // 0x01DC(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1DD[0x53];                                     // 0x01DD(0x0053)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigVMFunctionCompilationData) == 0x000008, "Wrong alignment on FRigVMFunctionCompilationData");
static_assert(sizeof(FRigVMFunctionCompilationData) == 0x000230, "Wrong size on FRigVMFunctionCompilationData");
...
static_assert(offsetof(FRigVMFunctionCompilationData, FunctionNames) == 0x0000A8, "Member 'FRigVMFunctionCompilationData::FunctionNames' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, WorkPropertyDescriptions) == 0x0000B8, "Member 'FRigVMFunctionCompilationData::WorkPropertyDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, WorkPropertyPathDescriptions) == 0x0000C8, "Member 'FRigVMFunctionCompilationData::WorkPropertyPathDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, LiteralPropertyDescriptions) == 0x0000D8, "Member 'FRigVMFunctionCompilationData::LiteralPropertyDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, LiteralPropertyPathDescriptions) == 0x0000E8, "Member 'FRigVMFunctionCompilationData::LiteralPropertyPathDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, DebugPropertyDescriptions) == 0x0000F8, "Member 'FRigVMFunctionCompilationData::DebugPropertyDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, DebugPropertyPathDescriptions) == 0x000108, "Member 'FRigVMFunctionCompilationData::DebugPropertyPathDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalPropertyDescriptions) == 0x000118, "Member 'FRigVMFunctionCompilationData::ExternalPropertyDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalPropertyPathDescriptions) == 0x000128, "Member 'FRigVMFunctionCompilationData::ExternalPropertyPathDescriptions' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, ExternalRegisterIndexToVariable) == 0x000138, "Member 'FRigVMFunctionCompilationData::ExternalRegisterIndexToVariable' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, Operands) == 0x000188, "Member 'FRigVMFunctionCompilationData::Operands' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, Hash) == 0x0001D8, "Member 'FRigVMFunctionCompilationData::Hash' has a wrong offset!");
static_assert(offsetof(FRigVMFunctionCompilationData, bEncounteredSurpressedErrors) == 0x0001DC, "Member 'FRigVMFunctionCompilationData::bEncounteredSurpressedErrors' has a wrong offset!");
...
{
public:
	struct FRigVMGraphFunctionHeader              Header;                                            // 0x0000(0x01E8)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMFunctionCompilationData          CompilationData;                                   // 0x01E8(0x0230)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SerializedCollapsedNode;                           // 0x0418(0x0010)(ZeroConstructor, Deprecated, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMObjectArchive                    CollapseNodeArchive;                               // 0x0428(0x0020)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMGraphFunctionData) == 0x000008, "Wrong alignment on FRigVMGraphFunctionData");
static_assert(sizeof(FRigVMGraphFunctionData) == 0x000448, "Wrong size on FRigVMGraphFunctionData");
static_assert(offsetof(FRigVMGraphFunctionData, Header) == 0x000000, "Member 'FRigVMGraphFunctionData::Header' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, CompilationData) == 0x0001E8, "Member 'FRigVMGraphFunctionData::CompilationData' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, SerializedCollapsedNode) == 0x000418, "Member 'FRigVMGraphFunctionData::SerializedCollapsedNode' has a wrong offset!");
static_assert(offsetof(FRigVMGraphFunctionData, CollapseNodeArchive) == 0x000428, "Member 'FRigVMGraphFunctionData::CollapseNodeArchive' has a wrong offset!");
...
public:
	...
	class FName                                   BlockToRun;                                        // 0x0420(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, TRUE_0) == 0x000120, "Member 'FRigVMFunction_ControlFlowBranch::TRUE_0' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ControlFlowBranch, FALSE_0) == 0x000220, "Member 'FRigVMFunction_ControlFlowBranch::FALSE_0' has a wrong offset!");
...
public:
	...
	class FName                                   Space;                                             // 0x0044(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   Space;                                             // 0x004C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTransform                             WorldOffset;                                       // 0x0050(0x0060)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnabled;                                          // 0x00B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0xF];                                       // 0x00B1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigVMFunction_DebugPointMutable) == 0x000010, "Wrong alignment on FRigVMFunction_DebugPointMutable");
static_assert(sizeof(FRigVMFunction_DebugPointMutable) == 0x0000C0, "Wrong size on FRigVMFunction_DebugPointMutable");
...
static_assert(offsetof(FRigVMFunction_DebugPointMutable, WorldOffset) == 0x000050, "Member 'FRigVMFunction_DebugPointMutable::WorldOffset' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_DebugPointMutable, bEnabled) == 0x0000B0, "Member 'FRigVMFunction_DebugPointMutable::bEnabled' has a wrong offset!");
...
public:
	...
	class FName                                   Space;                                             // 0x0098(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   Space;                                             // 0x00A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   BoneSpace;                                         // 0x0044(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	class FName                                   BlockToRun;                                        // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         Ratio;                                             // 0x001C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRigVMExecuteContext                   Completed;                                         // 0x0020(0x0100)(Edit, BlueprintVisible, BlueprintReadOnly, Transient, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMFunction_ForLoopCount) == 0x000010, "Wrong alignment on FRigVMFunction_ForLoopCount");
static_assert(sizeof(FRigVMFunction_ForLoopCount) == 0x000120, "Wrong size on FRigVMFunction_ForLoopCount");
...
static_assert(offsetof(FRigVMFunction_ForLoopCount, Count) == 0x000014, "Member 'FRigVMFunction_ForLoopCount::Count' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Index) == 0x000018, "Member 'FRigVMFunction_ForLoopCount::Index' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Ratio) == 0x00001C, "Member 'FRigVMFunction_ForLoopCount::Ratio' has a wrong offset!");
static_assert(offsetof(FRigVMFunction_ForLoopCount, Completed) == 0x000020, "Member 'FRigVMFunction_ForLoopCount::Completed' has a wrong offset!");
...
public:
	...
	class FName                                   EventName;                                         // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Transient, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigVMFunction_UserDefinedEvent) == 0x000008, "Wrong alignment on FRigVMFunction_UserDefinedEvent");
...
static_assert(alignof(FRigVMFunction_MathTransformMutableBase) == 0x000008, "Wrong alignment on FRigVMFunction_MathTransformMutableBase");
