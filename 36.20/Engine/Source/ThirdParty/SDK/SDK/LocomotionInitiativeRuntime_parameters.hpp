...
static_assert(offsetof(FortPlayerMotionMatchingLocomotionAnimInstance_OnUpdateIdleBreaks, Context) == 0x000000, "Member 'FortPlayerMotionMatchingLocomotionAnimInstance_OnUpdateIdleBreaks::Context' has a wrong offset!");
static_assert(offsetof(FortPlayerMotionMatchingLocomotionAnimInstance_OnUpdateIdleBreaks, Node) == 0x000010, "Member 'FortPlayerMotionMatchingLocomotionAnimInstance_OnUpdateIdleBreaks::Node' has a wrong offset!");
