...
static_assert(offsetof(FGameInputRawDeviceReportData, bIgnoreAnalogInputDeviceScopeForThisRawReport) == 0x000004, "Member 'FGameInputRawDeviceReportData::bIgnoreAnalogInputDeviceScopeForThisRawReport' has a wrong offset!");
static_assert(offsetof(FGameInputRawDeviceReportData, TranslationBehavior) == 0x000005, "Member 'FGameInputRawDeviceReportData::TranslationBehavior' has a wrong offset!");
static_assert(offsetof(FGameInputRawDeviceReportData, AnalogDeadzone) == 0x000006, "Member 'FGameInputRawDeviceReportData::AnalogDeadzone' has a wrong offset!");
