...
static_assert(sizeof(FFortLandingPageDefenderSummaryInfo) == 0x000028, "Wrong size on FFortLandingPageDefenderSummaryInfo");
...
static_assert(offsetof(FFortLandingPageDefenderSummaryInfo, TheaterUniqueId) == 0x000018, "Member 'FFortLandingPageDefenderSummaryInfo::TheaterUniqueId' has a wrong offset!");
...
static_assert(sizeof(FFortRefundDescriptionsData) == 0x000038, "Wrong size on FFortRefundDescriptionsData");
...
static_assert(sizeof(FFortSurvivorSquadSelectorButtonSummaryStats) == 0x000098, "Wrong size on FFortSurvivorSquadSelectorButtonSummaryStats");
...
static_assert(sizeof(FFortSurvivorSquadSelectorButtonPersonalityMatches) == 0x000430, "Wrong size on FFortSurvivorSquadSelectorButtonPersonalityMatches");
...
public:
	...
	class FText                                   MagnitudeText;                                     // 0x0420(0x0010)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   AttributeDisplayName;                              // 0x0430(0x0010)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	int32                                         NumMembersMeetingCriteria;                         // 0x0440(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumMembersRequired;                                // 0x0444(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortUISurvivorSquadMatchType                 MatchType;                                         // 0x0448(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortBuffState                                PreviewEffect;                                     // 0x0449(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortUISurvivorSquadStatMatch) == 0x000450, "Wrong size on FFortUISurvivorSquadStatMatch");
...
static_assert(offsetof(FFortUISurvivorSquadStatMatch, MagnitudeText) == 0x000420, "Member 'FFortUISurvivorSquadStatMatch::MagnitudeText' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, AttributeDisplayName) == 0x000430, "Member 'FFortUISurvivorSquadStatMatch::AttributeDisplayName' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersMeetingCriteria) == 0x000440, "Member 'FFortUISurvivorSquadStatMatch::NumMembersMeetingCriteria' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, NumMembersRequired) == 0x000444, "Member 'FFortUISurvivorSquadStatMatch::NumMembersRequired' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, MatchType) == 0x000448, "Member 'FFortUISurvivorSquadStatMatch::MatchType' has a wrong offset!");
static_assert(offsetof(FFortUISurvivorSquadStatMatch, PreviewEffect) == 0x000449, "Member 'FFortUISurvivorSquadStatMatch::PreviewEffect' has a wrong offset!");
...
static_assert(sizeof(FHomebaseNodeDisplayData) == 0x000070, "Wrong size on FHomebaseNodeDisplayData");
static_assert(offsetof(FHomebaseNodeDisplayData, Title) == 0x000008, "Member 'FHomebaseNodeDisplayData::Title' has a wrong offset!");
static_assert(offsetof(FHomebaseNodeDisplayData, Description) == 0x000018, "Member 'FHomebaseNodeDisplayData::Description' has a wrong offset!");
static_assert(offsetof(FHomebaseNodeDisplayData, LargePreviewImage) == 0x000028, "Member 'FHomebaseNodeDisplayData::LargePreviewImage' has a wrong offset!");
static_assert(offsetof(FHomebaseNodeDisplayData, SmallPreviewImage) == 0x000048, "Member 'FHomebaseNodeDisplayData::SmallPreviewImage' has a wrong offset!");
static_assert(offsetof(FHomebaseNodeDisplayData, PreviewVideoMediaSource) == 0x000068, "Member 'FHomebaseNodeDisplayData::PreviewVideoMediaSource' has a wrong offset!");
