...
static_assert(sizeof(UMassVisualizationTrait) == 0x000150, "Wrong size on UMassVisualizationTrait");
...
static_assert(offsetof(UMassVisualizationTrait, bAllowServerSideVisualization) == 0x000148, "Member 'UMassVisualizationTrait::bAllowServerSideVisualization' has a wrong offset!");
...
static_assert(sizeof(UMassMovableVisualizationTrait) == 0x000150, "Wrong size on UMassMovableVisualizationTrait");
...
static_assert(sizeof(UMassStationaryVisualizationTrait) == 0x000150, "Wrong size on UMassStationaryVisualizationTrait");
...
static_assert(sizeof(UMassVisualizationComponent) == 0x000218, "Wrong size on UMassVisualizationComponent");
static_assert(offsetof(UMassVisualizationComponent, InstancedStaticMeshInfos) == 0x0000B8, "Member 'UMassVisualizationComponent::InstancedStaticMeshInfos' has a wrong offset!");
...
{
public:
	class UMassVisualizationComponent*            VisComponent;                                      // 0x02A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMassVisualizer) == 0x0002B0, "Wrong size on AMassVisualizer");
static_assert(offsetof(AMassVisualizer, VisComponent) == 0x0002A8, "Member 'AMassVisualizer::VisComponent' has a wrong offset!");
