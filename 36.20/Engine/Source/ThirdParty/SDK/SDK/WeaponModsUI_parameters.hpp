...
static_assert(sizeof(AthenaLastKillerWeaponModsInfo_SetKillerWeaponMods) == 0x000018, "Wrong size on AthenaLastKillerWeaponModsInfo_SetKillerWeaponMods");
...
static_assert(offsetof(AthenaLastKillerWeaponModsInfo_SetKillerWeaponMods, bShouldShowMods) == 0x000010, "Member 'AthenaLastKillerWeaponModsInfo_SetKillerWeaponMods::bShouldShowMods' has a wrong offset!");
...
static_assert(alignof(AthenaMarkerDetailsExtensionWeaponMods_SetModInfo) == 0x000008, "Wrong alignment on AthenaMarkerDetailsExtensionWeaponMods_SetModInfo");
static_assert(sizeof(AthenaMarkerDetailsExtensionWeaponMods_SetModInfo) == 0x000010, "Wrong size on AthenaMarkerDetailsExtensionWeaponMods_SetModInfo");
static_assert(offsetof(AthenaMarkerDetailsExtensionWeaponMods_SetModInfo, ModSlot) == 0x000000, "Member 'AthenaMarkerDetailsExtensionWeaponMods_SetModInfo::ModSlot' has a wrong offset!");
...
static_assert(sizeof(AthenaPickupIndicatorWeaponMods_SetItemModifiedWeaponName) == 0x000010, "Wrong size on AthenaPickupIndicatorWeaponMods_SetItemModifiedWeaponName");
...
static_assert(alignof(AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals) == 0x000008, "Wrong alignment on AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals");
static_assert(sizeof(AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals) == 0x000010, "Wrong size on AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals");
static_assert(offsetof(AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals, ModSlots) == 0x000000, "Member 'AthenaQuickBarSlotWeaponModsIndicator_UpdateModVisuals::ModSlots' has a wrong offset!");
