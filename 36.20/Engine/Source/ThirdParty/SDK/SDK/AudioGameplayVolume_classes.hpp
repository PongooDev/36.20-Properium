...
static_assert(sizeof(UAudioGameplayVolumeMutator) == 0x0000C8, "Wrong size on UAudioGameplayVolumeMutator");
static_assert(offsetof(UAudioGameplayVolumeMutator, Priority) == 0x0000C0, "Member 'UAudioGameplayVolumeMutator::Priority' has a wrong offset!");
...
static_assert(sizeof(UAttenuationVolumeComponent) == 0x0000D8, "Wrong size on UAttenuationVolumeComponent");
static_assert(offsetof(UAttenuationVolumeComponent, ExteriorVolume) == 0x0000C8, "Member 'UAttenuationVolumeComponent::ExteriorVolume' has a wrong offset!");
static_assert(offsetof(UAttenuationVolumeComponent, ExteriorTime) == 0x0000CC, "Member 'UAttenuationVolumeComponent::ExteriorTime' has a wrong offset!");
static_assert(offsetof(UAttenuationVolumeComponent, InteriorVolume) == 0x0000D0, "Member 'UAttenuationVolumeComponent::InteriorVolume' has a wrong offset!");
static_assert(offsetof(UAttenuationVolumeComponent, InteriorTime) == 0x0000D4, "Member 'UAttenuationVolumeComponent::InteriorTime' has a wrong offset!");
...
public:
	...
	class UAudioGameplayVolumeProxy*              Proxy;                                             // 0x00E0(0x0008)(Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAudioGameplayVolumeComponent) == 0x0000E8, "Wrong size on UAudioGameplayVolumeComponent");
static_assert(offsetof(UAudioGameplayVolumeComponent, OnProxyEnter) == 0x0000C0, "Member 'UAudioGameplayVolumeComponent::OnProxyEnter' has a wrong offset!");
static_assert(offsetof(UAudioGameplayVolumeComponent, OnProxyExit) == 0x0000D0, "Member 'UAudioGameplayVolumeComponent::OnProxyExit' has a wrong offset!");
static_assert(offsetof(UAudioGameplayVolumeComponent, Proxy) == 0x0000E0, "Member 'UAudioGameplayVolumeComponent::Proxy' has a wrong offset!");
...
static_assert(sizeof(UAudioGameplayVolumeComponentBase) == 0x0000C8, "Wrong size on UAudioGameplayVolumeComponentBase");
...
{
public:
	TArray<class UPrimitiveComponent*>            Primitives;                                        // 0x0048(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAGVPrimitiveComponentProxy, Primitives) == 0x000048, "Member 'UAGVPrimitiveComponentProxy::Primitives' has a wrong offset!");
...
static_assert(sizeof(UFilterVolumeComponent) == 0x0000D8, "Wrong size on UFilterVolumeComponent");
static_assert(offsetof(UFilterVolumeComponent, ExteriorLPF) == 0x0000C8, "Member 'UFilterVolumeComponent::ExteriorLPF' has a wrong offset!");
static_assert(offsetof(UFilterVolumeComponent, ExteriorLPFTime) == 0x0000CC, "Member 'UFilterVolumeComponent::ExteriorLPFTime' has a wrong offset!");
static_assert(offsetof(UFilterVolumeComponent, InteriorLPF) == 0x0000D0, "Member 'UFilterVolumeComponent::InteriorLPF' has a wrong offset!");
static_assert(offsetof(UFilterVolumeComponent, InteriorLPFTime) == 0x0000D4, "Member 'UFilterVolumeComponent::InteriorLPFTime' has a wrong offset!");
...
static_assert(sizeof(UReverbVolumeComponent) == 0x0000E8, "Wrong size on UReverbVolumeComponent");
static_assert(offsetof(UReverbVolumeComponent, ReverbSettings) == 0x0000C8, "Member 'UReverbVolumeComponent::ReverbSettings' has a wrong offset!");
...
static_assert(sizeof(USubmixOverrideVolumeComponent) == 0x0000D8, "Wrong size on USubmixOverrideVolumeComponent");
static_assert(offsetof(USubmixOverrideVolumeComponent, SubmixOverrideSettings) == 0x0000C8, "Member 'USubmixOverrideVolumeComponent::SubmixOverrideSettings' has a wrong offset!");
...
static_assert(sizeof(USubmixSendVolumeComponent) == 0x0000D8, "Wrong size on USubmixSendVolumeComponent");
static_assert(offsetof(USubmixSendVolumeComponent, SubmixSendSettings) == 0x0000C8, "Member 'USubmixSendVolumeComponent::SubmixSendSettings' has a wrong offset!");
