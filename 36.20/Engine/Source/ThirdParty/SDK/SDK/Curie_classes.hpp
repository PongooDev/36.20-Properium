...
{
public:
	TSubclassOf<class UCurieComponent>            CurieComponentClass;                               // 0x00B8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   CurieManagerRegistryName;                          // 0x00C0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   MaterialDataRegistryName;                          // 0x00C4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   ElementDataRegistryName;                           // 0x00C8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   EntityStateDataRegistryName;                       // 0x00CC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_D0[0x298];                                     // 0x00D0(0x0298)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FGameplayTag, class UCurieElementAllocationHandler*> ElementAllocationHandlers;                         // 0x0368(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementAttachHandlersContainer> ElementAttachmentHandlers;                         // 0x03B8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementAttachConditionHandlersContainer> ElementAttachmentConditionHandlers;                // 0x0408(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FCurieElementPairKey, struct FCurieElementInteractWithElementHandlersContainer> ElementInteractWithElementHandlers;                // 0x0458(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementInteractWithMaterialHandlersContainer> ElementInteractWithMaterialHandlers;               // 0x04A8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TMap<struct FGameplayTag, struct FCurieElementInteractWithContainerHandlersContainer> ElementInteractWithContainerHandlers;              // 0x04F8(0x0050)(Transient, NativeAccessSpecifierPrivate)
	TArray<class UCurieManagerComponent*>         CurieManagerComponents;                            // 0x0548(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_558[0xF0];                                     // 0x0558(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCurieManager) == 0x000648, "Wrong size on UCurieManager");
static_assert(offsetof(UCurieManager, CurieComponentClass) == 0x0000B8, "Member 'UCurieManager::CurieComponentClass' has a wrong offset!");
static_assert(offsetof(UCurieManager, CurieManagerRegistryName) == 0x0000C0, "Member 'UCurieManager::CurieManagerRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, MaterialDataRegistryName) == 0x0000C4, "Member 'UCurieManager::MaterialDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementDataRegistryName) == 0x0000C8, "Member 'UCurieManager::ElementDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, EntityStateDataRegistryName) == 0x0000CC, "Member 'UCurieManager::EntityStateDataRegistryName' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAllocationHandlers) == 0x000368, "Member 'UCurieManager::ElementAllocationHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentHandlers) == 0x0003B8, "Member 'UCurieManager::ElementAttachmentHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementAttachmentConditionHandlers) == 0x000408, "Member 'UCurieManager::ElementAttachmentConditionHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithElementHandlers) == 0x000458, "Member 'UCurieManager::ElementInteractWithElementHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithMaterialHandlers) == 0x0004A8, "Member 'UCurieManager::ElementInteractWithMaterialHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, ElementInteractWithContainerHandlers) == 0x0004F8, "Member 'UCurieManager::ElementInteractWithContainerHandlers' has a wrong offset!");
static_assert(offsetof(UCurieManager, CurieManagerComponents) == 0x000548, "Member 'UCurieManager::CurieManagerComponents' has a wrong offset!");
