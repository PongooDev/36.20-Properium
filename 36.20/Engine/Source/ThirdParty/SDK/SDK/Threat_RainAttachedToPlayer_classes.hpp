...
static_assert(sizeof(AThreat_RainAttachedToPlayer_C) == 0x0002B8, "Wrong size on AThreat_RainAttachedToPlayer_C");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, ParticleSystem) == 0x0002A8, "Member 'AThreat_RainAttachedToPlayer_C::ParticleSystem' has a wrong offset!");
static_assert(offsetof(AThreat_RainAttachedToPlayer_C, DefaultSceneRoot) == 0x0002B0, "Member 'AThreat_RainAttachedToPlayer_C::DefaultSceneRoot' has a wrong offset!");
