...
void UFortAccoladeStageListEntry::BP_PopulateAchievedCount(int32 AchievedCount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_PopulateAchievedCount");
...
void UPinnedAccoladeWidget::BP_PopulateAccoladeInfo(const class FText& Description, int32 Achieved, int32 Total)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_PopulateAccoladeInfo");
...
void UFortPlayerAccoladeCollectionListEntry::BP_OnPinnedChanged(const bool bPinned)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_OnPinnedChanged");
...
void UFortPlayerAccoladeCollectionListEntry::BP_OnSelectionSuppressionChanged(const bool bShouldBeSuppressed)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_OnSelectionSuppressionChanged");
...
void UFortPlayerAccoladeCollectionListEntry::BP_UpdateAccoladeTier(EFortAccoladeTierType Tier)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_UpdateAccoladeTier");
...
void UFortPlayerAccoladeCollectionListEntry::BP_UpdateCompletedCount(int32 CompletedCount)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_UpdateCompletedCount");
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bLoadingInProgress                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortPlayerAccoladeCollectionScreenContainer::BP_OnLoadingStatusChanged(bool bLoadingInProgress)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("BP_OnLoadingStatusChanged");

	Params::FortPlayerAccoladeCollectionScreenContainer_BP_OnLoadingStatusChanged Parms{};

	Parms.bLoadingInProgress = bLoadingInProgress;
...
void UFortPlayerAccoladeCollectionScreenContainer::BP_PopulateProgress(int32 Current, int32 Total)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_PopulateProgress");
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                                    bShouldShow                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Current                                                (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   Max                                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortPlayerAccoladeCollectionScreenInfoOverlay::BP_PopulateCurrentProgress(const bool bShouldShow, const int32 Current, const int32 Max)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("BP_PopulateCurrentProgress");

	Params::FortPlayerAccoladeCollectionScreenInfoOverlay_BP_PopulateCurrentProgress Parms{};
...
void UFortPlayerAccoladeCollectionScreenInfoOverlay::BP_UpdateTrackButtonText(const bool bTracked)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_UpdateTrackButtonText");
