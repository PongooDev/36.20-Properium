...
static_assert(alignof(FOnVerseRuntimeErrorMessage) == 0x000008, "Wrong alignment on FOnVerseRuntimeErrorMessage");
static_assert(sizeof(FOnVerseRuntimeErrorMessage) == 0x000018, "Wrong size on FOnVerseRuntimeErrorMessage");
static_assert(offsetof(FOnVerseRuntimeErrorMessage, Timestamp) == 0x000000, "Member 'FOnVerseRuntimeErrorMessage::Timestamp' has a wrong offset!");
static_assert(offsetof(FOnVerseRuntimeErrorMessage, MessageStr) == 0x000008, "Member 'FOnVerseRuntimeErrorMessage::MessageStr' has a wrong offset!");
...
static_assert(alignof(FOnUnrecoverableErrorMessage) == 0x000008, "Wrong alignment on FOnUnrecoverableErrorMessage");
static_assert(sizeof(FOnUnrecoverableErrorMessage) == 0x000028, "Wrong size on FOnUnrecoverableErrorMessage");
static_assert(offsetof(FOnUnrecoverableErrorMessage, Timestamp) == 0x000000, "Member 'FOnUnrecoverableErrorMessage::Timestamp' has a wrong offset!");
static_assert(offsetof(FOnUnrecoverableErrorMessage, TitleStr) == 0x000008, "Member 'FOnUnrecoverableErrorMessage::TitleStr' has a wrong offset!");
static_assert(offsetof(FOnUnrecoverableErrorMessage, MessageStr) == 0x000018, "Member 'FOnUnrecoverableErrorMessage::MessageStr' has a wrong offset!");
...
static_assert(sizeof(FScriptDiagnosticMessage) == 0x000050, "Wrong size on FScriptDiagnosticMessage");
...
static_assert(offsetof(FScriptDiagnosticMessage, SourceLocation) == 0x000030, "Member 'FScriptDiagnosticMessage::SourceLocation' has a wrong offset!");
...
static_assert(sizeof(FScriptScreenLogMessage) == 0x000058, "Wrong size on FScriptScreenLogMessage");
static_assert(offsetof(FScriptScreenLogMessage, ScreenColor) == 0x000050, "Member 'FScriptScreenLogMessage::ScreenColor' has a wrong offset!");
static_assert(offsetof(FScriptScreenLogMessage, DisplayDuration) == 0x000054, "Member 'FScriptScreenLogMessage::DisplayDuration' has a wrong offset!");
