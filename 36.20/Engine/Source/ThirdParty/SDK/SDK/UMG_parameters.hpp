...
static_assert(alignof(UserWidget_OnTouchFirstMove) == 0x000008, "Wrong alignment on UserWidget_OnTouchFirstMove");
...
static_assert(alignof(WidgetAnimationHandleFunctionLibrary_GetUserTag) == 0x000008, "Wrong alignment on WidgetAnimationHandleFunctionLibrary_GetUserTag");
...
public:
	...
	class FName                                   InUserTag;                                         // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(WidgetAnimationHandleFunctionLibrary_SetUserTag) == 0x000008, "Wrong alignment on WidgetAnimationHandleFunctionLibrary_SetUserTag");
...
static_assert(alignof(SlateBlueprintLibrary_Vector_AbsoluteToLocal) == 0x000008, "Wrong alignment on SlateBlueprintLibrary_Vector_AbsoluteToLocal");
...
static_assert(alignof(SlateBlueprintLibrary_Vector_LocalToAbsolute) == 0x000008, "Wrong alignment on SlateBlueprintLibrary_Vector_LocalToAbsolute");
...
static_assert(alignof(EditableText_ToggleVirtualKeyboard) == 0x000001, "Wrong alignment on EditableText_ToggleVirtualKeyboard");
static_assert(sizeof(EditableText_ToggleVirtualKeyboard) == 0x000001, "Wrong size on EditableText_ToggleVirtualKeyboard");
static_assert(offsetof(EditableText_ToggleVirtualKeyboard, bShow) == 0x000000, "Member 'EditableText_ToggleVirtualKeyboard::bShow' has a wrong offset!");
...
static_assert(alignof(ScrollBox_SetAnalogMouseWheelKey) == 0x000008, "Wrong alignment on ScrollBox_SetAnalogMouseWheelKey");
...
static_assert(alignof(ScrollBox_GetAnalogMouseWheelKey) == 0x000008, "Wrong alignment on ScrollBox_GetAnalogMouseWheelKey");
...
static_assert(alignof(Viewport_GetViewProjectionMatrix) == 0x000010, "Wrong alignment on Viewport_GetViewProjectionMatrix");
...
static_assert(offsetof(WidgetBlueprintLibrary_DrawTextFormatted, Tint) == 0x000060, "Member 'WidgetBlueprintLibrary_DrawTextFormatted::Tint' has a wrong offset!");
