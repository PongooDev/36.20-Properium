...
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_IsNintendoSwitch_ReturnValue) == 0x000004, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_IsNintendoSwitch_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_IsNintendoSwitch_ReturnValue_1) == 0x000034, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_IsNintendoSwitch_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_IsNintendoSwitch_ReturnValue_2) == 0x000035, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_IsNintendoSwitch_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP, CallFunc_BooleanOR_ReturnValue_3) == 0x000036, "Member 'VaultCharacterLightingBP_C_ExecuteUbergraph_VaultCharacterLightingBP::CallFunc_BooleanOR_ReturnValue_3' has a wrong offset!");
