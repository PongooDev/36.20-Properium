...
// Function PlayerAnimOverrideLayerInterface.PlayerAnimOverrideLayerInterface_C.PreLegIK
// 0x0020 (0x0020 - 0x0000)
struct PlayerAnimOverrideLayerInterface_C_PreLegIK final
{
public:
	struct FPoseLink                              InPose;                                            // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
	struct FPoseLink                              PreLegIK_0;                                        // 0x0010(0x0010)(Parm, OutParm, NoDestructor)
};
static_assert(alignof(PlayerAnimOverrideLayerInterface_C_PreLegIK) == 0x000008, "Wrong alignment on PlayerAnimOverrideLayerInterface_C_PreLegIK");
static_assert(sizeof(PlayerAnimOverrideLayerInterface_C_PreLegIK) == 0x000020, "Wrong size on PlayerAnimOverrideLayerInterface_C_PreLegIK");
static_assert(offsetof(PlayerAnimOverrideLayerInterface_C_PreLegIK, InPose) == 0x000000, "Member 'PlayerAnimOverrideLayerInterface_C_PreLegIK::InPose' has a wrong offset!");
static_assert(offsetof(PlayerAnimOverrideLayerInterface_C_PreLegIK, PreLegIK_0) == 0x000010, "Member 'PlayerAnimOverrideLayerInterface_C_PreLegIK::PreLegIK_0' has a wrong offset!");
