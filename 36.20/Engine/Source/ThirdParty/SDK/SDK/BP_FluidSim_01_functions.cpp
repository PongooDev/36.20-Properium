...
void ABP_FluidSim_01_C::GetNormalRT(class UTextureRenderTarget2D** RT)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetNormalRT");
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UTextureRenderTarget2DArray*      WaterInfoTextureArray                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_FluidSim_01_C::WaterZoneTextureCreated(const class UTextureRenderTarget2DArray* WaterInfoTextureArray)
{
	static class UFunction* Func = nullptr;
	...
	Parms.WaterInfoTextureArray = WaterInfoTextureArray;
