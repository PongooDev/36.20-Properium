...
static_assert(offsetof(FortConversationOptionBrief_ConfigureBP, SelectedIndex) == 0x0000A0, "Member 'FortConversationOptionBrief_ConfigureBP::SelectedIndex' has a wrong offset!");
...
public:
	...
	struct FFortServiceTransactionInfo            TransactionInfo;                                   // 0x0008(0x0048)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortItemTransactionBrief_OnTransactionInfoReceived) == 0x000050, "Wrong size on FortItemTransactionBrief_OnTransactionInfoReceived");
...
static_assert(offsetof(FortItemTransactionBrief_OnTransactionInfoReceived, TransactionInfo) == 0x000008, "Member 'FortItemTransactionBrief_OnTransactionInfoReceived::TransactionInfo' has a wrong offset!");
...
static_assert(alignof(FortConversationMarker_OnEntityConversationComponentParticipantsChanged) == 0x000008, "Wrong alignment on FortConversationMarker_OnEntityConversationComponentParticipantsChanged");
static_assert(sizeof(FortConversationMarker_OnEntityConversationComponentParticipantsChanged) == 0x000020, "Wrong size on FortConversationMarker_OnEntityConversationComponentParticipantsChanged");
static_assert(offsetof(FortConversationMarker_OnEntityConversationComponentParticipantsChanged, ConversationComponent) == 0x000000, "Member 'FortConversationMarker_OnEntityConversationComponentParticipantsChanged::ConversationComponent' has a wrong offset!");
static_assert(offsetof(FortConversationMarker_OnEntityConversationComponentParticipantsChanged, Participants) == 0x000008, "Member 'FortConversationMarker_OnEntityConversationComponentParticipantsChanged::Participants' has a wrong offset!");
static_assert(offsetof(FortConversationMarker_OnEntityConversationComponentParticipantsChanged, bIsMaxParticipants) == 0x000018, "Member 'FortConversationMarker_OnEntityConversationComponentParticipantsChanged::bIsMaxParticipants' has a wrong offset!");
...
// Function FortniteConversationUI.FortConversationMarker.OnNonPlayerConversationSettingsChanged
// 0x0008 (0x0008 - 0x0000)
struct FortConversationMarker_OnNonPlayerConversationSettingsChanged final
{
public:
	class UFortNonPlayerConversationParticipantComponent* ConversationComponent;                             // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortConversationMarker_OnNonPlayerConversationSettingsChanged) == 0x000008, "Wrong alignment on FortConversationMarker_OnNonPlayerConversationSettingsChanged");
static_assert(sizeof(FortConversationMarker_OnNonPlayerConversationSettingsChanged) == 0x000008, "Wrong size on FortConversationMarker_OnNonPlayerConversationSettingsChanged");
static_assert(offsetof(FortConversationMarker_OnNonPlayerConversationSettingsChanged, ConversationComponent) == 0x000000, "Member 'FortConversationMarker_OnNonPlayerConversationSettingsChanged::ConversationComponent' has a wrong offset!");
...
static_assert(alignof(FortConversationMarker_OnParticipantNameSanitizationComplete) == 0x000008, "Wrong alignment on FortConversationMarker_OnParticipantNameSanitizationComplete");
static_assert(sizeof(FortConversationMarker_OnParticipantNameSanitizationComplete) == 0x000020, "Wrong size on FortConversationMarker_OnParticipantNameSanitizationComplete");
static_assert(offsetof(FortConversationMarker_OnParticipantNameSanitizationComplete, bSuccess) == 0x000000, "Member 'FortConversationMarker_OnParticipantNameSanitizationComplete::bSuccess' has a wrong offset!");
static_assert(offsetof(FortConversationMarker_OnParticipantNameSanitizationComplete, SanitizedEntries) == 0x000008, "Member 'FortConversationMarker_OnParticipantNameSanitizationComplete::SanitizedEntries' has a wrong offset!");
static_assert(offsetof(FortConversationMarker_OnParticipantNameSanitizationComplete, SanitizeID) == 0x000018, "Member 'FortConversationMarker_OnParticipantNameSanitizationComplete::SanitizeID' has a wrong offset!");
...
static_assert(offsetof(FortConversationMarker_SetIsAtMaxConversations, ConversationComponent) == 0x000000, "Member 'FortConversationMarker_SetIsAtMaxConversations::ConversationComponent' has a wrong offset!");
static_assert(offsetof(FortConversationMarker_SetIsAtMaxConversations, bIsAtMaxConversations) == 0x000008, "Member 'FortConversationMarker_SetIsAtMaxConversations::bIsAtMaxConversations' has a wrong offset!");
...
static_assert(offsetof(FortConversationMessageWidget_OnMainMessageSet, MessageBody) == 0x000010, "Member 'FortConversationMessageWidget_OnMainMessageSet::MessageBody' has a wrong offset!");
...
static_assert(alignof(FortDataDrivenServiceBrief_OnWarningMessageUpdated) == 0x000008, "Wrong alignment on FortDataDrivenServiceBrief_OnWarningMessageUpdated");
static_assert(sizeof(FortDataDrivenServiceBrief_OnWarningMessageUpdated) == 0x000010, "Wrong size on FortDataDrivenServiceBrief_OnWarningMessageUpdated");
static_assert(offsetof(FortDataDrivenServiceBrief_OnWarningMessageUpdated, WarningMessage) == 0x000000, "Member 'FortDataDrivenServiceBrief_OnWarningMessageUpdated::WarningMessage' has a wrong offset!");
...
static_assert(offsetof(FortHireBrief_BP_SetSpecializationIcon, ResourceObject) == 0x000000, "Member 'FortHireBrief_BP_SetSpecializationIcon::ResourceObject' has a wrong offset!");
...
static_assert(alignof(FortPlayerConversationUIComponent_OnMinigameReady) == 0x000008, "Wrong alignment on FortPlayerConversationUIComponent_OnMinigameReady");
static_assert(sizeof(FortPlayerConversationUIComponent_OnMinigameReady) == 0x000008, "Wrong size on FortPlayerConversationUIComponent_OnMinigameReady");
static_assert(offsetof(FortPlayerConversationUIComponent_OnMinigameReady, InMinigame) == 0x000000, "Member 'FortPlayerConversationUIComponent_OnMinigameReady::InMinigame' has a wrong offset!");
...
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, RarityData) == 0x000010, "Member 'FortQuestBrief_OnQuestInformationRecieved::RarityData' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, CategoryTag) == 0x000088, "Member 'FortQuestBrief_OnQuestInformationRecieved::CategoryTag' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, XPReward) == 0x00008C, "Member 'FortQuestBrief_OnQuestInformationRecieved::XPReward' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, MoneyReward) == 0x000090, "Member 'FortQuestBrief_OnQuestInformationRecieved::MoneyReward' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, TokenReward) == 0x000094, "Member 'FortQuestBrief_OnQuestInformationRecieved::TokenReward' has a wrong offset!");
static_assert(offsetof(FortQuestBrief_OnQuestInformationRecieved, TokenRewardIcon) == 0x000098, "Member 'FortQuestBrief_OnQuestInformationRecieved::TokenRewardIcon' has a wrong offset!");
...
static_assert(sizeof(FortTransactionStrip_OnTransactionInfoReceived) == 0x000048, "Wrong size on FortTransactionStrip_OnTransactionInfoReceived");
