...
{
public:
	struct FLiveLinkSubjectName                   ParentSubject;                                     // 0x0000(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ParentBone;                                        // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLiveLinkSubjectName                   ChildSubject;                                      // 0x0008(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ChildBone;                                         // 0x000C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FLiveLinkVirtualSubjectBoneAttachment) == 0x000050, "Wrong size on FLiveLinkVirtualSubjectBoneAttachment");
...
static_assert(offsetof(FLiveLinkVirtualSubjectBoneAttachment, ParentBone) == 0x000004, "Member 'FLiveLinkVirtualSubjectBoneAttachment::ParentBone' has a wrong offset!");
static_assert(offsetof(FLiveLinkVirtualSubjectBoneAttachment, ChildSubject) == 0x000008, "Member 'FLiveLinkVirtualSubjectBoneAttachment::ChildSubject' has a wrong offset!");
static_assert(offsetof(FLiveLinkVirtualSubjectBoneAttachment, ChildBone) == 0x00000C, "Member 'FLiveLinkVirtualSubjectBoneAttachment::ChildBone' has a wrong offset!");
static_assert(offsetof(FLiveLinkVirtualSubjectBoneAttachment, LocationOffset) == 0x000010, "Member 'FLiveLinkVirtualSubjectBoneAttachment::LocationOffset' has a wrong offset!");
static_assert(offsetof(FLiveLinkVirtualSubjectBoneAttachment, RotationOffset) == 0x000028, "Member 'FLiveLinkVirtualSubjectBoneAttachment::RotationOffset' has a wrong offset!");
