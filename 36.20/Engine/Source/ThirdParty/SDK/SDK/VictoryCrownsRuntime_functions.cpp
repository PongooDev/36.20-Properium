...
void UFortCheatManager_VictoryCrowns::VictoryCrownsGrantCrown(const int32 CrownLevel)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("VictoryCrownsGrantCrown");
...
const int32 UFortControllerComponent_VictoryCrowns::GetVictoryCrownLevel() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetVictoryCrownLevel");
...
bool UFortGameStateComponent_VictoryCrowns::GetVictoryCrownLevelFromItemTrackerGuid(int32* OutVictoryCrownLevel, const struct FGuid& VictoryCrownItemTrackerGuid) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetVictoryCrownLevelFromItemTrackerGuid");
