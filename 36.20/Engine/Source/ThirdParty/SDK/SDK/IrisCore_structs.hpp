...
public:
	...
	bool                                          bDynamicCreate;                                    // 0x0012(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FDataStreamDefinition, bDynamicCreate) == 0x000012, "Member 'FDataStreamDefinition::bDynamicCreate' has a wrong offset!");
...
static_assert(sizeof(FNetObjectGridFilterProfile) == 0x000008, "Wrong size on FNetObjectGridFilterProfile");
...
static_assert(offsetof(FNetObjectGridFilterProfile, FrameCountBeforeCulling) == 0x000004, "Member 'FNetObjectGridFilterProfile::FrameCountBeforeCulling' has a wrong offset!");
...
static_assert(offsetof(FObjectReplicationBridgeFilterConfig, FilterProfile) == 0x000008, "Member 'FObjectReplicationBridgeFilterConfig::FilterProfile' has a wrong offset!");
static_assert(offsetof(FObjectReplicationBridgeFilterConfig, bForceEnableOnAllInstances) == 0x00000C, "Member 'FObjectReplicationBridgeFilterConfig::bForceEnableOnAllInstances' has a wrong offset!");
...
public:
	class FName                                   ClassName;                                         // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EIrisAsyncLoadingPriority                     IrisAsyncLoadingPriority;                          // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FObjectReplicationBridgeAsyncLoadingClassConfig) == 0x000004, "Wrong alignment on FObjectReplicationBridgeAsyncLoadingClassConfig");
static_assert(sizeof(FObjectReplicationBridgeAsyncLoadingClassConfig) == 0x000008, "Wrong size on FObjectReplicationBridgeAsyncLoadingClassConfig");
static_assert(offsetof(FObjectReplicationBridgeAsyncLoadingClassConfig, ClassName) == 0x000000, "Member 'FObjectReplicationBridgeAsyncLoadingClassConfig::ClassName' has a wrong offset!");
static_assert(offsetof(FObjectReplicationBridgeAsyncLoadingClassConfig, IrisAsyncLoadingPriority) == 0x000004, "Member 'FObjectReplicationBridgeAsyncLoadingClassConfig::IrisAsyncLoadingPriority' has a wrong offset!");
...
static_assert(alignof(FRemoteObjectReferenceNetSerializerConfig) == 0x000008, "Wrong alignment on FRemoteObjectReferenceNetSerializerConfig");
...
static_assert(alignof(FRemoteObjectReferenceNetSerializationHelper) == 0x000008, "Wrong alignment on FRemoteObjectReferenceNetSerializationHelper");
...
static_assert(sizeof(FObjectScopeHysteresisProfile) == 0x000008, "Wrong size on FObjectScopeHysteresisProfile");
...
static_assert(offsetof(FObjectScopeHysteresisProfile, HysteresisFrameCount) == 0x000004, "Member 'FObjectScopeHysteresisProfile::HysteresisFrameCount' has a wrong offset!");
...
static_assert(sizeof(FReplicationStateDescriptorClassPushModelConfig) == 0x000004, "Wrong size on FReplicationStateDescriptorClassPushModelConfig");
