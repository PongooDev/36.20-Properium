...
static_assert(sizeof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry) == 0x000080, "Wrong size on TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry");
...
static_assert(offsetof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry, CallFunc_Percent_IntInt_ReturnValue) == 0x000050, "Member 'TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry, CallFunc_PlayAnimation_ReturnValue_1) == 0x000058, "Member 'TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000068, "Member 'TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry, K2Node_Select_Default) == 0x00006C, "Member 'TournamentPayoutThresholdEntry_C_ExecuteUbergraph_TournamentPayoutThresholdEntry::K2Node_Select_Default' has a wrong offset!");
