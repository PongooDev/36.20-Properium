...
public:
	...
	TArray<class FName>                           SupportedEventNames;                               // 0x0388(0x0010)(ZeroConstructor, AssetRegistrySearchable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URigVMBlueprintGeneratedClass) == 0x000398, "Wrong size on URigVMBlueprintGeneratedClass");
...
static_assert(offsetof(URigVMBlueprintGeneratedClass, SupportedEventNames) == 0x000388, "Member 'URigVMBlueprintGeneratedClass::SupportedEventNames' has a wrong offset!");
...
public:
	...
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0138(0x00A8)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1E0[0x8];                                      // 0x01E0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMInstructionArray                 Instructions;                                      // 0x01E8(0x0010)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(URigVM, Instructions) == 0x0001E8, "Member 'URigVM::Instructions' has a wrong offset!");
...
static_assert(sizeof(UDataAssetLink) == 0x000128, "Wrong size on UDataAssetLink");
static_assert(offsetof(UDataAssetLink, DataAsset) == 0x000100, "Member 'UDataAssetLink::DataAsset' has a wrong offset!");
static_assert(offsetof(UDataAssetLink, DataAssetCached) == 0x000120, "Member 'UDataAssetLink::DataAssetCached' has a wrong offset!");
...
{
public:
	TArray<struct FRigVMTag>                      VariantTags;                                       // 0x0030(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URigVMProjectSettings) == 0x000040, "Wrong size on URigVMProjectSettings");
static_assert(offsetof(URigVMProjectSettings, VariantTags) == 0x000030, "Member 'URigVMProjectSettings::VariantTags' has a wrong offset!");
