...
// Function Player_Goop_AnimBP.Player_Goop_AnimBP_C.ItemIdleOverride
// 0x0020 (0x0020 - 0x0000)
struct Player_Goop_AnimBP_C_ItemIdleOverride final
{
public:
...
static_assert(alignof(Player_Goop_AnimBP_C_ItemIdleOverride) == 0x000008, "Wrong alignment on Player_Goop_AnimBP_C_ItemIdleOverride");
static_assert(sizeof(Player_Goop_AnimBP_C_ItemIdleOverride) == 0x000020, "Wrong size on Player_Goop_AnimBP_C_ItemIdleOverride");
static_assert(offsetof(Player_Goop_AnimBP_C_ItemIdleOverride, InPose_Idle) == 0x000000, "Member 'Player_Goop_AnimBP_C_ItemIdleOverride::InPose_Idle' has a wrong offset!");
static_assert(offsetof(Player_Goop_AnimBP_C_ItemIdleOverride, ItemIdleOverride_0) == 0x000010, "Member 'Player_Goop_AnimBP_C_ItemIdleOverride::ItemIdleOverride_0' has a wrong offset!");
...
// Function Player_Goop_AnimBP.Player_Goop_AnimBP_C.ItemPreAimOffsets
// 0x0020 (0x0020 - 0x0000)
struct Player_Goop_AnimBP_C_ItemPreAimOffsets final
{
public:
...
static_assert(alignof(Player_Goop_AnimBP_C_ItemPreAimOffsets) == 0x000008, "Wrong alignment on Player_Goop_AnimBP_C_ItemPreAimOffsets");
static_assert(sizeof(Player_Goop_AnimBP_C_ItemPreAimOffsets) == 0x000020, "Wrong size on Player_Goop_AnimBP_C_ItemPreAimOffsets");
static_assert(offsetof(Player_Goop_AnimBP_C_ItemPreAimOffsets, InPosePreAimOffsets) == 0x000000, "Member 'Player_Goop_AnimBP_C_ItemPreAimOffsets::InPosePreAimOffsets' has a wrong offset!");
static_assert(offsetof(Player_Goop_AnimBP_C_ItemPreAimOffsets, ItemPreAimOffsets_0) == 0x000010, "Member 'Player_Goop_AnimBP_C_ItemPreAimOffsets::ItemPreAimOffsets_0' has a wrong offset!");
...
static_assert(sizeof(Player_Goop_AnimBP_C_ItemUpperBody) == 0x000290, "Wrong size on Player_Goop_AnimBP_C_ItemUpperBody");
...
static_assert(offsetof(Player_Goop_AnimBP_C_ItemUpperBody, ItemUpperBody_0) == 0x000280, "Member 'Player_Goop_AnimBP_C_ItemUpperBody::ItemUpperBody_0' has a wrong offset!");
