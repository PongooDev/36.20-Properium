...
static_assert(sizeof(UControlRigShapeLibraryLink) == 0x000138, "Wrong size on UControlRigShapeLibraryLink");
...
static_assert(offsetof(UControlRigShapeLibraryLink, ShapeNames) == 0x000120, "Member 'UControlRigShapeLibraryLink::ShapeNames' has a wrong offset!");
static_assert(offsetof(UControlRigShapeLibraryLink, ShapeLibraryCached) == 0x000130, "Member 'UControlRigShapeLibraryLink::ShapeLibraryCached' has a wrong offset!");

// Class ControlRig.ControlRig
// 0x08F0 (0x0B68 - 0x0278)
...
public:
	...
	struct FRigModuleSettings                     RigModuleSettings;                                 // 0x0AD0(0x0078)(NativeAccessSpecifierPrivate)
	class FString                                 RigModulePrefix;                                   // 0x0B48(0x0010)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UControlRig) == 0x000B68, "Wrong size on UControlRig");
...
static_assert(offsetof(UControlRig, RigModulePrefix) == 0x000B48, "Member 'UControlRig::RigModulePrefix' has a wrong offset!");
...
{
public:
	TArray<struct FRigModuleInstance>             Modules;                                           // 0x0B68(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B78[0x20];                                     // 0x0B78(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigSettings                    ModularRigSettings;                                // 0x0B98(0x0001)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B99[0x7];                                      // 0x0B99(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FModularRigModel                       ModularRigModel;                                   // 0x0BA0(0x0100)(NativeAccessSpecifierPublic)
	TArray<struct FRigModuleExecutionElement>     ExecutionQueue;                                    // 0x0CA0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_CB0[0x58];                                     // 0x0CB0(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UModularRig) == 0x000D08, "Wrong size on UModularRig");
static_assert(offsetof(UModularRig, Modules) == 0x000B68, "Member 'UModularRig::Modules' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigSettings) == 0x000B98, "Member 'UModularRig::ModularRigSettings' has a wrong offset!");
static_assert(offsetof(UModularRig, ModularRigModel) == 0x000BA0, "Member 'UModularRig::ModularRigModel' has a wrong offset!");
static_assert(offsetof(UModularRig, ExecutionQueue) == 0x000CA0, "Member 'UModularRig::ExecutionQueue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_B3[0x1E9];                                     // 0x00B3(0x01E9)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         TransformStackIndex;                               // 0x029C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2A0[0x70];                                     // 0x02A0(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	class URigHierarchyController*                HierarchyController;                               // 0x0310(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_318[0x8];                                      // 0x0318(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UModularRigRuleManager*                 RuleManager;                                       // 0x0320(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_328[0x190];                                    // 0x0328(0x0190)(Fixing Size After Last Property [ Dumper-7 ])
	class URigHierarchy*                          HierarchyForCacheValidation;                       // 0x04B8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4C0[0x110];                                    // 0x04C0(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URigHierarchy) == 0x0005D0, "Wrong size on URigHierarchy");
...
static_assert(offsetof(URigHierarchy, TransformStackIndex) == 0x00029C, "Member 'URigHierarchy::TransformStackIndex' has a wrong offset!");
static_assert(offsetof(URigHierarchy, HierarchyController) == 0x000310, "Member 'URigHierarchy::HierarchyController' has a wrong offset!");
static_assert(offsetof(URigHierarchy, RuleManager) == 0x000320, "Member 'URigHierarchy::RuleManager' has a wrong offset!");
static_assert(offsetof(URigHierarchy, HierarchyForCacheValidation) == 0x0004B8, "Member 'URigHierarchy::HierarchyForCacheValidation' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_84[0xBC];                                      // 0x0084(0x00BC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(UTransformableControlHandle) == 0x000010, "Wrong alignment on UTransformableControlHandle");
...
static_assert(sizeof(UControlRigAnimInstance) == 0x0003E0, "Wrong size on UControlRigAnimInstance");
...
{
public:
	struct FSoftObjectPath                        PreviewSkeletalMesh;                               // 0x0398(0x0018)(ZeroConstructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bExposesAnimatableControls;                        // 0x03B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowMultipleInstances;                           // 0x03B1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UControlRigBlueprintGeneratedClass) == 0x0003B8, "Wrong size on UControlRigBlueprintGeneratedClass");
static_assert(offsetof(UControlRigBlueprintGeneratedClass, PreviewSkeletalMesh) == 0x000398, "Member 'UControlRigBlueprintGeneratedClass::PreviewSkeletalMesh' has a wrong offset!");
static_assert(offsetof(UControlRigBlueprintGeneratedClass, bExposesAnimatableControls) == 0x0003B0, "Member 'UControlRigBlueprintGeneratedClass::bExposesAnimatableControls' has a wrong offset!");
static_assert(offsetof(UControlRigBlueprintGeneratedClass, bAllowMultipleInstances) == 0x0003B1, "Member 'UControlRigBlueprintGeneratedClass::bAllowMultipleInstances' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5C0[0x100];                                    // 0x05C0(0x0100)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	TSoftObjectPtr<class UControlRig>             ControlRig;                                        // 0x02E8(0x0020)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class FName                                   ColorParameterName;                                // 0x0348(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	class FName                                   ControlName;                                       // 0x02CC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ShapeName;                                         // 0x02D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ColorParameterName;                                // 0x02D4(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D8[0x78];                                     // 0x02D8(0x0078)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCachedRigElement                      CachedIndex;                                       // 0x0350(0x0018)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSelected : 1;                                     // 0x0368(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bHovered : 1;                                      // 0x0368(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(AControlRigShapeActor) == 0x000380, "Wrong size on AControlRigShapeActor");
...
static_assert(offsetof(AControlRigShapeActor, ShapeName) == 0x0002D0, "Member 'AControlRigShapeActor::ShapeName' has a wrong offset!");
...
static_assert(offsetof(AControlRigShapeActor, CachedIndex) == 0x000350, "Member 'AControlRigShapeActor::CachedIndex' has a wrong offset!");
...
public:
	...
	struct FSoftObjectPath                        ControlRigObjectPath;                              // 0x0038(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        PreviewSkeletalMeshObjectPath;                     // 0x0050(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FControlRigReplayTracks                InputTracks;                                       // 0x0068(0x0178)(Edit, NativeAccessSpecifierPublic)
	struct FControlRigReplayTracks                OutputTracks;                                      // 0x01E0(0x0178)(Edit, NativeAccessSpecifierPublic)
	double                                        Tolerance;                                         // 0x0358(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidateHierarchyTopology;                        // 0x0360(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidatePose;                                     // 0x0361(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidateMetadata;                                 // 0x0362(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidateVariables;                                // 0x0363(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_364[0x4];                                      // 0x0364(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<int32>                                 FramesToSkip;                                      // 0x0368(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          EnableTest;                                        // 0x0378(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_379[0x5F];                                     // 0x0379(0x005F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UControlRigReplay) == 0x0003D8, "Wrong size on UControlRigReplay");
...
static_assert(offsetof(UControlRigReplay, PreviewSkeletalMeshObjectPath) == 0x000050, "Member 'UControlRigReplay::PreviewSkeletalMeshObjectPath' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, InputTracks) == 0x000068, "Member 'UControlRigReplay::InputTracks' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, OutputTracks) == 0x0001E0, "Member 'UControlRigReplay::OutputTracks' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, Tolerance) == 0x000358, "Member 'UControlRigReplay::Tolerance' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, bValidateHierarchyTopology) == 0x000360, "Member 'UControlRigReplay::bValidateHierarchyTopology' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, bValidatePose) == 0x000361, "Member 'UControlRigReplay::bValidatePose' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, bValidateMetadata) == 0x000362, "Member 'UControlRigReplay::bValidateMetadata' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, bValidateVariables) == 0x000363, "Member 'UControlRigReplay::bValidateVariables' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, FramesToSkip) == 0x000368, "Member 'UControlRigReplay::FramesToSkip' has a wrong offset!");
static_assert(offsetof(UControlRigReplay, EnableTest) == 0x000378, "Member 'UControlRigReplay::EnableTest' has a wrong offset!");
...
{
public:
	struct FControlRigTestDataFrame               Initial;                                           // 0x03D8(0x0108)(Edit, BlueprintVisible, BlueprintReadOnly, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FControlRigTestDataFrame>       InputFrames;                                       // 0x04E0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<struct FControlRigTestDataFrame>       OutputFrames;                                      // 0x04F0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	TArray<class FName>                           EventQueue;                                        // 0x0500(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UControlRigTestData) == 0x000518, "Wrong size on UControlRigTestData");
static_assert(offsetof(UControlRigTestData, Initial) == 0x0003D8, "Member 'UControlRigTestData::Initial' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, InputFrames) == 0x0004E0, "Member 'UControlRigTestData::InputFrames' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, OutputFrames) == 0x0004F0, "Member 'UControlRigTestData::OutputFrames' has a wrong offset!");
static_assert(offsetof(UControlRigTestData, EventQueue) == 0x000500, "Member 'UControlRigTestData::EventQueue' has a wrong offset!");
...
static_assert(sizeof(UAdditiveControlRig) == 0x000B78, "Wrong size on UAdditiveControlRig");
...
{
public:
	TArray<bool>                                  IsControlActive;                                   // 0x0B68(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	EControlRigFKRigExecuteMode                   ApplyMode;                                         // 0x0B78(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_B79[0x2F];                                     // 0x0B79(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UFKControlRig) == 0x000BA8, "Wrong size on UFKControlRig");
static_assert(offsetof(UFKControlRig, IsControlActive) == 0x000B68, "Member 'UFKControlRig::IsControlActive' has a wrong offset!");
static_assert(offsetof(UFKControlRig, ApplyMode) == 0x000B78, "Member 'UFKControlRig::ApplyMode' has a wrong offset!");
...
static_assert(sizeof(UControlRigLayerInstance) == 0x0003E0, "Wrong size on UControlRigLayerInstance");
...
public:
	...
	class FName                                   TrackName;                                         // 0x01D0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
