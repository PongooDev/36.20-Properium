...
void UWBP_UIKit_Transference_C::ExecuteUbergraph_WBP_UIKit_Transference(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("ExecuteUbergraph_WBP_UIKit_Transference");

	Params::WBP_UIKit_Transference_C_ExecuteUbergraph_WBP_UIKit_Transference Parms{};
...
void UWBP_UIKit_Transference_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_UIKit_Transference_C_PreConstruct Parms{};
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TSet<uint8>                             Compatible_Modes                                       (BlueprintVisible, BlueprintReadOnly, Parm)
...
void UWBP_UIKit_Transference_C::SetSize(const struct FVector2D& Size_0)
{
	static class UFunction* Func = nullptr;
