...
static_assert(offsetof(ConversationContextHelpers_CanConversationContinue, ReturnValue) == 0x000070, "Member 'ConversationContextHelpers_CanConversationContinue::ReturnValue' has a wrong offset!");
...
// Function CommonConversationRuntime.ConversationEntryPointNode.GetIdentifier
// 0x0010 (0x0010 - 0x0000)
struct ConversationEntryPointNode_GetIdentifier final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ConversationEntryPointNode_GetIdentifier) == 0x000008, "Wrong alignment on ConversationEntryPointNode_GetIdentifier");
static_assert(sizeof(ConversationEntryPointNode_GetIdentifier) == 0x000010, "Wrong size on ConversationEntryPointNode_GetIdentifier");
static_assert(offsetof(ConversationEntryPointNode_GetIdentifier, ReturnValue) == 0x000000, "Member 'ConversationEntryPointNode_GetIdentifier::ReturnValue' has a wrong offset!");
...
public:
	...
	class FString                                 EntryPointIdentifier;                              // 0x0030(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UConversationInstance*                  ReturnValue;                                       // 0x0040(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(ConversationLibrary_StartConversationFromGraph) == 0x000048, "Wrong size on ConversationLibrary_StartConversationFromGraph");
...
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, EntryPointIdentifier) == 0x000030, "Member 'ConversationLibrary_StartConversationFromGraph::EntryPointIdentifier' has a wrong offset!");
static_assert(offsetof(ConversationLibrary_StartConversationFromGraph, ReturnValue) == 0x000040, "Member 'ConversationLibrary_StartConversationFromGraph::ReturnValue' has a wrong offset!");
