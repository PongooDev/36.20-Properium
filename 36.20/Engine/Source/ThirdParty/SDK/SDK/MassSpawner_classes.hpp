...
public:
	...
	TArray<class UMassProcessor*>                 PostSpawnProcessors;                               // 0x02F8(0x0010)(ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AMassSpawner) == 0x000350, "Wrong size on AMassSpawner");
static_assert(offsetof(AMassSpawner, OnSpawningFinishedEvent) == 0x0002A8, "Member 'AMassSpawner::OnSpawningFinishedEvent' has a wrong offset!");
static_assert(offsetof(AMassSpawner, OnDespawningFinishedEvent) == 0x0002B8, "Member 'AMassSpawner::OnDespawningFinishedEvent' has a wrong offset!");
static_assert(offsetof(AMassSpawner, Count) == 0x0002C8, "Member 'AMassSpawner::Count' has a wrong offset!");
static_assert(offsetof(AMassSpawner, EntityTypes) == 0x0002D0, "Member 'AMassSpawner::EntityTypes' has a wrong offset!");
static_assert(offsetof(AMassSpawner, SpawnDataGenerators) == 0x0002E0, "Member 'AMassSpawner::SpawnDataGenerators' has a wrong offset!");
static_assert(offsetof(AMassSpawner, PostSpawnProcessors) == 0x0002F8, "Member 'AMassSpawner::PostSpawnProcessors' has a wrong offset!");
static_assert(offsetof(AMassSpawner, SpawningCountScale) == 0x000308, "Member 'AMassSpawner::SpawningCountScale' has a wrong offset!");
