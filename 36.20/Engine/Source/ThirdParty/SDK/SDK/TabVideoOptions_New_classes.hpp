...
static_assert(sizeof(UTabVideoOptions_New_C) == 0x0004A0, "Wrong size on UTabVideoOptions_New_C");
static_assert(offsetof(UTabVideoOptions_New_C, UberGraphFrame) == 0x000498, "Member 'UTabVideoOptions_New_C::UberGraphFrame' has a wrong offset!");
