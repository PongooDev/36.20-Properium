...
static_assert(sizeof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton) == 0x000028, "Wrong size on AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton");
...
static_assert(offsetof(AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton, CallFunc_PlayAnimationForward_ReturnValue) == 0x000018, "Member 'AthenaMatchmakingPlayButton_C_ExecuteUbergraph_AthenaMatchmakingPlayButton::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
