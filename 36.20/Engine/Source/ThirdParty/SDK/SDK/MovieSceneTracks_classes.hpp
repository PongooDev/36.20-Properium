...
#pragma pack(pop)
static_assert(alignof(UMovieSceneCommonAnimationTrack) == 0x000010, "Wrong alignment on UMovieSceneCommonAnimationTrack");
static_assert(sizeof(UMovieSceneCommonAnimationTrack) == 0x0001B0, "Wrong size on UMovieSceneCommonAnimationTrack");
...
public:
	uint8                                         Pad_108[0x8];                                      // 0x0108(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneSkeletalAnimationParams     Params_0;                                          // 0x0110(0x0150)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	class UAnimSequence*                          AnimSequence;                                      // 0x0260(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UAnimSequenceBase*                      Animation;                                         // 0x0268(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	class FName                                   SlotName;                                          // 0x0280(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_284[0x4];                                      // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                StartLocationOffset;                               // 0x0288(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FRotator                               StartRotationOffset;                               // 0x02A0(0x0018)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	class FName                                   MatchedBoneName;                                   // 0x02B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         bMatchWithPrevious : 1;                            // 0x02F0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMatchTranslation : 1;                             // 0x02F0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMatchIncludeZHeight : 1;                          // 0x02F0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMatchRotationYaw : 1;                             // 0x02F0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMatchRotationPitch : 1;                           // 0x02F0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bMatchRotationRoll : 1;                            // 0x02F0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bDebugForceTickPose : 1;                           // 0x02F0(0x0001)(BitIndex: 0x06, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_2F1[0x7];                                      // 0x02F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInstancedStruct                       MixedAnimationTarget;                              // 0x02F8(0x0010)(Edit, NativeAccessSpecifierPublic)
	int32                                         MixedAnimationPriority;                            // 0x0308(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, AnimSequence) == 0x000260, "Member 'UMovieSceneSkeletalAnimationSection::AnimSequence' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, Animation) == 0x000268, "Member 'UMovieSceneSkeletalAnimationSection::Animation' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartOffset) == 0x000270, "Member 'UMovieSceneSkeletalAnimationSection::StartOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, EndOffset) == 0x000274, "Member 'UMovieSceneSkeletalAnimationSection::EndOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, PlayRate) == 0x000278, "Member 'UMovieSceneSkeletalAnimationSection::PlayRate' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, SlotName) == 0x000280, "Member 'UMovieSceneSkeletalAnimationSection::SlotName' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartLocationOffset) == 0x000288, "Member 'UMovieSceneSkeletalAnimationSection::StartLocationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, StartRotationOffset) == 0x0002A0, "Member 'UMovieSceneSkeletalAnimationSection::StartRotationOffset' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MatchedBoneName) == 0x0002B8, "Member 'UMovieSceneSkeletalAnimationSection::MatchedBoneName' has a wrong offset!");
...
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MixedAnimationTarget) == 0x0002F8, "Member 'UMovieSceneSkeletalAnimationSection::MixedAnimationTarget' has a wrong offset!");
static_assert(offsetof(UMovieSceneSkeletalAnimationSection, MixedAnimationPriority) == 0x000308, "Member 'UMovieSceneSkeletalAnimationSection::MixedAnimationPriority' has a wrong offset!");
...
public:
	...
	struct FMovieScenePropertyBinding             PropertyBinding;                                   // 0x0118(0x000C)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_124[0x4];                                      // 0x0124(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMovieSceneSection*>             Sections;                                          // 0x0128(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieScenePropertyTrack) == 0x000138, "Wrong size on UMovieScenePropertyTrack");
...
static_assert(offsetof(UMovieScenePropertyTrack, Sections) == 0x000128, "Member 'UMovieScenePropertyTrack::Sections' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneRotatorTrack) == 0x000138, "Wrong size on UMovieSceneRotatorTrack");
...
static_assert(sizeof(UMovieSceneActorReferenceTrack) == 0x000140, "Wrong size on UMovieSceneActorReferenceTrack");
...
public:
	...
	class FName                                   LevelName;                                         // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneSpawnableActorBindingBase) == 0x000038, "Wrong size on UMovieSceneSpawnableActorBindingBase");
...
{
public:
	class AActor*                                 ActorTemplate;                                     // 0x0038(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneSpawnableActorBinding) == 0x000040, "Wrong size on UMovieSceneSpawnableActorBinding");
static_assert(offsetof(UMovieSceneSpawnableActorBinding, ActorTemplate) == 0x000038, "Member 'UMovieSceneSpawnableActorBinding::ActorTemplate' has a wrong offset!");
...
{
public:
	class UEnum*                                  Enum;                                              // 0x0138(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMovieSceneEnumTrack) == 0x000140, "Wrong size on UMovieSceneEnumTrack");
static_assert(offsetof(UMovieSceneEnumTrack, Enum) == 0x000138, "Member 'UMovieSceneEnumTrack::Enum' has a wrong offset!");
...
public:
	...
	class FName                                   AttachSocketName;                                  // 0x0138(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   AttachComponentName;                               // 0x013C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieScene3DAttachSection, AttachComponentName) == 0x00013C, "Member 'UMovieScene3DAttachSection::AttachComponentName' has a wrong offset!");
...
{
public:
	struct FMovieSceneActorReferenceData          ActorReferenceData;                                // 0x0108(0x0118)(NativeAccessSpecifierPrivate)
...
public:
	...
	struct FMovieSceneActorReferenceData          AttachActorData;                                   // 0x04E8(0x0118)(NativeAccessSpecifierPrivate)
	...
	class USoundAttenuation*                      AttenuationSettings;                               // 0x0608(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TDelegate<void(TArray<struct FSubtitleCue>& Subtitles, float CueDuration)> OnQueueSubtitles;                                  // 0x0610(0x000C)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UMovieSceneAudioSection, bLooping) == 0x000600, "Member 'UMovieSceneAudioSection::bLooping' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bSuppressSubtitles) == 0x000601, "Member 'UMovieSceneAudioSection::bSuppressSubtitles' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, bOverrideAttenuation) == 0x000602, "Member 'UMovieSceneAudioSection::bOverrideAttenuation' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, AttenuationSettings) == 0x000608, "Member 'UMovieSceneAudioSection::AttenuationSettings' has a wrong offset!");
static_assert(offsetof(UMovieSceneAudioSection, OnQueueSubtitles) == 0x000610, "Member 'UMovieSceneAudioSection::OnQueueSubtitles' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneStringTrack) == 0x000138, "Wrong size on UMovieSceneStringTrack");
...
{
public:
	TSubclassOf<class UObject>                    PropertyClass;                                     // 0x0138(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneObjectPropertyTrack) == 0x000140, "Wrong size on UMovieSceneObjectPropertyTrack");
static_assert(offsetof(UMovieSceneObjectPropertyTrack, PropertyClass) == 0x000138, "Member 'UMovieSceneObjectPropertyTrack::PropertyClass' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneFloatTrack) == 0x000138, "Wrong size on UMovieSceneFloatTrack");
...
static_assert(sizeof(UMovieSceneFadeTrack) == 0x000138, "Wrong size on UMovieSceneFadeTrack");
...
public:
	uint8                                         Pad_108[0x8];                                      // 0x0108(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneObjectPathChannel           MaterialChannel;                                   // 0x0110(0x0128)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneFloatVectorTrack) == 0x000140, "Wrong size on UMovieSceneFloatVectorTrack");
static_assert(offsetof(UMovieSceneFloatVectorTrack, NumChannelsUsed) == 0x000138, "Member 'UMovieSceneFloatVectorTrack::NumChannelsUsed' has a wrong offset!");
...
public:
	uint8                                         Pad_108[0x8];                                      // 0x0108(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMovieSceneObjectPathChannel           ObjectChannel;                                     // 0x0110(0x0128)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMovieSceneObjectPropertySection) == 0x000238, "Wrong size on UMovieSceneObjectPropertySection");
...
static_assert(sizeof(UMovieScene3DTransformTrack) == 0x000148, "Wrong size on UMovieScene3DTransformTrack");
static_assert(offsetof(UMovieScene3DTransformTrack, BlenderSystemClass) == 0x000140, "Member 'UMovieScene3DTransformTrack::BlenderSystemClass' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneBoolTrack) == 0x000140, "Wrong size on UMovieSceneBoolTrack");
...
static_assert(sizeof(UMovieSceneByteTrack) == 0x000140, "Wrong size on UMovieSceneByteTrack");
static_assert(offsetof(UMovieSceneByteTrack, Enum) == 0x000138, "Member 'UMovieSceneByteTrack::Enum' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneColorTrack) == 0x000140, "Wrong size on UMovieSceneColorTrack");
static_assert(offsetof(UMovieSceneColorTrack, bIsSlateColor) == 0x000138, "Member 'UMovieSceneColorTrack::bIsSlateColor' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneDoubleTrack) == 0x000138, "Wrong size on UMovieSceneDoubleTrack");
...
static_assert(sizeof(UMovieSceneEulerTransformTrack) == 0x000138, "Wrong size on UMovieSceneEulerTransformTrack");
...
static_assert(sizeof(UMovieSceneIntegerTrack) == 0x000138, "Wrong size on UMovieSceneIntegerTrack");
...
public:
	uint8                                         Pad_128[0x10];                                     // 0x0128(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	struct FComponentMaterialInfo                 MaterialInfo;                                      // 0x0138(0x000C)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMovieScenePrimitiveMaterialTrack) == 0x000148, "Wrong size on UMovieScenePrimitiveMaterialTrack");
static_assert(offsetof(UMovieScenePrimitiveMaterialTrack, MaterialInfo) == 0x000138, "Member 'UMovieScenePrimitiveMaterialTrack::MaterialInfo' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneSlomoTrack) == 0x000138, "Wrong size on UMovieSceneSlomoTrack");
...
static_assert(sizeof(UMovieSceneTransformTrack) == 0x000138, "Wrong size on UMovieSceneTransformTrack");
...
static_assert(sizeof(UMovieSceneDoubleVectorTrack) == 0x000140, "Wrong size on UMovieSceneDoubleVectorTrack");
static_assert(offsetof(UMovieSceneDoubleVectorTrack, NumChannelsUsed) == 0x000138, "Member 'UMovieSceneDoubleVectorTrack::NumChannelsUsed' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneVisibilityTrack) == 0x000138, "Wrong size on UMovieSceneVisibilityTrack");
