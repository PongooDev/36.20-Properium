...
// Parameters:
// struct FMotorcycleRuntimeBoostInfo      NewBoostInfo                                           (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void AFortMotorcycleVehicle::SetRuntimeBoostInfoOnServer(const struct FMotorcycleRuntimeBoostInfo& NewBoostInfo)
{
	static class UFunction* Func = nullptr;
	...
	Params::FortMotorcycleVehicle_SetRuntimeBoostInfoOnServer Parms{};

	Parms.NewBoostInfo = std::move(NewBoostInfo);
