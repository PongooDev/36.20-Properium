...
public:
	...
	TSoftObjectPtr<class UObject>                 TypeObject;                                        // 0x0008(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FOptimusDataTypeRef) == 0x000008, "Wrong alignment on FOptimusDataTypeRef");
static_assert(sizeof(FOptimusDataTypeRef) == 0x000028, "Wrong size on FOptimusDataTypeRef");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0028)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FOptimus_ShaderBinding) == 0x000008, "Wrong alignment on FOptimus_ShaderBinding");
static_assert(sizeof(FOptimus_ShaderBinding) == 0x000030, "Wrong size on FOptimus_ShaderBinding");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0030(0x0040)(Edit, NativeAccessSpecifierPublic)
	bool                                          bSupportAtomicIfCompatibleDataType;                // 0x0070(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSupportRead;                                      // 0x0071(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FOptimusParameterBinding) == 0x000078, "Wrong size on FOptimusParameterBinding");
...
static_assert(offsetof(FOptimusParameterBinding, DataDomain) == 0x000030, "Member 'FOptimusParameterBinding::DataDomain' has a wrong offset!");
static_assert(offsetof(FOptimusParameterBinding, bSupportAtomicIfCompatibleDataType) == 0x000070, "Member 'FOptimusParameterBinding::bSupportAtomicIfCompatibleDataType' has a wrong offset!");
static_assert(offsetof(FOptimusParameterBinding, bSupportRead) == 0x000071, "Member 'FOptimusParameterBinding::bSupportRead' has a wrong offset!");
...
public:
	...
	class FName                                   FunctionName;                                      // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Category;                                          // 0x0014(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FOptimusFunctionNodeGraphHeaderWithGuid) == 0x000018, "Wrong size on FOptimusFunctionNodeGraphHeaderWithGuid");
...
static_assert(offsetof(FOptimusFunctionNodeGraphHeaderWithGuid, Category) == 0x000014, "Member 'FOptimusFunctionNodeGraphHeaderWithGuid::Category' has a wrong offset!");
...
static_assert(sizeof(FOptimusValueIdentifier) == 0x000008, "Wrong size on FOptimusValueIdentifier");
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0000(0x0028)(NativeAccessSpecifierPublic)
	EOptimusValueUsage                            ValueUsage;                                        // 0x0028(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusValueContainerStruct           Value;                                             // 0x0030(0x0010)(NativeAccessSpecifierPublic)
	struct FShaderValueContainer                  ShaderValue;                                       // 0x0040(0x0020)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FOptimusValueDescription) == 0x000008, "Wrong alignment on FOptimusValueDescription");
static_assert(sizeof(FOptimusValueDescription) == 0x000060, "Wrong size on FOptimusValueDescription");
...
static_assert(offsetof(FOptimusValueDescription, ValueUsage) == 0x000028, "Member 'FOptimusValueDescription::ValueUsage' has a wrong offset!");
static_assert(offsetof(FOptimusValueDescription, Value) == 0x000030, "Member 'FOptimusValueDescription::Value' has a wrong offset!");
static_assert(offsetof(FOptimusValueDescription, ShaderValue) == 0x000040, "Member 'FOptimusValueDescription::ShaderValue' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UOptimusDeformer>        DeformerGraph;                                     // 0x0018(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FRigVMTrait_OptimusDeformer) == 0x000008, "Wrong alignment on FRigVMTrait_OptimusDeformer");
static_assert(sizeof(FRigVMTrait_OptimusDeformer) == 0x000038, "Wrong size on FRigVMTrait_OptimusDeformer");
...
public:
	...
	class FName                                   ExcludeChildComponentsWithTag;                     // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FRigVMTrait_OptimusDeformerSettings) == 0x000028, "Wrong size on FRigVMTrait_OptimusDeformerSettings");
...
public:
	...
	struct FOptimusValueIdentifier                ValueId;                                           // 0x0018(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         Offset;                                            // 0x0020(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<uint8>                                 Value;                                             // 0x0028(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)
	struct FShaderValueContainer                  ShaderValue;                                       // 0x0038(0x0020)(Deprecated, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObject>                 SourceObject;                                      // 0x0058(0x0020)(Deprecated, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FOptimusGraphVariableDescription) == 0x000008, "Wrong alignment on FOptimusGraphVariableDescription");
static_assert(sizeof(FOptimusGraphVariableDescription) == 0x000078, "Wrong size on FOptimusGraphVariableDescription");
...
static_assert(offsetof(FOptimusGraphVariableDescription, Offset) == 0x000020, "Member 'FOptimusGraphVariableDescription::Offset' has a wrong offset!");
static_assert(offsetof(FOptimusGraphVariableDescription, Value) == 0x000028, "Member 'FOptimusGraphVariableDescription::Value' has a wrong offset!");
static_assert(offsetof(FOptimusGraphVariableDescription, ShaderValue) == 0x000038, "Member 'FOptimusGraphVariableDescription::ShaderValue' has a wrong offset!");
static_assert(offsetof(FOptimusGraphVariableDescription, SourceObject) == 0x000058, "Member 'FOptimusGraphVariableDescription::SourceObject' has a wrong offset!");
...
static_assert(alignof(FRigUnit_AddOptimusDeformer) == 0x000008, "Wrong alignment on FRigUnit_AddOptimusDeformer");
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0018(0x0028)(Edit, NativeAccessSpecifierPublic)
	...
	class FName                                   PinName;                                           // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UOptimusValueContainer*                 DefaultValue;                                      // 0x0068(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FOptimusAnimAttributeDescription) == 0x000008, "Wrong alignment on FOptimusAnimAttributeDescription");
static_assert(sizeof(FOptimusAnimAttributeDescription) == 0x000070, "Wrong size on FOptimusAnimAttributeDescription");
...
static_assert(offsetof(FOptimusAnimAttributeDescription, DefaultValueStruct) == 0x000040, "Member 'FOptimusAnimAttributeDescription::DefaultValueStruct' has a wrong offset!");
static_assert(offsetof(FOptimusAnimAttributeDescription, HlslId) == 0x000050, "Member 'FOptimusAnimAttributeDescription::HlslId' has a wrong offset!");
static_assert(offsetof(FOptimusAnimAttributeDescription, PinName) == 0x000060, "Member 'FOptimusAnimAttributeDescription::PinName' has a wrong offset!");
static_assert(offsetof(FOptimusAnimAttributeDescription, DefaultValue) == 0x000068, "Member 'FOptimusAnimAttributeDescription::DefaultValue' has a wrong offset!");
...
{
public:
	class FName                                   Value;                                             // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(alignof(FOptimusCommentNodeAction_ResizeNode) == 0x000008, "Wrong alignment on FOptimusCommentNodeAction_ResizeNode");
...
static_assert(sizeof(FOptimusResourceAction_AddResource) == 0x000088, "Wrong size on FOptimusResourceAction_AddResource");
...
static_assert(sizeof(FOptimusResourceAction_RemoveResource) == 0x000060, "Wrong size on FOptimusResourceAction_RemoveResource");
...
static_assert(sizeof(FOptimusResourceAction_SetDataType) == 0x000070, "Wrong size on FOptimusResourceAction_SetDataType");
...
static_assert(sizeof(FOptimusVariableAction_AddVariable) == 0x000048, "Wrong size on FOptimusVariableAction_AddVariable");
...
static_assert(sizeof(FOptimusVariableAction_RemoveVariable) == 0x000070, "Wrong size on FOptimusVariableAction_RemoveVariable");
...
static_assert(sizeof(FOptimusVariableAction_SetDataType) == 0x000070, "Wrong size on FOptimusVariableAction_SetDataType");
...
public:
	class FString                                 Name;                                              // 0x0000(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0010(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FOptimusValueContainerStruct           DefaultValueStruct;                                // 0x0038(0x0010)(Edit, NativeAccessSpecifierPublic)
	class FString                                 HlslId;                                            // 0x0048(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   PinName;                                           // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FOptimusAnimAttributeBufferDescription) == 0x000060, "Wrong size on FOptimusAnimAttributeBufferDescription");
...
static_assert(offsetof(FOptimusAnimAttributeBufferDescription, DefaultValueStruct) == 0x000038, "Member 'FOptimusAnimAttributeBufferDescription::DefaultValueStruct' has a wrong offset!");
static_assert(offsetof(FOptimusAnimAttributeBufferDescription, HlslId) == 0x000048, "Member 'FOptimusAnimAttributeBufferDescription::HlslId' has a wrong offset!");
static_assert(offsetof(FOptimusAnimAttributeBufferDescription, PinName) == 0x000058, "Member 'FOptimusAnimAttributeBufferDescription::PinName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0028)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(FOptimusNode_GetVariable_DuplicationInfo) == 0x000040, "Wrong size on FOptimusNode_GetVariable_DuplicationInfo");
...
static_assert(offsetof(FOptimusNode_GetVariable_DuplicationInfo, DefaultValue) == 0x000030, "Member 'FOptimusNode_GetVariable_DuplicationInfo::DefaultValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0008(0x0028)(NativeAccessSpecifierPublic)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0030(0x0040)(NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FOptimusNode_ResourceAccessorBase_DuplicationInfo) == 0x000070, "Wrong size on FOptimusNode_ResourceAccessorBase_DuplicationInfo");
...
static_assert(offsetof(FOptimusNode_ResourceAccessorBase_DuplicationInfo, DataDomain) == 0x000030, "Member 'FOptimusNode_ResourceAccessorBase_DuplicationInfo::DataDomain' has a wrong offset!");
...
static_assert(offsetof(FOptimusDataType, TypeObject) == 0x000028, "Member 'FOptimusDataType::TypeObject' has a wrong offset!");
static_assert(offsetof(FOptimusDataType, bHasCustomPinColor) == 0x000030, "Member 'FOptimusDataType::bHasCustomPinColor' has a wrong offset!");
static_assert(offsetof(FOptimusDataType, CustomPinColor) == 0x000034, "Member 'FOptimusDataType::CustomPinColor' has a wrong offset!");
static_assert(offsetof(FOptimusDataType, UsageFlags) == 0x000044, "Member 'FOptimusDataType::UsageFlags' has a wrong offset!");
static_assert(offsetof(FOptimusDataType, TypeFlags) == 0x000045, "Member 'FOptimusDataType::TypeFlags' has a wrong offset!");
