...
// Function AbilityFunctions.AbilityFunctions_C.GetDistanceFromOwnerToAITarget
// 0x0030 (0x0030 - 0x0000)
struct AbilityFunctions_C_GetDistanceFromOwnerToAITarget final
{
public:
	class UFortGameplayAbility*                   ability;                                           // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UObject*                                __WorldContext;                                    // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                 CallFunc_GetAIAbilityTarget_ReturnValue;           // 0x0020(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_GetDistanceBetweenActors_Distance;        // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget) == 0x000008, "Wrong alignment on AbilityFunctions_C_GetDistanceFromOwnerToAITarget");
static_assert(sizeof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget) == 0x000030, "Wrong size on AbilityFunctions_C_GetDistanceFromOwnerToAITarget");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, ability) == 0x000000, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::ability' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, __WorldContext) == 0x000008, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::__WorldContext' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, Distance) == 0x000010, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::Distance' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, CallFunc_GetActivatingPawn_ReturnValue) == 0x000018, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::CallFunc_GetActivatingPawn_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, CallFunc_GetAIAbilityTarget_ReturnValue) == 0x000020, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::CallFunc_GetAIAbilityTarget_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetDistanceFromOwnerToAITarget, CallFunc_GetDistanceBetweenActors_Distance) == 0x000028, "Member 'AbilityFunctions_C_GetDistanceFromOwnerToAITarget::CallFunc_GetDistanceBetweenActors_Distance' has a wrong offset!");
...
public:
	...
	struct FFortAbilityTargetSelection            CallFunc_Array_Get_Item;                           // 0x00D8(0x0170)()
	float                                         CallFunc_GetValueAtLevel_ReturnValue;              // 0x0248(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_GetValueAtLevel_Level_ImplicitCast;       // 0x024C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_FunctionResult_Range_ImplicitCast;          // 0x0250(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer) == 0x000258, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainer");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, CallFunc_GetValueAtLevel_ReturnValue) == 0x000248, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, CallFunc_GetValueAtLevel_Level_ImplicitCast) == 0x00024C, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::CallFunc_GetValueAtLevel_Level_ImplicitCast' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainer, K2Node_FunctionResult_Range_ImplicitCast) == 0x000250, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainer::K2Node_FunctionResult_Range_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec) == 0x000258, "Wrong size on AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec");
...
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, CallFunc_GetValueAtLevel_ReturnValue) == 0x000248, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::CallFunc_GetValueAtLevel_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, CallFunc_GetValueAtLevel_Level_ImplicitCast) == 0x00024C, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::CallFunc_GetValueAtLevel_Level_ImplicitCast' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec, K2Node_FunctionResult_Range_ImplicitCast) == 0x000250, "Member 'AbilityFunctions_C_GetRangeFromGameplayEffectContainerSpec::K2Node_FunctionResult_Range_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(AbilityFunctions_C_CalculateRootMotionDuration) == 0x000008, "Wrong alignment on AbilityFunctions_C_CalculateRootMotionDuration");
static_assert(sizeof(AbilityFunctions_C_CalculateRootMotionDuration) == 0x000050, "Wrong size on AbilityFunctions_C_CalculateRootMotionDuration");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, Distance) == 0x000000, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::Distance' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, Speed) == 0x000008, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::Speed' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, ClampMinMax_) == 0x000010, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::ClampMinMax_' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, MinDuration) == 0x000018, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::MinDuration' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, MaxDuration) == 0x000020, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::MaxDuration' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, __WorldContext) == 0x000028, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::__WorldContext' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, ReturnValue) == 0x000030, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, CallFunc_SafeDivide_ReturnValue) == 0x000038, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::CallFunc_SafeDivide_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, CallFunc_FClamp_ReturnValue) == 0x000040, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::CallFunc_FClamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(AbilityFunctions_C_CalculateRootMotionDuration, CallFunc_SelectFloat_ReturnValue) == 0x000048, "Member 'AbilityFunctions_C_CalculateRootMotionDuration::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
