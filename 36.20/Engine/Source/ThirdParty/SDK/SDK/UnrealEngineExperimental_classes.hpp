...
{
public:
	TArray<struct FPersistentLineBatcher>         PersistentLineBatchers;                            // 0x00B8(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UControllerComponentDebugDraw) == 0x000120, "Wrong size on UControllerComponentDebugDraw");
static_assert(offsetof(UControllerComponentDebugDraw, PersistentLineBatchers) == 0x0000B8, "Member 'UControllerComponentDebugDraw::PersistentLineBatchers' has a wrong offset!");
