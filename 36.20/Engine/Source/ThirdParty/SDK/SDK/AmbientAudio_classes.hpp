...
public:
	...
	class UAmbientAudioDataAsset*                 AmbientAsset;                                      // 0x00C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         Priority;                                          // 0x00D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CrossfadeTime;                                     // 0x00D4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGuid                                  AmbientGuid;                                       // 0x00D8(0x0010)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FName                                   DisplayName;                                       // 0x00E8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UAmbientAudioComponent) == 0x0000F0, "Wrong size on UAmbientAudioComponent");
static_assert(offsetof(UAmbientAudioComponent, AmbientAsset) == 0x0000C8, "Member 'UAmbientAudioComponent::AmbientAsset' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, Priority) == 0x0000D0, "Member 'UAmbientAudioComponent::Priority' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, CrossfadeTime) == 0x0000D4, "Member 'UAmbientAudioComponent::CrossfadeTime' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, AmbientGuid) == 0x0000D8, "Member 'UAmbientAudioComponent::AmbientGuid' has a wrong offset!");
static_assert(offsetof(UAmbientAudioComponent, DisplayName) == 0x0000E8, "Member 'UAmbientAudioComponent::DisplayName' has a wrong offset!");
...
{
public:
	class UAudioParameterComponent*               Parameters;                                        // 0x02A8(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAmbientAudioParameterActor) == 0x0002B0, "Wrong size on AAmbientAudioParameterActor");
static_assert(offsetof(AAmbientAudioParameterActor, Parameters) == 0x0002A8, "Member 'AAmbientAudioParameterActor::Parameters' has a wrong offset!");
