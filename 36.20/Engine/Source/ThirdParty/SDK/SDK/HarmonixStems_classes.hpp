...
static_assert(sizeof(UStemmedWavesAsset) == 0x000068, "Wrong size on UStemmedWavesAsset");
...
static_assert(sizeof(UStemmedMediaStreamAsset) == 0x000068, "Wrong size on UStemmedMediaStreamAsset");
