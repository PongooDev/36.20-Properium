...
{
public:
	class UFortWorldItemDefinition*               ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
// Function WeaponModsCodeRuntime.FortWeaponModStationBase.ShouldShowItemRarity
// 0x0001 (0x0001 - 0x0000)
struct FortWeaponModStationBase_ShouldShowItemRarity final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortWeaponModStationBase_ShouldShowItemRarity) == 0x000001, "Wrong alignment on FortWeaponModStationBase_ShouldShowItemRarity");
static_assert(sizeof(FortWeaponModStationBase_ShouldShowItemRarity) == 0x000001, "Wrong size on FortWeaponModStationBase_ShouldShowItemRarity");
static_assert(offsetof(FortWeaponModStationBase_ShouldShowItemRarity, ReturnValue) == 0x000000, "Member 'FortWeaponModStationBase_ShouldShowItemRarity::ReturnValue' has a wrong offset!");
...
static_assert(alignof(FortWeaponModStationSharedDataComponent_OnPlaylistLoaded) == 0x000008, "Wrong alignment on FortWeaponModStationSharedDataComponent_OnPlaylistLoaded");
static_assert(sizeof(FortWeaponModStationSharedDataComponent_OnPlaylistLoaded) == 0x000028, "Wrong size on FortWeaponModStationSharedDataComponent_OnPlaylistLoaded");
static_assert(offsetof(FortWeaponModStationSharedDataComponent_OnPlaylistLoaded, PlaylistName) == 0x000000, "Member 'FortWeaponModStationSharedDataComponent_OnPlaylistLoaded::PlaylistName' has a wrong offset!");
static_assert(offsetof(FortWeaponModStationSharedDataComponent_OnPlaylistLoaded, PlaylistContextTags) == 0x000008, "Member 'FortWeaponModStationSharedDataComponent_OnPlaylistLoaded::PlaylistContextTags' has a wrong offset!");
