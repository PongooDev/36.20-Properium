...
public:
	...
	TMulticastInlineDelegate<void(class UContextualAnimSceneActorComponent* SceneActorComponent)> OnJoinedSceneDelegate;                             // 0x0248(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UContextualAnimSceneActorComponent* SceneActorComponent)> OnLeftSceneDelegate;                               // 0x0258(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UContextualAnimSceneActorComponent* SceneActorComponent, class FName NotifyName)> OnPlayMontageNotifyBeginDelegate;                  // 0x0268(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UContextualAnimSceneActorComponent* SceneComponent, class UAnimMontage* BlendingOutMontage, bool bInterrupted)> OnMontageBlendingOutDelegate;                      // 0x0278(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UContextualAnimSceneAsset*              SceneAsset;                                        // 0x0288(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UAnimInstance>           OwnerAnimInstance;                                 // 0x0290(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FContextualAnimRepBindingsData         RepBindings;                                       // 0x0298(0x0050)(Net, Transient, RepNotify, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FContextualAnimRepLateJoinData         RepLateJoinData;                                   // 0x02E8(0x0030)(Net, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
	struct FContextualAnimRepTransitionData       RepTransitionData;                                 // 0x0318(0x0028)(Net, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
	struct FContextualAnimRepTransitionData       RepTransitionSingleActorData;                      // 0x0340(0x0028)(Net, Transient, RepNotify, Protected, NativeAccessSpecifierProtected)
	struct FContextualAnimSceneBindings           Bindings;                                          // 0x0368(0x0028)(Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<struct FContextualAnimIKTarget>        IKTargets;                                         // 0x0390(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	TArray<class FName>                           WarpTargetNamesCache;                              // 0x03A0(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UContextualAnimSceneActorComponent) == 0x000410, "Wrong size on UContextualAnimSceneActorComponent");
static_assert(offsetof(UContextualAnimSceneActorComponent, OnJoinedSceneDelegate) == 0x000248, "Member 'UContextualAnimSceneActorComponent::OnJoinedSceneDelegate' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, OnLeftSceneDelegate) == 0x000258, "Member 'UContextualAnimSceneActorComponent::OnLeftSceneDelegate' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, OnPlayMontageNotifyBeginDelegate) == 0x000268, "Member 'UContextualAnimSceneActorComponent::OnPlayMontageNotifyBeginDelegate' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, OnMontageBlendingOutDelegate) == 0x000278, "Member 'UContextualAnimSceneActorComponent::OnMontageBlendingOutDelegate' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, SceneAsset) == 0x000288, "Member 'UContextualAnimSceneActorComponent::SceneAsset' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, OwnerAnimInstance) == 0x000290, "Member 'UContextualAnimSceneActorComponent::OwnerAnimInstance' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, RepBindings) == 0x000298, "Member 'UContextualAnimSceneActorComponent::RepBindings' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, RepLateJoinData) == 0x0002E8, "Member 'UContextualAnimSceneActorComponent::RepLateJoinData' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, RepTransitionData) == 0x000318, "Member 'UContextualAnimSceneActorComponent::RepTransitionData' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, RepTransitionSingleActorData) == 0x000340, "Member 'UContextualAnimSceneActorComponent::RepTransitionSingleActorData' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, Bindings) == 0x000368, "Member 'UContextualAnimSceneActorComponent::Bindings' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, IKTargets) == 0x000390, "Member 'UContextualAnimSceneActorComponent::IKTargets' has a wrong offset!");
static_assert(offsetof(UContextualAnimSceneActorComponent, WarpTargetNamesCache) == 0x0003A0, "Member 'UContextualAnimSceneActorComponent::WarpTargetNamesCache' has a wrong offset!");
