...
static_assert(sizeof(UDataStream) == 0x000048, "Wrong size on UDataStream");
...
public:
	...
	class UIrisObjectReferencePackageMap*         PackageMap;                                        // 0x0058(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UChunkedDataStream) == 0x000060, "Wrong size on UChunkedDataStream");
static_assert(offsetof(UChunkedDataStream, PackageMap) == 0x000058, "Member 'UChunkedDataStream::PackageMap' has a wrong offset!");
...
static_assert(sizeof(UDataStreamManager) == 0x000050, "Wrong size on UDataStreamManager");
...
static_assert(sizeof(UNetObjectGridFilter) == 0x000198, "Wrong size on UNetObjectGridFilter");
...
static_assert(sizeof(UNetObjectGridWorldLocFilter) == 0x0001A0, "Wrong size on UNetObjectGridWorldLocFilter");
...
public:
	...
	class FName                                   RequiredNetDriverChannelClassName;                 // 0x00A8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UObjectReplicationBridgeConfig) == 0x0000C0, "Wrong size on UObjectReplicationBridgeConfig");
...
static_assert(offsetof(UObjectReplicationBridgeConfig, AsyncLoadingClassConfigs) == 0x000098, "Member 'UObjectReplicationBridgeConfig::AsyncLoadingClassConfigs' has a wrong offset!");
static_assert(offsetof(UObjectReplicationBridgeConfig, RequiredNetDriverChannelClassName) == 0x0000A8, "Member 'UObjectReplicationBridgeConfig::RequiredNetDriverChannelClassName' has a wrong offset!");
static_assert(offsetof(UObjectReplicationBridgeConfig, CriticalActorClasses) == 0x0000B0, "Member 'UObjectReplicationBridgeConfig::CriticalActorClasses' has a wrong offset!");
...
static_assert(sizeof(UNetTokenDataStream) == 0x000098, "Wrong size on UNetTokenDataStream");
...
// 0x0518 (0x0680 - 0x0168)
class alignas(0x10) UObjectReplicationBridge : public UReplicationBridge
{
public:
	uint8                                         Pad_168[0x460];                                    // 0x0168(0x0460)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UNetObjectFactory*>              NetObjectFactories;                                // 0x05C8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UObjectReplicationBridge) == 0x000680, "Wrong size on UObjectReplicationBridge");
static_assert(offsetof(UObjectReplicationBridge, NetObjectFactories) == 0x0005C8, "Member 'UObjectReplicationBridge::NetObjectFactories' has a wrong offset!");
...
static_assert(sizeof(UReplicationDataStream) == 0x000058, "Wrong size on UReplicationDataStream");
