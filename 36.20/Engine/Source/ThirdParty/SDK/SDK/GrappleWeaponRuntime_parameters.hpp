...
public:
	...
	struct FGrappleWeaponLedgeConfig              Config;                                            // 0x0100(0x0078)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          OutDidImpactWalkableSurface;                       // 0x0178(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          OutTargetingLedge;                                 // 0x0179(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_17A[0x6];                                      // 0x017A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                OutLedgeLocation;                                  // 0x0180(0x0018)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDrawDebug;                                        // 0x0198(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(GrappleWeaponLibrary_DidHitResultImpactLedge) == 0x0001A0, "Wrong size on GrappleWeaponLibrary_DidHitResultImpactLedge");
...
static_assert(offsetof(GrappleWeaponLibrary_DidHitResultImpactLedge, Config) == 0x000100, "Member 'GrappleWeaponLibrary_DidHitResultImpactLedge::Config' has a wrong offset!");
static_assert(offsetof(GrappleWeaponLibrary_DidHitResultImpactLedge, OutDidImpactWalkableSurface) == 0x000178, "Member 'GrappleWeaponLibrary_DidHitResultImpactLedge::OutDidImpactWalkableSurface' has a wrong offset!");
static_assert(offsetof(GrappleWeaponLibrary_DidHitResultImpactLedge, OutTargetingLedge) == 0x000179, "Member 'GrappleWeaponLibrary_DidHitResultImpactLedge::OutTargetingLedge' has a wrong offset!");
static_assert(offsetof(GrappleWeaponLibrary_DidHitResultImpactLedge, OutLedgeLocation) == 0x000180, "Member 'GrappleWeaponLibrary_DidHitResultImpactLedge::OutLedgeLocation' has a wrong offset!");
static_assert(offsetof(GrappleWeaponLibrary_DidHitResultImpactLedge, bDrawDebug) == 0x000198, "Member 'GrappleWeaponLibrary_DidHitResultImpactLedge::bDrawDebug' has a wrong offset!");
