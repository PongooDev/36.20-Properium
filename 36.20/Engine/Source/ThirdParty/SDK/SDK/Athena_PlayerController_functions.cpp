...
TSoftObjectPtr<class UFortCreativeOptionsBundle> AAthena_PlayerController_C::GetCreativeOptionsBundleOverride()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetCreativeOptionsBundleOverride");
...
// (Net, NetReliable, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPlayerController*            FortPlayerController                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void AAthena_PlayerController_C::RPC_Event_ClientToServer(class AFortPlayerController* FortPlayerController)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("RPC_Event_ClientToServer");

	Params::Athena_PlayerController_C_RPC_Event_ClientToServer Parms{};
