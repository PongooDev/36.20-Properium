...
public:
	...
	void OnBlendedIn_A513E1E044E129CC612DF5A23589BC9C();
...
static_assert(sizeof(UGA_DefaultPlayer_InteractUse_C) == 0x000B70, "Wrong size on UGA_DefaultPlayer_InteractUse_C");
static_assert(offsetof(UGA_DefaultPlayer_InteractUse_C, UberGraphFrame) == 0x000B68, "Member 'UGA_DefaultPlayer_InteractUse_C::UberGraphFrame' has a wrong offset!");
