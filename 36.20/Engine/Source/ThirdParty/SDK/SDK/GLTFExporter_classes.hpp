...
static_assert(offsetof(UGLTFExportOptions, bExportLightmaps) == 0x0000A9, "Member 'UGLTFExportOptions::bExportLightmaps' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bAdjustNormalmaps) == 0x0000AA, "Member 'UGLTFExportOptions::bAdjustNormalmaps' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportHiddenInGame) == 0x0000AB, "Member 'UGLTFExportOptions::bExportHiddenInGame' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportLights) == 0x0000AC, "Member 'UGLTFExportOptions::bExportLights' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, bExportCameras) == 0x0000AD, "Member 'UGLTFExportOptions::bExportCameras' has a wrong offset!");
static_assert(offsetof(UGLTFExportOptions, ExportMaterialVariants) == 0x0000AE, "Member 'UGLTFExportOptions::ExportMaterialVariants' has a wrong offset!");
