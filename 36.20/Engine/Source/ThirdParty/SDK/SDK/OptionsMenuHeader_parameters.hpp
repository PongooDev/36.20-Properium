...
static_assert(sizeof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader) == 0x000178, "Wrong size on OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader");
...
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, K2Node_Event_MouseEvent_1) == 0x0000D8, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::K2Node_Event_MouseEvent_1' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, K2Node_Event_bIsSelected) == 0x000158, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::K2Node_Event_bIsSelected' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_FTrunc_ReturnValue) == 0x00015C, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_GetContext_ReturnValue) == 0x000160, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_IsUsingGamepad_ReturnValue) == 0x000168, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_IsUsingGamepad_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader, CallFunc_FTrunc_A_ImplicitCast) == 0x000170, "Member 'OptionsMenuHeader_C_ExecuteUbergraph_OptionsMenuHeader::CallFunc_FTrunc_A_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(OptionsMenuHeader_C_OnMouseEnter) == 0x0000B8, "Wrong size on OptionsMenuHeader_C_OnMouseEnter");
...
static_assert(sizeof(OptionsMenuHeader_C_OnMouseLeave) == 0x000080, "Wrong size on OptionsMenuHeader_C_OnMouseLeave");
...
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, CallFunc_IsMobileGame_ReturnValue) == 0x000068, "Member 'OptionsMenuHeader_C_SetFontSize::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(OptionsMenuHeader_C_SetFontSize, Temp_bool_Variable) == 0x000069, "Member 'OptionsMenuHeader_C_SetFontSize::Temp_bool_Variable' has a wrong offset!");
