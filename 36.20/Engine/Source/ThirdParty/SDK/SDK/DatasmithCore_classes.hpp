...
static_assert(alignof(UDatasmithClothAssetFactory) == 0x000008, "Wrong alignment on UDatasmithClothAssetFactory");
static_assert(sizeof(UDatasmithClothAssetFactory) == 0x000028, "Wrong size on UDatasmithClothAssetFactory");
...
static_assert(alignof(UDatasmithClothComponentFactory) == 0x000008, "Wrong alignment on UDatasmithClothComponentFactory");
static_assert(sizeof(UDatasmithClothComponentFactory) == 0x000028, "Wrong size on UDatasmithClothComponentFactory");
