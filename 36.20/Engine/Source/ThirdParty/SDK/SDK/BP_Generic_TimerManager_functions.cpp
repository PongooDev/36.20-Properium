...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UFortGameActivity*                PreviewLink                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_Generic_TimerManager_C::OnLinkPreviewUpdated_E104FC0242B238EB1016FA8A0CC280A2(class UFortGameActivity* PreviewLink)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnLinkPreviewUpdated_E104FC0242B238EB1016FA8A0CC280A2");

	Params::BP_Generic_TimerManager_C_OnLinkPreviewUpdated_E104FC0242B238EB1016FA8A0CC280A2 Parms{};

	Parms.PreviewLink = PreviewLink;
