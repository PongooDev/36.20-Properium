...
public:
	...
	float                                         MaxHealth;                                         // 0x0350(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_354[0x4];                                      // 0x0354(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortAbilitySystemComponent*            AbilitySystemComponent;                            // 0x0358(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AWheelGrenadeWheel) == 0x000360, "Wrong size on AWheelGrenadeWheel");
static_assert(offsetof(AWheelGrenadeWheel, MaxHealth) == 0x000350, "Member 'AWheelGrenadeWheel::MaxHealth' has a wrong offset!");
static_assert(offsetof(AWheelGrenadeWheel, AbilitySystemComponent) == 0x000358, "Member 'AWheelGrenadeWheel::AbilitySystemComponent' has a wrong offset!");
