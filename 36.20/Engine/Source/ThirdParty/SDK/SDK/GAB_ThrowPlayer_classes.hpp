...
static_assert(sizeof(UGAB_ThrowPlayer_C) == 0x000C08, "Wrong size on UGAB_ThrowPlayer_C");
static_assert(offsetof(UGAB_ThrowPlayer_C, UberGraphFrame) == 0x000BF8, "Member 'UGAB_ThrowPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAB_ThrowPlayer_C, PlayerPawn) == 0x000C00, "Member 'UGAB_ThrowPlayer_C::PlayerPawn' has a wrong offset!");
