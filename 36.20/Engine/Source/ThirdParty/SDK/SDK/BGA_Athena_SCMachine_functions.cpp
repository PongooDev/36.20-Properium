...
void ABGA_Athena_SCMachine_C::BlueprintOnBeginInteract(const class AFortPawn* InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted, const ETInteractionType InteractionType)
{
	...
	Params::BGA_Athena_SCMachine_C_BlueprintOnBeginInteract Parms{};
...
void ABGA_Athena_SCMachine_C::BlueprintOnInteract(const class AFortPawn* InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted)
{
	static class UFunction* Func = nullptr;
	...
	Params::BGA_Athena_SCMachine_C_BlueprintOnInteract Parms{};
...
void ABGA_Athena_SCMachine_C::CheckForTetherRange()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CheckForTetherRange");
...
void ABGA_Athena_SCMachine_C::EnabledState()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("EnabledState");
...
// bool                                    bEnhancedResurrection                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_Athena_SCMachine_C::GiveWeaponsAndResources(class AFortPlayerController* FortPC, bool bEnhancedResurrection)
{
	static class UFunction* Func = nullptr;
	...
	Parms.FortPC = FortPC;
	Parms.bEnhancedResurrection = bEnhancedResurrection;
...
void ABGA_Athena_SCMachine_C::HandlePlayerSpawned(class AFortPlayerPawn* Pawn)
{
	static class UFunction* Func = nullptr;
	...
	Params::BGA_Athena_SCMachine_C_HandlePlayerSpawned Parms{};
...
void ABGA_Athena_SCMachine_C::InitMaterialParameters()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("InitMaterialParameters");
...
// bool                                    bEnhancedResurrection                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABGA_Athena_SCMachine_C::OnPlayerPawnResurrected(class AFortPlayerPawn* PlayerPawn, const bool bEnhancedResurrection)
{
	static class UFunction* Func = nullptr;
...
void ABGA_Athena_SCMachine_C::ReceiveEndPlay(EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;
	...
	Params::BGA_Athena_SCMachine_C_ReceiveEndPlay Parms{};
...
// Function BGA_Athena_SCMachine.BGA_Athena_SCMachine_C.RemoveActiveGameplayCue
// (BlueprintCallable, BlueprintEvent)

void ABGA_Athena_SCMachine_C::RemoveActiveGameplayCue()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("RemoveActiveGameplayCue");
...
void ABGA_Athena_SCMachine_C::TriggerRespawnFX(class AFortPawn* PhaseInPawn, bool bEnhancedResurrection)
{
	static class UFunction* Func = nullptr;
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPawn*                        InteractingActor                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABGA_Athena_SCMachine_C::UpdateSquadTags(class AFortPawn* InteractingActor)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateSquadTags");

	Params::BGA_Athena_SCMachine_C_UpdateSquadTags Parms{};
...
void ABGA_Athena_SCMachine_C::BlueprintUpdateDynamicInteractionOptions(struct FGameplayTagContainer* OutGameplayTags, const class AFortPawn* InteractingPawn, const EInteractionBeingAttempted InteractionBeingAttempted, const ETInteractionType InteractionType) const
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("BlueprintUpdateDynamicInteractionOptions");

	Params::BGA_Athena_SCMachine_C_BlueprintUpdateDynamicInteractionOptions Parms{};
...
struct FGameplayTag ABGA_Athena_SCMachine_C::GetOverrideItemInteractAbilityTag() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetOverrideItemInteractAbilityTag");
