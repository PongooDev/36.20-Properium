...
static_assert(sizeof(UZoneGraphAnnotationComponent) == 0x0005A0, "Wrong size on UZoneGraphAnnotationComponent");
static_assert(offsetof(UZoneGraphAnnotationComponent, bEnableDebugDrawing) == 0x000590, "Member 'UZoneGraphAnnotationComponent::bEnableDebugDrawing' has a wrong offset!");
...
{
public:
	TArray<class UZoneGraphAnnotationTest*>       Tests;                                             // 0x0578(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UZoneGraphAnnotationTestingComponent) == 0x000590, "Wrong size on UZoneGraphAnnotationTestingComponent");
static_assert(offsetof(UZoneGraphAnnotationTestingComponent, Tests) == 0x000578, "Member 'UZoneGraphAnnotationTestingComponent::Tests' has a wrong offset!");
...
{
public:
	class UZoneGraphAnnotationTestingComponent*   TestingComp;                                       // 0x02A8(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AZoneGraphAnnotationTestingActor) == 0x0002B0, "Wrong size on AZoneGraphAnnotationTestingActor");
static_assert(offsetof(AZoneGraphAnnotationTestingActor, TestingComp) == 0x0002A8, "Member 'AZoneGraphAnnotationTestingActor::TestingComp' has a wrong offset!");
...
public:
	...
	class UZoneGraphSubsystem*                    ZoneGraphSubsystem;                                // 0x05F8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UZoneGraphDisturbanceAnnotation) == 0x000600, "Wrong size on UZoneGraphDisturbanceAnnotation");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, DangerAnnotationTag) == 0x000598, "Member 'UZoneGraphDisturbanceAnnotation::DangerAnnotationTag' has a wrong offset!");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, ObstacleAnnotationTag) == 0x000599, "Member 'UZoneGraphDisturbanceAnnotation::ObstacleAnnotationTag' has a wrong offset!");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, AffectedLaneTags) == 0x00059C, "Member 'UZoneGraphDisturbanceAnnotation::AffectedLaneTags' has a wrong offset!");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, EscapeLaneTags) == 0x0005A8, "Member 'UZoneGraphDisturbanceAnnotation::EscapeLaneTags' has a wrong offset!");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, IdealSpanLength) == 0x0005B4, "Member 'UZoneGraphDisturbanceAnnotation::IdealSpanLength' has a wrong offset!");
static_assert(offsetof(UZoneGraphDisturbanceAnnotation, ZoneGraphSubsystem) == 0x0005F8, "Member 'UZoneGraphDisturbanceAnnotation::ZoneGraphSubsystem' has a wrong offset!");
