...
// (Final, RequiredAPI, BlueprintAuthorityOnly, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FConversationContext             Context                                                (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
class FString UConversationEntryPointNode::GetIdentifier() const
{
	static class UFunction* Func = nullptr;
	...
	Params::ConversationEntryPointNode_GetIdentifier Parms{};
...
// class FString                           EntryPointIdentifier                                   (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UConversationInstance*            ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UConversationInstance* UConversationLibrary::StartConversationFromGraph(const struct FGameplayTag& ConversationEntryTag, class AActor* Instigator, const struct FGameplayTag& InstigatorTag, class AActor* Target, const struct FGameplayTag& TargetTag, const class UConversationDatabase* Graph, const class FString& EntryPointIdentifier)
{
	...
	Parms.TargetTag = std::move(TargetTag);
	Parms.Graph = Graph;
	Parms.EntryPointIdentifier = std::move(EntryPointIdentifier);
...
// (RequiredAPI, BlueprintCosmetic, Native, Event, Protected, HasOutParams, BlueprintEvent, Const)
// Parameters:
// struct FConversationContext             Context                                                (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
...
// (RequiredAPI, BlueprintAuthorityOnly, Native, Event, Protected, HasOutParams, BlueprintEvent, Const)
// Parameters:
// struct FConversationContext             Context                                                (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// struct FConversationTaskResult          ReturnValue                                            (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
