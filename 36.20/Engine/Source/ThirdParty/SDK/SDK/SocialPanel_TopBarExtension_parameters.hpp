...
static_assert(sizeof(SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension) == 0x000028, "Wrong size on SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension");
...
static_assert(offsetof(SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension, CallFunc_PlayAnimation_ReturnValue_1) == 0x000018, "Member 'SocialPanel_TopBarExtension_C_ExecuteUbergraph_SocialPanel_TopBarExtension::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
