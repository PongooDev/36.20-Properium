...
public:
	...
	struct FHitResult                             MovementHitResult;                                 // 0x0008(0x00F8)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(BuildingGameplayActorSupplyDropRadio_UpdateGroundInfo) == 0x000100, "Wrong size on BuildingGameplayActorSupplyDropRadio_UpdateGroundInfo");
