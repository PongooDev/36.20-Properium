...
public:
	...
	float                                         K2Node_MakeStruct_Right_ImplicitCast;              // 0x0124(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         K2Node_MakeStruct_Bottom_ImplicitCast;             // 0x0128(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetMaxDesiredWidth_InMaxDesiredWidth_ImplicitCast; // 0x012C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_SlotAsOverlaySlot_ReturnValue) == 0x0000D0, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_SlotAsOverlaySlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x0000D8, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_Margin) == 0x0000E0, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_MakeVector2D_ReturnValue_1) == 0x0000F0, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_MakeVector2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_NearlyEqual_FloatFloat_ReturnValue) == 0x000100, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_NearlyEqual_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_GetRuntimeOptions_ReturnValue) == 0x000108, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_GetRuntimeOptions_ReturnValue' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_Select_Default) == 0x000110, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_ImageSize_ImplicitCast) == 0x000114, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_ImageSize_ImplicitCast' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_Left_ImplicitCast) == 0x00011C, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_Left_ImplicitCast' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_Top_ImplicitCast) == 0x000120, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_Top_ImplicitCast' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_Right_ImplicitCast) == 0x000124, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_Right_ImplicitCast' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, K2Node_MakeStruct_Bottom_ImplicitCast) == 0x000128, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::K2Node_MakeStruct_Bottom_ImplicitCast' has a wrong offset!");
static_assert(offsetof(InfoFlag_C_ExecuteUbergraph_InfoFlag, CallFunc_SetMaxDesiredWidth_InMaxDesiredWidth_ImplicitCast) == 0x00012C, "Member 'InfoFlag_C_ExecuteUbergraph_InfoFlag::CallFunc_SetMaxDesiredWidth_InMaxDesiredWidth_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(InfoFlag_C_UpdateText) == 0x000010, "Wrong size on InfoFlag_C_UpdateText");
