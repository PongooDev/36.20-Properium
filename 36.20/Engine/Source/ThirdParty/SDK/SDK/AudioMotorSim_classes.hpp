...
{
public:
	TArray<struct FMotorSimEntry>                 SimComponents;                                     // 0x00B8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<TScriptInterface<class IAudioMotorSimOutput>> AudioComponents;                                   // 0x00C8(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
...
public:
	...
	void ConfigureMotorSimComponents(const TArray<struct FInstancedStruct>& InConfigData);
...
static_assert(sizeof(UAudioMotorModelComponent) == 0x000118, "Wrong size on UAudioMotorModelComponent");
static_assert(offsetof(UAudioMotorModelComponent, SimComponents) == 0x0000B8, "Member 'UAudioMotorModelComponent::SimComponents' has a wrong offset!");
static_assert(offsetof(UAudioMotorModelComponent, AudioComponents) == 0x0000C8, "Member 'UAudioMotorModelComponent::AudioComponents' has a wrong offset!");
...
{
public:
	void ConfigMotorSim(const struct FInstancedStruct& InConfigData);
	bool GetEnabled();
	void Reset();
...
public:
	...
	bool                                          bEnabled;                                          // 0x00C0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAudioMotorSimComponent) == 0x0000C8, "Wrong size on UAudioMotorSimComponent");
static_assert(offsetof(UAudioMotorSimComponent, bEnabled) == 0x0000C0, "Member 'UAudioMotorSimComponent::bEnabled' has a wrong offset!");
