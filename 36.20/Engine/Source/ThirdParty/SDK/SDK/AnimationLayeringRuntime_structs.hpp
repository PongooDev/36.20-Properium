...
public:
	...
	bool                                          bUpdateSkeletonDataOnDemand;                       // 0x00B0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_B1[0x67];                                      // 0x00B1(0x0067)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_BoneMask) == 0x000008, "Wrong alignment on FAnimNode_BoneMask");
static_assert(sizeof(FAnimNode_BoneMask) == 0x000118, "Wrong size on FAnimNode_BoneMask");
...
static_assert(offsetof(FAnimNode_BoneMask, bUpdateSkeletonDataOnDemand) == 0x0000B0, "Member 'FAnimNode_BoneMask::bUpdateSkeletonDataOnDemand' has a wrong offset!");
