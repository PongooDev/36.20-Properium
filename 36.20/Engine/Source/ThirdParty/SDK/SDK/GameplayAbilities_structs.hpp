...
public:
	...
	struct FVector_NetQuantize10                  Location;                                          // 0x0068(0x0018)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector_NetQuantizeNormal              Normal;                                            // 0x0080(0x0018)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FGameplayTagChangedEventWrapperSpecHandle) == 0x000008, "Wrong alignment on FGameplayTagChangedEventWrapperSpecHandle");
...
static_assert(offsetof(FActiveGameplayCue, Parameters) == 0x000020, "Member 'FActiveGameplayCue::Parameters' has a wrong offset!");
...
public:
	...
	float                                         PlayCount;                                         // 0x001C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayAbilityRepAnimMontage, PlayCount) == 0x00001C, "Member 'FGameplayAbilityRepAnimMontage::PlayCount' has a wrong offset!");
...
public:
	...
	class FName                                   SourceSocketName;                                  // 0x0080(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayAbilityTargetingLocationType         LocationType;                                      // 0x0084(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FGameplayAbilityTargetingLocationInfo, LocationType) == 0x000084, "Member 'FGameplayAbilityTargetingLocationInfo::LocationType' has a wrong offset!");
...
{
public:
	uint8                                         Pad_0[0x2B0];                                      // 0x0000(0x02B0)(Fixing Size After Last Property [ Dumper-7 ])
	class UAbilitySystemComponent*                Owner;                                             // 0x02B0(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FMinimalGameplayCueReplicationProxy) == 0x0002C0, "Wrong size on FMinimalGameplayCueReplicationProxy");
static_assert(offsetof(FMinimalGameplayCueReplicationProxy, Owner) == 0x0002B0, "Member 'FMinimalGameplayCueReplicationProxy::Owner' has a wrong offset!");
