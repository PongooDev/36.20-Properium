...
{
public:
	TMulticastInlineDelegate<void(const class FString& FailureReason)> OnTerminalError;                                   // 0x02A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AElectraDataChannelPlayer) == 0x0002D8, "Wrong size on AElectraDataChannelPlayer");
static_assert(offsetof(AElectraDataChannelPlayer, OnTerminalError) == 0x0002A8, "Member 'AElectraDataChannelPlayer::OnTerminalError' has a wrong offset!");
...
static_assert(sizeof(AElectraDataChannelRecorder) == 0x0002E0, "Wrong size on AElectraDataChannelRecorder");
...
static_assert(sizeof(AElectraDataChannelTarget) == 0x000320, "Wrong size on AElectraDataChannelTarget");
