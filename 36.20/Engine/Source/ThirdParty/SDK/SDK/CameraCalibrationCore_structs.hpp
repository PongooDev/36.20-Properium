...
static_assert(alignof(FDistortionCalibrationResult) == 0x000010, "Wrong alignment on FDistortionCalibrationResult");
...
static_assert(alignof(FDistortionFocusCurve) == 0x000008, "Wrong alignment on FDistortionFocusCurve");
...
static_assert(alignof(FFocalLengthFocusCurve) == 0x000008, "Wrong alignment on FFocalLengthFocusCurve");
...
static_assert(alignof(FImageCenterFocusCurve) == 0x000008, "Wrong alignment on FImageCenterFocusCurve");
...
static_assert(alignof(FNodalOffsetFocusCurve) == 0x000008, "Wrong alignment on FNodalOffsetFocusCurve");
...
static_assert(alignof(FSTMapFocusCurve) == 0x000008, "Wrong alignment on FSTMapFocusCurve");
