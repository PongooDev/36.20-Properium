...
static_assert(offsetof(FFastEntityComponentArrayItem, ComponentName) == 0x00000C, "Member 'FFastEntityComponentArrayItem::ComponentName' has a wrong offset!");
...
static_assert(offsetof(FFastEntityComponentArray, Components) == 0x000108, "Member 'FFastEntityComponentArray::Components' has a wrong offset!");
