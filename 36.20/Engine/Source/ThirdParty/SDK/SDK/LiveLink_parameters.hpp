...
static_assert(sizeof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState) == 0x000008, "Wrong size on LiveLinkBlueprintLibrary_GetLiveLinkSubjectState");
...
static_assert(offsetof(LiveLinkBlueprintLibrary_GetLiveLinkSubjectState, ReturnValue) == 0x000004, "Member 'LiveLinkBlueprintLibrary_GetLiveLinkSubjectState::ReturnValue' has a wrong offset!");
...
static_assert(alignof(LiveLinkBlueprintLibrary_PauseSubject) == 0x000004, "Wrong alignment on LiveLinkBlueprintLibrary_PauseSubject");
static_assert(sizeof(LiveLinkBlueprintLibrary_PauseSubject) == 0x000004, "Wrong size on LiveLinkBlueprintLibrary_PauseSubject");
static_assert(offsetof(LiveLinkBlueprintLibrary_PauseSubject, SubjectName) == 0x000000, "Member 'LiveLinkBlueprintLibrary_PauseSubject::SubjectName' has a wrong offset!");
...
static_assert(alignof(LiveLinkBlueprintLibrary_UnpauseSubject) == 0x000004, "Wrong alignment on LiveLinkBlueprintLibrary_UnpauseSubject");
static_assert(sizeof(LiveLinkBlueprintLibrary_UnpauseSubject) == 0x000004, "Wrong size on LiveLinkBlueprintLibrary_UnpauseSubject");
static_assert(offsetof(LiveLinkBlueprintLibrary_UnpauseSubject, SubjectName) == 0x000000, "Member 'LiveLinkBlueprintLibrary_UnpauseSubject::SubjectName' has a wrong offset!");
