...
static_assert(sizeof(RebootCardIndicator_C_bp_UpdateCountdownText) == 0x000088, "Wrong size on RebootCardIndicator_C_bp_UpdateCountdownText");
...
static_assert(offsetof(RebootCardIndicator_C_bp_UpdateCountdownText, K2Node_MakeStruct_FormatArgumentData) == 0x000020, "Member 'RebootCardIndicator_C_bp_UpdateCountdownText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
