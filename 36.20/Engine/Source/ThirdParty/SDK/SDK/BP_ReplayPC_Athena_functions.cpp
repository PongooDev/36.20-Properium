...
void ABP_ReplayPC_Athena_C::InpActEvt_Tab_K2Node_InputKeyEvent_0(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("InpActEvt_Tab_K2Node_InputKeyEvent_0");

	Params::BP_ReplayPC_Athena_C_InpActEvt_Tab_K2Node_InputKeyEvent_0 Parms{};
...
void ABP_ReplayPC_Athena_C::InpActEvt_Tab_K2Node_InputKeyEvent_1(const struct FKey& Key)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("InpActEvt_Tab_K2Node_InputKeyEvent_1");

	Params::BP_ReplayPC_Athena_C_InpActEvt_Tab_K2Node_InputKeyEvent_1 Parms{};
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// int32                                   ShotIndex                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_ReplayPC_Athena_C::OnShotChanged(int32 ShotIndex)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnShotChanged");

	Params::BP_ReplayPC_Athena_C_OnShotChanged Parms{};
...
// Function BP_ReplayPC_Athena.BP_ReplayPC_Athena_C.TeleportToPawn
// (BlueprintCallable, BlueprintEvent)

void ABP_ReplayPC_Athena_C::TeleportToPawn()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("TeleportToPawn");
...
void ABP_ReplayPC_Athena_C::ToggleQuickAccessSettings(bool bVisible)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("ToggleQuickAccessSettings");

	Params::BP_ReplayPC_Athena_C_ToggleQuickAccessSettings Parms{};
