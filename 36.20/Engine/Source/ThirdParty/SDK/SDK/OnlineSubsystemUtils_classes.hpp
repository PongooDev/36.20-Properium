...
static_assert(sizeof(UIpConnection) == 0x001EC0, "Wrong size on UIpConnection");
static_assert(offsetof(UIpConnection, SocketErrorDisconnectDelay) == 0x001EA4, "Member 'UIpConnection::SocketErrorDisconnectDelay' has a wrong offset!");
...
static_assert(sizeof(UIpNetDriver) == 0x000970, "Wrong size on UIpNetDriver");
static_assert(offsetof(UIpNetDriver, MaxPortCountToTry) == 0x0008C4, "Member 'UIpNetDriver::MaxPortCountToTry' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketReceiveBufferBytes) == 0x0008CC, "Member 'UIpNetDriver::ServerDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ServerDesiredSocketSendBufferBytes) == 0x0008D0, "Member 'UIpNetDriver::ServerDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketReceiveBufferBytes) == 0x0008D4, "Member 'UIpNetDriver::ClientDesiredSocketReceiveBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ClientDesiredSocketSendBufferBytes) == 0x0008D8, "Member 'UIpNetDriver::ClientDesiredSocketSendBufferBytes' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, MaxSecondsInReceive) == 0x0008E0, "Member 'UIpNetDriver::MaxSecondsInReceive' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, NbPacketsBetweenReceiveTimeTest) == 0x0008E8, "Member 'UIpNetDriver::NbPacketsBetweenReceiveTimeTest' has a wrong offset!");
static_assert(offsetof(UIpNetDriver, ResolutionConnectionTimeout) == 0x0008EC, "Member 'UIpNetDriver::ResolutionConnectionTimeout' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_8C[0xFC];                                      // 0x008C(0x00FC)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	TArray<struct FOnlineAccountStoredCredentials> Logins;                                            // 0x0038(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
static_assert(alignof(UOnlineBeaconUnitTestNetConnection) == 0x000010, "Wrong alignment on UOnlineBeaconUnitTestNetConnection");
static_assert(sizeof(UOnlineBeaconUnitTestNetConnection) == 0x001EC0, "Wrong size on UOnlineBeaconUnitTestNetConnection");
...
static_assert(sizeof(UOnlineBeaconUnitTestNetDriver) == 0x000970, "Wrong size on UOnlineBeaconUnitTestNetDriver");
