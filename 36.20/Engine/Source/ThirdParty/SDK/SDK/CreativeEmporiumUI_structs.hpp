...
// Enum CreativeEmporiumUI.EFortEmporiumHomeEntrySource
// NumValues: 0x0002
enum class EFortEmporiumHomeEntrySource : uint8
{
	Featured                                 = 0,
	Recents                                  = 1,
};
...
static_assert(offsetof(FFortEmporiumPriceFilterEntry, Filter) == 0x000018, "Member 'FFortEmporiumPriceFilterEntry::Filter' has a wrong offset!");
...
{
public:
	class FName                                   ID;                                                // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ParentID;                                          // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsTab;                                            // 0x0008(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowCategoryModal;                                // 0x0009(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x6];                                        // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           SubcategoryIDList;                                 // 0x0010(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FFortEmporiumFilterEntry, Mode) == 0x000018, "Member 'FFortEmporiumFilterEntry::Mode' has a wrong offset!");
...
static_assert(alignof(FFortEmporiumKeyEdgeMappings) == 0x000008, "Wrong alignment on FFortEmporiumKeyEdgeMappings");
static_assert(sizeof(FFortEmporiumKeyEdgeMappings) == 0x000010, "Wrong size on FFortEmporiumKeyEdgeMappings");
static_assert(offsetof(FFortEmporiumKeyEdgeMappings, Keys) == 0x000000, "Member 'FFortEmporiumKeyEdgeMappings::Keys' has a wrong offset!");
...
static_assert(offsetof(FFortEmporiumSortEntry, Mode) == 0x000010, "Member 'FFortEmporiumSortEntry::Mode' has a wrong offset!");
...
static_assert(offsetof(FFortEmporiumItemLicenseData, License) == 0x000028, "Member 'FFortEmporiumItemLicenseData::License' has a wrong offset!");
static_assert(offsetof(FFortEmporiumItemLicenseData, URL) == 0x000030, "Member 'FFortEmporiumItemLicenseData::URL' has a wrong offset!");
