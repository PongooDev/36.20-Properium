...
static_assert(sizeof(ASpecialEventsCamera_Blueprint_C) == 0x000AA0, "Wrong size on ASpecialEventsCamera_Blueprint_C");
static_assert(offsetof(ASpecialEventsCamera_Blueprint_C, UberGraphFrame) == 0x000A90, "Member 'ASpecialEventsCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
