...
static_assert(sizeof(UGameplayCameraParameterSetterComponent) == 0x0001F8, "Wrong size on UGameplayCameraParameterSetterComponent");
static_assert(offsetof(UGameplayCameraParameterSetterComponent, CameraRigReference) == 0x0000B8, "Member 'UGameplayCameraParameterSetterComponent::CameraRigReference' has a wrong offset!");
static_assert(offsetof(UGameplayCameraParameterSetterComponent, BlendInTime) == 0x0001D8, "Member 'UGameplayCameraParameterSetterComponent::BlendInTime' has a wrong offset!");
static_assert(offsetof(UGameplayCameraParameterSetterComponent, BlendOutTime) == 0x0001DC, "Member 'UGameplayCameraParameterSetterComponent::BlendOutTime' has a wrong offset!");
static_assert(offsetof(UGameplayCameraParameterSetterComponent, BlendType) == 0x0001E0, "Member 'UGameplayCameraParameterSetterComponent::BlendType' has a wrong offset!");
...
static_assert(alignof(AGameplayCamerasPlayerCameraManager) == 0x000010, "Wrong alignment on AGameplayCamerasPlayerCameraManager");
static_assert(sizeof(AGameplayCamerasPlayerCameraManager) == 0x0030E0, "Wrong size on AGameplayCamerasPlayerCameraManager");
static_assert(offsetof(AGameplayCamerasPlayerCameraManager, ViewRotationMode) == 0x0027F0, "Member 'AGameplayCamerasPlayerCameraManager::ViewRotationMode' has a wrong offset!");
static_assert(offsetof(AGameplayCamerasPlayerCameraManager, bOverrideViewRotationMode) == 0x0027F4, "Member 'AGameplayCamerasPlayerCameraManager::bOverrideViewRotationMode' has a wrong offset!");
static_assert(offsetof(AGameplayCamerasPlayerCameraManager, OriginalCameraManager) == 0x0027F8, "Member 'AGameplayCamerasPlayerCameraManager::OriginalCameraManager' has a wrong offset!");
...
// 0x0000 (0x0028 - 0x0028)
class IAssetReferenceCameraNode final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IAssetReferenceCameraNode) == 0x000008, "Wrong alignment on IAssetReferenceCameraNode");
static_assert(sizeof(IAssetReferenceCameraNode) == 0x000028, "Wrong size on IAssetReferenceCameraNode");

// Class GameplayCameras.CustomCameraNodeParameterProvider
// 0x0000 (0x0028 - 0x0028)
class ICustomCameraNodeParameterProvider final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(ICustomCameraNodeParameterProvider) == 0x000008, "Wrong alignment on ICustomCameraNodeParameterProvider");
static_assert(sizeof(ICustomCameraNodeParameterProvider) == 0x000028, "Wrong size on ICustomCameraNodeParameterProvider");

// Class GameplayCameras.GameplayCameraSystemHost
// 0x0000 (0x0028 - 0x0028)
class IGameplayCameraSystemHost final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IGameplayCameraSystemHost) == 0x000008, "Wrong alignment on IGameplayCameraSystemHost");
static_assert(sizeof(IGameplayCameraSystemHost) == 0x000028, "Wrong size on IGameplayCameraSystemHost");
...
public:
	...
	class FName                                   TargetPropertyName;                                // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  Guid;                                              // 0x004C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UCameraObjectInterfaceParameterBase, Guid) == 0x00004C, "Member 'UCameraObjectInterfaceParameterBase::Guid' has a wrong offset!");
...
static_assert(sizeof(UControllerGameplayCameraEvaluationComponent) == 0x0000E8, "Wrong size on UControllerGameplayCameraEvaluationComponent");
static_assert(offsetof(UControllerGameplayCameraEvaluationComponent, CameraSystemHost) == 0x0000D8, "Member 'UControllerGameplayCameraEvaluationComponent::CameraSystemHost' has a wrong offset!");
...
static_assert(sizeof(AGameplayCameraActorBase) == 0x0002A8, "Wrong size on AGameplayCameraActorBase");
...
public:
	...
	class UCineCameraComponent*                   OutputCameraComponent;                             // 0x0260(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(alignof(UGameplayCameraComponentBase) == 0x000010, "Wrong alignment on UGameplayCameraComponentBase");
static_assert(sizeof(UGameplayCameraComponentBase) == 0x000280, "Wrong size on UGameplayCameraComponentBase");
static_assert(offsetof(UGameplayCameraComponentBase, AutoActivateForPlayer) == 0x000258, "Member 'UGameplayCameraComponentBase::AutoActivateForPlayer' has a wrong offset!");
static_assert(offsetof(UGameplayCameraComponentBase, bSetControlRotationWhenViewTarget) == 0x000259, "Member 'UGameplayCameraComponentBase::bSetControlRotationWhenViewTarget' has a wrong offset!");
static_assert(offsetof(UGameplayCameraComponentBase, OutputCameraComponent) == 0x000260, "Member 'UGameplayCameraComponentBase::OutputCameraComponent' has a wrong offset!");
...
public:
	...
	class UCameraAsset*                           Camera;                                            // 0x02B8(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayCameraComponent) == 0x0002C0, "Wrong size on UGameplayCameraComponent");
static_assert(offsetof(UGameplayCameraComponent, CameraReference) == 0x000280, "Member 'UGameplayCameraComponent::CameraReference' has a wrong offset!");
static_assert(offsetof(UGameplayCameraComponent, Camera) == 0x0002B8, "Member 'UGameplayCameraComponent::Camera' has a wrong offset!");
...
{
public:
	class UGameplayCameraRigComponent*            CameraRigComponent;                                // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AGameplayCameraRigActor) == 0x0002B0, "Wrong size on AGameplayCameraRigActor");
static_assert(offsetof(AGameplayCameraRigActor, CameraRigComponent) == 0x0002A8, "Member 'AGameplayCameraRigActor::CameraRigComponent' has a wrong offset!");
...
public:
	...
	class UCameraAsset*                           GeneratedCameraAsset;                              // 0x03A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(alignof(UGameplayCameraRigComponent) == 0x000010, "Wrong alignment on UGameplayCameraRigComponent");
static_assert(sizeof(UGameplayCameraRigComponent) == 0x0003B0, "Wrong size on UGameplayCameraRigComponent");
static_assert(offsetof(UGameplayCameraRigComponent, CameraRigReference) == 0x000280, "Member 'UGameplayCameraRigComponent::CameraRigReference' has a wrong offset!");
static_assert(offsetof(UGameplayCameraRigComponent, GeneratedCameraAsset) == 0x0003A0, "Member 'UGameplayCameraRigComponent::GeneratedCameraAsset' has a wrong offset!");
...
static_assert(sizeof(UGameplayCameraSystemComponent) == 0x000270, "Wrong size on UGameplayCameraSystemComponent");
static_assert(offsetof(UGameplayCameraSystemComponent, AutoActivateForPlayer) == 0x000258, "Member 'UGameplayCameraSystemComponent::AutoActivateForPlayer' has a wrong offset!");
static_assert(offsetof(UGameplayCameraSystemComponent, bSetPlayerControllerRotation) == 0x000259, "Member 'UGameplayCameraSystemComponent::bSetPlayerControllerRotation' has a wrong offset!");
static_assert(offsetof(UGameplayCameraSystemComponent, WeakPlayerController) == 0x00025C, "Member 'UGameplayCameraSystemComponent::WeakPlayerController' has a wrong offset!");
...
{
public:
	TArray<class UInputAction*>                   AxisActions;                                       // 0x00B8(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	class APlayerController*                      PlayerController;                                  // 0x00D8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UGameplayControlRotationComponent) == 0x000100, "Wrong size on UGameplayControlRotationComponent");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActions) == 0x0000B8, "Member 'UGameplayControlRotationComponent::AxisActions' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActionAngularSpeedThreshold) == 0x0000C8, "Member 'UGameplayControlRotationComponent::AxisActionAngularSpeedThreshold' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AxisActionMagnitudeThreshold) == 0x0000CC, "Member 'UGameplayControlRotationComponent::AxisActionMagnitudeThreshold' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, AutoActivateForPlayer) == 0x0000D0, "Member 'UGameplayControlRotationComponent::AutoActivateForPlayer' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, PlayerController) == 0x0000D8, "Member 'UGameplayControlRotationComponent::PlayerController' has a wrong offset!");
static_assert(offsetof(UGameplayControlRotationComponent, CameraSystemHost) == 0x0000E0, "Member 'UGameplayControlRotationComponent::CameraSystemHost' has a wrong offset!");
...
{
public:
	bool                                          bAutoBuildInPIE;                                   // 0x0030(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	EGameplayCamerasViewRotationMode              DefaultViewRotationMode;                           // 0x0034(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         CombinedCameraRigNumThreshold;                     // 0x0038(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayCamerasSettings, bAutoBuildInPIE) == 0x000030, "Member 'UGameplayCamerasSettings::bAutoBuildInPIE' has a wrong offset!");
static_assert(offsetof(UGameplayCamerasSettings, DefaultViewRotationMode) == 0x000034, "Member 'UGameplayCamerasSettings::DefaultViewRotationMode' has a wrong offset!");
static_assert(offsetof(UGameplayCamerasSettings, CombinedCameraRigNumThreshold) == 0x000038, "Member 'UGameplayCamerasSettings::CombinedCameraRigNumThreshold' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneCameraFramingZoneTrack) == 0x000138, "Wrong size on UMovieSceneCameraFramingZoneTrack");
...
{
public:
	struct FCameraActorAttachmentInfo             Attachment;                                        // 0x0038(0x0018)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FCameraContextDataID                   AttachmentDataID;                                  // 0x0050(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FBooleanCameraParameter                AttachToLocation;                                  // 0x0058(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBooleanCameraParameter                AttachToRotation;                                  // 0x0068(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAttachToActorCameraNode) == 0x000078, "Wrong size on UAttachToActorCameraNode");
...
static_assert(offsetof(UAttachToActorCameraNode, AttachmentDataID) == 0x000050, "Member 'UAttachToActorCameraNode::AttachmentDataID' has a wrong offset!");
static_assert(offsetof(UAttachToActorCameraNode, AttachToLocation) == 0x000058, "Member 'UAttachToActorCameraNode::AttachToLocation' has a wrong offset!");
static_assert(offsetof(UAttachToActorCameraNode, AttachToRotation) == 0x000068, "Member 'UAttachToActorCameraNode::AttachToRotation' has a wrong offset!");
...
static_assert(sizeof(UPostProcessCameraNode) == 0x0007A0, "Wrong size on UPostProcessCameraNode");
...
public:
	...
	struct FCameraActorTargetInfo                 TargetInfo;                                        // 0x0148(0x0020)(Deprecated, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UBaseFramingCameraNode) == 0x000168, "Wrong size on UBaseFramingCameraNode");
...
{
public:
	struct FBooleanCameraParameter                CanMoveLaterally;                                  // 0x0168(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBooleanCameraParameter                CanMoveVertically;                                 // 0x0178(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDollyFramingCameraNode) == 0x000188, "Wrong size on UDollyFramingCameraNode");
static_assert(offsetof(UDollyFramingCameraNode, CanMoveLaterally) == 0x000168, "Member 'UDollyFramingCameraNode::CanMoveLaterally' has a wrong offset!");
static_assert(offsetof(UDollyFramingCameraNode, CanMoveVertically) == 0x000178, "Member 'UDollyFramingCameraNode::CanMoveVertically' has a wrong offset!");
...
{
public:
	struct FBooleanCameraParameter                CanPanLaterally;                                   // 0x0168(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FBooleanCameraParameter                CanPanVertically;                                  // 0x0178(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UPanningFramingCameraNode) == 0x000188, "Wrong size on UPanningFramingCameraNode");
static_assert(offsetof(UPanningFramingCameraNode, CanPanLaterally) == 0x000168, "Member 'UPanningFramingCameraNode::CanPanLaterally' has a wrong offset!");
static_assert(offsetof(UPanningFramingCameraNode, CanPanVertically) == 0x000178, "Member 'UPanningFramingCameraNode::CanPanVertically' has a wrong offset!");
