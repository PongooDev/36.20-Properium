...
static_assert(alignof(UVerseDeviceHealth) == 0x000008, "Wrong alignment on UVerseDeviceHealth");
static_assert(sizeof(UVerseDeviceHealth) == 0x000030, "Wrong size on UVerseDeviceHealth");
...
static_assert(offsetof(UPlaylistUserOptionScript, OptionValues) == 0x0001B8, "Member 'UPlaylistUserOptionScript::OptionValues' has a wrong offset!");
static_assert(offsetof(UPlaylistUserOptionScript, DefaultValueIndex) == 0x0001C8, "Member 'UPlaylistUserOptionScript::DefaultValueIndex' has a wrong offset!");
...
public:
	...
	class UVerseCreativeDevice*                   Script;                                            // 0x0C08(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, SaveGame, NoDestructor, Protected, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVerseCreativeDevice*                   ScriptInstance;                                    // 0x0C10(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AScriptDevice) == 0x000C28, "Wrong size on AScriptDevice");
static_assert(offsetof(AScriptDevice, Script) == 0x000C08, "Member 'AScriptDevice::Script' has a wrong offset!");
static_assert(offsetof(AScriptDevice, ScriptInstance) == 0x000C10, "Member 'AScriptDevice::ScriptInstance' has a wrong offset!");
...
{
public:
	class AActor*                                 SavedActor;                                        // 0x00A0(0x0008)(Edit, ZeroConstructor, SaveGame, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UVerseCreativeObjectQuotaHelperComponent) == 0x0000D0, "Wrong size on UVerseCreativeObjectQuotaHelperComponent");
...
static_assert(sizeof(UVerseDeviceSubsystem) == 0x0000E0, "Wrong size on UVerseDeviceSubsystem");
