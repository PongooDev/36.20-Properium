...
static_assert(sizeof(UMediaTexture) == 0x000228, "Wrong size on UMediaTexture");
...
static_assert(offsetof(UMediaTexture, NewStyleOutput) == 0x000155, "Member 'UMediaTexture::NewStyleOutput' has a wrong offset!");
