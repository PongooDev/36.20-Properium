...
{
public:
	class UFortMobileImage*                       SpeakerIcon;                                       // 0x03C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UFortVoiceChannelSpeakerContainer_C) == 0x0003D0, "Wrong size on UFortVoiceChannelSpeakerContainer_C");
static_assert(offsetof(UFortVoiceChannelSpeakerContainer_C, SpeakerIcon) == 0x0003C0, "Member 'UFortVoiceChannelSpeakerContainer_C::SpeakerIcon' has a wrong offset!");
