...
public:
	...
	struct FGameplayDebuggerDebugActor            DebugActor;                                        // 0x02D0(0x0010)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AGameplayDebuggerCategoryReplicator) == 0x000360, "Wrong size on AGameplayDebuggerCategoryReplicator");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, OwnerPC) == 0x0002A8, "Member 'AGameplayDebuggerCategoryReplicator::OwnerPC' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, bIsEnabled) == 0x0002B0, "Member 'AGameplayDebuggerCategoryReplicator::bIsEnabled' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, ReplicatedData) == 0x0002B8, "Member 'AGameplayDebuggerCategoryReplicator::ReplicatedData' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, DebugActor) == 0x0002D0, "Member 'AGameplayDebuggerCategoryReplicator::DebugActor' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, VisLogSync) == 0x0002E0, "Member 'AGameplayDebuggerCategoryReplicator::VisLogSync' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerCategoryReplicator, RenderingComp) == 0x0002F0, "Member 'AGameplayDebuggerCategoryReplicator::RenderingComp' has a wrong offset!");
...
public:
	...
	TSet<class FName>                             EnabledCategories;                                 // 0x0040(0x0050)(Edit, Config, NativeAccessSpecifierPublic)
	int32                                         FontSize;                                          // 0x0090(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayDebuggerUserSettings) == 0x000098, "Wrong size on UGameplayDebuggerUserSettings");
...
static_assert(offsetof(UGameplayDebuggerUserSettings, EnabledCategories) == 0x000040, "Member 'UGameplayDebuggerUserSettings::EnabledCategories' has a wrong offset!");
static_assert(offsetof(UGameplayDebuggerUserSettings, FontSize) == 0x000090, "Member 'UGameplayDebuggerUserSettings::FontSize' has a wrong offset!");
...
static_assert(sizeof(AGameplayDebuggerPlayerManager) == 0x0002D8, "Wrong size on AGameplayDebuggerPlayerManager");
static_assert(offsetof(AGameplayDebuggerPlayerManager, PlayerData) == 0x0002B0, "Member 'AGameplayDebuggerPlayerManager::PlayerData' has a wrong offset!");
static_assert(offsetof(AGameplayDebuggerPlayerManager, PendingRegistrations) == 0x0002C0, "Member 'AGameplayDebuggerPlayerManager::PendingRegistrations' has a wrong offset!");
...
static_assert(sizeof(UGameplayDebuggerRenderingComponent) == 0x0005F0, "Wrong size on UGameplayDebuggerRenderingComponent");
