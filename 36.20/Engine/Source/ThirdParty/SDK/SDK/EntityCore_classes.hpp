...
static_assert(alignof(EntityCore::UEntity) == 0x000008, "Wrong alignment on EntityCore::UEntity");
static_assert(sizeof(EntityCore::UEntity) == 0x000038, "Wrong size on EntityCore::UEntity");
static_assert(offsetof(EntityCore::UEntity, Level) == 0x000030, "Member 'EntityCore::UEntity::Level' has a wrong offset!");
