...
static_assert(alignof(BP_AudioParameterComponent_Pawn_C_ExecuteUbergraph_BP_AudioParameterComponent_Pawn) == 0x000004, "Wrong alignment on BP_AudioParameterComponent_Pawn_C_ExecuteUbergraph_BP_AudioParameterComponent_Pawn");
static_assert(sizeof(BP_AudioParameterComponent_Pawn_C_ExecuteUbergraph_BP_AudioParameterComponent_Pawn) == 0x000004, "Wrong size on BP_AudioParameterComponent_Pawn_C_ExecuteUbergraph_BP_AudioParameterComponent_Pawn");
...
public:
	...
	TDelegate<void(int32 FootIndex)>              K2Node_CreateDelegate_OutputDelegate;              // 0x0008(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	TDelegate<void(int32 FootIndex)>              K2Node_CreateDelegate_OutputDelegate;              // 0x000C(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	float                                         CallFunc_GetWaterDepthValue_ReturnValue;           // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsSurfaceSwimming_ReturnValue;            // 0x000B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate) == 0x000020, "Wrong size on BP_AudioParameterComponent_Pawn_C_OnWaterUpdate");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, FootIndex) == 0x000000, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::FootIndex' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_GetWaterDepthValue_ReturnValue) == 0x000004, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_GetWaterDepthValue_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000008, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_Greater_DoubleDouble_ReturnValue_1) == 0x000009, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_Greater_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x00000A, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_IsSurfaceSwimming_ReturnValue) == 0x00000B, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_IsSurfaceSwimming_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_Greater_DoubleDouble_A_ImplicitCast) == 0x000010, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_Greater_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(BP_AudioParameterComponent_Pawn_C_OnWaterUpdate, CallFunc_Greater_DoubleDouble_A_ImplicitCast_1) == 0x000018, "Member 'BP_AudioParameterComponent_Pawn_C_OnWaterUpdate::CallFunc_Greater_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
