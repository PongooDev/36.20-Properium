...
public:
	...
	class UBodySetup*                             ProcMeshBodySetup;                                 // 0x0570(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UProceduralMeshComponent, AsyncBodySetupQueue) == 0x0005D0, "Member 'UProceduralMeshComponent::AsyncBodySetupQueue' has a wrong offset!");
