...
public:
	...
	TArray<struct FUIFrameworkWidgetTreeEntry>    Entries;                                           // 0x0150(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	class AActor*                                 ReplicatedOwner;                                   // 0x0160(0x0008)(ZeroConstructor, Transient, RepSkip, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FUIFrameworkWidgetTree) == 0x000210, "Wrong size on FUIFrameworkWidgetTree");
static_assert(offsetof(FUIFrameworkWidgetTree, Entries) == 0x000150, "Member 'FUIFrameworkWidgetTree::Entries' has a wrong offset!");
static_assert(offsetof(FUIFrameworkWidgetTree, ReplicatedOwner) == 0x000160, "Member 'FUIFrameworkWidgetTree::ReplicatedOwner' has a wrong offset!");
...
static_assert(offsetof(FUIFrameworkUserWidgetNamedSlot, SlotName) == 0x000028, "Member 'FUIFrameworkUserWidgetNamedSlot::SlotName' has a wrong offset!");
...
static_assert(offsetof(FUIFrameworkUserWidgetNamedSlotList, Slots) == 0x000108, "Member 'FUIFrameworkUserWidgetNamedSlotList::Slots' has a wrong offset!");
static_assert(offsetof(FUIFrameworkUserWidgetNamedSlotList, Owner) == 0x000118, "Member 'FUIFrameworkUserWidgetNamedSlotList::Owner' has a wrong offset!");
