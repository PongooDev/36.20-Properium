...
static_assert(sizeof(UPhysicsControlAsset) == 0x000210, "Wrong size on UPhysicsControlAsset");
...
static_assert(offsetof(UPhysicsControlAsset, AdditionalControlsAndModifiers) == 0x0000F0, "Member 'UPhysicsControlAsset::AdditionalControlsAndModifiers' has a wrong offset!");
static_assert(offsetof(UPhysicsControlAsset, AdditionalSets) == 0x000190, "Member 'UPhysicsControlAsset::AdditionalSets' has a wrong offset!");
static_assert(offsetof(UPhysicsControlAsset, InitialControlAndModifierUpdates) == 0x0001B0, "Member 'UPhysicsControlAsset::InitialControlAndModifierUpdates' has a wrong offset!");
static_assert(offsetof(UPhysicsControlAsset, Profiles) == 0x0001C0, "Member 'UPhysicsControlAsset::Profiles' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class UPhysicsControlAsset>    PhysicsControlAsset;                               // 0x0240(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TeleportDistanceThreshold;                         // 0x0260(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TeleportRotationThreshold;                         // 0x0264(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugVisualization;                           // 0x0268(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_269[0x3];                                      // 0x0269(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         VisualizationSizeScale;                            // 0x026C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugControlList;                             // 0x0270(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_271[0x7];                                      // 0x0271(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DebugControlDetailFilter;                          // 0x0278(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugBodyModifierList;                        // 0x0288(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_289[0x7];                                      // 0x0289(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DebugBodyModifierDetailFilter;                     // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         VelocityPredictionTime;                            // 0x02A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MaxNumControlsOrModifiersPerName;                  // 0x02A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bWarnAboutInvalidNames;                            // 0x02A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2A9[0x1F7];                                    // 0x02A9(0x01F7)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UPhysicsControlComponent) == 0x0004A0, "Wrong size on UPhysicsControlComponent");
static_assert(offsetof(UPhysicsControlComponent, PhysicsControlAsset) == 0x000240, "Member 'UPhysicsControlComponent::PhysicsControlAsset' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, TeleportDistanceThreshold) == 0x000260, "Member 'UPhysicsControlComponent::TeleportDistanceThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, TeleportRotationThreshold) == 0x000264, "Member 'UPhysicsControlComponent::TeleportRotationThreshold' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugVisualization) == 0x000268, "Member 'UPhysicsControlComponent::bShowDebugVisualization' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VisualizationSizeScale) == 0x00026C, "Member 'UPhysicsControlComponent::VisualizationSizeScale' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugControlList) == 0x000270, "Member 'UPhysicsControlComponent::bShowDebugControlList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugControlDetailFilter) == 0x000278, "Member 'UPhysicsControlComponent::DebugControlDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bShowDebugBodyModifierList) == 0x000288, "Member 'UPhysicsControlComponent::bShowDebugBodyModifierList' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, DebugBodyModifierDetailFilter) == 0x000290, "Member 'UPhysicsControlComponent::DebugBodyModifierDetailFilter' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, VelocityPredictionTime) == 0x0002A0, "Member 'UPhysicsControlComponent::VelocityPredictionTime' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, MaxNumControlsOrModifiersPerName) == 0x0002A4, "Member 'UPhysicsControlComponent::MaxNumControlsOrModifiersPerName' has a wrong offset!");
static_assert(offsetof(UPhysicsControlComponent, bWarnAboutInvalidNames) == 0x0002A8, "Member 'UPhysicsControlComponent::bWarnAboutInvalidNames' has a wrong offset!");
...
static_assert(sizeof(UPhysicsControlInitializerComponent) == 0x0003C0, "Wrong size on UPhysicsControlInitializerComponent");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialCharacterControls) == 0x000240, "Member 'UPhysicsControlInitializerComponent::InitialCharacterControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialControls) == 0x000310, "Member 'UPhysicsControlInitializerComponent::InitialControls' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, InitialBodyModifiers) == 0x000360, "Member 'UPhysicsControlInitializerComponent::InitialBodyModifiers' has a wrong offset!");
static_assert(offsetof(UPhysicsControlInitializerComponent, bCreateControlsAtBeginPlay) == 0x0003B0, "Member 'UPhysicsControlInitializerComponent::bCreateControlsAtBeginPlay' has a wrong offset!");
...
{
public:
	class UPhysicsControlComponent*               ControlComponent;                                  // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UPhysicsControlInitializerComponent*    ControlInitializerComponent;                       // 0x02B0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(APhysicsControlActor) == 0x0002B8, "Wrong size on APhysicsControlActor");
static_assert(offsetof(APhysicsControlActor, ControlComponent) == 0x0002A8, "Member 'APhysicsControlActor::ControlComponent' has a wrong offset!");
static_assert(offsetof(APhysicsControlActor, ControlInitializerComponent) == 0x0002B0, "Member 'APhysicsControlActor::ControlInitializerComponent' has a wrong offset!");
