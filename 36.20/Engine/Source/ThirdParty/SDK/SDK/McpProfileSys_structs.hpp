...
static_assert(alignof(FProfileDataOmissionGroupsDefinition) == 0x000008, "Wrong alignment on FProfileDataOmissionGroupsDefinition");
static_assert(sizeof(FProfileDataOmissionGroupsDefinition) == 0x000020, "Wrong size on FProfileDataOmissionGroupsDefinition");
static_assert(offsetof(FProfileDataOmissionGroupsDefinition, ProfileId) == 0x000000, "Member 'FProfileDataOmissionGroupsDefinition::ProfileId' has a wrong offset!");
static_assert(offsetof(FProfileDataOmissionGroupsDefinition, OmissionGroups) == 0x000010, "Member 'FProfileDataOmissionGroupsDefinition::OmissionGroups' has a wrong offset!");
...
static_assert(offsetof(FMultiProfileUpdate, ProfileWeakPtr) == 0x000000, "Member 'FMultiProfileUpdate::ProfileWeakPtr' has a wrong offset!");
static_assert(offsetof(FMultiProfileUpdate, bSkipPreload) == 0x000008, "Member 'FMultiProfileUpdate::bSkipPreload' has a wrong offset!");
