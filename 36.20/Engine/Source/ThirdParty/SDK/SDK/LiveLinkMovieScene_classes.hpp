...
public:
	...
	TArray<class UMovieSceneLiveLinkSubSection*>  Subsections;                                       // 0x0150(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_160[0x10];                                     // 0x0160(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   SubjectName;                                       // 0x0170(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectPreset) == 0x000108, "Member 'UMovieSceneLiveLinkSection::SubjectPreset' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, ChannelMask) == 0x000140, "Member 'UMovieSceneLiveLinkSection::ChannelMask' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, Subsections) == 0x000150, "Member 'UMovieSceneLiveLinkSection::Subsections' has a wrong offset!");
static_assert(offsetof(UMovieSceneLiveLinkSection, SubjectName) == 0x000170, "Member 'UMovieSceneLiveLinkSection::SubjectName' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneLiveLinkTrack) == 0x000148, "Wrong size on UMovieSceneLiveLinkTrack");
static_assert(offsetof(UMovieSceneLiveLinkTrack, TrackRole) == 0x000140, "Member 'UMovieSceneLiveLinkTrack::TrackRole' has a wrong offset!");
