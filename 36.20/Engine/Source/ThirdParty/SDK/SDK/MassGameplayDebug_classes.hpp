...
static_assert(sizeof(UMassDebugVisualizationComponent) == 0x0000B8, "Wrong size on UMassDebugVisualizationComponent");
...
static_assert(sizeof(AMassDebugVisualizer) == 0x0002A8, "Wrong size on AMassDebugVisualizer");
