...
{
public:
	class FName                                   Path;                                              // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FSolarisProfilingData) == 0x000008, "Wrong alignment on FSolarisProfilingData");
...
static_assert(alignof(FRemoteObjectReference) == 0x000008, "Wrong alignment on FRemoteObjectReference");
...
{
public:
	TObjectPtr ScriptStruct;
	void* Struct;
public:
	uintptr_t GetType() const { return ScriptStruct.ObjectPtr.Handle.pointerOrRef; }
	bool operator==(const FInstancedStruct& Other) const
	{
		return ScriptStruct.DebugPtr == Other.ScriptStruct.DebugPtr
			&& Struct == Other.Struct;
	}
...
static_assert(alignof(FProfileLocus) == 0x000008, "Wrong alignment on FProfileLocus");
...
public:
	...
	uint64                                        PropertyFlags;                                     // 0x0020(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_28[0x10];                                      // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPropertyBagPropertyDesc) == 0x000008, "Wrong alignment on FPropertyBagPropertyDesc");
static_assert(sizeof(FPropertyBagPropertyDesc) == 0x000038, "Wrong size on FPropertyBagPropertyDesc");
...
static_assert(offsetof(FPropertyBagPropertyDesc, PropertyFlags) == 0x000020, "Member 'FPropertyBagPropertyDesc::PropertyFlags' has a wrong offset!");
