...
struct MidiSongPosFunctionLibrary_IsSongPosValid final
{
public:
...
static_assert(alignof(MidiSongPosFunctionLibrary_IsSongPosValid) == 0x000008, "Wrong alignment on MidiSongPosFunctionLibrary_IsSongPosValid");
static_assert(sizeof(MidiSongPosFunctionLibrary_IsSongPosValid) == 0x000050, "Wrong size on MidiSongPosFunctionLibrary_IsSongPosValid");
static_assert(offsetof(MidiSongPosFunctionLibrary_IsSongPosValid, SongPos) == 0x000000, "Member 'MidiSongPosFunctionLibrary_IsSongPosValid::SongPos' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_IsSongPosValid, ReturnValue) == 0x000048, "Member 'MidiSongPosFunctionLibrary_IsSongPosValid::ReturnValue' has a wrong offset!");

// Function HarmonixMidi.MidiSongPosFunctionLibrary.LerpSongPos
// 0x00E0 (0x00E0 - 0x0000)
struct MidiSongPosFunctionLibrary_LerpSongPos final
{
public:
	struct FMidiSongPos                           A;                                                 // 0x0000(0x0048)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct FMidiSongPos                           B;                                                 // 0x0048(0x0048)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	...
	struct FMidiSongPos                           ReturnValue;                                       // 0x0098(0x0048)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(MidiSongPosFunctionLibrary_LerpSongPos) == 0x000008, "Wrong alignment on MidiSongPosFunctionLibrary_LerpSongPos");
static_assert(sizeof(MidiSongPosFunctionLibrary_LerpSongPos) == 0x0000E0, "Wrong size on MidiSongPosFunctionLibrary_LerpSongPos");
static_assert(offsetof(MidiSongPosFunctionLibrary_LerpSongPos, A) == 0x000000, "Member 'MidiSongPosFunctionLibrary_LerpSongPos::A' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_LerpSongPos, B) == 0x000048, "Member 'MidiSongPosFunctionLibrary_LerpSongPos::B' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_LerpSongPos, Alpha) == 0x000090, "Member 'MidiSongPosFunctionLibrary_LerpSongPos::Alpha' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_LerpSongPos, ReturnValue) == 0x000098, "Member 'MidiSongPosFunctionLibrary_LerpSongPos::ReturnValue' has a wrong offset!");

// Function HarmonixMidi.MidiSongPosFunctionLibrary.MakeSongPosFromTime
// 0x0060 (0x0060 - 0x0000)
struct MidiSongPosFunctionLibrary_MakeSongPosFromTime final
{
public:
	...
	float                                         BeatsPerMinute;                                    // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TimeSignatureNumerator;                            // 0x0008(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TimeSignatureDenominator;                          // 0x000C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StartBar;                                          // 0x0010(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_14[0x4];                                       // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FMidiSongPos                           ReturnValue;                                       // 0x0018(0x0048)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(MidiSongPosFunctionLibrary_MakeSongPosFromTime) == 0x000008, "Wrong alignment on MidiSongPosFunctionLibrary_MakeSongPosFromTime");
static_assert(sizeof(MidiSongPosFunctionLibrary_MakeSongPosFromTime) == 0x000060, "Wrong size on MidiSongPosFunctionLibrary_MakeSongPosFromTime");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, TimeMs) == 0x000000, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::TimeMs' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, BeatsPerMinute) == 0x000004, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::BeatsPerMinute' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, TimeSignatureNumerator) == 0x000008, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::TimeSignatureNumerator' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, TimeSignatureDenominator) == 0x00000C, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::TimeSignatureDenominator' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, StartBar) == 0x000010, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::StartBar' has a wrong offset!");
static_assert(offsetof(MidiSongPosFunctionLibrary_MakeSongPosFromTime, ReturnValue) == 0x000018, "Member 'MidiSongPosFunctionLibrary_MakeSongPosFromTime::ReturnValue' has a wrong offset!");
