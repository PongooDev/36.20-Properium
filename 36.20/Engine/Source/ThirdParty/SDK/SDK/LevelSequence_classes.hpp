...
public:
	...
	struct FWorldPartitionResolveData             WorldPartitionResolveData;                         // 0x032C(0x0018)(NoDestructor, NativeAccessSpecifierPrivate)
...
{
public:
	struct FLevelSequencePlayerSnapshot           FrameInformation;                                  // 0x02F8(0x00A0)(BlueprintVisible, BlueprintReadOnly, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class ALevelSequenceActor*                    LevelSequenceActor;                                // 0x0398(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ULevelSequenceBurnIn) == 0x0003A0, "Wrong size on ULevelSequenceBurnIn");
...
static_assert(offsetof(ULevelSequenceBurnIn, LevelSequenceActor) == 0x000398, "Member 'ULevelSequenceBurnIn::LevelSequenceActor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_488[0xF0];                                     // 0x0488(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(ULevelSequencePlayer) == 0x000578, "Wrong size on ULevelSequencePlayer");
