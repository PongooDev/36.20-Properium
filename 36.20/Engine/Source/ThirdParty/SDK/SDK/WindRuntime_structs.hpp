...
static_assert(sizeof(FRootMotionSource_ConstantWindForce) == 0x0000E0, "Wrong size on FRootMotionSource_ConstantWindForce");
static_assert(offsetof(FRootMotionSource_ConstantWindForce, Force) == 0x0000C0, "Member 'FRootMotionSource_ConstantWindForce::Force' has a wrong offset!");
static_assert(offsetof(FRootMotionSource_ConstantWindForce, StrengthOverTime) == 0x0000D8, "Member 'FRootMotionSource_ConstantWindForce::StrengthOverTime' has a wrong offset!");
