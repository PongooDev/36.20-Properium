...
static_assert(offsetof(FortContentGateRatingWidget_OnLabelUpdated, LabelNumber) == 0x000018, "Member 'FortContentGateRatingWidget_OnLabelUpdated::LabelNumber' has a wrong offset!");
...
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, ActivityDescription) == 0x000010, "Member 'FortContentManagementDetails_OnShowActivityData::ActivityDescription' has a wrong offset!");
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, CreatorName) == 0x000020, "Member 'FortContentManagementDetails_OnShowActivityData::CreatorName' has a wrong offset!");
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, LinkCode) == 0x000030, "Member 'FortContentManagementDetails_OnShowActivityData::LinkCode' has a wrong offset!");
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, IsCreative) == 0x000040, "Member 'FortContentManagementDetails_OnShowActivityData::IsCreative' has a wrong offset!");
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, UnlockTime) == 0x000048, "Member 'FortContentManagementDetails_OnShowActivityData::UnlockTime' has a wrong offset!");
static_assert(offsetof(FortContentManagementDetails_OnShowActivityData, GameActivity) == 0x000050, "Member 'FortContentManagementDetails_OnShowActivityData::GameActivity' has a wrong offset!");

// Function SqueegeeUI.FortContentManagementButton.GetDataObject
// 0x0008 (0x0008 - 0x0000)
struct FortContentManagementButton_GetDataObject final
{
public:
	class UFortContentManagementEntryDataObject*  ReturnValue;                                       // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortContentManagementButton_GetDataObject) == 0x000008, "Wrong alignment on FortContentManagementButton_GetDataObject");
static_assert(sizeof(FortContentManagementButton_GetDataObject) == 0x000008, "Wrong size on FortContentManagementButton_GetDataObject");
static_assert(offsetof(FortContentManagementButton_GetDataObject, ReturnValue) == 0x000000, "Member 'FortContentManagementButton_GetDataObject::ReturnValue' has a wrong offset!");

// Function SqueegeeUI.FortContentManagementButton.GetManagementState
// 0x0001 (0x0001 - 0x0000)
struct FortContentManagementButton_GetManagementState final
{
public:
	EFortContentManagementState                   ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortContentManagementButton_GetManagementState) == 0x000001, "Wrong alignment on FortContentManagementButton_GetManagementState");
static_assert(sizeof(FortContentManagementButton_GetManagementState) == 0x000001, "Wrong size on FortContentManagementButton_GetManagementState");
static_assert(offsetof(FortContentManagementButton_GetManagementState, ReturnValue) == 0x000000, "Member 'FortContentManagementButton_GetManagementState::ReturnValue' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct FortContentManagementButton_SetManagementState final
{
public:
...
static_assert(alignof(FortContentManagementButton_SetManagementState) == 0x000001, "Wrong alignment on FortContentManagementButton_SetManagementState");
static_assert(sizeof(FortContentManagementButton_SetManagementState) == 0x000001, "Wrong size on FortContentManagementButton_SetManagementState");
static_assert(offsetof(FortContentManagementButton_SetManagementState, NewState) == 0x000000, "Member 'FortContentManagementButton_SetManagementState::NewState' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct FortContentManagementVM_SetSelectedButton final
{
public:
	class UFortContentManagementButton*           InButton;                                          // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortContentManagementVM_SetSelectedButton) == 0x000008, "Wrong alignment on FortContentManagementVM_SetSelectedButton");
static_assert(sizeof(FortContentManagementVM_SetSelectedButton) == 0x000008, "Wrong size on FortContentManagementVM_SetSelectedButton");
static_assert(offsetof(FortContentManagementVM_SetSelectedButton, InButton) == 0x000000, "Member 'FortContentManagementVM_SetSelectedButton::InButton' has a wrong offset!");

// Function SqueegeeUI.FortContentManagementVM.SetSelectedLockState
// 0x0001 (0x0001 - 0x0000)
struct FortContentManagementVM_SetSelectedLockState final
{
public:
	EFortContentManagementState                   InLockState;                                       // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortContentManagementVM_SetSelectedLockState) == 0x000001, "Wrong alignment on FortContentManagementVM_SetSelectedLockState");
static_assert(sizeof(FortContentManagementVM_SetSelectedLockState) == 0x000001, "Wrong size on FortContentManagementVM_SetSelectedLockState");
static_assert(offsetof(FortContentManagementVM_SetSelectedLockState, InLockState) == 0x000000, "Member 'FortContentManagementVM_SetSelectedLockState::InLockState' has a wrong offset!");
