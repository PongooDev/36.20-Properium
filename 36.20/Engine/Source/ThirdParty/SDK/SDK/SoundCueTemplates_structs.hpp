...
static_assert(sizeof(FSoundCueTemplateQualitySettings) == 0x000020, "Wrong size on FSoundCueTemplateQualitySettings");
...
static_assert(offsetof(FSoundCueTemplateQualitySettings, MaxConcatenatedVariations) == 0x000010, "Member 'FSoundCueTemplateQualitySettings::MaxConcatenatedVariations' has a wrong offset!");
static_assert(offsetof(FSoundCueTemplateQualitySettings, MaxRandomizedVariations) == 0x000014, "Member 'FSoundCueTemplateQualitySettings::MaxRandomizedVariations' has a wrong offset!");
static_assert(offsetof(FSoundCueTemplateQualitySettings, MaxMixVariations) == 0x000018, "Member 'FSoundCueTemplateQualitySettings::MaxMixVariations' has a wrong offset!");
