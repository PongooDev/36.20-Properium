...
static_assert(sizeof(USoundControlBusMix) == 0x000050, "Wrong size on USoundControlBusMix");
...
static_assert(offsetof(USoundControlBusMix, duration) == 0x000030, "Member 'USoundControlBusMix::duration' has a wrong offset!");
static_assert(offsetof(USoundControlBusMix, bRetriggerOnActivation) == 0x000038, "Member 'USoundControlBusMix::bRetriggerOnActivation' has a wrong offset!");
static_assert(offsetof(USoundControlBusMix, MixStages) == 0x000040, "Member 'USoundControlBusMix::MixStages' has a wrong offset!");
