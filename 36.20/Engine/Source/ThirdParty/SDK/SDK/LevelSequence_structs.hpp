...
public:
	...
	TArray<class FString>                         IncludeAnimationNames;                             // 0x0030(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         ExcludeAnimationNames;                             // 0x0040(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FFrameNumber                           WarmUpFrames;                                      // 0x0050(0x0004)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           DelayBeforeStart;                                  // 0x0054(0x0004)(BlueprintVisible, ZeroConstructor, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseCustomTimeRange;                               // 0x0058(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x3];                                       // 0x0059(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFrameNumber                           CustomStartFrame;                                  // 0x005C(0x0004)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           CustomEndFrame;                                    // 0x0060(0x0004)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameRate                             CustomDisplayRate;                                 // 0x0064(0x0008)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseCustomFrameRate;                               // 0x006C(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_6D[0x3];                                       // 0x006D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FFrameRate                             CustomFrameRate;                                   // 0x0070(0x0008)(BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, IncludeAnimationNames) == 0x000030, "Member 'FLevelSequenceAnimSequenceLinkItem::IncludeAnimationNames' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, ExcludeAnimationNames) == 0x000040, "Member 'FLevelSequenceAnimSequenceLinkItem::ExcludeAnimationNames' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, WarmUpFrames) == 0x000050, "Member 'FLevelSequenceAnimSequenceLinkItem::WarmUpFrames' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, DelayBeforeStart) == 0x000054, "Member 'FLevelSequenceAnimSequenceLinkItem::DelayBeforeStart' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bUseCustomTimeRange) == 0x000058, "Member 'FLevelSequenceAnimSequenceLinkItem::bUseCustomTimeRange' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CustomStartFrame) == 0x00005C, "Member 'FLevelSequenceAnimSequenceLinkItem::CustomStartFrame' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CustomEndFrame) == 0x000060, "Member 'FLevelSequenceAnimSequenceLinkItem::CustomEndFrame' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CustomDisplayRate) == 0x000064, "Member 'FLevelSequenceAnimSequenceLinkItem::CustomDisplayRate' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, bUseCustomFrameRate) == 0x00006C, "Member 'FLevelSequenceAnimSequenceLinkItem::bUseCustomFrameRate' has a wrong offset!");
static_assert(offsetof(FLevelSequenceAnimSequenceLinkItem, CustomFrameRate) == 0x000070, "Member 'FLevelSequenceAnimSequenceLinkItem::CustomFrameRate' has a wrong offset!");
...
static_assert(sizeof(FLevelSequencePlayerSnapshot) == 0x0000A0, "Wrong size on FLevelSequencePlayerSnapshot");
