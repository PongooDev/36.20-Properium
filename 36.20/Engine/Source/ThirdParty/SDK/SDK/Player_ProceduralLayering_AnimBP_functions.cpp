...
void UPlayer_ProceduralLayering_AnimBP_C::AdditiveLayering(const struct FPoseLink& AddLayer_InLocomotionPose, const struct FPoseLink& AddLayer_InBasePose, const struct FPoseLink& InPoseSourcePose, struct FPoseLink* AdditiveLayering_0)
{
...
// struct FPoseLink                        AdditivePosePostProcess_0                              (Parm, OutParm, NoDestructor)

void UPlayer_ProceduralLayering_AnimBP_C::AdditivePosePostProcess(const struct FPoseLink& InPose, struct FPoseLink* AdditivePosePostProcess_0)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("AdditivePosePostProcess");

	Params::Player_ProceduralLayering_AnimBP_C_AdditivePosePostProcess Parms{};

	Parms.InPose = std::move(InPose);

	UObject::ProcessEvent(Func, &Parms);

	if (AdditivePosePostProcess_0 != nullptr)
		*AdditivePosePostProcess_0 = std::move(Parms.AdditivePosePostProcess_0);
}
...
// struct FPoseLink                        BaseLocomotionPose                                     (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// struct FPoseLink                        InSourceLocoPose                                       (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
// struct FPoseLink                        BlendStack_0                                           (Parm, OutParm, NoDestructor)

void UPlayer_ProceduralLayering_AnimBP_C::BlendStack(const struct FPoseLink& SourcePose, const struct FPoseLink& BasePose, const struct FPoseLink& BaseLocomotionPose, const struct FPoseLink& InSourceLocoPose, struct FPoseLink* BlendStack_0)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("BlendStack");

	Params::Player_ProceduralLayering_AnimBP_C_BlendStack Parms{};

	Parms.SourcePose = std::move(SourcePose);
	Parms.BasePose = std::move(BasePose);
	Parms.BaseLocomotionPose = std::move(BaseLocomotionPose);
	Parms.InSourceLocoPose = std::move(InSourceLocoPose);

	UObject::ProcessEvent(Func, &Parms);

	if (BlendStack_0 != nullptr)
		*BlendStack_0 = std::move(Parms.BlendStack_0);
}
...
void UPlayer_ProceduralLayering_AnimBP_C::ProceduralAdditivePose(const struct FPoseLink& InSourceLocomotionPose, const struct FPoseLink& InMotionMatchingPose, const struct FPoseLink& InProceduralLayeredPose, const struct FPoseLink& InSourcePose, struct FPoseLink* ProceduralAdditivePose_0)
{
	static class UFunction* Func = nullptr;
