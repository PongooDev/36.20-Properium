...
{
public:
	struct FValueOrBBKey_GameplayTagContainer     Value;                                             // 0x0098(0x0028)(Edit, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UBTTask_SetKeyValueGameplayTag) == 0x0000C0, "Wrong size on UBTTask_SetKeyValueGameplayTag");
