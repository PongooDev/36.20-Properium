...
static_assert(sizeof(USidebarEmptyPanelWidget_C) == 0x0015D0, "Wrong size on USidebarEmptyPanelWidget_C");
static_assert(offsetof(USidebarEmptyPanelWidget_C, UberGraphFrame) == 0x0015C0, "Member 'USidebarEmptyPanelWidget_C::UberGraphFrame' has a wrong offset!");
