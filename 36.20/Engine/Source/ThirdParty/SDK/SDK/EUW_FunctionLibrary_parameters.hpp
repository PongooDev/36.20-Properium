...
static_assert(offsetof(EUW_FunctionLibrary_C_Create_SliderLabel, CallFunc_GetLocalTopLeft_ReturnValue) == 0x0000F8, "Member 'EUW_FunctionLibrary_C_Create_SliderLabel::CallFunc_GetLocalTopLeft_ReturnValue' has a wrong offset!");
static_assert(offsetof(EUW_FunctionLibrary_C_Create_SliderLabel, CallFunc_Add_Vector2DVector2D_ReturnValue) == 0x000108, "Member 'EUW_FunctionLibrary_C_Create_SliderLabel::CallFunc_Add_Vector2DVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(EUW_FunctionLibrary_C_Create_SliderLabel, CallFunc_DrawTextFormatted_FontSize_ImplicitCast) == 0x000118, "Member 'EUW_FunctionLibrary_C_Create_SliderLabel::CallFunc_DrawTextFormatted_FontSize_ImplicitCast' has a wrong offset!");
