...
static_assert(offsetof(AttachableWheel_SetRuntimeData_SteerAngle, SteerAngle) == 0x000000, "Member 'AttachableWheel_SetRuntimeData_SteerAngle::SteerAngle' has a wrong offset!");
...
static_assert(offsetof(AttachableWheel_SetRuntimeData_Torque, Torque) == 0x000000, "Member 'AttachableWheel_SetRuntimeData_Torque::Torque' has a wrong offset!");
...
static_assert(offsetof(AttachableWheel_SetRuntimeData_Velocity, Velocity) == 0x000000, "Member 'AttachableWheel_SetRuntimeData_Velocity::Velocity' has a wrong offset!");
...
static_assert(offsetof(AttachableWheelsComponent_SetMaxChassisMassFraction, InMaxChassisMassFraction) == 0x000000, "Member 'AttachableWheelsComponent_SetMaxChassisMassFraction::InMaxChassisMassFraction' has a wrong offset!");
