...
{
public:
	class UParticleSystemComponent*               Portal;                                            // 0x0390(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_CameraLens_CrackExit_C) == 0x0003A0, "Wrong size on ABP_CameraLens_CrackExit_C");
static_assert(offsetof(ABP_CameraLens_CrackExit_C, Portal) == 0x000390, "Member 'ABP_CameraLens_CrackExit_C::Portal' has a wrong offset!");
