...
public:
	...
	uint8                                         bUseWidgetClass : 1;                               // 0x0044(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bUseUniqueID : 1;                                  // 0x0044(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FDynamicUIWidgetTarget) == 0x000078, "Wrong size on FDynamicUIWidgetTarget");
...
static_assert(offsetof(FDynamicUIWidgetTarget, WidgetAssetPath) == 0x000008, "Member 'FDynamicUIWidgetTarget::WidgetAssetPath' has a wrong offset!");
static_assert(offsetof(FDynamicUIWidgetTarget, WidgetClass) == 0x000020, "Member 'FDynamicUIWidgetTarget::WidgetClass' has a wrong offset!");
static_assert(offsetof(FDynamicUIWidgetTarget, UniqueID) == 0x000040, "Member 'FDynamicUIWidgetTarget::UniqueID' has a wrong offset!");
...
static_assert(sizeof(FDynamicUIAdjust) == 0x000088, "Wrong size on FDynamicUIAdjust");
static_assert(offsetof(FDynamicUIAdjust, TargetWidget) == 0x000000, "Member 'FDynamicUIAdjust::TargetWidget' has a wrong offset!");
static_assert(offsetof(FDynamicUIAdjust, LayoutConstraint) == 0x000078, "Member 'FDynamicUIAdjust::LayoutConstraint' has a wrong offset!");
static_assert(offsetof(FDynamicUIAdjust, SizeModifier) == 0x000080, "Member 'FDynamicUIAdjust::SizeModifier' has a wrong offset!");
...
public:
	...
	TArray<class UDynamicUIExcludeBase*>          ExcludeConditions;                                 // 0x0060(0x0010)(Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	uint8                                         bUseExclude : 1;                                   // 0x0071(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(offsetof(FDynamicUIAllowed, ExcludeConditions) == 0x000060, "Member 'FDynamicUIAllowed::ExcludeConditions' has a wrong offset!");
...
// ScriptStruct DynamicUI.DynamicUIVerticalMargin
// 0x0008 (0x0008 - 0x0000)
struct FDynamicUIVerticalMargin final
{
public:
	float                                         Top;                                               // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Bottom;                                            // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDynamicUIVerticalMargin) == 0x000004, "Wrong alignment on FDynamicUIVerticalMargin");
static_assert(sizeof(FDynamicUIVerticalMargin) == 0x000008, "Wrong size on FDynamicUIVerticalMargin");
static_assert(offsetof(FDynamicUIVerticalMargin, Top) == 0x000000, "Member 'FDynamicUIVerticalMargin::Top' has a wrong offset!");
static_assert(offsetof(FDynamicUIVerticalMargin, Bottom) == 0x000004, "Member 'FDynamicUIVerticalMargin::Bottom' has a wrong offset!");

// ScriptStruct DynamicUI.DynamicUIHorizontalMargin
// 0x0008 (0x0008 - 0x0000)
struct FDynamicUIHorizontalMargin final
{
public:
...
static_assert(alignof(FDynamicUIHorizontalMargin) == 0x000004, "Wrong alignment on FDynamicUIHorizontalMargin");
static_assert(sizeof(FDynamicUIHorizontalMargin) == 0x000008, "Wrong size on FDynamicUIHorizontalMargin");
static_assert(offsetof(FDynamicUIHorizontalMargin, Left) == 0x000000, "Member 'FDynamicUIHorizontalMargin::Left' has a wrong offset!");
static_assert(offsetof(FDynamicUIHorizontalMargin, Right) == 0x000004, "Member 'FDynamicUIHorizontalMargin::Right' has a wrong offset!");
...
static_assert(alignof(FDynamicUISceneTarget) == 0x000008, "Wrong alignment on FDynamicUISceneTarget");
static_assert(sizeof(FDynamicUISceneTarget) == 0x000018, "Wrong size on FDynamicUISceneTarget");
static_assert(offsetof(FDynamicUISceneTarget, SceneAssetPath) == 0x000000, "Member 'FDynamicUISceneTarget::SceneAssetPath' has a wrong offset!");
