...
{
public:
	class UStaticMeshComponent*                   StaticMesh_Inverted;                               // 0x03E8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_BattleMapZoneNode_C) == 0x0003F0, "Wrong size on ABP_BattleMapZoneNode_C");
static_assert(offsetof(ABP_BattleMapZoneNode_C, StaticMesh_Inverted) == 0x0003E8, "Member 'ABP_BattleMapZoneNode_C::StaticMesh_Inverted' has a wrong offset!");
