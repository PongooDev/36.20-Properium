...
struct AudioWorldizationSubsystem_GetActorTagCounts final
{
public:
	TMap<struct FGameplayTag, int32>              ReturnValue;                                       // 0x0000(0x0050)(ConstParm, Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(AudioWorldizationSubsystem_GetActorTagCounts) == 0x000008, "Wrong alignment on AudioWorldizationSubsystem_GetActorTagCounts");
static_assert(sizeof(AudioWorldizationSubsystem_GetActorTagCounts) == 0x000050, "Wrong size on AudioWorldizationSubsystem_GetActorTagCounts");
static_assert(offsetof(AudioWorldizationSubsystem_GetActorTagCounts, ReturnValue) == 0x000000, "Member 'AudioWorldizationSubsystem_GetActorTagCounts::ReturnValue' has a wrong offset!");

// Function AudioWorldization.AudioWorldizationSubsystem.GetActorTags
// 0x0020 (0x0020 - 0x0000)
struct AudioWorldizationSubsystem_GetActorTags final
{
public:
	struct FGameplayTagContainer                  ReturnValue;                                       // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(AudioWorldizationSubsystem_GetActorTags) == 0x000008, "Wrong alignment on AudioWorldizationSubsystem_GetActorTags");
static_assert(sizeof(AudioWorldizationSubsystem_GetActorTags) == 0x000020, "Wrong size on AudioWorldizationSubsystem_GetActorTags");
static_assert(offsetof(AudioWorldizationSubsystem_GetActorTags, ReturnValue) == 0x000000, "Member 'AudioWorldizationSubsystem_GetActorTags::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AudioWorldizationSubsystem_SetWorldizationSettings) == 0x000080, "Wrong size on AudioWorldizationSubsystem_SetWorldizationSettings");
