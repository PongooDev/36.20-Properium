...
static_assert(alignof(FMassSmartObjectCandidateSlots) == 0x000004, "Wrong alignment on FMassSmartObjectCandidateSlots");
...
static_assert(alignof(FMassSmartObjectRequestResultFragment) == 0x000004, "Wrong alignment on FMassSmartObjectRequestResultFragment");
