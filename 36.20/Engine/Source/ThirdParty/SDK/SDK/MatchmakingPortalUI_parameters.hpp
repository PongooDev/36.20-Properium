...
static_assert(offsetof(FortMatchmakingPortalPopup_GetIslandData, HUDComponent) == 0x000048, "Member 'FortMatchmakingPortalPopup_GetIslandData::HUDComponent' has a wrong offset!");
static_assert(offsetof(FortMatchmakingPortalPopup_GetIslandData, ReturnValue) == 0x000050, "Member 'FortMatchmakingPortalPopup_GetIslandData::ReturnValue' has a wrong offset!");
