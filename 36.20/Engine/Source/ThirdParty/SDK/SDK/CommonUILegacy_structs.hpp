...
// 0x0670 (0x0990 - 0x0320)
struct FCommonInputActionData final : public FCommonInputActionDataBase
{
public:
	TMap<ECommonGamepadType, struct FCommonInputTypeInfo> GamepadInputTypeInfoOverrides;                     // 0x0320(0x0050)(Edit, Protected, NativeAccessSpecifierProtected)
	struct FCommonInputTypeInfo                   GamepadInputTypeInfos[0x7];                        // 0x0370(0x00E0)(Deprecated, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FCommonInputActionData) == 0x000010, "Wrong alignment on FCommonInputActionData");
static_assert(sizeof(FCommonInputActionData) == 0x000990, "Wrong size on FCommonInputActionData");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfoOverrides) == 0x000320, "Member 'FCommonInputActionData::GamepadInputTypeInfoOverrides' has a wrong offset!");
static_assert(offsetof(FCommonInputActionData, GamepadInputTypeInfos) == 0x000370, "Member 'FCommonInputActionData::GamepadInputTypeInfos' has a wrong offset!");
