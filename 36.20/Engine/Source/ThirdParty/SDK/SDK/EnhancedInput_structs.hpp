...
public:
	...
	struct FGameplayTag                           ProfileId;                                         // 0x0024(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ProfileIdString;                                   // 0x0028(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FMapPlayerKeyArgs, ProfileIdString) == 0x000028, "Member 'FMapPlayerKeyArgs::ProfileIdString' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UInputAction>            AssociatedInputActionSoft;                         // 0x0078(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Transient, EditConst, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
static_assert(alignof(FPlayerKeyMapping) == 0x000008, "Wrong alignment on FPlayerKeyMapping");
static_assert(sizeof(FPlayerKeyMapping) == 0x000098, "Wrong size on FPlayerKeyMapping");
...
static_assert(offsetof(FPlayerKeyMapping, AssociatedInputAction) == 0x000070, "Member 'FPlayerKeyMapping::AssociatedInputAction' has a wrong offset!");
static_assert(offsetof(FPlayerKeyMapping, AssociatedInputActionSoft) == 0x000078, "Member 'FPlayerKeyMapping::AssociatedInputActionSoft' has a wrong offset!");
...
public:
	...
	struct FGameplayTag                           ProfileIdentifier;                                 // 0x0008(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
