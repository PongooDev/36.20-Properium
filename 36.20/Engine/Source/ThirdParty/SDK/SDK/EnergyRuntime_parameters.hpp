...
static_assert(alignof(FortEnergyAttrSet_OnRep_EnergyUsageMultiplier) == 0x000008, "Wrong alignment on FortEnergyAttrSet_OnRep_EnergyUsageMultiplier");
static_assert(sizeof(FortEnergyAttrSet_OnRep_EnergyUsageMultiplier) == 0x000028, "Wrong size on FortEnergyAttrSet_OnRep_EnergyUsageMultiplier");
static_assert(offsetof(FortEnergyAttrSet_OnRep_EnergyUsageMultiplier, OldValue) == 0x000000, "Member 'FortEnergyAttrSet_OnRep_EnergyUsageMultiplier::OldValue' has a wrong offset!");
...
static_assert(alignof(FortEnergyAttrSet_OnRep_MaxEnergy) == 0x000008, "Wrong alignment on FortEnergyAttrSet_OnRep_MaxEnergy");
static_assert(sizeof(FortEnergyAttrSet_OnRep_MaxEnergy) == 0x000028, "Wrong size on FortEnergyAttrSet_OnRep_MaxEnergy");
static_assert(offsetof(FortEnergyAttrSet_OnRep_MaxEnergy, OldValue) == 0x000000, "Member 'FortEnergyAttrSet_OnRep_MaxEnergy::OldValue' has a wrong offset!");
...
static_assert(alignof(FortEnergyAttrSet_OnRep_RechargeAmountPerSecond) == 0x000008, "Wrong alignment on FortEnergyAttrSet_OnRep_RechargeAmountPerSecond");
static_assert(sizeof(FortEnergyAttrSet_OnRep_RechargeAmountPerSecond) == 0x000028, "Wrong size on FortEnergyAttrSet_OnRep_RechargeAmountPerSecond");
static_assert(offsetof(FortEnergyAttrSet_OnRep_RechargeAmountPerSecond, OldValue) == 0x000000, "Member 'FortEnergyAttrSet_OnRep_RechargeAmountPerSecond::OldValue' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  AdditionalTags;                                    // 0x0018(0x0020)(Parm, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FortComponent_Energy_AddEnergy) == 0x000040, "Wrong size on FortComponent_Energy_AddEnergy");
...
static_assert(offsetof(FortComponent_Energy_AddEnergy, AdditionalTags) == 0x000018, "Member 'FortComponent_Energy_AddEnergy::AdditionalTags' has a wrong offset!");
static_assert(offsetof(FortComponent_Energy_AddEnergy, ReturnValue) == 0x000038, "Member 'FortComponent_Energy_AddEnergy::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(FortComponent_Energy_BP_HasSufficientEnergy, EnergyAmountToTest) == 0x000000, "Member 'FortComponent_Energy_BP_HasSufficientEnergy::EnergyAmountToTest' has a wrong offset!");
static_assert(offsetof(FortComponent_Energy_BP_HasSufficientEnergy, ReturnValue) == 0x000004, "Member 'FortComponent_Energy_BP_HasSufficientEnergy::ReturnValue' has a wrong offset!");
