...
// Parameters:
// struct FGameplayTag                     EventName                                              (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor, HasGetValueTypeHash)

void UBP_SkydiveSoundLibraryComponent_C::ActivateCBM(const struct FGameplayTag& EventName)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("ActivateCBM");

	Params::BP_SkydiveSoundLibraryComponent_C_ActivateCBM Parms{};
