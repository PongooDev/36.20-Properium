...
public:
	...
	struct FBodyInstance                          BodyInstance;                                      // 0x0048(0x0178)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	EHasCustomNavigableGeometry                   CustomNavigableGeometry;                           // 0x01C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLightingChannels                      LightingChannels;                                  // 0x01C1(0x0001)(Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C2[0x2];                                      // 0x01C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bRenderCustomDepth : 1;                            // 0x01C4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1C5[0x3];                                      // 0x01C5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	ERendererStencilMask                          CustomDepthStencilWriteMask;                       // 0x01C8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C9[0x3];                                      // 0x01C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CustomDepthStencilValue;                           // 0x01CC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         TranslucencySortPriority;                          // 0x01D0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEnableDensityScaling : 1;                         // 0x01D4(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_1D5[0x3];                                      // 0x01D5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class URuntimeVirtualTexture*>         RuntimeVirtualTextures;                            // 0x01D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	int32                                         VirtualTextureCullMips;                            // 0x01E8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ERuntimeVirtualTextureMainPassType            VirtualTextureRenderPassType;                      // 0x01EC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UHISMBuilderSettings) == 0x0001F0, "Wrong size on UHISMBuilderSettings");
...
static_assert(offsetof(UHISMBuilderSettings, CustomNavigableGeometry) == 0x0001C0, "Member 'UHISMBuilderSettings::CustomNavigableGeometry' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, LightingChannels) == 0x0001C1, "Member 'UHISMBuilderSettings::LightingChannels' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilWriteMask) == 0x0001C8, "Member 'UHISMBuilderSettings::CustomDepthStencilWriteMask' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, CustomDepthStencilValue) == 0x0001CC, "Member 'UHISMBuilderSettings::CustomDepthStencilValue' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, TranslucencySortPriority) == 0x0001D0, "Member 'UHISMBuilderSettings::TranslucencySortPriority' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, RuntimeVirtualTextures) == 0x0001D8, "Member 'UHISMBuilderSettings::RuntimeVirtualTextures' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, VirtualTextureCullMips) == 0x0001E8, "Member 'UHISMBuilderSettings::VirtualTextureCullMips' has a wrong offset!");
static_assert(offsetof(UHISMBuilderSettings, VirtualTextureRenderPassType) == 0x0001EC, "Member 'UHISMBuilderSettings::VirtualTextureRenderPassType' has a wrong offset!");
...
{
public:
	TArray<class AProceduralGenerationVolume*>    BlockedVolumes;                                    // 0x02E0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AProceduralGenerationBlockingVolume) == 0x0002F0, "Wrong size on AProceduralGenerationBlockingVolume");
static_assert(offsetof(AProceduralGenerationBlockingVolume, BlockedVolumes) == 0x0002E0, "Member 'AProceduralGenerationBlockingVolume::BlockedVolumes' has a wrong offset!");
...
{
public:
	class UProceduralGenerator*                   Generator;                                         // 0x00B8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShowDebugVisualization;                           // 0x00C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C1[0x3];                                       // 0x00C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  ProceduralGenerationGuid;                          // 0x00C4(0x0010)(ZeroConstructor, DuplicateTransient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_D4[0x4];                                       // 0x00D4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AVolume*                                GenerationVolume;                                  // 0x00D8(0x0008)(ZeroConstructor, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UProceduralGenerationContext*           GenerationContext;                                 // 0x00E0(0x0008)(ZeroConstructor, DuplicateTransient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UProceduralGenerationComponent) == 0x0000E8, "Wrong size on UProceduralGenerationComponent");
static_assert(offsetof(UProceduralGenerationComponent, Generator) == 0x0000B8, "Member 'UProceduralGenerationComponent::Generator' has a wrong offset!");
static_assert(offsetof(UProceduralGenerationComponent, bShowDebugVisualization) == 0x0000C0, "Member 'UProceduralGenerationComponent::bShowDebugVisualization' has a wrong offset!");
static_assert(offsetof(UProceduralGenerationComponent, ProceduralGenerationGuid) == 0x0000C4, "Member 'UProceduralGenerationComponent::ProceduralGenerationGuid' has a wrong offset!");
static_assert(offsetof(UProceduralGenerationComponent, GenerationVolume) == 0x0000D8, "Member 'UProceduralGenerationComponent::GenerationVolume' has a wrong offset!");
static_assert(offsetof(UProceduralGenerationComponent, GenerationContext) == 0x0000E0, "Member 'UProceduralGenerationComponent::GenerationContext' has a wrong offset!");
...
{
public:
	class UProceduralGenerationComponent*         ProceduralComponent;                               // 0x02E0(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AProceduralGenerationVolume) == 0x0002E8, "Wrong size on AProceduralGenerationVolume");
static_assert(offsetof(AProceduralGenerationVolume, ProceduralComponent) == 0x0002E0, "Member 'AProceduralGenerationVolume::ProceduralComponent' has a wrong offset!");
