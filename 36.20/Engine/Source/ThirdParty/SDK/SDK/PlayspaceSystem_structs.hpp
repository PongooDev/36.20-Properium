...
public:
	...
	TWeakObjectPtr<class APlayspace>              LeafPlayspace;                                     // 0x0040(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class UObject*                                ContextObject;                                     // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UObject*                                RequesterObject;                                   // 0x0030(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   TargetPlayspaceClass;                              // 0x0038(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EPlayspaceJurisdictionFilterState             State;                                             // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_59[0x7];                                       // 0x0059(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlayspaceJurisdictionFilter) == 0x000008, "Wrong alignment on FPlayspaceJurisdictionFilter");
static_assert(sizeof(FPlayspaceJurisdictionFilter) == 0x000060, "Wrong size on FPlayspaceJurisdictionFilter");
static_assert(offsetof(FPlayspaceJurisdictionFilter, ContextObject) == 0x000028, "Member 'FPlayspaceJurisdictionFilter::ContextObject' has a wrong offset!");
static_assert(offsetof(FPlayspaceJurisdictionFilter, RequesterObject) == 0x000030, "Member 'FPlayspaceJurisdictionFilter::RequesterObject' has a wrong offset!");
static_assert(offsetof(FPlayspaceJurisdictionFilter, TargetPlayspaceClass) == 0x000038, "Member 'FPlayspaceJurisdictionFilter::TargetPlayspaceClass' has a wrong offset!");
static_assert(offsetof(FPlayspaceJurisdictionFilter, State) == 0x000058, "Member 'FPlayspaceJurisdictionFilter::State' has a wrong offset!");
...
{
public:
	struct FPlayspaceJurisdictionFilter           Filter;                                            // 0x0000(0x0060)(NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0x18];                                      // 0x0060(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FPlayspaceExternallyReachableListenRequest) == 0x000008, "Wrong alignment on FPlayspaceExternallyReachableListenRequest");
static_assert(sizeof(FPlayspaceExternallyReachableListenRequest) == 0x000078, "Wrong size on FPlayspaceExternallyReachableListenRequest");
static_assert(offsetof(FPlayspaceExternallyReachableListenRequest, Filter) == 0x000000, "Member 'FPlayspaceExternallyReachableListenRequest::Filter' has a wrong offset!");
