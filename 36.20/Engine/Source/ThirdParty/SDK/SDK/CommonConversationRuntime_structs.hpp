...
static_assert(offsetof(FClientConversationMessage, Text) == 0x000018, "Member 'FClientConversationMessage::Text' has a wrong offset!");
static_assert(offsetof(FClientConversationMessage, MetadataParameters) == 0x000028, "Member 'FClientConversationMessage::MetadataParameters' has a wrong offset!");
...
static_assert(offsetof(FClientConversationOptionEntry, ChoiceTags) == 0x000010, "Member 'FClientConversationOptionEntry::ChoiceTags' has a wrong offset!");
static_assert(offsetof(FClientConversationOptionEntry, ChoiceType) == 0x000030, "Member 'FClientConversationOptionEntry::ChoiceType' has a wrong offset!");
static_assert(offsetof(FClientConversationOptionEntry, ChoiceReference) == 0x000038, "Member 'FClientConversationOptionEntry::ChoiceReference' has a wrong offset!");
static_assert(offsetof(FClientConversationOptionEntry, ExtraData) == 0x000058, "Member 'FClientConversationOptionEntry::ExtraData' has a wrong offset!");
...
static_assert(offsetof(FCommonDialogueBankParticipant, ParticipantName) == 0x000010, "Member 'FCommonDialogueBankParticipant::ParticipantName' has a wrong offset!");
static_assert(offsetof(FCommonDialogueBankParticipant, NodeTint) == 0x000014, "Member 'FCommonDialogueBankParticipant::NodeTint' has a wrong offset!");
...
public:
	...
	class FString                                 EntryIdentifier;                                   // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FConversationEntryList) == 0x000008, "Wrong alignment on FConversationEntryList");
static_assert(sizeof(FConversationEntryList) == 0x000028, "Wrong size on FConversationEntryList");
...
static_assert(offsetof(FConversationEntryList, EntryIdentifier) == 0x000018, "Member 'FConversationEntryList::EntryIdentifier' has a wrong offset!");
