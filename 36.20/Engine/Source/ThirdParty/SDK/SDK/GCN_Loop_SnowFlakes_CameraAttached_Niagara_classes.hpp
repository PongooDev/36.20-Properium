...
public:
	...
	class UNiagaraComponent*                      ReturnValue;                                       // 0x09D0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	int32                                         NewVar;                                            // 0x09D8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C) == 0x0009E0, "Wrong size on AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C");
static_assert(offsetof(AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C, UberGraphFrame) == 0x0009C8, "Member 'AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C, ReturnValue) == 0x0009D0, "Member 'AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C::ReturnValue' has a wrong offset!");
static_assert(offsetof(AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C, NewVar) == 0x0009D8, "Member 'AGCN_Loop_SnowFlakes_CameraAttached_Niagara_C::NewVar' has a wrong offset!");
