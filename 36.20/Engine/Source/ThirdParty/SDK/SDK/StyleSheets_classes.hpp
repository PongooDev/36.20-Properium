...
static_assert(alignof(UStyledWidgetTree) == 0x000008, "Wrong alignment on UStyledWidgetTree");
static_assert(sizeof(UStyledWidgetTree) == 0x000120, "Wrong size on UStyledWidgetTree");
static_assert(offsetof(UStyledWidgetTree, StyleProvider) == 0x000028, "Member 'UStyledWidgetTree::StyleProvider' has a wrong offset!");
...
static_assert(sizeof(UStyleProvider) == 0x000068, "Wrong size on UStyleProvider");
...
static_assert(offsetof(UStyleProvider, StyledWidgetTree) == 0x000058, "Member 'UStyleProvider::StyledWidgetTree' has a wrong offset!");
