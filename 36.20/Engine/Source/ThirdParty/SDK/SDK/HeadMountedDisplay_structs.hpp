...
public:
	...
	class FName                                   DeviceName;                                        // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  ApplicationInstanceID;                             // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EXRSpaceType                                  XRSpaceType;                                       // 0x0018(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EControllerHand                               Hand;                                              // 0x0019(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETrackingStatus                               TrackingStatus;                                    // 0x001A(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EXRControllerPoseType                         XRControllerPoseType;                              // 0x001B(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FXRMotionControllerState, ApplicationInstanceID) == 0x000008, "Member 'FXRMotionControllerState::ApplicationInstanceID' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerState, XRSpaceType) == 0x000018, "Member 'FXRMotionControllerState::XRSpaceType' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerState, Hand) == 0x000019, "Member 'FXRMotionControllerState::Hand' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerState, TrackingStatus) == 0x00001A, "Member 'FXRMotionControllerState::TrackingStatus' has a wrong offset!");
static_assert(offsetof(FXRMotionControllerState, XRControllerPoseType) == 0x00001B, "Member 'FXRMotionControllerState::XRControllerPoseType' has a wrong offset!");
...
static_assert(offsetof(FXRHandTrackingState, ApplicationInstanceID) == 0x000008, "Member 'FXRHandTrackingState::ApplicationInstanceID' has a wrong offset!");
static_assert(offsetof(FXRHandTrackingState, XRSpaceType) == 0x000018, "Member 'FXRHandTrackingState::XRSpaceType' has a wrong offset!");
static_assert(offsetof(FXRHandTrackingState, Hand) == 0x000019, "Member 'FXRHandTrackingState::Hand' has a wrong offset!");
static_assert(offsetof(FXRHandTrackingState, TrackingStatus) == 0x00001A, "Member 'FXRHandTrackingState::TrackingStatus' has a wrong offset!");
