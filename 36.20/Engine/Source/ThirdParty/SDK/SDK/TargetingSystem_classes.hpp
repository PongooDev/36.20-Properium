...
public:
	...
	struct FRotator                               DefaultSourceRotationOffset;                       // 0x0058(0x0018)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         bUseRelativeOffset : 1;                            // 0x0070(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIgnoreSourceActor : 1;                            // 0x0070(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIgnoreInstigatorActor : 1;                        // 0x0070(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bTraceComplex : 1;                                 // 0x0070(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                HalfExtent;                                        // 0x0078(0x0018)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class FName                                   ComponentTag;                                      // 0x00E0(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UTargetingSelectionTask_AOE) == 0x0000E8, "Wrong size on UTargetingSelectionTask_AOE");
...
static_assert(offsetof(UTargetingSelectionTask_AOE, DefaultSourceRotationOffset) == 0x000058, "Member 'UTargetingSelectionTask_AOE::DefaultSourceRotationOffset' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, HalfExtent) == 0x000078, "Member 'UTargetingSelectionTask_AOE::HalfExtent' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, Radius) == 0x000090, "Member 'UTargetingSelectionTask_AOE::Radius' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, HalfHeight) == 0x0000B8, "Member 'UTargetingSelectionTask_AOE::HalfHeight' has a wrong offset!");
static_assert(offsetof(UTargetingSelectionTask_AOE, ComponentTag) == 0x0000E0, "Member 'UTargetingSelectionTask_AOE::ComponentTag' has a wrong offset!");
...
public:
	...
	uint8                                         bMultiTrace : 1;                                   // 0x0168(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIgnoreSourceActor : 1;                            // 0x0168(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
	uint8                                         bIgnoreInstigatorActor : 1;                        // 0x0168(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, BlueprintReadOnly, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected))
