...
static_assert(sizeof(ASimObject) == 0x0002B0, "Wrong size on ASimObject");
...
public:
	...
	TArray<class UEntityComponent*>               SerializedComponents;                              // 0x00C0(0x0010)(Edit, ExportObject, ZeroConstructor, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         bForceOwnerReplication : 1;                        // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UActorToEntityAdapterComponent) == 0x0000D8, "Wrong size on UActorToEntityAdapterComponent");
static_assert(offsetof(UActorToEntityAdapterComponent, SerializedComponents) == 0x0000C0, "Member 'UActorToEntityAdapterComponent::SerializedComponents' has a wrong offset!");
...
static_assert(sizeof(UEntityActorTextDisplayComponent) == 0x0000A8, "Wrong size on UEntityActorTextDisplayComponent");
...
static_assert(offsetof(UEntityActorTextDisplayComponent, ShadowVar_WorldSize) == 0x000098, "Member 'UEntityActorTextDisplayComponent::ShadowVar_WorldSize' has a wrong offset!");
static_assert(offsetof(UEntityActorTextDisplayComponent, ShadowVar_TextRenderColor) == 0x00009C, "Member 'UEntityActorTextDisplayComponent::ShadowVar_TextRenderColor' has a wrong offset!");
static_assert(offsetof(UEntityActorTextDisplayComponent, bAddedTextRenderComponent) == 0x0000A0, "Member 'UEntityActorTextDisplayComponent::bAddedTextRenderComponent' has a wrong offset!");
