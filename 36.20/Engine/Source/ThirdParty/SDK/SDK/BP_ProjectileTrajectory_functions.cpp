...
void ABP_ProjectileTrajectory_C::PreSetTrajectorySpline(const TArray<struct FVector>& SplinePoints, const TArray<struct FVector>& SplineTangents, const struct FHitResult& TrajectoryHitResult)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("PreSetTrajectorySpline");

	Params::BP_ProjectileTrajectory_C_PreSetTrajectorySpline Parms{};
...
void ABP_ProjectileTrajectory_C::SetProjectileBudgetMesh(class USkeletalMeshComponentBudgeted* ProjectileBudgetMesh)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetProjectileBudgetMesh");
