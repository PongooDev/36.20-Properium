...
static_assert(alignof(UMeshMaterialTweening) == 0x000008, "Wrong alignment on UMeshMaterialTweening");
static_assert(sizeof(UMeshMaterialTweening) == 0x000028, "Wrong size on UMeshMaterialTweening");
...
static_assert(sizeof(UTweenManager) == 0x000108, "Wrong size on UTweenManager");
static_assert(offsetof(UTweenManager, TweenContexts) == 0x000058, "Member 'UTweenManager::TweenContexts' has a wrong offset!");
