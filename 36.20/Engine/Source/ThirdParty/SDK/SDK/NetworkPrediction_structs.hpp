...
static_assert(sizeof(FReplicationProxy) == 0x000040, "Wrong size on FReplicationProxy");
...
static_assert(offsetof(FNetworkPredictionSettings, bEnableFixedTickSmoothing) == 0x000016, "Member 'FNetworkPredictionSettings::bEnableFixedTickSmoothing' has a wrong offset!");
