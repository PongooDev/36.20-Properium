...
static_assert(alignof(EpicStreamMediaSource_IsSyncTimeSet) == 0x000001, "Wrong alignment on EpicStreamMediaSource_IsSyncTimeSet");
static_assert(sizeof(EpicStreamMediaSource_IsSyncTimeSet) == 0x000001, "Wrong size on EpicStreamMediaSource_IsSyncTimeSet");
static_assert(offsetof(EpicStreamMediaSource_IsSyncTimeSet, ReturnValue) == 0x000000, "Member 'EpicStreamMediaSource_IsSyncTimeSet::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(EpicStreamMediaSource_IsTimeWindowSet, ReturnValue) == 0x000000, "Member 'EpicStreamMediaSource_IsTimeWindowSet::ReturnValue' has a wrong offset!");
...
{
public:
	struct FEpicMediaMetadataExt                  MetaData;                                          // 0x0000(0x0308)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	bool                                          bSuccess;                                          // 0x0308(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(EpicStreamMediaSource_MetadataResultHandler) == 0x000310, "Wrong size on EpicStreamMediaSource_MetadataResultHandler");
...
static_assert(offsetof(EpicStreamMediaSource_MetadataResultHandler, bSuccess) == 0x000308, "Member 'EpicStreamMediaSource_MetadataResultHandler::bSuccess' has a wrong offset!");
...
static_assert(offsetof(EpicStreamMediaSource_SetMediaTimeWindowSeconds, InStartTime) == 0x000000, "Member 'EpicStreamMediaSource_SetMediaTimeWindowSeconds::InStartTime' has a wrong offset!");
static_assert(offsetof(EpicStreamMediaSource_SetMediaTimeWindowSeconds, InEndTime) == 0x000008, "Member 'EpicStreamMediaSource_SetMediaTimeWindowSeconds::InEndTime' has a wrong offset!");
...
{
public:
	struct FMediaPlayerOptions                    PlayerOptions;                                     // 0x0000(0x00C8)(Parm, NativeAccessSpecifierPublic)
	struct FMediaPlayerOptions                    ReturnValue;                                       // 0x00C8(0x00C8)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(EpicStreamMediaSource_UpdatePlayerOptions) == 0x000190, "Wrong size on EpicStreamMediaSource_UpdatePlayerOptions");
...
static_assert(offsetof(EpicStreamMediaSource_UpdatePlayerOptions, ReturnValue) == 0x0000C8, "Member 'EpicStreamMediaSource_UpdatePlayerOptions::ReturnValue' has a wrong offset!");
