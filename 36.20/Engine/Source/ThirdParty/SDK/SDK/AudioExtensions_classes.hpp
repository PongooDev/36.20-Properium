...
class IAudioPropertiesSheetAssetUserInterface final : public IInterface
{
public:
...
static_assert(alignof(IAudioPropertiesSheetAssetUserInterface) == 0x000008, "Wrong alignment on IAudioPropertiesSheetAssetUserInterface");
static_assert(sizeof(IAudioPropertiesSheetAssetUserInterface) == 0x000028, "Wrong size on IAudioPropertiesSheetAssetUserInterface");
