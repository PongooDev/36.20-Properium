...
static_assert(alignof(McpItemDefinitionBase_GetTemplateId) == 0x000008, "Wrong alignment on McpItemDefinitionBase_GetTemplateId");
static_assert(sizeof(McpItemDefinitionBase_GetTemplateId) == 0x000010, "Wrong size on McpItemDefinitionBase_GetTemplateId");
static_assert(offsetof(McpItemDefinitionBase_GetTemplateId, ReturnValue) == 0x000000, "Member 'McpItemDefinitionBase_GetTemplateId::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(McpProfile_QueryPublicProfile) == 0x000070, "Wrong size on McpProfile_QueryPublicProfile");
