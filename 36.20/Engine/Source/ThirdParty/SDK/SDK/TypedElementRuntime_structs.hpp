...
static_assert(sizeof(FTypedElementSelectionNormalizationOptions) == 0x000008, "Wrong size on FTypedElementSelectionNormalizationOptions");
...
static_assert(sizeof(FTypedElementIsSelectedOptions) == 0x000008, "Wrong size on FTypedElementIsSelectedOptions");
