...
static_assert(alignof(GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree) == 0x000008, "Wrong alignment on GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree");
static_assert(sizeof(GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree) == 0x000008, "Wrong size on GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree");
static_assert(offsetof(GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree, NewStateTree) == 0x000000, "Member 'GameplayInteractionSmartObjectBehaviorDefinition_SetStateTree::NewStateTree' has a wrong offset!");
...
static_assert(alignof(GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree) == 0x000008, "Wrong alignment on GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree");
static_assert(sizeof(GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree) == 0x000008, "Wrong size on GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree");
static_assert(offsetof(GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree, ReturnValue) == 0x000000, "Member 'GameplayInteractionSmartObjectBehaviorDefinition_GetStateTree::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction) == 0x000040, "Wrong size on AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction");
...
static_assert(offsetof(AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction, bLockAILogic) == 0x000030, "Member 'AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction::bLockAILogic' has a wrong offset!");
static_assert(offsetof(AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction, ReturnValue) == 0x000038, "Member 'AITask_UseGameplayInteraction_MoveToAndUseSmartObjectWithGameplayInteraction::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction) == 0x000040, "Wrong size on AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction");
...
static_assert(offsetof(AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction, bLockAILogic) == 0x000030, "Member 'AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction::bLockAILogic' has a wrong offset!");
static_assert(offsetof(AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction, ReturnValue) == 0x000038, "Member 'AITask_UseGameplayInteraction_UseSmartObjectWithGameplayInteraction::ReturnValue' has a wrong offset!");
