...
// Parameters:
// class AFortPlayerPawn*                  InterrogatedPlayer_0                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UGAB_InterrogatePlayer_Reveal_C::RPC_SetInterrogatedPlayer(class AFortPlayerPawn* InterrogatedPlayer_0)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("RPC_SetInterrogatedPlayer");

	Params::GAB_InterrogatePlayer_Reveal_C_RPC_SetInterrogatedPlayer Parms{};

	Parms.InterrogatedPlayer_0 = InterrogatedPlayer_0;
