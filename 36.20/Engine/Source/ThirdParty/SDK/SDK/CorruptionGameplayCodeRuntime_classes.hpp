...
{
public:
	float                                         GenerationZTraceHeight;                            // 0x04F8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CubeSpacingFactor;                                 // 0x04FC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         CubeAngleLimitDegrees;                             // 0x0500(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_504[0x4];                                      // 0x0504(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortCorruptionSequenceData*            CorruptionSequence;                                // 0x0508(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_510[0x8];                                      // 0x0510(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTravelerStepCorruptionOverrideData> TravelerCorruptionStepPercentOverrides;            // 0x0518(0x0010)(Edit, ZeroConstructor, DisableEditOnTemplate, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(ACubeMovementStaticPath) == 0x000530, "Wrong size on ACubeMovementStaticPath");
static_assert(offsetof(ACubeMovementStaticPath, GenerationZTraceHeight) == 0x0004F8, "Member 'ACubeMovementStaticPath::GenerationZTraceHeight' has a wrong offset!");
static_assert(offsetof(ACubeMovementStaticPath, CubeSpacingFactor) == 0x0004FC, "Member 'ACubeMovementStaticPath::CubeSpacingFactor' has a wrong offset!");
static_assert(offsetof(ACubeMovementStaticPath, CubeAngleLimitDegrees) == 0x000500, "Member 'ACubeMovementStaticPath::CubeAngleLimitDegrees' has a wrong offset!");
static_assert(offsetof(ACubeMovementStaticPath, CorruptionSequence) == 0x000508, "Member 'ACubeMovementStaticPath::CorruptionSequence' has a wrong offset!");
static_assert(offsetof(ACubeMovementStaticPath, TravelerCorruptionStepPercentOverrides) == 0x000518, "Member 'ACubeMovementStaticPath::TravelerCorruptionStepPercentOverrides' has a wrong offset!");
...
public:
	...
	struct FWarEffortMutatorMetadata              MeshNetworkMetadata;                               // 0x04B8(0x0020)(BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	TArray<struct FWarEffortMutatorChoiceData>    WeaponChoices;                                     // 0x04D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FPrimaryAssetId>                PreloadedItemList;                                 // 0x04E8(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	bool                                          bCanPreloadItems;                                  // 0x04F8(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_4F9[0x1F];                                     // 0x04F9(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(AFortAthenaMutator_WarEffort) == 0x000518, "Wrong size on AFortAthenaMutator_WarEffort");
static_assert(offsetof(AFortAthenaMutator_WarEffort, MeshNetworkMetadata) == 0x0004B8, "Member 'AFortAthenaMutator_WarEffort::MeshNetworkMetadata' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, WeaponChoices) == 0x0004D8, "Member 'AFortAthenaMutator_WarEffort::WeaponChoices' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, PreloadedItemList) == 0x0004E8, "Member 'AFortAthenaMutator_WarEffort::PreloadedItemList' has a wrong offset!");
static_assert(offsetof(AFortAthenaMutator_WarEffort, bCanPreloadItems) == 0x0004F8, "Member 'AFortAthenaMutator_WarEffort::bCanPreloadItems' has a wrong offset!");
...
{
public:
	class UMeshNetworkComponent*                  MeshNetworkComponent;                              // 0x02A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FGameplayTag>                   ActiveFundedItems;                                 // 0x02B0(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<struct FGameplayTag>                   ActiveTryBeforeYouBuyItems;                        // 0x02C0(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
	TArray<struct FWarEffortFundingData>          CurrentFundingData;                                // 0x02D0(0x0010)(Net, ZeroConstructor, RepNotify, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AWarEffortMeshActor) == 0x000330, "Wrong size on AWarEffortMeshActor");
static_assert(offsetof(AWarEffortMeshActor, MeshNetworkComponent) == 0x0002A8, "Member 'AWarEffortMeshActor::MeshNetworkComponent' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, ActiveFundedItems) == 0x0002B0, "Member 'AWarEffortMeshActor::ActiveFundedItems' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, ActiveTryBeforeYouBuyItems) == 0x0002C0, "Member 'AWarEffortMeshActor::ActiveTryBeforeYouBuyItems' has a wrong offset!");
static_assert(offsetof(AWarEffortMeshActor, CurrentFundingData) == 0x0002D0, "Member 'AWarEffortMeshActor::CurrentFundingData' has a wrong offset!");
