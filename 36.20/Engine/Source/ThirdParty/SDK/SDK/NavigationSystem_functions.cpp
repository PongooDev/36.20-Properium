...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct FBox                             Bounds                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSubclassOf<class UNavArea>             OldArea                                                (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSubclassOf<class UNavArea>             NewArea                                                (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UNavModifierComponent::SetAreaClassToReplace(TSubclassOf<class UNavArea> NewAreaClassToReplace)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetAreaClassToReplace");
...
void USplineNavModifierComponent::UpdateNavigationWithComponentData()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("UpdateNavigationWithComponentData");
