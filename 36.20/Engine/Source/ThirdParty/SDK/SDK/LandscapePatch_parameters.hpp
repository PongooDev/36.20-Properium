...
static_assert(alignof(LandscapePatchComponent_GetLayerOptions) == 0x000008, "Wrong alignment on LandscapePatchComponent_GetLayerOptions");
static_assert(sizeof(LandscapePatchComponent_GetLayerOptions) == 0x000010, "Wrong size on LandscapePatchComponent_GetLayerOptions");
static_assert(offsetof(LandscapePatchComponent_GetLayerOptions, ReturnValue) == 0x000000, "Member 'LandscapePatchComponent_GetLayerOptions::ReturnValue' has a wrong offset!");
...
static_assert(alignof(LandscapePatchComponent_SetPriority) == 0x000008, "Wrong alignment on LandscapePatchComponent_SetPriority");
static_assert(sizeof(LandscapePatchComponent_SetPriority) == 0x000008, "Wrong size on LandscapePatchComponent_SetPriority");
static_assert(offsetof(LandscapePatchComponent_SetPriority, PriorityIn) == 0x000000, "Member 'LandscapePatchComponent_SetPriority::PriorityIn' has a wrong offset!");
...
static_assert(alignof(LandscapePatchComponent_GetPriority) == 0x000008, "Wrong alignment on LandscapePatchComponent_GetPriority");
static_assert(sizeof(LandscapePatchComponent_GetPriority) == 0x000008, "Wrong size on LandscapePatchComponent_GetPriority");
static_assert(offsetof(LandscapePatchComponent_GetPriority, ReturnValue) == 0x000000, "Member 'LandscapePatchComponent_GetPriority::ReturnValue' has a wrong offset!");
...
public:
	class FName                                   InWeightmapLayerName;                              // 0x0000(0x0004)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bMarkDirty;                                        // 0x0004(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(LandscapeTexturePatch_GetWeightPatchRenderTarget, bMarkDirty) == 0x000004, "Member 'LandscapeTexturePatch_GetWeightPatchRenderTarget::bMarkDirty' has a wrong offset!");
...
// Function LandscapePatch.LandscapeTexturePatch.GetWeightPatchTextureAsset
// 0x0010 (0x0010 - 0x0000)
struct LandscapeTexturePatch_GetWeightPatchTextureAsset final
{
public:
	class FName                                   InWeightmapLayerName;                              // 0x0000(0x0004)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(LandscapeTexturePatch_GetWeightPatchTextureAsset) == 0x000008, "Wrong alignment on LandscapeTexturePatch_GetWeightPatchTextureAsset");
static_assert(sizeof(LandscapeTexturePatch_GetWeightPatchTextureAsset) == 0x000010, "Wrong size on LandscapeTexturePatch_GetWeightPatchTextureAsset");
static_assert(offsetof(LandscapeTexturePatch_GetWeightPatchTextureAsset, InWeightmapLayerName) == 0x000000, "Member 'LandscapeTexturePatch_GetWeightPatchTextureAsset::InWeightmapLayerName' has a wrong offset!");
static_assert(offsetof(LandscapeTexturePatch_GetWeightPatchTextureAsset, ReturnValue) == 0x000008, "Member 'LandscapeTexturePatch_GetWeightPatchTextureAsset::ReturnValue' has a wrong offset!");
...
static_assert(alignof(LandscapeTexturePatch_SetFalloffMode) == 0x000001, "Wrong alignment on LandscapeTexturePatch_SetFalloffMode");
static_assert(sizeof(LandscapeTexturePatch_SetFalloffMode) == 0x000001, "Wrong size on LandscapeTexturePatch_SetFalloffMode");
static_assert(offsetof(LandscapeTexturePatch_SetFalloffMode, FalloffModeIn) == 0x000000, "Member 'LandscapeTexturePatch_SetFalloffMode::FalloffModeIn' has a wrong offset!");
