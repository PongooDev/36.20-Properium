...
void APlayerPawn_Generic_C::BindToAnimTrailEvents(const TDelegate<void(bool bActive)>& AnimNotifyBegin, const TDelegate<void()>& AnimNotifyEnd)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_BindToAnimTrailEvents Parms{};
...
void APlayerPawn_Generic_C::BindToSwingFX(const TDelegate<void()>& SwingLeft_0, const TDelegate<void()>& SwingLeftEnd_0, const TDelegate<void()>& SwingRight_0, const TDelegate<void()>& SwingRightEnd_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_BindToSwingFX Parms{};
...
void APlayerPawn_Generic_C::BindToSwingFX2(const TDelegate<void()>& SwingLeft2_0, const TDelegate<void()>& SwingRight2_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_BindToSwingFX2 Parms{};
...
void APlayerPawn_Generic_C::UnbindFromAnimTrailEvents(const TDelegate<void(bool bActive)>& AnimNotifyBegin, const TDelegate<void()>& AnimNotifyEnd)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_UnbindFromAnimTrailEvents Parms{};
...
void APlayerPawn_Generic_C::UnbindFromSwingFX(const TDelegate<void()>& SwingLeft_0, const TDelegate<void()>& SwingLeftEnd_0, const TDelegate<void()>& SwingRight_0, const TDelegate<void()>& SwingRightEnd_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_UnbindFromSwingFX Parms{};
...
void APlayerPawn_Generic_C::UnbindFromSwingFX2(const TDelegate<void()>& SwingLeft2_0, const TDelegate<void()>& SwingRight2_0)
{
	static class UFunction* Func = nullptr;
	...
	Params::PlayerPawn_Generic_C_UnbindFromSwingFX2 Parms{};
