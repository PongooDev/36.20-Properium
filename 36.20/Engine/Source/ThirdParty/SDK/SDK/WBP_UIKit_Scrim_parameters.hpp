...
static_assert(sizeof(WBP_UIKit_Scrim_C_FadeIn) == 0x000010, "Wrong size on WBP_UIKit_Scrim_C_FadeIn");
...
static_assert(sizeof(WBP_UIKit_Scrim_C_FadeOut) == 0x000010, "Wrong size on WBP_UIKit_Scrim_C_FadeOut");
