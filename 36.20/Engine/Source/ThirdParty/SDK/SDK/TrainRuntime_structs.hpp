...
// Enum TrainRuntime.ETrainMovementState
// NumValues: 0x0005
enum class ETrainMovementState : uint8
{
	Moving                                   = 0,
	RampingUp                                = 1,
	Express                                  = 2,
...
// ScriptStruct TrainRuntime.TrainRailHotspot
// 0x0014 (0x0014 - 0x0000)
struct alignas(0x04) FTrainRailHotspot final
{
public:
	uint8                                         Pad_0[0x14];                                       // 0x0000(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTrainRailHotspot) == 0x000004, "Wrong alignment on FTrainRailHotspot");
static_assert(sizeof(FTrainRailHotspot) == 0x000014, "Wrong size on FTrainRailHotspot");
...
public:
	...
	float                                         StopDistanceAlongRail;                             // 0x0008(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RampUpDistanceAlongRail;                           // 0x000C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RampUpSpeedMultipler;                              // 0x0010(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TimeAlongRail;                                     // 0x0014(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETrainMovementState                           MovementState;                                     // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bReverseDirection;                                 // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A[0x2];                                       // 0x001A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTrainMovementData) == 0x000004, "Wrong alignment on FTrainMovementData");
static_assert(sizeof(FTrainMovementData) == 0x00001C, "Wrong size on FTrainMovementData");
...
static_assert(offsetof(FTrainMovementData, StopDistanceAlongRail) == 0x000008, "Member 'FTrainMovementData::StopDistanceAlongRail' has a wrong offset!");
static_assert(offsetof(FTrainMovementData, RampUpDistanceAlongRail) == 0x00000C, "Member 'FTrainMovementData::RampUpDistanceAlongRail' has a wrong offset!");
static_assert(offsetof(FTrainMovementData, RampUpSpeedMultipler) == 0x000010, "Member 'FTrainMovementData::RampUpSpeedMultipler' has a wrong offset!");
static_assert(offsetof(FTrainMovementData, TimeAlongRail) == 0x000014, "Member 'FTrainMovementData::TimeAlongRail' has a wrong offset!");
static_assert(offsetof(FTrainMovementData, MovementState) == 0x000018, "Member 'FTrainMovementData::MovementState' has a wrong offset!");
static_assert(offsetof(FTrainMovementData, bReverseDirection) == 0x000019, "Member 'FTrainMovementData::bReverseDirection' has a wrong offset!");
