...
static_assert(alignof(DelMarTrackBase_GetNextSplineSegmentIndexWithActor) == 0x000004, "Wrong alignment on DelMarTrackBase_GetNextSplineSegmentIndexWithActor");
static_assert(sizeof(DelMarTrackBase_GetNextSplineSegmentIndexWithActor) == 0x000008, "Wrong size on DelMarTrackBase_GetNextSplineSegmentIndexWithActor");
static_assert(offsetof(DelMarTrackBase_GetNextSplineSegmentIndexWithActor, SplineSegmentIndex) == 0x000000, "Member 'DelMarTrackBase_GetNextSplineSegmentIndexWithActor::SplineSegmentIndex' has a wrong offset!");
static_assert(offsetof(DelMarTrackBase_GetNextSplineSegmentIndexWithActor, ReturnValue) == 0x000004, "Member 'DelMarTrackBase_GetNextSplineSegmentIndexWithActor::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DelMarTrack_GetPrimaryLength) == 0x000004, "Wrong alignment on DelMarTrack_GetPrimaryLength");
static_assert(sizeof(DelMarTrack_GetPrimaryLength) == 0x000004, "Wrong size on DelMarTrack_GetPrimaryLength");
static_assert(offsetof(DelMarTrack_GetPrimaryLength, ReturnValue) == 0x000000, "Member 'DelMarTrack_GetPrimaryLength::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DelMarTrack_GetSecondaryDistance) == 0x000004, "Wrong alignment on DelMarTrack_GetSecondaryDistance");
static_assert(sizeof(DelMarTrack_GetSecondaryDistance) == 0x000008, "Wrong size on DelMarTrack_GetSecondaryDistance");
static_assert(offsetof(DelMarTrack_GetSecondaryDistance, DistanceOnPrimaryTrack) == 0x000000, "Member 'DelMarTrack_GetSecondaryDistance::DistanceOnPrimaryTrack' has a wrong offset!");
static_assert(offsetof(DelMarTrack_GetSecondaryDistance, ReturnValue) == 0x000004, "Member 'DelMarTrack_GetSecondaryDistance::ReturnValue' has a wrong offset!");
...
// Function DelMarTrackRuntime.DelMarTrack.IsIndependent
// 0x0001 (0x0001 - 0x0000)
struct DelMarTrack_IsIndependent final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarTrack_IsIndependent) == 0x000001, "Wrong alignment on DelMarTrack_IsIndependent");
static_assert(sizeof(DelMarTrack_IsIndependent) == 0x000001, "Wrong size on DelMarTrack_IsIndependent");
static_assert(offsetof(DelMarTrack_IsIndependent, ReturnValue) == 0x000000, "Member 'DelMarTrack_IsIndependent::ReturnValue' has a wrong offset!");
...
// Function DelMarTrackRuntime.DelMarTrackPositionComponent.GetBaseTrackFor
// 0x0010 (0x0010 - 0x0000)
struct DelMarTrackPositionComponent_GetBaseTrackFor final
{
public:
	const class ADelMarTrack*                     Track;                                             // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	const class ADelMarTrackBase*                 ReturnValue;                                       // 0x0008(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarTrackPositionComponent_GetBaseTrackFor) == 0x000008, "Wrong alignment on DelMarTrackPositionComponent_GetBaseTrackFor");
static_assert(sizeof(DelMarTrackPositionComponent_GetBaseTrackFor) == 0x000010, "Wrong size on DelMarTrackPositionComponent_GetBaseTrackFor");
static_assert(offsetof(DelMarTrackPositionComponent_GetBaseTrackFor, Track) == 0x000000, "Member 'DelMarTrackPositionComponent_GetBaseTrackFor::Track' has a wrong offset!");
static_assert(offsetof(DelMarTrackPositionComponent_GetBaseTrackFor, ReturnValue) == 0x000008, "Member 'DelMarTrackPositionComponent_GetBaseTrackFor::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DelMarTrackTubeAudioComponent_SetRadius) == 0x000004, "Wrong alignment on DelMarTrackTubeAudioComponent_SetRadius");
static_assert(sizeof(DelMarTrackTubeAudioComponent_SetRadius) == 0x000004, "Wrong size on DelMarTrackTubeAudioComponent_SetRadius");
static_assert(offsetof(DelMarTrackTubeAudioComponent_SetRadius, InRadius) == 0x000000, "Member 'DelMarTrackTubeAudioComponent_SetRadius::InRadius' has a wrong offset!");
...
static_assert(alignof(DelMarTrackTubeAudioComponent_SetSpline) == 0x000008, "Wrong alignment on DelMarTrackTubeAudioComponent_SetSpline");
static_assert(sizeof(DelMarTrackTubeAudioComponent_SetSpline) == 0x000008, "Wrong size on DelMarTrackTubeAudioComponent_SetSpline");
static_assert(offsetof(DelMarTrackTubeAudioComponent_SetSpline, NewSpline) == 0x000000, "Member 'DelMarTrackTubeAudioComponent_SetSpline::NewSpline' has a wrong offset!");
