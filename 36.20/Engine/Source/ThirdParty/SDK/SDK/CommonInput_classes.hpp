...
static_assert(offsetof(UCommonInputActionDomainTable, bHideCursorDuringViewportCapture) == 0x000042, "Member 'UCommonInputActionDomainTable::bHideCursorDuringViewportCapture' has a wrong offset!");
...
static_assert(offsetof(UCommonInputBaseControllerData, GamepadCategory) == 0x000040, "Member 'UCommonInputBaseControllerData::GamepadCategory' has a wrong offset!");
static_assert(offsetof(UCommonInputBaseControllerData, GamepadPlatformName) == 0x000050, "Member 'UCommonInputBaseControllerData::GamepadPlatformName' has a wrong offset!");
static_assert(offsetof(UCommonInputBaseControllerData, GamepadHardwareIdMapping) == 0x000060, "Member 'UCommonInputBaseControllerData::GamepadHardwareIdMapping' has a wrong offset!");
static_assert(offsetof(UCommonInputBaseControllerData, ControllerTexture) == 0x000070, "Member 'UCommonInputBaseControllerData::ControllerTexture' has a wrong offset!");
static_assert(offsetof(UCommonInputBaseControllerData, ControllerButtonMaskTexture) == 0x000090, "Member 'UCommonInputBaseControllerData::ControllerButtonMaskTexture' has a wrong offset!");
...
public:
	...
	TMap<class FName, class FName>                PlatformNameUpgrades;                              // 0x00F0(0x0050)(Edit, Config, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonInputSettings) == 0x000158, "Wrong size on UCommonInputSettings");
...
static_assert(offsetof(UCommonInputSettings, PlatformNameUpgrades) == 0x0000F0, "Member 'UCommonInputSettings::PlatformNameUpgrades' has a wrong offset!");
static_assert(offsetof(UCommonInputSettings, InputDataClass) == 0x000148, "Member 'UCommonInputSettings::InputDataClass' has a wrong offset!");
static_assert(offsetof(UCommonInputSettings, ActionDomainTablePtr) == 0x000150, "Member 'UCommonInputSettings::ActionDomainTablePtr' has a wrong offset!");
