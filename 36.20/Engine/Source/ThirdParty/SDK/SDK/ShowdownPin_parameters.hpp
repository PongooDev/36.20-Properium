...
public:
	...
	int32                                         CallFunc_GetCurrentPartyRelevantAlternativeLeaderboardPoints_ReturnValue; // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetCurrentPartyRankGroupAlternativeLeaderboardPoints_ReturnValue; // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldUseRelevantAlternativeScore_ReturnValue; // 0x000C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldUseRankGroupAlternativeScore_ReturnValue; // 0x000D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_E[0x2];                                        // 0x000E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue; // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ShowdownPin_C_ChooseScoreToDisplay) == 0x00001C, "Wrong size on ShowdownPin_C_ChooseScoreToDisplay");
...
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_GetCurrentPartyRelevantAlternativeLeaderboardPoints_ReturnValue) == 0x000004, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_GetCurrentPartyRelevantAlternativeLeaderboardPoints_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_GetCurrentPartyRankGroupAlternativeLeaderboardPoints_ReturnValue) == 0x000008, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_GetCurrentPartyRankGroupAlternativeLeaderboardPoints_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_ShouldUseRelevantAlternativeScore_ReturnValue) == 0x00000C, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_ShouldUseRelevantAlternativeScore_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_ShouldUseRankGroupAlternativeScore_ReturnValue) == 0x00000D, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_ShouldUseRankGroupAlternativeScore_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue) == 0x000010, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_Not_PreBool_ReturnValue) == 0x000014, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_BooleanAND_ReturnValue) == 0x000015, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_BooleanAND_ReturnValue_1) == 0x000016, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_BooleanAND_ReturnValue_2) == 0x000017, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_BooleanAND_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ChooseScoreToDisplay, CallFunc_BooleanAND_ReturnValue_3) == 0x000018, "Member 'ShowdownPin_C_ChooseScoreToDisplay::CallFunc_BooleanAND_ReturnValue_3' has a wrong offset!");
...
public:
	...
	struct FWidgetAnimationHandle                 CallFunc_PlayAnimation_ReturnValue_1;              // 0x0170(0x0010)(HasGetValueTypeHash)
	...
	int32                                         K2Node_Select_Default_4;                           // 0x01AC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Select_Default_5;                           // 0x01B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select_Default_6;                           // 0x01B4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_1B5[0x3];                                      // 0x01B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UMaterialInterface*                     K2Node_Select_Default_7;                           // 0x01B8(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin) == 0x000200, "Wrong size on ShowdownPin_C_ExecuteUbergraph_ShowdownPin");
...
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000100, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_MakeColor_ReturnValue) == 0x000108, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_MakeColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, Temp_byte_Variable_3) == 0x000118, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_GetDynamicMaterial_ReturnValue_1) == 0x000120, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_GetDynamicMaterial_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, Temp_bool_Variable_5) == 0x000128, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::Temp_bool_Variable_5' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default) == 0x000129, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, Temp_int_Variable_5) == 0x00012C, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::Temp_int_Variable_5' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_PauseAnimation_ReturnValue) == 0x000130, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_PauseAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_GetStartTime_ReturnValue) == 0x000134, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_GetStartTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_PauseAnimation_ReturnValue_1) == 0x000138, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_PauseAnimation_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x00013C, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000140, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_PlayAnimation_ReturnValue) == 0x000148, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000160, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_1) == 0x000168, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_PlayAnimation_ReturnValue_1) == 0x000170, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000188, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_2) == 0x000190, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x000198, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Less_DoubleDouble_ReturnValue) == 0x0001A0, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Less_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Less_DoubleDouble_ReturnValue_1) == 0x0001A1, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Less_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_3) == 0x0001A4, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_3' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, CallFunc_Less_DoubleDouble_ReturnValue_2) == 0x0001A8, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::CallFunc_Less_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_4) == 0x0001AC, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_4' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_5) == 0x0001B0, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_5' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_6) == 0x0001B4, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_6' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_ExecuteUbergraph_ShowdownPin, K2Node_Select_Default_7) == 0x0001B8, "Member 'ShowdownPin_C_ExecuteUbergraph_ShowdownPin::K2Node_Select_Default_7' has a wrong offset!");
...
public:
	...
	int32                                         CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue; // 0x0048(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Temp_bool_Variable;                                // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortShowdownPinState                         Temp_byte_Variable_1;                              // 0x004D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ShowdownPin_C_Refresh) == 0x000068, "Wrong size on ShowdownPin_C_Refresh");
...
static_assert(offsetof(ShowdownPin_C_Refresh, CallFunc_Conv_IntToText_ReturnValue) == 0x000038, "Member 'ShowdownPin_C_Refresh::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue) == 0x000048, "Member 'ShowdownPin_C_Refresh::CallFunc_GetMainLeaderboardScoreToDisplay_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, Temp_bool_Variable) == 0x00004C, "Member 'ShowdownPin_C_Refresh::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, Temp_byte_Variable_1) == 0x00004D, "Member 'ShowdownPin_C_Refresh::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, K2Node_SwitchEnum_CmpSuccess) == 0x00004E, "Member 'ShowdownPin_C_Refresh::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, K2Node_Select_Default) == 0x000050, "Member 'ShowdownPin_C_Refresh::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, K2Node_Select_Default_1) == 0x000058, "Member 'ShowdownPin_C_Refresh::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, CallFunc_GetEventPinState_ReturnValue) == 0x000060, "Member 'ShowdownPin_C_Refresh::CallFunc_GetEventPinState_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, CallFunc_GetTournamentBestPinState_ReturnValue) == 0x000061, "Member 'ShowdownPin_C_Refresh::CallFunc_GetTournamentBestPinState_ReturnValue' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, K2Node_Select_Default_2) == 0x000062, "Member 'ShowdownPin_C_Refresh::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(ShowdownPin_C_Refresh, CallFunc_InterpolateToValue_TargetValue_ImplicitCast) == 0x000064, "Member 'ShowdownPin_C_Refresh::CallFunc_InterpolateToValue_TargetValue_ImplicitCast' has a wrong offset!");
