...
{
public:
	class UMLDeformerAsset*                       RequestedMLDeformerAsset;                          // 0x00F8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMeshDeformer*                          RequestedMeshDeformerAsset;                        // 0x0100(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortMLDeformerComponent) == 0x000118, "Wrong size on UFortMLDeformerComponent");
static_assert(offsetof(UFortMLDeformerComponent, RequestedMLDeformerAsset) == 0x0000F8, "Member 'UFortMLDeformerComponent::RequestedMLDeformerAsset' has a wrong offset!");
static_assert(offsetof(UFortMLDeformerComponent, RequestedMeshDeformerAsset) == 0x000100, "Member 'UFortMLDeformerComponent::RequestedMeshDeformerAsset' has a wrong offset!");
...
{
public:
	bool                                          bDisableWhenOwnerIsNotViewTarget;                  // 0x04F0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldRampUpWeightWhenEnabled;                    // 0x04F1(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4F2[0x2];                                      // 0x04F2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         WeightIncreasePerSecond;                           // 0x04F4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMLDeformerGameFeatureData) == 0x0004F8, "Wrong size on UMLDeformerGameFeatureData");
static_assert(offsetof(UMLDeformerGameFeatureData, bDisableWhenOwnerIsNotViewTarget) == 0x0004F0, "Member 'UMLDeformerGameFeatureData::bDisableWhenOwnerIsNotViewTarget' has a wrong offset!");
static_assert(offsetof(UMLDeformerGameFeatureData, bShouldRampUpWeightWhenEnabled) == 0x0004F1, "Member 'UMLDeformerGameFeatureData::bShouldRampUpWeightWhenEnabled' has a wrong offset!");
static_assert(offsetof(UMLDeformerGameFeatureData, WeightIncreasePerSecond) == 0x0004F4, "Member 'UMLDeformerGameFeatureData::WeightIncreasePerSecond' has a wrong offset!");
...
static_assert(sizeof(UMLDeformerComponentManager) == 0x0000E0, "Wrong size on UMLDeformerComponentManager");
