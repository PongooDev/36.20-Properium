...
static_assert(offsetof(FVoteSettings, VoteSelections) == 0x000018, "Member 'FVoteSettings::VoteSelections' has a wrong offset!");
...
static_assert(offsetof(FVoteSessionSettings, VoteSettingsList) == 0x000018, "Member 'FVoteSessionSettings::VoteSettingsList' has a wrong offset!");
static_assert(offsetof(FVoteSessionSettings, NetworkType) == 0x000028, "Member 'FVoteSessionSettings::NetworkType' has a wrong offset!");
