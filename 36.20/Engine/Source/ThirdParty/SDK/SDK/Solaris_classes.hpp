...
static_assert(offsetof(UVerseAssetsConfig, AssetConfigs) == 0x000028, "Member 'UVerseAssetsConfig::AssetConfigs' has a wrong offset!");
...
public:
	...
	TArray<class FName>                           DigestDependencyPackageNames;                      // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVerseDigest) == 0x0000D0, "Wrong size on UVerseDigest");
...
static_assert(offsetof(UVerseDigest, DigestDependencyPackageNames) == 0x0000C0, "Member 'UVerseDigest::DigestDependencyPackageNames' has a wrong offset!");
...
public:
	...
	static void MakeRationalFromInt(int64 int_0);
...
// Class Solaris.SolarisGameFeatureObserver
// 0x0008 (0x0030 - 0x0028)
class USolarisGameFeatureObserver final : public UObject
{
public:
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"SolarisGameFeatureObserver">();
	}
	static class USolarisGameFeatureObserver* GetDefaultObj()
	{
		return GetDefaultObjImpl<USolarisGameFeatureObserver>();
	}
};
static_assert(alignof(USolarisGameFeatureObserver) == 0x000008, "Wrong alignment on USolarisGameFeatureObserver");
static_assert(sizeof(USolarisGameFeatureObserver) == 0x000030, "Wrong size on USolarisGameFeatureObserver");
...
public:
	...
	static bool CheckFunctionReportCVar();
	static void DebugReportFunction(const class FString& FunctionName, const class FString& Qualifier);
	static int64 Dereference(int64 Reference);
	static void DestroyClassVarProxy();
	static void DidClassVarProxyCallSucceed();
	static void DynamicCastClassOrInterfaceType(class UObject* Object, class UClass* TargetType);
...
public:
	...
	static void MakeRuntimeTypeRational();
	static void MakeRuntimeTypeReference(int32 ValueType);
