...
static_assert(sizeof(WarEffortFundingLibrary_WriteTextToBuffer) == 0x000020, "Wrong size on WarEffortFundingLibrary_WriteTextToBuffer");
...
static_assert(offsetof(WarEffortFundingLibrary_WriteTextToBuffer, ReturnValue) == 0x000010, "Member 'WarEffortFundingLibrary_WriteTextToBuffer::ReturnValue' has a wrong offset!");
