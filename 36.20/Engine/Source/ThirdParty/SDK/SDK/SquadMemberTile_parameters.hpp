...
public:
	...
	struct FAthenaTeamDisplayInfo                 CallFunc_GetSquadDisplayInfo_ReturnValue;          // 0x0028(0x0070)()
	...
	bool                                          K2Node_Event_bHasValidMember;                      // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_F9[0x3];                                       // 0x00F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(class UObject* Loaded)>        K2Node_CreateDelegate_OutputDelegate;              // 0x00FC(0x000C)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bIsInFrontend;                        // 0x0108(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsCurrentMemberInFrontend_ReturnValue;    // 0x0109(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile) == 0x000110, "Wrong size on SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile");
...
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000018, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, Temp_object_Variable) == 0x000020, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::Temp_object_Variable' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_GetSquadDisplayInfo_ReturnValue) == 0x000028, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_GetSquadDisplayInfo_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_PlayAnimation_ReturnValue_1) == 0x0000B8, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x0000D8, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_GetDynamicMaterial_ReturnValue_1) == 0x0000E8, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_GetDynamicMaterial_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, K2Node_CustomEvent_Loaded) == 0x0000F0, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::K2Node_CustomEvent_Loaded' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, K2Node_Event_bHasValidMember) == 0x0000F8, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::K2Node_Event_bHasValidMember' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, K2Node_CreateDelegate_OutputDelegate) == 0x0000FC, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, K2Node_Event_bIsInFrontend) == 0x000108, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::K2Node_Event_bIsInFrontend' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile, CallFunc_IsCurrentMemberInFrontend_ReturnValue) == 0x000109, "Member 'SquadMemberTile_C_ExecuteUbergraph_SquadMemberTile::CallFunc_IsCurrentMemberInFrontend_ReturnValue' has a wrong offset!");
...
public:
	...
	EGameReadiness                                Temp_byte_Variable;                                // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(SquadMemberTile_C_SetVisuals) == 0x000050, "Wrong size on SquadMemberTile_C_SetVisuals");
...
static_assert(offsetof(SquadMemberTile_C_SetVisuals, CallFunc_BooleanOR_ReturnValue) == 0x000014, "Member 'SquadMemberTile_C_SetVisuals::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_SetVisuals, CallFunc_EqualEqual_ByteByte_ReturnValue_3) == 0x000015, "Member 'SquadMemberTile_C_SetVisuals::CallFunc_EqualEqual_ByteByte_ReturnValue_3' has a wrong offset!");
...
static_assert(offsetof(SquadMemberTile_C_SetVisuals, CallFunc_BooleanOR_ReturnValue_1) == 0x000020, "Member 'SquadMemberTile_C_SetVisuals::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(SquadMemberTile_C_SetVisuals, Temp_object_Variable_4) == 0x000038, "Member 'SquadMemberTile_C_SetVisuals::Temp_object_Variable_4' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_SetVisuals, Temp_byte_Variable) == 0x000040, "Member 'SquadMemberTile_C_SetVisuals::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(SquadMemberTile_C_SetVisuals, K2Node_Select_Default) == 0x000048, "Member 'SquadMemberTile_C_SetVisuals::K2Node_Select_Default' has a wrong offset!");
