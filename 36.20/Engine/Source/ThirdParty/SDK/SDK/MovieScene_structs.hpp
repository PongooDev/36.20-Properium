...
{
public:
	TSoftObjectPtr<class UMovieSceneCondition>    Condition;                                         // 0x0000(0x0020)(ExportObject, InstancedReference, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OverrideBoundPropertyPath;                         // 0x0020(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                           ForcedTime;                                        // 0x0030(0x0004)(ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESectionEvaluationFlags                       Flags;                                             // 0x0034(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bEvaluateInSequencePreRoll : 1;                    // 0x0035(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEvaluateInSequencePostRoll : 1;                   // 0x0035(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
...
static_assert(sizeof(FMovieSceneEvaluationFieldEntityMetaData) == 0x000038, "Wrong size on FMovieSceneEvaluationFieldEntityMetaData");
...
static_assert(offsetof(FMovieSceneEvaluationFieldEntityMetaData, OverrideBoundPropertyPath) == 0x000020, "Member 'FMovieSceneEvaluationFieldEntityMetaData::OverrideBoundPropertyPath' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationFieldEntityMetaData, ForcedTime) == 0x000030, "Member 'FMovieSceneEvaluationFieldEntityMetaData::ForcedTime' has a wrong offset!");
static_assert(offsetof(FMovieSceneEvaluationFieldEntityMetaData, Flags) == 0x000034, "Member 'FMovieSceneEvaluationFieldEntityMetaData::Flags' has a wrong offset!");
...
public:
	...
	struct FFrameRate                             TickResolution;                                    // 0x0058(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FMovieSceneFrameRange                  PlayRange;                                         // 0x0064(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  ParentPlayRange;                                   // 0x0074(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  PreRollRange;                                      // 0x0084(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	struct FMovieSceneFrameRange                  PostRollRange;                                     // 0x0094(0x0010)(NoDestructor, NativeAccessSpecifierPublic)
	int16                                         HierarchicalBias;                                  // 0x00A4(0x0002)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMovieSceneSubSectionFlags                    AccumulatedFlags;                                  // 0x00A6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCanLoop;                                          // 0x00A7(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FMovieSceneSequenceInstanceDataPtr     InstanceData;                                      // 0x00A8(0x0018)(NativeAccessSpecifierPublic)
	class FName                                   SectionPath;                                       // 0x00C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UMovieSceneCondition>    WeakCondition;                                     // 0x00C4(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CC[0x8];                                       // 0x00CC(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  SubSectionSignature;                               // 0x00D4(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FMovieSceneSubSequenceData, PlayRange) == 0x000064, "Member 'FMovieSceneSubSequenceData::PlayRange' has a wrong offset!");
...
static_assert(offsetof(FMovieSceneSubSequenceData, PreRollRange) == 0x000084, "Member 'FMovieSceneSubSequenceData::PreRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, PostRollRange) == 0x000094, "Member 'FMovieSceneSubSequenceData::PostRollRange' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, HierarchicalBias) == 0x0000A4, "Member 'FMovieSceneSubSequenceData::HierarchicalBias' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, AccumulatedFlags) == 0x0000A6, "Member 'FMovieSceneSubSequenceData::AccumulatedFlags' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, bCanLoop) == 0x0000A7, "Member 'FMovieSceneSubSequenceData::bCanLoop' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, InstanceData) == 0x0000A8, "Member 'FMovieSceneSubSequenceData::InstanceData' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, SectionPath) == 0x0000C0, "Member 'FMovieSceneSubSequenceData::SectionPath' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, WeakCondition) == 0x0000C4, "Member 'FMovieSceneSubSequenceData::WeakCondition' has a wrong offset!");
static_assert(offsetof(FMovieSceneSubSequenceData, SubSectionSignature) == 0x0000D4, "Member 'FMovieSceneSubSequenceData::SubSectionSignature' has a wrong offset!");
...
static_assert(alignof(FTestMovieSceneStruct) == 0x000008, "Wrong alignment on FTestMovieSceneStruct");
