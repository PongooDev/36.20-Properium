...
static_assert(alignof(FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown) == 0x000004, "Wrong alignment on FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown");
static_assert(sizeof(FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown) == 0x000004, "Wrong size on FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown");
static_assert(offsetof(FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown, CrownLevel) == 0x000000, "Member 'FortCheatManager_VictoryCrowns_VictoryCrownsGrantCrown::CrownLevel' has a wrong offset!");
...
static_assert(alignof(FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel) == 0x000004, "Wrong alignment on FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel");
static_assert(sizeof(FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel) == 0x000004, "Wrong size on FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel");
static_assert(offsetof(FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel, ReturnValue) == 0x000000, "Member 'FortControllerComponent_VictoryCrowns_GetVictoryCrownLevel::ReturnValue' has a wrong offset!");
...
static_assert(alignof(FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid) == 0x000004, "Wrong alignment on FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid");
static_assert(sizeof(FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid) == 0x000018, "Wrong size on FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid");
static_assert(offsetof(FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid, OutVictoryCrownLevel) == 0x000000, "Member 'FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid::OutVictoryCrownLevel' has a wrong offset!");
static_assert(offsetof(FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid, VictoryCrownItemTrackerGuid) == 0x000004, "Member 'FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid::VictoryCrownItemTrackerGuid' has a wrong offset!");
static_assert(offsetof(FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid, ReturnValue) == 0x000014, "Member 'FortGameStateComponent_VictoryCrowns_GetVictoryCrownLevelFromItemTrackerGuid::ReturnValue' has a wrong offset!");
