...
public:
	...
	TSoftObjectPtr<class UFortWeaponItemDefinition> ActivatorAsset;                                    // 0x0118(0x0020)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UInputComponent*                        InputComponent;                                    // 0x01B0(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TSoftObjectPtr<class AActor>                  CurrentlyFocusedActor;                             // 0x01C8(0x0020)(Transient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UFortGameFrameworkComponent_EventMode) == 0x000228, "Wrong size on UFortGameFrameworkComponent_EventMode");
static_assert(offsetof(UFortGameFrameworkComponent_EventMode, ActivatorAsset) == 0x000118, "Member 'UFortGameFrameworkComponent_EventMode::ActivatorAsset' has a wrong offset!");
...
static_assert(sizeof(AFortWeapon_EventMode) == 0x0019B8, "Wrong size on AFortWeapon_EventMode");
