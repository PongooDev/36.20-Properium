...
public:
	...
	struct FSlateFontInfo                         TicksTextFont;                                     // 0x00F8(0x0058)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TicksTextOffset;                                   // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateColor                            BackgroundColor;                                   // 0x0154(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FFixedSampleSequenceRulerStyle, TicksTextOffset) == 0x000150, "Member 'FFixedSampleSequenceRulerStyle::TicksTextOffset' has a wrong offset!");
static_assert(offsetof(FFixedSampleSequenceRulerStyle, BackgroundColor) == 0x000154, "Member 'FFixedSampleSequenceRulerStyle::BackgroundColor' has a wrong offset!");
...
public:
	...
	struct FSampledSequenceValueGridOverlayStyle  ValueGridStyle;                                    // 0x0240(0x0098)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x0090(0x0058)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAudioMaterialMeterStyle) == 0x000008, "Wrong alignment on FAudioMaterialMeterStyle");
static_assert(sizeof(FAudioMaterialMeterStyle) == 0x0000E8, "Wrong size on FAudioMaterialMeterStyle");
...
public:
	...
	struct FSlateFontInfo                         Font;                                              // 0x03D0(0x0058)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FSampledSequenceVectorViewerStyle      VectorViewerStyle;                                 // 0x00A0(0x00F0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAudioVectorscopePanelStyle) == 0x000010, "Wrong alignment on FAudioVectorscopePanelStyle");
static_assert(sizeof(FAudioVectorscopePanelStyle) == 0x000190, "Wrong size on FAudioVectorscopePanelStyle");
...
static_assert(alignof(FSpectrogramRackUnitSettings) == 0x000001, "Wrong alignment on FSpectrogramRackUnitSettings");
static_assert(sizeof(FSpectrogramRackUnitSettings) == 0x000007, "Wrong size on FSpectrogramRackUnitSettings");
static_assert(offsetof(FSpectrogramRackUnitSettings, AnalyzerType) == 0x000000, "Member 'FSpectrogramRackUnitSettings::AnalyzerType' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, FFTAnalyzerFFTSize) == 0x000001, "Member 'FSpectrogramRackUnitSettings::FFTAnalyzerFFTSize' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, CQTAnalyzerFFTSize) == 0x000002, "Member 'FSpectrogramRackUnitSettings::CQTAnalyzerFFTSize' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, PixelPlotMode) == 0x000003, "Member 'FSpectrogramRackUnitSettings::PixelPlotMode' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, FrequencyScale) == 0x000004, "Member 'FSpectrogramRackUnitSettings::FrequencyScale' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, ColorMap) == 0x000005, "Member 'FSpectrogramRackUnitSettings::ColorMap' has a wrong offset!");
static_assert(offsetof(FSpectrogramRackUnitSettings, orientation) == 0x000006, "Member 'FSpectrogramRackUnitSettings::orientation' has a wrong offset!");
...
static_assert(alignof(FSpectrumAnalyzerRackUnitSettings) == 0x000001, "Wrong alignment on FSpectrumAnalyzerRackUnitSettings");
static_assert(sizeof(FSpectrumAnalyzerRackUnitSettings) == 0x000009, "Wrong size on FSpectrumAnalyzerRackUnitSettings");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, Ballistics) == 0x000000, "Member 'FSpectrumAnalyzerRackUnitSettings::Ballistics' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, AnalyzerType) == 0x000001, "Member 'FSpectrumAnalyzerRackUnitSettings::AnalyzerType' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, FFTAnalyzerFFTSize) == 0x000002, "Member 'FSpectrumAnalyzerRackUnitSettings::FFTAnalyzerFFTSize' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, CQTAnalyzerFFTSize) == 0x000003, "Member 'FSpectrumAnalyzerRackUnitSettings::CQTAnalyzerFFTSize' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, TiltSpectrum) == 0x000004, "Member 'FSpectrumAnalyzerRackUnitSettings::TiltSpectrum' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, PixelPlotMode) == 0x000005, "Member 'FSpectrumAnalyzerRackUnitSettings::PixelPlotMode' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, FrequencyScale) == 0x000006, "Member 'FSpectrumAnalyzerRackUnitSettings::FrequencyScale' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, bDisplayFrequencyAxisLabels) == 0x000007, "Member 'FSpectrumAnalyzerRackUnitSettings::bDisplayFrequencyAxisLabels' has a wrong offset!");
static_assert(offsetof(FSpectrumAnalyzerRackUnitSettings, bDisplaySoundLevelAxisLabels) == 0x000008, "Member 'FSpectrumAnalyzerRackUnitSettings::bDisplaySoundLevelAxisLabels' has a wrong offset!");
...
public:
	...
	struct FSlateColor                            CrosshairColor;                                    // 0x00B4(0x0014)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FSlateFontInfo                         CrosshairLabelFont;                                // 0x00C8(0x0058)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAudioSpectrumPlotStyle) == 0x000008, "Wrong alignment on FAudioSpectrumPlotStyle");
static_assert(sizeof(FAudioSpectrumPlotStyle) == 0x000120, "Wrong size on FAudioSpectrumPlotStyle");
...
static_assert(offsetof(FAudioSpectrumPlotStyle, CrosshairColor) == 0x0000B4, "Member 'FAudioSpectrumPlotStyle::CrosshairColor' has a wrong offset!");
static_assert(offsetof(FAudioSpectrumPlotStyle, CrosshairLabelFont) == 0x0000C8, "Member 'FAudioSpectrumPlotStyle::CrosshairLabelFont' has a wrong offset!");
