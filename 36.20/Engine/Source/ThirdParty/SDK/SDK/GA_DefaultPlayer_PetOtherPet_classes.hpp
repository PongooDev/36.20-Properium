...
public:
	...
	void OnBlendedIn_FB7AFE5D4FF547CAEB1ECA8264EE1330();
...
static_assert(sizeof(UGA_DefaultPlayer_PetOtherPet_C) == 0x000B70, "Wrong size on UGA_DefaultPlayer_PetOtherPet_C");
static_assert(offsetof(UGA_DefaultPlayer_PetOtherPet_C, UberGraphFrame) == 0x000B68, "Member 'UGA_DefaultPlayer_PetOtherPet_C::UberGraphFrame' has a wrong offset!");
