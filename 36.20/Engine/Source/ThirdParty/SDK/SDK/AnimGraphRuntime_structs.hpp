...
public:
	...
	bool                                          bOverridePositionWhenJoiningSyncGroupAsLeader;     // 0x006D(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EAnimSyncMethod                               Method;                                            // 0x006E(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bIgnoreForRelevancyTest;                           // 0x006F(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bOverridePositionWhenJoiningSyncGroupAsLeader) == 0x00006D, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bOverridePositionWhenJoiningSyncGroupAsLeader' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, Method) == 0x00006E, "Member 'FAnimNode_BlendSpacePlayer_Standalone::Method' has a wrong offset!");
static_assert(offsetof(FAnimNode_BlendSpacePlayer_Standalone, bIgnoreForRelevancyTest) == 0x00006F, "Member 'FAnimNode_BlendSpacePlayer_Standalone::bIgnoreForRelevancyTest' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseByName, PoseWeight) == 0x0000A4, "Member 'FAnimNode_PoseByName::PoseWeight' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_PoseDriver, bEvalFromRefPose) == 0x0000CC, "Member 'FAnimNode_PoseDriver::bEvalFromRefPose' has a wrong offset!");
...
// 0x0450 (0x0BF0 - 0x07A0)
struct FAnimSequencerInstanceProxy final : public FAnimInstanceProxy
{
public:
	uint8                                         Pad_798[0x458];                                    // 0x0798(0x0458)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimSequencerInstanceProxy) == 0x000010, "Wrong alignment on FAnimSequencerInstanceProxy");
static_assert(sizeof(FAnimSequencerInstanceProxy) == 0x000BF0, "Wrong size on FAnimSequencerInstanceProxy");
...
public:
	...
	struct FBoneReference                         BaseBoneRef;                                       // 0x02F4(0x000C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	bool                                          bForceDisableCollisionBetweenConstraintBodies;     // 0x0302(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseExternalClothCollision;                        // 0x0303(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_304[0x1];                                      // 0x0304(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	uint8                                         bEnableWorldGeometry : 1;                          // 0x0305(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bOverrideWorldGravity : 1;                         // 0x0305(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bTransferBoneVelocities : 1;                       // 0x0305(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bFreezeIncomingPoseOnStart : 1;                    // 0x0305(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bClampLinearTranslationLimitToRefPose : 1;         // 0x0305(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	...
	ESimulationTiming                             SimulationTiming;                                  // 0x0311(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_312[0x60E];                                    // 0x0312(0x060E)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAnimNode_RigidBody) == 0x000010, "Wrong alignment on FAnimNode_RigidBody");
static_assert(sizeof(FAnimNode_RigidBody) == 0x000920, "Wrong size on FAnimNode_RigidBody");
...
static_assert(offsetof(FAnimNode_RigidBody, OverlapChannel) == 0x000300, "Member 'FAnimNode_RigidBody::OverlapChannel' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationSpace) == 0x000301, "Member 'FAnimNode_RigidBody::SimulationSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bForceDisableCollisionBetweenConstraintBodies) == 0x000302, "Member 'FAnimNode_RigidBody::bForceDisableCollisionBetweenConstraintBodies' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, bUseExternalClothCollision) == 0x000303, "Member 'FAnimNode_RigidBody::bUseExternalClothCollision' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, WorldSpaceMinimumScale) == 0x000308, "Member 'FAnimNode_RigidBody::WorldSpaceMinimumScale' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, EvaluationResetTime) == 0x00030C, "Member 'FAnimNode_RigidBody::EvaluationResetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_RigidBody, SimulationTiming) == 0x000311, "Member 'FAnimNode_RigidBody::SimulationTiming' has a wrong offset!");
...
static_assert(sizeof(FAnimNode_SplineIK) == 0x000258, "Wrong size on FAnimNode_SplineIK");
...
static_assert(sizeof(FAnimNode_SpringBone) == 0x000180, "Wrong size on FAnimNode_SpringBone");
...
static_assert(offsetof(FAnimNode_SpringBone, OwnerVelocityOverride) == 0x000168, "Member 'FAnimNode_SpringBone::OwnerVelocityOverride' has a wrong offset!");
