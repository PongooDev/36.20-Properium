...
// Function FortniteConversationUI.FortConversation_CommActiveBase.BP_HandleBackAction
// (RequiredAPI, Event, Protected, BlueprintEvent)

void UFortConversation_CommActiveBase::BP_HandleBackAction()
{
...
void UFortItemTransactionBrief::OnTransactionInfoReceived(class UFortItem* Item, const struct FFortServiceTransactionInfo& TransactionInfo)
{
	static class UFunction* Func = nullptr;
...
void UFortConversationMarker::OnEntityConversationComponentParticipantsChanged(class UFortNonPlayerConversationParticipantComponent* ConversationComponent, const TArray<class AController*>& Participants, const bool bIsMaxParticipants)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnEntityConversationComponentParticipantsChanged");
...
void UFortConversationMarker::OnNonPlayerConversationSettingsChanged(class UFortNonPlayerConversationParticipantComponent* ConversationComponent)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnNonPlayerConversationSettingsChanged");

	Params::FortConversationMarker_OnNonPlayerConversationSettingsChanged Parms{};
...
void UFortConversationMarker::OnParticipantNameSanitizationComplete(bool bSuccess, const TArray<struct FSanitizedEntry>& SanitizedEntries, const int32 SanitizeID)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnParticipantNameSanitizationComplete");
...
void UFortConversationMarker::SetIsAtMaxConversations(class UFortNonPlayerConversationParticipantComponent* ConversationComponent, bool bIsAtMaxConversations)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsAtMaxConversations");
...
void UFortDataDrivenServiceBrief::OnWarningMessageUpdated(const class FText& WarningMessage)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnWarningMessageUpdated");
...
void UFortHireBrief::BP_SetSpecializationIcon(class UObject* ResourceObject)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_SetSpecializationIcon");
