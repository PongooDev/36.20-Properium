...
public:
	...
	TWeakObjectPtr<class UObjectTest>             WeakObject;                                        // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UObjectTest>             SoftObject;                                        // 0x0050(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TOptional<class FName, true>                  NameOptional;                                      // 0x0030(0x0004)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TOptional<class FName, true>                  NameOptionalUnset;                                 // 0x0034(0x0004)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FStructSerializerOptionalTestStruct, NameOptionalUnset) == 0x000034, "Member 'FStructSerializerOptionalTestStruct::NameOptionalUnset' has a wrong offset!");
...
public:
	...
	struct FStructSerializerOptionalTestStruct    Optionals;                                         // 0x0490(0x0200)(NativeAccessSpecifierPublic)
	struct FStructSerializerLWCTypesTest          LWCTypes;                                          // 0x0690(0x0360)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FStructSerializerTestStruct) == 0x000010, "Wrong alignment on FStructSerializerTestStruct");
static_assert(sizeof(FStructSerializerTestStruct) == 0x0009F0, "Wrong size on FStructSerializerTestStruct");
...
static_assert(offsetof(FStructSerializerTestStruct, Optionals) == 0x000490, "Member 'FStructSerializerTestStruct::Optionals' has a wrong offset!");
static_assert(offsetof(FStructSerializerTestStruct, LWCTypes) == 0x000690, "Member 'FStructSerializerTestStruct::LWCTypes' has a wrong offset!");
