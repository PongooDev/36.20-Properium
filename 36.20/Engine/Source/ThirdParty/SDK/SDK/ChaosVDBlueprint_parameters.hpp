...
public:
	...
	class FName                                   Tag;                                               // 0x0040(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawBox, Color) == 0x000044, "Member 'ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawBox::Color' has a wrong offset!");
...
public:
	...
	class FName                                   Tag;                                               // 0x0038(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawLine, Color) == 0x00003C, "Member 'ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawLine::Color' has a wrong offset!");
...
public:
	...
	class FName                                   Tag;                                               // 0x0024(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawSphere) == 0x000038, "Wrong size on ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawSphere");
...
static_assert(offsetof(ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawSphere, Color) == 0x000028, "Member 'ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawSphere::Color' has a wrong offset!");
...
static_assert(offsetof(ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawVector, Color) == 0x00003C, "Member 'ChaosVDRuntimeBlueprintLibrary_RecordDebugDrawVector::Color' has a wrong offset!");
