...
{
public:
	TMulticastInlineDelegate<void(struct FGameplayTag& Key, class UUIStateChartContextEntry* Entry)> AnyEntryChangedDynamic;                            // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMap<struct FGameplayTag, class UUIStateChartContextEntry*> Store;                                             // 0x0038(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UUIStateChartContext) == 0x0000A0, "Wrong size on UUIStateChartContext");
static_assert(offsetof(UUIStateChartContext, AnyEntryChangedDynamic) == 0x000028, "Member 'UUIStateChartContext::AnyEntryChangedDynamic' has a wrong offset!");
static_assert(offsetof(UUIStateChartContext, Store) == 0x000038, "Member 'UUIStateChartContext::Store' has a wrong offset!");
