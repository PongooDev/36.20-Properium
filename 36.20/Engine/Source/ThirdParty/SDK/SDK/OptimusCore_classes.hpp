...
// 0x0000 (0x0028 - 0x0028)
class IOptimusDeformerAssetPathAccessor final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IOptimusDeformerAssetPathAccessor) == 0x000008, "Wrong alignment on IOptimusDeformerAssetPathAccessor");
static_assert(sizeof(IOptimusDeformerAssetPathAccessor) == 0x000028, "Wrong size on IOptimusDeformerAssetPathAccessor");

// Class OptimusCore.OptimusDeformerGeometryReadbackProvider
// 0x0000 (0x0028 - 0x0028)
class IOptimusDeformerGeometryReadbackProvider final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IOptimusDeformerGeometryReadbackProvider) == 0x000008, "Wrong alignment on IOptimusDeformerGeometryReadbackProvider");
static_assert(sizeof(IOptimusDeformerGeometryReadbackProvider) == 0x000028, "Wrong size on IOptimusDeformerGeometryReadbackProvider");
...
public:
	...
	float                                         DefaultValue;                                      // 0x002C(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UOptimusSkinnedMeshVertexAttributeDataInterface, DefaultValue) == 0x00002C, "Member 'UOptimusSkinnedMeshVertexAttributeDataInterface::DefaultValue' has a wrong offset!");
...
public:
	...
	class FName                                   AttributeName;                                     // 0x0038(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DefaultValue;                                      // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UOptimusSkinnedMeshVertexAttributeDataProvider, DefaultValue) == 0x00003C, "Member 'UOptimusSkinnedMeshVertexAttributeDataProvider::DefaultValue' has a wrong offset!");
...
{
public:
	class FName                                   SkinWeightProfile;                                 // 0x0028(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	class FName                                   SkinWeightProfile;                                 // 0x0028(0x0004)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableLayeredSkinning;                            // 0x002C(0x0001)(Edit, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusAnimAttributeBufferArray       AttributeBufferArray;                              // 0x0030(0x0010)(Edit, BlueprintReadOnly, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusAdvancedSkeletonDataInterface) == 0x000070, "Wrong size on UOptimusAdvancedSkeletonDataInterface");
...
static_assert(offsetof(UOptimusAdvancedSkeletonDataInterface, bEnableLayeredSkinning) == 0x00002C, "Member 'UOptimusAdvancedSkeletonDataInterface::bEnableLayeredSkinning' has a wrong offset!");
static_assert(offsetof(UOptimusAdvancedSkeletonDataInterface, AttributeBufferArray) == 0x000030, "Member 'UOptimusAdvancedSkeletonDataInterface::AttributeBufferArray' has a wrong offset!");
...
static_assert(sizeof(UOptimusCopyKernelDataProvider) == 0x000090, "Wrong size on UOptimusCopyKernelDataProvider");
...
static_assert(sizeof(UOptimusCustomComputeKernelDataProvider) == 0x000090, "Wrong size on UOptimusCustomComputeKernelDataProvider");
...
static_assert(sizeof(UOptimusRawBufferDataProvider) == 0x000098, "Wrong size on UOptimusRawBufferDataProvider");
...
static_assert(sizeof(UOptimusTransientBufferDataProvider) == 0x0000A0, "Wrong size on UOptimusTransientBufferDataProvider");
...
static_assert(sizeof(UOptimusImplicitPersistentBufferDataProvider) == 0x0000B8, "Wrong size on UOptimusImplicitPersistentBufferDataProvider");
...
static_assert(sizeof(UOptimusPersistentBufferDataProvider) == 0x0000B8, "Wrong size on UOptimusPersistentBufferDataProvider");
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0200(0x0028)(NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusNode_ConstantValueGeneratorClass) == 0x000228, "Wrong size on UOptimusNode_ConstantValueGeneratorClass");
...
static_assert(offsetof(UOptimusNode_CustomComputeKernel, KernelName) == 0x000134, "Member 'UOptimusNode_CustomComputeKernel::KernelName' has a wrong offset!");
static_assert(offsetof(UOptimusNode_CustomComputeKernel, ExecutionDomain) == 0x000138, "Member 'UOptimusNode_CustomComputeKernel::ExecutionDomain' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UOptimusFunctionNodeGraph> FunctionGraph;                                     // 0x0148(0x0020)(Deprecated, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusNode_FunctionReference) == 0x000170, "Wrong size on UOptimusNode_FunctionReference");
...
public:
	...
	struct FOptimusNode_ResourceAccessorBase_DuplicationInfo DuplicationInfo;                                   // 0x0138(0x0070)(DuplicateTransient, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UOptimusNode_ResourceAccessorBase) == 0x0001A8, "Wrong size on UOptimusNode_ResourceAccessorBase");
...
static_assert(sizeof(UOptimusNode_GetResource) == 0x0001A8, "Wrong size on UOptimusNode_GetResource");
...
public:
	...
	struct FOptimusNode_GetVariable_DuplicationInfo DuplicationInfo;                                   // 0x0128(0x0040)(DuplicateTransient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusNode_GetVariable) == 0x000168, "Wrong size on UOptimusNode_GetVariable");
...
static_assert(sizeof(UOptimusNode_Resource) == 0x0001A8, "Wrong size on UOptimusNode_Resource");
...
static_assert(sizeof(UOptimusNode_SetResource) == 0x0001A8, "Wrong size on UOptimusNode_SetResource");
...
static_assert(offsetof(UOptimusNode_SubGraphReference, DefaultComponentPin) == 0x000124, "Member 'UOptimusNode_SubGraphReference::DefaultComponentPin' has a wrong offset!");
...
public:
	...
	struct FGuid                                  Guid;                                              // 0x0150(0x0010)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, AdvancedDisplay, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UOptimusFunctionNodeGraph, AccessSpecifier) == 0x00014C, "Member 'UOptimusFunctionNodeGraph::AccessSpecifier' has a wrong offset!");
static_assert(offsetof(UOptimusFunctionNodeGraph, Guid) == 0x000150, "Member 'UOptimusFunctionNodeGraph::Guid' has a wrong offset!");
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0070(0x0028)(NativeAccessSpecifierPrivate)
	TArray<class UOptimusNodePin*>                SubPins;                                           // 0x0098(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(UOptimusNodePin, SubPins) == 0x000098, "Member 'UOptimusNodePin::SubPins' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C[0x4];                                       // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0030(0x0028)(Edit, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UOptimusComponentSourceBinding> ComponentBinding;                                  // 0x0058(0x0008)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FOptimusDataDomain                     DataDomain;                                        // 0x0060(0x0040)(Edit, NativeAccessSpecifierPublic)
	class UOptimusPersistentBufferDataInterface*  DataInterface;                                     // 0x00A0(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusResourceDescription) == 0x0000A8, "Wrong size on UOptimusResourceDescription");
...
static_assert(offsetof(UOptimusResourceDescription, ComponentBinding) == 0x000058, "Member 'UOptimusResourceDescription::ComponentBinding' has a wrong offset!");
static_assert(offsetof(UOptimusResourceDescription, DataDomain) == 0x000060, "Member 'UOptimusResourceDescription::DataDomain' has a wrong offset!");
static_assert(offsetof(UOptimusResourceDescription, DataInterface) == 0x0000A0, "Member 'UOptimusResourceDescription::DataInterface' has a wrong offset!");
...
{
public:
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0200(0x0028)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusValueContainerGeneratorClass) == 0x000228, "Wrong size on UOptimusValueContainerGeneratorClass");
...
public:
	...
	struct FOptimusDataTypeRef                    DataType;                                          // 0x0040(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FOptimusValueContainerStruct           DefaultValueStruct;                                // 0x0068(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FShaderValueContainer                  CachedShaderValue;                                 // 0x0078(0x0020)(Transient, NativeAccessSpecifierPublic)
	TArray<uint8>                                 ValueData;                                         // 0x0098(0x0010)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
	class UOptimusValueContainer*                 DefaultValue;                                      // 0x00A8(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UOptimusVariableDescription) == 0x0000B0, "Wrong size on UOptimusVariableDescription");
...
static_assert(offsetof(UOptimusVariableDescription, DefaultValueStruct) == 0x000068, "Member 'UOptimusVariableDescription::DefaultValueStruct' has a wrong offset!");
static_assert(offsetof(UOptimusVariableDescription, CachedShaderValue) == 0x000078, "Member 'UOptimusVariableDescription::CachedShaderValue' has a wrong offset!");
static_assert(offsetof(UOptimusVariableDescription, ValueData) == 0x000098, "Member 'UOptimusVariableDescription::ValueData' has a wrong offset!");
static_assert(offsetof(UOptimusVariableDescription, DefaultValue) == 0x0000A8, "Member 'UOptimusVariableDescription::DefaultValue' has a wrong offset!");
