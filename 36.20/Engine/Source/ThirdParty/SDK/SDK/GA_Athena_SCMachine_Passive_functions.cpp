...
bool UGA_Athena_SCMachine_Passive_C::AutoCollectCardsOverrideCheck()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("AutoCollectCardsOverrideCheck");

	Params::GA_Athena_SCMachine_Passive_C_AutoCollectCardsOverrideCheck Parms{};
...
// bool                                    AutoCollect                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FTransform                       Teamate_Transform                                      (Parm, OutParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGA_Athena_SCMachine_Passive_C::AutoCollectRebootCard(class AFortPlayerPawnAthena* Pawn, double ZPos, bool* AutoCollect, struct FTransform* Teamate_Transform)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("AutoCollectRebootCard");

	Params::GA_Athena_SCMachine_Passive_C_AutoCollectRebootCard Parms{};
	...
	if (AutoCollect != nullptr)
		*AutoCollect = Parms.AutoCollect;
