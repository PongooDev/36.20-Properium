...
// Enum FortniteAI.ETryStartSpawningResult
// NumValues: 0x0003
enum class ETryStartSpawningResult : uint8
{
	Failure                                  = 0,
	Success                                  = 1,
	DelayedUntilPlaylistDataIsReady          = 2,
};
...
enum class EUnconvertReason : uint8
{
	...
	EndPlay                                  = 6,
	Dismiss                                  = 7,
	TurnAgainstConverter                     = 8,
	GiveOwnershipToSquadmate                 = 9,
	Unknown                                  = 10,
};
...
// Enum FortniteAI.EFortActorFocusRotationAxis
// NumValues: 0x0004
enum class EFortActorFocusRotationAxis : uint8
{
	None                                     = 0,
	Pitch                                    = 1,
	Yaw                                      = 2,
...
// Enum FortniteAI.EVerbSubjectOwnerRequirement
// NumValues: 0x0003
enum class EVerbSubjectOwnerRequirement : uint8
{
	None                                     = 0,
	NoSelf                                   = 1,
	RequireSelf                              = 2,
...
// Enum FortniteAI.EVerbAuthorCategory
// NumValues: 0x0003
enum class EVerbAuthorCategory : uint8
{
	None                                     = 0,
	Self                                     = 1,
	Others                                   = 2,
...
// Enum FortniteAI.ENPCReactionPriority
// NumValues: 0x0007
enum class ENPCReactionPriority : uint8
{
	Low                                      = 0,
	BelowNormal                              = 1,
	Normal                                   = 2,
...
// NumValues: 0x0007
enum class ECorePerceptionTypesBitmask : uint8
{
	Sight                                    = 1,
	Hearing                                  = 2,
	Damage                                   = 4,
...
// Enum FortniteAI.EFortAIGamePhaseBehavior
// NumValues: 0x0004
enum class EFortAIGamePhaseBehavior : uint8
{
	None                                     = 0,
	Warmup                                   = 1,
	Gameplay                                 = 2,
...
// Enum FortniteAI.EFortWorldConditionDistanceType
// NumValues: 0x0004
enum class EFortWorldConditionDistanceType : uint8
{
	Distance3D                               = 0,
	DistanceHorizontal                       = 1,
	DistanceSignedVertical                   = 2,
	DistanceAbsoluteVertical                 = 3,
};
...
// ScriptStruct FortniteAI.FortAIDefendSpot_ShootSpot
// 0x0020 (0x0020 - 0x0000)
struct FFortAIDefendSpot_ShootSpot final
{
public:
	...
	bool                                          bCrouchValid;                                      // 0x0018(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSamePosition;                                     // 0x0019(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A[0x6];                                       // 0x001A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIDefendSpot_ShootSpot) == 0x000008, "Wrong alignment on FFortAIDefendSpot_ShootSpot");
static_assert(sizeof(FFortAIDefendSpot_ShootSpot) == 0x000020, "Wrong size on FFortAIDefendSpot_ShootSpot");
static_assert(offsetof(FFortAIDefendSpot_ShootSpot, Position) == 0x000000, "Member 'FFortAIDefendSpot_ShootSpot::Position' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot_ShootSpot, bCrouchValid) == 0x000018, "Member 'FFortAIDefendSpot_ShootSpot::bCrouchValid' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot_ShootSpot, bSamePosition) == 0x000019, "Member 'FFortAIDefendSpot_ShootSpot::bSamePosition' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIDefendSpot
// 0x0078 (0x0078 - 0x0000)
struct FFortAIDefendSpot final
{
public:
	struct FVector                                P0;                                                // 0x0000(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                P1;                                                // 0x0018(0x0018)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         SegmentHeight;                                     // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<struct FFortAIDefendSpot_ShootSpot>    ShootSpots;                                        // 0x0068(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAIDefendSpot) == 0x000008, "Wrong alignment on FFortAIDefendSpot");
static_assert(sizeof(FFortAIDefendSpot) == 0x000078, "Wrong size on FFortAIDefendSpot");
static_assert(offsetof(FFortAIDefendSpot, P0) == 0x000000, "Member 'FFortAIDefendSpot::P0' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot, P1) == 0x000018, "Member 'FFortAIDefendSpot::P1' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot, SegmentHeight) == 0x000030, "Member 'FFortAIDefendSpot::SegmentHeight' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot, Direction) == 0x000038, "Member 'FFortAIDefendSpot::Direction' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot, Position) == 0x000050, "Member 'FFortAIDefendSpot::Position' has a wrong offset!");
static_assert(offsetof(FFortAIDefendSpot, ShootSpots) == 0x000068, "Member 'FFortAIDefendSpot::ShootSpots' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIDefendVolume_BuilderData
// 0x0001 (0x0001 - 0x0000)
struct FFortAIDefendVolume_BuilderData final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIDefendVolume_BuilderData) == 0x000001, "Wrong alignment on FFortAIDefendVolume_BuilderData");
static_assert(sizeof(FFortAIDefendVolume_BuilderData) == 0x000001, "Wrong size on FFortAIDefendVolume_BuilderData");
...
// ScriptStruct FortniteAI.FortAIAimingDataTableRow
// 0x0090 (0x0098 - 0x0008)
struct FFortAIAimingDataTableRow final : public FTableRowBase
{
public:
	struct FGameplayTagQuery                      AimingTagQuery;                                    // 0x0008(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bCanTargetWeakspot;                                // 0x0050(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDoesAffectAccuracy;                               // 0x0051(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDoesHaveTargetAimOffset;                          // 0x0052(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_53[0x5];                                       // 0x0053(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         AccuracyErrorRatioMultiplier;                      // 0x0058(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FVector                                LocalTargetAimOffset;                              // 0x0080(0x0018)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAIAimingDataTableRow) == 0x000008, "Wrong alignment on FFortAIAimingDataTableRow");
static_assert(sizeof(FFortAIAimingDataTableRow) == 0x000098, "Wrong size on FFortAIAimingDataTableRow");
static_assert(offsetof(FFortAIAimingDataTableRow, AimingTagQuery) == 0x000008, "Member 'FFortAIAimingDataTableRow::AimingTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIAimingDataTableRow, bCanTargetWeakspot) == 0x000050, "Member 'FFortAIAimingDataTableRow::bCanTargetWeakspot' has a wrong offset!");
static_assert(offsetof(FFortAIAimingDataTableRow, bDoesAffectAccuracy) == 0x000051, "Member 'FFortAIAimingDataTableRow::bDoesAffectAccuracy' has a wrong offset!");
static_assert(offsetof(FFortAIAimingDataTableRow, bDoesHaveTargetAimOffset) == 0x000052, "Member 'FFortAIAimingDataTableRow::bDoesHaveTargetAimOffset' has a wrong offset!");
static_assert(offsetof(FFortAIAimingDataTableRow, AccuracyErrorRatioMultiplier) == 0x000058, "Member 'FFortAIAimingDataTableRow::AccuracyErrorRatioMultiplier' has a wrong offset!");
static_assert(offsetof(FFortAIAimingDataTableRow, LocalTargetAimOffset) == 0x000080, "Member 'FFortAIAimingDataTableRow::LocalTargetAimOffset' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIDefendVolume_DebugData
// 0x0001 (0x0001 - 0x0000)
struct FFortAIDefendVolume_DebugData final
{
public:
	uint8                                         Pad_0[0x1];                                        // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIDefendVolume_DebugData) == 0x000001, "Wrong alignment on FFortAIDefendVolume_DebugData");
static_assert(sizeof(FFortAIDefendVolume_DebugData) == 0x000001, "Wrong size on FFortAIDefendVolume_DebugData");

// ScriptStruct FortniteAI.AIEscalateReasonStim
// 0x0030 (0x0030 - 0x0000)
struct FAIEscalateReasonStim final
{
public:
	class FName                                   StimTag;                                           // 0x0000(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   StimGroupTag;                                      // 0x0004(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         IncreasePercentage;                                // 0x0008(0x0028)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIEscalateReasonStim) == 0x000008, "Wrong alignment on FAIEscalateReasonStim");
static_assert(sizeof(FAIEscalateReasonStim) == 0x000030, "Wrong size on FAIEscalateReasonStim");
static_assert(offsetof(FAIEscalateReasonStim, StimTag) == 0x000000, "Member 'FAIEscalateReasonStim::StimTag' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonStim, StimGroupTag) == 0x000004, "Member 'FAIEscalateReasonStim::StimGroupTag' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonStim, IncreasePercentage) == 0x000008, "Member 'FAIEscalateReasonStim::IncreasePercentage' has a wrong offset!");
...
public:
	...
	struct FBox                                   Box;                                               // 0x0008(0x0038)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FSmartObjectBanned) == 0x000014, "Wrong size on FSmartObjectBanned");

// ScriptStruct FortniteAI.GameplayAbilityDistanceValueModule
// 0x0050 (0x0050 - 0x0000)
struct FGameplayAbilityDistanceValueModule final
{
public:
	struct FGameplayTagContainer                  GameplayAbilityTag;                                // 0x0000(0x0020)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DistanceValueTag;                                  // 0x0020(0x0020)(Edit, NativeAccessSpecifierPublic)
	bool                                          bInitialized;                                      // 0x0040(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x3];                                       // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TOptional<float>                              CachedValue;                                       // 0x0044(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4C[0x4];                                       // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGameplayAbilityDistanceValueModule) == 0x000008, "Wrong alignment on FGameplayAbilityDistanceValueModule");
static_assert(sizeof(FGameplayAbilityDistanceValueModule) == 0x000050, "Wrong size on FGameplayAbilityDistanceValueModule");
static_assert(offsetof(FGameplayAbilityDistanceValueModule, GameplayAbilityTag) == 0x000000, "Member 'FGameplayAbilityDistanceValueModule::GameplayAbilityTag' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityDistanceValueModule, DistanceValueTag) == 0x000020, "Member 'FGameplayAbilityDistanceValueModule::DistanceValueTag' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityDistanceValueModule, bInitialized) == 0x000040, "Member 'FGameplayAbilityDistanceValueModule::bInitialized' has a wrong offset!");
static_assert(offsetof(FGameplayAbilityDistanceValueModule, CachedValue) == 0x000044, "Member 'FGameplayAbilityDistanceValueModule::CachedValue' has a wrong offset!");

// ScriptStruct FortniteAI.AIMovementItemData
// 0x00A0 (0x00A0 - 0x0000)
struct FAIMovementItemData final
{
public:
	struct FGameplayTagQuery                      MovementItemTagQuery;                              // 0x0000(0x0048)(Transient, NativeAccessSpecifierPrivate)
	struct FGameplayTagQuery                      ExplicitCooldownTagQuery;                          // 0x0048(0x0048)(Transient, NativeAccessSpecifierPrivate)
	bool                                          bIsAugmentItem;                                    // 0x0090(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bUseSecondaryFire;                                 // 0x0091(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCanUseInputToDeactivate;                          // 0x0092(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bPerformPathChecks;                                // 0x0093(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MinimumPathLength;                                 // 0x0094(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         NavLinkLookaheadDistance;                          // 0x0098(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIMovementItemData) == 0x000008, "Wrong alignment on FAIMovementItemData");
static_assert(sizeof(FAIMovementItemData) == 0x0000A0, "Wrong size on FAIMovementItemData");
static_assert(offsetof(FAIMovementItemData, MovementItemTagQuery) == 0x000000, "Member 'FAIMovementItemData::MovementItemTagQuery' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, ExplicitCooldownTagQuery) == 0x000048, "Member 'FAIMovementItemData::ExplicitCooldownTagQuery' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, bIsAugmentItem) == 0x000090, "Member 'FAIMovementItemData::bIsAugmentItem' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, bUseSecondaryFire) == 0x000091, "Member 'FAIMovementItemData::bUseSecondaryFire' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, bCanUseInputToDeactivate) == 0x000092, "Member 'FAIMovementItemData::bCanUseInputToDeactivate' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, bPerformPathChecks) == 0x000093, "Member 'FAIMovementItemData::bPerformPathChecks' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, MinimumPathLength) == 0x000094, "Member 'FAIMovementItemData::MinimumPathLength' has a wrong offset!");
static_assert(offsetof(FAIMovementItemData, NavLinkLookaheadDistance) == 0x000098, "Member 'FAIMovementItemData::NavLinkLookaheadDistance' has a wrong offset!");
...
{
public:
	class FName                                   Loadout;                                           // 0x0000(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         Weight;                                            // 0x0008(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAILoadoutEntry) == 0x000008, "Wrong alignment on FFortAILoadoutEntry");
static_assert(sizeof(FFortAILoadoutEntry) == 0x000030, "Wrong size on FFortAILoadoutEntry");
static_assert(offsetof(FFortAILoadoutEntry, Loadout) == 0x000000, "Member 'FFortAILoadoutEntry::Loadout' has a wrong offset!");
static_assert(offsetof(FFortAILoadoutEntry, Weight) == 0x000008, "Member 'FFortAILoadoutEntry::Weight' has a wrong offset!");
...
static_assert(alignof(FFortAILoadoutInfo) == 0x000008, "Wrong alignment on FFortAILoadoutInfo");
static_assert(sizeof(FFortAILoadoutInfo) == 0x000018, "Wrong size on FFortAILoadoutInfo");
static_assert(offsetof(FFortAILoadoutInfo, LoadoutTable) == 0x000000, "Member 'FFortAILoadoutInfo::LoadoutTable' has a wrong offset!");
static_assert(offsetof(FFortAILoadoutInfo, Loadouts) == 0x000008, "Member 'FFortAILoadoutInfo::Loadouts' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortAIWeaponDataTableRow
// 0x0050 (0x0058 - 0x0008)
struct FFortAIWeaponDataTableRow final : public FTableRowBase
{
public:
	struct FGameplayTagQuery                      WeaponTagQuery;                                    // 0x0008(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	float                                         FiringRateMultiplier;                              // 0x0050(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_54[0x4];                                       // 0x0054(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIWeaponDataTableRow) == 0x000008, "Wrong alignment on FFortAIWeaponDataTableRow");
static_assert(sizeof(FFortAIWeaponDataTableRow) == 0x000058, "Wrong size on FFortAIWeaponDataTableRow");
static_assert(offsetof(FFortAIWeaponDataTableRow, WeaponTagQuery) == 0x000008, "Member 'FFortAIWeaponDataTableRow::WeaponTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIWeaponDataTableRow, FiringRateMultiplier) == 0x000050, "Member 'FFortAIWeaponDataTableRow::FiringRateMultiplier' has a wrong offset!");
...
{
public:
	struct FBox                                   Box;                                               // 0x0000(0x0038)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct FFortSmartObjectEvaluationRequest      Request;                                           // 0x0000(0x0058)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortAISmartObjectEvaluationRequestInternalData) == 0x0000C8, "Wrong size on FFortAISmartObjectEvaluationRequestInternalData");
...
{
public:
	struct FWorldConditionContextDataRef          SourceActorRef;                                    // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FWorldConditionContextDataRef          TargetActorRef;                                    // 0x0018(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Distance;                                          // 0x0020(0x0028)(Edit, NativeAccessSpecifierPublic)
	EArithmeticKeyOperation                       Operation;                                         // 0x0048(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFortWorldConditionDistanceType               DistanceType;                                      // 0x0049(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4A[0x6];                                       // 0x004A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionDistanceCheck) == 0x000008, "Wrong alignment on FFortWorldConditionDistanceCheck");
static_assert(sizeof(FFortWorldConditionDistanceCheck) == 0x000050, "Wrong size on FFortWorldConditionDistanceCheck");
static_assert(offsetof(FFortWorldConditionDistanceCheck, SourceActorRef) == 0x000010, "Member 'FFortWorldConditionDistanceCheck::SourceActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionDistanceCheck, TargetActorRef) == 0x000018, "Member 'FFortWorldConditionDistanceCheck::TargetActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionDistanceCheck, Distance) == 0x000020, "Member 'FFortWorldConditionDistanceCheck::Distance' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionDistanceCheck, Operation) == 0x000048, "Member 'FFortWorldConditionDistanceCheck::Operation' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionDistanceCheck, DistanceType) == 0x000049, "Member 'FFortWorldConditionDistanceCheck::DistanceType' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         IncreasedAccuracyRatioAgainstDBNO;                 // 0x02F8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         IncreasedAccuracyRatioAgainstBots;                 // 0x0320(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         UseLastTimeToHitOnWeaponChange;                    // 0x0348(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ForceMissEnabled;                                  // 0x0370(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ExtraClampingDistance;                             // 0x0398(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         PreventHeadshots;                                  // 0x03C0(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         WeaponSpreadContributionToClampCurve;              // 0x03E8(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         KillingBlowGracePeriodAtMinRange;                  // 0x0410(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         KillingBlowGracePeriodAtMaxRange;                  // 0x0438(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ExtraHitOddsCurve;                                 // 0x0460(0x0028)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FAimingCircleSettings) == 0x000008, "Wrong alignment on FAimingCircleSettings");
static_assert(sizeof(FAimingCircleSettings) == 0x000488, "Wrong size on FAimingCircleSettings");
...
static_assert(offsetof(FAimingCircleSettings, IncreasedAccuracyRatioAgainstDBNO) == 0x0002F8, "Member 'FAimingCircleSettings::IncreasedAccuracyRatioAgainstDBNO' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, IncreasedAccuracyRatioAgainstBots) == 0x000320, "Member 'FAimingCircleSettings::IncreasedAccuracyRatioAgainstBots' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, UseLastTimeToHitOnWeaponChange) == 0x000348, "Member 'FAimingCircleSettings::UseLastTimeToHitOnWeaponChange' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, ForceMissEnabled) == 0x000370, "Member 'FAimingCircleSettings::ForceMissEnabled' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, ExtraClampingDistance) == 0x000398, "Member 'FAimingCircleSettings::ExtraClampingDistance' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, PreventHeadshots) == 0x0003C0, "Member 'FAimingCircleSettings::PreventHeadshots' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, WeaponSpreadContributionToClampCurve) == 0x0003E8, "Member 'FAimingCircleSettings::WeaponSpreadContributionToClampCurve' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, KillingBlowGracePeriodAtMinRange) == 0x000410, "Member 'FAimingCircleSettings::KillingBlowGracePeriodAtMinRange' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, KillingBlowGracePeriodAtMaxRange) == 0x000438, "Member 'FAimingCircleSettings::KillingBlowGracePeriodAtMaxRange' has a wrong offset!");
static_assert(offsetof(FAimingCircleSettings, ExtraHitOddsCurve) == 0x000460, "Member 'FAimingCircleSettings::ExtraHitOddsCurve' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         MaxAngleThresholdToAddWeaponOffset;                // 0x01B8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         StopFiringIfLoFIsOccludedByLandscape;              // 0x01E0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ChaseAfterTargetOnLoFLoss;                         // 0x0208(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         LookForDistantPositionsOnLoFLoss;                  // 0x0230(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         OccludedShootingPositionScoreDistance;             // 0x0258(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         LoFMaxTestDistance;                                // 0x0280(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         IdealAttackRange;                                  // 0x02A8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         TargetingIdealAttackRange;                         // 0x02D0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxAttackRangeFactor;                              // 0x02F8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ShouldAimAtTargetsFeet;                            // 0x0320(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ChanceToAimAtTargetsFeetWhenTimeToHit;             // 0x0348(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ShouldUseProjectileArcForAiming;                   // 0x0370(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         KeepAimingOnSameSideWhileFiring;                   // 0x0398(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         SkipTargetPositionHistoryForEstimatedLocation;     // 0x03C0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxTrackingHeightOffsetError;                      // 0x03E8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MinRotationInterpSpeed;                            // 0x0410(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxRotationInterpSpeed;                            // 0x0438(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         ConsiderProjectileTravelTime;                      // 0x0460(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAimingCircleSettings;                     // 0x0488(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_489[0x7];                                      // 0x0489(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAimingCircleSettings                  AimingCircleSettingsOverride;                      // 0x0490(0x0488)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FWeaponAccuracy) == 0x000008, "Wrong alignment on FWeaponAccuracy");
static_assert(sizeof(FWeaponAccuracy) == 0x000918, "Wrong size on FWeaponAccuracy");
...
static_assert(offsetof(FWeaponAccuracy, MaxAngleThresholdToAddWeaponOffset) == 0x0001B8, "Member 'FWeaponAccuracy::MaxAngleThresholdToAddWeaponOffset' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, StopFiringIfLoFIsOccludedByLandscape) == 0x0001E0, "Member 'FWeaponAccuracy::StopFiringIfLoFIsOccludedByLandscape' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, ChaseAfterTargetOnLoFLoss) == 0x000208, "Member 'FWeaponAccuracy::ChaseAfterTargetOnLoFLoss' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, LookForDistantPositionsOnLoFLoss) == 0x000230, "Member 'FWeaponAccuracy::LookForDistantPositionsOnLoFLoss' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, OccludedShootingPositionScoreDistance) == 0x000258, "Member 'FWeaponAccuracy::OccludedShootingPositionScoreDistance' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, LoFMaxTestDistance) == 0x000280, "Member 'FWeaponAccuracy::LoFMaxTestDistance' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, IdealAttackRange) == 0x0002A8, "Member 'FWeaponAccuracy::IdealAttackRange' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, TargetingIdealAttackRange) == 0x0002D0, "Member 'FWeaponAccuracy::TargetingIdealAttackRange' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, MaxAttackRangeFactor) == 0x0002F8, "Member 'FWeaponAccuracy::MaxAttackRangeFactor' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, ShouldAimAtTargetsFeet) == 0x000320, "Member 'FWeaponAccuracy::ShouldAimAtTargetsFeet' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, ChanceToAimAtTargetsFeetWhenTimeToHit) == 0x000348, "Member 'FWeaponAccuracy::ChanceToAimAtTargetsFeetWhenTimeToHit' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, ShouldUseProjectileArcForAiming) == 0x000370, "Member 'FWeaponAccuracy::ShouldUseProjectileArcForAiming' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, KeepAimingOnSameSideWhileFiring) == 0x000398, "Member 'FWeaponAccuracy::KeepAimingOnSameSideWhileFiring' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, SkipTargetPositionHistoryForEstimatedLocation) == 0x0003C0, "Member 'FWeaponAccuracy::SkipTargetPositionHistoryForEstimatedLocation' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, MaxTrackingHeightOffsetError) == 0x0003E8, "Member 'FWeaponAccuracy::MaxTrackingHeightOffsetError' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, MinRotationInterpSpeed) == 0x000410, "Member 'FWeaponAccuracy::MinRotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, MaxRotationInterpSpeed) == 0x000438, "Member 'FWeaponAccuracy::MaxRotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, ConsiderProjectileTravelTime) == 0x000460, "Member 'FWeaponAccuracy::ConsiderProjectileTravelTime' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, bOverrideAimingCircleSettings) == 0x000488, "Member 'FWeaponAccuracy::bOverrideAimingCircleSettings' has a wrong offset!");
static_assert(offsetof(FWeaponAccuracy, AimingCircleSettingsOverride) == 0x000490, "Member 'FWeaponAccuracy::AimingCircleSettingsOverride' has a wrong offset!");
...
public:
	...
	struct FWeaponAccuracy                        WeaponAccuracy;                                    // 0x0020(0x0918)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FWeaponAccuracyCategorySpecialization) == 0x000938, "Wrong size on FWeaponAccuracyCategorySpecialization");
...
// ScriptStruct FortniteAI.FortInjectedBehaviorContextBase
// 0x0018 (0x0018 - 0x0000)
struct FFortInjectedBehaviorContextBase
{
public:
	class UFortInjectedBehavior*                  InjectedBehavior;                                  // 0x0000(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UFortWorldItem>          InjectionItem;                                     // 0x0008(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class AFortAthenaVehicle>      InjectionVehicle;                                  // 0x0010(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortInjectedBehaviorContextBase) == 0x000008, "Wrong alignment on FFortInjectedBehaviorContextBase");
static_assert(sizeof(FFortInjectedBehaviorContextBase) == 0x000018, "Wrong size on FFortInjectedBehaviorContextBase");
static_assert(offsetof(FFortInjectedBehaviorContextBase, InjectedBehavior) == 0x000000, "Member 'FFortInjectedBehaviorContextBase::InjectedBehavior' has a wrong offset!");
static_assert(offsetof(FFortInjectedBehaviorContextBase, InjectionItem) == 0x000008, "Member 'FFortInjectedBehaviorContextBase::InjectionItem' has a wrong offset!");
static_assert(offsetof(FFortInjectedBehaviorContextBase, InjectionVehicle) == 0x000010, "Member 'FFortInjectedBehaviorContextBase::InjectionVehicle' has a wrong offset!");
...
struct alignas(0x04) FSmartObjectActivityResult final
{
public:
	uint8                                         Pad_0[0x2C];                                       // 0x0000(0x002C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FSmartObjectActivityResult) == 0x000004, "Wrong alignment on FSmartObjectActivityResult");
static_assert(sizeof(FSmartObjectActivityResult) == 0x00002C, "Wrong size on FSmartObjectActivityResult");
...
public:
	...
	struct FSlateBrush                            DebugMinimapIconBrush;                             // 0x0010(0x00B0)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FVector2D                              DebugMinimapIconScale;                             // 0x00C0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSlateBrush                            DebugCompassIconBrush;                             // 0x00D0(0x00B0)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FVector2D                              DebugCompassIconScale;                             // 0x0180(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDebugMinimapData) == 0x000010, "Wrong alignment on FDebugMinimapData");
static_assert(sizeof(FDebugMinimapData) == 0x000190, "Wrong size on FDebugMinimapData");
...
static_assert(offsetof(FDebugMinimapData, DebugMinimapIconScale) == 0x0000C0, "Member 'FDebugMinimapData::DebugMinimapIconScale' has a wrong offset!");
static_assert(offsetof(FDebugMinimapData, DebugCompassIconBrush) == 0x0000D0, "Member 'FDebugMinimapData::DebugCompassIconBrush' has a wrong offset!");
static_assert(offsetof(FDebugMinimapData, DebugCompassIconScale) == 0x000180, "Member 'FDebugMinimapData::DebugCompassIconScale' has a wrong offset!");

// ScriptStruct FortniteAI.AIEscalateReasonCondition
// 0x0060 (0x0060 - 0x0000)
struct FAIEscalateReasonCondition
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         Enabled;                                           // 0x0008(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         IncreasePercentageRate;                            // 0x0030(0x0028)(Edit, NativeAccessSpecifierPublic)
	class FName                                   DebugTag;                                          // 0x0058(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateReasonCondition) == 0x000008, "Wrong alignment on FAIEscalateReasonCondition");
static_assert(sizeof(FAIEscalateReasonCondition) == 0x000060, "Wrong size on FAIEscalateReasonCondition");
static_assert(offsetof(FAIEscalateReasonCondition, Enabled) == 0x000008, "Member 'FAIEscalateReasonCondition::Enabled' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition, IncreasePercentageRate) == 0x000030, "Member 'FAIEscalateReasonCondition::IncreasePercentageRate' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition, DebugTag) == 0x000058, "Member 'FAIEscalateReasonCondition::DebugTag' has a wrong offset!");

// ScriptStruct FortniteAI.AthenaAIServiceLOF_SubscriberData
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FAthenaAIServiceLOF_SubscriberData final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaAIServiceLOF_SubscriberData) == 0x000008, "Wrong alignment on FAthenaAIServiceLOF_SubscriberData");
static_assert(sizeof(FAthenaAIServiceLOF_SubscriberData) == 0x000010, "Wrong size on FAthenaAIServiceLOF_SubscriberData");

// ScriptStruct FortniteAI.AthenaAIServiceLOF_EvaluationData
// 0x0110 (0x0110 - 0x0000)
struct alignas(0x10) FAthenaAIServiceLOF_EvaluationData final
{
public:
	uint8                                         Pad_0[0x110];                                      // 0x0000(0x0110)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAthenaAIServiceLOF_EvaluationData) == 0x000010, "Wrong alignment on FAthenaAIServiceLOF_EvaluationData");
static_assert(sizeof(FAthenaAIServiceLOF_EvaluationData) == 0x000110, "Wrong size on FAthenaAIServiceLOF_EvaluationData");

// ScriptStruct FortniteAI.FortActorFocusTurningStrategy
// 0x0008 (0x0008 - 0x0000)
struct alignas(0x08) FFortActorFocusTurningStrategy
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortActorFocusTurningStrategy) == 0x000008, "Wrong alignment on FFortActorFocusTurningStrategy");
static_assert(sizeof(FFortActorFocusTurningStrategy) == 0x000008, "Wrong size on FFortActorFocusTurningStrategy");

// ScriptStruct FortniteAI.FortActorFocusTurningConstantSpeedStrategy
// 0x0028 (0x0030 - 0x0008)
struct FFortActorFocusTurningConstantSpeedStrategy final : public FFortActorFocusTurningStrategy
{
public:
	struct FScalableFloat                         TurningRate;                                       // 0x0008(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortActorFocusTurningConstantSpeedStrategy) == 0x000008, "Wrong alignment on FFortActorFocusTurningConstantSpeedStrategy");
static_assert(sizeof(FFortActorFocusTurningConstantSpeedStrategy) == 0x000030, "Wrong size on FFortActorFocusTurningConstantSpeedStrategy");
static_assert(offsetof(FFortActorFocusTurningConstantSpeedStrategy, TurningRate) == 0x000008, "Member 'FFortActorFocusTurningConstantSpeedStrategy::TurningRate' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusTurningRInterpStrategy
// 0x0028 (0x0030 - 0x0008)
struct FFortActorFocusTurningRInterpStrategy final : public FFortActorFocusTurningStrategy
{
public:
	struct FScalableFloat                         InterpSpeed;                                       // 0x0008(0x0028)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortActorFocusTurningRInterpStrategy) == 0x000008, "Wrong alignment on FFortActorFocusTurningRInterpStrategy");
static_assert(sizeof(FFortActorFocusTurningRInterpStrategy) == 0x000030, "Wrong size on FFortActorFocusTurningRInterpStrategy");
static_assert(offsetof(FFortActorFocusTurningRInterpStrategy, InterpSpeed) == 0x000008, "Member 'FFortActorFocusTurningRInterpStrategy::InterpSpeed' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusComponentPauseInstanceData
// 0x0008 (0x0008 - 0x0000)
struct FFortActorFocusComponentPauseInstanceData final
{
public:
...
static_assert(alignof(FFortActorFocusComponentPauseInstanceData) == 0x000008, "Wrong alignment on FFortActorFocusComponentPauseInstanceData");
static_assert(sizeof(FFortActorFocusComponentPauseInstanceData) == 0x000008, "Wrong size on FFortActorFocusComponentPauseInstanceData");
static_assert(offsetof(FFortActorFocusComponentPauseInstanceData, Actor) == 0x000000, "Member 'FFortActorFocusComponentPauseInstanceData::Actor' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusComponentPauseTask
// 0x0000 (0x0020 - 0x0020)
struct FFortActorFocusComponentPauseTask final : public FStateTreeTaskCommonBase
{
};
static_assert(alignof(FFortActorFocusComponentPauseTask) == 0x000008, "Wrong alignment on FFortActorFocusComponentPauseTask");
static_assert(sizeof(FFortActorFocusComponentPauseTask) == 0x000020, "Wrong size on FFortActorFocusComponentPauseTask");

// ScriptStruct FortniteAI.FortActorFocusComponentSetActorFocusInstanceData
// 0x0010 (0x0010 - 0x0000)
struct FFortActorFocusComponentSetActorFocusInstanceData final
{
public:
	class AActor*                                 Actor;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FFortActorFocusComponentSetActorFocusInstanceData) == 0x000008, "Wrong alignment on FFortActorFocusComponentSetActorFocusInstanceData");
static_assert(sizeof(FFortActorFocusComponentSetActorFocusInstanceData) == 0x000010, "Wrong size on FFortActorFocusComponentSetActorFocusInstanceData");
static_assert(offsetof(FFortActorFocusComponentSetActorFocusInstanceData, Actor) == 0x000000, "Member 'FFortActorFocusComponentSetActorFocusInstanceData::Actor' has a wrong offset!");
static_assert(offsetof(FFortActorFocusComponentSetActorFocusInstanceData, FocusActor) == 0x000008, "Member 'FFortActorFocusComponentSetActorFocusInstanceData::FocusActor' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusComponentSetActorFocusTask
// 0x0000 (0x0020 - 0x0020)
struct FFortActorFocusComponentSetActorFocusTask final : public FStateTreeTaskCommonBase
{
};
static_assert(alignof(FFortActorFocusComponentSetActorFocusTask) == 0x000008, "Wrong alignment on FFortActorFocusComponentSetActorFocusTask");
static_assert(sizeof(FFortActorFocusComponentSetActorFocusTask) == 0x000020, "Wrong size on FFortActorFocusComponentSetActorFocusTask");

// ScriptStruct FortniteAI.FortActorFocusComponentSetLocationFocusInstanceData
// 0x0020 (0x0020 - 0x0000)
struct FFortActorFocusComponentSetLocationFocusInstanceData final
{
public:
	class AActor*                                 Actor;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                FocusLocation;                                     // 0x0008(0x0018)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortActorFocusComponentSetLocationFocusInstanceData) == 0x000008, "Wrong alignment on FFortActorFocusComponentSetLocationFocusInstanceData");
static_assert(sizeof(FFortActorFocusComponentSetLocationFocusInstanceData) == 0x000020, "Wrong size on FFortActorFocusComponentSetLocationFocusInstanceData");
static_assert(offsetof(FFortActorFocusComponentSetLocationFocusInstanceData, Actor) == 0x000000, "Member 'FFortActorFocusComponentSetLocationFocusInstanceData::Actor' has a wrong offset!");
static_assert(offsetof(FFortActorFocusComponentSetLocationFocusInstanceData, FocusLocation) == 0x000008, "Member 'FFortActorFocusComponentSetLocationFocusInstanceData::FocusLocation' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusComponentSetLocationFocusTask
// 0x0000 (0x0020 - 0x0020)
struct FFortActorFocusComponentSetLocationFocusTask final : public FStateTreeTaskCommonBase
{
};
static_assert(alignof(FFortActorFocusComponentSetLocationFocusTask) == 0x000008, "Wrong alignment on FFortActorFocusComponentSetLocationFocusTask");
static_assert(sizeof(FFortActorFocusComponentSetLocationFocusTask) == 0x000020, "Wrong size on FFortActorFocusComponentSetLocationFocusTask");

// ScriptStruct FortniteAI.FortActorFocusComponentUpdateStrategyInstanceData
// 0x0028 (0x0028 - 0x0000)
struct FFortActorFocusComponentUpdateStrategyInstanceData final
{
public:
	class AActor*                                 Actor;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       NewStrategy;                                       // 0x0008(0x0010)(Edit, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       PreviousStrategy;                                  // 0x0018(0x0010)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortActorFocusComponentUpdateStrategyInstanceData) == 0x000008, "Wrong alignment on FFortActorFocusComponentUpdateStrategyInstanceData");
static_assert(sizeof(FFortActorFocusComponentUpdateStrategyInstanceData) == 0x000028, "Wrong size on FFortActorFocusComponentUpdateStrategyInstanceData");
static_assert(offsetof(FFortActorFocusComponentUpdateStrategyInstanceData, Actor) == 0x000000, "Member 'FFortActorFocusComponentUpdateStrategyInstanceData::Actor' has a wrong offset!");
static_assert(offsetof(FFortActorFocusComponentUpdateStrategyInstanceData, NewStrategy) == 0x000008, "Member 'FFortActorFocusComponentUpdateStrategyInstanceData::NewStrategy' has a wrong offset!");
static_assert(offsetof(FFortActorFocusComponentUpdateStrategyInstanceData, PreviousStrategy) == 0x000018, "Member 'FFortActorFocusComponentUpdateStrategyInstanceData::PreviousStrategy' has a wrong offset!");

// ScriptStruct FortniteAI.FortActorFocusComponentUpdateTurningStrategyTask
// 0x0000 (0x0020 - 0x0020)
struct FFortActorFocusComponentUpdateTurningStrategyTask final : public FStateTreeTaskCommonBase
{
};
static_assert(alignof(FFortActorFocusComponentUpdateTurningStrategyTask) == 0x000008, "Wrong alignment on FFortActorFocusComponentUpdateTurningStrategyTask");
static_assert(sizeof(FFortActorFocusComponentUpdateTurningStrategyTask) == 0x000020, "Wrong size on FFortActorFocusComponentUpdateTurningStrategyTask");
...
// ScriptStruct FortniteAI.FortAIInjectedDecisionInterfaceData
// 0x0018 (0x0018 - 0x0000)
struct FFortAIInjectedDecisionInterfaceData final
{
public:
	class UObject*                                DecisionObject;                                    // 0x0000(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8[0x10];                                       // 0x0008(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIInjectedDecisionInterfaceData) == 0x000008, "Wrong alignment on FFortAIInjectedDecisionInterfaceData");
static_assert(sizeof(FFortAIInjectedDecisionInterfaceData) == 0x000018, "Wrong size on FFortAIInjectedDecisionInterfaceData");
static_assert(offsetof(FFortAIInjectedDecisionInterfaceData, DecisionObject) == 0x000000, "Member 'FFortAIInjectedDecisionInterfaceData::DecisionObject' has a wrong offset!");
...
public:
	...
	class UObject*                                ActionInterfaceObject;                             // 0x0010(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FFortAIInjectedDecisionServiceData     ServiceData;                                       // 0x0018(0x0028)(Transient, NativeAccessSpecifierPrivate)
	struct FFortAIInjectedDecisionInterfaceData   InterfaceData;                                     // 0x0040(0x0018)(Transient, NoDestructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FFortAIInjectedDecision) == 0x000070, "Wrong size on FFortAIInjectedDecision");
...
static_assert(offsetof(FFortAIInjectedDecision, ActionInterfaceObject) == 0x000010, "Member 'FFortAIInjectedDecision::ActionInterfaceObject' has a wrong offset!");
static_assert(offsetof(FFortAIInjectedDecision, ServiceData) == 0x000018, "Member 'FFortAIInjectedDecision::ServiceData' has a wrong offset!");
static_assert(offsetof(FFortAIInjectedDecision, InterfaceData) == 0x000040, "Member 'FFortAIInjectedDecision::InterfaceData' has a wrong offset!");
...
public:
	...
	struct FGameplayTag                           InjectionTag;                                      // 0x0008(0x0004)(BlueprintVisible, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortInstancedInjectedBehavior) == 0x000008, "Wrong alignment on FFortInstancedInjectedBehavior");
static_assert(sizeof(FFortInstancedInjectedBehavior) == 0x000010, "Wrong size on FFortInstancedInjectedBehavior");
static_assert(offsetof(FFortInstancedInjectedBehavior, InjectedBehavior) == 0x000000, "Member 'FFortInstancedInjectedBehavior::InjectedBehavior' has a wrong offset!");
static_assert(offsetof(FFortInstancedInjectedBehavior, InjectionTag) == 0x000008, "Member 'FFortInstancedInjectedBehavior::InjectionTag' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIMovementItemDataTableRow
// 0x00E8 (0x00F0 - 0x0008)
struct FFortAIMovementItemDataTableRow final : public FTableRowBase
{
public:
	struct FGameplayTagQuery                      MovementItemTagQuery;                              // 0x0008(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      ExplicitCooldownTagQuery;                          // 0x0050(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bIsAugmentItem;                                    // 0x0098(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseSecondaryFire;                                 // 0x0099(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCanUseInputToDeactivate;                          // 0x009A(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bPerformPathChecks;                                // 0x009B(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         MinimumPathLength;                                 // 0x00A0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         NavLinkLookaheadDistance;                          // 0x00C8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAIMovementItemDataTableRow) == 0x000008, "Wrong alignment on FFortAIMovementItemDataTableRow");
static_assert(sizeof(FFortAIMovementItemDataTableRow) == 0x0000F0, "Wrong size on FFortAIMovementItemDataTableRow");
static_assert(offsetof(FFortAIMovementItemDataTableRow, MovementItemTagQuery) == 0x000008, "Member 'FFortAIMovementItemDataTableRow::MovementItemTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, ExplicitCooldownTagQuery) == 0x000050, "Member 'FFortAIMovementItemDataTableRow::ExplicitCooldownTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, bIsAugmentItem) == 0x000098, "Member 'FFortAIMovementItemDataTableRow::bIsAugmentItem' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, bUseSecondaryFire) == 0x000099, "Member 'FFortAIMovementItemDataTableRow::bUseSecondaryFire' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, bCanUseInputToDeactivate) == 0x00009A, "Member 'FFortAIMovementItemDataTableRow::bCanUseInputToDeactivate' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, bPerformPathChecks) == 0x00009B, "Member 'FFortAIMovementItemDataTableRow::bPerformPathChecks' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, MinimumPathLength) == 0x0000A0, "Member 'FFortAIMovementItemDataTableRow::MinimumPathLength' has a wrong offset!");
static_assert(offsetof(FFortAIMovementItemDataTableRow, NavLinkLookaheadDistance) == 0x0000C8, "Member 'FFortAIMovementItemDataTableRow::NavLinkLookaheadDistance' has a wrong offset!");
...
{
public:
	uint8                                         Pad_0[0xF8];                                       // 0x0000(0x00F8)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayInteractionContext            ActiveGameplayInteractionContext;                  // 0x00F8(0x0078)(Transient, NativeAccessSpecifierPrivate)
	class UGameplayBehaviorConfig*                ActiveBehaviorConfig;                              // 0x0170(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UGameplayBehavior*                      ActiveGameplayBehavior;                            // 0x0178(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UGameplayInteractionSmartObjectBehaviorDefinition* ActiveSmartObjectInteractionBehaviorDefinition;    // 0x0180(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(FFortSmartObjectEvaluationResult) == 0x0001B0, "Wrong size on FFortSmartObjectEvaluationResult");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveGameplayInteractionContext) == 0x0000F8, "Member 'FFortSmartObjectEvaluationResult::ActiveGameplayInteractionContext' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveBehaviorConfig) == 0x000170, "Member 'FFortSmartObjectEvaluationResult::ActiveBehaviorConfig' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveGameplayBehavior) == 0x000178, "Member 'FFortSmartObjectEvaluationResult::ActiveGameplayBehavior' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectEvaluationResult, ActiveSmartObjectInteractionBehaviorDefinition) == 0x000180, "Member 'FFortSmartObjectEvaluationResult::ActiveSmartObjectInteractionBehaviorDefinition' has a wrong offset!");
...
{
public:
	TWeakObjectPtr<class AActor>                  SOActor;                                           // 0x0008(0x0008)(Edit, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAICommandSOUsageData) == 0x000004, "Wrong alignment on FFortAICommandSOUsageData");
...
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x04) FFortAIActiveCommandSOUsageData final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIActiveCommandSOUsageData) == 0x000004, "Wrong alignment on FFortAIActiveCommandSOUsageData");
...
static_assert(offsetof(FFortAISmartObjectAnimConfigRow, Montage) == 0x000008, "Member 'FFortAISmartObjectAnimConfigRow::Montage' has a wrong offset!");
static_assert(offsetof(FFortAISmartObjectAnimConfigRow, SceneAsset) == 0x000028, "Member 'FFortAISmartObjectAnimConfigRow::SceneAsset' has a wrong offset!");
static_assert(offsetof(FFortAISmartObjectAnimConfigRow, TagQuery) == 0x000048, "Member 'FFortAISmartObjectAnimConfigRow::TagQuery' has a wrong offset!");
static_assert(offsetof(FFortAISmartObjectAnimConfigRow, SelectionPreconditions) == 0x000090, "Member 'FFortAISmartObjectAnimConfigRow::SelectionPreconditions' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortStateTreeSuppressGoalSelectionTaskInstanceData
// 0x0018 (0x0018 - 0x0000)
struct FFortStateTreeSuppressGoalSelectionTaskInstanceData final
{
public:
	class AActor*                                 Actor;                                             // 0x0000(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bClearGoalInfo;                                    // 0x0008(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0xF];                                        // 0x0009(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortStateTreeSuppressGoalSelectionTaskInstanceData) == 0x000008, "Wrong alignment on FFortStateTreeSuppressGoalSelectionTaskInstanceData");
static_assert(sizeof(FFortStateTreeSuppressGoalSelectionTaskInstanceData) == 0x000018, "Wrong size on FFortStateTreeSuppressGoalSelectionTaskInstanceData");
static_assert(offsetof(FFortStateTreeSuppressGoalSelectionTaskInstanceData, Actor) == 0x000000, "Member 'FFortStateTreeSuppressGoalSelectionTaskInstanceData::Actor' has a wrong offset!");
static_assert(offsetof(FFortStateTreeSuppressGoalSelectionTaskInstanceData, bClearGoalInfo) == 0x000008, "Member 'FFortStateTreeSuppressGoalSelectionTaskInstanceData::bClearGoalInfo' has a wrong offset!");

// ScriptStruct FortniteAI.FortStateTreeSuppressGoalSelectionTask
// 0x0000 (0x0020 - 0x0020)
struct FFortStateTreeSuppressGoalSelectionTask final : public FStateTreeTaskCommonBase
{
};
static_assert(alignof(FFortStateTreeSuppressGoalSelectionTask) == 0x000008, "Wrong alignment on FFortStateTreeSuppressGoalSelectionTask");
static_assert(sizeof(FFortStateTreeSuppressGoalSelectionTask) == 0x000020, "Wrong size on FFortStateTreeSuppressGoalSelectionTask");
...
static_assert(alignof(FFortAthenaAILoadoutTableRow) == 0x000008, "Wrong alignment on FFortAthenaAILoadoutTableRow");
static_assert(sizeof(FFortAthenaAILoadoutTableRow) == 0x000028, "Wrong size on FFortAthenaAILoadoutTableRow");
static_assert(offsetof(FFortAthenaAILoadoutTableRow, Items) == 0x000008, "Member 'FFortAthenaAILoadoutTableRow::Items' has a wrong offset!");
static_assert(offsetof(FFortAthenaAILoadoutTableRow, LootInfo) == 0x000018, "Member 'FFortAthenaAILoadoutTableRow::LootInfo' has a wrong offset!");
...
static_assert(sizeof(FFortBehaviorValue_Enum) == 0x000028, "Wrong size on FFortBehaviorValue_Enum");
...
static_assert(offsetof(FFortBehaviorValue_Enum, NativeEnumTypeName) == 0x000018, "Member 'FFortBehaviorValue_Enum::NativeEnumTypeName' has a wrong offset!");
...
// ScriptStruct FortniteAI.InstancedFortInjectedBehavior
// 0x0008 (0x0008 - 0x0000)
struct FInstancedFortInjectedBehavior final
{
public:
	class UFortInjectedBehavior*                  InjectedBehavior;                                  // 0x0000(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoClear, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FInstancedFortInjectedBehavior) == 0x000008, "Wrong alignment on FInstancedFortInjectedBehavior");
static_assert(sizeof(FInstancedFortInjectedBehavior) == 0x000008, "Wrong size on FInstancedFortInjectedBehavior");
static_assert(offsetof(FInstancedFortInjectedBehavior, InjectedBehavior) == 0x000000, "Member 'FInstancedFortInjectedBehavior::InjectedBehavior' has a wrong offset!");
...
static_assert(alignof(FFortInjectedBehaviorsDataTableRow) == 0x000008, "Wrong alignment on FFortInjectedBehaviorsDataTableRow");
static_assert(sizeof(FFortInjectedBehaviorsDataTableRow) == 0x000018, "Wrong size on FFortInjectedBehaviorsDataTableRow");
static_assert(offsetof(FFortInjectedBehaviorsDataTableRow, InjectedBehaviorsByTagQuery) == 0x000008, "Member 'FFortInjectedBehaviorsDataTableRow::InjectedBehaviorsByTagQuery' has a wrong offset!");

// ScriptStruct FortniteAI.FortInjectedBehaviorDecisionContext
// 0x0000 (0x0018 - 0x0018)
struct FFortInjectedBehaviorDecisionContext final : public FFortInjectedBehaviorContextBase
{
};
static_assert(alignof(FFortInjectedBehaviorDecisionContext) == 0x000008, "Wrong alignment on FFortInjectedBehaviorDecisionContext");
static_assert(sizeof(FFortInjectedBehaviorDecisionContext) == 0x000018, "Wrong size on FFortInjectedBehaviorDecisionContext");

// ScriptStruct FortniteAI.FortInjectedBehaviorActionContext
// 0x0000 (0x0018 - 0x0018)
struct FFortInjectedBehaviorActionContext final : public FFortInjectedBehaviorContextBase
{
};
static_assert(alignof(FFortInjectedBehaviorActionContext) == 0x000008, "Wrong alignment on FFortInjectedBehaviorActionContext");
static_assert(sizeof(FFortInjectedBehaviorActionContext) == 0x000018, "Wrong size on FFortInjectedBehaviorActionContext");

// ScriptStruct FortniteAI.OnInjectedBehaviorEndedStateTreeEvent
// 0x0010 (0x0010 - 0x0000)
struct FOnInjectedBehaviorEndedStateTreeEvent final
{
public:
	class UFortInjectedBehavior*                  InjectedBehavior;                                  // 0x0000(0x0008)(Edit, ZeroConstructor, EditConst, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EExecutionStatus                              ExecutionStatus;                                   // 0x0008(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EExecutionStatus                              PreviousExecutionStatus;                           // 0x0009(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x6];                                        // 0x000A(0x0006)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FOnInjectedBehaviorEndedStateTreeEvent) == 0x000008, "Wrong alignment on FOnInjectedBehaviorEndedStateTreeEvent");
static_assert(sizeof(FOnInjectedBehaviorEndedStateTreeEvent) == 0x000010, "Wrong size on FOnInjectedBehaviorEndedStateTreeEvent");
static_assert(offsetof(FOnInjectedBehaviorEndedStateTreeEvent, InjectedBehavior) == 0x000000, "Member 'FOnInjectedBehaviorEndedStateTreeEvent::InjectedBehavior' has a wrong offset!");
static_assert(offsetof(FOnInjectedBehaviorEndedStateTreeEvent, ExecutionStatus) == 0x000008, "Member 'FOnInjectedBehaviorEndedStateTreeEvent::ExecutionStatus' has a wrong offset!");
static_assert(offsetof(FOnInjectedBehaviorEndedStateTreeEvent, PreviousExecutionStatus) == 0x000009, "Member 'FOnInjectedBehaviorEndedStateTreeEvent::PreviousExecutionStatus' has a wrong offset!");
...
public:
	...
	struct FWorldConditionQueryDefinition         Conditions;                                        // 0x0018(0x0018)(Edit, NativeAccessSpecifierPublic)
	ENPCReactionPriority                          Priority;                                          // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_31[0x3];                                       // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         VerbAuthorCategories;                              // 0x0034(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UAthenaDanceItemDefinition*             EmoteReaction;                                     // 0x0038(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UGameplayEffect>>    GameplayEffectsReaction;                           // 0x0040(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      ConditionalQuery;                                  // 0x0050(0x0048)(Edit, NativeAccessSpecifierPublic)
	bool                                          bOncePerWorld;                                     // 0x0098(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_99[0x3];                                       // 0x0099(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         MaxNPCsReacting;                                   // 0x009C(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVerbSubjectOwnerRequirement                  VerbSubjectsRequirement;                           // 0x00A0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bShouldMoveInRange;                                // 0x00A1(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A2[0x2];                                       // 0x00A2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ShouldMoveReachDistance;                           // 0x00A4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Cooldown;                                          // 0x00A8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         CooldownRandomVariance;                            // 0x00AC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortNPCVerbReactionTableRow) == 0x000008, "Wrong alignment on FFortNPCVerbReactionTableRow");
static_assert(sizeof(FFortNPCVerbReactionTableRow) == 0x0000B0, "Wrong size on FFortNPCVerbReactionTableRow");
...
static_assert(offsetof(FFortNPCVerbReactionTableRow, Conditions) == 0x000018, "Member 'FFortNPCVerbReactionTableRow::Conditions' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, Priority) == 0x000030, "Member 'FFortNPCVerbReactionTableRow::Priority' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, VerbAuthorCategories) == 0x000034, "Member 'FFortNPCVerbReactionTableRow::VerbAuthorCategories' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, EmoteReaction) == 0x000038, "Member 'FFortNPCVerbReactionTableRow::EmoteReaction' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, GameplayEffectsReaction) == 0x000040, "Member 'FFortNPCVerbReactionTableRow::GameplayEffectsReaction' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, ConditionalQuery) == 0x000050, "Member 'FFortNPCVerbReactionTableRow::ConditionalQuery' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, bOncePerWorld) == 0x000098, "Member 'FFortNPCVerbReactionTableRow::bOncePerWorld' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, MaxNPCsReacting) == 0x00009C, "Member 'FFortNPCVerbReactionTableRow::MaxNPCsReacting' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, VerbSubjectsRequirement) == 0x0000A0, "Member 'FFortNPCVerbReactionTableRow::VerbSubjectsRequirement' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, bShouldMoveInRange) == 0x0000A1, "Member 'FFortNPCVerbReactionTableRow::bShouldMoveInRange' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, ShouldMoveReachDistance) == 0x0000A4, "Member 'FFortNPCVerbReactionTableRow::ShouldMoveReachDistance' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, Cooldown) == 0x0000A8, "Member 'FFortNPCVerbReactionTableRow::Cooldown' has a wrong offset!");
static_assert(offsetof(FFortNPCVerbReactionTableRow, CooldownRandomVariance) == 0x0000AC, "Member 'FFortNPCVerbReactionTableRow::CooldownRandomVariance' has a wrong offset!");
...
public:
	...
	bool                                          bKillAllBuildingActorsAtSpawnLocation;             // 0x0091(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bKillPlayBuildingActorsAtSpawnLocation;            // 0x0092(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TStructCycleFixup<struct FFortAIPawnLootDropData, 0x0014, 0x04> LootDropData;                                      // 0x0120(0x0014)(NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FPendingSpawnInfo, bKillAllBuildingActorsAtSpawnLocation) == 0x000091, "Member 'FPendingSpawnInfo::bKillAllBuildingActorsAtSpawnLocation' has a wrong offset!");
static_assert(offsetof(FPendingSpawnInfo, bKillPlayBuildingActorsAtSpawnLocation) == 0x000092, "Member 'FPendingSpawnInfo::bKillPlayBuildingActorsAtSpawnLocation' has a wrong offset!");
...
static_assert(offsetof(FPendingSpawnInfo, LootDropData) == 0x000120, "Member 'FPendingSpawnInfo::LootDropData' has a wrong offset!");

// ScriptStruct FortniteAI.FortVehicleInjectedBehaviorsDataTableRow
// 0x0078 (0x0080 - 0x0008)
struct FFortVehicleInjectedBehaviorsDataTableRow final : public FTableRowBase
{
public:
	TSoftClassPtr<class UClass>                   VehicleClass;                                      // 0x0008(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      VehicleGameplayTagQuery;                           // 0x0028(0x0048)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFortAISpawnerTagQueryInjectedBehavior> InjectedBehaviorsByTagQuery;                       // 0x0070(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortVehicleInjectedBehaviorsDataTableRow) == 0x000008, "Wrong alignment on FFortVehicleInjectedBehaviorsDataTableRow");
static_assert(sizeof(FFortVehicleInjectedBehaviorsDataTableRow) == 0x000080, "Wrong size on FFortVehicleInjectedBehaviorsDataTableRow");
static_assert(offsetof(FFortVehicleInjectedBehaviorsDataTableRow, VehicleClass) == 0x000008, "Member 'FFortVehicleInjectedBehaviorsDataTableRow::VehicleClass' has a wrong offset!");
static_assert(offsetof(FFortVehicleInjectedBehaviorsDataTableRow, VehicleGameplayTagQuery) == 0x000028, "Member 'FFortVehicleInjectedBehaviorsDataTableRow::VehicleGameplayTagQuery' has a wrong offset!");
static_assert(offsetof(FFortVehicleInjectedBehaviorsDataTableRow, InjectedBehaviorsByTagQuery) == 0x000070, "Member 'FFortVehicleInjectedBehaviorsDataTableRow::InjectedBehaviorsByTagQuery' has a wrong offset!");
...
static_assert(alignof(FFortWorldConditionAlwaysTrue) == 0x000008, "Wrong alignment on FFortWorldConditionAlwaysTrue");
static_assert(sizeof(FFortWorldConditionAlwaysTrue) == 0x000010, "Wrong size on FFortWorldConditionAlwaysTrue");
...
// ScriptStruct FortniteAI.FortWorldConditionEventRouter_HasValidEventState
// 0x0028 (0x0038 - 0x0010)
struct FFortWorldConditionEventRouter_HasValidEventState final : public FWorldConditionCommonBase
{
public:
	struct FWorldConditionContextDataRef          OptionalContext;                                   // 0x0010(0x0008)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
	TSoftObjectPtr<class UScriptStruct>           EventStruct;                                       // 0x0018(0x0020)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
static_assert(alignof(FFortWorldConditionEventRouter_HasValidEventState) == 0x000008, "Wrong alignment on FFortWorldConditionEventRouter_HasValidEventState");
static_assert(sizeof(FFortWorldConditionEventRouter_HasValidEventState) == 0x000038, "Wrong size on FFortWorldConditionEventRouter_HasValidEventState");
static_assert(offsetof(FFortWorldConditionEventRouter_HasValidEventState, OptionalContext) == 0x000010, "Member 'FFortWorldConditionEventRouter_HasValidEventState::OptionalContext' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionEventRouter_HasValidEventState, EventStruct) == 0x000018, "Member 'FFortWorldConditionEventRouter_HasValidEventState::EventStruct' has a wrong offset!");

// ScriptStruct FortniteAI.FortWorldConditionHotfix
// 0x0030 (0x0040 - 0x0010)
struct FFortWorldConditionHotfix final : public FWorldConditionCommonBase
{
public:
	struct FScalableFloat                         HotfixToCheck;                                     // 0x0010(0x0028)(Edit, NativeAccessSpecifierPrivate)
	float                                         TargetValue;                                       // 0x0038(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionHotfix) == 0x000008, "Wrong alignment on FFortWorldConditionHotfix");
static_assert(sizeof(FFortWorldConditionHotfix) == 0x000040, "Wrong size on FFortWorldConditionHotfix");
static_assert(offsetof(FFortWorldConditionHotfix, HotfixToCheck) == 0x000010, "Member 'FFortWorldConditionHotfix::HotfixToCheck' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionHotfix, TargetValue) == 0x000038, "Member 'FFortWorldConditionHotfix::TargetValue' has a wrong offset!");

// ScriptStruct FortniteAI.FortWorldCondition_InEditorOrPie
// 0x0000 (0x0010 - 0x0010)
struct FFortWorldCondition_InEditorOrPie final : public FWorldConditionCommonBase
{
};
static_assert(alignof(FFortWorldCondition_InEditorOrPie) == 0x000008, "Wrong alignment on FFortWorldCondition_InEditorOrPie");
static_assert(sizeof(FFortWorldCondition_InEditorOrPie) == 0x000010, "Wrong size on FFortWorldCondition_InEditorOrPie");
...
// ScriptStruct FortniteAI.GoalActorDistanceNotify
// 0x0008 (0x0008 - 0x0000)
struct FGoalActorDistanceNotify final
{
public:
	float                                         DistanceSq;                                        // 0x0000(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FGoalActorDistanceNotify) == 0x000004, "Wrong alignment on FGoalActorDistanceNotify");
static_assert(sizeof(FGoalActorDistanceNotify) == 0x000008, "Wrong size on FGoalActorDistanceNotify");
static_assert(offsetof(FGoalActorDistanceNotify, DistanceSq) == 0x000000, "Member 'FGoalActorDistanceNotify::DistanceSq' has a wrong offset!");
...
public:
	...
	struct FGameplayTagContainer                  OutputTags;                                        // 0x0020(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FVector                                OutputVector;                                      // 0x0040(0x0018)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAIComponent_AnimationEvaluationContext) == 0x000008, "Wrong alignment on FFortAIComponent_AnimationEvaluationContext");
static_assert(sizeof(FFortAIComponent_AnimationEvaluationContext) == 0x000058, "Wrong size on FFortAIComponent_AnimationEvaluationContext");
static_assert(offsetof(FFortAIComponent_AnimationEvaluationContext, TagContainer) == 0x000000, "Member 'FFortAIComponent_AnimationEvaluationContext::TagContainer' has a wrong offset!");
static_assert(offsetof(FFortAIComponent_AnimationEvaluationContext, OutputTags) == 0x000020, "Member 'FFortAIComponent_AnimationEvaluationContext::OutputTags' has a wrong offset!");
static_assert(offsetof(FFortAIComponent_AnimationEvaluationContext, OutputVector) == 0x000040, "Member 'FFortAIComponent_AnimationEvaluationContext::OutputVector' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIComponent_AnimationEvaluationContextOutput
// 0x0060 (0x0060 - 0x0000)
struct FFortAIComponent_AnimationEvaluationContextOutput final
{
public:
	class UAnimMontage*                           AnimMontage;                                       // 0x0000(0x0008)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortAIComponent_AnimationEvaluationContext AnimEvaluationContext;                             // 0x0008(0x0058)(BlueprintVisible, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAIComponent_AnimationEvaluationContextOutput) == 0x000008, "Wrong alignment on FFortAIComponent_AnimationEvaluationContextOutput");
static_assert(sizeof(FFortAIComponent_AnimationEvaluationContextOutput) == 0x000060, "Wrong size on FFortAIComponent_AnimationEvaluationContextOutput");
static_assert(offsetof(FFortAIComponent_AnimationEvaluationContextOutput, AnimMontage) == 0x000000, "Member 'FFortAIComponent_AnimationEvaluationContextOutput::AnimMontage' has a wrong offset!");
static_assert(offsetof(FFortAIComponent_AnimationEvaluationContextOutput, AnimEvaluationContext) == 0x000008, "Member 'FFortAIComponent_AnimationEvaluationContextOutput::AnimEvaluationContext' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortAIDefendSpotActorData
// 0x0028 (0x0028 - 0x0000)
struct alignas(0x08) FFortAIDefendSpotActorData final
{
public:
	uint8                                         Pad_0[0x28];                                       // 0x0000(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIDefendSpotActorData) == 0x000008, "Wrong alignment on FFortAIDefendSpotActorData");
static_assert(sizeof(FFortAIDefendSpotActorData) == 0x000028, "Wrong size on FFortAIDefendSpotActorData");

// ScriptStruct FortniteAI.AIEscalateStimGroupEntry
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x08) FAIEscalateStimGroupEntry final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateStimGroupEntry) == 0x000008, "Wrong alignment on FAIEscalateStimGroupEntry");
static_assert(sizeof(FAIEscalateStimGroupEntry) == 0x000010, "Wrong size on FAIEscalateStimGroupEntry");

// ScriptStruct FortniteAI.AIEscalateDebugEntry
// 0x0030 (0x0030 - 0x0000)
struct alignas(0x08) FAIEscalateDebugEntry final
{
public:
	uint8                                         Pad_0[0x30];                                       // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateDebugEntry) == 0x000008, "Wrong alignment on FAIEscalateDebugEntry");
static_assert(sizeof(FAIEscalateDebugEntry) == 0x000030, "Wrong size on FAIEscalateDebugEntry");

// ScriptStruct FortniteAI.AIEscalateConditionDebugEntry
// 0x0008 (0x0008 - 0x0000)
struct alignas(0x04) FAIEscalateConditionDebugEntry final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateConditionDebugEntry) == 0x000004, "Wrong alignment on FAIEscalateConditionDebugEntry");
static_assert(sizeof(FAIEscalateConditionDebugEntry) == 0x000008, "Wrong size on FAIEscalateConditionDebugEntry");

// ScriptStruct FortniteAI.AIEscalateTarget
// 0x0040 (0x0040 - 0x0000)
struct alignas(0x08) FAIEscalateTarget final
{
public:
	TWeakObjectPtr<class AFortPlayerPawn>         PlayerPawn;                                        // 0x0000(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8[0x38];                                       // 0x0008(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateTarget) == 0x000008, "Wrong alignment on FAIEscalateTarget");
static_assert(sizeof(FAIEscalateTarget) == 0x000040, "Wrong size on FAIEscalateTarget");
static_assert(offsetof(FAIEscalateTarget, PlayerPawn) == 0x000000, "Member 'FAIEscalateTarget::PlayerPawn' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class USoundBase>              SoundEffect;                                       // 0x0030(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// ScriptStruct FortniteAI.AIEscalateReasonCondition_Aiming
// 0x0030 (0x0090 - 0x0060)
struct FAIEscalateReasonCondition_Aiming final : public FAIEscalateReasonCondition
{
public:
	struct FScalableFloat                         AimingAngleCutoff;                                 // 0x0060(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint8                                         Pad_88[0x8];                                       // 0x0088(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateReasonCondition_Aiming) == 0x000008, "Wrong alignment on FAIEscalateReasonCondition_Aiming");
static_assert(sizeof(FAIEscalateReasonCondition_Aiming) == 0x000090, "Wrong size on FAIEscalateReasonCondition_Aiming");
static_assert(offsetof(FAIEscalateReasonCondition_Aiming, AimingAngleCutoff) == 0x000060, "Member 'FAIEscalateReasonCondition_Aiming::AimingAngleCutoff' has a wrong offset!");

// ScriptStruct FortniteAI.AIEscalateReasonCondition_OnMyPath
// 0x0098 (0x00F8 - 0x0060)
struct FAIEscalateReasonCondition_OnMyPath final : public FAIEscalateReasonCondition
{
public:
	struct FScalableFloat                         CheckPathBlockingForwardDistance;                  // 0x0060(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         CheckPathBlockingSideDistance;                     // 0x0088(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         CheckBlockingHeightDistance;                       // 0x00B0(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint8                                         Pad_D8[0x20];                                      // 0x00D8(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEscalateReasonCondition_OnMyPath) == 0x000008, "Wrong alignment on FAIEscalateReasonCondition_OnMyPath");
static_assert(sizeof(FAIEscalateReasonCondition_OnMyPath) == 0x0000F8, "Wrong size on FAIEscalateReasonCondition_OnMyPath");
static_assert(offsetof(FAIEscalateReasonCondition_OnMyPath, CheckPathBlockingForwardDistance) == 0x000060, "Member 'FAIEscalateReasonCondition_OnMyPath::CheckPathBlockingForwardDistance' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition_OnMyPath, CheckPathBlockingSideDistance) == 0x000088, "Member 'FAIEscalateReasonCondition_OnMyPath::CheckPathBlockingSideDistance' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition_OnMyPath, CheckBlockingHeightDistance) == 0x0000B0, "Member 'FAIEscalateReasonCondition_OnMyPath::CheckBlockingHeightDistance' has a wrong offset!");

// ScriptStruct FortniteAI.AIEscalateReasonCondition_TooClose
// 0x0078 (0x00D8 - 0x0060)
struct FAIEscalateReasonCondition_TooClose final : public FAIEscalateReasonCondition
{
public:
	struct FScalableFloat                         TooCloseDistance;                                  // 0x0060(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         StopConditionDistance;                             // 0x0088(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         DoPathTest;                                        // 0x00B0(0x0028)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIEscalateReasonCondition_TooClose) == 0x000008, "Wrong alignment on FAIEscalateReasonCondition_TooClose");
static_assert(sizeof(FAIEscalateReasonCondition_TooClose) == 0x0000D8, "Wrong size on FAIEscalateReasonCondition_TooClose");
static_assert(offsetof(FAIEscalateReasonCondition_TooClose, TooCloseDistance) == 0x000060, "Member 'FAIEscalateReasonCondition_TooClose::TooCloseDistance' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition_TooClose, StopConditionDistance) == 0x000088, "Member 'FAIEscalateReasonCondition_TooClose::StopConditionDistance' has a wrong offset!");
static_assert(offsetof(FAIEscalateReasonCondition_TooClose, DoPathTest) == 0x0000B0, "Member 'FAIEscalateReasonCondition_TooClose::DoPathTest' has a wrong offset!");
...
{
public:
	struct FWorldConditionQueryDefinition         OptionalCondition;                                 // 0x0000(0x0018)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      OptionalTagQuery;                                  // 0x0018(0x0048)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      OptionalPlaylistTagQuery;                          // 0x0060(0x0048)(Edit, NativeAccessSpecifierPublic)
	uint8                                         bShouldDropInventoryOnDeath : 1;                   // 0x00A8(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldDropLootOnDeath : 1;                        // 0x00A8(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldGrantLootOnSpawn : 1;                       // 0x00A8(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldBotPickRandomLootTier : 1;                  // 0x00A8(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldDropInstanced : 1;                          // 0x00A8(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           LootTiers;                                         // 0x00B0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UFortItemDefinition>> ItemClassToDropOnDeathInsteadOfGrant;              // 0x00C0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<TSoftObjectPtr<class UFortItemDefinition>> ItemToDropOnDeathInsteadOfGrant;                   // 0x00D0(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      ItemTagQueryToDropOnDeathInsteadOfGrant;           // 0x00E0(0x0048)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAILootInfoRowEntry) == 0x000008, "Wrong alignment on FAILootInfoRowEntry");
static_assert(sizeof(FAILootInfoRowEntry) == 0x000128, "Wrong size on FAILootInfoRowEntry");
static_assert(offsetof(FAILootInfoRowEntry, OptionalCondition) == 0x000000, "Member 'FAILootInfoRowEntry::OptionalCondition' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, OptionalTagQuery) == 0x000018, "Member 'FAILootInfoRowEntry::OptionalTagQuery' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, OptionalPlaylistTagQuery) == 0x000060, "Member 'FAILootInfoRowEntry::OptionalPlaylistTagQuery' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, LootTiers) == 0x0000B0, "Member 'FAILootInfoRowEntry::LootTiers' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemClassToDropOnDeathInsteadOfGrant) == 0x0000C0, "Member 'FAILootInfoRowEntry::ItemClassToDropOnDeathInsteadOfGrant' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemToDropOnDeathInsteadOfGrant) == 0x0000D0, "Member 'FAILootInfoRowEntry::ItemToDropOnDeathInsteadOfGrant' has a wrong offset!");
static_assert(offsetof(FAILootInfoRowEntry, ItemTagQueryToDropOnDeathInsteadOfGrant) == 0x0000E0, "Member 'FAILootInfoRowEntry::ItemTagQueryToDropOnDeathInsteadOfGrant' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortBotTargetWeakspot
// 0x0010 (0x0010 - 0x0000)
struct alignas(0x04) FFortBotTargetWeakspot final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortBotTargetWeakspot) == 0x000004, "Wrong alignment on FFortBotTargetWeakspot");
static_assert(sizeof(FFortBotTargetWeakspot) == 0x000010, "Wrong size on FFortBotTargetWeakspot");
...
static_assert(offsetof(FSpawnGroupInstanceInfo, PawnUpgrades) == 0x0000B8, "Member 'FSpawnGroupInstanceInfo::PawnUpgrades' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, ModifiersForAllPawns) == 0x0000C8, "Member 'FSpawnGroupInstanceInfo::ModifiersForAllPawns' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, PawnList) == 0x0000D8, "Member 'FSpawnGroupInstanceInfo::PawnList' has a wrong offset!");
static_assert(offsetof(FSpawnGroupInstanceInfo, LifespanExpiredList) == 0x0000E8, "Member 'FSpawnGroupInstanceInfo::LifespanExpiredList' has a wrong offset!");
...
static_assert(alignof(FDigestedTokenTargetWeightHeuristic) == 0x000008, "Wrong alignment on FDigestedTokenTargetWeightHeuristic");
static_assert(sizeof(FDigestedTokenTargetWeightHeuristic) == 0x000050, "Wrong size on FDigestedTokenTargetWeightHeuristic");
static_assert(offsetof(FDigestedTokenTargetWeightHeuristic, TokenTagQuery) == 0x000000, "Member 'FDigestedTokenTargetWeightHeuristic::TokenTagQuery' has a wrong offset!");
static_assert(offsetof(FDigestedTokenTargetWeightHeuristic, Weight) == 0x000048, "Member 'FDigestedTokenTargetWeightHeuristic::Weight' has a wrong offset!");
...
public:
	...
	float                                         TargetInLeashWeight;                               // 0x019C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
};
...
static_assert(sizeof(FFortAthenaAIBotDigestedTargetHeuristicSettings) == 0x0001A0, "Wrong size on FFortAthenaAIBotDigestedTargetHeuristicSettings");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, TokenWeights) == 0x000000, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::TokenWeights' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, PerceptionStateSettings) == 0x000010, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::PerceptionStateSettings' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, ThreatDamageWeight) == 0x000160, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::ThreatDamageWeight' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, ThreatDamageWeightMultiplier) == 0x000164, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::ThreatDamageWeightMultiplier' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, ThreatTimeSinceLastDamageMultiplier) == 0x000168, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::ThreatTimeSinceLastDamageMultiplier' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, ThreatLoFWeight) == 0x000190, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::ThreatLoFWeight' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, DBNOWeightModifier) == 0x000194, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::DBNOWeightModifier' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, GameParticipantWeightModifier) == 0x000198, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::GameParticipantWeightModifier' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotDigestedTargetHeuristicSettings, TargetInLeashWeight) == 0x00019C, "Member 'FFortAthenaAIBotDigestedTargetHeuristicSettings::TargetInLeashWeight' has a wrong offset!");
...
static_assert(sizeof(FFortAthenaAIBotDigestedTargetHeuristicSettingsSpecialization) == 0x0001E8, "Wrong size on FFortAthenaAIBotDigestedTargetHeuristicSettingsSpecialization");
...
static_assert(alignof(FDigestedWeaponFiringTime) == 0x000004, "Wrong alignment on FDigestedWeaponFiringTime");
static_assert(sizeof(FDigestedWeaponFiringTime) == 0x000008, "Wrong size on FDigestedWeaponFiringTime");
static_assert(offsetof(FDigestedWeaponFiringTime, HoldFireTime) == 0x000000, "Member 'FDigestedWeaponFiringTime::HoldFireTime' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponFiringTime, PreventFireTime) == 0x000004, "Member 'FDigestedWeaponFiringTime::PreventFireTime' has a wrong offset!");
...
static_assert(alignof(FTokenTargetWeightHeuristic) == 0x000008, "Wrong alignment on FTokenTargetWeightHeuristic");
static_assert(sizeof(FTokenTargetWeightHeuristic) == 0x000070, "Wrong size on FTokenTargetWeightHeuristic");
static_assert(offsetof(FTokenTargetWeightHeuristic, TokenTagQuery) == 0x000000, "Member 'FTokenTargetWeightHeuristic::TokenTagQuery' has a wrong offset!");
static_assert(offsetof(FTokenTargetWeightHeuristic, Weight) == 0x000048, "Member 'FTokenTargetWeightHeuristic::Weight' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         TargetInLeashWeight;                               // 0x0358(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaAIBotTargetHeuristicSettings) == 0x000380, "Wrong size on FFortAthenaAIBotTargetHeuristicSettings");
...
static_assert(offsetof(FFortAthenaAIBotTargetHeuristicSettings, TokenWeights) == 0x000348, "Member 'FFortAthenaAIBotTargetHeuristicSettings::TokenWeights' has a wrong offset!");
static_assert(offsetof(FFortAthenaAIBotTargetHeuristicSettings, TargetInLeashWeight) == 0x000358, "Member 'FFortAthenaAIBotTargetHeuristicSettings::TargetInLeashWeight' has a wrong offset!");
...
static_assert(offsetof(FRangedWeaponSkill, StopFiringWhenTargetWillDieOdds) == 0x000160, "Member 'FRangedWeaponSkill::StopFiringWhenTargetWillDieOdds' has a wrong offset!");
...
static_assert(sizeof(FVehicleDriving) == 0x000328, "Wrong size on FVehicleDriving");
...
static_assert(offsetof(FVehicleDriving, NavigationOffsetFromObstacles) == 0x000290, "Member 'FVehicleDriving::NavigationOffsetFromObstacles' has a wrong offset!");
static_assert(offsetof(FVehicleDriving, AppendToPath) == 0x0002B8, "Member 'FVehicleDriving::AppendToPath' has a wrong offset!");
static_assert(offsetof(FVehicleDriving, ModsTags) == 0x000308, "Member 'FVehicleDriving::ModsTags' has a wrong offset!");
...
static_assert(sizeof(FVehicleDrivingCategory) == 0x000348, "Wrong size on FVehicleDrivingCategory");
...
static_assert(offsetof(FDigestedVehicleDriving, NavigationOffsetFromObstacles) == 0x000050, "Member 'FDigestedVehicleDriving::NavigationOffsetFromObstacles' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, bReverseSwapLeftAndRight) == 0x000054, "Member 'FDigestedVehicleDriving::bReverseSwapLeftAndRight' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, MinimumForwardPIDValueForStopping) == 0x000058, "Member 'FDigestedVehicleDriving::MinimumForwardPIDValueForStopping' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, MinimumDistanceLeftForBoosting) == 0x00005C, "Member 'FDigestedVehicleDriving::MinimumDistanceLeftForBoosting' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, ForwardPIDController) == 0x000060, "Member 'FDigestedVehicleDriving::ForwardPIDController' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, SteeringPIDController) == 0x00006C, "Member 'FDigestedVehicleDriving::SteeringPIDController' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, AppendToPath) == 0x000078, "Member 'FDigestedVehicleDriving::AppendToPath' has a wrong offset!");
static_assert(offsetof(FDigestedVehicleDriving, TurnInPlace) == 0x000080, "Member 'FDigestedVehicleDriving::TurnInPlace' has a wrong offset!");
...
public:
	...
	struct FBox                                   ThreatVolume;                                      // 0x0028(0x0038)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// ScriptStruct FortniteAI.DefendBehaviorSettings
// 0x0070 (0x0070 - 0x0000)
struct FDefendBehaviorSettings final
{
public:
	struct FScalableFloat                         DefendBehaviorEnabled;                             // 0x0000(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FEQSParametrizedQueryExecutionRequest  EQSRequest;                                        // 0x0028(0x0048)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDefendBehaviorSettings) == 0x000008, "Wrong alignment on FDefendBehaviorSettings");
static_assert(sizeof(FDefendBehaviorSettings) == 0x000070, "Wrong size on FDefendBehaviorSettings");
static_assert(offsetof(FDefendBehaviorSettings, DefendBehaviorEnabled) == 0x000000, "Member 'FDefendBehaviorSettings::DefendBehaviorEnabled' has a wrong offset!");
static_assert(offsetof(FDefendBehaviorSettings, EQSRequest) == 0x000028, "Member 'FDefendBehaviorSettings::EQSRequest' has a wrong offset!");
...
static_assert(sizeof(FAIRuntimeParametersSmartObjectActivityConfig) == 0x000068, "Wrong size on FAIRuntimeParametersSmartObjectActivityConfig");
...
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivityConfig, ActivityDiceRollPercentage) == 0x000058, "Member 'FAIRuntimeParametersSmartObjectActivityConfig::ActivityDiceRollPercentage' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivityConfig, ActivityDiceRollCooldown) == 0x00005C, "Member 'FAIRuntimeParametersSmartObjectActivityConfig::ActivityDiceRollCooldown' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivityConfig, ActivityDiceRollCooldownVariance) == 0x000060, "Member 'FAIRuntimeParametersSmartObjectActivityConfig::ActivityDiceRollCooldownVariance' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivityConfig, ActivityDiceRollWinDuration) == 0x000064, "Member 'FAIRuntimeParametersSmartObjectActivityConfig::ActivityDiceRollWinDuration' has a wrong offset!");
...
static_assert(sizeof(FAIRuntimeParametersSmartObjectActivity) == 0x0000C8, "Wrong size on FAIRuntimeParametersSmartObjectActivity");
...
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivity, ActivityId) == 0x0000B4, "Member 'FAIRuntimeParametersSmartObjectActivity::ActivityId' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivity, LastUseTimestamp) == 0x0000B8, "Member 'FAIRuntimeParametersSmartObjectActivity::LastUseTimestamp' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivity, Cooldown) == 0x0000BC, "Member 'FAIRuntimeParametersSmartObjectActivity::Cooldown' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivity, DiceRollCooldownInWorldSeconds) == 0x0000C0, "Member 'FAIRuntimeParametersSmartObjectActivity::DiceRollCooldownInWorldSeconds' has a wrong offset!");
static_assert(offsetof(FAIRuntimeParametersSmartObjectActivity, DiceRollWinDurationInWorldSeconds) == 0x0000C4, "Member 'FAIRuntimeParametersSmartObjectActivity::DiceRollWinDurationInWorldSeconds' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortSmartObjectSlotDefinitionDataTableRow
// 0x0010 (0x0018 - 0x0008)
struct FFortSmartObjectSlotDefinitionDataTableRow final : public FTableRowBase
{
public:
	class FText                                   Description;                                       // 0x0008(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortSmartObjectSlotDefinitionDataTableRow) == 0x000008, "Wrong alignment on FFortSmartObjectSlotDefinitionDataTableRow");
static_assert(sizeof(FFortSmartObjectSlotDefinitionDataTableRow) == 0x000018, "Wrong size on FFortSmartObjectSlotDefinitionDataTableRow");
static_assert(offsetof(FFortSmartObjectSlotDefinitionDataTableRow, Description) == 0x000008, "Member 'FFortSmartObjectSlotDefinitionDataTableRow::Description' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         EscalatePlayerTooCloseDistance;                    // 0x0118(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         StopEscalateRequiredDistance;                      // 0x0140(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         StopEscalateRequiredTime;                          // 0x0168(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         StopEscalateAngleCutoff;                           // 0x0190(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FGameplayTag                           EscalateDefaultSpeechTag;                          // 0x01B8(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           EscalateAimingSpeechTag;                           // 0x01BC(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         EscalateComponentEnabled;                          // 0x01C0(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         EscalateExpirationTime;                            // 0x01E8(0x0028)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FAIEscalateReasonStim>          EscalateReasonStims;                               // 0x0210(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FInstancedStruct>               EscalateReasonConditions;                          // 0x0220(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	struct FGameplayTag                           AlertGameplayCueTag;                               // 0x0230(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_234[0x4];                                      // 0x0234(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEscalateBehaviorSettings) == 0x000008, "Wrong alignment on FEscalateBehaviorSettings");
static_assert(sizeof(FEscalateBehaviorSettings) == 0x000238, "Wrong size on FEscalateBehaviorSettings");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateBehaviorEnabled) == 0x000000, "Member 'FEscalateBehaviorSettings::EscalateBehaviorEnabled' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateMeterFillTime) == 0x000028, "Member 'FEscalateBehaviorSettings::EscalateMeterFillTime' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateVisionAngleCutoff) == 0x000050, "Member 'FEscalateBehaviorSettings::EscalateVisionAngleCutoff' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalatePlayerOnPathForwardDistance) == 0x000078, "Member 'FEscalateBehaviorSettings::EscalatePlayerOnPathForwardDistance' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalatePlayerOnPathPerpindicularDistance) == 0x0000A0, "Member 'FEscalateBehaviorSettings::EscalatePlayerOnPathPerpindicularDistance' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalatePlayerOnPathZCutoff) == 0x0000C8, "Member 'FEscalateBehaviorSettings::EscalatePlayerOnPathZCutoff' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalatePlayerAimingAngleCutoff) == 0x0000F0, "Member 'FEscalateBehaviorSettings::EscalatePlayerAimingAngleCutoff' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalatePlayerTooCloseDistance) == 0x000118, "Member 'FEscalateBehaviorSettings::EscalatePlayerTooCloseDistance' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, StopEscalateRequiredDistance) == 0x000140, "Member 'FEscalateBehaviorSettings::StopEscalateRequiredDistance' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, StopEscalateRequiredTime) == 0x000168, "Member 'FEscalateBehaviorSettings::StopEscalateRequiredTime' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, StopEscalateAngleCutoff) == 0x000190, "Member 'FEscalateBehaviorSettings::StopEscalateAngleCutoff' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateDefaultSpeechTag) == 0x0001B8, "Member 'FEscalateBehaviorSettings::EscalateDefaultSpeechTag' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateAimingSpeechTag) == 0x0001BC, "Member 'FEscalateBehaviorSettings::EscalateAimingSpeechTag' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateComponentEnabled) == 0x0001C0, "Member 'FEscalateBehaviorSettings::EscalateComponentEnabled' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateExpirationTime) == 0x0001E8, "Member 'FEscalateBehaviorSettings::EscalateExpirationTime' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateReasonStims) == 0x000210, "Member 'FEscalateBehaviorSettings::EscalateReasonStims' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, EscalateReasonConditions) == 0x000220, "Member 'FEscalateBehaviorSettings::EscalateReasonConditions' has a wrong offset!");
static_assert(offsetof(FEscalateBehaviorSettings, AlertGameplayCueTag) == 0x000230, "Member 'FEscalateBehaviorSettings::AlertGameplayCueTag' has a wrong offset!");
...
static_assert(alignof(FNavDataDetectedInfo) == 0x000008, "Wrong alignment on FNavDataDetectedInfo");
static_assert(sizeof(FNavDataDetectedInfo) == 0x000030, "Wrong size on FNavDataDetectedInfo");
static_assert(offsetof(FNavDataDetectedInfo, NavData) == 0x000000, "Member 'FNavDataDetectedInfo::NavData' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortAthenaAIItemLootInfoDataTableRow
// 0x0020 (0x0038 - 0x0018)
struct FFortAthenaAIItemLootInfoDataTableRow final : public FFortAthenaAILootInfoDataTableRow
{
public:
	TSoftObjectPtr<class UFortItemDefinition>     ReferenceItem;                                     // 0x0018(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAthenaAIItemLootInfoDataTableRow) == 0x000008, "Wrong alignment on FFortAthenaAIItemLootInfoDataTableRow");
static_assert(sizeof(FFortAthenaAIItemLootInfoDataTableRow) == 0x000038, "Wrong size on FFortAthenaAIItemLootInfoDataTableRow");
static_assert(offsetof(FFortAthenaAIItemLootInfoDataTableRow, ReferenceItem) == 0x000018, "Member 'FFortAthenaAIItemLootInfoDataTableRow::ReferenceItem' has a wrong offset!");
...
{
public:
	TStructCycleFixup<struct FFortAthenaLoadout, 0x01A8, 0x08> CosmeticLoadout;                                   // 0x0000(0x01A8)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         Weight;                                            // 0x01A8(0x0028)(Edit, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaAIWeightedCosmeticLoadout) == 0x0001D0, "Wrong size on FFortAthenaAIWeightedCosmeticLoadout");
...
static_assert(offsetof(FFortAthenaAIWeightedCosmeticLoadout, Weight) == 0x0001A8, "Member 'FFortAthenaAIWeightedCosmeticLoadout::Weight' has a wrong offset!");
...
{
public:
	struct FFortReleaseVersion                    StartVersion;                                      // 0x0000(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortReleaseVersion                    EndVersion;                                        // 0x0004(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	struct FScalableFloat                         ActivityDiceRollPercentage;                        // 0x00C0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         ActivityDiceRollCooldown;                          // 0x00E8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         ActivityDiceRollCooldownVariance;                  // 0x0110(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         ActivityDiceRollWinDuration;                       // 0x0138(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FFortAthenaAISmartObjectActivityConfig) == 0x000160, "Wrong size on FFortAthenaAISmartObjectActivityConfig");
...
static_assert(offsetof(FFortAthenaAISmartObjectActivityConfig, ActivityDiceRollPercentage) == 0x0000C0, "Member 'FFortAthenaAISmartObjectActivityConfig::ActivityDiceRollPercentage' has a wrong offset!");
static_assert(offsetof(FFortAthenaAISmartObjectActivityConfig, ActivityDiceRollCooldown) == 0x0000E8, "Member 'FFortAthenaAISmartObjectActivityConfig::ActivityDiceRollCooldown' has a wrong offset!");
static_assert(offsetof(FFortAthenaAISmartObjectActivityConfig, ActivityDiceRollCooldownVariance) == 0x000110, "Member 'FFortAthenaAISmartObjectActivityConfig::ActivityDiceRollCooldownVariance' has a wrong offset!");
static_assert(offsetof(FFortAthenaAISmartObjectActivityConfig, ActivityDiceRollWinDuration) == 0x000138, "Member 'FFortAthenaAISmartObjectActivityConfig::ActivityDiceRollWinDuration' has a wrong offset!");
...
static_assert(alignof(FUpdatedNavHeightMapTiles) == 0x000008, "Wrong alignment on FUpdatedNavHeightMapTiles");
static_assert(sizeof(FUpdatedNavHeightMapTiles) == 0x000018, "Wrong size on FUpdatedNavHeightMapTiles");
static_assert(offsetof(FUpdatedNavHeightMapTiles, NavHeightMap) == 0x000000, "Member 'FUpdatedNavHeightMapTiles::NavHeightMap' has a wrong offset!");
...
static_assert(offsetof(FPatrolPathLeash, bHasInnerLeash) == 0x000050, "Member 'FPatrolPathLeash::bHasInnerLeash' has a wrong offset!");
static_assert(offsetof(FPatrolPathLeash, InnerWidth) == 0x000054, "Member 'FPatrolPathLeash::InnerWidth' has a wrong offset!");
static_assert(offsetof(FPatrolPathLeash, InnerHeight) == 0x000058, "Member 'FPatrolPathLeash::InnerHeight' has a wrong offset!");
...
static_assert(offsetof(FFortAIInjectedDecisionContextData, ExecutionStatus) == 0x000000, "Member 'FFortAIInjectedDecisionContextData::ExecutionStatus' has a wrong offset!");
...
static_assert(alignof(FFortAIStateTreeReference) == 0x000008, "Wrong alignment on FFortAIStateTreeReference");
static_assert(sizeof(FFortAIStateTreeReference) == 0x000028, "Wrong size on FFortAIStateTreeReference");
static_assert(offsetof(FFortAIStateTreeReference, StateTreeRef) == 0x000000, "Member 'FFortAIStateTreeReference::StateTreeRef' has a wrong offset!");
...
static_assert(alignof(FFortAIInjectedActionStateTreeReference) == 0x000008, "Wrong alignment on FFortAIInjectedActionStateTreeReference");
static_assert(sizeof(FFortAIInjectedActionStateTreeReference) == 0x000028, "Wrong size on FFortAIInjectedActionStateTreeReference");
static_assert(offsetof(FFortAIInjectedActionStateTreeReference, StateTreeRef) == 0x000000, "Member 'FFortAIInjectedActionStateTreeReference::StateTreeRef' has a wrong offset!");
...
static_assert(alignof(FFortAIInjectedDecisionStateTreeReference) == 0x000008, "Wrong alignment on FFortAIInjectedDecisionStateTreeReference");
static_assert(sizeof(FFortAIInjectedDecisionStateTreeReference) == 0x000028, "Wrong size on FFortAIInjectedDecisionStateTreeReference");
static_assert(offsetof(FFortAIInjectedDecisionStateTreeReference, StateTreeRef) == 0x000000, "Member 'FFortAIInjectedDecisionStateTreeReference::StateTreeRef' has a wrong offset!");
...
static_assert(alignof(FTokenHandle) == 0x000004, "Wrong alignment on FTokenHandle");
static_assert(sizeof(FTokenHandle) == 0x000008, "Wrong size on FTokenHandle");
...
{
public:
	struct FGameplayTag                           TokenTag;                                          // 0x0000(0x0004)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FTokenHandle                           TokenHandle;                                       // 0x0004(0x0008)(Transient, NoDestructor, NativeAccessSpecifierPublic)
	ETokenState                                   TokenState;                                        // 0x000C(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UFortAICombatTokenProviderComponent> TokenProvider;                                     // 0x0010(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FOwnedTokenData) == 0x000004, "Wrong alignment on FOwnedTokenData");
static_assert(sizeof(FOwnedTokenData) == 0x000018, "Wrong size on FOwnedTokenData");
static_assert(offsetof(FOwnedTokenData, TokenTag) == 0x000000, "Member 'FOwnedTokenData::TokenTag' has a wrong offset!");
static_assert(offsetof(FOwnedTokenData, TokenHandle) == 0x000004, "Member 'FOwnedTokenData::TokenHandle' has a wrong offset!");
static_assert(offsetof(FOwnedTokenData, TokenState) == 0x00000C, "Member 'FOwnedTokenData::TokenState' has a wrong offset!");
static_assert(offsetof(FOwnedTokenData, TokenProvider) == 0x000010, "Member 'FOwnedTokenData::TokenProvider' has a wrong offset!");
...
static_assert(alignof(FTokenReservationData) == 0x000008, "Wrong alignment on FTokenReservationData");
static_assert(sizeof(FTokenReservationData) == 0x000018, "Wrong size on FTokenReservationData");
static_assert(offsetof(FTokenReservationData, TokenState) == 0x000000, "Member 'FTokenReservationData::TokenState' has a wrong offset!");
static_assert(offsetof(FTokenReservationData, TokenHandle) == 0x000004, "Member 'FTokenReservationData::TokenHandle' has a wrong offset!");
static_assert(offsetof(FTokenReservationData, TokenConsumer) == 0x000010, "Member 'FTokenReservationData::TokenConsumer' has a wrong offset!");
...
static_assert(offsetof(FQueryableTagContainerEntry, Query) == 0x000000, "Member 'FQueryableTagContainerEntry::Query' has a wrong offset!");
static_assert(offsetof(FQueryableTagContainerEntry, Tags) == 0x000048, "Member 'FQueryableTagContainerEntry::Tags' has a wrong offset!");
...
public:
	...
	float                                         CurrentNumberOfTokens;                             // 0x0030(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAmountModified;                                   // 0x0034(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAssignTokensBasedOnProximity;                     // 0x0035(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_36[0x2];                                       // 0x0036(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FTokenReservationData>          TokenReservations;                                 // 0x0038(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(FTokenType) == 0x000008, "Wrong alignment on FTokenType");
static_assert(sizeof(FTokenType) == 0x000048, "Wrong size on FTokenType");
static_assert(offsetof(FTokenType, TokenIdentificationTag) == 0x000000, "Member 'FTokenType::TokenIdentificationTag' has a wrong offset!");
static_assert(offsetof(FTokenType, NumberOfTokens) == 0x000008, "Member 'FTokenType::NumberOfTokens' has a wrong offset!");
static_assert(offsetof(FTokenType, CurrentNumberOfTokens) == 0x000030, "Member 'FTokenType::CurrentNumberOfTokens' has a wrong offset!");
static_assert(offsetof(FTokenType, bAmountModified) == 0x000034, "Member 'FTokenType::bAmountModified' has a wrong offset!");
static_assert(offsetof(FTokenType, bAssignTokensBasedOnProximity) == 0x000035, "Member 'FTokenType::bAssignTokensBasedOnProximity' has a wrong offset!");
static_assert(offsetof(FTokenType, TokenReservations) == 0x000038, "Member 'FTokenType::TokenReservations' has a wrong offset!");
...
public:
	...
	struct FScalableFloat                         OrientationAngleForResultsInvalidation;            // 0x0078(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FScalableFloat                         MinimumDistanceBetweenPositions;                   // 0x00A0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bOwnerRelativePositions;                           // 0x00C8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOwnerVelocityOffset;                              // 0x00C9(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bOwnerVelocityOffsetTowardsPlayer;                 // 0x00CA(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_CB[0x5];                                       // 0x00CB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         OffsetMaxLength;                                   // 0x00D0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bReassignReservedPositions;                        // 0x00F8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           RunQueryHandle;                                    // 0x0100(0x0008)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                LastQueryLocation;                                 // 0x0108(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                                LastQueryOrientation;                              // 0x0120(0x0018)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 Owner;                                             // 0x0138(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LastQueryTimestamp;                                // 0x0140(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         PositionRequesters;                                // 0x0144(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FTokenProviderPositioningData) == 0x000190, "Wrong size on FTokenProviderPositioningData");
...
static_assert(offsetof(FTokenProviderPositioningData, OrientationAngleForResultsInvalidation) == 0x000078, "Member 'FTokenProviderPositioningData::OrientationAngleForResultsInvalidation' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, MinimumDistanceBetweenPositions) == 0x0000A0, "Member 'FTokenProviderPositioningData::MinimumDistanceBetweenPositions' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, bOwnerRelativePositions) == 0x0000C8, "Member 'FTokenProviderPositioningData::bOwnerRelativePositions' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, bOwnerVelocityOffset) == 0x0000C9, "Member 'FTokenProviderPositioningData::bOwnerVelocityOffset' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, bOwnerVelocityOffsetTowardsPlayer) == 0x0000CA, "Member 'FTokenProviderPositioningData::bOwnerVelocityOffsetTowardsPlayer' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, OffsetMaxLength) == 0x0000D0, "Member 'FTokenProviderPositioningData::OffsetMaxLength' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, bReassignReservedPositions) == 0x0000F8, "Member 'FTokenProviderPositioningData::bReassignReservedPositions' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, RunQueryHandle) == 0x000100, "Member 'FTokenProviderPositioningData::RunQueryHandle' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, LastQueryLocation) == 0x000108, "Member 'FTokenProviderPositioningData::LastQueryLocation' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, LastQueryOrientation) == 0x000120, "Member 'FTokenProviderPositioningData::LastQueryOrientation' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, Owner) == 0x000138, "Member 'FTokenProviderPositioningData::Owner' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, LastQueryTimestamp) == 0x000140, "Member 'FTokenProviderPositioningData::LastQueryTimestamp' has a wrong offset!");
static_assert(offsetof(FTokenProviderPositioningData, PositionRequesters) == 0x000144, "Member 'FTokenProviderPositioningData::PositionRequesters' has a wrong offset!");
...
{
public:
	struct FGameplayTag                           EnergyOverTimeIdentifier;                          // 0x0000(0x0004)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         EnergyPerSecond;                                   // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FAIEnergyOverTimeData) == 0x000004, "Wrong alignment on FAIEnergyOverTimeData");
static_assert(sizeof(FAIEnergyOverTimeData) == 0x000008, "Wrong size on FAIEnergyOverTimeData");
static_assert(offsetof(FAIEnergyOverTimeData, EnergyOverTimeIdentifier) == 0x000000, "Member 'FAIEnergyOverTimeData::EnergyOverTimeIdentifier' has a wrong offset!");
static_assert(offsetof(FAIEnergyOverTimeData, EnergyPerSecond) == 0x000004, "Member 'FAIEnergyOverTimeData::EnergyPerSecond' has a wrong offset!");
...
{
public:
	TDelegate<void()>                             Delegate;                                          // 0x0000(0x000C)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ThresholdPercentageValue;                          // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAIEnergyThresholdEventType                   ThresholdType;                                     // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIsPendingRemove;                                  // 0x0011(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_12[0x2];                                       // 0x0012(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAIEnergyThresholdEventData) == 0x000004, "Wrong alignment on FAIEnergyThresholdEventData");
static_assert(sizeof(FAIEnergyThresholdEventData) == 0x000014, "Wrong size on FAIEnergyThresholdEventData");
static_assert(offsetof(FAIEnergyThresholdEventData, Delegate) == 0x000000, "Member 'FAIEnergyThresholdEventData::Delegate' has a wrong offset!");
static_assert(offsetof(FAIEnergyThresholdEventData, ThresholdPercentageValue) == 0x00000C, "Member 'FAIEnergyThresholdEventData::ThresholdPercentageValue' has a wrong offset!");
static_assert(offsetof(FAIEnergyThresholdEventData, ThresholdType) == 0x000010, "Member 'FAIEnergyThresholdEventData::ThresholdType' has a wrong offset!");
static_assert(offsetof(FAIEnergyThresholdEventData, bIsPendingRemove) == 0x000011, "Member 'FAIEnergyThresholdEventData::bIsPendingRemove' has a wrong offset!");
...
{
public:
	struct FBox                                   ClusterBox;                                        // 0x0000(0x0038)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	TStructCycleFixup<struct FFortWorldMarkerData, 0x00E0, 0x08> MarkerData;                                        // 0x0008(0x00E0)(Transient, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FFortPingInfo) == 0x000100, "Wrong size on FFortPingInfo");
...
public:
	...
	float                                         IncreasedAccuracyRatioAgainstDBNO;                 // 0x0100(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         IncreasedAccuracyRatioAgainstBots;                 // 0x0104(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bUseLastTimeToHitOnWeaponChange;                   // 0x0108(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bForceMissEnabled;                                 // 0x0109(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_10A[0x2];                                      // 0x010A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ExtraClampingDistance;                             // 0x010C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bPreventHeadshots;                                 // 0x0110(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         WeaponSpreadContributionToClampCurve;              // 0x0118(0x0028)(Transient, Protected, NativeAccessSpecifierProtected)
	float                                         KillingBlowGracePeriodAtMinRange;                  // 0x0140(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         KillingBlowGracePeriodAtMaxRange;                  // 0x0144(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FScalableFloat                         ExtraHitOddsCurve;                                 // 0x0148(0x0028)(Transient, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FDigestedAimingCircleSettings) == 0x000008, "Wrong alignment on FDigestedAimingCircleSettings");
static_assert(sizeof(FDigestedAimingCircleSettings) == 0x000170, "Wrong size on FDigestedAimingCircleSettings");
...
static_assert(offsetof(FDigestedAimingCircleSettings, IncreasedAccuracyRatioAgainstDBNO) == 0x000100, "Member 'FDigestedAimingCircleSettings::IncreasedAccuracyRatioAgainstDBNO' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, IncreasedAccuracyRatioAgainstBots) == 0x000104, "Member 'FDigestedAimingCircleSettings::IncreasedAccuracyRatioAgainstBots' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, bUseLastTimeToHitOnWeaponChange) == 0x000108, "Member 'FDigestedAimingCircleSettings::bUseLastTimeToHitOnWeaponChange' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, bForceMissEnabled) == 0x000109, "Member 'FDigestedAimingCircleSettings::bForceMissEnabled' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, ExtraClampingDistance) == 0x00010C, "Member 'FDigestedAimingCircleSettings::ExtraClampingDistance' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, bPreventHeadshots) == 0x000110, "Member 'FDigestedAimingCircleSettings::bPreventHeadshots' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, WeaponSpreadContributionToClampCurve) == 0x000118, "Member 'FDigestedAimingCircleSettings::WeaponSpreadContributionToClampCurve' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, KillingBlowGracePeriodAtMinRange) == 0x000140, "Member 'FDigestedAimingCircleSettings::KillingBlowGracePeriodAtMinRange' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, KillingBlowGracePeriodAtMaxRange) == 0x000144, "Member 'FDigestedAimingCircleSettings::KillingBlowGracePeriodAtMaxRange' has a wrong offset!");
static_assert(offsetof(FDigestedAimingCircleSettings, ExtraHitOddsCurve) == 0x000148, "Member 'FDigestedAimingCircleSettings::ExtraHitOddsCurve' has a wrong offset!");
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FWeaponAccuracy                        WeaponAccuracy;                                    // 0x0020(0x0918)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<struct FWeaponAccuracyCategorySpecialization> Specializations;                                   // 0x0938(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FWeaponAccuracyCategory) == 0x000008, "Wrong alignment on FWeaponAccuracyCategory");
static_assert(sizeof(FWeaponAccuracyCategory) == 0x000948, "Wrong size on FWeaponAccuracyCategory");
...
static_assert(offsetof(FWeaponAccuracyCategory, Specializations) == 0x000938, "Member 'FWeaponAccuracyCategory::Specializations' has a wrong offset!");
...
static_assert(alignof(FWeaponAimOffset) == 0x000008, "Wrong alignment on FWeaponAimOffset");
static_assert(sizeof(FWeaponAimOffset) == 0x0000C0, "Wrong size on FWeaponAimOffset");
static_assert(offsetof(FWeaponAimOffset, TagQuery) == 0x000000, "Member 'FWeaponAimOffset::TagQuery' has a wrong offset!");
static_assert(offsetof(FWeaponAimOffset, AimOffsetX) == 0x000048, "Member 'FWeaponAimOffset::AimOffsetX' has a wrong offset!");
static_assert(offsetof(FWeaponAimOffset, AimOffsetY) == 0x000070, "Member 'FWeaponAimOffset::AimOffsetY' has a wrong offset!");
static_assert(offsetof(FWeaponAimOffset, AimOffsetZ) == 0x000098, "Member 'FWeaponAimOffset::AimOffsetZ' has a wrong offset!");
...
public:
	...
	float                                         MaxAngleThresholdToAddWeaponOffset;                // 0x0170(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bStopFiringIfLoFIsOccludedByLandscape;             // 0x0174(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bChaseAfterTargetOnLoFLoss;                        // 0x0175(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bLookForDistantPositionsOnLoFLoss;                 // 0x0176(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_177[0x1];                                      // 0x0177(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         OccludedShootingPositionScoreDistance;             // 0x0178(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         LoFMaxTestDistance;                                // 0x017C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         IdealAttackRange;                                  // 0x0180(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         TargetingIdealAttackRange;                         // 0x0184(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxAttackRange;                                    // 0x0188(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ChanceToAimAtTargetsFeet;                          // 0x018C(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ChanceToAimAtTargetsFeetWhenTimeToHit;             // 0x0190(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_194[0x4];                                      // 0x0194(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         ShouldUseProjectileArcForAiming;                   // 0x0198(0x0028)(Transient, NativeAccessSpecifierPrivate)
	bool                                          bKeepAimingOnSameSideWhileFiring;                  // 0x01C0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bSkipTargetPositionHistoryForEstimatedLocation;    // 0x01C1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1C2[0x2];                                      // 0x01C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxTrackingHeightOffsetError;                      // 0x01C4(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MinRotationInterpSpeed;                            // 0x01C8(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxRotationInterpSpeed;                            // 0x01CC(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOverrideAimingCircleSettings;                     // 0x01D0(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bConsiderProjectileTravelTime;                     // 0x01D1(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D2[0x6];                                      // 0x01D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDigestedAimingCircleSettings          AimingCircleSettingsOverride;                      // 0x01D8(0x0170)(Transient, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FDigestedWeaponAccuracy) == 0x000008, "Wrong alignment on FDigestedWeaponAccuracy");
static_assert(sizeof(FDigestedWeaponAccuracy) == 0x000348, "Wrong size on FDigestedWeaponAccuracy");
...
static_assert(offsetof(FDigestedWeaponAccuracy, MaxAngleThresholdToAddWeaponOffset) == 0x000170, "Member 'FDigestedWeaponAccuracy::MaxAngleThresholdToAddWeaponOffset' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bStopFiringIfLoFIsOccludedByLandscape) == 0x000174, "Member 'FDigestedWeaponAccuracy::bStopFiringIfLoFIsOccludedByLandscape' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bChaseAfterTargetOnLoFLoss) == 0x000175, "Member 'FDigestedWeaponAccuracy::bChaseAfterTargetOnLoFLoss' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bLookForDistantPositionsOnLoFLoss) == 0x000176, "Member 'FDigestedWeaponAccuracy::bLookForDistantPositionsOnLoFLoss' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, OccludedShootingPositionScoreDistance) == 0x000178, "Member 'FDigestedWeaponAccuracy::OccludedShootingPositionScoreDistance' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, LoFMaxTestDistance) == 0x00017C, "Member 'FDigestedWeaponAccuracy::LoFMaxTestDistance' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, IdealAttackRange) == 0x000180, "Member 'FDigestedWeaponAccuracy::IdealAttackRange' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, TargetingIdealAttackRange) == 0x000184, "Member 'FDigestedWeaponAccuracy::TargetingIdealAttackRange' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, MaxAttackRange) == 0x000188, "Member 'FDigestedWeaponAccuracy::MaxAttackRange' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, ChanceToAimAtTargetsFeet) == 0x00018C, "Member 'FDigestedWeaponAccuracy::ChanceToAimAtTargetsFeet' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, ChanceToAimAtTargetsFeetWhenTimeToHit) == 0x000190, "Member 'FDigestedWeaponAccuracy::ChanceToAimAtTargetsFeetWhenTimeToHit' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, ShouldUseProjectileArcForAiming) == 0x000198, "Member 'FDigestedWeaponAccuracy::ShouldUseProjectileArcForAiming' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bKeepAimingOnSameSideWhileFiring) == 0x0001C0, "Member 'FDigestedWeaponAccuracy::bKeepAimingOnSameSideWhileFiring' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bSkipTargetPositionHistoryForEstimatedLocation) == 0x0001C1, "Member 'FDigestedWeaponAccuracy::bSkipTargetPositionHistoryForEstimatedLocation' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, MaxTrackingHeightOffsetError) == 0x0001C4, "Member 'FDigestedWeaponAccuracy::MaxTrackingHeightOffsetError' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, MinRotationInterpSpeed) == 0x0001C8, "Member 'FDigestedWeaponAccuracy::MinRotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, MaxRotationInterpSpeed) == 0x0001CC, "Member 'FDigestedWeaponAccuracy::MaxRotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bOverrideAimingCircleSettings) == 0x0001D0, "Member 'FDigestedWeaponAccuracy::bOverrideAimingCircleSettings' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, bConsiderProjectileTravelTime) == 0x0001D1, "Member 'FDigestedWeaponAccuracy::bConsiderProjectileTravelTime' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAccuracy, AimingCircleSettingsOverride) == 0x0001D8, "Member 'FDigestedWeaponAccuracy::AimingCircleSettingsOverride' has a wrong offset!");
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Transient, NativeAccessSpecifierPrivate)
	struct FDigestedWeaponAccuracy                WeaponAccuracy;                                    // 0x0020(0x0348)(Transient, NativeAccessSpecifierPrivate)
};
...
static_assert(sizeof(FDigestedWeaponAccuracyCategorySpecialization) == 0x000368, "Wrong size on FDigestedWeaponAccuracyCategorySpecialization");
...
public:
	struct FGameplayTagContainer                  Tags;                                              // 0x0000(0x0020)(Transient, NativeAccessSpecifierPrivate)
	struct FDigestedWeaponAccuracy                WeaponAccuracy;                                    // 0x0020(0x0348)(Transient, NativeAccessSpecifierPrivate)
	TArray<struct FDigestedWeaponAccuracyCategorySpecialization> Specializations;                                   // 0x0368(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FDigestedWeaponAccuracyCategory) == 0x000008, "Wrong alignment on FDigestedWeaponAccuracyCategory");
static_assert(sizeof(FDigestedWeaponAccuracyCategory) == 0x000378, "Wrong size on FDigestedWeaponAccuracyCategory");
...
static_assert(offsetof(FDigestedWeaponAccuracyCategory, Specializations) == 0x000368, "Member 'FDigestedWeaponAccuracyCategory::Specializations' has a wrong offset!");
...
static_assert(sizeof(FDigestedFiringPattern) == 0x000028, "Wrong size on FDigestedFiringPattern");
...
static_assert(offsetof(FDigestedFiringPattern, FiringTimes) == 0x000018, "Member 'FDigestedFiringPattern::FiringTimes' has a wrong offset!");
...
static_assert(offsetof(FDigestedRangedWeaponSkill, StopFiringWhenTargetWillDieOdds) == 0x000020, "Member 'FDigestedRangedWeaponSkill::StopFiringWhenTargetWillDieOdds' has a wrong offset!");
static_assert(offsetof(FDigestedRangedWeaponSkill, TargetInAirFiringPatterns) == 0x000028, "Member 'FDigestedRangedWeaponSkill::TargetInAirFiringPatterns' has a wrong offset!");
static_assert(offsetof(FDigestedRangedWeaponSkill, FiringPatterns) == 0x000038, "Member 'FDigestedRangedWeaponSkill::FiringPatterns' has a wrong offset!");
...
static_assert(offsetof(FDigestedRangedWeaponSkillCategory, Specializations) == 0x000068, "Member 'FDigestedRangedWeaponSkillCategory::Specializations' has a wrong offset!");
...
static_assert(alignof(FDigestedWeaponAimOffset) == 0x000008, "Wrong alignment on FDigestedWeaponAimOffset");
static_assert(sizeof(FDigestedWeaponAimOffset) == 0x000060, "Wrong size on FDigestedWeaponAimOffset");
static_assert(offsetof(FDigestedWeaponAimOffset, TagQuery) == 0x000000, "Member 'FDigestedWeaponAimOffset::TagQuery' has a wrong offset!");
static_assert(offsetof(FDigestedWeaponAimOffset, AimOffset) == 0x000048, "Member 'FDigestedWeaponAimOffset::AimOffset' has a wrong offset!");
...
{
public:
	struct FWorldConditionContextDataRef          BotControllerRef;                                  // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWorldConditionBotControllerBase) == 0x000008, "Wrong alignment on FWorldConditionBotControllerBase");
static_assert(sizeof(FWorldConditionBotControllerBase) == 0x000018, "Wrong size on FWorldConditionBotControllerBase");
static_assert(offsetof(FWorldConditionBotControllerBase, BotControllerRef) == 0x000010, "Member 'FWorldConditionBotControllerBase::BotControllerRef' has a wrong offset!");
...
static_assert(alignof(FWorldConditionHasReceivedDamageFromTarget) == 0x000008, "Wrong alignment on FWorldConditionHasReceivedDamageFromTarget");
static_assert(sizeof(FWorldConditionHasReceivedDamageFromTarget) == 0x000020, "Wrong size on FWorldConditionHasReceivedDamageFromTarget");
static_assert(offsetof(FWorldConditionHasReceivedDamageFromTarget, TargetActorRef) == 0x000018, "Member 'FWorldConditionHasReceivedDamageFromTarget::TargetActorRef' has a wrong offset!");
...
{
public:
	struct FWorldConditionContextDataRef          ControllerRef;                                     // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWorldConditionControllerBase) == 0x000008, "Wrong alignment on FWorldConditionControllerBase");
static_assert(sizeof(FWorldConditionControllerBase) == 0x000018, "Wrong size on FWorldConditionControllerBase");
static_assert(offsetof(FWorldConditionControllerBase, ControllerRef) == 0x000010, "Member 'FWorldConditionControllerBase::ControllerRef' has a wrong offset!");
...
static_assert(alignof(FWorldConditionPawnBase) == 0x000008, "Wrong alignment on FWorldConditionPawnBase");
static_assert(sizeof(FWorldConditionPawnBase) == 0x000018, "Wrong size on FWorldConditionPawnBase");
static_assert(offsetof(FWorldConditionPawnBase, PawnRef) == 0x000010, "Member 'FWorldConditionPawnBase::PawnRef' has a wrong offset!");
...
public:
	struct FWorldConditionContextDataRef          SourceActorRef;                                    // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FWorldConditionContextDataRef          TargetActorRef;                                    // 0x0018(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FScalableFloat                         CutoffAngle;                                       // 0x0020(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint8                                         Pad_48[0x8];                                       // 0x0048(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionFacing) == 0x000008, "Wrong alignment on FFortWorldConditionFacing");
static_assert(sizeof(FFortWorldConditionFacing) == 0x000050, "Wrong size on FFortWorldConditionFacing");
static_assert(offsetof(FFortWorldConditionFacing, SourceActorRef) == 0x000010, "Member 'FFortWorldConditionFacing::SourceActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFacing, TargetActorRef) == 0x000018, "Member 'FFortWorldConditionFacing::TargetActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFacing, CutoffAngle) == 0x000020, "Member 'FFortWorldConditionFacing::CutoffAngle' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortWorldConditionAreCalendarEventsActive
// 0x0020 (0x0030 - 0x0010)
struct FFortWorldConditionAreCalendarEventsActive final : public FWorldConditionCommonBase
{
public:
	TArray<class FString>                         ActiveCalendarEvents;                              // 0x0010(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                         InactiveCalendarEvents;                            // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortWorldConditionAreCalendarEventsActive) == 0x000008, "Wrong alignment on FFortWorldConditionAreCalendarEventsActive");
static_assert(sizeof(FFortWorldConditionAreCalendarEventsActive) == 0x000030, "Wrong size on FFortWorldConditionAreCalendarEventsActive");
static_assert(offsetof(FFortWorldConditionAreCalendarEventsActive, ActiveCalendarEvents) == 0x000010, "Member 'FFortWorldConditionAreCalendarEventsActive::ActiveCalendarEvents' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionAreCalendarEventsActive, InactiveCalendarEvents) == 0x000020, "Member 'FFortWorldConditionAreCalendarEventsActive::InactiveCalendarEvents' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortWorldConditionNearbyPawn_State
// 0x0030 (0x0030 - 0x0000)
struct alignas(0x08) FFortWorldConditionNearbyPawn_State final
{
public:
	uint8                                         Pad_0[0x30];                                       // 0x0000(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionNearbyPawn_State) == 0x000008, "Wrong alignment on FFortWorldConditionNearbyPawn_State");
static_assert(sizeof(FFortWorldConditionNearbyPawn_State) == 0x000030, "Wrong size on FFortWorldConditionNearbyPawn_State");
...
{
public:
	struct FWorldConditionContextDataRef          WeaponActorRef;                                    // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWorldConditionFortWeaponBase) == 0x000008, "Wrong alignment on FWorldConditionFortWeaponBase");
static_assert(sizeof(FWorldConditionFortWeaponBase) == 0x000018, "Wrong size on FWorldConditionFortWeaponBase");
static_assert(offsetof(FWorldConditionFortWeaponBase, WeaponActorRef) == 0x000010, "Member 'FWorldConditionFortWeaponBase::WeaponActorRef' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         AmmoThreshold;                                     // 0x0018(0x0028)(Edit, NativeAccessSpecifierPublic)
	EArithmeticKeyOperation                       Operation;                                         // 0x0040(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionAmmoClip) == 0x000008, "Wrong alignment on FFortWorldConditionAmmoClip");
static_assert(sizeof(FFortWorldConditionAmmoClip) == 0x000048, "Wrong size on FFortWorldConditionAmmoClip");
static_assert(offsetof(FFortWorldConditionAmmoClip, AmmoThreshold) == 0x000018, "Member 'FFortWorldConditionAmmoClip::AmmoThreshold' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionAmmoClip, Operation) == 0x000040, "Member 'FFortWorldConditionAmmoClip::Operation' has a wrong offset!");
...
public:
	...
	struct FGameplayTagQuery                      AlliesTagQuery;                                    // 0x0038(0x0048)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         NumberOfAllies;                                    // 0x0080(0x0028)(Edit, NativeAccessSpecifierPublic)
	EArithmeticKeyOperation                       Operation;                                         // 0x00A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A9[0x3];                                       // 0x00A9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWorldConditionContextDataRef          ActorRef;                                          // 0x00AC(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_B4[0x4];                                       // 0x00B4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionFactionAlliesCheck) == 0x000008, "Wrong alignment on FFortWorldConditionFactionAlliesCheck");
static_assert(sizeof(FFortWorldConditionFactionAlliesCheck) == 0x0000B8, "Wrong size on FFortWorldConditionFactionAlliesCheck");
static_assert(offsetof(FFortWorldConditionFactionAlliesCheck, Radius) == 0x000010, "Member 'FFortWorldConditionFactionAlliesCheck::Radius' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFactionAlliesCheck, AlliesTagQuery) == 0x000038, "Member 'FFortWorldConditionFactionAlliesCheck::AlliesTagQuery' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFactionAlliesCheck, NumberOfAllies) == 0x000080, "Member 'FFortWorldConditionFactionAlliesCheck::NumberOfAllies' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFactionAlliesCheck, Operation) == 0x0000A8, "Member 'FFortWorldConditionFactionAlliesCheck::Operation' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionFactionAlliesCheck, ActorRef) == 0x0000AC, "Member 'FFortWorldConditionFactionAlliesCheck::ActorRef' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortWorldConditionNearbyLoot_State
// 0x0020 (0x0020 - 0x0000)
struct alignas(0x08) FFortWorldConditionNearbyLoot_State final
{
public:
	uint8                                         Pad_0[0x20];                                       // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionNearbyLoot_State) == 0x000008, "Wrong alignment on FFortWorldConditionNearbyLoot_State");
static_assert(sizeof(FFortWorldConditionNearbyLoot_State) == 0x000020, "Wrong size on FFortWorldConditionNearbyLoot_State");
...
{
public:
	struct FWorldConditionContextDataRef          FortPawnRef;                                       // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWorldConditionFortPawnBase) == 0x000008, "Wrong alignment on FWorldConditionFortPawnBase");
static_assert(sizeof(FWorldConditionFortPawnBase) == 0x000018, "Wrong size on FWorldConditionFortPawnBase");
static_assert(offsetof(FWorldConditionFortPawnBase, FortPawnRef) == 0x000010, "Member 'FWorldConditionFortPawnBase::FortPawnRef' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         HealthThresholdRatio;                              // 0x0018(0x0028)(Edit, NativeAccessSpecifierPublic)
	EArithmeticKeyOperation                       Operation;                                         // 0x0040(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionHealthCheck) == 0x000008, "Wrong alignment on FFortWorldConditionHealthCheck");
static_assert(sizeof(FFortWorldConditionHealthCheck) == 0x000048, "Wrong size on FFortWorldConditionHealthCheck");
static_assert(offsetof(FFortWorldConditionHealthCheck, HealthThresholdRatio) == 0x000018, "Member 'FFortWorldConditionHealthCheck::HealthThresholdRatio' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionHealthCheck, Operation) == 0x000040, "Member 'FFortWorldConditionHealthCheck::Operation' has a wrong offset!");

// ScriptStruct FortniteAI.FortAIWeaponEffectivenessDataTableRow
// 0x0098 (0x00A0 - 0x0008)
struct FFortAIWeaponEffectivenessDataTableRow final : public FTableRowBase
{
public:
	struct FGameplayTagQuery                      TargetTagQuery;                                    // 0x0008(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FGameplayTagQuery                      WeaponTagQuery;                                    // 0x0050(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	float                                         EffectivenessMultiplier;                           // 0x0098(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9C[0x4];                                       // 0x009C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAIWeaponEffectivenessDataTableRow) == 0x000008, "Wrong alignment on FFortAIWeaponEffectivenessDataTableRow");
static_assert(sizeof(FFortAIWeaponEffectivenessDataTableRow) == 0x0000A0, "Wrong size on FFortAIWeaponEffectivenessDataTableRow");
static_assert(offsetof(FFortAIWeaponEffectivenessDataTableRow, TargetTagQuery) == 0x000008, "Member 'FFortAIWeaponEffectivenessDataTableRow::TargetTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIWeaponEffectivenessDataTableRow, WeaponTagQuery) == 0x000050, "Member 'FFortAIWeaponEffectivenessDataTableRow::WeaponTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAIWeaponEffectivenessDataTableRow, EffectivenessMultiplier) == 0x000098, "Member 'FFortAIWeaponEffectivenessDataTableRow::EffectivenessMultiplier' has a wrong offset!");
...
public:
	...
	struct FFortAthenaAIBotTargetHeuristicSettings Settings;                                          // 0x0048(0x0380)(Edit, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
};
...
static_assert(sizeof(FFortAthenaAIBotTargetHeuristicSettingsSpecialization) == 0x0003C8, "Wrong size on FFortAthenaAIBotTargetHeuristicSettingsSpecialization");
...
static_assert(offsetof(FRangedWeaponSkillCategory, Specializations) == 0x0001A8, "Member 'FRangedWeaponSkillCategory::Specializations' has a wrong offset!");
...
static_assert(offsetof(FFortSmartObjectCustomVerb, VerbTag) == 0x000000, "Member 'FFortSmartObjectCustomVerb::VerbTag' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectCustomVerb, InstigatorName) == 0x000004, "Member 'FFortSmartObjectCustomVerb::InstigatorName' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectCustomVerb, ActivityName) == 0x000008, "Member 'FFortSmartObjectCustomVerb::ActivityName' has a wrong offset!");
...
{
public:
	float                                         CooldownOnFinished;                                // 0x0008(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CooldownOnInterrupted;                             // 0x000C(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         Radius;                                            // 0x0010(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         SlotCooldownOnFinished;                            // 0x0014(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         SlotCooldownOnInterrupted;                         // 0x0018(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EFortAthenaSmartObjectPriority                Priority;                                          // 0x001C(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D[0x3];                                       // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         PriorityChangeWithOtherAIUser;                     // 0x0020(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                         PriorityChangeWithOtherPlayerUser;                 // 0x0024(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	EFortAthenaSmartObjectUrgency                 Urgency;                                           // 0x0028(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_29[0x7];                                       // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFortSmartObjectCustomVerb>     CustomVerbs;                                       // 0x0030(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	struct FDataTableRowHandle                    ExternalDataTableRow;                              // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortSmartObjectSlotDefinitionData) == 0x000008, "Wrong alignment on FFortSmartObjectSlotDefinitionData");
static_assert(sizeof(FFortSmartObjectSlotDefinitionData) == 0x000050, "Wrong size on FFortSmartObjectSlotDefinitionData");
...
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, PriorityChangeWithOtherAIUser) == 0x000020, "Member 'FFortSmartObjectSlotDefinitionData::PriorityChangeWithOtherAIUser' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, PriorityChangeWithOtherPlayerUser) == 0x000024, "Member 'FFortSmartObjectSlotDefinitionData::PriorityChangeWithOtherPlayerUser' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, Urgency) == 0x000028, "Member 'FFortSmartObjectSlotDefinitionData::Urgency' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, CustomVerbs) == 0x000030, "Member 'FFortSmartObjectSlotDefinitionData::CustomVerbs' has a wrong offset!");
static_assert(offsetof(FFortSmartObjectSlotDefinitionData, ExternalDataTableRow) == 0x000040, "Member 'FFortSmartObjectSlotDefinitionData::ExternalDataTableRow' has a wrong offset!");
...
static_assert(sizeof(FSmartObjectRecentlyUsed) == 0x00002C, "Wrong size on FSmartObjectRecentlyUsed");
...
{
public:
	TSoftObjectPtr<class UAthenaDanceItemDefinition> PatrolEmote;                                       // 0x0000(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FScalableFloat                         PatrolSpeed;                                       // 0x0020(0x0028)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FPatrolBehaviorSettings) == 0x000008, "Wrong alignment on FPatrolBehaviorSettings");
static_assert(sizeof(FPatrolBehaviorSettings) == 0x000048, "Wrong size on FPatrolBehaviorSettings");
static_assert(offsetof(FPatrolBehaviorSettings, PatrolEmote) == 0x000000, "Member 'FPatrolBehaviorSettings::PatrolEmote' has a wrong offset!");
static_assert(offsetof(FPatrolBehaviorSettings, PatrolSpeed) == 0x000020, "Member 'FPatrolBehaviorSettings::PatrolSpeed' has a wrong offset!");
...
public:
	...
	TArray<struct FFortBotTargetWeakspot>         Weakspots;                                         // 0x0050(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	int32                                         TargetWeakspotIdx;                                 // 0x0060(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x90];                                      // 0x0064(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class AActor>                  LOFHitActor;                                       // 0x00F4(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_FC[0xAC];                                      // 0x00FC(0x00AC)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortBotTargetInfo) == 0x000008, "Wrong alignment on FFortBotTargetInfo");
static_assert(sizeof(FFortBotTargetInfo) == 0x0001A8, "Wrong size on FFortBotTargetInfo");
...
static_assert(offsetof(FFortBotTargetInfo, Weakspots) == 0x000050, "Member 'FFortBotTargetInfo::Weakspots' has a wrong offset!");
static_assert(offsetof(FFortBotTargetInfo, TargetWeakspotIdx) == 0x000060, "Member 'FFortBotTargetInfo::TargetWeakspotIdx' has a wrong offset!");
static_assert(offsetof(FFortBotTargetInfo, LOFHitActor) == 0x0000F4, "Member 'FFortBotTargetInfo::LOFHitActor' has a wrong offset!");
...
static_assert(offsetof(FFortBotTargetHandler, Targets) == 0x000000, "Member 'FFortBotTargetHandler::Targets' has a wrong offset!");
...
static_assert(offsetof(FQueryableTagContainer, Entries) == 0x000000, "Member 'FQueryableTagContainer::Entries' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortWorldConditionAbilityBehaviorDistanceCheck
// 0x0050 (0x00A0 - 0x0050)
struct FFortWorldConditionAbilityBehaviorDistanceCheck final : public FFortWorldConditionDistanceCheck
{
public:
	struct FGameplayAbilityDistanceValueModule    GameplayAbilityDistanceValueModule;                // 0x0050(0x0050)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortWorldConditionAbilityBehaviorDistanceCheck) == 0x000008, "Wrong alignment on FFortWorldConditionAbilityBehaviorDistanceCheck");
static_assert(sizeof(FFortWorldConditionAbilityBehaviorDistanceCheck) == 0x0000A0, "Wrong size on FFortWorldConditionAbilityBehaviorDistanceCheck");
static_assert(offsetof(FFortWorldConditionAbilityBehaviorDistanceCheck, GameplayAbilityDistanceValueModule) == 0x000050, "Member 'FFortWorldConditionAbilityBehaviorDistanceCheck::GameplayAbilityDistanceValueModule' has a wrong offset!");
...
static_assert(alignof(FFortWorldConditionActorBase) == 0x000008, "Wrong alignment on FFortWorldConditionActorBase");
static_assert(sizeof(FFortWorldConditionActorBase) == 0x000018, "Wrong size on FFortWorldConditionActorBase");
static_assert(offsetof(FFortWorldConditionActorBase, ActorRef) == 0x000010, "Member 'FFortWorldConditionActorBase::ActorRef' has a wrong offset!");
...
static_assert(alignof(FFortWorldConditionValidActor) == 0x000008, "Wrong alignment on FFortWorldConditionValidActor");
static_assert(sizeof(FFortWorldConditionValidActor) == 0x000018, "Wrong size on FFortWorldConditionValidActor");
...
{
public:
	EPathFollowingStatus                          MoveStatus;                                        // 0x0018(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_19[0x7];                                       // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWorldConditionHasMoveStatus) == 0x000008, "Wrong alignment on FWorldConditionHasMoveStatus");
static_assert(sizeof(FWorldConditionHasMoveStatus) == 0x000020, "Wrong size on FWorldConditionHasMoveStatus");
static_assert(offsetof(FWorldConditionHasMoveStatus, MoveStatus) == 0x000018, "Member 'FWorldConditionHasMoveStatus::MoveStatus' has a wrong offset!");
...
// ScriptStruct FortniteAI.FortWorldConditionNearbyLoot
// 0x0038 (0x0048 - 0x0010)
struct FFortWorldConditionNearbyLoot final : public FWorldConditionCommonActorBase
{
public:
	struct FWorldConditionContextDataRef          ActorRef;                                          // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct FScalableFloat                         NearbyDistance;                                    // 0x0018(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint32                                        LootElementTypeBitMask;                            // 0x0040(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_44[0x4];                                       // 0x0044(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionNearbyLoot) == 0x000008, "Wrong alignment on FFortWorldConditionNearbyLoot");
static_assert(sizeof(FFortWorldConditionNearbyLoot) == 0x000048, "Wrong size on FFortWorldConditionNearbyLoot");
static_assert(offsetof(FFortWorldConditionNearbyLoot, ActorRef) == 0x000010, "Member 'FFortWorldConditionNearbyLoot::ActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyLoot, NearbyDistance) == 0x000018, "Member 'FFortWorldConditionNearbyLoot::NearbyDistance' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyLoot, LootElementTypeBitMask) == 0x000040, "Member 'FFortWorldConditionNearbyLoot::LootElementTypeBitMask' has a wrong offset!");

// ScriptStruct FortniteAI.FortWorldConditionNearbyPawn
// 0x0110 (0x0120 - 0x0010)
struct alignas(0x10) FFortWorldConditionNearbyPawn final : public FWorldConditionCommonActorBase
{
public:
	struct FWorldConditionContextDataRef          ActorRef;                                          // 0x0010(0x0008)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	int32                                         RequiredTypes;                                     // 0x0018(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<ETeamAttitude>                         RequiredAttitudes;                                 // 0x0020(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          bIncludeDead;                                      // 0x0030(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bIncludeDBNO;                                      // 0x0031(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_32[0x6];                                       // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FScalableFloat                         NearbyDistance;                                    // 0x0038(0x0028)(Edit, NativeAccessSpecifierPublic)
	uint8                                         Pad_60[0xC0];                                      // 0x0060(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionNearbyPawn) == 0x000010, "Wrong alignment on FFortWorldConditionNearbyPawn");
static_assert(sizeof(FFortWorldConditionNearbyPawn) == 0x000120, "Wrong size on FFortWorldConditionNearbyPawn");
static_assert(offsetof(FFortWorldConditionNearbyPawn, ActorRef) == 0x000010, "Member 'FFortWorldConditionNearbyPawn::ActorRef' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyPawn, RequiredTypes) == 0x000018, "Member 'FFortWorldConditionNearbyPawn::RequiredTypes' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyPawn, RequiredAttitudes) == 0x000020, "Member 'FFortWorldConditionNearbyPawn::RequiredAttitudes' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyPawn, bIncludeDead) == 0x000030, "Member 'FFortWorldConditionNearbyPawn::bIncludeDead' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyPawn, bIncludeDBNO) == 0x000031, "Member 'FFortWorldConditionNearbyPawn::bIncludeDBNO' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionNearbyPawn, NearbyDistance) == 0x000038, "Member 'FFortWorldConditionNearbyPawn::NearbyDistance' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         SpeedThreshold;                                    // 0x0018(0x0028)(Edit, NativeAccessSpecifierPublic)
	EArithmeticKeyOperation                       Operation;                                         // 0x0040(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortWorldConditionIsMoving) == 0x000008, "Wrong alignment on FFortWorldConditionIsMoving");
static_assert(sizeof(FFortWorldConditionIsMoving) == 0x000048, "Wrong size on FFortWorldConditionIsMoving");
static_assert(offsetof(FFortWorldConditionIsMoving, SpeedThreshold) == 0x000018, "Member 'FFortWorldConditionIsMoving::SpeedThreshold' has a wrong offset!");
static_assert(offsetof(FFortWorldConditionIsMoving, Operation) == 0x000040, "Member 'FFortWorldConditionIsMoving::Operation' has a wrong offset!");
...
static_assert(alignof(FFortWorldConditionIsReloading) == 0x000008, "Wrong alignment on FFortWorldConditionIsReloading");
static_assert(sizeof(FFortWorldConditionIsReloading) == 0x000018, "Wrong size on FFortWorldConditionIsReloading");
...
static_assert(offsetof(FGameDifficultyInfo, DefaultPlayerLives) == 0x000084, "Member 'FGameDifficultyInfo::DefaultPlayerLives' has a wrong offset!");
static_assert(offsetof(FGameDifficultyInfo, PlayerStatClampRowName) == 0x000088, "Member 'FGameDifficultyInfo::PlayerStatClampRowName' has a wrong offset!");
