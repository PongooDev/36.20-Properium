...
{
public:
	struct FHitResult                             RotorHit;                                          // 0x0000(0x00F8)(ConstParm, Parm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FortHoagieVehicle_MulticastRotorImpulse) == 0x0000F8, "Wrong size on FortHoagieVehicle_MulticastRotorImpulse");
...
public:
	...
	bool                                          bInner;                                            // 0x00F8(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealt) == 0x000100, "Wrong size on FortHoagieVehicle_OnRotorDamageDealt");
...
static_assert(offsetof(FortHoagieVehicle_OnRotorDamageDealt, bInner) == 0x0000F8, "Member 'FortHoagieVehicle_OnRotorDamageDealt::bInner' has a wrong offset!");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtInner) == 0x0000F8, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtInner");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamageDealtOuter) == 0x0000F8, "Wrong size on FortHoagieVehicle_OnRotorDamageDealtOuter");
...
static_assert(sizeof(FortHoagieVehicle_OnRotorDamagePlayer) == 0x0000F8, "Wrong size on FortHoagieVehicle_OnRotorDamagePlayer");
