...
public:
	...
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* Panel)> OnWidgetActivated;                                 // 0x0458(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* Panel)> OnWidgetDeactivated;                               // 0x0468(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bConsumeAllActions;                                // 0x0478(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bExposeActionsExternally;                          // 0x0479(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bShouldBypassStack;                                // 0x047A(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_47B[0x10D];                                    // 0x047B(0x010D)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCommonActivatablePanelLegacy) == 0x000588, "Wrong size on UCommonActivatablePanelLegacy");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetActivated) == 0x000458, "Member 'UCommonActivatablePanelLegacy::OnWidgetActivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, OnWidgetDeactivated) == 0x000468, "Member 'UCommonActivatablePanelLegacy::OnWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bConsumeAllActions) == 0x000478, "Member 'UCommonActivatablePanelLegacy::bConsumeAllActions' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bExposeActionsExternally) == 0x000479, "Member 'UCommonActivatablePanelLegacy::bExposeActionsExternally' has a wrong offset!");
static_assert(offsetof(UCommonActivatablePanelLegacy, bShouldBypassStack) == 0x00047A, "Member 'UCommonActivatablePanelLegacy::bShouldBypassStack' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button, bool Selected)> OnSelectedChanged;                                 // 0x14F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button)> OnButtonClicked;                                   // 0x1500(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button)> OnButtonDoubleClicked;                             // 0x1510(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button)> OnButtonHovered;                                   // 0x1520(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	TMulticastInlineDelegate<void(class UCommonButtonLegacy* Button)> OnButtonUnhovered;                                 // 0x1530(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonButtonLegacy) == 0x001540, "Wrong size on UCommonButtonLegacy");
static_assert(offsetof(UCommonButtonLegacy, OnSelectedChanged) == 0x0014F0, "Member 'UCommonButtonLegacy::OnSelectedChanged' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonClicked) == 0x001500, "Member 'UCommonButtonLegacy::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonDoubleClicked) == 0x001510, "Member 'UCommonButtonLegacy::OnButtonDoubleClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonHovered) == 0x001520, "Member 'UCommonButtonLegacy::OnButtonHovered' has a wrong offset!");
static_assert(offsetof(UCommonButtonLegacy, OnButtonUnhovered) == 0x001530, "Member 'UCommonButtonLegacy::OnButtonUnhovered' has a wrong offset!");
...
{
public:
	TSubclassOf<class UCommonButtonLegacy>        ButtonType;                                        // 0x0320(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class UCommonButtonLegacy*>            ActiveButtons;                                     // 0x0328(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	TArray<class UCommonButtonLegacy*>            InactiveButtons;                                   // 0x0338(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonInputReflectorLegacy) == 0x000350, "Wrong size on UCommonInputReflectorLegacy");
static_assert(offsetof(UCommonInputReflectorLegacy, ButtonType) == 0x000320, "Member 'UCommonInputReflectorLegacy::ButtonType' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, ActiveButtons) == 0x000328, "Member 'UCommonInputReflectorLegacy::ActiveButtons' has a wrong offset!");
static_assert(offsetof(UCommonInputReflectorLegacy, InactiveButtons) == 0x000338, "Member 'UCommonInputReflectorLegacy::InactiveButtons' has a wrong offset!");
...
{
public:
	class UMenuAnchor*                            PopupMenuAnchor;                                   // 0x1540(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCommonPopupMenuLegacy*                 PopupMenu;                                         // 0x1548(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonPopupButtonLegacy) == 0x001550, "Wrong size on UCommonPopupButtonLegacy");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenuAnchor) == 0x001540, "Member 'UCommonPopupButtonLegacy::PopupMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupButtonLegacy, PopupMenu) == 0x001548, "Member 'UCommonPopupButtonLegacy::PopupMenu' has a wrong offset!");
...
{
public:
	bool                                          bUseInputStack;                                    // 0x0588(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_589[0x3];                                      // 0x0589(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class UMenuAnchor>             OwningMenuAnchor;                                  // 0x058C(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TWeakObjectPtr<class UObject>                 ContextProvidingObject;                            // 0x0594(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, ExposeOnSpawn, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonPopupMenuLegacy) == 0x0005A0, "Wrong size on UCommonPopupMenuLegacy");
static_assert(offsetof(UCommonPopupMenuLegacy, bUseInputStack) == 0x000588, "Member 'UCommonPopupMenuLegacy::bUseInputStack' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, OwningMenuAnchor) == 0x00058C, "Member 'UCommonPopupMenuLegacy::OwningMenuAnchor' has a wrong offset!");
static_assert(offsetof(UCommonPopupMenuLegacy, ContextProvidingObject) == 0x000594, "Member 'UCommonPopupMenuLegacy::ContextProvidingObject' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class FName TabID, class UCommonButtonLegacy* TabButton)> OnTabButtonCreated;                                // 0x0498(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class FName TabID, class UCommonButtonLegacy* TabButton)> OnTabButtonRemoved;                                // 0x04A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCommonTabListWidgetLegacy) == 0x0004B8, "Wrong size on UCommonTabListWidgetLegacy");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonCreated) == 0x000498, "Member 'UCommonTabListWidgetLegacy::OnTabButtonCreated' has a wrong offset!");
static_assert(offsetof(UCommonTabListWidgetLegacy, OnTabButtonRemoved) == 0x0004A8, "Member 'UCommonTabListWidgetLegacy::OnTabButtonRemoved' has a wrong offset!");
...
public:
	...
	bool                                          bShowForSwitch2;                                   // 0x02FC(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              VisibleType;                                       // 0x02FD(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              HiddenType;                                        // 0x02FE(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2FF[0x1];                                      // 0x02FF(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UCommonVisibilityWidgetLegacy, bShowForSwitch2) == 0x0002FC, "Member 'UCommonVisibilityWidgetLegacy::bShowForSwitch2' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, VisibleType) == 0x0002FD, "Member 'UCommonVisibilityWidgetLegacy::VisibleType' has a wrong offset!");
static_assert(offsetof(UCommonVisibilityWidgetLegacy, HiddenType) == 0x0002FE, "Member 'UCommonVisibilityWidgetLegacy::HiddenType' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class UWidget* InActiveWidget, int32 InActiveWidgetIndex)> OnActiveWidgetChangedLegacyEvent;                  // 0x01A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UCommonWidgetStackLegacy) == 0x0001B8, "Wrong size on UCommonWidgetStackLegacy");
static_assert(offsetof(UCommonWidgetStackLegacy, OnActiveWidgetChangedLegacyEvent) == 0x0001A8, "Member 'UCommonWidgetStackLegacy::OnActiveWidgetChangedLegacyEvent' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(class UCommonActivatablePanelLegacy* DeactivatedWidget)> OnActiveWidgetDeactivated;                         // 0x0210(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UWidget* ActiveWidget, int32 ActiveWidgetIndex)> OnActiveWidgetChanged;                             // 0x0220(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	bool                                          bWidgetActivationEnabled;                          // 0x0230(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOutroPanelBelow;                                  // 0x0231(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UCommonWidgetSwitcherLegacy) == 0x000238, "Wrong size on UCommonWidgetSwitcherLegacy");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetDeactivated) == 0x000210, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetDeactivated' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, OnActiveWidgetChanged) == 0x000220, "Member 'UCommonWidgetSwitcherLegacy::OnActiveWidgetChanged' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bWidgetActivationEnabled) == 0x000230, "Member 'UCommonWidgetSwitcherLegacy::bWidgetActivationEnabled' has a wrong offset!");
static_assert(offsetof(UCommonWidgetSwitcherLegacy, bOutroPanelBelow) == 0x000231, "Member 'UCommonWidgetSwitcherLegacy::bOutroPanelBelow' has a wrong offset!");
...
static_assert(offsetof(UCommonButtonGroupLegacy, OnSelectedButtonChanged) == 0x000160, "Member 'UCommonButtonGroupLegacy::OnSelectedButtonChanged' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroupLegacy, OnHoveredButtonChanged) == 0x000188, "Member 'UCommonButtonGroupLegacy::OnHoveredButtonChanged' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroupLegacy, OnButtonClicked) == 0x0001B0, "Member 'UCommonButtonGroupLegacy::OnButtonClicked' has a wrong offset!");
static_assert(offsetof(UCommonButtonGroupLegacy, OnButtonDoubleClicked) == 0x0001D8, "Member 'UCommonButtonGroupLegacy::OnButtonDoubleClicked' has a wrong offset!");
...
static_assert(sizeof(UCommonUIActionRouterLegacy) == 0x0001E0, "Wrong size on UCommonUIActionRouterLegacy");
