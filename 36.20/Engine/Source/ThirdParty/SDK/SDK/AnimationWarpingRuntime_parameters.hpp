...
static_assert(sizeof(AnimationWarpingLibrary_GetCurveValueFromAnimation) == 0x000018, "Wrong size on AnimationWarpingLibrary_GetCurveValueFromAnimation");
...
static_assert(offsetof(AnimationWarpingLibrary_GetCurveValueFromAnimation, time) == 0x00000C, "Member 'AnimationWarpingLibrary_GetCurveValueFromAnimation::time' has a wrong offset!");
static_assert(offsetof(AnimationWarpingLibrary_GetCurveValueFromAnimation, OutValue) == 0x000010, "Member 'AnimationWarpingLibrary_GetCurveValueFromAnimation::OutValue' has a wrong offset!");
static_assert(offsetof(AnimationWarpingLibrary_GetCurveValueFromAnimation, ReturnValue) == 0x000014, "Member 'AnimationWarpingLibrary_GetCurveValueFromAnimation::ReturnValue' has a wrong offset!");
