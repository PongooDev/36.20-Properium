...
static_assert(alignof(AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged) == 0x000001, "Wrong alignment on AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged");
static_assert(sizeof(AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged) == 0x000001, "Wrong size on AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged");
static_assert(offsetof(AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged, bInventoryActive) == 0x000000, "Member 'AthenaEquippedItemCraftingIndicator_HandleInventoryActiveChanged::bInventoryActive' has a wrong offset!");
...
static_assert(alignof(AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged) == 0x000001, "Wrong alignment on AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged");
static_assert(sizeof(AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged) == 0x000001, "Wrong size on AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged");
static_assert(offsetof(AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged, bInventoryActive) == 0x000000, "Member 'AthenaQuickBarSlotCraftingIndicator_HandleInventoryActiveChanged::bInventoryActive' has a wrong offset!");
...
static_assert(sizeof(FortCraftingItemInfoWidget_OnItemRaritySet) == 0x000080, "Wrong size on FortCraftingItemInfoWidget_OnItemRaritySet");
