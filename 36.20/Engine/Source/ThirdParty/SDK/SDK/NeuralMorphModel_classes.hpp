...
public:
	...
	EMLDeformerSkinningMode                       SkinningMode;                                      // 0x0088(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UNeuralMorphInputInfo) == 0x000090, "Wrong size on UNeuralMorphInputInfo");
...
static_assert(offsetof(UNeuralMorphInputInfo, SkinningMode) == 0x000088, "Member 'UNeuralMorphInputInfo::SkinningMode' has a wrong offset!");
...
{
public:
	TArray<struct FNeuralMorphBoneGroup>          BoneGroups;                                        // 0x0220(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FNeuralMorphCurveGroup>         CurveGroups;                                       // 0x0230(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, struct FNeuralMorphMaskInfo> BoneMaskInfos;                                     // 0x0240(0x0050)(Deprecated, NativeAccessSpecifierPublic)
	TMap<class FName, struct FNeuralMorphMaskInfo> BoneGroupMaskInfos;                                // 0x0290(0x0050)(Deprecated, NativeAccessSpecifierPublic)
	TMap<class FName, struct FMLDeformerMaskInfo> BoneMaskInfoMap;                                   // 0x02E0(0x0050)(NativeAccessSpecifierPublic)
	TMap<class FName, struct FMLDeformerMaskInfo> BoneGroupMaskInfoMap;                              // 0x0330(0x0050)(NativeAccessSpecifierPublic)
	ENeuralMorphMode                              Mode;                                              // 0x0380(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_381[0x3];                                      // 0x0381(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         LocalNumMorphTargetsPerBone;                       // 0x0384(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         GlobalNumMorphTargets;                             // 0x0388(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         NumIterations;                                     // 0x038C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LocalNumHiddenLayers;                              // 0x0390(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         LocalNumNeuronsPerLayer;                           // 0x0394(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         GlobalNumHiddenLayers;                             // 0x0398(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         GlobalNumNeuronsPerLayer;                          // 0x039C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         BatchSize;                                         // 0x03A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         LearningRate;                                      // 0x03A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RegularizationFactor;                              // 0x03A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableBoneMasks;                                  // 0x03AC(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3AD[0x3];                                      // 0x03AD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SmoothLossBeta;                                    // 0x03B0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EMLDeformerSkinningMode                       SkinningMode;                                      // 0x03B4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_3B5[0x3];                                      // 0x03B5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class UNeuralMorphNetwork*                    NeuralMorphNetwork;                                // 0x03B8(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UNeuralMorphModel) == 0x0003C0, "Wrong size on UNeuralMorphModel");
static_assert(offsetof(UNeuralMorphModel, BoneGroups) == 0x000220, "Member 'UNeuralMorphModel::BoneGroups' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, CurveGroups) == 0x000230, "Member 'UNeuralMorphModel::CurveGroups' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneMaskInfos) == 0x000240, "Member 'UNeuralMorphModel::BoneMaskInfos' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneGroupMaskInfos) == 0x000290, "Member 'UNeuralMorphModel::BoneGroupMaskInfos' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneMaskInfoMap) == 0x0002E0, "Member 'UNeuralMorphModel::BoneMaskInfoMap' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BoneGroupMaskInfoMap) == 0x000330, "Member 'UNeuralMorphModel::BoneGroupMaskInfoMap' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, Mode) == 0x000380, "Member 'UNeuralMorphModel::Mode' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumMorphTargetsPerBone) == 0x000384, "Member 'UNeuralMorphModel::LocalNumMorphTargetsPerBone' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumMorphTargets) == 0x000388, "Member 'UNeuralMorphModel::GlobalNumMorphTargets' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, NumIterations) == 0x00038C, "Member 'UNeuralMorphModel::NumIterations' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumHiddenLayers) == 0x000390, "Member 'UNeuralMorphModel::LocalNumHiddenLayers' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LocalNumNeuronsPerLayer) == 0x000394, "Member 'UNeuralMorphModel::LocalNumNeuronsPerLayer' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumHiddenLayers) == 0x000398, "Member 'UNeuralMorphModel::GlobalNumHiddenLayers' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, GlobalNumNeuronsPerLayer) == 0x00039C, "Member 'UNeuralMorphModel::GlobalNumNeuronsPerLayer' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, BatchSize) == 0x0003A0, "Member 'UNeuralMorphModel::BatchSize' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, LearningRate) == 0x0003A4, "Member 'UNeuralMorphModel::LearningRate' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, RegularizationFactor) == 0x0003A8, "Member 'UNeuralMorphModel::RegularizationFactor' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, bEnableBoneMasks) == 0x0003AC, "Member 'UNeuralMorphModel::bEnableBoneMasks' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, SmoothLossBeta) == 0x0003B0, "Member 'UNeuralMorphModel::SmoothLossBeta' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, SkinningMode) == 0x0003B4, "Member 'UNeuralMorphModel::SkinningMode' has a wrong offset!");
static_assert(offsetof(UNeuralMorphModel, NeuralMorphNetwork) == 0x0003B8, "Member 'UNeuralMorphModel::NeuralMorphNetwork' has a wrong offset!");
