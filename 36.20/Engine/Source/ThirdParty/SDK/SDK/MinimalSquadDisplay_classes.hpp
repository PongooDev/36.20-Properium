...
public:
	...
	class UImage*                                 SquadRibbon;                                       // 0x0338(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
static_assert(sizeof(UMinimalSquadDisplay_C) == 0x000340, "Wrong size on UMinimalSquadDisplay_C");
static_assert(offsetof(UMinimalSquadDisplay_C, UberGraphFrame) == 0x000330, "Member 'UMinimalSquadDisplay_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UMinimalSquadDisplay_C, SquadRibbon) == 0x000338, "Member 'UMinimalSquadDisplay_C::SquadRibbon' has a wrong offset!");
