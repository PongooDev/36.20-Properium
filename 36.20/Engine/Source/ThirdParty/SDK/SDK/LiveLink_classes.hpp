...
{
public:
	struct FLiveLinkSubjectName                   SubjectName;                                       // 0x00B8(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   ActorTransformBone;                                // 0x00BC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(ULiveLinkDrivenComponent, ActorTransformBone) == 0x0000BC, "Member 'ULiveLinkDrivenComponent::ActorTransformBone' has a wrong offset!");
...
{
public:
	class FString                                 SubjectName;                                       // 0x0098(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 OutboundName;                                      // 0x00A8(0x0010)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class FString                                 Source;                                            // 0x00B8(0x0010)(Edit, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class ULiveLinkFrameTranslator*               TranslatorsProxy;                                  // 0x00C8(0x0008)(Edit, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(alignof(ULiveLinkHubSubjectSettings) == 0x000008, "Wrong alignment on ULiveLinkHubSubjectSettings");
static_assert(sizeof(ULiveLinkHubSubjectSettings) == 0x0000D8, "Wrong size on ULiveLinkHubSubjectSettings");
static_assert(offsetof(ULiveLinkHubSubjectSettings, SubjectName) == 0x000098, "Member 'ULiveLinkHubSubjectSettings::SubjectName' has a wrong offset!");
static_assert(offsetof(ULiveLinkHubSubjectSettings, OutboundName) == 0x0000A8, "Member 'ULiveLinkHubSubjectSettings::OutboundName' has a wrong offset!");
static_assert(offsetof(ULiveLinkHubSubjectSettings, Source) == 0x0000B8, "Member 'ULiveLinkHubSubjectSettings::Source' has a wrong offset!");
static_assert(offsetof(ULiveLinkHubSubjectSettings, TranslatorsProxy) == 0x0000C8, "Member 'ULiveLinkHubSubjectSettings::TranslatorsProxy' has a wrong offset!");
...
{
public:
	TSoftObjectPtr<class USkeletalMesh>           ReferenceSkeleton;                                 // 0x0080(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkSkeletonRemapper) == 0x0000B0, "Wrong size on ULiveLinkSkeletonRemapper");
...
public:
	...
	struct FSoftClassPath                         DefaultSettingsClass;                              // 0x0038(0x0018)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSubclassOf<class ULiveLinkFrameInterpolationProcessor> FrameInterpolationProcessor;                       // 0x0050(0x0008)(ZeroConstructor, Config, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class ULiveLinkPreset>         DefaultLiveLinkPreset;                             // 0x0058(0x0020)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bPreProcessRebroadcastFrames;                      // 0x00A0(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTranslateRebroadcastFrames;                       // 0x00A1(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTransmitEvaluatedData;                            // 0x00A2(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(ULiveLinkSettings) == 0x0000D8, "Wrong size on ULiveLinkSettings");
...
static_assert(offsetof(ULiveLinkSettings, FrameInterpolationProcessor) == 0x000050, "Member 'ULiveLinkSettings::FrameInterpolationProcessor' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, DefaultLiveLinkPreset) == 0x000058, "Member 'ULiveLinkSettings::DefaultLiveLinkPreset' has a wrong offset!");
...
static_assert(offsetof(ULiveLinkSettings, bPreProcessRebroadcastFrames) == 0x0000A0, "Member 'ULiveLinkSettings::bPreProcessRebroadcastFrames' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, bTranslateRebroadcastFrames) == 0x0000A1, "Member 'ULiveLinkSettings::bTranslateRebroadcastFrames' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, bTransmitEvaluatedData) == 0x0000A2, "Member 'ULiveLinkSettings::bTransmitEvaluatedData' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, TimeWithoutFrameToBeConsiderAsInvalid) == 0x0000A8, "Member 'ULiveLinkSettings::TimeWithoutFrameToBeConsiderAsInvalid' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, ValidColor) == 0x0000B0, "Member 'ULiveLinkSettings::ValidColor' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, InvalidColor) == 0x0000C0, "Member 'ULiveLinkSettings::InvalidColor' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, TextSizeSource) == 0x0000D0, "Member 'ULiveLinkSettings::TextSizeSource' has a wrong offset!");
static_assert(offsetof(ULiveLinkSettings, TextSizeSubject) == 0x0000D1, "Member 'ULiveLinkSettings::TextSizeSubject' has a wrong offset!");
...
public:
	...
	struct FFrameRate                             OverrideFrameRate;                                 // 0x004C(0x0008)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	class FName                                   SourceName;                                        // 0x00B0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"LiveLinkLocatorAxisSwitchPreProcessor">();
	}
...
static_assert(alignof(ULiveLinkLocatorAxisSwitchPreProcessor) == 0x000008, "Wrong alignment on ULiveLinkLocatorAxisSwitchPreProcessor");
static_assert(sizeof(ULiveLinkLocatorAxisSwitchPreProcessor) == 0x000070, "Wrong size on ULiveLinkLocatorAxisSwitchPreProcessor");
...
{
public:
	class FName                                   OutputBoneName;                                    // 0x0028(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C[0x14];                                      // 0x002C(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
