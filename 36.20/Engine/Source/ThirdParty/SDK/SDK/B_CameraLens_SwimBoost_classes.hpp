...
static_assert(sizeof(AB_CameraLens_SwimBoost_C) == 0x0003A0, "Wrong size on AB_CameraLens_SwimBoost_C");
static_assert(offsetof(AB_CameraLens_SwimBoost_C, UberGraphFrame) == 0x000390, "Member 'AB_CameraLens_SwimBoost_C::UberGraphFrame' has a wrong offset!");
