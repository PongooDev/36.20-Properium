...
struct FMsg
{
	...
	static void SendNotificationStringf(const TCHAR* Fmt, Types... Args)
	{
	...
	/** Log function */
	template <typename... Types>
	static void Logf(const ANSICHAR* File, int32 Line, const FLogCategoryName& Category, ELogVerbosity::Type Verbosity, const TCHAR* Fmt, Types... Args)
	{
	...
	template <typename... Types>
	static void Logf_Internal(const ANSICHAR* File, int32 Line, const FLogCategoryName& Category, ELogVerbosity::Type Verbosity, const TCHAR* Fmt, Types... Args)
	{
