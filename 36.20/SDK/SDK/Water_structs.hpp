...
public:
	...
	TSoftObjectPtr<class UTexture2D>              Texture;                                           // 0x0008(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Midpoint;                                          // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           Channel;                                           // 0x002C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         WeightmapInfluence;                                // 0x003C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWaterBrushEffectDisplacement) == 0x000008, "Wrong alignment on FWaterBrushEffectDisplacement");
static_assert(sizeof(FWaterBrushEffectDisplacement) == 0x000040, "Wrong size on FWaterBrushEffectDisplacement");
...
static_assert(offsetof(FWaterBrushEffectDisplacement, Midpoint) == 0x000028, "Member 'FWaterBrushEffectDisplacement::Midpoint' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffectDisplacement, Channel) == 0x00002C, "Member 'FWaterBrushEffectDisplacement::Channel' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffectDisplacement, WeightmapInfluence) == 0x00003C, "Member 'FWaterBrushEffectDisplacement::WeightmapInfluence' has a wrong offset!");
...
public:
	...
	TSoftObjectPtr<class UTexture2D>              ModulationTexture;                                 // 0x0008(0x0020)(Edit, BlueprintVisible, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TextureTiling;                                     // 0x0028(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         TextureInfluence;                                  // 0x002C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	float                                         FinalOpacity;                                      // 0x0034(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWaterBodyWeightmapSettings) == 0x000008, "Wrong alignment on FWaterBodyWeightmapSettings");
static_assert(sizeof(FWaterBodyWeightmapSettings) == 0x000038, "Wrong size on FWaterBodyWeightmapSettings");
...
static_assert(offsetof(FWaterBodyWeightmapSettings, TextureTiling) == 0x000028, "Member 'FWaterBodyWeightmapSettings::TextureTiling' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, TextureInfluence) == 0x00002C, "Member 'FWaterBodyWeightmapSettings::TextureInfluence' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, Midpoint) == 0x000030, "Member 'FWaterBodyWeightmapSettings::Midpoint' has a wrong offset!");
static_assert(offsetof(FWaterBodyWeightmapSettings, FinalOpacity) == 0x000034, "Member 'FWaterBodyWeightmapSettings::FinalOpacity' has a wrong offset!");
...
public:
	...
	class UMaterialInterface*                     UnderwaterPostProcessMaterial;                     // 0x0770(0x0008)(ZeroConstructor, Deprecated, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FUnderwaterPostProcessSettings) == 0x000780, "Wrong size on FUnderwaterPostProcessSettings");
...
static_assert(offsetof(FUnderwaterPostProcessSettings, UnderwaterPostProcessMaterial) == 0x000770, "Member 'FUnderwaterPostProcessSettings::UnderwaterPostProcessMaterial' has a wrong offset!");
...
public:
	...
	struct FWaterBrushEffectDisplacement          Displacement;                                      // 0x0018(0x0040)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FWaterBrushEffectSmoothBlending        SmoothBlending;                                    // 0x0058(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FWaterBrushEffectTerracing             Terracing;                                         // 0x0060(0x0014)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_74[0x4];                                       // 0x0074(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FWaterBrushEffects) == 0x000008, "Wrong alignment on FWaterBrushEffects");
static_assert(sizeof(FWaterBrushEffects) == 0x000078, "Wrong size on FWaterBrushEffects");
...
static_assert(offsetof(FWaterBrushEffects, SmoothBlending) == 0x000058, "Member 'FWaterBrushEffects::SmoothBlending' has a wrong offset!");
static_assert(offsetof(FWaterBrushEffects, Terracing) == 0x000060, "Member 'FWaterBrushEffects::Terracing' has a wrong offset!");
...
public:
	...
	struct FWaterBrushEffects                     Effects;                                           // 0x0018(0x0078)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          bInvertShape;                                      // 0x0090(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_91[0x3];                                       // 0x0091(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Priority;                                          // 0x0094(0x0004)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FWaterBodyHeightmapSettings) == 0x000008, "Wrong alignment on FWaterBodyHeightmapSettings");
static_assert(sizeof(FWaterBodyHeightmapSettings) == 0x000098, "Wrong size on FWaterBodyHeightmapSettings");
...
static_assert(offsetof(FWaterBodyHeightmapSettings, bInvertShape) == 0x000090, "Member 'FWaterBodyHeightmapSettings::bInvertShape' has a wrong offset!");
static_assert(offsetof(FWaterBodyHeightmapSettings, Priority) == 0x000094, "Member 'FWaterBodyHeightmapSettings::Priority' has a wrong offset!");
