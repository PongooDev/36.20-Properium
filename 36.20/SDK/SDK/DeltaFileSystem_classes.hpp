...
static_assert(sizeof(UDeltaComponent) == 0x0000C8, "Wrong size on UDeltaComponent");
...
static_assert(sizeof(UDeltaFileSaveHandler) == 0x000120, "Wrong size on UDeltaFileSaveHandler");
