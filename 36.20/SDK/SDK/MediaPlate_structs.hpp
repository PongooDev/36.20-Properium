...
public:
	...
	TSoftObjectPtr<class UMediaSource>            MediaAsset;                                        // 0x0018(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSoftObjectPtr<class UMediaPlaylist>          SourcePlaylist;                                    // 0x0038(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FMediaPlateResource) == 0x000008, "Wrong alignment on FMediaPlateResource");
static_assert(sizeof(FMediaPlateResource) == 0x000058, "Wrong size on FMediaPlateResource");
...
static_assert(offsetof(FMediaPlateResource, SourcePlaylist) == 0x000038, "Member 'FMediaPlateResource::SourcePlaylist' has a wrong offset!");
