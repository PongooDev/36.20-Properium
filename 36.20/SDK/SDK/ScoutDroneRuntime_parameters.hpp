...
static_assert(sizeof(FortGameplayAbility_ScoutDrone_SpeedBoost_OnBoostedIntoActor) == 0x0000F8, "Wrong size on FortGameplayAbility_ScoutDrone_SpeedBoost_OnBoostedIntoActor");
...
static_assert(sizeof(FortGameplayAbility_ScoutDrone_SpeedBoost_OnDoorBashed) == 0x000100, "Wrong size on FortGameplayAbility_ScoutDrone_SpeedBoost_OnDoorBashed");
...
static_assert(offsetof(FortGameplayAbility_ScoutDrone_SpeedBoost_OnDoorBashed, BashedDoor) == 0x0000F8, "Member 'FortGameplayAbility_ScoutDrone_SpeedBoost_OnDoorBashed::BashedDoor' has a wrong offset!");
...
static_assert(alignof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange) == 0x000001, "Wrong alignment on FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange");
static_assert(sizeof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange) == 0x000001, "Wrong size on FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange");
static_assert(offsetof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange, bValue) == 0x000000, "Member 'FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInSignalLossRange::bValue' has a wrong offset!");
...
static_assert(alignof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange) == 0x000001, "Wrong alignment on FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange");
static_assert(sizeof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange) == 0x000001, "Wrong size on FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange");
static_assert(offsetof(FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange, bValue) == 0x000000, "Member 'FortGameplayAbility_ScoutDrone_Tether_Client_SetIsInWarningRange::bValue' has a wrong offset!");
...
static_assert(sizeof(FortScoutDrone_OnDamagePlayEffects) == 0x000160, "Wrong size on FortScoutDrone_OnDamagePlayEffects");
...
static_assert(offsetof(FortScoutDrone_OnDamagePlayEffects, InstigatedBy) == 0x000138, "Member 'FortScoutDrone_OnDamagePlayEffects::InstigatedBy' has a wrong offset!");
static_assert(offsetof(FortScoutDrone_OnDamagePlayEffects, DamageCauser) == 0x000140, "Member 'FortScoutDrone_OnDamagePlayEffects::DamageCauser' has a wrong offset!");
static_assert(offsetof(FortScoutDrone_OnDamagePlayEffects, EffectContext) == 0x000148, "Member 'FortScoutDrone_OnDamagePlayEffects::EffectContext' has a wrong offset!");
...
static_assert(sizeof(FortScoutDrone_OnDeathPlayEffects) == 0x000160, "Wrong size on FortScoutDrone_OnDeathPlayEffects");
...
static_assert(offsetof(FortScoutDrone_OnDeathPlayEffects, InstigatedBy) == 0x000138, "Member 'FortScoutDrone_OnDeathPlayEffects::InstigatedBy' has a wrong offset!");
static_assert(offsetof(FortScoutDrone_OnDeathPlayEffects, DamageCauser) == 0x000140, "Member 'FortScoutDrone_OnDeathPlayEffects::DamageCauser' has a wrong offset!");
static_assert(offsetof(FortScoutDrone_OnDeathPlayEffects, EffectContext) == 0x000148, "Member 'FortScoutDrone_OnDeathPlayEffects::EffectContext' has a wrong offset!");
