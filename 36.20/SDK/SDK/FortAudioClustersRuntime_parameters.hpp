...
static_assert(sizeof(GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath) == 0x000160, "Wrong size on GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath");
...
static_assert(offsetof(GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath, InstigatedBy) == 0x000138, "Member 'GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath::InstigatedBy' has a wrong offset!");
static_assert(offsetof(GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath, DamageCauser) == 0x000140, "Member 'GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath::DamageCauser' has a wrong offset!");
static_assert(offsetof(GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath, EffectContext) == 0x000148, "Member 'GameFeatureAction_AddAudioCluster_HandleRegisteredActorDeath::EffectContext' has a wrong offset!");
