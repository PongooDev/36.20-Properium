...
{
public:
	class FName                                   WarpTargetName;                                    // 0x0000(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FAttributeBasedRootMotionComponentPrePhysicsTickFunction) == 0x000030, "Wrong size on FAttributeBasedRootMotionComponentPrePhysicsTickFunction");
...
public:
	...
	EWarpTargetLocationOffsetDirection            LocationOffsetDirection;                           // 0x0045(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TWeakObjectPtr<class AActor>                  AvatarActor;                                       // 0x0078(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FMotionWarpingTarget) == 0x0000D8, "Wrong size on FMotionWarpingTarget");
...
static_assert(offsetof(FMotionWarpingTarget, LocationOffsetDirection) == 0x000045, "Member 'FMotionWarpingTarget::LocationOffsetDirection' has a wrong offset!");
...
static_assert(offsetof(FMotionWarpingTarget, AvatarActor) == 0x000078, "Member 'FMotionWarpingTarget::AvatarActor' has a wrong offset!");
