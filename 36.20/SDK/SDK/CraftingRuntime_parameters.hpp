...
static_assert(sizeof(CraftingObjectBGA_HandleInteractionRangeBeginOverlap) == 0x000118, "Wrong size on CraftingObjectBGA_HandleInteractionRangeBeginOverlap");
...
static_assert(offsetof(FortControllerComponent_CraftingNetworkEvents_ServerStartCrafting, OverriddenObjectStateLength) == 0x000018, "Member 'FortControllerComponent_CraftingNetworkEvents_ServerStartCrafting::OverriddenObjectStateLength' has a wrong offset!");
...
static_assert(offsetof(CraftingLibrary_CanCraftFormula, InInventoryGroups) == 0x000030, "Member 'CraftingLibrary_CanCraftFormula::InInventoryGroups' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_CanCraftFormula, ReturnValue) == 0x000050, "Member 'CraftingLibrary_CanCraftFormula::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(CraftingLibrary_CanCraftFormulaWithAdditionalItems, InInventoryGroups) == 0x000040, "Member 'CraftingLibrary_CanCraftFormulaWithAdditionalItems::InInventoryGroups' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_CanCraftFormulaWithAdditionalItems, ReturnValue) == 0x000060, "Member 'CraftingLibrary_CanCraftFormulaWithAdditionalItems::ReturnValue' has a wrong offset!");

// Function CraftingRuntime.CraftingLibrary.CanCraftFormulaWithParameters
// 0x0078 (0x0078 - 0x0000)
struct CraftingLibrary_CanCraftFormulaWithParameters final
{
public:
	struct FCraftingQueryParameters               Parameters;                                        // 0x0000(0x0060)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	TArray<struct FCraftingIngredientQueryState>  OutIngredientStates;                               // 0x0060(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0070(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_71[0x7];                                       // 0x0071(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(CraftingLibrary_CanCraftFormulaWithParameters) == 0x000008, "Wrong alignment on CraftingLibrary_CanCraftFormulaWithParameters");
static_assert(sizeof(CraftingLibrary_CanCraftFormulaWithParameters) == 0x000078, "Wrong size on CraftingLibrary_CanCraftFormulaWithParameters");
static_assert(offsetof(CraftingLibrary_CanCraftFormulaWithParameters, Parameters) == 0x000000, "Member 'CraftingLibrary_CanCraftFormulaWithParameters::Parameters' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_CanCraftFormulaWithParameters, OutIngredientStates) == 0x000060, "Member 'CraftingLibrary_CanCraftFormulaWithParameters::OutIngredientStates' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_CanCraftFormulaWithParameters, ReturnValue) == 0x000070, "Member 'CraftingLibrary_CanCraftFormulaWithParameters::ReturnValue' has a wrong offset!");
...
// Function CraftingRuntime.CraftingLibrary.GetCraftingDetailsForRowName
// 0x00F8 (0x00F8 - 0x0000)
struct CraftingLibrary_GetCraftingDetailsForRowName final
{
public:
	...
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCraftingFormula                       OutFormulaDetails;                                 // 0x0010(0x00E0)(Parm, OutParm, NativeAccessSpecifierPublic)
	bool                                          bOutFoundDetails;                                  // 0x00F0(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(CraftingLibrary_GetCraftingDetailsForRowName) == 0x000008, "Wrong alignment on CraftingLibrary_GetCraftingDetailsForRowName");
static_assert(sizeof(CraftingLibrary_GetCraftingDetailsForRowName) == 0x0000F8, "Wrong size on CraftingLibrary_GetCraftingDetailsForRowName");
static_assert(offsetof(CraftingLibrary_GetCraftingDetailsForRowName, WorldContextObject) == 0x000000, "Member 'CraftingLibrary_GetCraftingDetailsForRowName::WorldContextObject' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_GetCraftingDetailsForRowName, CraftingFormulaRow) == 0x000008, "Member 'CraftingLibrary_GetCraftingDetailsForRowName::CraftingFormulaRow' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_GetCraftingDetailsForRowName, OutFormulaDetails) == 0x000010, "Member 'CraftingLibrary_GetCraftingDetailsForRowName::OutFormulaDetails' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_GetCraftingDetailsForRowName, bOutFoundDetails) == 0x0000F0, "Member 'CraftingLibrary_GetCraftingDetailsForRowName::bOutFoundDetails' has a wrong offset!");
...
static_assert(offsetof(CraftingLibrary_GetCraftingFormulasForCraftingObject, CraftingObject) == 0x000000, "Member 'CraftingLibrary_GetCraftingFormulasForCraftingObject::CraftingObject' has a wrong offset!");
static_assert(offsetof(CraftingLibrary_GetCraftingFormulasForCraftingObject, OutFormulas) == 0x000008, "Member 'CraftingLibrary_GetCraftingFormulasForCraftingObject::OutFormulas' has a wrong offset!");
...
public:
	class AFortPlayerController*                  Instigator;                                        // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 CraftingObject;                                    // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortItemEntry                         ItemEntryToGrant;                                  // 0x0010(0x0158)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(CraftingLibrary_GiveItemToCraftingObject) == 0x000168, "Wrong size on CraftingLibrary_GiveItemToCraftingObject");
...
static_assert(offsetof(CraftingLibrary_StartCrafting, OverriddenCraftingLength) == 0x000020, "Member 'CraftingLibrary_StartCrafting::OverriddenCraftingLength' has a wrong offset!");

// Function CraftingRuntime.CraftingLibrary.StartCraftingWithParameters
// 0x0038 (0x0038 - 0x0000)
struct CraftingLibrary_StartCraftingWithParameters final
{
public:
	struct FCraftingParameters                    Parameters;                                        // 0x0000(0x0038)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(CraftingLibrary_StartCraftingWithParameters) == 0x000008, "Wrong alignment on CraftingLibrary_StartCraftingWithParameters");
static_assert(sizeof(CraftingLibrary_StartCraftingWithParameters) == 0x000038, "Wrong size on CraftingLibrary_StartCraftingWithParameters");
static_assert(offsetof(CraftingLibrary_StartCraftingWithParameters, Parameters) == 0x000000, "Member 'CraftingLibrary_StartCraftingWithParameters::Parameters' has a wrong offset!");
