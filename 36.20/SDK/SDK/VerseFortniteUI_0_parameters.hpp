...
// Function VerseFortniteUI.VerseFortniteUIAllowedConversionLibrary.Conv_ObjectComparisonToSlateVisibility
// 0x0018 (0x0018 - 0x0000)
struct VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility final
{
public:
	const class UObject*                          ObjectA;                                           // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	const class UObject*                          ObjectB;                                           // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              EqualVisibility;                                   // 0x0010(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESlateVisibility                              UnequalVisibility;                                 // 0x0011(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility) == 0x000008, "Wrong alignment on VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility");
static_assert(sizeof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility) == 0x000018, "Wrong size on VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility");
static_assert(offsetof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility, ObjectA) == 0x000000, "Member 'VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility::ObjectA' has a wrong offset!");
static_assert(offsetof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility, ObjectB) == 0x000008, "Member 'VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility::ObjectB' has a wrong offset!");
static_assert(offsetof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility, EqualVisibility) == 0x000010, "Member 'VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility::EqualVisibility' has a wrong offset!");
static_assert(offsetof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility, UnequalVisibility) == 0x000011, "Member 'VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility::UnequalVisibility' has a wrong offset!");
static_assert(offsetof(VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility, ReturnValue) == 0x000012, "Member 'VerseFortniteUIAllowedConversionLibrary_Conv_ObjectComparisonToSlateVisibility::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FSlateBrush                            ReturnValue;                                       // 0x0030(0x00B0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(VerseFortniteUIAllowedConversionLibrary_MakeImageBrushFromMaterial) == 0x0000E0, "Wrong size on VerseFortniteUIAllowedConversionLibrary_MakeImageBrushFromMaterial");
...
static_assert(sizeof(VerseFortniteUIAllowedConversionLibrary_MakeImageBrushFromTexture) == 0x0000E0, "Wrong size on VerseFortniteUIAllowedConversionLibrary_MakeImageBrushFromTexture");
...
static_assert(offsetof(VerseFortniteUIFrameworkText_Base_ExecuteServerTextCommitted, InCommitMethod) == 0x000010, "Member 'VerseFortniteUIFrameworkText_Base_ExecuteServerTextCommitted::InCommitMethod' has a wrong offset!");
