...
static_assert(sizeof(FRichTextIconData) == 0x000048, "Wrong size on FRichTextIconData");
...
static_assert(offsetof(FRichTextIconData, ImageSize) == 0x000038, "Member 'FRichTextIconData::ImageSize' has a wrong offset!");
