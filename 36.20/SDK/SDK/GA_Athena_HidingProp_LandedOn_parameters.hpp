...
static_assert(offsetof(GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn, CallFunc_GetValueAsBool_ReturnValue) == 0x000004, "Member 'GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn::CallFunc_GetValueAsBool_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn, CallFunc_GetValueAsBool_ReturnValue_1) == 0x0000B8, "Member 'GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn::CallFunc_GetValueAsBool_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn, CallFunc_BooleanAND_ReturnValue) == 0x000170, "Member 'GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn, CallFunc_IsServer_ReturnValue) == 0x000171, "Member 'GA_Athena_HidingProp_LandedOn_C_ExecuteUbergraph_GA_Athena_HidingProp_LandedOn::CallFunc_IsServer_ReturnValue' has a wrong offset!");
