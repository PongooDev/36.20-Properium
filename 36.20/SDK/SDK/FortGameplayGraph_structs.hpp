...
static_assert(offsetof(FSerializableConnectivityGraph_v2, ConnectivityVertexData) == 0x000078, "Member 'FSerializableConnectivityGraph_v2::ConnectivityVertexData' has a wrong offset!");
