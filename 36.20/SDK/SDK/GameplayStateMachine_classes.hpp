...
{
public:
	struct FGameplayStateMachineArray             StateMachineList;                                  // 0x00B8(0x0120)(Net, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayStateMachineManager) == 0x0001D8, "Wrong size on UGameplayStateMachineManager");
static_assert(offsetof(UGameplayStateMachineManager, StateMachineList) == 0x0000B8, "Member 'UGameplayStateMachineManager::StateMachineList' has a wrong offset!");
