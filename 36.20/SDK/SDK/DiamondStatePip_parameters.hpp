...
static_assert(sizeof(DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip) == 0x000030, "Wrong size on DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip");
...
static_assert(offsetof(DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip, CallFunc_PlayAnimationForward_ReturnValue) == 0x000018, "Member 'DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip, K2Node_CustomEvent_IsSelected) == 0x000028, "Member 'DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip::K2Node_CustomEvent_IsSelected' has a wrong offset!");
static_assert(offsetof(DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip, K2Node_CustomEvent_IsHovered) == 0x000029, "Member 'DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip::K2Node_CustomEvent_IsHovered' has a wrong offset!");
static_assert(offsetof(DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip, K2Node_Select_Default) == 0x00002A, "Member 'DiamondStatePip_C_ExecuteUbergraph_DiamondStatePip::K2Node_Select_Default' has a wrong offset!");
