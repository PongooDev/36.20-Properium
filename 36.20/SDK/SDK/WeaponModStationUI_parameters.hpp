...
static_assert(alignof(AthenaWeaponModsWorkbenchModal_OnWeaponEquipped) == 0x000008, "Wrong alignment on AthenaWeaponModsWorkbenchModal_OnWeaponEquipped");
static_assert(sizeof(AthenaWeaponModsWorkbenchModal_OnWeaponEquipped) == 0x000010, "Wrong size on AthenaWeaponModsWorkbenchModal_OnWeaponEquipped");
...
static_assert(offsetof(AthenaWeaponModsWorkbenchModal_OnWeaponEquipped, NewWeapon) == 0x000008, "Member 'AthenaWeaponModsWorkbenchModal_OnWeaponEquipped::NewWeapon' has a wrong offset!");
...
static_assert(alignof(AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP) == 0x000004, "Wrong alignment on AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP");
static_assert(sizeof(AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP) == 0x000004, "Wrong size on AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP");
static_assert(offsetof(AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP, Direction) == 0x000000, "Member 'AthenaWeaponModsWorkbenchModTypeTabs_RequestTabInDirection_BP::Direction' has a wrong offset!");
...
static_assert(offsetof(AthenaWeaponModsWorkbenchWeaponDetails_OnWeaponEquipped, bIsModdable) == 0x000018, "Member 'AthenaWeaponModsWorkbenchWeaponDetails_OnWeaponEquipped::bIsModdable' has a wrong offset!");
...
static_assert(offsetof(AthenaWeaponModsWorkbenchWeaponDetails_SetWeaponType, WeaponTypeTexture) == 0x000010, "Member 'AthenaWeaponModsWorkbenchWeaponDetails_SetWeaponType::WeaponTypeTexture' has a wrong offset!");
static_assert(offsetof(AthenaWeaponModsWorkbenchWeaponDetails_SetWeaponType, bIsValidType) == 0x000018, "Member 'AthenaWeaponModsWorkbenchWeaponDetails_SetWeaponType::bIsValidType' has a wrong offset!");
