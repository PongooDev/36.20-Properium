...
static_assert(sizeof(GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver) == 0x0001A0, "Wrong size on GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver");
...
static_assert(offsetof(GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver, CallFunc_GetActorInfo_ReturnValue) == 0x000148, "Member 'GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver::CallFunc_GetActorInfo_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver, K2Node_DynamicCast_AsFort_Player_Controller_Athena) == 0x000190, "Member 'GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver::K2Node_DynamicCast_AsFort_Player_Controller_Athena' has a wrong offset!");
static_assert(offsetof(GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver, K2Node_DynamicCast_bSuccess_2) == 0x000198, "Member 'GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver::K2Node_DynamicCast_bSuccess_2' has a wrong offset!");
static_assert(offsetof(GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver, CallFunc_IsValid_ReturnValue) == 0x000199, "Member 'GA_DuelObserver_C_ExecuteUbergraph_GA_DuelObserver::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(GA_DuelObserver_C_OnDuelChange) == 0x000070, "Wrong size on GA_DuelObserver_C_OnDuelChange");
