...
static_assert(sizeof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS) == 0x000058, "Wrong size on InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS");
...
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, K2Node_ComponentBoundEvent_bIsOpen) == 0x000028, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::K2Node_ComponentBoundEvent_bIsOpen' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_PlayAnimation_ReturnValue_2) == 0x000030, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_PlayAnimation_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_PlayAnimation_ReturnValue_3) == 0x000040, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_PlayAnimation_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000050, "Member 'InviteListEntry_FriendInvite_XS_C_ExecuteUbergraph_InviteListEntry_FriendInvite_XS::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
