...
{
public:
	TDelegate<void(struct FNiagaraDataChannelUpdateContext& NewDataContext)> UpdateDelegate;                                    // 0x0000(0x000C)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(NiagaraDataChannelHandler_SubscribeToDataChannelUpdates) == 0x000008, "Wrong alignment on NiagaraDataChannelHandler_SubscribeToDataChannelUpdates");
...
public:
	...
	const class UNiagaraDataChannelAsset*         Channel;                                           // 0x0008(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FNiagaraDataChannelSearchParameters    SearchParams;                                      // 0x0010(0x0028)(Parm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TDelegate<void(struct FNiagaraDataChannelUpdateContext& NewDataContext)> UpdateDelegate;                                    // 0x0038(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         UnsubscribeToken;                                  // 0x0044(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(NiagaraDataChannelLibrary_SubscribeToNiagaraDataChannel) == 0x000048, "Wrong size on NiagaraDataChannelLibrary_SubscribeToNiagaraDataChannel");
...
static_assert(offsetof(NiagaraDataChannelLibrary_SubscribeToNiagaraDataChannel, UnsubscribeToken) == 0x000044, "Member 'NiagaraDataChannelLibrary_SubscribeToNiagaraDataChannel::UnsubscribeToken' has a wrong offset!");
...
public:
	class UNiagaraComponent*                      NiagaraSystem;                                     // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   DIName;                                            // 0x0008(0x0004)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ESceneCaptureSource                           ManagedCaptureSource;                              // 0x000C(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D[0x3];                                        // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              ManagedTextureSize;                                // 0x0010(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ETextureRenderTargetFormat                    ManagedTextureFormat;                              // 0x0018(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	ECameraProjectionMode                         ManagedProjectionType;                             // 0x0019(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A[0x2];                                       // 0x001A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ManagedFOVAngle;                                   // 0x001C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ManagedOrthoWidth;                                 // 0x0020(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bManagedCaptureEveryFrame;                         // 0x0024(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bManagedCaptureOnMovement;                         // 0x0025(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_26[0x2];                                       // 0x0026(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class AActor*>                         ShowOnlyActors;                                    // 0x0028(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode) == 0x000038, "Wrong size on NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode");
...
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedCaptureSource) == 0x00000C, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedCaptureSource' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedTextureSize) == 0x000010, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedTextureSize' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedTextureFormat) == 0x000018, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedTextureFormat' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedProjectionType) == 0x000019, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedProjectionType' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedFOVAngle) == 0x00001C, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedFOVAngle' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ManagedOrthoWidth) == 0x000020, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ManagedOrthoWidth' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, bManagedCaptureEveryFrame) == 0x000024, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::bManagedCaptureEveryFrame' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, bManagedCaptureOnMovement) == 0x000025, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::bManagedCaptureOnMovement' has a wrong offset!");
static_assert(offsetof(NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode, ShowOnlyActors) == 0x000028, "Member 'NiagaraFunctionLibrary_SetSceneCapture2DDataInterfaceManagedMode::ShowOnlyActors' has a wrong offset!");
...
public:
	...
	int32                                         FrameIndex;                                        // 0x000C(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(NiagaraSimCache_ReadDataInterfaceAs) == 0x000018, "Wrong size on NiagaraSimCache_ReadDataInterfaceAs");
...
static_assert(offsetof(NiagaraSimCache_ReadDataInterfaceAs, FrameIndex) == 0x00000C, "Member 'NiagaraSimCache_ReadDataInterfaceAs::FrameIndex' has a wrong offset!");
static_assert(offsetof(NiagaraSimCache_ReadDataInterfaceAs, ReturnValue) == 0x000010, "Member 'NiagaraSimCache_ReadDataInterfaceAs::ReturnValue' has a wrong offset!");
