...
static_assert(offsetof(UIFrameworkUserWidget_GetNamedSlot, SlotName) == 0x000000, "Member 'UIFrameworkUserWidget_GetNamedSlot::SlotName' has a wrong offset!");
static_assert(offsetof(UIFrameworkUserWidget_GetNamedSlot, ReturnValue) == 0x000008, "Member 'UIFrameworkUserWidget_GetNamedSlot::ReturnValue' has a wrong offset!");
