...
{
public:
	class FName                                   InUsedGroupName;                                   // 0x0000(0x0004)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(InterchangeEditorSettings_SetUsedGroupName) == 0x000004, "Wrong size on InterchangeEditorSettings_SetUsedGroupName");
...
static_assert(sizeof(InterchangeEditorSettings_GetUsedGroupName) == 0x000004, "Wrong size on InterchangeEditorSettings_GetUsedGroupName");
...
static_assert(sizeof(InterchangeManager_ImportAsset) == 0x0000F0, "Wrong size on InterchangeManager_ImportAsset");
...
static_assert(offsetof(InterchangeManager_ImportAsset, OutImportedObjects) == 0x0000D8, "Member 'InterchangeManager_ImportAsset::OutImportedObjects' has a wrong offset!");
static_assert(offsetof(InterchangeManager_ImportAsset, ReturnValue) == 0x0000E8, "Member 'InterchangeManager_ImportAsset::ReturnValue' has a wrong offset!");
...
public:
	...
	struct FImportAssetParameters                 ImportAssetParameters;                             // 0x0008(0x00C0)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
	TArray<class UObject*>                        OutImportedObjects;                                // 0x00C8(0x0010)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x00D8(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(InterchangeManager_ReimportAsset) == 0x000008, "Wrong alignment on InterchangeManager_ReimportAsset");
static_assert(sizeof(InterchangeManager_ReimportAsset) == 0x0000E0, "Wrong size on InterchangeManager_ReimportAsset");
...
static_assert(offsetof(InterchangeManager_ReimportAsset, OutImportedObjects) == 0x0000C8, "Member 'InterchangeManager_ReimportAsset::OutImportedObjects' has a wrong offset!");
static_assert(offsetof(InterchangeManager_ReimportAsset, ReturnValue) == 0x0000D8, "Member 'InterchangeManager_ReimportAsset::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(InterchangeManager_ScriptedImportAssetAsync) == 0x0000E0, "Wrong size on InterchangeManager_ScriptedImportAssetAsync");
...
static_assert(offsetof(InterchangeManager_ScriptedImportAssetAsync, ReturnValue) == 0x0000D8, "Member 'InterchangeManager_ScriptedImportAssetAsync::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(InterchangeManager_ScriptedImportSceneAsync) == 0x0000E0, "Wrong size on InterchangeManager_ScriptedImportSceneAsync");
...
static_assert(offsetof(InterchangeManager_ScriptedImportSceneAsync, ReturnValue) == 0x0000D8, "Member 'InterchangeManager_ScriptedImportSceneAsync::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(InterchangeManager_ScriptedReimportAssetAsync) == 0x0000D0, "Wrong size on InterchangeManager_ScriptedReimportAssetAsync");
...
static_assert(offsetof(InterchangeManager_ScriptedReimportAssetAsync, ReturnValue) == 0x0000C8, "Member 'InterchangeManager_ScriptedReimportAssetAsync::ReturnValue' has a wrong offset!");
