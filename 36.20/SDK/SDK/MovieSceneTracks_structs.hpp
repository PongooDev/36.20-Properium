...
static_assert(sizeof(FMovieSceneDirectorBlueprintConditionPayloadVariable) == 0x000028, "Wrong size on FMovieSceneDirectorBlueprintConditionPayloadVariable");
...
static_assert(offsetof(FMovieSceneDirectorBlueprintConditionPayloadVariable, Value) == 0x000018, "Member 'FMovieSceneDirectorBlueprintConditionPayloadVariable::Value' has a wrong offset!");
...
static_assert(alignof(FMovieSceneMixedAnimationTarget) == 0x000008, "Wrong alignment on FMovieSceneMixedAnimationTarget");
...
static_assert(sizeof(FBaseParameterNameAndValue) == 0x000004, "Wrong size on FBaseParameterNameAndValue");
...
public:
	...
	class FName                                   SlotName;                                          // 0x0024(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                          bLinearPlaybackWhenScaled;                         // 0x0143(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(FMovieSceneSkeletalAnimationParams, bLinearPlaybackWhenScaled) == 0x000143, "Member 'FMovieSceneSkeletalAnimationParams::bLinearPlaybackWhenScaled' has a wrong offset!");
...
{
public:
	class FName                                   MaterialSlotName;                                  // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	EComponentMaterialType                        MaterialType;                                      // 0x0008(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
