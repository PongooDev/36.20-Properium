...
public:
	...
	class FName                                   Name;                                              // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMetaSoundPageSettings) == 0x000004, "Wrong alignment on FMetaSoundPageSettings");
static_assert(sizeof(FMetaSoundPageSettings) == 0x000014, "Wrong size on FMetaSoundPageSettings");
...
public:
	struct FGuid                                  UniqueID;                                          // 0x0000(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   Name;                                              // 0x0010(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FPerPlatformInt                        SampleRate;                                        // 0x0014(0x0004)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	struct FPerPlatformFloat                      BlockRate;                                         // 0x0018(0x0004)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMetaSoundQualitySettings) == 0x000004, "Wrong alignment on FMetaSoundQualitySettings");
static_assert(sizeof(FMetaSoundQualitySettings) == 0x00001C, "Wrong size on FMetaSoundQualitySettings");
...
static_assert(offsetof(FMetaSoundQualitySettings, SampleRate) == 0x000014, "Member 'FMetaSoundQualitySettings::SampleRate' has a wrong offset!");
static_assert(offsetof(FMetaSoundQualitySettings, BlockRate) == 0x000018, "Member 'FMetaSoundQualitySettings::BlockRate' has a wrong offset!");
