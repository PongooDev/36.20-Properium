...
// 0x0000 (0x0028 - 0x0028)
class IInterchangeVolumePayloadInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IInterchangeVolumePayloadInterface) == 0x000008, "Wrong alignment on IInterchangeVolumePayloadInterface");
static_assert(sizeof(IInterchangeVolumePayloadInterface) == 0x000028, "Wrong size on IInterchangeVolumePayloadInterface");
