...
{
public:
	TSoftClassPtr<class UClass>                   AnimPreset;                                        // 0x00B8(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAnimPresetComponent) == 0x0000D8, "Wrong size on UAnimPresetComponent");
static_assert(offsetof(UAnimPresetComponent, AnimPreset) == 0x0000B8, "Member 'UAnimPresetComponent::AnimPreset' has a wrong offset!");
...
static_assert(sizeof(UGameFeatureAction_AnimPreset) == 0x000048, "Wrong size on UGameFeatureAction_AnimPreset");
