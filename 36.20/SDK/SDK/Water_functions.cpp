...
void UWaterBodyComponent::SetAudioIntensityAtSplineInputKey(float InKey, float InAudioIntensity)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetAudioIntensityAtSplineInputKey");
...
void UWaterBodyComponent::SetWaterInfoMaterial(class UMaterialInterface* InMaterial)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetWaterInfoMaterial");
...
void UWaterBodyComponent::SetWaterVelocityAtSplineInputKey(float InKey, float InVelocity)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetWaterVelocityAtSplineInputKey");
...
class UMaterialInterface* UWaterBodyComponent::GetRiverToLakeTransitionMaterial() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiverToLakeTransitionMaterial");
...
class UMaterialInterface* UWaterBodyComponent::GetRiverToOceanTransitionMaterial() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiverToOceanTransitionMaterial");
...
void UWaterBodyRiverComponent::SetRiverDepthAtSplineInputKey(float InKey, float InDepth)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetRiverDepthAtSplineInputKey");
...
void UWaterBodyRiverComponent::SetRiverWidthAtSplineInputKey(float InKey, float InWidth)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetRiverWidthAtSplineInputKey");
...
float UWaterBodyRiverComponent::GetRiverDepthAtSplineInputKey(float InKey) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiverDepthAtSplineInputKey");
...
float UWaterBodyRiverComponent::GetRiverWidthAtSplineInputKey(float InKey) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetRiverWidthAtSplineInputKey");
