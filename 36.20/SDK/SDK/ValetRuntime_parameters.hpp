...
static_assert(alignof(FortDagwoodVehicle_BoostCameraFoVRumble) == 0x000008, "Wrong alignment on FortDagwoodVehicle_BoostCameraFoVRumble");
static_assert(sizeof(FortDagwoodVehicle_BoostCameraFoVRumble) == 0x000020, "Wrong size on FortDagwoodVehicle_BoostCameraFoVRumble");
static_assert(offsetof(FortDagwoodVehicle_BoostCameraFoVRumble, bReverse) == 0x000000, "Member 'FortDagwoodVehicle_BoostCameraFoVRumble::bReverse' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_BoostCameraFoVRumble, LatentInfo) == 0x000008, "Member 'FortDagwoodVehicle_BoostCameraFoVRumble::LatentInfo' has a wrong offset!");
...
static_assert(alignof(FortDagwoodVehicle_BoostEmissiveTween) == 0x000001, "Wrong alignment on FortDagwoodVehicle_BoostEmissiveTween");
static_assert(sizeof(FortDagwoodVehicle_BoostEmissiveTween) == 0x000001, "Wrong size on FortDagwoodVehicle_BoostEmissiveTween");
static_assert(offsetof(FortDagwoodVehicle_BoostEmissiveTween, bTurnOn) == 0x000000, "Member 'FortDagwoodVehicle_BoostEmissiveTween::bTurnOn' has a wrong offset!");

// Function ValetRuntime.FortDagwoodVehicle.BP_OnServerMove
// 0x0004 (0x0004 - 0x0000)
struct FortDagwoodVehicle_BP_OnServerMove final
{
public:
	float                                         MoveDist;                                          // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FortDagwoodVehicle_BP_OnServerMove) == 0x000004, "Wrong alignment on FortDagwoodVehicle_BP_OnServerMove");
static_assert(sizeof(FortDagwoodVehicle_BP_OnServerMove) == 0x000004, "Wrong size on FortDagwoodVehicle_BP_OnServerMove");
static_assert(offsetof(FortDagwoodVehicle_BP_OnServerMove, MoveDist) == 0x000000, "Member 'FortDagwoodVehicle_BP_OnServerMove::MoveDist' has a wrong offset!");
...
static_assert(alignof(FortDagwoodVehicle_NativePlayCollisionHitFX) == 0x000008, "Wrong alignment on FortDagwoodVehicle_NativePlayCollisionHitFX");
static_assert(sizeof(FortDagwoodVehicle_NativePlayCollisionHitFX) == 0x000060, "Wrong size on FortDagwoodVehicle_NativePlayCollisionHitFX");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitFX, HitActor) == 0x000000, "Member 'FortDagwoodVehicle_NativePlayCollisionHitFX::HitActor' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitFX, HitLocation) == 0x000008, "Member 'FortDagwoodVehicle_NativePlayCollisionHitFX::HitLocation' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitFX, HitNormal) == 0x000020, "Member 'FortDagwoodVehicle_NativePlayCollisionHitFX::HitNormal' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitFX, HitMagnitude) == 0x000038, "Member 'FortDagwoodVehicle_NativePlayCollisionHitFX::HitMagnitude' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitFX, HitFXConfig) == 0x000040, "Member 'FortDagwoodVehicle_NativePlayCollisionHitFX::HitFXConfig' has a wrong offset!");
...
static_assert(alignof(FortDagwoodVehicle_NativePlayCollisionHitHaptics) == 0x000008, "Wrong alignment on FortDagwoodVehicle_NativePlayCollisionHitHaptics");
static_assert(sizeof(FortDagwoodVehicle_NativePlayCollisionHitHaptics) == 0x000060, "Wrong size on FortDagwoodVehicle_NativePlayCollisionHitHaptics");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitHaptics, ValidPlayerControllers) == 0x000000, "Member 'FortDagwoodVehicle_NativePlayCollisionHitHaptics::ValidPlayerControllers' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitHaptics, HitMagnitude) == 0x000010, "Member 'FortDagwoodVehicle_NativePlayCollisionHitHaptics::HitMagnitude' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_NativePlayCollisionHitHaptics, HapticsConfig) == 0x000018, "Member 'FortDagwoodVehicle_NativePlayCollisionHitHaptics::HapticsConfig' has a wrong offset!");
...
static_assert(alignof(FortDagwoodVehicle_SetNativeCollisionHitFxConfig) == 0x000008, "Wrong alignment on FortDagwoodVehicle_SetNativeCollisionHitFxConfig");
static_assert(sizeof(FortDagwoodVehicle_SetNativeCollisionHitFxConfig) == 0x000020, "Wrong size on FortDagwoodVehicle_SetNativeCollisionHitFxConfig");
static_assert(offsetof(FortDagwoodVehicle_SetNativeCollisionHitFxConfig, InCollisionHitFxConfig) == 0x000000, "Member 'FortDagwoodVehicle_SetNativeCollisionHitFxConfig::InCollisionHitFxConfig' has a wrong offset!");
...
static_assert(alignof(FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig) == 0x000008, "Wrong alignment on FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig");
static_assert(sizeof(FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig) == 0x000048, "Wrong size on FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig");
static_assert(offsetof(FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig, InCollisionHapticsConfig) == 0x000000, "Member 'FortDagwoodVehicle_SetNativeCollisionHitHapticsConfig::InCollisionHapticsConfig' has a wrong offset!");
...
{
public:
	EVehicleWheelAndTireNiagaraParams             Flag;                                              // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FortDagwoodVehicle_SetWheelAndTireParam) == 0x000001, "Wrong alignment on FortDagwoodVehicle_SetWheelAndTireParam");
static_assert(sizeof(FortDagwoodVehicle_SetWheelAndTireParam) == 0x000002, "Wrong size on FortDagwoodVehicle_SetWheelAndTireParam");
static_assert(offsetof(FortDagwoodVehicle_SetWheelAndTireParam, Flag) == 0x000000, "Member 'FortDagwoodVehicle_SetWheelAndTireParam::Flag' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_SetWheelAndTireParam, bEnable) == 0x000001, "Member 'FortDagwoodVehicle_SetWheelAndTireParam::bEnable' has a wrong offset!");

// Function ValetRuntime.FortDagwoodVehicle.BP_ShouldBlockInteractForSeat
// 0x0008 (0x0008 - 0x0000)
struct FortDagwoodVehicle_BP_ShouldBlockInteractForSeat final
{
public:
...
static_assert(alignof(FortDagwoodVehicle_BP_ShouldBlockInteractForSeat) == 0x000004, "Wrong alignment on FortDagwoodVehicle_BP_ShouldBlockInteractForSeat");
static_assert(sizeof(FortDagwoodVehicle_BP_ShouldBlockInteractForSeat) == 0x000008, "Wrong size on FortDagwoodVehicle_BP_ShouldBlockInteractForSeat");
static_assert(offsetof(FortDagwoodVehicle_BP_ShouldBlockInteractForSeat, SeatIndex) == 0x000000, "Member 'FortDagwoodVehicle_BP_ShouldBlockInteractForSeat::SeatIndex' has a wrong offset!");
static_assert(offsetof(FortDagwoodVehicle_BP_ShouldBlockInteractForSeat, ReturnValue) == 0x000004, "Member 'FortDagwoodVehicle_BP_ShouldBlockInteractForSeat::ReturnValue' has a wrong offset!");
