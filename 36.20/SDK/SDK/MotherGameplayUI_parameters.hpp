...
static_assert(offsetof(FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged, PropIndex) == 0x000010, "Member 'FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged::PropIndex' has a wrong offset!");
static_assert(offsetof(FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged, MaxPropCount) == 0x000014, "Member 'FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged::MaxPropCount' has a wrong offset!");
static_assert(offsetof(FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged, CategoryIndex) == 0x000018, "Member 'FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged::CategoryIndex' has a wrong offset!");
static_assert(offsetof(FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged, MaxCategoryCount) == 0x00001C, "Member 'FortPaddleGingerReticleExtensionWidget_OnPropIndexChanged::MaxCategoryCount' has a wrong offset!");
