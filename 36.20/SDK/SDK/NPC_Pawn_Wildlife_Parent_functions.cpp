...
void ANPC_Pawn_Wildlife_Parent_C::ApplyVariation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("ApplyVariation");
...
void ANPC_Pawn_Wildlife_Parent_C::On_Customization_Applied(TScriptInterface<class ICustomCharacterPartOwnerInterface> Value)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("On Customization Applied");
...
void ANPC_Pawn_Wildlife_Parent_C::On_NPC_PawnInteractedWith(class AActor* AIPawn, class AFortPlayerPawn* InteractingPlayerPawn, EInteractionBeingAttempted InteractionBeingAttempted)
{
	static class UFunction* Func = nullptr;
...
void ANPC_Pawn_Wildlife_Parent_C::SetColorVariation()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetColorVariation");
