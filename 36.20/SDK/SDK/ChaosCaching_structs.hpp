...
static_assert(alignof(FBreakingEvent) == 0x000010, "Wrong alignment on FBreakingEvent");
...
static_assert(alignof(FTrailingEvent) == 0x000010, "Wrong alignment on FTrailingEvent");
