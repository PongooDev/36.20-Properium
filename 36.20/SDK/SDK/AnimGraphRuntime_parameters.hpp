...
public:
	...
	bool                                          bShouldStopAllMontages;                            // 0x001C(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(PlayMontageCallbackProxy_CreateProxyObjectForPlayMontage, bShouldStopAllMontages) == 0x00001C, "Member 'PlayMontageCallbackProxy_CreateProxyObjectForPlayMontage::bShouldStopAllMontages' has a wrong offset!");
