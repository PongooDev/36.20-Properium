...
void UFortEventMoreInfoModal::OnKeyArtLoaded(const class UObject* Icon)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnKeyArtLoaded");
...
// Function EventScreenBase.FortEventScreenBase.OnExitPremiumUpsellScreen
// (Event, Protected, BlueprintEvent)

void UFortEventScreenBase::OnExitPremiumUpsellScreen()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnExitPremiumUpsellScreen");
...
// Function EventScreenBase.FortEventScreenBase.OnShowPremiumUpsellScreen
// (Event, Protected, BlueprintEvent)

void UFortEventScreenBase::OnShowPremiumUpsellScreen()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnShowPremiumUpsellScreen");
...
// Parameters:
// EEventScreenView                        View                                                   (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortEventScreenBase::SetCurrentView(const EEventScreenView View)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("SetCurrentView");

	Params::FortEventScreenBase_SetCurrentView Parms{};
...
class AFortItemPreviewWorld* UFortEventScreenBase::GetVaultWorld() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetVaultWorld");
