...
public:
	...
	struct FLiveLinkSubjectName                   ParentSubject;                                     // 0x00A8(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	class FName                                   OriginalSourceName;                                // 0x006C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLiveLinkSubjectKey                    Key;                                               // 0x0070(0x0014)(NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_84[0xC];                                       // 0x0084(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bAllowModifyingRebroadcast;                        // 0x0090(0x0001)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(ULiveLinkSubjectSettings, Key) == 0x000070, "Member 'ULiveLinkSubjectSettings::Key' has a wrong offset!");
static_assert(offsetof(ULiveLinkSubjectSettings, bAllowModifyingRebroadcast) == 0x000090, "Member 'ULiveLinkSubjectSettings::bAllowModifyingRebroadcast' has a wrong offset!");
