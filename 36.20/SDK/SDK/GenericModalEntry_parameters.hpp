...
static_assert(sizeof(GenericModalEntry_C_ExecuteUbergraph_GenericModalEntry) == 0x000020, "Wrong size on GenericModalEntry_C_ExecuteUbergraph_GenericModalEntry");
...
static_assert(offsetof(GenericModalEntry_C_ExecuteUbergraph_GenericModalEntry, K2Node_Event_IsDesignTime) == 0x000018, "Member 'GenericModalEntry_C_ExecuteUbergraph_GenericModalEntry::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(sizeof(GenericModalEntry_C_SetText) == 0x000010, "Wrong size on GenericModalEntry_C_SetText");
