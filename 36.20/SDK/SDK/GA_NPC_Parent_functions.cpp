...
struct FHitResult UGA_NPC_Parent_C::NPC_ModifyHitResultToObeyMinimumYawForKnockback(const struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("NPC ModifyHitResultToObeyMinimumYawForKnockback");

	Params::GA_NPC_Parent_C_NPC_ModifyHitResultToObeyMinimumYawForKnockback Parms{};
