...
public:
	...
	uint8                                         Pad_88[0xA0];                                      // 0x0088(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bRemoveInvalidatedUserFromMaps;                    // 0x0128(0x0001)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_129[0x3];                                      // 0x0129(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	TWeakObjectPtr<class ULocalPlayer>            LocalPlayerOwner;                                  // 0x012C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_134[0x1E4];                                    // 0x0134(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USocialToolkit) == 0x000318, "Wrong size on USocialToolkit");
...
static_assert(offsetof(USocialToolkit, bRemoveInvalidatedUserFromMaps) == 0x000128, "Member 'USocialToolkit::bRemoveInvalidatedUserFromMaps' has a wrong offset!");
static_assert(offsetof(USocialToolkit, LocalPlayerOwner) == 0x00012C, "Member 'USocialToolkit::LocalPlayerOwner' has a wrong offset!");
