...
public:
	...
	class UWidgetAnimation*                       Opened;                                            // 0x04A8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, RepSkip, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ULeavePartyConfirmationMenu_C) == 0x0004B0, "Wrong size on ULeavePartyConfirmationMenu_C");
static_assert(offsetof(ULeavePartyConfirmationMenu_C, UberGraphFrame) == 0x0004A0, "Member 'ULeavePartyConfirmationMenu_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ULeavePartyConfirmationMenu_C, Opened) == 0x0004A8, "Member 'ULeavePartyConfirmationMenu_C::Opened' has a wrong offset!");
