...
{
public:
	class UImagePlateComponent*                   ImagePlate;                                        // 0x02A8(0x0008)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AImagePlate) == 0x0002B0, "Wrong size on AImagePlate");
static_assert(offsetof(AImagePlate, ImagePlate) == 0x0002A8, "Member 'AImagePlate::ImagePlate' has a wrong offset!");
...
{
public:
	struct FImagePlateParameters                  Plate;                                             // 0x0518(0x0040)(Edit, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_558[0x118];                                    // 0x0558(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
