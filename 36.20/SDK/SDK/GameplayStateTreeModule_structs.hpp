...
static_assert(sizeof(FStateTreeGetActorLocationPropertyFunction) == 0x000018, "Wrong size on FStateTreeGetActorLocationPropertyFunction");
...
static_assert(sizeof(FStateTreeAIConditionBase) == 0x000020, "Wrong size on FStateTreeAIConditionBase");
...
static_assert(sizeof(FStateTreeRunEnvQueryTask) == 0x000020, "Wrong size on FStateTreeRunEnvQueryTask");
