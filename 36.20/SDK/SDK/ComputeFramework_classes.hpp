...
static_assert(sizeof(UComputeGraphComponent) == 0x0000D8, "Wrong size on UComputeGraphComponent");
static_assert(offsetof(UComputeGraphComponent, ComputeGraph) == 0x0000B8, "Member 'UComputeGraphComponent::ComputeGraph' has a wrong offset!");
static_assert(offsetof(UComputeGraphComponent, ComputeGraphInstance) == 0x0000C0, "Member 'UComputeGraphComponent::ComputeGraphInstance' has a wrong offset!");
