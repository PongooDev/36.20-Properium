...
public:
	...
	TArray<class UAudioComponent*>                Components;                                        // 0x0288(0x0010)(Edit, ExportObject, ZeroConstructor, EditConst, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	...
	uint8                                         Pad_2C8[0x120];                                    // 0x02C8(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAudioComponentGroup) == 0x0003F0, "Wrong size on UAudioComponentGroup");
static_assert(offsetof(UAudioComponentGroup, OnStopped) == 0x000248, "Member 'UAudioComponentGroup::OnStopped' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnKilled) == 0x000258, "Member 'UAudioComponentGroup::OnKilled' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnVirtualized) == 0x000268, "Member 'UAudioComponentGroup::OnVirtualized' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, OnUnvirtualized) == 0x000278, "Member 'UAudioComponentGroup::OnUnvirtualized' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, Components) == 0x000288, "Member 'UAudioComponentGroup::Components' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, ParamsToSet) == 0x000298, "Member 'UAudioComponentGroup::ParamsToSet' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, PersistentParams) == 0x0002A8, "Member 'UAudioComponentGroup::PersistentParams' has a wrong offset!");
static_assert(offsetof(UAudioComponentGroup, Extensions) == 0x0002B8, "Member 'UAudioComponentGroup::Extensions' has a wrong offset!");
...
static_assert(sizeof(UAudioGameplayComponent) == 0x0000C0, "Wrong size on UAudioGameplayComponent");
...
static_assert(sizeof(UAudioParameterComponent) == 0x0000F0, "Wrong size on UAudioParameterComponent");
static_assert(offsetof(UAudioParameterComponent, ActiveComponents) == 0x0000D0, "Member 'UAudioParameterComponent::ActiveComponents' has a wrong offset!");
static_assert(offsetof(UAudioParameterComponent, Parameters) == 0x0000E0, "Member 'UAudioParameterComponent::Parameters' has a wrong offset!");
