...
static_assert(alignof(UDataflowDebugDrawComponent) == 0x000010, "Wrong alignment on UDataflowDebugDrawComponent");
static_assert(sizeof(UDataflowDebugDrawComponent) == 0x000580, "Wrong size on UDataflowDebugDrawComponent");

// Class DataflowEngine.DataflowInstanceInterface
// 0x0000 (0x0028 - 0x0028)
class IDataflowInstanceInterface final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IDataflowInstanceInterface) == 0x000008, "Wrong alignment on IDataflowInstanceInterface");
static_assert(sizeof(IDataflowInstanceInterface) == 0x000028, "Wrong size on IDataflowInstanceInterface");
