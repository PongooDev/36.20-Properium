...
public:
	...
	class USceneComponent*                        PinataSceneRoot;                                   // 0x02B0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AStorePinataMaster_Parent_C) == 0x0002B8, "Wrong size on AStorePinataMaster_Parent_C");
static_assert(offsetof(AStorePinataMaster_Parent_C, UberGraphFrame) == 0x0002A8, "Member 'AStorePinataMaster_Parent_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AStorePinataMaster_Parent_C, PinataSceneRoot) == 0x0002B0, "Member 'AStorePinataMaster_Parent_C::PinataSceneRoot' has a wrong offset!");
