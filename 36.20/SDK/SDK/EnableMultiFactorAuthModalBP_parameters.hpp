...
public:
	...
	bool                                          K2Node_Event_bIncentivized;                        // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_Event_NewButtonText;                        // 0x0050(0x0010)(ConstParm)
	class UIconTextButton_C*                      K2Node_DynamicCast_AsIcon_Text_Button;             // 0x0060(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   K2Node_Event_UniquePlayerURLText;                  // 0x0070(0x0010)(ConstParm)
	bool                                          K2Node_Event_bIsConsole;                           // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bUsingGamepad;                        // 0x0081(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_IsMobileGame_ReturnValue) == 0x000004, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_Event_IsDesignTime) == 0x000005, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_TextToUpper_ReturnValue) == 0x000018, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_TextToUpper_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_PlayAnimation_ReturnValue) == 0x000028, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_Event_bIncentivized) == 0x000038, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_Event_bIncentivized' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_GetEndTime_ReturnValue) == 0x00003C, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_GetEndTime_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_PlayAnimation_ReturnValue_1) == 0x000040, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_PlayAnimation_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_DynamicCast_AsIcon_Text_Button) == 0x000060, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_DynamicCast_AsIcon_Text_Button' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_DynamicCast_bSuccess) == 0x000068, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_Event_UniquePlayerURLText) == 0x000070, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_Event_UniquePlayerURLText' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_Event_bIsConsole) == 0x000080, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_Event_bIsConsole' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, K2Node_Event_bUsingGamepad) == 0x000081, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::K2Node_Event_bUsingGamepad' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_SpawnSound2D_ReturnValue) == 0x000088, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_SpawnSound2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP, CallFunc_Delay_Duration_ImplicitCast) == 0x000090, "Member 'EnableMultiFactorAuthModalBP_C_ExecuteUbergraph_EnableMultiFactorAuthModalBP::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(EnableMultiFactorAuthModalBP_C_OnConsoleDisplayURLProvided) == 0x000010, "Wrong size on EnableMultiFactorAuthModalBP_C_OnConsoleDisplayURLProvided");
...
static_assert(sizeof(EnableMultiFactorAuthModalBP_C_OnSetExitButtonText) == 0x000010, "Wrong size on EnableMultiFactorAuthModalBP_C_OnSetExitButtonText");
