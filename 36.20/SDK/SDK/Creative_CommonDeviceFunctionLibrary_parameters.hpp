...
public:
	...
	EAwardScoreType                               Temp_byte_Variable;                                // 0x0058(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AController*                            CallFunc_GetParticipantControllerFromActor_Controller; // 0x0068(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UFortMinigameManager*                   CallFunc_GetMinigameManager_ReturnValue;           // 0x0070(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTagContainer                  CallFunc_GetSourceAndContextTags_OutSourceTags;    // 0x0078(0x0020)()
	struct FGameplayTagContainer                  CallFunc_GetSourceAndContextTags_OutContextTags;   // 0x0098(0x0020)()
	class UFortMinigameStatsComponent*            CallFunc_GetMinigameStatsComponent_ReturnValue;    // 0x00B8(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	class UFortMinigameStatFilter*                CallFunc_GetLoadedStatFromClass_ReturnValue;       // 0x00D0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetStatForPlayer_ReturnValue;             // 0x00D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_AwardScore) == 0x0000E8, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_AwardScore");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, Temp_byte_Variable) == 0x000058, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x000059, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_IsValid_ReturnValue) == 0x000060, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_Multiply_IntInt_ReturnValue) == 0x000064, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_Multiply_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetParticipantControllerFromActor_Controller) == 0x000068, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetParticipantControllerFromActor_Controller' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetMinigameManager_ReturnValue) == 0x000070, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetMinigameManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetSourceAndContextTags_OutSourceTags) == 0x000078, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetSourceAndContextTags_OutSourceTags' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetSourceAndContextTags_OutContextTags) == 0x000098, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetSourceAndContextTags_OutContextTags' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetMinigameStatsComponent_ReturnValue) == 0x0000B8, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetMinigameStatsComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_DynamicCast_AsFort_Player_State) == 0x0000C0, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_DynamicCast_AsFort_Player_State' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_DynamicCast_bSuccess) == 0x0000C8, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_IsValid_ReturnValue_1) == 0x0000C9, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetLoadedStatFromClass_ReturnValue) == 0x0000D0, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetLoadedStatFromClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_GetStatForPlayer_ReturnValue) == 0x0000D8, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_GetStatForPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_IsValid_ReturnValue_2) == 0x0000DC, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, CallFunc_Subtract_IntInt_ReturnValue) == 0x0000E0, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_AwardScore, K2Node_Select_Default) == 0x0000E4, "Member 'Creative_CommonDeviceFunctionLibrary_C_AwardScore::K2Node_Select_Default' has a wrong offset!");
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_Current_Material_Matches_Base) == 0x000088, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_Current_Material_Matches_Base");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Current_Material_Matches_Base, CallFunc_EqualEqual_ObjectObject_ReturnValue) == 0x000080, "Member 'Creative_CommonDeviceFunctionLibrary_C_Current_Material_Matches_Base::CallFunc_EqualEqual_ObjectObject_ReturnValue' has a wrong offset!");
...
public:
	...
	ECreativeTeamColor                            Temp_byte_Variable;                                // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_39[0x7];                                       // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	ECreativeTeamColor                            Temp_byte_Variable_1;                              // 0x0049(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECreativeTeamColor                            Temp_byte_Variable_2;                              // 0x004A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         CallFunc_MakeLiteralByte_ReturnValue;              // 0x004B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortTeamAffiliation                          Temp_byte_Variable_3;                              // 0x004C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortTeamAffiliation                          CallFunc_GetTeamAffiliation_ReturnValue;           // 0x004D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         CallFunc_GetActorPvPTeamIndex_TeamIndex;           // 0x004E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetActorPvPTeamIndex_ReturnValue;         // 0x004F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         CallFunc_Add_ByteByte_ReturnValue;                 // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ECreativeTeamColor                            K2Node_Select_Default;                             // 0x0051(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_GetTeamColorIndex_ReturnValue;            // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color) == 0x000060, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, Temp_byte_Variable) == 0x000038, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_GetFirstLocalFortPlayerController_ReturnValue) == 0x000040, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_GetFirstLocalFortPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, K2Node_SwitchEnum_CmpSuccess) == 0x000048, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, Temp_byte_Variable_1) == 0x000049, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, Temp_byte_Variable_2) == 0x00004A, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_MakeLiteralByte_ReturnValue) == 0x00004B, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_MakeLiteralByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, Temp_byte_Variable_3) == 0x00004C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_GetTeamAffiliation_ReturnValue) == 0x00004D, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_GetTeamAffiliation_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_GetActorPvPTeamIndex_TeamIndex) == 0x00004E, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_GetActorPvPTeamIndex_TeamIndex' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_GetActorPvPTeamIndex_ReturnValue) == 0x00004F, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_GetActorPvPTeamIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_Add_ByteByte_ReturnValue) == 0x000050, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_Add_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, K2Node_Select_Default) == 0x000051, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_Conv_ByteToInt_ReturnValue) == 0x000054, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_Conv_ByteToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color, CallFunc_GetTeamColorIndex_ReturnValue) == 0x000058, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Dynamic_Team_Color::CallFunc_GetTeamColorIndex_ReturnValue' has a wrong offset!");
...
public:
	...
	class AFortPlayerState*                       PurposelyInvalidPlayerState;                       // 0x0040(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue; // 0x00A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, PurposelyInvalidPlayerState) == 0x000040, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::PurposelyInvalidPlayerState' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_GetGameState_ReturnValue) == 0x000048, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_GetGameState_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, Temp_int_Array_Index_Variable) == 0x000050, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_IsValid_ReturnValue) == 0x000054, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_Array_Length_ReturnValue) == 0x00006C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, Temp_int_Loop_Counter_Variable) == 0x0000A0, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue) == 0x0000A4, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_Less_IntInt_ReturnValue) == 0x0000A5, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID, CallFunc_Add_IntInt_ReturnValue) == 0x0000A8, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_PlayerState_from_NetID::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	struct FGameplayTag                           CallFunc_Array_Get_Item;                           // 0x0070(0x0004)(NoDestructor, HasGetValueTypeHash)
	...
	int32                                         CallFunc_Get_Dynamic_Team_Color_Array_Index;       // 0x0088(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Get_Dynamic_Team_Color_Array_Index_1;     // 0x008C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_GameplayTag_ReturnValue_1;     // 0x0091(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_MatchesTag_ReturnValue;                   // 0x0092(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagContainer                  CallFunc_BP_GetOwnedGameplayTags_ReturnValue;      // 0x00B0(0x0020)()
};
...
static_assert(sizeof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag) == 0x0000D0, "Wrong size on Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag");
...
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, Temp_struct_Variable) == 0x000038, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_BreakGameplayTagContainer_GameplayTags) == 0x000058, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_BreakGameplayTagContainer_GameplayTags' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, Temp_int_Array_Index_Variable) == 0x000068, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, Temp_int_Loop_Counter_Variable) == 0x00006C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Array_Get_Item) == 0x000070, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Subtract_IntInt_ReturnValue) == 0x000074, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x000078, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Array_Length_ReturnValue) == 0x00007C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Subtract_IntInt_ReturnValue_1) == 0x000080, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Subtract_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Max_ReturnValue) == 0x000084, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Max_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Get_Dynamic_Team_Color_Array_Index) == 0x000088, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Get_Dynamic_Team_Color_Array_Index' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_Get_Dynamic_Team_Color_Array_Index_1) == 0x00008C, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_Get_Dynamic_Team_Color_Array_Index_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_EqualEqual_GameplayTag_ReturnValue) == 0x000090, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_EqualEqual_GameplayTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_EqualEqual_GameplayTag_ReturnValue_1) == 0x000091, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_EqualEqual_GameplayTag_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_MatchesTag_ReturnValue) == 0x000092, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_MatchesTag_ReturnValue' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface) == 0x000098, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::K2Node_DynamicCast_AsGameplay_Tag_Asset_Interface' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, K2Node_DynamicCast_bSuccess) == 0x0000A8, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag, CallFunc_BP_GetOwnedGameplayTags_ReturnValue) == 0x0000B0, "Member 'Creative_CommonDeviceFunctionLibrary_C_Get_Team_Color_Index_from_Tag::CallFunc_BP_GetOwnedGameplayTags_ReturnValue' has a wrong offset!");
