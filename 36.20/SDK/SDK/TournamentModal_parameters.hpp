...
static_assert(sizeof(TournamentModal_C_ExecuteUbergraph_TournamentModal) == 0x000040, "Wrong size on TournamentModal_C_ExecuteUbergraph_TournamentModal");
...
static_assert(offsetof(TournamentModal_C_ExecuteUbergraph_TournamentModal, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000038, "Member 'TournamentModal_C_ExecuteUbergraph_TournamentModal::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
