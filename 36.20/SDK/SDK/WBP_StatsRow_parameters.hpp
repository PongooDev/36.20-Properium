...
static_assert(offsetof(WBP_StatsRow_C_SetBlocksData, RatioText) == 0x000018, "Member 'WBP_StatsRow_C_SetBlocksData::RatioText' has a wrong offset!");
static_assert(offsetof(WBP_StatsRow_C_SetBlocksData, Temp_int_Variable) == 0x000028, "Member 'WBP_StatsRow_C_SetBlocksData::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_StatsRow_C_SetBlocksData, K2Node_Select_Default) == 0x000030, "Member 'WBP_StatsRow_C_SetBlocksData::K2Node_Select_Default' has a wrong offset!");
...
static_assert(offsetof(WBP_StatsRow_C_SetBlockTemplate, RatioTextFormat_0) == 0x000018, "Member 'WBP_StatsRow_C_SetBlockTemplate::RatioTextFormat_0' has a wrong offset!");
static_assert(offsetof(WBP_StatsRow_C_SetBlockTemplate, IconTexture) == 0x000028, "Member 'WBP_StatsRow_C_SetBlockTemplate::IconTexture' has a wrong offset!");
static_assert(offsetof(WBP_StatsRow_C_SetBlockTemplate, Temp_int_Variable) == 0x000030, "Member 'WBP_StatsRow_C_SetBlockTemplate::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(WBP_StatsRow_C_SetBlockTemplate, K2Node_Select_Default) == 0x000038, "Member 'WBP_StatsRow_C_SetBlockTemplate::K2Node_Select_Default' has a wrong offset!");
