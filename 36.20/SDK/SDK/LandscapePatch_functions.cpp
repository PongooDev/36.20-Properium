...
const TArray<class FString> ULandscapePatchComponent::GetLayerOptions()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetLayerOptions");
...
class UTexture* ULandscapeTexturePatch::GetWeightPatchTextureAsset(const class FName& InWeightmapLayerName)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("GetWeightPatchTextureAsset");

	Params::LandscapeTexturePatch_GetWeightPatchTextureAsset Parms{};
...
void ULandscapeTexturePatch::RequestReinitializeHeight()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RequestReinitializeHeight");
...
void ULandscapeTexturePatch::RequestReinitializeWeights()
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RequestReinitializeWeights");
...
void ULandscapeTexturePatch::SetFalloffMode(ELandscapeTexturePatchFalloffMode FalloffModeIn)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetFalloffMode");
