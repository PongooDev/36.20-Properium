...
// Parameters:
// struct FVector2D                        InGrainDurationRangeSeconds                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UScrubbedSound::SetGrainDurationRange(const struct FVector2D& InGrainDurationRangeSeconds)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetGrainDurationRange");
...
void UScrubbedSound::SetIsScrubbing(bool bInIsScrubbing)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsScrubbing");
...
void UScrubbedSound::SetIsScrubbingWhileStationary(bool bInScrubWhileStationary)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetIsScrubbingWhileStationary");
...
float UScrubbedSound::GetPlayheadTime() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetPlayheadTime");
...
void UQuartzSubsystem::SetQuartzSubsystemTickableWhenPaused(const bool bInTickableWhenPaused)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetQuartzSubsystemTickableWhenPaused");
