...
public:
	...
	class AFortGameplayEffectDeliveryActor*       LightningBolt;                                     // 0x0050(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class AActor*>                         TargetActors;                                      // 0x0058(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class AFortPawn*>                      TargetPawns;                                       // 0x0068(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_78[0x8];                                       // 0x0078(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FTempestLightningBoltData) == 0x000008, "Wrong alignment on FTempestLightningBoltData");
static_assert(sizeof(FTempestLightningBoltData) == 0x000080, "Wrong size on FTempestLightningBoltData");
...
static_assert(offsetof(FTempestLightningBoltData, LightningBolt) == 0x000050, "Member 'FTempestLightningBoltData::LightningBolt' has a wrong offset!");
static_assert(offsetof(FTempestLightningBoltData, TargetActors) == 0x000058, "Member 'FTempestLightningBoltData::TargetActors' has a wrong offset!");
static_assert(offsetof(FTempestLightningBoltData, TargetPawns) == 0x000068, "Member 'FTempestLightningBoltData::TargetPawns' has a wrong offset!");
