...
static_assert(alignof(FMDeviceCable_OnCablePortsUpdated) == 0x000001, "Wrong alignment on FMDeviceCable_OnCablePortsUpdated");
static_assert(sizeof(FMDeviceCable_OnCablePortsUpdated) == 0x000001, "Wrong size on FMDeviceCable_OnCablePortsUpdated");
static_assert(offsetof(FMDeviceCable_OnCablePortsUpdated, CurrentPortDataType) == 0x000000, "Member 'FMDeviceCable_OnCablePortsUpdated::CurrentPortDataType' has a wrong offset!");
...
static_assert(offsetof(FMDeviceCable_SetDeviceCableHeadScale, Scale) == 0x000000, "Member 'FMDeviceCable_SetDeviceCableHeadScale::Scale' has a wrong offset!");
...
static_assert(offsetof(FMDeviceCableAnimatorFloatProvider_OnFloatChanged, FloatProvider) == 0x000008, "Member 'FMDeviceCableAnimatorFloatProvider_OnFloatChanged::FloatProvider' has a wrong offset!");
...
static_assert(offsetof(FMDeviceCableAnimatorFloatProvider_SetFloatProviders, InFloatProviders) == 0x000000, "Member 'FMDeviceCableAnimatorFloatProvider_SetFloatProviders::InFloatProviders' has a wrong offset!");
...
static_assert(offsetof(FMDeviceCableControllerComponent_ClientPortUpdatesRejected, PortChangeInfos) == 0x000000, "Member 'FMDeviceCableControllerComponent_ClientPortUpdatesRejected::PortChangeInfos' has a wrong offset!");
...
static_assert(alignof(FMDeviceCableControllerComponent_OnEmoteStarted) == 0x000008, "Wrong alignment on FMDeviceCableControllerComponent_OnEmoteStarted");
static_assert(sizeof(FMDeviceCableControllerComponent_OnEmoteStarted) == 0x000010, "Wrong size on FMDeviceCableControllerComponent_OnEmoteStarted");
static_assert(offsetof(FMDeviceCableControllerComponent_OnEmoteStarted, MontageItemDef) == 0x000000, "Member 'FMDeviceCableControllerComponent_OnEmoteStarted::MontageItemDef' has a wrong offset!");
static_assert(offsetof(FMDeviceCableControllerComponent_OnEmoteStarted, PawnEmoting) == 0x000008, "Member 'FMDeviceCableControllerComponent_OnEmoteStarted::PawnEmoting' has a wrong offset!");
...
static_assert(offsetof(FMDeviceCableControllerComponent_OnFortPawnChanged, NewPawn) == 0x000000, "Member 'FMDeviceCableControllerComponent_OnFortPawnChanged::NewPawn' has a wrong offset!");
...
// Function FMDeviceCablesRuntime.FMDeviceCablePortComponent.OnFabricGlobalSystemChanged
// 0x0010 (0x0010 - 0x0000)
struct FMDeviceCablePortComponent_OnFabricGlobalSystemChanged final
{
public:
...
static_assert(alignof(FMDeviceCablePortComponent_OnFabricGlobalSystemChanged) == 0x000008, "Wrong alignment on FMDeviceCablePortComponent_OnFabricGlobalSystemChanged");
static_assert(sizeof(FMDeviceCablePortComponent_OnFabricGlobalSystemChanged) == 0x000010, "Wrong size on FMDeviceCablePortComponent_OnFabricGlobalSystemChanged");
static_assert(offsetof(FMDeviceCablePortComponent_OnFabricGlobalSystemChanged, OldGlobalSystem) == 0x000000, "Member 'FMDeviceCablePortComponent_OnFabricGlobalSystemChanged::OldGlobalSystem' has a wrong offset!");
static_assert(offsetof(FMDeviceCablePortComponent_OnFabricGlobalSystemChanged, GlobalSystem) == 0x000008, "Member 'FMDeviceCablePortComponent_OnFabricGlobalSystemChanged::GlobalSystem' has a wrong offset!");
...
static_assert(alignof(FMDeviceCablePortComponent_SetCablesHidden) == 0x000001, "Wrong alignment on FMDeviceCablePortComponent_SetCablesHidden");
static_assert(sizeof(FMDeviceCablePortComponent_SetCablesHidden) == 0x000001, "Wrong size on FMDeviceCablePortComponent_SetCablesHidden");
static_assert(offsetof(FMDeviceCablePortComponent_SetCablesHidden, bNewHidden) == 0x000000, "Member 'FMDeviceCablePortComponent_SetCablesHidden::bNewHidden' has a wrong offset!");
...
static_assert(alignof(FMDeviceCablePortComponent_SetConnectedCablesHidden) == 0x000001, "Wrong alignment on FMDeviceCablePortComponent_SetConnectedCablesHidden");
static_assert(sizeof(FMDeviceCablePortComponent_SetConnectedCablesHidden) == 0x000001, "Wrong size on FMDeviceCablePortComponent_SetConnectedCablesHidden");
static_assert(offsetof(FMDeviceCablePortComponent_SetConnectedCablesHidden, bNewHidden) == 0x000000, "Member 'FMDeviceCablePortComponent_SetConnectedCablesHidden::bNewHidden' has a wrong offset!");
...
static_assert(alignof(FMDeviceCablePortComponent_UpdateCableHiddenState) == 0x000008, "Wrong alignment on FMDeviceCablePortComponent_UpdateCableHiddenState");
static_assert(sizeof(FMDeviceCablePortComponent_UpdateCableHiddenState) == 0x000008, "Wrong size on FMDeviceCablePortComponent_UpdateCableHiddenState");
static_assert(offsetof(FMDeviceCablePortComponent_UpdateCableHiddenState, OtherPort) == 0x000000, "Member 'FMDeviceCablePortComponent_UpdateCableHiddenState::OtherPort' has a wrong offset!");
...
static_assert(alignof(FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort) == 0x000008, "Wrong alignment on FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort");
static_assert(sizeof(FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort) == 0x000010, "Wrong size on FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort");
static_assert(offsetof(FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort, OtherPort) == 0x000000, "Member 'FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort::OtherPort' has a wrong offset!");
static_assert(offsetof(FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort, bNewHidden) == 0x000008, "Member 'FMDeviceCablePortComponent_UpdateCableHiddenStateForConnectedPort::bNewHidden' has a wrong offset!");
