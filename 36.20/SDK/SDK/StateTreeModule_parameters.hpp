...
static_assert(alignof(StateTreeFunctionLibrary_K2_GetParametersProperty) == 0x000008, "Wrong alignment on StateTreeFunctionLibrary_K2_GetParametersProperty");
...
static_assert(alignof(StateTreeFunctionLibrary_K2_SetParametersProperty) == 0x000008, "Wrong alignment on StateTreeFunctionLibrary_K2_SetParametersProperty");
...
public:
	...
	TDelegate<void()>                             Delegate;                                          // 0x0014(0x000C)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(StateTreeTaskBlueprintBase_BindDelegate) == 0x000020, "Wrong size on StateTreeTaskBlueprintBase_BindDelegate");
...
static_assert(alignof(StateTreeTaskBlueprintBase_BroadcastDelegate) == 0x000004, "Wrong alignment on StateTreeTaskBlueprintBase_BroadcastDelegate");
...
static_assert(alignof(StateTreeTaskBlueprintBase_ReceiveStateCompleted) == 0x000004, "Wrong alignment on StateTreeTaskBlueprintBase_ReceiveStateCompleted");
...
static_assert(alignof(StateTreeTaskBlueprintBase_UnbindDelegate) == 0x000004, "Wrong alignment on StateTreeTaskBlueprintBase_UnbindDelegate");
