...
static_assert(sizeof(RigVM_Execute) == 0x000248, "Wrong size on RigVM_Execute");
...
static_assert(offsetof(RigVM_Execute, ReturnValue) == 0x000244, "Member 'RigVM_Execute::ReturnValue' has a wrong offset!");
...
{
public:
	class FName                                   InTagName;                                         // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
