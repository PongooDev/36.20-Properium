...
static_assert(alignof(FWidgetAnimationHandle) == 0x000008, "Wrong alignment on FWidgetAnimationHandle");
...
{
public:
	class FName                                   TargetName;                                        // 0x0000(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FMovieSceneDynamicBinding              DynamicBinding;                                    // 0x0020(0x0028)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FWidgetAnimationBinding) == 0x000008, "Wrong alignment on FWidgetAnimationBinding");
static_assert(sizeof(FWidgetAnimationBinding) == 0x000048, "Wrong size on FWidgetAnimationBinding");
...
static_assert(offsetof(FWidgetAnimationBinding, DynamicBinding) == 0x000020, "Member 'FWidgetAnimationBinding::DynamicBinding' has a wrong offset!");
