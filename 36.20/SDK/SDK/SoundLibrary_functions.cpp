...
bool USoundLibraryComponent::StopAllEvents()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("StopAllEvents");

	Params::SoundLibraryComponent_StopAllEvents Parms{};
...
// (RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct FGameplayTagContainer            InEventNames                                           (Parm, NativeAccessSpecifierPublic)
// bool                                    ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool USoundLibraryComponent::StopMultipleEvents(const struct FGameplayTagContainer& InEventNames)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("StopMultipleEvents");

	Params::SoundLibraryComponent_StopMultipleEvents Parms{};
