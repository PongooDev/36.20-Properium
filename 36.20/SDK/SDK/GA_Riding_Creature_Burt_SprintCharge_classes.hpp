...
static_assert(sizeof(UGA_Riding_Creature_Burt_SprintCharge_C) == 0x000B70, "Wrong size on UGA_Riding_Creature_Burt_SprintCharge_C");
static_assert(offsetof(UGA_Riding_Creature_Burt_SprintCharge_C, UberGraphFrame) == 0x000B68, "Member 'UGA_Riding_Creature_Burt_SprintCharge_C::UberGraphFrame' has a wrong offset!");
