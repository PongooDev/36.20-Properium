...
static_assert(alignof(TargetingSelectionTask_AOE_GetSourceRotationOffset) == 0x000008, "Wrong alignment on TargetingSelectionTask_AOE_GetSourceRotationOffset");
static_assert(sizeof(TargetingSelectionTask_AOE_GetSourceRotationOffset) == 0x000020, "Wrong size on TargetingSelectionTask_AOE_GetSourceRotationOffset");
static_assert(offsetof(TargetingSelectionTask_AOE_GetSourceRotationOffset, TargetingHandle) == 0x000000, "Member 'TargetingSelectionTask_AOE_GetSourceRotationOffset::TargetingHandle' has a wrong offset!");
static_assert(offsetof(TargetingSelectionTask_AOE_GetSourceRotationOffset, ReturnValue) == 0x000008, "Member 'TargetingSelectionTask_AOE_GetSourceRotationOffset::ReturnValue' has a wrong offset!");
