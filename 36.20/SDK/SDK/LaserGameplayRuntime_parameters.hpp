...
static_assert(alignof(BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated) == 0x000008, "Wrong alignment on BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated");
static_assert(sizeof(BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated) == 0x000010, "Wrong size on BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated");
static_assert(offsetof(BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated, NewLaserGridConnections) == 0x000000, "Member 'BuildingGameplayActorLaserGrid_CosmeticLaserConnectionsUpdated::NewLaserGridConnections' has a wrong offset!");
...
static_assert(sizeof(BuildingGameplayActorLaserGrid_HandleLaserCollisionOverlap) == 0x000118, "Wrong size on BuildingGameplayActorLaserGrid_HandleLaserCollisionOverlap");
