...
static_assert(alignof(FDelMarEnvironmentVFX) == 0x000008, "Wrong alignment on FDelMarEnvironmentVFX");
static_assert(sizeof(FDelMarEnvironmentVFX) == 0x000018, "Wrong size on FDelMarEnvironmentVFX");
static_assert(offsetof(FDelMarEnvironmentVFX, OnAppliedFX) == 0x000000, "Member 'FDelMarEnvironmentVFX::OnAppliedFX' has a wrong offset!");
static_assert(offsetof(FDelMarEnvironmentVFX, WhileAppliedFX) == 0x000008, "Member 'FDelMarEnvironmentVFX::WhileAppliedFX' has a wrong offset!");
static_assert(offsetof(FDelMarEnvironmentVFX, OnRemovedFX) == 0x000010, "Member 'FDelMarEnvironmentVFX::OnRemovedFX' has a wrong offset!");
...
static_assert(alignof(FDelMarAITrackDecision) == 0x000004, "Wrong alignment on FDelMarAITrackDecision");
static_assert(sizeof(FDelMarAITrackDecision) == 0x000010, "Wrong size on FDelMarAITrackDecision");
static_assert(offsetof(FDelMarAITrackDecision, Track) == 0x000000, "Member 'FDelMarAITrackDecision::Track' has a wrong offset!");
...
// ScriptStruct DelMarCore.DriveHazardInfo
// 0x00D0 (0x00D0 - 0x0000)
struct alignas(0x10) FDriveHazardInfo final
{
public:
	...
	TWeakObjectPtr<class UDelMarTrackSplineComponent> HazardTrackSplineComponent;                        // 0x0008(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10[0xC0];                                      // 0x0010(0x00C0)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDriveHazardInfo) == 0x000010, "Wrong alignment on FDriveHazardInfo");
static_assert(sizeof(FDriveHazardInfo) == 0x0000D0, "Wrong size on FDriveHazardInfo");
static_assert(offsetof(FDriveHazardInfo, Actor) == 0x000000, "Member 'FDriveHazardInfo::Actor' has a wrong offset!");
static_assert(offsetof(FDriveHazardInfo, HazardTrackSplineComponent) == 0x000008, "Member 'FDriveHazardInfo::HazardTrackSplineComponent' has a wrong offset!");

// ScriptStruct DelMarCore.AvoidanceInfo
// 0x0090 (0x0090 - 0x0000)
struct alignas(0x08) FAvoidanceInfo final
{
public:
	uint8                                         Pad_0[0x90];                                       // 0x0000(0x0090)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FAvoidanceInfo) == 0x000008, "Wrong alignment on FAvoidanceInfo");
static_assert(sizeof(FAvoidanceInfo) == 0x000090, "Wrong size on FAvoidanceInfo");
...
static_assert(offsetof(FDelMarCosmeticSlotInfo, ShortDescription) == 0x000018, "Member 'FDelMarCosmeticSlotInfo::ShortDescription' has a wrong offset!");
static_assert(offsetof(FDelMarCosmeticSlotInfo, bCanBeEmpty) == 0x000028, "Member 'FDelMarCosmeticSlotInfo::bCanBeEmpty' has a wrong offset!");
static_assert(offsetof(FDelMarCosmeticSlotInfo, UnassignedPreviewImage) == 0x000030, "Member 'FDelMarCosmeticSlotInfo::UnassignedPreviewImage' has a wrong offset!");
...
{
public:
	struct FHitResult                             Hit;                                               // 0x0000(0x00F8)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	uint8                                         Pad_F8[0x8];                                       // 0x00F8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FQuat                                  VehicleLandingRotation;                            // 0x0100(0x0020)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bValidLandingRotation;                             // 0x0120(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bDriveableSurfaceHit;                              // 0x0121(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_122[0x2];                                      // 0x0122(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SuctionVelocityUsed;                               // 0x0124(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         ElapsedTime;                                       // 0x0128(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         DistanceTravelled;                                 // 0x012C(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarKickflipSimulationResult) == 0x000010, "Wrong alignment on FDelMarKickflipSimulationResult");
static_assert(sizeof(FDelMarKickflipSimulationResult) == 0x000130, "Wrong size on FDelMarKickflipSimulationResult");
...
static_assert(offsetof(FDelMarKickflipSimulationResult, VehicleLandingRotation) == 0x000100, "Member 'FDelMarKickflipSimulationResult::VehicleLandingRotation' has a wrong offset!");
static_assert(offsetof(FDelMarKickflipSimulationResult, bValidLandingRotation) == 0x000120, "Member 'FDelMarKickflipSimulationResult::bValidLandingRotation' has a wrong offset!");
static_assert(offsetof(FDelMarKickflipSimulationResult, bDriveableSurfaceHit) == 0x000121, "Member 'FDelMarKickflipSimulationResult::bDriveableSurfaceHit' has a wrong offset!");
static_assert(offsetof(FDelMarKickflipSimulationResult, SuctionVelocityUsed) == 0x000124, "Member 'FDelMarKickflipSimulationResult::SuctionVelocityUsed' has a wrong offset!");
static_assert(offsetof(FDelMarKickflipSimulationResult, ElapsedTime) == 0x000128, "Member 'FDelMarKickflipSimulationResult::ElapsedTime' has a wrong offset!");
static_assert(offsetof(FDelMarKickflipSimulationResult, DistanceTravelled) == 0x00012C, "Member 'FDelMarKickflipSimulationResult::DistanceTravelled' has a wrong offset!");
...
// ScriptStruct DelMarCore.DelMarEvent_MatchmakingReadyUp
// 0x0008 (0x0008 - 0x0000)
struct FDelMarEvent_MatchmakingReadyUp final
{
public:
...
static_assert(alignof(FDelMarEvent_MatchmakingReadyUp) == 0x000004, "Wrong alignment on FDelMarEvent_MatchmakingReadyUp");
static_assert(sizeof(FDelMarEvent_MatchmakingReadyUp) == 0x000008, "Wrong size on FDelMarEvent_MatchmakingReadyUp");
static_assert(offsetof(FDelMarEvent_MatchmakingReadyUp, LocalPlayer) == 0x000000, "Member 'FDelMarEvent_MatchmakingReadyUp::LocalPlayer' has a wrong offset!");
...
static_assert(offsetof(FDelMarEvent_SetTutorialHint, GamepadText) == 0x000010, "Member 'FDelMarEvent_SetTutorialHint::GamepadText' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialHint, TouchText) == 0x000020, "Member 'FDelMarEvent_SetTutorialHint::TouchText' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialHint, DisplayTime) == 0x000030, "Member 'FDelMarEvent_SetTutorialHint::DisplayTime' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialHint, Priority) == 0x000034, "Member 'FDelMarEvent_SetTutorialHint::Priority' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialHint, AssociatedInputActions) == 0x000038, "Member 'FDelMarEvent_SetTutorialHint::AssociatedInputActions' has a wrong offset!");
...
static_assert(offsetof(FDelMarEvent_SetTutorialAnnouncement, GamepadText) == 0x000010, "Member 'FDelMarEvent_SetTutorialAnnouncement::GamepadText' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialAnnouncement, TouchText) == 0x000020, "Member 'FDelMarEvent_SetTutorialAnnouncement::TouchText' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_SetTutorialAnnouncement, AssociatedInputActions) == 0x000030, "Member 'FDelMarEvent_SetTutorialAnnouncement::AssociatedInputActions' has a wrong offset!");
...
static_assert(offsetof(FDelMarEvent_SetControlsText, GamepadText) == 0x000010, "Member 'FDelMarEvent_SetControlsText::GamepadText' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class ADelMarCheckpoint>       CurrentCheckPoint;                                 // 0x0008(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FDelMarEvent_CheckpointPassed_ParallelPath) == 0x000018, "Wrong size on FDelMarEvent_CheckpointPassed_ParallelPath");
static_assert(offsetof(FDelMarEvent_CheckpointPassed_ParallelPath, PlayerState) == 0x000000, "Member 'FDelMarEvent_CheckpointPassed_ParallelPath::PlayerState' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_CheckpointPassed_ParallelPath, CurrentCheckPoint) == 0x000008, "Member 'FDelMarEvent_CheckpointPassed_ParallelPath::CurrentCheckPoint' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_CheckpointPassed_ParallelPath, CheckpointIndexForLap) == 0x000010, "Member 'FDelMarEvent_CheckpointPassed_ParallelPath::CheckpointIndexForLap' has a wrong offset!");
...
static_assert(alignof(FDelMarVerbMessage_LapStarted) == 0x000008, "Wrong alignment on FDelMarVerbMessage_LapStarted");
static_assert(sizeof(FDelMarVerbMessage_LapStarted) == 0x000138, "Wrong size on FDelMarVerbMessage_LapStarted");
...
static_assert(alignof(FDelMarEvent_LapStarted) == 0x000008, "Wrong alignment on FDelMarEvent_LapStarted");
static_assert(sizeof(FDelMarEvent_LapStarted) == 0x000008, "Wrong size on FDelMarEvent_LapStarted");
static_assert(offsetof(FDelMarEvent_LapStarted, PlayerState) == 0x000000, "Member 'FDelMarEvent_LapStarted::PlayerState' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_AutoUpright, MaxWorldContactDegreeThreshold) == 0x000000, "Member 'FDelMarVehicleConfigOverride_AutoUpright::MaxWorldContactDegreeThreshold' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_WorldBonusSpeed, WorldBonusSpeedActors) == 0x000018, "Member 'FDelMarVehicleConfig_WorldBonusSpeed::WorldBonusSpeedActors' has a wrong offset!");
...
// ScriptStruct DelMarCore.DelMarEvent_QuestScreenOpened
// 0x000C (0x000C - 0x0000)
struct FDelMarEvent_QuestScreenOpened final
{
public:
	TWeakObjectPtr<class AFortPlayerState>        PlayerState;                                       // 0x0000(0x0008)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           RaceState;                                         // 0x0008(0x0004)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarEvent_QuestScreenOpened) == 0x000004, "Wrong alignment on FDelMarEvent_QuestScreenOpened");
static_assert(sizeof(FDelMarEvent_QuestScreenOpened) == 0x00000C, "Wrong size on FDelMarEvent_QuestScreenOpened");
static_assert(offsetof(FDelMarEvent_QuestScreenOpened, PlayerState) == 0x000000, "Member 'FDelMarEvent_QuestScreenOpened::PlayerState' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_QuestScreenOpened, RaceState) == 0x000008, "Member 'FDelMarEvent_QuestScreenOpened::RaceState' has a wrong offset!");
...
// ScriptStruct DelMarCore.DelMarEvent_QuestScreenClosed
// 0x0008 (0x0008 - 0x0000)
struct FDelMarEvent_QuestScreenClosed final
{
public:
	float                                         OpenedDuration;                                    // 0x0000(0x0004)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           RaceState;                                         // 0x0004(0x0004)(Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarEvent_QuestScreenClosed) == 0x000004, "Wrong alignment on FDelMarEvent_QuestScreenClosed");
static_assert(sizeof(FDelMarEvent_QuestScreenClosed) == 0x000008, "Wrong size on FDelMarEvent_QuestScreenClosed");
static_assert(offsetof(FDelMarEvent_QuestScreenClosed, OpenedDuration) == 0x000000, "Member 'FDelMarEvent_QuestScreenClosed::OpenedDuration' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_QuestScreenClosed, RaceState) == 0x000004, "Member 'FDelMarEvent_QuestScreenClosed::RaceState' has a wrong offset!");
...
static_assert(alignof(FDelMarGameplayModifierList) == 0x000008, "Wrong alignment on FDelMarGameplayModifierList");
static_assert(sizeof(FDelMarGameplayModifierList) == 0x000010, "Wrong size on FDelMarGameplayModifierList");
static_assert(offsetof(FDelMarGameplayModifierList, Modifiers) == 0x000000, "Member 'FDelMarGameplayModifierList::Modifiers' has a wrong offset!");
...
static_assert(alignof(FDelMarObjectiveFilter_Demolished) == 0x000008, "Wrong alignment on FDelMarObjectiveFilter_Demolished");
static_assert(sizeof(FDelMarObjectiveFilter_Demolished) == 0x000190, "Wrong size on FDelMarObjectiveFilter_Demolished");
...
// ScriptStruct DelMarCore.DelMarCurveFloat
// 0x0010 (0x0010 - 0x0000)
struct FDelMarCurveFloat final
{
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveFloat*                            Curve;                                             // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarCurveFloat) == 0x000008, "Wrong alignment on FDelMarCurveFloat");
static_assert(sizeof(FDelMarCurveFloat) == 0x000010, "Wrong size on FDelMarCurveFloat");
static_assert(offsetof(FDelMarCurveFloat, Scale) == 0x000000, "Member 'FDelMarCurveFloat::Scale' has a wrong offset!");
static_assert(offsetof(FDelMarCurveFloat, Curve) == 0x000008, "Member 'FDelMarCurveFloat::Curve' has a wrong offset!");
...
static_assert(alignof(FDelMarObjectiveFilter_JellyHit) == 0x000008, "Wrong alignment on FDelMarObjectiveFilter_JellyHit");
static_assert(sizeof(FDelMarObjectiveFilter_JellyHit) == 0x000190, "Wrong size on FDelMarObjectiveFilter_JellyHit");
...
static_assert(sizeof(FDelMarVehicleCollisionConfig) == 0x0001F8, "Wrong size on FDelMarVehicleCollisionConfig");
...
static_assert(offsetof(FDelMarVehicleCollisionConfig, MinGroundedDemolitionSpeed) == 0x0001D4, "Member 'FDelMarVehicleCollisionConfig::MinGroundedDemolitionSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, MinAerialDemolitionSpeed) == 0x0001D8, "Member 'FDelMarVehicleCollisionConfig::MinAerialDemolitionSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, MaxGroundedDemolitionAngleDegrees) == 0x0001DC, "Member 'FDelMarVehicleCollisionConfig::MaxGroundedDemolitionAngleDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, MaxAerialDemolitionAngleDegrees) == 0x0001E0, "Member 'FDelMarVehicleCollisionConfig::MaxAerialDemolitionAngleDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, ParallelCollisionThresholdDegrees) == 0x0001E4, "Member 'FDelMarVehicleCollisionConfig::ParallelCollisionThresholdDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, HeadOnCollisionThresholdDegrees) == 0x0001E8, "Member 'FDelMarVehicleCollisionConfig::HeadOnCollisionThresholdDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, BumperToBumperThresholdDegrees) == 0x0001EC, "Member 'FDelMarVehicleCollisionConfig::BumperToBumperThresholdDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, ContactNormalToVehicleRightThresholdDegrees) == 0x0001F0, "Member 'FDelMarVehicleCollisionConfig::ContactNormalToVehicleRightThresholdDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleCollisionConfig, TrackTraceChannel) == 0x0001F4, "Member 'FDelMarVehicleCollisionConfig::TrackTraceChannel' has a wrong offset!");
...
static_assert(alignof(FDelMarObjectiveFilter_LapStarted) == 0x000008, "Wrong alignment on FDelMarObjectiveFilter_LapStarted");
static_assert(sizeof(FDelMarObjectiveFilter_LapStarted) == 0x000190, "Wrong size on FDelMarObjectiveFilter_LapStarted");
...
static_assert(alignof(FDelMarObjectiveFilter_StartlineBoostPercentEarned) == 0x000008, "Wrong alignment on FDelMarObjectiveFilter_StartlineBoostPercentEarned");
static_assert(sizeof(FDelMarObjectiveFilter_StartlineBoostPercentEarned) == 0x000190, "Wrong size on FDelMarObjectiveFilter_StartlineBoostPercentEarned");
...
static_assert(offsetof(FDelMarRaceCVar, VariableName) == 0x000000, "Member 'FDelMarRaceCVar::VariableName' has a wrong offset!");
static_assert(offsetof(FDelMarRaceCVar, Value) == 0x000010, "Member 'FDelMarRaceCVar::Value' has a wrong offset!");
...
static_assert(offsetof(FDelMarEvent_MusicPlaylistUpdated, PreRaceMusic) == 0x000008, "Member 'FDelMarEvent_MusicPlaylistUpdated::PreRaceMusic' has a wrong offset!");
static_assert(offsetof(FDelMarEvent_MusicPlaylistUpdated, PostRaceMusic) == 0x000010, "Member 'FDelMarEvent_MusicPlaylistUpdated::PostRaceMusic' has a wrong offset!");
...
static_assert(offsetof(FDelMarTutorialSection, ControlsText) == 0x000070, "Member 'FDelMarTutorialSection::ControlsText' has a wrong offset!");
static_assert(offsetof(FDelMarTutorialSection, DialogTag) == 0x000090, "Member 'FDelMarTutorialSection::DialogTag' has a wrong offset!");
static_assert(offsetof(FDelMarTutorialSection, bSkipCountdown) == 0x000094, "Member 'FDelMarTutorialSection::bSkipCountdown' has a wrong offset!");
...
static_assert(sizeof(FDelMarVehicleConfig_Underthrust) == 0x000168, "Wrong size on FDelMarVehicleConfig_Underthrust");
...
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, PitchRatioScalarCurve) == 0x0000C0, "Member 'FDelMarVehicleConfig_Underthrust::PitchRatioScalarCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bVehicleRelativeWithFreestyle) == 0x000150, "Member 'FDelMarVehicleConfig_Underthrust::bVehicleRelativeWithFreestyle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, MinUpwardAccel) == 0x000154, "Member 'FDelMarVehicleConfig_Underthrust::MinUpwardAccel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, LateralRelativeAccel) == 0x000158, "Member 'FDelMarVehicleConfig_Underthrust::LateralRelativeAccel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bReplenishTankOnLanding) == 0x00015C, "Member 'FDelMarVehicleConfig_Underthrust::bReplenishTankOnLanding' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, bReplenishTankOverTime) == 0x00015D, "Member 'FDelMarVehicleConfig_Underthrust::bReplenishTankOverTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, TankReplenishDelaySeconds) == 0x000160, "Member 'FDelMarVehicleConfig_Underthrust::TankReplenishDelaySeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Underthrust, TankReplenishRatePerSecond) == 0x000164, "Member 'FDelMarVehicleConfig_Underthrust::TankReplenishRatePerSecond' has a wrong offset!");
...
static_assert(offsetof(FDelMarEvent_TutorialSectionChanged, CurrentSectionIndex) == 0x000098, "Member 'FDelMarEvent_TutorialSectionChanged::CurrentSectionIndex' has a wrong offset!");
...
static_assert(offsetof(FDelMarHintText, GamepadText) == 0x000010, "Member 'FDelMarHintText::GamepadText' has a wrong offset!");
static_assert(offsetof(FDelMarHintText, TouchText) == 0x000020, "Member 'FDelMarHintText::TouchText' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MaxUpsideDownDegreesForForcedRoll) == 0x000030, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MaxUpsideDownDegreesForForcedRoll' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, IdleRotationThreshold) == 0x000034, "Member 'FDelMarVehicleConfig_AutoAerialRotation::IdleRotationThreshold' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, UpsideDownRollTorque) == 0x000038, "Member 'FDelMarVehicleConfig_AutoAerialRotation::UpsideDownRollTorque' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, UpsideDownRollDamping) == 0x00003C, "Member 'FDelMarVehicleConfig_AutoAerialRotation::UpsideDownRollDamping' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinRollInput) == 0x000040, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinRollInput' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, SteerRollOffsetDegrees) == 0x000044, "Member 'FDelMarVehicleConfig_AutoAerialRotation::SteerRollOffsetDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinPitchInput) == 0x000048, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinPitchInput' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MaxUserPitchOffsetDegrees) == 0x00004C, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MaxUserPitchOffsetDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, LateralPitchOffsetDegrees) == 0x000050, "Member 'FDelMarVehicleConfig_AutoAerialRotation::LateralPitchOffsetDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, UnderthrustPitchDegrees) == 0x000054, "Member 'FDelMarVehicleConfig_AutoAerialRotation::UnderthrustPitchDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinThrottleInput) == 0x000058, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinThrottleInput' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MaxUserThrottleOffsetDegrees) == 0x00005C, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MaxUserThrottleOffsetDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, YawTorque) == 0x000060, "Member 'FDelMarVehicleConfig_AutoAerialRotation::YawTorque' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MaxRotationSpeed) == 0x000068, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MaxRotationSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinApproachTargetScalar) == 0x000080, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinApproachTargetScalar' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinForwardSpeedForYawRotation) == 0x000084, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinForwardSpeedForYawRotation' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinSteerInputForForwardStateTurning) == 0x000088, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinSteerInputForForwardStateTurning' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, ForwardStateTurnRate) == 0x00008C, "Member 'FDelMarVehicleConfig_AutoAerialRotation::ForwardStateTurnRate' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, bLandingAssistanceEnabled) == 0x000090, "Member 'FDelMarVehicleConfig_AutoAerialRotation::bLandingAssistanceEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, LandingCollisionChannel) == 0x000091, "Member 'FDelMarVehicleConfig_AutoAerialRotation::LandingCollisionChannel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, LandingDetectionSeconds) == 0x000094, "Member 'FDelMarVehicleConfig_AutoAerialRotation::LandingDetectionSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, MinLandingDetectionDistance) == 0x000098, "Member 'FDelMarVehicleConfig_AutoAerialRotation::MinLandingDetectionDistance' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, LandingSurfaceNormalMaxDegrees) == 0x00009C, "Member 'FDelMarVehicleConfig_AutoAerialRotation::LandingSurfaceNormalMaxDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_AutoAerialRotation, LandingRotationAmplifier) == 0x0000A0, "Member 'FDelMarVehicleConfig_AutoAerialRotation::LandingRotationAmplifier' has a wrong offset!");
...
static_assert(sizeof(FDelMarVehicleAxleConfig) == 0x000028, "Wrong size on FDelMarVehicleAxleConfig");
...
static_assert(offsetof(FDelMarVehicleAxleConfig, RestDistanceZ) == 0x000010, "Member 'FDelMarVehicleAxleConfig::RestDistanceZ' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleAxleConfig, Suspension) == 0x000014, "Member 'FDelMarVehicleAxleConfig::Suspension' has a wrong offset!");
...
static_assert(alignof(FDelMarDefaultCameraValues) == 0x000004, "Wrong alignment on FDelMarDefaultCameraValues");
static_assert(sizeof(FDelMarDefaultCameraValues) == 0x000010, "Wrong size on FDelMarDefaultCameraValues");
static_assert(offsetof(FDelMarDefaultCameraValues, FOV) == 0x000000, "Member 'FDelMarDefaultCameraValues::FOV' has a wrong offset!");
static_assert(offsetof(FDelMarDefaultCameraValues, Distance) == 0x000004, "Member 'FDelMarDefaultCameraValues::Distance' has a wrong offset!");
static_assert(offsetof(FDelMarDefaultCameraValues, Height) == 0x000008, "Member 'FDelMarDefaultCameraValues::Height' has a wrong offset!");
static_assert(offsetof(FDelMarDefaultCameraValues, AngleToOriginDegrees) == 0x00000C, "Member 'FDelMarDefaultCameraValues::AngleToOriginDegrees' has a wrong offset!");
...
static_assert(offsetof(FDelMarWorldBonusSpeedStack, GroupId) == 0x000010, "Member 'FDelMarWorldBonusSpeedStack::GroupId' has a wrong offset!");
static_assert(offsetof(FDelMarWorldBonusSpeedStack, ActorSource) == 0x000014, "Member 'FDelMarWorldBonusSpeedStack::ActorSource' has a wrong offset!");
...
static_assert(offsetof(FDelMarStartlineBoostData, EarnedPotential) == 0x000010, "Member 'FDelMarStartlineBoostData::EarnedPotential' has a wrong offset!");
...
static_assert(alignof(FDelMarVerbMessage_Demolished) == 0x000008, "Wrong alignment on FDelMarVerbMessage_Demolished");
static_assert(sizeof(FDelMarVerbMessage_Demolished) == 0x000138, "Wrong size on FDelMarVerbMessage_Demolished");
...
static_assert(alignof(FDelMarVerbMessage_JellyHit) == 0x000008, "Wrong alignment on FDelMarVerbMessage_JellyHit");
static_assert(sizeof(FDelMarVerbMessage_JellyHit) == 0x000138, "Wrong size on FDelMarVerbMessage_JellyHit");
...
{
public:
	float                                         PercentEarned;                                     // 0x0138(0x0004)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_13C[0x4];                                      // 0x013C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDelMarVerbMessage_StartlineBoostPercentEarned) == 0x000008, "Wrong alignment on FDelMarVerbMessage_StartlineBoostPercentEarned");
static_assert(sizeof(FDelMarVerbMessage_StartlineBoostPercentEarned) == 0x000140, "Wrong size on FDelMarVerbMessage_StartlineBoostPercentEarned");
static_assert(offsetof(FDelMarVerbMessage_StartlineBoostPercentEarned, PercentEarned) == 0x000138, "Member 'FDelMarVerbMessage_StartlineBoostPercentEarned::PercentEarned' has a wrong offset!");
...
public:
	...
	float                                         LocalDistance;                                     // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FCheckpointTrackDistance) == 0x000020, "Wrong size on FCheckpointTrackDistance");
static_assert(offsetof(FCheckpointTrackDistance, Track) == 0x000000, "Member 'FCheckpointTrackDistance::Track' has a wrong offset!");
static_assert(offsetof(FCheckpointTrackDistance, LocalDistance) == 0x000008, "Member 'FCheckpointTrackDistance::LocalDistance' has a wrong offset!");
...
static_assert(sizeof(FDelMarPositionValue) == 0x000018, "Wrong size on FDelMarPositionValue");
...
public:
	...
	bool                                          bIdleDisablesVehicleCollision;                     // 0x0001(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SecondsToSetIdle;                                  // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EDelMarVehicleCollisionOverrideSetting        VehicleCollisionsGlobalOverride;                   // 0x0008(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bApplyOverlapFilter;                               // 0x0009(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A[0x2];                                        // 0x000A(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDelMarVehicleRuntimeConfig) == 0x000004, "Wrong alignment on FDelMarVehicleRuntimeConfig");
static_assert(sizeof(FDelMarVehicleRuntimeConfig) == 0x00000C, "Wrong size on FDelMarVehicleRuntimeConfig");
...
static_assert(offsetof(FDelMarVehicleRuntimeConfig, bIdleDisablesVehicleCollision) == 0x000001, "Member 'FDelMarVehicleRuntimeConfig::bIdleDisablesVehicleCollision' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleRuntimeConfig, SecondsToSetIdle) == 0x000004, "Member 'FDelMarVehicleRuntimeConfig::SecondsToSetIdle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleRuntimeConfig, VehicleCollisionsGlobalOverride) == 0x000008, "Member 'FDelMarVehicleRuntimeConfig::VehicleCollisionsGlobalOverride' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleRuntimeConfig, bApplyOverlapFilter) == 0x000009, "Member 'FDelMarVehicleRuntimeConfig::bApplyOverlapFilter' has a wrong offset!");
...
static_assert(sizeof(FDelMarMatchmakingConfig) == 0x00001C, "Wrong size on FDelMarMatchmakingConfig");
...
static_assert(offsetof(FDelMarMatchmakingConfig, CODGracePeriodSeconds) == 0x000008, "Member 'FDelMarMatchmakingConfig::CODGracePeriodSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarMatchmakingConfig, MatchStartDelaySeconds) == 0x00000C, "Member 'FDelMarMatchmakingConfig::MatchStartDelaySeconds' has a wrong offset!");
static_assert(offsetof(FDelMarMatchmakingConfig, bMatchInProgressBackFillEnabled) == 0x000010, "Member 'FDelMarMatchmakingConfig::bMatchInProgressBackFillEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarMatchmakingConfig, MinSecondsRemainingForBackfill) == 0x000014, "Member 'FDelMarMatchmakingConfig::MinSecondsRemainingForBackfill' has a wrong offset!");
static_assert(offsetof(FDelMarMatchmakingConfig, TimeIntervalBetweenAnalyticsSeconds) == 0x000018, "Member 'FDelMarMatchmakingConfig::TimeIntervalBetweenAnalyticsSeconds' has a wrong offset!");

// ScriptStruct DelMarCore.DelMarBotMMRPenaltyConfig
// 0x0028 (0x0028 - 0x0000)
struct FDelMarBotMMRPenaltyConfig final
{
public:
	float                                         MinMmr;                                            // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MaxMmr;                                            // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDelMarCurveFloat                      TargetSpeedPenaltyCurve;                           // 0x0008(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FDelMarCurveFloat                      TargetTurboChancesCurve;                           // 0x0018(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarBotMMRPenaltyConfig) == 0x000008, "Wrong alignment on FDelMarBotMMRPenaltyConfig");
static_assert(sizeof(FDelMarBotMMRPenaltyConfig) == 0x000028, "Wrong size on FDelMarBotMMRPenaltyConfig");
static_assert(offsetof(FDelMarBotMMRPenaltyConfig, MinMmr) == 0x000000, "Member 'FDelMarBotMMRPenaltyConfig::MinMmr' has a wrong offset!");
static_assert(offsetof(FDelMarBotMMRPenaltyConfig, MaxMmr) == 0x000004, "Member 'FDelMarBotMMRPenaltyConfig::MaxMmr' has a wrong offset!");
static_assert(offsetof(FDelMarBotMMRPenaltyConfig, TargetSpeedPenaltyCurve) == 0x000008, "Member 'FDelMarBotMMRPenaltyConfig::TargetSpeedPenaltyCurve' has a wrong offset!");
static_assert(offsetof(FDelMarBotMMRPenaltyConfig, TargetTurboChancesCurve) == 0x000018, "Member 'FDelMarBotMMRPenaltyConfig::TargetTurboChancesCurve' has a wrong offset!");
...
{
public:
	struct FDelMarCurveFloat                      BotTargetSpeedPenaltyCurve;                        // 0x0000(0x0010)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TArray<struct FDelMarBotMMRPenaltyConfig>     BotTargetSpeedMMRPenalty;                          // 0x0010(0x0010)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	int32                                         NumPlayersAheadForNoBotPenalty;                    // 0x0020(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FDelMarBotRuntimeConfig) == 0x000008, "Wrong alignment on FDelMarBotRuntimeConfig");
static_assert(sizeof(FDelMarBotRuntimeConfig) == 0x000028, "Wrong size on FDelMarBotRuntimeConfig");
static_assert(offsetof(FDelMarBotRuntimeConfig, BotTargetSpeedPenaltyCurve) == 0x000000, "Member 'FDelMarBotRuntimeConfig::BotTargetSpeedPenaltyCurve' has a wrong offset!");
static_assert(offsetof(FDelMarBotRuntimeConfig, BotTargetSpeedMMRPenalty) == 0x000010, "Member 'FDelMarBotRuntimeConfig::BotTargetSpeedMMRPenalty' has a wrong offset!");
static_assert(offsetof(FDelMarBotRuntimeConfig, NumPlayersAheadForNoBotPenalty) == 0x000020, "Member 'FDelMarBotRuntimeConfig::NumPlayersAheadForNoBotPenalty' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleDriveSetup, MinSpeedForPersistentTargetSpeedModifier) == 0x00012C, "Member 'FDelMarVehicleDriveSetup::MinSpeedForPersistentTargetSpeedModifier' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, bAllowBrakingInAir) == 0x000130, "Member 'FDelMarVehicleDriveSetup::bAllowBrakingInAir' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, BrakeAccel) == 0x000134, "Member 'FDelMarVehicleDriveSetup::BrakeAccel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, StopSpeed) == 0x000138, "Member 'FDelMarVehicleDriveSetup::StopSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, IdleBrakeFactor) == 0x00013C, "Member 'FDelMarVehicleDriveSetup::IdleBrakeFactor' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxSpeedToResetTargetSpeedDirection) == 0x000140, "Member 'FDelMarVehicleDriveSetup::MaxSpeedToResetTargetSpeedDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, SteerAngleCurve) == 0x000148, "Member 'FDelMarVehicleDriveSetup::SteerAngleCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, SteerAngleCurveOverrides) == 0x0001D0, "Member 'FDelMarVehicleDriveSetup::SteerAngleCurveOverrides' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, LatFrictionCurve) == 0x0001E0, "Member 'FDelMarVehicleDriveSetup::LatFrictionCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, WheelsGroundedFrictionCurve) == 0x000270, "Member 'FDelMarVehicleDriveSetup::WheelsGroundedFrictionCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxForwardSpeedToIgnoreLandingSpeed) == 0x0002F8, "Member 'FDelMarVehicleDriveSetup::MaxForwardSpeedToIgnoreLandingSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxKickflipLandingSeconds) == 0x0002FC, "Member 'FDelMarVehicleDriveSetup::MaxKickflipLandingSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, SkydiveVerticalVelocitySensitivity) == 0x000300, "Member 'FDelMarVehicleDriveSetup::SkydiveVerticalVelocitySensitivity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, SkydiveVerticalPitchSensitivity) == 0x000304, "Member 'FDelMarVehicleDriveSetup::SkydiveVerticalPitchSensitivity' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxGroundNormalDiffForPrimaryDirection) == 0x000314, "Member 'FDelMarVehicleDriveSetup::MaxGroundNormalDiffForPrimaryDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinPrevVelocityDotProductForPrimaryDirection) == 0x000318, "Member 'FDelMarVehicleDriveSetup::MinPrevVelocityDotProductForPrimaryDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, ForwardMaxSpeed) == 0x00031C, "Member 'FDelMarVehicleDriveSetup::ForwardMaxSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, UpwardMaxLandingSpeed) == 0x000320, "Member 'FDelMarVehicleDriveSetup::UpwardMaxLandingSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, UpwardMaxSpeed) == 0x000324, "Member 'FDelMarVehicleDriveSetup::UpwardMaxSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxLandingAngularVelocity) == 0x000328, "Member 'FDelMarVehicleDriveSetup::MaxLandingAngularVelocity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxLinearSpeed) == 0x00032C, "Member 'FDelMarVehicleDriveSetup::MaxLinearSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxAngularSpeed) == 0x000330, "Member 'FDelMarVehicleDriveSetup::MaxAngularSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinCeilingDegrees) == 0x000334, "Member 'FDelMarVehicleDriveSetup::MinCeilingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxCeilingDegrees) == 0x000338, "Member 'FDelMarVehicleDriveSetup::MaxCeilingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, AerialCeilingDegrees) == 0x00033C, "Member 'FDelMarVehicleDriveSetup::AerialCeilingDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxInvertedControlSteering) == 0x000340, "Member 'FDelMarVehicleDriveSetup::MaxInvertedControlSteering' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinCeilingSecondsToInvertControls) == 0x000344, "Member 'FDelMarVehicleDriveSetup::MinCeilingSecondsToInvertControls' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, WheelPushForce) == 0x000348, "Member 'FDelMarVehicleDriveSetup::WheelPushForce' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinSpeedForVelocityDirection) == 0x00034C, "Member 'FDelMarVehicleDriveSetup::MinSpeedForVelocityDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinZSpeedForUpwardDirection) == 0x000350, "Member 'FDelMarVehicleDriveSetup::MinZSpeedForUpwardDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, VerticalOrientationSensitivity) == 0x000354, "Member 'FDelMarVehicleDriveSetup::VerticalOrientationSensitivity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxInactiveLandedFlipTime) == 0x000358, "Member 'FDelMarVehicleDriveSetup::MaxInactiveLandedFlipTime' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, NumWheelsForWheelsOnGround) == 0x00035C, "Member 'FDelMarVehicleDriveSetup::NumWheelsForWheelsOnGround' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxLandingSpeedSpringVarianceDegrees) == 0x000360, "Member 'FDelMarVehicleDriveSetup::MaxLandingSpeedSpringVarianceDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MinDownDegreesForForwardDirection) == 0x000364, "Member 'FDelMarVehicleDriveSetup::MinDownDegreesForForwardDirection' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxNormalizedForwardSpeed) == 0x000368, "Member 'FDelMarVehicleDriveSetup::MaxNormalizedForwardSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriveSetup, MaxNormalizedBonusSpeed) == 0x00036C, "Member 'FDelMarVehicleDriveSetup::MaxNormalizedBonusSpeed' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleDriftConfig, MinFullDriftInput) == 0x000034, "Member 'FDelMarVehicleDriftConfig::MinFullDriftInput' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, ForcedDriftSteer) == 0x000038, "Member 'FDelMarVehicleDriftConfig::ForcedDriftSteer' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, InitialTorqueImpulse) == 0x00003C, "Member 'FDelMarVehicleDriftConfig::InitialTorqueImpulse' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxAllowedGroundedSpringVarianceDegrees) == 0x000040, "Member 'FDelMarVehicleDriftConfig::MaxAllowedGroundedSpringVarianceDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelInDriftDir) == 0x000044, "Member 'FDelMarVehicleDriftConfig::TorqueAccelInDriftDir' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelNoSteer) == 0x000048, "Member 'FDelMarVehicleDriftConfig::TorqueAccelNoSteer' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelNotInDriftDir) == 0x00004C, "Member 'FDelMarVehicleDriftConfig::TorqueAccelNotInDriftDir' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelChangeDir) == 0x000050, "Member 'FDelMarVehicleDriftConfig::TorqueAccelChangeDir' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelDampening) == 0x000054, "Member 'FDelMarVehicleDriftConfig::TorqueAccelDampening' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelWithKick) == 0x000058, "Member 'FDelMarVehicleDriftConfig::TorqueAccelWithKick' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelWithKickV2) == 0x00005C, "Member 'FDelMarVehicleDriftConfig::TorqueAccelWithKickV2' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAccelForcedDrift) == 0x000060, "Member 'FDelMarVehicleDriftConfig::TorqueAccelForcedDrift' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, TorqueAgainstExit) == 0x000064, "Member 'FDelMarVehicleDriftConfig::TorqueAgainstExit' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxRotationSpeedWithThrottle) == 0x000068, "Member 'FDelMarVehicleDriftConfig::MaxRotationSpeedWithThrottle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxRotationSpeedNoThrottle) == 0x00006C, "Member 'FDelMarVehicleDriftConfig::MaxRotationSpeedNoThrottle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxRotationSpeedWithKick) == 0x000070, "Member 'FDelMarVehicleDriftConfig::MaxRotationSpeedWithKick' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxRotationSpeedSwapDirections) == 0x000074, "Member 'FDelMarVehicleDriftConfig::MaxRotationSpeedSwapDirections' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MinDriftDegrees) == 0x000078, "Member 'FDelMarVehicleDriftConfig::MinDriftDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MaxDriftDegrees) == 0x00007C, "Member 'FDelMarVehicleDriftConfig::MaxDriftDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, ExitDriftDegrees) == 0x000080, "Member 'FDelMarVehicleDriftConfig::ExitDriftDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, ApproachDistance) == 0x000084, "Member 'FDelMarVehicleDriftConfig::ApproachDistance' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, PeakForwardSpeedDegrees) == 0x000088, "Member 'FDelMarVehicleDriftConfig::PeakForwardSpeedDegrees' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, KickRedirectRate) == 0x00008C, "Member 'FDelMarVehicleDriftConfig::KickRedirectRate' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, KickRedirectRateV2) == 0x000090, "Member 'FDelMarVehicleDriftConfig::KickRedirectRateV2' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, ForcedDriftRedirectRate) == 0x000094, "Member 'FDelMarVehicleDriftConfig::ForcedDriftRedirectRate' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDriftConfig, MinSteerRedirectInput) == 0x000098, "Member 'FDelMarVehicleDriftConfig::MinSteerRedirectInput' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleDraftingConfig, bEnableDynamicAngle) == 0x000010, "Member 'FDelMarVehicleDraftingConfig::bEnableDynamicAngle' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, MaxBonusSpeedPercentageCurve) == 0x000018, "Member 'FDelMarVehicleDraftingConfig::MaxBonusSpeedPercentageCurve' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, LineOfSightChannel) == 0x0000A8, "Member 'FDelMarVehicleDraftingConfig::LineOfSightChannel' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, MinSpeedToStartDrafting) == 0x0000AC, "Member 'FDelMarVehicleDraftingConfig::MinSpeedToStartDrafting' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, NumSecondsToActivateDrafting) == 0x0000B0, "Member 'FDelMarVehicleDraftingConfig::NumSecondsToActivateDrafting' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, NumForgivenessSeconds) == 0x0000B4, "Member 'FDelMarVehicleDraftingConfig::NumForgivenessSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, NumGracePeriodSeconds) == 0x0000B8, "Member 'FDelMarVehicleDraftingConfig::NumGracePeriodSeconds' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, NumSecondsToMaxBonusSpeed) == 0x0000BC, "Member 'FDelMarVehicleDraftingConfig::NumSecondsToMaxBonusSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, MaxBonusSpeed) == 0x0000C0, "Member 'FDelMarVehicleDraftingConfig::MaxBonusSpeed' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleDraftingConfig, NumSpeedRemovalSeconds) == 0x0000C4, "Member 'FDelMarVehicleDraftingConfig::NumSpeedRemovalSeconds' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfig_Terrain, bDemolishInWater) == 0x000010, "Member 'FDelMarVehicleConfig_Terrain::bDemolishInWater' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Terrain, MaxWaterDepth) == 0x000014, "Member 'FDelMarVehicleConfig_Terrain::MaxWaterDepth' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Terrain, WaterDestructionDelay) == 0x000018, "Member 'FDelMarVehicleConfig_Terrain::WaterDestructionDelay' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_Terrain, NonDriveableActorClasses) == 0x000020, "Member 'FDelMarVehicleConfig_Terrain::NonDriveableActorClasses' has a wrong offset!");
...
// ScriptStruct DelMarCore.DelMarVehicleConfig_SelfDemolish
// 0x0008 (0x0008 - 0x0000)
struct FDelMarVehicleConfig_SelfDemolish final
{
public:
	bool                                          bSelfDemolishEnabled;                              // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDelMarVehicleConfig_SelfDemolish) == 0x000004, "Wrong alignment on FDelMarVehicleConfig_SelfDemolish");
static_assert(sizeof(FDelMarVehicleConfig_SelfDemolish) == 0x000008, "Wrong size on FDelMarVehicleConfig_SelfDemolish");
static_assert(offsetof(FDelMarVehicleConfig_SelfDemolish, bSelfDemolishEnabled) == 0x000000, "Member 'FDelMarVehicleConfig_SelfDemolish::bSelfDemolishEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfig_SelfDemolish, RequiredDemolishActionDuration) == 0x000004, "Member 'FDelMarVehicleConfig_SelfDemolish::RequiredDemolishActionDuration' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Collision, bNonTrackVelocityRedirectEnabled) == 0x000002, "Member 'FDelMarVehicleConfigOverride_Collision::bNonTrackVelocityRedirectEnabled' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Gravity, CounterGravityContactDegreeThreshold) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Gravity::CounterGravityContactDegreeThreshold' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Gravity, AerialGravityScalar) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Gravity::AerialGravityScalar' has a wrong offset!");
...
static_assert(offsetof(FDelMarVehicleConfigOverride_Terrain, bDemolishInWater) == 0x000000, "Member 'FDelMarVehicleConfigOverride_Terrain::bDemolishInWater' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_Terrain, WaterDestructionDelay) == 0x000004, "Member 'FDelMarVehicleConfigOverride_Terrain::WaterDestructionDelay' has a wrong offset!");
...
// ScriptStruct DelMarCore.DelMarVehicleConfigOverride_SelfDemolish
// 0x0008 (0x0008 - 0x0000)
struct FDelMarVehicleConfigOverride_SelfDemolish final
{
public:
	bool                                          bSelfDemolishEnabled;                              // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(FDelMarVehicleConfigOverride_SelfDemolish) == 0x000004, "Wrong alignment on FDelMarVehicleConfigOverride_SelfDemolish");
static_assert(sizeof(FDelMarVehicleConfigOverride_SelfDemolish) == 0x000008, "Wrong size on FDelMarVehicleConfigOverride_SelfDemolish");
static_assert(offsetof(FDelMarVehicleConfigOverride_SelfDemolish, bSelfDemolishEnabled) == 0x000000, "Member 'FDelMarVehicleConfigOverride_SelfDemolish::bSelfDemolishEnabled' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverride_SelfDemolish, RequiredDemolishActionDuration) == 0x000004, "Member 'FDelMarVehicleConfigOverride_SelfDemolish::RequiredDemolishActionDuration' has a wrong offset!");
...
public:
	...
	struct FDelMarVehicleConfigOverride_SelfDemolish SelfDemolish;                                      // 0x0098(0x0008)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FDelMarVehicleConfigOverrides) == 0x000004, "Wrong alignment on FDelMarVehicleConfigOverrides");
static_assert(sizeof(FDelMarVehicleConfigOverrides) == 0x0000A0, "Wrong size on FDelMarVehicleConfigOverrides");
...
static_assert(offsetof(FDelMarVehicleConfigOverrides, AutoUpright) == 0x000004, "Member 'FDelMarVehicleConfigOverrides::AutoUpright' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Collision) == 0x000008, "Member 'FDelMarVehicleConfigOverrides::Collision' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Drift) == 0x000010, "Member 'FDelMarVehicleConfigOverrides::Drift' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, DriftBoost) == 0x00001C, "Member 'FDelMarVehicleConfigOverrides::DriftBoost' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Drive) == 0x000028, "Member 'FDelMarVehicleConfigOverrides::Drive' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Gravity) == 0x00003C, "Member 'FDelMarVehicleConfigOverrides::Gravity' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Jump) == 0x000044, "Member 'FDelMarVehicleConfigOverrides::Jump' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Kickflip) == 0x000048, "Member 'FDelMarVehicleConfigOverrides::Kickflip' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Oversteer) == 0x000054, "Member 'FDelMarVehicleConfigOverrides::Oversteer' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Terrain) == 0x00005C, "Member 'FDelMarVehicleConfigOverrides::Terrain' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Turbo) == 0x000064, "Member 'FDelMarVehicleConfigOverrides::Turbo' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, Underthrust) == 0x00007C, "Member 'FDelMarVehicleConfigOverrides::Underthrust' has a wrong offset!");
static_assert(offsetof(FDelMarVehicleConfigOverrides, SelfDemolish) == 0x000098, "Member 'FDelMarVehicleConfigOverrides::SelfDemolish' has a wrong offset!");
