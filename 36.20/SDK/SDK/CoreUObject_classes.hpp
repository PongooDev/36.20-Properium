...
public:
	...
	int16                                         MinAlignemnt;                                      // 0x005C(0x0002)(NOT AUTO-GENERATED PROPERTY)
...
{
public:
	EVerseEnumFlags                               VerseEnumFlags;                                    // 0x0060(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_64[0x4];                                       // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FUtf8StrProperty_                             QualifiedName;                                     // 0x0068(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVerseEnum) == 0x000078, "Wrong size on UVerseEnum");
static_assert(offsetof(UVerseEnum, VerseEnumFlags) == 0x000060, "Member 'UVerseEnum::VerseEnumFlags' has a wrong offset!");
static_assert(offsetof(UVerseEnum, QualifiedName) == 0x000068, "Member 'UVerseEnum::QualifiedName' has a wrong offset!");
...
static_assert(sizeof(UPackage) == 0x000048, "Wrong size on UPackage");
...
static_assert(sizeof(UVerseFunction) == 0x0000E8, "Wrong size on UVerseFunction");
...
public:
	...
	class FName                                   MangledPackageVersePath;                           // 0x0294(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PackageRelativeVersePath;                          // 0x0298(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, class FName>                DisplayNameToUENameFunctionMap;                    // 0x02A8(0x0050)(NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UObject>>            DirectInterfaces;                                  // 0x02F8(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<TFieldPath<class FProperty>>           PropertiesWrittenByInitCDO;                        // 0x0308(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TMap<class FName, class FName>                FunctionMangledNames;                              // 0x0318(0x0050)(NativeAccessSpecifierPublic)
	TArray<class FName>                           PredictsFunctionNames;                             // 0x0368(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UVerseClass) == 0x000380, "Wrong size on UVerseClass");
...
static_assert(offsetof(UVerseClass, PackageRelativeVersePath) == 0x000298, "Member 'UVerseClass::PackageRelativeVersePath' has a wrong offset!");
static_assert(offsetof(UVerseClass, DisplayNameToUENameFunctionMap) == 0x0002A8, "Member 'UVerseClass::DisplayNameToUENameFunctionMap' has a wrong offset!");
static_assert(offsetof(UVerseClass, DirectInterfaces) == 0x0002F8, "Member 'UVerseClass::DirectInterfaces' has a wrong offset!");
static_assert(offsetof(UVerseClass, PropertiesWrittenByInitCDO) == 0x000308, "Member 'UVerseClass::PropertiesWrittenByInitCDO' has a wrong offset!");
static_assert(offsetof(UVerseClass, FunctionMangledNames) == 0x000318, "Member 'UVerseClass::FunctionMangledNames' has a wrong offset!");
static_assert(offsetof(UVerseClass, PredictsFunctionNames) == 0x000368, "Member 'UVerseClass::PredictsFunctionNames' has a wrong offset!");
