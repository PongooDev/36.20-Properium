...
public:
	...
	struct FGameplayInteractionContext            GameplayInteractionContext;                        // 0x00A8(0x0078)(Protected, NativeAccessSpecifierProtected)
	class UAITask_MoveTo*                         MoveToTask;                                        // 0x0120(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FSmartObjectClaimHandle                ClaimedHandle;                                     // 0x0128(0x0028)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	struct FGameplayInteractionAbortContext       AbortContext;                                      // 0x0150(0x0001)(NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAITask_UseGameplayInteraction) == 0x000158, "Wrong size on UAITask_UseGameplayInteraction");
...
static_assert(offsetof(UAITask_UseGameplayInteraction, MoveToTask) == 0x000120, "Member 'UAITask_UseGameplayInteraction::MoveToTask' has a wrong offset!");
static_assert(offsetof(UAITask_UseGameplayInteraction, ClaimedHandle) == 0x000128, "Member 'UAITask_UseGameplayInteraction::ClaimedHandle' has a wrong offset!");
static_assert(offsetof(UAITask_UseGameplayInteraction, AbortContext) == 0x000150, "Member 'UAITask_UseGameplayInteraction::AbortContext' has a wrong offset!");
