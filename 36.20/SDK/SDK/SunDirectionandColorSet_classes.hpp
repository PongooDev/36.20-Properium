...
public:
	...
	struct FLinearColor                           SunLightColor;                                     // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ASunDirectionandColorSet_C) == 0x0002D0, "Wrong size on ASunDirectionandColorSet_C");
static_assert(offsetof(ASunDirectionandColorSet_C, UberGraphFrame) == 0x0002A8, "Member 'ASunDirectionandColorSet_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ASunDirectionandColorSet_C, Scene) == 0x0002B0, "Member 'ASunDirectionandColorSet_C::Scene' has a wrong offset!");
static_assert(offsetof(ASunDirectionandColorSet_C, Arrow) == 0x0002B8, "Member 'ASunDirectionandColorSet_C::Arrow' has a wrong offset!");
static_assert(offsetof(ASunDirectionandColorSet_C, SunLightColor) == 0x0002C0, "Member 'ASunDirectionandColorSet_C::SunLightColor' has a wrong offset!");
