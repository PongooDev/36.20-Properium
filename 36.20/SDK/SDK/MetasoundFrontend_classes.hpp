...
public:
	...
	struct FMetasoundFrontendDocument             Document;                                          // 0x0030(0x0180)(Transient, NativeAccessSpecifierPrivate)
	TSubclassOf<class UObject>                    MetaSoundUClass;                                   // 0x01B0(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TSubclassOf<class UObject>                    BuilderUClass;                                     // 0x01B8(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMetaSoundBuilderDocument) == 0x0001C0, "Wrong size on UMetaSoundBuilderDocument");
...
static_assert(offsetof(UMetaSoundBuilderDocument, MetaSoundUClass) == 0x0001B0, "Member 'UMetaSoundBuilderDocument::MetaSoundUClass' has a wrong offset!");
static_assert(offsetof(UMetaSoundBuilderDocument, BuilderUClass) == 0x0001B8, "Member 'UMetaSoundBuilderDocument::BuilderUClass' has a wrong offset!");
