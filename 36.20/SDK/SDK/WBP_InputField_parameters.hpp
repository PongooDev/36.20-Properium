...
public:
	...
	struct FPointerEvent                          K2Node_Event_MouseEvent_1;                         // 0x0078(0x0080)(ConstParm)
	struct FPointerEvent                          K2Node_Event_MouseEvent;                           // 0x00F8(0x0080)(ConstParm)
	class FText                                   K2Node_Event_EditableText;                         // 0x0178(0x0010)(ConstParm)
	class FText                                   K2Node_Event_ErrorText;                            // 0x0188(0x0010)(ConstParm)
	class FText                                   K2Node_Event_HintText;                             // 0x0198(0x0010)(ConstParm)
	...
	struct FWidgetAnimationHandle                 CallFunc_PlayAnimationForward_ReturnValue;         // 0x01C0(0x0010)(HasGetValueTypeHash)
	ECommonInputType                              K2Node_CustomEvent_bNewInputType;                  // 0x01D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField) == 0x0001D8, "Wrong size on WBP_InputField_C_ExecuteUbergraph_WBP_InputField");
...
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_InFocusEvent_1) == 0x000030, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_InFocusEvent_1' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_InFocusEvent) == 0x000038, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_InFocusEvent' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_MyGeometry) == 0x000040, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_MyGeometry' has a wrong offset!");
...
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_MouseEvent) == 0x0000F8, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_MouseEvent' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_EditableText) == 0x000178, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_EditableText' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_ErrorText) == 0x000188, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_ErrorText' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_HintText) == 0x000198, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_HintText' has a wrong offset!");
...
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, CallFunc_PlayAnimationForward_ReturnValue) == 0x0001C0, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_CustomEvent_bNewInputType) == 0x0001D0, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_CustomEvent_bNewInputType' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_ExecuteUbergraph_WBP_InputField, K2Node_Event_IsDesignTime) == 0x0001D1, "Member 'WBP_InputField_C_ExecuteUbergraph_WBP_InputField::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(sizeof(WBP_InputField_C_OnMouseButtonUp) == 0x000228, "Wrong size on WBP_InputField_C_OnMouseButtonUp");
...
static_assert(offsetof(WBP_InputField_C_OnMouseButtonUp, ReturnValue) == 0x0000B8, "Member 'WBP_InputField_C_OnMouseButtonUp::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_OnMouseButtonUp, K2Node_MakeStruct_EventReply) == 0x000170, "Member 'WBP_InputField_C_OnMouseButtonUp::K2Node_MakeStruct_EventReply' has a wrong offset!");
...
static_assert(sizeof(WBP_InputField_C_OnMouseEnter) == 0x0000B8, "Wrong size on WBP_InputField_C_OnMouseEnter");
...
static_assert(sizeof(WBP_InputField_C_OnMouseLeave) == 0x000080, "Wrong size on WBP_InputField_C_OnMouseLeave");
...
public:
	struct FGeometry                              MyGeometry;                                        // 0x0000(0x0038)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
	struct FPointerEvent                          InTouchEvent;                                      // 0x0038(0x0080)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
	struct FEventReply                            ReturnValue;                                       // 0x00B8(0x00B8)(Parm, OutParm, ReturnParm)
	struct FEventReply                            K2Node_MakeStruct_EventReply;                      // 0x0170(0x00B8)()
};
static_assert(alignof(WBP_InputField_C_OnTouchStarted) == 0x000008, "Wrong alignment on WBP_InputField_C_OnTouchStarted");
static_assert(sizeof(WBP_InputField_C_OnTouchStarted) == 0x000228, "Wrong size on WBP_InputField_C_OnTouchStarted");
...
static_assert(offsetof(WBP_InputField_C_OnTouchStarted, ReturnValue) == 0x0000B8, "Member 'WBP_InputField_C_OnTouchStarted::ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_OnTouchStarted, K2Node_MakeStruct_EventReply) == 0x000170, "Member 'WBP_InputField_C_OnTouchStarted::K2Node_MakeStruct_EventReply' has a wrong offset!");
...
public:
	...
	struct FEditableTextStyle                     K2Node_MakeStruct_EditableTextStyle;               // 0x0030(0x0290)()
	struct FSlateFontInfo                         CallFunc_GetFont_ReturnValue;                      // 0x02C0(0x0058)(ConstParm, HasGetValueTypeHash)
	struct FLinearColor                           CallFunc_SelectColor_ReturnValue_1;                // 0x0318(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_InputField_C_Set_Focus_Visual) == 0x000010, "Wrong alignment on WBP_InputField_C_Set_Focus_Visual");
static_assert(sizeof(WBP_InputField_C_Set_Focus_Visual) == 0x000330, "Wrong size on WBP_InputField_C_Set_Focus_Visual");
...
static_assert(offsetof(WBP_InputField_C_Set_Focus_Visual, CallFunc_GetFont_ReturnValue) == 0x0002C0, "Member 'WBP_InputField_C_Set_Focus_Visual::CallFunc_GetFont_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_InputField_C_Set_Focus_Visual, CallFunc_SelectColor_ReturnValue_1) == 0x000318, "Member 'WBP_InputField_C_Set_Focus_Visual::CallFunc_SelectColor_ReturnValue_1' has a wrong offset!");
...
static_assert(sizeof(WBP_InputField_C_SetEditableText) == 0x000010, "Wrong size on WBP_InputField_C_SetEditableText");
...
static_assert(sizeof(WBP_InputField_C_SetErrorText) == 0x000010, "Wrong size on WBP_InputField_C_SetErrorText");
...
static_assert(sizeof(WBP_InputField_C_SetHintText) == 0x000010, "Wrong size on WBP_InputField_C_SetHintText");
...
static_assert(sizeof(WBP_InputField_C_SetLabelValue) == 0x000010, "Wrong size on WBP_InputField_C_SetLabelValue");
...
static_assert(sizeof(WBP_InputField_C_SetTextValue) == 0x000010, "Wrong size on WBP_InputField_C_SetTextValue");
