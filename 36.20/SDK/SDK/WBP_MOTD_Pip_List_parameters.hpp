...
static_assert(offsetof(WBP_MOTD_Pip_List_C_PauseActivePip, CallFunc_IsValid_ReturnValue) == 0x000001, "Member 'WBP_MOTD_Pip_List_C_PauseActivePip::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MOTD_Pip_List_C_SetActivePip, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'WBP_MOTD_Pip_List_C_SetActivePip::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MOTD_Pip_List_C_SetActivePip, CallFunc_Array_IsEmpty_ReturnValue) == 0x000010, "Member 'WBP_MOTD_Pip_List_C_SetActivePip::CallFunc_Array_IsEmpty_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_MOTD_Pip_List_C_SetPipsCount, CallFunc_Array_IsEmpty_ReturnValue) == 0x000028, "Member 'WBP_MOTD_Pip_List_C_SetPipsCount::CallFunc_Array_IsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_MOTD_Pip_List_C_SetPipsCount, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000029, "Member 'WBP_MOTD_Pip_List_C_SetPipsCount::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
