...
static_assert(sizeof(TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C) == 0x000190, "Wrong size on TextStyle_BurbankSmall_S_White::UTextStyle_BurbankSmall_S_White_C");
