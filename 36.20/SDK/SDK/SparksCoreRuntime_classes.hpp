...
static_assert(alignof(UPilgrimTrackTypeUtils) == 0x000008, "Wrong alignment on UPilgrimTrackTypeUtils");
static_assert(sizeof(UPilgrimTrackTypeUtils) == 0x000028, "Wrong size on UPilgrimTrackTypeUtils");
...
public:
	...
	static int32 GetSquadMemberIndexFromPlayerUniqueNetId(const class UObject* WorldContextObject, const struct FUniqueNetIdRepl& PlayerNetId);
