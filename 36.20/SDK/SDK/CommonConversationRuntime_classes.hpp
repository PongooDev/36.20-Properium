...
static_assert(offsetof(UConversationChoiceNode, ChoiceTags) == 0x000068, "Member 'UConversationChoiceNode::ChoiceTags' has a wrong offset!");
...
static_assert(sizeof(UConversationInstance) == 0x0001A0, "Wrong size on UConversationInstance");
...
public:
	...
	static class UConversationInstance* StartConversationFromGraph(const struct FGameplayTag& ConversationEntryTag, class AActor* Instigator, const struct FGameplayTag& InstigatorTag, class AActor* Target, const struct FGameplayTag& TargetTag, const class UConversationDatabase* Graph, const class FString& EntryPointIdentifier);
...
public:
	...
	int32                                         ConversationsActive;                               // 0x0118(0x0004)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_11C[0x4];                                      // 0x011C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UConversationInstance*                  Auth_CurrentConversation;                          // 0x0120(0x0008)(ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<class UConversationInstance*>          Auth_Conversations;                                // 0x0128(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPrivate)
	struct FClientConversationMessagePayload      LastMessage;                                       // 0x0138(0x0068)(NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UConversationParticipantComponent) == 0x0001A8, "Wrong size on UConversationParticipantComponent");
static_assert(offsetof(UConversationParticipantComponent, ConversationsActive) == 0x000118, "Member 'UConversationParticipantComponent::ConversationsActive' has a wrong offset!");
static_assert(offsetof(UConversationParticipantComponent, Auth_CurrentConversation) == 0x000120, "Member 'UConversationParticipantComponent::Auth_CurrentConversation' has a wrong offset!");
static_assert(offsetof(UConversationParticipantComponent, Auth_Conversations) == 0x000128, "Member 'UConversationParticipantComponent::Auth_Conversations' has a wrong offset!");
static_assert(offsetof(UConversationParticipantComponent, LastMessage) == 0x000138, "Member 'UConversationParticipantComponent::LastMessage' has a wrong offset!");
