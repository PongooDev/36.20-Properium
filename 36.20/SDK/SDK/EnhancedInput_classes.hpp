...
{
public:
	struct FGameplayTag                           ProfileIdentifier;                                 // 0x0028(0x0004)(SaveGame, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	class FString                                 InputSettingsSaveSlotName;                         // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   DefaultWorldInputClass;                            // 0x00B0(0x0020)(Edit, Config, NoClear, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         bSendTriggeredEventsWhenInputIsFlushed : 1;        // 0x00D0(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableUserSettings : 1;                           // 0x00D0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableDefaultMappingContexts : 1;                 // 0x00D0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bShouldOnlyTriggerLastActionInChord : 1;           // 0x00D0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableInputModeFiltering : 1;                     // 0x00D0(0x0001)(BitIndex: 0x04, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         bEnableWorldSubsystem : 1;                         // 0x00D0(0x0001)(BitIndex: 0x05, PropSize: 0x0001 (Edit, Config, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	uint8                                         Pad_D1[0x7];                                       // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTagQuery                      DefaultMappingContextInputModeQuery;               // 0x00D8(0x0048)(Edit, Config, NativeAccessSpecifierPublic)
	struct FGameplayTagContainer                  DefaultInputMode;                                  // 0x0120(0x0020)(Edit, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEnhancedInputDeveloperSettings) == 0x000140, "Wrong size on UEnhancedInputDeveloperSettings");
...
static_assert(offsetof(UEnhancedInputDeveloperSettings, InputSettingsSaveSlotName) == 0x0000A0, "Member 'UEnhancedInputDeveloperSettings::InputSettingsSaveSlotName' has a wrong offset!");
...
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultMappingContextInputModeQuery) == 0x0000D8, "Member 'UEnhancedInputDeveloperSettings::DefaultMappingContextInputModeQuery' has a wrong offset!");
static_assert(offsetof(UEnhancedInputDeveloperSettings, DefaultInputMode) == 0x000120, "Member 'UEnhancedInputDeveloperSettings::DefaultInputMode' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(class UInputMappingContext* MappingContext)> OnMappingContextAdded;                             // 0x0190(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(class UInputMappingContext* MappingContext)> OnMappingContextRemoved;                           // 0x01A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                         Pad_838[0x70];                                     // 0x0838(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEnhancedPlayerInput) == 0x0008A8, "Wrong size on UEnhancedPlayerInput");
