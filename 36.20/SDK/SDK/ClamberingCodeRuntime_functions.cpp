...
struct FVector UFortMovementMode_ClamberingRuntimeData::GetSyncPosition() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSyncPosition");
...
void UClamberingComponent::HandleOwnerPersonalVehicleModeChanged(bool bIsMounted)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HandleOwnerPersonalVehicleModeChanged");
...
void UClamberingComponent::OnOwnerPawnPossessed(class APawn* PossessedPawn)
{
	static class UFunction* Func = nullptr;
	...
	Params::ClamberingComponent_OnOwnerPawnPossessed Parms{};
...
bool UClamberingComponent::ShouldShowUIPrompt() const
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("ShouldShowUIPrompt");

	Params::ClamberingComponent_ShouldShowUIPrompt Parms{};
