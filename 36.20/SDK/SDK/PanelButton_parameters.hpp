...
public:
	...
	class UOverlaySlot*                           K2Node_DynamicCast_AsOverlay_Slot;                 // 0x0160(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FDeprecateSlateVector2D                K2Node_SetFieldsInStruct_ImageSize_ImplicitCast;   // 0x016C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(PanelButton_C_UpdateInputActionLayout) == 0x000180, "Wrong size on PanelButton_C_UpdateInputActionLayout");
...
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, K2Node_MakeStruct_SlateBrush) == 0x0000B0, "Member 'PanelButton_C_UpdateInputActionLayout::K2Node_MakeStruct_SlateBrush' has a wrong offset!");
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, K2Node_DynamicCast_AsOverlay_Slot) == 0x000160, "Member 'PanelButton_C_UpdateInputActionLayout::K2Node_DynamicCast_AsOverlay_Slot' has a wrong offset!");
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, K2Node_DynamicCast_bSuccess) == 0x000168, "Member 'PanelButton_C_UpdateInputActionLayout::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, CallFunc_IsValid_ReturnValue) == 0x000169, "Member 'PanelButton_C_UpdateInputActionLayout::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(PanelButton_C_UpdateInputActionLayout, K2Node_SetFieldsInStruct_ImageSize_ImplicitCast) == 0x00016C, "Member 'PanelButton_C_UpdateInputActionLayout::K2Node_SetFieldsInStruct_ImageSize_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(PanelButton_C_UpdateStyle) == 0x000018, "Wrong size on PanelButton_C_UpdateStyle");
