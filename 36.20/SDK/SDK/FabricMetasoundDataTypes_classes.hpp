...
{
public:
	class FText                                   SampleKitName;                                     // 0x0030(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct FFabricMetasoundDrumPlayerSampleData> Samples;                                           // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)

public:
	class FText GetSampleKitName() const;
...
static_assert(sizeof(UFabricMetasoundDrumPlayerSampleBankAsset) == 0x000050, "Wrong size on UFabricMetasoundDrumPlayerSampleBankAsset");
static_assert(offsetof(UFabricMetasoundDrumPlayerSampleBankAsset, SampleKitName) == 0x000030, "Member 'UFabricMetasoundDrumPlayerSampleBankAsset::SampleKitName' has a wrong offset!");
static_assert(offsetof(UFabricMetasoundDrumPlayerSampleBankAsset, Samples) == 0x000040, "Member 'UFabricMetasoundDrumPlayerSampleBankAsset::Samples' has a wrong offset!");
...
public:
	...
	struct FFabricUserOption                      FabricUserOption;                                  // 0x0030(0x0038)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFabricMetaSoundUserOption) == 0x000078, "Wrong size on UFabricMetaSoundUserOption");
