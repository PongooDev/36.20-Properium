...
static_assert(offsetof(StreamingRadioPlayerComponent_Rock_VehicleExploded, VehicleActor) == 0x000008, "Member 'StreamingRadioPlayerComponent_Rock_VehicleExploded::VehicleActor' has a wrong offset!");
