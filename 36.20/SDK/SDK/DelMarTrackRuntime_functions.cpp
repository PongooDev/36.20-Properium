...
int32 ADelMarTrackBase::GetNextSplineSegmentIndexWithActor(int32 SplineSegmentIndex) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetNextSplineSegmentIndexWithActor");
...
// (RequiredAPI, Event, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
...
float ADelMarTrack::GetPrimaryLength() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetPrimaryLength");
...
float ADelMarTrack::GetSecondaryDistance(const float DistanceOnPrimaryTrack) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetSecondaryDistance");
...
bool ADelMarTrack::IsIndependent() const
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("IsIndependent");

	Params::DelMarTrack_IsIndependent Parms{};
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// class ADelMarTrack*                     Track                                                  (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const class ADelMarTrackBase*           ReturnValue                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

const class ADelMarTrackBase* UDelMarTrackPositionComponent::GetBaseTrackFor(const class ADelMarTrack* Track) const
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("GetBaseTrackFor");

	Params::DelMarTrackPositionComponent_GetBaseTrackFor Parms{};
...
void UDelMarTrackTubeAudioComponent::SetSpline(class USplineComponent* NewSpline)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetSpline");
