...
static_assert(sizeof(ControllableRidableComponent_OnCapsuleBeginOverlap) == 0x000118, "Wrong size on ControllableRidableComponent_OnCapsuleBeginOverlap");
...
static_assert(alignof(ControllableRidableComponent_CanJump) == 0x000001, "Wrong alignment on ControllableRidableComponent_CanJump");
static_assert(sizeof(ControllableRidableComponent_CanJump) == 0x000001, "Wrong size on ControllableRidableComponent_CanJump");
static_assert(offsetof(ControllableRidableComponent_CanJump, ReturnValue) == 0x000000, "Member 'ControllableRidableComponent_CanJump::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ControllableRidableComponent_GetSecondaryAbilityDisplayText) == 0x000008, "Wrong alignment on ControllableRidableComponent_GetSecondaryAbilityDisplayText");
static_assert(sizeof(ControllableRidableComponent_GetSecondaryAbilityDisplayText) == 0x000010, "Wrong size on ControllableRidableComponent_GetSecondaryAbilityDisplayText");
static_assert(offsetof(ControllableRidableComponent_GetSecondaryAbilityDisplayText, ReturnValue) == 0x000000, "Member 'ControllableRidableComponent_GetSecondaryAbilityDisplayText::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ControllableRidableComponent_GetTertiaryAbilityDisplayText) == 0x000008, "Wrong alignment on ControllableRidableComponent_GetTertiaryAbilityDisplayText");
static_assert(sizeof(ControllableRidableComponent_GetTertiaryAbilityDisplayText) == 0x000010, "Wrong size on ControllableRidableComponent_GetTertiaryAbilityDisplayText");
static_assert(offsetof(ControllableRidableComponent_GetTertiaryAbilityDisplayText, ReturnValue) == 0x000000, "Member 'ControllableRidableComponent_GetTertiaryAbilityDisplayText::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(RiderComponent_HandleRidableFound) == 0x0000F8, "Wrong size on RiderComponent_HandleRidableFound");
...
// Function RidingCodeRuntime.RiderComponent.CanBecomeRider
// 0x0001 (0x0001 - 0x0000)
struct RiderComponent_CanBecomeRider final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(RiderComponent_CanBecomeRider) == 0x000001, "Wrong alignment on RiderComponent_CanBecomeRider");
static_assert(sizeof(RiderComponent_CanBecomeRider) == 0x000001, "Wrong size on RiderComponent_CanBecomeRider");
static_assert(offsetof(RiderComponent_CanBecomeRider, ReturnValue) == 0x000000, "Member 'RiderComponent_CanBecomeRider::ReturnValue' has a wrong offset!");

// Function RidingCodeRuntime.RiderComponent.CanRideActor
// 0x0010 (0x0010 - 0x0000)
struct RiderComponent_CanRideActor final
{
public:
	const class AActor*                           RidableActor;                                      // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(RiderComponent_CanRideActor) == 0x000008, "Wrong alignment on RiderComponent_CanRideActor");
static_assert(sizeof(RiderComponent_CanRideActor) == 0x000010, "Wrong size on RiderComponent_CanRideActor");
static_assert(offsetof(RiderComponent_CanRideActor, RidableActor) == 0x000000, "Member 'RiderComponent_CanRideActor::RidableActor' has a wrong offset!");
static_assert(offsetof(RiderComponent_CanRideActor, ReturnValue) == 0x000008, "Member 'RiderComponent_CanRideActor::ReturnValue' has a wrong offset!");
