...
static_assert(offsetof(EventScoreRow_C_SetData, Value) == 0x000010, "Member 'EventScoreRow_C_SetData::Value' has a wrong offset!");
static_assert(offsetof(EventScoreRow_C_SetData, CallFunc_Conv_IntToText_ReturnValue) == 0x000018, "Member 'EventScoreRow_C_SetData::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
