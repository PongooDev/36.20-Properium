...
public:
	...
	struct FGameplayTag                           PlacedCue;                                         // 0x0B70(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGA_TrapBuildGeneric_C) == 0x000B78, "Wrong size on UGA_TrapBuildGeneric_C");
static_assert(offsetof(UGA_TrapBuildGeneric_C, UberGraphFrame) == 0x000B68, "Member 'UGA_TrapBuildGeneric_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGA_TrapBuildGeneric_C, PlacedCue) == 0x000B70, "Member 'UGA_TrapBuildGeneric_C::PlacedCue' has a wrong offset!");
