...
static_assert(sizeof(GCNL_EnvCampFire_Stoke_C_ExecuteUbergraph_GCNL_EnvCampFire_Stoke) == 0x000248, "Wrong size on GCNL_EnvCampFire_Stoke_C_ExecuteUbergraph_GCNL_EnvCampFire_Stoke");
...
static_assert(offsetof(GCNL_EnvCampFire_Stoke_C_ExecuteUbergraph_GCNL_EnvCampFire_Stoke, CallFunc_Less_IntInt_ReturnValue) == 0x000240, "Member 'GCNL_EnvCampFire_Stoke_C_ExecuteUbergraph_GCNL_EnvCampFire_Stoke::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
