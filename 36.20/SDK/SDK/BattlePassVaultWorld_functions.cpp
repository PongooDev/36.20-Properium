...
void ABattlePassVaultWorld_C::AssignMaterials(class AStaticMeshActor* TargetBackground)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("AssignMaterials");

	Params::BattlePassVaultWorld_C_AssignMaterials Parms{};
...
void ABattlePassVaultWorld_C::OnNewSceneBackgroundChildActor(class AFortStaticMeshActor* NewActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::BattlePassVaultWorld_C_OnNewSceneBackgroundChildActor Parms{};
...
// (Event, Protected, BlueprintEvent)
// Parameters:
// EVaultWorldTransitionDirection          TransitionDirection                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABattlePassVaultWorld_C::OnTransitionBackground(EVaultWorldTransitionDirection TransitionDirection, EBackgroundIntensityLevel IntensityTransition)
{
	static class UFunction* Func = nullptr;
...
void ABattlePassVaultWorld_C::OnUpdateDisplay(bool bShowFloor, bool bShowEffects, EFortItemType ItemType)
{
	static class UFunction* Func = nullptr;
