...
// Function SideloadedAnimationRuntime.AnimSequenceSideloaded.SideloadDataFromBuffer
// 0x0018 (0x0018 - 0x0000)
struct AnimSequenceSideloaded_SideloadDataFromBuffer final
{
public:
...
static_assert(alignof(AnimSequenceSideloaded_SideloadDataFromBuffer) == 0x000008, "Wrong alignment on AnimSequenceSideloaded_SideloadDataFromBuffer");
static_assert(sizeof(AnimSequenceSideloaded_SideloadDataFromBuffer) == 0x000018, "Wrong size on AnimSequenceSideloaded_SideloadDataFromBuffer");
static_assert(offsetof(AnimSequenceSideloaded_SideloadDataFromBuffer, Memory) == 0x000000, "Member 'AnimSequenceSideloaded_SideloadDataFromBuffer::Memory' has a wrong offset!");
static_assert(offsetof(AnimSequenceSideloaded_SideloadDataFromBuffer, ReturnValue) == 0x000010, "Member 'AnimSequenceSideloaded_SideloadDataFromBuffer::ReturnValue' has a wrong offset!");
