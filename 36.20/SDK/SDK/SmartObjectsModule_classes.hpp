...
{
public:
	TMulticastInlineDelegate<void(struct FSmartObjectEventData& EventData, class AActor* Interactor)> OnSmartObjectEvent;                                // 0x0240(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, Protected, NativeAccessSpecifierProtected)
	...
	class USmartObjectDefinition*                 CachedDefinitionAssetVariation;                    // 0x02C0(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(USmartObjectComponent, OnSmartObjectEvent) == 0x000240, "Member 'USmartObjectComponent::OnSmartObjectEvent' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, ComponentGuid) == 0x000268, "Member 'USmartObjectComponent::ComponentGuid' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, DefinitionRef) == 0x000278, "Member 'USmartObjectComponent::DefinitionRef' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, RegisteredHandle) == 0x0002A0, "Member 'USmartObjectComponent::RegisteredHandle' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, bCanBePartOfCollection) == 0x0002B9, "Member 'USmartObjectComponent::bCanBePartOfCollection' has a wrong offset!");
static_assert(offsetof(USmartObjectComponent, CachedDefinitionAssetVariation) == 0x0002C0, "Member 'USmartObjectComponent::CachedDefinitionAssetVariation' has a wrong offset!");
...
static_assert(sizeof(USmartObjectDebugRenderingComponent) == 0x000580, "Wrong size on USmartObjectDebugRenderingComponent");
...
static_assert(alignof(USmartObjectDefinition) == 0x000010, "Wrong alignment on USmartObjectDefinition");
...
static_assert(sizeof(ASmartObjectPersistentCollection) == 0x0003B0, "Wrong size on ASmartObjectPersistentCollection");
...
public:
	...
	struct FSmartObjectContainer                  SmartObjectContainer;                              // 0x0060(0x0100)(Transient, ContainsInstancedReference, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_160[0x10];                                     // 0x0160(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<struct FSmartObjectHandle, struct FSmartObjectRuntime> RuntimeSmartObjects;                               // 0x0170(0x0050)(Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	TArray<class USmartObjectComponent*>          RegisteredSOComponents;                            // 0x01C0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<class USmartObjectComponent*>          PendingSmartObjectRegistration;                    // 0x01D0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USmartObjectSubsystem) == 0x0001E8, "Wrong size on USmartObjectSubsystem");
...
static_assert(offsetof(USmartObjectSubsystem, RuntimeSmartObjects) == 0x000170, "Member 'USmartObjectSubsystem::RuntimeSmartObjects' has a wrong offset!");
static_assert(offsetof(USmartObjectSubsystem, RegisteredSOComponents) == 0x0001C0, "Member 'USmartObjectSubsystem::RegisteredSOComponents' has a wrong offset!");
static_assert(offsetof(USmartObjectSubsystem, PendingSmartObjectRegistration) == 0x0001D0, "Member 'USmartObjectSubsystem::PendingSmartObjectRegistration' has a wrong offset!");
...
static_assert(sizeof(USmartObjectSubsystemRenderingComponent) == 0x000580, "Wrong size on USmartObjectSubsystemRenderingComponent");
...
static_assert(sizeof(USmartObjectTestRenderingComponent) == 0x000580, "Wrong size on USmartObjectTestRenderingComponent");
...
static_assert(sizeof(USmartObjectUserComponent) == 0x0000C0, "Wrong size on USmartObjectUserComponent");
static_assert(offsetof(USmartObjectUserComponent, ValidationFilter) == 0x0000B8, "Member 'USmartObjectUserComponent::ValidationFilter' has a wrong offset!");
