...
static_assert(sizeof(UGA_Athena_HidingProp_BlockMovement_C) == 0x000B70, "Wrong size on UGA_Athena_HidingProp_BlockMovement_C");
static_assert(offsetof(UGA_Athena_HidingProp_BlockMovement_C, UberGraphFrame) == 0x000B68, "Member 'UGA_Athena_HidingProp_BlockMovement_C::UberGraphFrame' has a wrong offset!");
