...
static_assert(sizeof(FZoneGraphBuildSettings) == 0x000060, "Wrong size on FZoneGraphBuildSettings");
...
static_assert(offsetof(FZoneGraphBuildSettings, DragEndpointAutoIntersectionRange) == 0x000048, "Member 'FZoneGraphBuildSettings::DragEndpointAutoIntersectionRange' has a wrong offset!");
static_assert(offsetof(FZoneGraphBuildSettings, SnapAutoIntersectionToClosestPointTolerance) == 0x000050, "Member 'FZoneGraphBuildSettings::SnapAutoIntersectionToClosestPointTolerance' has a wrong offset!");
static_assert(offsetof(FZoneGraphBuildSettings, bShow3DRadiusForAutoConnectionAndIntersection) == 0x000058, "Member 'FZoneGraphBuildSettings::bShow3DRadiusForAutoConnectionAndIntersection' has a wrong offset!");
