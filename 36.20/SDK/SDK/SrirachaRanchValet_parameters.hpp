...
static_assert(offsetof(StreamingRadioPlayerComponent_Valet_VehicleExploded, VehicleActor) == 0x000008, "Member 'StreamingRadioPlayerComponent_Valet_VehicleExploded::VehicleActor' has a wrong offset!");
