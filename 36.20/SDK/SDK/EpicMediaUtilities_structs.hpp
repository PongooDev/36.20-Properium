...
// Enum EpicMediaUtilities.EEpicMediaRequestType
// NumValues: 0x0003
enum class EEpicMediaRequestType : uint8
{
	BLURL                                    = 0,
	EPS                                      = 1,
	LOCAL                                    = 2,
...
static_assert(sizeof(FEpicMediaExtraMetadataExt) == 0x000068, "Wrong size on FEpicMediaExtraMetadataExt");
...
static_assert(offsetof(FEpicMediaExtraMetadataExt, Limits) == 0x000058, "Member 'FEpicMediaExtraMetadataExt::Limits' has a wrong offset!");
...
public:
	...
	int32                                         ResponseHTTPCode;                                  // 0x00A0(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bTreatCDNSwitchAsFatal;                            // 0x00A4(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_A5[0x3];                                       // 0x00A5(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEpicMediaRegionLockExt                RegionLockData;                                    // 0x00A8(0x00A8)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	struct FEpicMediaAudioMetadataExt             AudioMetadata;                                     // 0x0150(0x0130)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	bool                                          bQuicksilverEP;                                    // 0x0280(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_281[0x7];                                      // 0x0281(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FEpicMediaExtraMetadataExt             ExtraMetadata;                                     // 0x0288(0x0068)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	EEpicMediaRequestType                         RequestType;                                       // 0x02F0(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2F1[0x17];                                     // 0x02F1(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FEpicMediaMetadataExt) == 0x000008, "Wrong alignment on FEpicMediaMetadataExt");
static_assert(sizeof(FEpicMediaMetadataExt) == 0x000308, "Wrong size on FEpicMediaMetadataExt");
...
static_assert(offsetof(FEpicMediaMetadataExt, ResponseHTTPCode) == 0x0000A0, "Member 'FEpicMediaMetadataExt::ResponseHTTPCode' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, bTreatCDNSwitchAsFatal) == 0x0000A4, "Member 'FEpicMediaMetadataExt::bTreatCDNSwitchAsFatal' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, RegionLockData) == 0x0000A8, "Member 'FEpicMediaMetadataExt::RegionLockData' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, AudioMetadata) == 0x000150, "Member 'FEpicMediaMetadataExt::AudioMetadata' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, bQuicksilverEP) == 0x000280, "Member 'FEpicMediaMetadataExt::bQuicksilverEP' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, ExtraMetadata) == 0x000288, "Member 'FEpicMediaMetadataExt::ExtraMetadata' has a wrong offset!");
static_assert(offsetof(FEpicMediaMetadataExt, RequestType) == 0x0002F0, "Member 'FEpicMediaMetadataExt::RequestType' has a wrong offset!");
