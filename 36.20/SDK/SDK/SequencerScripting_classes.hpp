...
static_assert(sizeof(UMovieSceneScriptingParticleKey) == 0x000058, "Wrong size on UMovieSceneScriptingParticleKey");
...
static_assert(sizeof(UMovieSceneScriptingParticleChannel) == 0x000058, "Wrong size on UMovieSceneScriptingParticleChannel");
