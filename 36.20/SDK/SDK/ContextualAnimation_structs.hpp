...
public:
	...
	class FName                                   Role;                                              // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FContextualAnimWarpPoint>       WarpPoints;                                        // 0x0010(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FContextualAnimWarpTarget>      ExternalWarpTargets;                               // 0x0020(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FContextualAnimRepLateJoinData) == 0x000008, "Wrong alignment on FContextualAnimRepLateJoinData");
static_assert(sizeof(FContextualAnimRepLateJoinData) == 0x000030, "Wrong size on FContextualAnimRepLateJoinData");
...
static_assert(offsetof(FContextualAnimRepLateJoinData, WarpPoints) == 0x000010, "Member 'FContextualAnimRepLateJoinData::WarpPoints' has a wrong offset!");
static_assert(offsetof(FContextualAnimRepLateJoinData, ExternalWarpTargets) == 0x000020, "Member 'FContextualAnimRepLateJoinData::ExternalWarpTargets' has a wrong offset!");
...
public:
	...
	class FName                                   Role;                                              // 0x00E0(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SectionIdx;                                        // 0x00E4(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AnimSetIdx;                                        // 0x00E8(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AnimTrackIdx;                                      // 0x00EC(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FContextualAnimTrack) == 0x000010, "Wrong alignment on FContextualAnimTrack");
static_assert(sizeof(FContextualAnimTrack) == 0x0000F0, "Wrong size on FContextualAnimTrack");
...
static_assert(offsetof(FContextualAnimTrack, SectionIdx) == 0x0000E4, "Member 'FContextualAnimTrack::SectionIdx' has a wrong offset!");
static_assert(offsetof(FContextualAnimTrack, AnimSetIdx) == 0x0000E8, "Member 'FContextualAnimTrack::AnimSetIdx' has a wrong offset!");
static_assert(offsetof(FContextualAnimTrack, AnimTrackIdx) == 0x0000EC, "Member 'FContextualAnimTrack::AnimTrackIdx' has a wrong offset!");
...
public:
	...
	class FName                                   Name;                                              // 0x0060(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         RandomWeight;                                      // 0x0064(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FContextualAnimSet, RandomWeight) == 0x000064, "Member 'FContextualAnimSet::RandomWeight' has a wrong offset!");
...
static_assert(offsetof(FContextualAnimIKTarget, BoneName) == 0x000004, "Member 'FContextualAnimIKTarget::BoneName' has a wrong offset!");
static_assert(offsetof(FContextualAnimIKTarget, Alpha) == 0x000008, "Member 'FContextualAnimIKTarget::Alpha' has a wrong offset!");
