...
static_assert(offsetof(EncounterMobManagerComponent_OnMobActorSpawn, EventData) == 0x000008, "Member 'EncounterMobManagerComponent_OnMobActorSpawn::EventData' has a wrong offset!");
...
static_assert(offsetof(LWMEncounterInstance_OnMobActorSpawn, EventData) == 0x000008, "Member 'LWMEncounterInstance_OnMobActorSpawn::EventData' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct LWMEncounterInstance_OnPointProviderEndPlayed final
{
public:
...
static_assert(alignof(LWMEncounterInstance_OnPointProviderEndPlayed) == 0x000008, "Wrong alignment on LWMEncounterInstance_OnPointProviderEndPlayed");
static_assert(sizeof(LWMEncounterInstance_OnPointProviderEndPlayed) == 0x000010, "Wrong size on LWMEncounterInstance_OnPointProviderEndPlayed");
static_assert(offsetof(LWMEncounterInstance_OnPointProviderEndPlayed, InActor) == 0x000000, "Member 'LWMEncounterInstance_OnPointProviderEndPlayed::InActor' has a wrong offset!");
static_assert(offsetof(LWMEncounterInstance_OnPointProviderEndPlayed, EndPlayReason) == 0x000008, "Member 'LWMEncounterInstance_OnPointProviderEndPlayed::EndPlayReason' has a wrong offset!");
...
public:
	...
	EPersistentValueScope                         PersistenceScope;                                  // 0x0008(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(EncounterManagerComponent_SetPersistentValue) == 0x00000C, "Wrong size on EncounterManagerComponent_SetPersistentValue");
...
static_assert(offsetof(EncounterManagerComponent_SetPersistentValue, PersistenceScope) == 0x000008, "Member 'EncounterManagerComponent_SetPersistentValue::PersistenceScope' has a wrong offset!");

// Function EncountersRuntime.EncounterManagerComponent.GetOverlapComponents
// 0x0010 (0x0010 - 0x0000)
struct EncounterManagerComponent_GetOverlapComponents final
{
public:
	TArray<class UOverlapComponent*>              ReturnValue;                                       // 0x0000(0x0010)(ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_GetOverlapComponents) == 0x000008, "Wrong alignment on EncounterManagerComponent_GetOverlapComponents");
static_assert(sizeof(EncounterManagerComponent_GetOverlapComponents) == 0x000010, "Wrong size on EncounterManagerComponent_GetOverlapComponents");
static_assert(offsetof(EncounterManagerComponent_GetOverlapComponents, ReturnValue) == 0x000000, "Member 'EncounterManagerComponent_GetOverlapComponents::ReturnValue' has a wrong offset!");
...
// 0x0018 (0x0018 - 0x0000)
struct EncounterManagerComponent_GetVariable_DynamicEncounterConfig final
{
public:
	struct FGameplayTag                           VarName;                                           // 0x0000(0x0004)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FDynamicEncounterEntry>         ReturnValue;                                       // 0x0008(0x0010)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_GetVariable_DynamicEncounterConfig) == 0x000008, "Wrong alignment on EncounterManagerComponent_GetVariable_DynamicEncounterConfig");
static_assert(sizeof(EncounterManagerComponent_GetVariable_DynamicEncounterConfig) == 0x000018, "Wrong size on EncounterManagerComponent_GetVariable_DynamicEncounterConfig");
static_assert(offsetof(EncounterManagerComponent_GetVariable_DynamicEncounterConfig, VarName) == 0x000000, "Member 'EncounterManagerComponent_GetVariable_DynamicEncounterConfig::VarName' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_GetVariable_DynamicEncounterConfig, ReturnValue) == 0x000008, "Member 'EncounterManagerComponent_GetVariable_DynamicEncounterConfig::ReturnValue' has a wrong offset!");
...
public:
	struct FGameplayTag                           VarName;                                           // 0x0000(0x0004)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	const class UEncounterFactionData*            ReturnValue;                                       // 0x0008(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_GetVariable_Faction) == 0x000008, "Wrong alignment on EncounterManagerComponent_GetVariable_Faction");
static_assert(sizeof(EncounterManagerComponent_GetVariable_Faction) == 0x000010, "Wrong size on EncounterManagerComponent_GetVariable_Faction");
static_assert(offsetof(EncounterManagerComponent_GetVariable_Faction, VarName) == 0x000000, "Member 'EncounterManagerComponent_GetVariable_Faction::VarName' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_GetVariable_Faction, ReturnValue) == 0x000008, "Member 'EncounterManagerComponent_GetVariable_Faction::ReturnValue' has a wrong offset!");
...
// 0x0010 (0x0010 - 0x0000)
struct EncounterManagerComponent_GetVariable_QuestDefinition final
{
public:
	struct FGameplayTag                           VarName;                                           // 0x0000(0x0004)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	const class UFortQuestItemDefinition*         ReturnValue;                                       // 0x0008(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_GetVariable_QuestDefinition) == 0x000008, "Wrong alignment on EncounterManagerComponent_GetVariable_QuestDefinition");
static_assert(sizeof(EncounterManagerComponent_GetVariable_QuestDefinition) == 0x000010, "Wrong size on EncounterManagerComponent_GetVariable_QuestDefinition");
static_assert(offsetof(EncounterManagerComponent_GetVariable_QuestDefinition, VarName) == 0x000000, "Member 'EncounterManagerComponent_GetVariable_QuestDefinition::VarName' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_GetVariable_QuestDefinition, ReturnValue) == 0x000008, "Member 'EncounterManagerComponent_GetVariable_QuestDefinition::ReturnValue' has a wrong offset!");

// Function EncountersRuntime.EncounterManagerComponent.GetVariable_ScenarioDefinition
// 0x0010 (0x0010 - 0x0000)
struct EncounterManagerComponent_GetVariable_ScenarioDefinition final
{
public:
	struct FGameplayTag                           VarName;                                           // 0x0000(0x0004)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	const class UEncounterItemDefinition*         ReturnValue;                                       // 0x0008(0x0008)(ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_GetVariable_ScenarioDefinition) == 0x000008, "Wrong alignment on EncounterManagerComponent_GetVariable_ScenarioDefinition");
static_assert(sizeof(EncounterManagerComponent_GetVariable_ScenarioDefinition) == 0x000010, "Wrong size on EncounterManagerComponent_GetVariable_ScenarioDefinition");
static_assert(offsetof(EncounterManagerComponent_GetVariable_ScenarioDefinition, VarName) == 0x000000, "Member 'EncounterManagerComponent_GetVariable_ScenarioDefinition::VarName' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_GetVariable_ScenarioDefinition, ReturnValue) == 0x000008, "Member 'EncounterManagerComponent_GetVariable_ScenarioDefinition::ReturnValue' has a wrong offset!");
...
static_assert(alignof(EncounterManagerComponent_GetVariable_String) == 0x000004, "Wrong alignment on EncounterManagerComponent_GetVariable_String");
static_assert(sizeof(EncounterManagerComponent_GetVariable_String) == 0x000008, "Wrong size on EncounterManagerComponent_GetVariable_String");
static_assert(offsetof(EncounterManagerComponent_GetVariable_String, VarName) == 0x000000, "Member 'EncounterManagerComponent_GetVariable_String::VarName' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_GetVariable_String, ReturnValue) == 0x000004, "Member 'EncounterManagerComponent_GetVariable_String::ReturnValue' has a wrong offset!");
...
// 0x0018 (0x0018 - 0x0000)
struct EncounterManagerComponent_TriggerClientReactions final
{
public:
	TArray<struct FInstancedStruct>               Reactions;                                         // 0x0000(0x0010)(ConstParm, Parm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	class AActor*                                 TargetActor;                                       // 0x0010(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(EncounterManagerComponent_TriggerClientReactions) == 0x000008, "Wrong alignment on EncounterManagerComponent_TriggerClientReactions");
static_assert(sizeof(EncounterManagerComponent_TriggerClientReactions) == 0x000018, "Wrong size on EncounterManagerComponent_TriggerClientReactions");
static_assert(offsetof(EncounterManagerComponent_TriggerClientReactions, Reactions) == 0x000000, "Member 'EncounterManagerComponent_TriggerClientReactions::Reactions' has a wrong offset!");
static_assert(offsetof(EncounterManagerComponent_TriggerClientReactions, TargetActor) == 0x000010, "Member 'EncounterManagerComponent_TriggerClientReactions::TargetActor' has a wrong offset!");
