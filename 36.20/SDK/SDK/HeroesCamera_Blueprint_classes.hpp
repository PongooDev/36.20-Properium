...
public:
	...
	bool                                          MouseDown;                                         // 0x0A98(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_A99[0x7];                                      // 0x0A99(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class AFortPlayerPawn*                        Cached_Pawn;                                       // 0x0AA0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AHeroesCamera_Blueprint_C) == 0x000AB0, "Wrong size on AHeroesCamera_Blueprint_C");
static_assert(offsetof(AHeroesCamera_Blueprint_C, UberGraphFrame) == 0x000A90, "Member 'AHeroesCamera_Blueprint_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(AHeroesCamera_Blueprint_C, MouseDown) == 0x000A98, "Member 'AHeroesCamera_Blueprint_C::MouseDown' has a wrong offset!");
static_assert(offsetof(AHeroesCamera_Blueprint_C, Cached_Pawn) == 0x000AA0, "Member 'AHeroesCamera_Blueprint_C::Cached_Pawn' has a wrong offset!");
