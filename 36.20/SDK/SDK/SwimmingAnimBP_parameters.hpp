...
static_assert(offsetof(SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP, Temp_bool_IsClosed_Variable) == 0x000005, "Member 'SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP, Temp_bool_Whether_the_gate_is_currently_open_or_close_Variable) == 0x000006, "Member 'SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP::Temp_bool_Whether_the_gate_is_currently_open_or_close_Variable' has a wrong offset!");
static_assert(offsetof(SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP, K2Node_VariableSet_LocalAccelYawAngleAtStart_ImplicitCast) == 0x000008, "Member 'SwimmingAnimBP_C_ExecuteUbergraph_SwimmingAnimBP::K2Node_VariableSet_LocalAccelYawAngleAtStart_ImplicitCast' has a wrong offset!");
...
// Function SwimmingAnimBP.SwimmingAnimBP_C.MovementMode_InAirOverride
// 0x0030 (0x0030 - 0x0000)
struct SwimmingAnimBP_C_MovementMode_InAirOverride final
{
public:
...
static_assert(alignof(SwimmingAnimBP_C_MovementMode_InAirOverride) == 0x000008, "Wrong alignment on SwimmingAnimBP_C_MovementMode_InAirOverride");
static_assert(sizeof(SwimmingAnimBP_C_MovementMode_InAirOverride) == 0x000030, "Wrong size on SwimmingAnimBP_C_MovementMode_InAirOverride");
static_assert(offsetof(SwimmingAnimBP_C_MovementMode_InAirOverride, InSource_Pose) == 0x000000, "Member 'SwimmingAnimBP_C_MovementMode_InAirOverride::InSource_Pose' has a wrong offset!");
static_assert(offsetof(SwimmingAnimBP_C_MovementMode_InAirOverride, InAirPose) == 0x000010, "Member 'SwimmingAnimBP_C_MovementMode_InAirOverride::InAirPose' has a wrong offset!");
static_assert(offsetof(SwimmingAnimBP_C_MovementMode_InAirOverride, MovementMode_InAirOverride_0) == 0x000020, "Member 'SwimmingAnimBP_C_MovementMode_InAirOverride::MovementMode_InAirOverride_0' has a wrong offset!");
