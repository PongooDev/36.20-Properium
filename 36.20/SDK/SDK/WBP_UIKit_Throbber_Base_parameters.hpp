...
public:
	...
	struct FDeprecateSlateVector2D                K2Node_Select_Default_2;                           // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSlateBrush                            K2Node_MakeStruct_SlateBrush;                      // 0x0080(0x00B0)()
	struct FDeprecateSlateVector2D                K2Node_Select_NewEnumerator2_ImplicitCast;         // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDeprecateSlateVector2D                K2Node_Select_NewEnumerator1_ImplicitCast;         // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDeprecateSlateVector2D                K2Node_Select_NewEnumerator0_ImplicitCast;         // 0x0140(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_UIKit_Throbber_Base_C_SetThrobberSize) == 0x000150, "Wrong size on WBP_UIKit_Throbber_Base_C_SetThrobberSize");
...
static_assert(offsetof(WBP_UIKit_Throbber_Base_C_SetThrobberSize, K2Node_Select_NewEnumerator2_ImplicitCast) == 0x000130, "Member 'WBP_UIKit_Throbber_Base_C_SetThrobberSize::K2Node_Select_NewEnumerator2_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Throbber_Base_C_SetThrobberSize, K2Node_Select_NewEnumerator1_ImplicitCast) == 0x000138, "Member 'WBP_UIKit_Throbber_Base_C_SetThrobberSize::K2Node_Select_NewEnumerator1_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_UIKit_Throbber_Base_C_SetThrobberSize, K2Node_Select_NewEnumerator0_ImplicitCast) == 0x000140, "Member 'WBP_UIKit_Throbber_Base_C_SetThrobberSize::K2Node_Select_NewEnumerator0_ImplicitCast' has a wrong offset!");
