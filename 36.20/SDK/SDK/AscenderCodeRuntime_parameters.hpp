...
// 0x0010 (0x0010 - 0x0000)
struct FortAscenderZipline_IsUsingHandle final
{
public:
	const class AFortPawn*                        PawnToCheck;                                       // 0x0000(0x0008)(ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0008(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_9[0x7];                                        // 0x0009(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FortAscenderZipline_IsUsingHandle) == 0x000008, "Wrong alignment on FortAscenderZipline_IsUsingHandle");
static_assert(sizeof(FortAscenderZipline_IsUsingHandle) == 0x000010, "Wrong size on FortAscenderZipline_IsUsingHandle");
static_assert(offsetof(FortAscenderZipline_IsUsingHandle, PawnToCheck) == 0x000000, "Member 'FortAscenderZipline_IsUsingHandle::PawnToCheck' has a wrong offset!");
static_assert(offsetof(FortAscenderZipline_IsUsingHandle, ReturnValue) == 0x000008, "Member 'FortAscenderZipline_IsUsingHandle::ReturnValue' has a wrong offset!");
