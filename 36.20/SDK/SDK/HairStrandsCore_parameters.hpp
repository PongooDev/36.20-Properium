...
{
public:
	TDelegate<void(class UGroomBindingAsset* GroomBinding, EGroomBindingAssetBuildResult Result)> CompletionDelegate;                                // 0x0000(0x000C)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(GroomBindingAsset_Build) == 0x000004, "Wrong alignment on GroomBindingAsset_Build");
static_assert(sizeof(GroomBindingAsset_Build) == 0x00000C, "Wrong size on GroomBindingAsset_Build");
...
{
public:
	class FName                                   InAttributeName;                                   // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(GroomBindingAsset_SetTargetBindingAttribute) == 0x000004, "Wrong size on GroomBindingAsset_SetTargetBindingAttribute");
...
static_assert(sizeof(GroomBindingAsset_GetTargetBindingAttribute) == 0x000004, "Wrong size on GroomBindingAsset_GetTargetBindingAttribute");
