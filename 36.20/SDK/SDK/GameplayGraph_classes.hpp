...
static_assert(offsetof(UGraph, Vertices) == 0x000088, "Member 'UGraph::Vertices' has a wrong offset!");
static_assert(offsetof(UGraph, Islands) == 0x0000D8, "Member 'UGraph::Islands' has a wrong offset!");
