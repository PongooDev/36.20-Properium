...
static_assert(alignof(FSmartObjectSlotEntranceHandle) == 0x000004, "Wrong alignment on FSmartObjectSlotEntranceHandle");
...
public:
	...
	struct FGameplayTag                           Tag;                                               // 0x0028(0x0004)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(FSmartObjectBindingCollection) == 0x000010, "Wrong alignment on FSmartObjectBindingCollection");
...
{
public:
	TSoftClassPtr<class UClass>                   ObjectActorClass;                                  // 0x0000(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        ObjectMeshPath;                                    // 0x0020(0x0018)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   UserActorClass;                                    // 0x0038(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftClassPtr<class UClass>                   UserValidationFilterClass;                         // 0x0058(0x0020)(Edit, BlueprintVisible, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(alignof(FConstSmartObjectSlotView) == 0x000008, "Wrong alignment on FConstSmartObjectSlotView");
