...
static_assert(alignof(MeshMaterialTweening_BP_ScalarParamTo) == 0x000008, "Wrong alignment on MeshMaterialTweening_BP_ScalarParamTo");
static_assert(sizeof(MeshMaterialTweening_BP_ScalarParamTo) == 0x000058, "Wrong size on MeshMaterialTweening_BP_ScalarParamTo");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, OutTweenId) == 0x000000, "Member 'MeshMaterialTweening_BP_ScalarParamTo::OutTweenId' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, ContextObject) == 0x000008, "Member 'MeshMaterialTweening_BP_ScalarParamTo::ContextObject' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, Target) == 0x000010, "Member 'MeshMaterialTweening_BP_ScalarParamTo::Target' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, ParameterName) == 0x000018, "Member 'MeshMaterialTweening_BP_ScalarParamTo::ParameterName' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, FromOptions) == 0x00001C, "Member 'MeshMaterialTweening_BP_ScalarParamTo::FromOptions' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, ToValue) == 0x000024, "Member 'MeshMaterialTweening_BP_ScalarParamTo::ToValue' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, bIsRelative) == 0x000028, "Member 'MeshMaterialTweening_BP_ScalarParamTo::bIsRelative' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, duration) == 0x00002C, "Member 'MeshMaterialTweening_BP_ScalarParamTo::duration' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, DelayOptions) == 0x000030, "Member 'MeshMaterialTweening_BP_ScalarParamTo::DelayOptions' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, EasingFunction) == 0x00003C, "Member 'MeshMaterialTweening_BP_ScalarParamTo::EasingFunction' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, EasingCurve) == 0x000040, "Member 'MeshMaterialTweening_BP_ScalarParamTo::EasingCurve' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, LoopOptions) == 0x000048, "Member 'MeshMaterialTweening_BP_ScalarParamTo::LoopOptions' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, bAutoPlay) == 0x000050, "Member 'MeshMaterialTweening_BP_ScalarParamTo::bAutoPlay' has a wrong offset!");
static_assert(offsetof(MeshMaterialTweening_BP_ScalarParamTo, bAutoKill) == 0x000051, "Member 'MeshMaterialTweening_BP_ScalarParamTo::bAutoKill' has a wrong offset!");
