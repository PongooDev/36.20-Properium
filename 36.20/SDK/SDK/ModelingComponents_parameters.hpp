...
static_assert(offsetof(ModelingObjectsCreationAPI_CreateMeshObject, ReturnValue) == 0x0006B0, "Member 'ModelingObjectsCreationAPI_CreateMeshObject::ReturnValue' has a wrong offset!");
...
static_assert(alignof(ModelingObjectsCreationAPI_CreateNewComponentOnActor) == 0x000008, "Wrong alignment on ModelingObjectsCreationAPI_CreateNewComponentOnActor");
