...
public:
	...
	struct FGameplayTag                           TC_AbilitiesGenericTriggeredAbilityActivate;       // 0x0B70(0x0004)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	bool                                          bPlayerHolsterState;                               // 0x0B74(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UGAT_TriggeredAbility_C) == 0x000B78, "Wrong size on UGAT_TriggeredAbility_C");
static_assert(offsetof(UGAT_TriggeredAbility_C, UberGraphFrame) == 0x000B68, "Member 'UGAT_TriggeredAbility_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, TC_AbilitiesGenericTriggeredAbilityActivate) == 0x000B70, "Member 'UGAT_TriggeredAbility_C::TC_AbilitiesGenericTriggeredAbilityActivate' has a wrong offset!");
static_assert(offsetof(UGAT_TriggeredAbility_C, bPlayerHolsterState) == 0x000B74, "Member 'UGAT_TriggeredAbility_C::bPlayerHolsterState' has a wrong offset!");
