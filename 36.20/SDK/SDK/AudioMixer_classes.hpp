...
public:
	...
	TMulticastInlineDelegate<void(float EnvelopeValue)> OnAudioEnvelopeValue;                              // 0x0838(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	class USoundWave*                             SoundWaveToScrub;                                  // 0x0438(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UScrubbedSound) == 0x000440, "Wrong size on UScrubbedSound");
static_assert(offsetof(UScrubbedSound, SoundWaveToScrub) == 0x000438, "Member 'UScrubbedSound::SoundWaveToScrub' has a wrong offset!");
...
static_assert(offsetof(USynthSound, OwningSynthComponent) == 0x000460, "Member 'USynthSound::OwningSynthComponent' has a wrong offset!");
