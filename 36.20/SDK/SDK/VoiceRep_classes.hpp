...
{
public:
	class UCommonTextBlock*                       Text_VoiceReportingTitle;                          // 0x0450(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UFortVoiceReportIntroModal) == 0x000460, "Wrong size on UFortVoiceReportIntroModal");
static_assert(offsetof(UFortVoiceReportIntroModal, Text_VoiceReportingTitle) == 0x000450, "Member 'UFortVoiceReportIntroModal::Text_VoiceReportingTitle' has a wrong offset!");
...
{
public:
	int32                                         AutoDismissTimerInterval;                          // 0x04B8(0x0004)(ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UVoiceRepTooltipBase) == 0x0004C0, "Wrong size on UVoiceRepTooltipBase");
static_assert(offsetof(UVoiceRepTooltipBase, AutoDismissTimerInterval) == 0x0004B8, "Member 'UVoiceRepTooltipBase::AutoDismissTimerInterval' has a wrong offset!");
