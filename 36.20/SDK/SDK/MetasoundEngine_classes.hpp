...
public:
	bool UnwatchOutput(class UAudioComponent* AudioComponent, class FName OutputName, const TDelegate<void(class FName OutputName, struct FMetaSoundOutput& Output)>& OnOutputValueChanged, class FName AnalyzerName, class FName AnalyzerOutputName);
...
public:
	...
	class FName                                   TargetPageName;                                    // 0x0074(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FMetaSoundPageSettings                 DefaultPageSettings;                               // 0x0078(0x0014)(Edit, Config, NoDestructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_8C[0x4];                                       // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FMetaSoundPageSettings>         PageSettings;                                      // 0x0090(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate)
	TArray<struct FMetaSoundQualitySettings>      QualitySettings;                                   // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UMetaSoundSettings) == 0x0000B8, "Wrong size on UMetaSoundSettings");
...
static_assert(offsetof(UMetaSoundSettings, TargetPageName) == 0x000074, "Member 'UMetaSoundSettings::TargetPageName' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, DefaultPageSettings) == 0x000078, "Member 'UMetaSoundSettings::DefaultPageSettings' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, PageSettings) == 0x000090, "Member 'UMetaSoundSettings::PageSettings' has a wrong offset!");
static_assert(offsetof(UMetaSoundSettings, QualitySettings) == 0x0000A0, "Member 'UMetaSoundSettings::QualitySettings' has a wrong offset!");
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x0068(0x0180)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x01E8(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0238(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x0288(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMetaSoundPatch) == 0x0002E0, "Wrong size on UMetaSoundPatch");
static_assert(offsetof(UMetaSoundPatch, RootMetaSoundDocument) == 0x000068, "Member 'UMetaSoundPatch::RootMetaSoundDocument' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassKeys) == 0x0001E8, "Member 'UMetaSoundPatch::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferencedAssetClassObjects) == 0x000238, "Member 'UMetaSoundPatch::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundPatch, ReferenceAssetClassCache) == 0x000288, "Member 'UMetaSoundPatch::ReferenceAssetClassCache' has a wrong offset!");
...
{
public:
	struct FMetaSoundFrontendDocumentBuilder      Builder;                                           // 0x0028(0x0050)(Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UMetaSoundBuilderBase) == 0x000098, "Wrong size on UMetaSoundBuilderBase");
...
static_assert(sizeof(UMetaSoundPatchBuilder) == 0x000098, "Wrong size on UMetaSoundPatchBuilder");
...
static_assert(sizeof(UMetaSoundSourceBuilder) == 0x0000C0, "Wrong size on UMetaSoundSourceBuilder");
...
public:
	...
	struct FMetasoundFrontendDocument             RootMetaSoundDocument;                             // 0x04A0(0x0180)(Edit, Protected, NativeAccessSpecifierProtected)
	TSet<class FString>                           ReferencedAssetClassKeys;                          // 0x0620(0x0050)(Protected, NativeAccessSpecifierProtected)
	TSet<class UObject*>                          ReferencedAssetClassObjects;                       // 0x0670(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TSet<struct FSoftObjectPath>                  ReferenceAssetClassCache;                          // 0x06C0(0x0050)(Protected, NativeAccessSpecifierProtected)
	EMetaSoundOutputAudioFormat                   OutputFormat;                                      // 0x0710(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_711[0x17F];                                    // 0x0711(0x017F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassKeys) == 0x000620, "Member 'UMetaSoundSource::ReferencedAssetClassKeys' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferencedAssetClassObjects) == 0x000670, "Member 'UMetaSoundSource::ReferencedAssetClassObjects' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, ReferenceAssetClassCache) == 0x0006C0, "Member 'UMetaSoundSource::ReferenceAssetClassCache' has a wrong offset!");
static_assert(offsetof(UMetaSoundSource, OutputFormat) == 0x000710, "Member 'UMetaSoundSource::OutputFormat' has a wrong offset!");
