...
static_assert(sizeof(UDataAssetDirectoryTestPODAsset) == 0x000070, "Wrong size on UDataAssetDirectoryTestPODAsset");
...
static_assert(sizeof(UDataAssetDirectoryTestStructAsset) == 0x000060, "Wrong size on UDataAssetDirectoryTestStructAsset");
