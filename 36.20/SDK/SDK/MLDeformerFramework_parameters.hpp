...
static_assert(offsetof(MLDeformerComponent_GetModelInstance, ReturnValue) == 0x000000, "Member 'MLDeformerComponent_GetModelInstance::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MLDeformerModel_SetTrainingDevice) == 0x000008, "Wrong alignment on MLDeformerModel_SetTrainingDevice");
static_assert(sizeof(MLDeformerModel_SetTrainingDevice) == 0x000010, "Wrong size on MLDeformerModel_SetTrainingDevice");
static_assert(offsetof(MLDeformerModel_SetTrainingDevice, DeviceName) == 0x000000, "Member 'MLDeformerModel_SetTrainingDevice::DeviceName' has a wrong offset!");
...
static_assert(alignof(MLDeformerModel_GetTrainingDevice) == 0x000008, "Wrong alignment on MLDeformerModel_GetTrainingDevice");
static_assert(sizeof(MLDeformerModel_GetTrainingDevice) == 0x000010, "Wrong size on MLDeformerModel_GetTrainingDevice");
static_assert(offsetof(MLDeformerModel_GetTrainingDevice, ReturnValue) == 0x000000, "Member 'MLDeformerModel_GetTrainingDevice::ReturnValue' has a wrong offset!");
...
static_assert(alignof(MLDeformerModel_GetTrainingDeviceList) == 0x000008, "Wrong alignment on MLDeformerModel_GetTrainingDeviceList");
static_assert(sizeof(MLDeformerModel_GetTrainingDeviceList) == 0x000010, "Wrong size on MLDeformerModel_GetTrainingDeviceList");
static_assert(offsetof(MLDeformerModel_GetTrainingDeviceList, ReturnValue) == 0x000000, "Member 'MLDeformerModel_GetTrainingDeviceList::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(MLDeformerMorphModel_CanDynamicallyUpdateMorphTargets, ReturnValue) == 0x000000, "Member 'MLDeformerMorphModel_CanDynamicallyUpdateMorphTargets::ReturnValue' has a wrong offset!");
