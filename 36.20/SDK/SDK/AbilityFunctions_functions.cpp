...
// (Static, Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class UFortGameplayAbility*             ability                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// double                                  Distance                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAbilityFunctions_C::GetDistanceFromOwnerToAITarget(class UFortGameplayAbility* ability, class UObject* __WorldContext, double* Distance)
{
	static class UFunction* Func = nullptr;
	class UClass* StaticClss = StaticClass();

	if (Func == nullptr)
		Func = StaticClss->FindFunction("GetDistanceFromOwnerToAITarget");

	Params::AbilityFunctions_C_GetDistanceFromOwnerToAITarget Parms{};
...
double UAbilityFunctions_C::CalculateRootMotionDuration(double Distance, double Speed, bool ClampMinMax_, double MinDuration, double MaxDuration, class UObject* __WorldContext)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CalculateRootMotionDuration");
