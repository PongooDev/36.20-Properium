...
bool UGA_Athena_ZipLine_SmashParent_C::GetOnlyRemoveFallDmgImmunityOnLandOrWaterEvents()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("GetOnlyRemoveFallDmgImmunityOnLandOrWaterEvents");

	Params::GA_Athena_ZipLine_SmashParent_C_GetOnlyRemoveFallDmgImmunityOnLandOrWaterEvents Parms{};
...
// Function GA_Athena_ZipLine_SmashParent.GA_Athena_ZipLine_SmashParent_C.OnPawnDBNO
// (BlueprintCallable, BlueprintEvent)

void UGA_Athena_ZipLine_SmashParent_C::OnPawnDBNO()
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("OnPawnDBNO");
