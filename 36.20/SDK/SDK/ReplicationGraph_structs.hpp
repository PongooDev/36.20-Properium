...
public:
	...
	uint8                                         Pad_12[0x42];                                      // 0x0012(0x0042)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CullDistance;                                      // 0x0054(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         CullDistanceSquared;                               // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(FClassReplicationInfo, CullDistance) == 0x000054, "Member 'FClassReplicationInfo::CullDistance' has a wrong offset!");
static_assert(offsetof(FClassReplicationInfo, CullDistanceSquared) == 0x000058, "Member 'FClassReplicationInfo::CullDistanceSquared' has a wrong offset!");
