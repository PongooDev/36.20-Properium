...
public:
	...
	TSoftObjectPtr<class UMaterialInterface>      MapMaskMaterialOverride;                           // 0x0058(0x0020)(Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(CRDMapCustomizationComponent_SetOverrideMapMaterial) == 0x000078, "Wrong size on CRDMapCustomizationComponent_SetOverrideMapMaterial");
...
static_assert(offsetof(CRDMapCustomizationComponent_SetOverrideMapMaterial, MapMaskMaterialOverride) == 0x000058, "Member 'CRDMapCustomizationComponent_SetOverrideMapMaterial::MapMaskMaterialOverride' has a wrong offset!");
...
static_assert(sizeof(CRDMapCustomizationComponent_SetOverrideMapTexture) == 0x000078, "Wrong size on CRDMapCustomizationComponent_SetOverrideMapTexture");
...
static_assert(offsetof(CRDMapCustomizationComponent_SetOverrideMapTexture, MapMaskMaterialOverride) == 0x000058, "Member 'CRDMapCustomizationComponent_SetOverrideMapTexture::MapMaskMaterialOverride' has a wrong offset!");

// Function MapDevice.CRDMapCustomizationComponent.SetOverrideMapUISettings
// 0x0060 (0x0060 - 0x0000)
struct CRDMapCustomizationComponent_SetOverrideMapUISettings final
{
public:
	float                                         MapWalkingOpacity;                                 // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateFontInfo                         DefaultMapLocationFont;                            // 0x0008(0x0058)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(CRDMapCustomizationComponent_SetOverrideMapUISettings) == 0x000008, "Wrong alignment on CRDMapCustomizationComponent_SetOverrideMapUISettings");
static_assert(sizeof(CRDMapCustomizationComponent_SetOverrideMapUISettings) == 0x000060, "Wrong size on CRDMapCustomizationComponent_SetOverrideMapUISettings");
static_assert(offsetof(CRDMapCustomizationComponent_SetOverrideMapUISettings, MapWalkingOpacity) == 0x000000, "Member 'CRDMapCustomizationComponent_SetOverrideMapUISettings::MapWalkingOpacity' has a wrong offset!");
static_assert(offsetof(CRDMapCustomizationComponent_SetOverrideMapUISettings, DefaultMapLocationFont) == 0x000008, "Member 'CRDMapCustomizationComponent_SetOverrideMapUISettings::DefaultMapLocationFont' has a wrong offset!");
