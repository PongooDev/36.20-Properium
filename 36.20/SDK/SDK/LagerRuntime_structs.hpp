...
// Enum LagerRuntime.EFortAthenaLivingWorldEventToDebugLogOnEnd
// NumValues: 0x0002
enum class EFortAthenaLivingWorldEventToDebugLogOnEnd : uint8
{
	Yes                                      = 0,
	No                                       = 1,
};
...
// Enum LagerRuntime.EFortEQSLWPointProviderSelectorMode
// NumValues: 0x0002
enum class EFortEQSLWPointProviderSelectorMode : uint8
{
	Best                                     = 0,
	Random                                   = 1,
};
...
public:
	...
	bool                                          bPreloadOnClient;                                  // 0x0088(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_89[0x7];                                       // 0x0089(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldActorLoadDescription) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldActorLoadDescription");
static_assert(sizeof(FFortAthenaLivingWorldActorLoadDescription) == 0x000090, "Wrong size on FFortAthenaLivingWorldActorLoadDescription");
static_assert(offsetof(FFortAthenaLivingWorldActorLoadDescription, ActorClass) == 0x000000, "Member 'FFortAthenaLivingWorldActorLoadDescription::ActorClass' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorLoadDescription, SpawnerData) == 0x000020, "Member 'FFortAthenaLivingWorldActorLoadDescription::SpawnerData' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorLoadDescription, SpawnerDataTagQuery) == 0x000040, "Member 'FFortAthenaLivingWorldActorLoadDescription::SpawnerDataTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorLoadDescription, bPreloadOnClient) == 0x000088, "Member 'FFortAthenaLivingWorldActorLoadDescription::bPreloadOnClient' has a wrong offset!");
...
{
public:
	struct FScalableFloat                         ActorDensityValue;                                 // 0x0090(0x0028)(Edit, NativeAccessSpecifierPublic)
	struct FScalableFloat                         DensityComputationRangeOverride;                   // 0x00B8(0x0028)(Edit, NativeAccessSpecifierPublic)
	TArray<struct FFortAthenaLivingWorldEventTagDensityRegistration> TagDensityRegistrations;                           // 0x00E0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct FFortAthenaLivingWorldTagTimer> PostDestructionTagDensityPersistenceDuration;      // 0x00F0(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(FFortAthenaLivingWorldActorSpawnDescription, ActorDensityValue) == 0x000090, "Member 'FFortAthenaLivingWorldActorSpawnDescription::ActorDensityValue' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorSpawnDescription, DensityComputationRangeOverride) == 0x0000B8, "Member 'FFortAthenaLivingWorldActorSpawnDescription::DensityComputationRangeOverride' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorSpawnDescription, TagDensityRegistrations) == 0x0000E0, "Member 'FFortAthenaLivingWorldActorSpawnDescription::TagDensityRegistrations' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldActorSpawnDescription, PostDestructionTagDensityPersistenceDuration) == 0x0000F0, "Member 'FFortAthenaLivingWorldActorSpawnDescription::PostDestructionTagDensityPersistenceDuration' has a wrong offset!");
...
{
public:
	struct FGuid                                  ActorSpawnerGuid;                                  // 0x0000(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortAthenaLivingWorldActorSpawnDescription ActorDescription;                                  // 0x0010(0x0100)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
...
// ScriptStruct LagerRuntime.Variable_LWMEncounter
// 0x0010 (0x0020 - 0x0010)
struct FVariable_LWMEncounter final : public FVariable
{
public:
	struct FDataTableRowHandle                    RowValue;                                          // 0x0010(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariable_LWMEncounter) == 0x000008, "Wrong alignment on FVariable_LWMEncounter");
static_assert(sizeof(FVariable_LWMEncounter) == 0x000020, "Wrong size on FVariable_LWMEncounter");
static_assert(offsetof(FVariable_LWMEncounter, RowValue) == 0x000010, "Member 'FVariable_LWMEncounter::RowValue' has a wrong offset!");
...
static_assert(offsetof(FLivingWorldCalendarEventCondition, Behavior) == 0x000010, "Member 'FLivingWorldCalendarEventCondition::Behavior' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, ShouldEventBeActive) == 0x000011, "Member 'FLivingWorldCalendarEventCondition::ShouldEventBeActive' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioBehavior) == 0x000012, "Member 'FLivingWorldCalendarEventCondition::RatioBehavior' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioValue) == 0x000014, "Member 'FLivingWorldCalendarEventCondition::RatioValue' has a wrong offset!");
static_assert(offsetof(FLivingWorldCalendarEventCondition, RatioMaxValue) == 0x000018, "Member 'FLivingWorldCalendarEventCondition::RatioMaxValue' has a wrong offset!");
...
static_assert(alignof(FFortAthenaLivingWorldLiveCapture) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldLiveCapture");
static_assert(sizeof(FFortAthenaLivingWorldLiveCapture) == 0x000098, "Wrong size on FFortAthenaLivingWorldLiveCapture");
...
// ScriptStruct LagerRuntime.VariableSelectionsRow_LWMEncounter
// 0x0020 (0x0068 - 0x0048)
struct FVariableSelectionsRow_LWMEncounter final : public FVariableSelectionsRow
{
public:
	struct FDataRegistryOrTableRow                RowValue;                                          // 0x0048(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariableSelectionsRow_LWMEncounter) == 0x000008, "Wrong alignment on FVariableSelectionsRow_LWMEncounter");
static_assert(sizeof(FVariableSelectionsRow_LWMEncounter) == 0x000068, "Wrong size on FVariableSelectionsRow_LWMEncounter");
static_assert(offsetof(FVariableSelectionsRow_LWMEncounter, RowValue) == 0x000048, "Member 'FVariableSelectionsRow_LWMEncounter::RowValue' has a wrong offset!");
...
// ScriptStruct LagerRuntime.FortAthenaLivingWorldEventDataRuntime
// 0x00A0 (0x00A0 - 0x0000)
struct FFortAthenaLivingWorldEventDataRuntime final
{
public:
	uint8                                         Pad_0[0x10];                                       // 0x0000(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TScriptInterface<class IFortAthenaLivingWorldPointProviderInterface>> MatchingPointProviders;                            // 0x0010(0x0010)(ZeroConstructor, Transient, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_20[0x50];                                      // 0x0020(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	struct FInstancedStruct                       PointProviderSelector;                             // 0x0070(0x0010)(Transient, NativeAccessSpecifierPublic)
	struct FInstancedStruct                       SpawnerDataSelector;                               // 0x0080(0x0010)(Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_90[0x10];                                      // 0x0090(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldEventDataRuntime) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldEventDataRuntime");
static_assert(sizeof(FFortAthenaLivingWorldEventDataRuntime) == 0x0000A0, "Wrong size on FFortAthenaLivingWorldEventDataRuntime");
static_assert(offsetof(FFortAthenaLivingWorldEventDataRuntime, MatchingPointProviders) == 0x000010, "Member 'FFortAthenaLivingWorldEventDataRuntime::MatchingPointProviders' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEventDataRuntime, PointProviderSelector) == 0x000070, "Member 'FFortAthenaLivingWorldEventDataRuntime::PointProviderSelector' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEventDataRuntime, SpawnerDataSelector) == 0x000080, "Member 'FFortAthenaLivingWorldEventDataRuntime::SpawnerDataSelector' has a wrong offset!");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldEventRuntimeSpawnData
// 0x0048 (0x0048 - 0x0000)
struct alignas(0x08) FFortAthenaLivingWorldEventRuntimeSpawnData final
{
public:
	uint8                                         Pad_0[0x48];                                       // 0x0000(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldEventRuntimeSpawnData) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldEventRuntimeSpawnData");
static_assert(sizeof(FFortAthenaLivingWorldEventRuntimeSpawnData) == 0x000048, "Wrong size on FFortAthenaLivingWorldEventRuntimeSpawnData");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldEventRuntime
// 0x0048 (0x0048 - 0x0000)
struct FFortAthenaLivingWorldEventRuntime final
{
public:
	TArray<struct FFortAthenaLivingWorldEventDataRuntime> EventDataRuntimes;                                 // 0x0000(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<struct FFortAthenaLivingWorldEventRuntimeSpawnData> RuntimeSpawnDatas;                                 // 0x0010(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_20[0x28];                                      // 0x0020(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldEventRuntime) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldEventRuntime");
static_assert(sizeof(FFortAthenaLivingWorldEventRuntime) == 0x000048, "Wrong size on FFortAthenaLivingWorldEventRuntime");
static_assert(offsetof(FFortAthenaLivingWorldEventRuntime, EventDataRuntimes) == 0x000000, "Member 'FFortAthenaLivingWorldEventRuntime::EventDataRuntimes' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEventRuntime, RuntimeSpawnDatas) == 0x000010, "Member 'FFortAthenaLivingWorldEventRuntime::RuntimeSpawnDatas' has a wrong offset!");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldPrefabActorSpawnerDataOverride
// 0x0008 (0x0118 - 0x0110)
struct FFortAthenaLivingWorldPrefabActorSpawnerDataOverride final : public FFortAthenaLivingWorldPrefabActorSpawnerData
{
public:
	bool                                          bRemove;                                           // 0x0110(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_111[0x7];                                      // 0x0111(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldPrefabActorSpawnerDataOverride) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldPrefabActorSpawnerDataOverride");
static_assert(sizeof(FFortAthenaLivingWorldPrefabActorSpawnerDataOverride) == 0x000118, "Wrong size on FFortAthenaLivingWorldPrefabActorSpawnerDataOverride");
static_assert(offsetof(FFortAthenaLivingWorldPrefabActorSpawnerDataOverride, bRemove) == 0x000110, "Member 'FFortAthenaLivingWorldPrefabActorSpawnerDataOverride::bRemove' has a wrong offset!");
...
// ScriptStruct LagerRuntime.FortAthenaLivingWorldGridHLODData
// 0x0028 (0x0028 - 0x0000)
struct FFortAthenaLivingWorldGridHLODData final
{
public:
	TSoftObjectPtr<class UWorld>                  WorldAsset;                                        // 0x0000(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   TargetGridName;                                    // 0x0020(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_24[0x4];                                       // 0x0024(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldGridHLODData) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldGridHLODData");
static_assert(sizeof(FFortAthenaLivingWorldGridHLODData) == 0x000028, "Wrong size on FFortAthenaLivingWorldGridHLODData");
static_assert(offsetof(FFortAthenaLivingWorldGridHLODData, WorldAsset) == 0x000000, "Member 'FFortAthenaLivingWorldGridHLODData::WorldAsset' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridHLODData, TargetGridName) == 0x000020, "Member 'FFortAthenaLivingWorldGridHLODData::TargetGridName' has a wrong offset!");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldGridInjectionData
// 0x0030 (0x0030 - 0x0000)
struct FFortAthenaLivingWorldGridInjectionData final
{
public:
	class FName                                   TargetGridName;                                    // 0x0000(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 LevelNameSuffix;                                   // 0x0008(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         StreamingPriority;                                 // 0x0018(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FFortAthenaLivingWorldGridHLODData> HLODData;                                          // 0x0020(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAthenaLivingWorldGridInjectionData) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldGridInjectionData");
static_assert(sizeof(FFortAthenaLivingWorldGridInjectionData) == 0x000030, "Wrong size on FFortAthenaLivingWorldGridInjectionData");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionData, TargetGridName) == 0x000000, "Member 'FFortAthenaLivingWorldGridInjectionData::TargetGridName' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionData, LevelNameSuffix) == 0x000008, "Member 'FFortAthenaLivingWorldGridInjectionData::LevelNameSuffix' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionData, StreamingPriority) == 0x000018, "Member 'FFortAthenaLivingWorldGridInjectionData::StreamingPriority' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionData, HLODData) == 0x000020, "Member 'FFortAthenaLivingWorldGridInjectionData::HLODData' has a wrong offset!");
...
public:
	...
	struct FGameplayTagQuery                      PlaylistTagQuery;                                  // 0x0020(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UFortAthenaLivingWorldConfigData> LagerConfig;                                       // 0x0068(0x0020)(Edit, DisableEditOnInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortReleaseVersion                    StartVersion;                                      // 0x0088(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortReleaseVersion                    EndVersion;                                        // 0x008C(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortLivingWorldConfigOverride) == 0x000008, "Wrong alignment on FFortLivingWorldConfigOverride");
static_assert(sizeof(FFortLivingWorldConfigOverride) == 0x000090, "Wrong size on FFortLivingWorldConfigOverride");
...
static_assert(offsetof(FFortLivingWorldConfigOverride, PlaylistTagQuery) == 0x000020, "Member 'FFortLivingWorldConfigOverride::PlaylistTagQuery' has a wrong offset!");
static_assert(offsetof(FFortLivingWorldConfigOverride, LagerConfig) == 0x000068, "Member 'FFortLivingWorldConfigOverride::LagerConfig' has a wrong offset!");
static_assert(offsetof(FFortLivingWorldConfigOverride, StartVersion) == 0x000088, "Member 'FFortLivingWorldConfigOverride::StartVersion' has a wrong offset!");
static_assert(offsetof(FFortLivingWorldConfigOverride, EndVersion) == 0x00008C, "Member 'FFortLivingWorldConfigOverride::EndVersion' has a wrong offset!");
...
// ScriptStruct LagerRuntime.FortAthenaLivingWorldGridInjectionRuntimeData
// 0x0114 (0x0120 - 0x000C)
struct FFortAthenaLivingWorldGridInjectionRuntimeData final : public FFastArraySerializerItem
{
public:
	uint8                                         Pad_C[0x4];                                        // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTransform                             InjectionTransform;                                // 0x0010(0x0060)(IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FBox                                   LevelBound;                                        // 0x0070(0x0038)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UWorld>                  WorldAsset;                                        // 0x00A8(0x0020)(UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class AFortAthenaLivingWorldPrefab> Prefab;                                            // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  PrefabGuid;                                        // 0x00D0(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGuid                                  RuntimeCellGuid;                                   // 0x00E0(0x0010)(ZeroConstructor, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFortAthenaLivingWorldGridInjectionData InjectionData;                                     // 0x00F0(0x0030)(NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAthenaLivingWorldGridInjectionRuntimeData) == 0x000010, "Wrong alignment on FFortAthenaLivingWorldGridInjectionRuntimeData");
static_assert(sizeof(FFortAthenaLivingWorldGridInjectionRuntimeData) == 0x000120, "Wrong size on FFortAthenaLivingWorldGridInjectionRuntimeData");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, InjectionTransform) == 0x000010, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::InjectionTransform' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, LevelBound) == 0x000070, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::LevelBound' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, WorldAsset) == 0x0000A8, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::WorldAsset' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, Prefab) == 0x0000C8, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::Prefab' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, PrefabGuid) == 0x0000D0, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::PrefabGuid' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, RuntimeCellGuid) == 0x0000E0, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::RuntimeCellGuid' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionRuntimeData, InjectionData) == 0x0000F0, "Member 'FFortAthenaLivingWorldGridInjectionRuntimeData::InjectionData' has a wrong offset!");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldEventWrapper
// 0x0008 (0x0008 - 0x0000)
struct alignas(0x08) FFortAthenaLivingWorldEventWrapper final
{
public:
	uint8                                         Pad_0[0x8];                                        // 0x0000(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortAthenaLivingWorldEventWrapper) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldEventWrapper");
static_assert(sizeof(FFortAthenaLivingWorldEventWrapper) == 0x000008, "Wrong size on FFortAthenaLivingWorldEventWrapper");
...
static_assert(offsetof(FFortLivingWorldEventTableVariation, VariationWeight) == 0x000030, "Member 'FFortLivingWorldEventTableVariation::VariationWeight' has a wrong offset!");
...
public:
	...
	TArray<struct FFortAthenaLivingWorldActorLoadDescription> ActorsToPreload;                                   // 0x00D0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         IsEnabled;                                         // 0x00E0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortAthenaLivingWorldCategory) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldCategory");
static_assert(sizeof(FFortAthenaLivingWorldCategory) == 0x000108, "Wrong size on FFortAthenaLivingWorldCategory");
...
static_assert(offsetof(FFortAthenaLivingWorldCategory, EventTableVariations) == 0x000038, "Member 'FFortAthenaLivingWorldCategory::EventTableVariations' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, MaxCount) == 0x000048, "Member 'FFortAthenaLivingWorldCategory::MaxCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, MaxSpawnedCount) == 0x00004C, "Member 'FFortAthenaLivingWorldCategory::MaxSpawnedCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, EventInstanceMaxCount) == 0x000050, "Member 'FFortAthenaLivingWorldCategory::EventInstanceMaxCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, EventInstanceMaxSpawnedCount) == 0x000054, "Member 'FFortAthenaLivingWorldCategory::EventInstanceMaxSpawnedCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, CanSpawnCondition) == 0x000058, "Member 'FFortAthenaLivingWorldCategory::CanSpawnCondition' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, Priority) == 0x000070, "Member 'FFortAthenaLivingWorldCategory::Priority' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, bExcludeFromGlobalAIBudget) == 0x000074, "Member 'FFortAthenaLivingWorldCategory::bExcludeFromGlobalAIBudget' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, RequirePlaylistTagQuery) == 0x000078, "Member 'FFortAthenaLivingWorldCategory::RequirePlaylistTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, Encounters) == 0x0000C0, "Member 'FFortAthenaLivingWorldCategory::Encounters' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, ActorsToPreload) == 0x0000D0, "Member 'FFortAthenaLivingWorldCategory::ActorsToPreload' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldCategory, IsEnabled) == 0x0000E0, "Member 'FFortAthenaLivingWorldCategory::IsEnabled' has a wrong offset!");
...
// ScriptStruct LagerRuntime.FortItemComponentData_LivingWorld
// 0x0010 (0x0010 - 0x0000)
struct FFortItemComponentData_LivingWorld final : public FFortItemComponentData
{
public:
	TArray<struct FFortAthenaLivingWorldEventTagDensityRegistration> TagRegistrations;                                  // 0x0000(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortItemComponentData_LivingWorld) == 0x000008, "Wrong alignment on FFortItemComponentData_LivingWorld");
static_assert(sizeof(FFortItemComponentData_LivingWorld) == 0x000010, "Wrong size on FFortItemComponentData_LivingWorld");
static_assert(offsetof(FFortItemComponentData_LivingWorld, TagRegistrations) == 0x000000, "Member 'FFortItemComponentData_LivingWorld::TagRegistrations' has a wrong offset!");

// ScriptStruct LagerRuntime.FortAthenaLivingWorldGridInjectionManager
// 0x0018 (0x0120 - 0x0108)
struct FFortAthenaLivingWorldGridInjectionManager final : public FFastArraySerializer
{
public:
	class UFortAthenaLivingWorldManager*          LivingWorldManager;                                // 0x0108(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, RepSkip, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<struct FFortAthenaLivingWorldGridInjectionRuntimeData> Items;                                             // 0x0110(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
};
static_assert(alignof(FFortAthenaLivingWorldGridInjectionManager) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldGridInjectionManager");
static_assert(sizeof(FFortAthenaLivingWorldGridInjectionManager) == 0x000120, "Wrong size on FFortAthenaLivingWorldGridInjectionManager");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionManager, LivingWorldManager) == 0x000108, "Member 'FFortAthenaLivingWorldGridInjectionManager::LivingWorldManager' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldGridInjectionManager, Items) == 0x000110, "Member 'FFortAthenaLivingWorldGridInjectionManager::Items' has a wrong offset!");
...
// ScriptStruct LagerRuntime.FortLWPointProviderSelector_EQS
// 0x0030 (0x0038 - 0x0008)
struct FFortLWPointProviderSelector_EQS final : public FFortAthenaLivingWorldPointProviderSelector
{
public:
	class UEnvQuery*                              QueryToRun;                                        // 0x0008(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FEnvNamedValue>                 QueryParams;                                       // 0x0010(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	EFortEQSLWPointProviderSelectorMode           ResultsSelectionMode;                              // 0x0020(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortLWPointProviderSelectorHelper_EQS* SelectorHelperObject;                              // 0x0028(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_30[0x8];                                       // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFortLWPointProviderSelector_EQS) == 0x000008, "Wrong alignment on FFortLWPointProviderSelector_EQS");
static_assert(sizeof(FFortLWPointProviderSelector_EQS) == 0x000038, "Wrong size on FFortLWPointProviderSelector_EQS");
static_assert(offsetof(FFortLWPointProviderSelector_EQS, QueryToRun) == 0x000008, "Member 'FFortLWPointProviderSelector_EQS::QueryToRun' has a wrong offset!");
static_assert(offsetof(FFortLWPointProviderSelector_EQS, QueryParams) == 0x000010, "Member 'FFortLWPointProviderSelector_EQS::QueryParams' has a wrong offset!");
static_assert(offsetof(FFortLWPointProviderSelector_EQS, ResultsSelectionMode) == 0x000020, "Member 'FFortLWPointProviderSelector_EQS::ResultsSelectionMode' has a wrong offset!");
static_assert(offsetof(FFortLWPointProviderSelector_EQS, SelectorHelperObject) == 0x000028, "Member 'FFortLWPointProviderSelector_EQS::SelectorHelperObject' has a wrong offset!");

// ScriptStruct LagerRuntime.VariableSelectionsRow_ActorDescription
// 0x0020 (0x0068 - 0x0048)
struct FVariableSelectionsRow_ActorDescription final : public FVariableSelectionsRow
{
public:
	struct FDataRegistryOrTableRow                RowValue;                                          // 0x0048(0x0020)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariableSelectionsRow_ActorDescription) == 0x000008, "Wrong alignment on FVariableSelectionsRow_ActorDescription");
static_assert(sizeof(FVariableSelectionsRow_ActorDescription) == 0x000068, "Wrong size on FVariableSelectionsRow_ActorDescription");
static_assert(offsetof(FVariableSelectionsRow_ActorDescription, RowValue) == 0x000048, "Member 'FVariableSelectionsRow_ActorDescription::RowValue' has a wrong offset!");

// ScriptStruct LagerRuntime.VariableSelections_ActorDescription
// 0x0030 (0x0090 - 0x0060)
struct FVariableSelections_ActorDescription final : public FVariableSelections
{
public:
	struct FSoftDataRegistryOrTable               ValueChoiceTable;                                  // 0x0060(0x0030)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariableSelections_ActorDescription) == 0x000008, "Wrong alignment on FVariableSelections_ActorDescription");
static_assert(sizeof(FVariableSelections_ActorDescription) == 0x000090, "Wrong size on FVariableSelections_ActorDescription");
static_assert(offsetof(FVariableSelections_ActorDescription, ValueChoiceTable) == 0x000060, "Member 'FVariableSelections_ActorDescription::ValueChoiceTable' has a wrong offset!");

// ScriptStruct LagerRuntime.VariableSelections_LWMEncounter
// 0x0030 (0x0090 - 0x0060)
struct FVariableSelections_LWMEncounter final : public FVariableSelections
{
public:
	struct FSoftDataRegistryOrTable               ValueChoiceTable;                                  // 0x0060(0x0030)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariableSelections_LWMEncounter) == 0x000008, "Wrong alignment on FVariableSelections_LWMEncounter");
static_assert(sizeof(FVariableSelections_LWMEncounter) == 0x000090, "Wrong size on FVariableSelections_LWMEncounter");
static_assert(offsetof(FVariableSelections_LWMEncounter, ValueChoiceTable) == 0x000060, "Member 'FVariableSelections_LWMEncounter::ValueChoiceTable' has a wrong offset!");

// ScriptStruct LagerRuntime.Variable_ActorDescription
// 0x0010 (0x0020 - 0x0010)
struct FVariable_ActorDescription final : public FVariable
{
public:
	struct FDataTableRowHandle                    RowValue;                                          // 0x0010(0x0010)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVariable_ActorDescription) == 0x000008, "Wrong alignment on FVariable_ActorDescription");
static_assert(sizeof(FVariable_ActorDescription) == 0x000020, "Wrong size on FVariable_ActorDescription");
static_assert(offsetof(FVariable_ActorDescription, RowValue) == 0x000010, "Member 'FVariable_ActorDescription::RowValue' has a wrong offset!");

// ScriptStruct LagerRuntime.VarRow_ActorDescription
// 0x0010 (0x0018 - 0x0008)
struct FVarRow_ActorDescription final : public FVarRow
{
public:
...
static_assert(alignof(FVarRow_ActorDescription) == 0x000008, "Wrong alignment on FVarRow_ActorDescription");
static_assert(sizeof(FVarRow_ActorDescription) == 0x000018, "Wrong size on FVarRow_ActorDescription");
static_assert(offsetof(FVarRow_ActorDescription, Value) == 0x000008, "Member 'FVarRow_ActorDescription::Value' has a wrong offset!");

// ScriptStruct LagerRuntime.VarRow_LWMEncounter
// 0x0020 (0x0028 - 0x0008)
struct FVarRow_LWMEncounter final : public FVarRow
{
public:
...
static_assert(alignof(FVarRow_LWMEncounter) == 0x000008, "Wrong alignment on FVarRow_LWMEncounter");
static_assert(sizeof(FVarRow_LWMEncounter) == 0x000028, "Wrong size on FVarRow_LWMEncounter");
static_assert(offsetof(FVarRow_LWMEncounter, Value) == 0x000008, "Member 'FVarRow_LWMEncounter::Value' has a wrong offset!");
...
static_assert(alignof(FFortAthenaLivingWorldCondition_CheckEncounterInstances) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldCondition_CheckEncounterInstances");
static_assert(sizeof(FFortAthenaLivingWorldCondition_CheckEncounterInstances) == 0x000018, "Wrong size on FFortAthenaLivingWorldCondition_CheckEncounterInstances");
static_assert(offsetof(FFortAthenaLivingWorldCondition_CheckEncounterInstances, ActorRef) == 0x000010, "Member 'FFortAthenaLivingWorldCondition_CheckEncounterInstances::ActorRef' has a wrong offset!");
...
static_assert(sizeof(FFortAthenaLivingWorldDensityGrid) == 0x0001E0, "Wrong size on FFortAthenaLivingWorldDensityGrid");
...
public:
	...
	struct FScalableFloat                         MaximumConcurrentNumberOfAI_LowValue;              // 0x0058(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaximumSpawnedNumberOfAI;                          // 0x0080(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaximumSpawnedNumberOfAI_LowValue;                 // 0x00A8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         MaxSpawnCountPerEventGeneration;                   // 0x00D0(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         DelayBetweenEvents;                                // 0x00F8(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         DelayBetweenEvents_LowValue;                       // 0x0120(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	uint8                                         bUseRandomDelayBetweenEvents : 1;                  // 0x0148(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAllowRandomMaximumActorCount : 1;                 // 0x0148(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bAllowRandomMaximumActorSpawnedCount : 1;          // 0x0148(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(FFortAthenaLivingWorldEncounterStage) == 0x000150, "Wrong size on FFortAthenaLivingWorldEncounterStage");
...
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, MaximumConcurrentNumberOfAI) == 0x000030, "Member 'FFortAthenaLivingWorldEncounterStage::MaximumConcurrentNumberOfAI' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, MaximumConcurrentNumberOfAI_LowValue) == 0x000058, "Member 'FFortAthenaLivingWorldEncounterStage::MaximumConcurrentNumberOfAI_LowValue' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, MaximumSpawnedNumberOfAI) == 0x000080, "Member 'FFortAthenaLivingWorldEncounterStage::MaximumSpawnedNumberOfAI' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, MaximumSpawnedNumberOfAI_LowValue) == 0x0000A8, "Member 'FFortAthenaLivingWorldEncounterStage::MaximumSpawnedNumberOfAI_LowValue' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, MaxSpawnCountPerEventGeneration) == 0x0000D0, "Member 'FFortAthenaLivingWorldEncounterStage::MaxSpawnCountPerEventGeneration' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, DelayBetweenEvents) == 0x0000F8, "Member 'FFortAthenaLivingWorldEncounterStage::DelayBetweenEvents' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEncounterStage, DelayBetweenEvents_LowValue) == 0x000120, "Member 'FFortAthenaLivingWorldEncounterStage::DelayBetweenEvents_LowValue' has a wrong offset!");
...
{
public:
	TArray<struct FFortAthenaLivingWorldEventDataEntry> EventDatas;                                        // 0x0008(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FScalableFloat                         IsEnabled;                                         // 0x0018(0x0028)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	bool                                          bShouldProcessEventRequestImmediately;             // 0x0040(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 MaxCount;                                          // 0x0048(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<float>                                 MaxSpawnedCount;                                   // 0x0058(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<float>                                 EventInstanceMaxCount;                             // 0x0068(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	TArray<float>                                 EventInstanceMaxSpawnedCount;                      // 0x0078(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	float                                         Weight;                                            // 0x0088(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCheckForActorDensity;                             // 0x008C(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_8D[0x3];                                       // 0x008D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MaxActorDensityOverride;                           // 0x0090(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_94[0x4];                                       // 0x0094(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<float>                                 MinRespawnTime;                                    // 0x0098(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<float>                                 MaxRespawnTime;                                    // 0x00A8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<float>                                 InstantDeathMinRespawnTime;                        // 0x00B8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<float>                                 InstantDeathMaxRespawnTime;                        // 0x00C8(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPrivate)
	bool                                          bOnlyInSafeZone;                                   // 0x00D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOnlyInNextSafeZone;                               // 0x00D9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bOnlyInNextSafeZoneIfStormShrinking;               // 0x00DA(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_DB[0x5];                                       // 0x00DB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	struct FWorldConditionQueryDefinition         CanSpawnCondition;                                 // 0x00E0(0x0018)(Edit, NativeAccessSpecifierPrivate)
	EAthenaGamePhaseStep                          ActivationGamePhaseStep;                           // 0x00F8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_F9[0x3];                                       // 0x00F9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         ActivationSafezoneIndex;                           // 0x00FC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ActivationMinDelay;                                // 0x0100(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         ActivationMaxDelay;                                // 0x0104(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         DeactivationMinDelay;                              // 0x0108(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         DeactivationMaxDelay;                              // 0x010C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FFortAthenaLivingWorldEventTagDensityCondition> TagDensityConditions;                              // 0x0110(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	bool                                          bCanSpawnWithoutMatchingPlayerDistance;            // 0x0120(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_121[0x3];                                      // 0x0121(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         MinDistanceToPlayer;                               // 0x0124(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         MaxDistanceToPlayer;                               // 0x0128(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	struct FFortAthenaLivingWorldEventDespawnCondition DespawnCondition;                                  // 0x0130(0x0020)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPrivate)
	TArray<struct FFortAthenaLivingWorldDespawnCondition> DespawnConditions;                                 // 0x0150(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FGameplayTagQuery                      PlaylistTagQuery;                                  // 0x0160(0x0048)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
	struct FLivingWorldCalendarEventConditions    CalendarEventConditions;                           // 0x01A8(0x0018)(Edit, DisableEditOnInstance, NativeAccessSpecifierPrivate)
};
static_assert(alignof(FFortAthenaLivingWorldEvent) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldEvent");
static_assert(sizeof(FFortAthenaLivingWorldEvent) == 0x0001C0, "Wrong size on FFortAthenaLivingWorldEvent");
static_assert(offsetof(FFortAthenaLivingWorldEvent, EventDatas) == 0x000008, "Member 'FFortAthenaLivingWorldEvent::EventDatas' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, IsEnabled) == 0x000018, "Member 'FFortAthenaLivingWorldEvent::IsEnabled' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bShouldProcessEventRequestImmediately) == 0x000040, "Member 'FFortAthenaLivingWorldEvent::bShouldProcessEventRequestImmediately' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxCount) == 0x000048, "Member 'FFortAthenaLivingWorldEvent::MaxCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxSpawnedCount) == 0x000058, "Member 'FFortAthenaLivingWorldEvent::MaxSpawnedCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, EventInstanceMaxCount) == 0x000068, "Member 'FFortAthenaLivingWorldEvent::EventInstanceMaxCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, EventInstanceMaxSpawnedCount) == 0x000078, "Member 'FFortAthenaLivingWorldEvent::EventInstanceMaxSpawnedCount' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, Weight) == 0x000088, "Member 'FFortAthenaLivingWorldEvent::Weight' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCheckForActorDensity) == 0x00008C, "Member 'FFortAthenaLivingWorldEvent::bCheckForActorDensity' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxActorDensityOverride) == 0x000090, "Member 'FFortAthenaLivingWorldEvent::MaxActorDensityOverride' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MinRespawnTime) == 0x000098, "Member 'FFortAthenaLivingWorldEvent::MinRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxRespawnTime) == 0x0000A8, "Member 'FFortAthenaLivingWorldEvent::MaxRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, InstantDeathMinRespawnTime) == 0x0000B8, "Member 'FFortAthenaLivingWorldEvent::InstantDeathMinRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, InstantDeathMaxRespawnTime) == 0x0000C8, "Member 'FFortAthenaLivingWorldEvent::InstantDeathMaxRespawnTime' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInSafeZone) == 0x0000D8, "Member 'FFortAthenaLivingWorldEvent::bOnlyInSafeZone' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInNextSafeZone) == 0x0000D9, "Member 'FFortAthenaLivingWorldEvent::bOnlyInNextSafeZone' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bOnlyInNextSafeZoneIfStormShrinking) == 0x0000DA, "Member 'FFortAthenaLivingWorldEvent::bOnlyInNextSafeZoneIfStormShrinking' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, CanSpawnCondition) == 0x0000E0, "Member 'FFortAthenaLivingWorldEvent::CanSpawnCondition' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationGamePhaseStep) == 0x0000F8, "Member 'FFortAthenaLivingWorldEvent::ActivationGamePhaseStep' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationSafezoneIndex) == 0x0000FC, "Member 'FFortAthenaLivingWorldEvent::ActivationSafezoneIndex' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationMinDelay) == 0x000100, "Member 'FFortAthenaLivingWorldEvent::ActivationMinDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, ActivationMaxDelay) == 0x000104, "Member 'FFortAthenaLivingWorldEvent::ActivationMaxDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DeactivationMinDelay) == 0x000108, "Member 'FFortAthenaLivingWorldEvent::DeactivationMinDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, DeactivationMaxDelay) == 0x00010C, "Member 'FFortAthenaLivingWorldEvent::DeactivationMaxDelay' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, TagDensityConditions) == 0x000110, "Member 'FFortAthenaLivingWorldEvent::TagDensityConditions' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, bCanSpawnWithoutMatchingPlayerDistance) == 0x000120, "Member 'FFortAthenaLivingWorldEvent::bCanSpawnWithoutMatchingPlayerDistance' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MinDistanceToPlayer) == 0x000124, "Member 'FFortAthenaLivingWorldEvent::MinDistanceToPlayer' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, MaxDistanceToPlayer) == 0x000128, "Member 'FFortAthenaLivingWorldEvent::MaxDistanceToPlayer' has a wrong offset!");
...
static_assert(offsetof(FFortAthenaLivingWorldEvent, DespawnConditions) == 0x000150, "Member 'FFortAthenaLivingWorldEvent::DespawnConditions' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, PlaylistTagQuery) == 0x000160, "Member 'FFortAthenaLivingWorldEvent::PlaylistTagQuery' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldEvent, CalendarEventConditions) == 0x0001A8, "Member 'FFortAthenaLivingWorldEvent::CalendarEventConditions' has a wrong offset!");
...
public:
	struct FGameplayTag                           SpawnActionTag;                                    // 0x0000(0x0004)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftClassPtr<class UClass>                   SpawnActionClass;                                  // 0x0008(0x0020)(Edit, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFortAthenaLivingWorldSoftTaggedSpawnActionClass) == 0x000008, "Wrong alignment on FFortAthenaLivingWorldSoftTaggedSpawnActionClass");
static_assert(sizeof(FFortAthenaLivingWorldSoftTaggedSpawnActionClass) == 0x000028, "Wrong size on FFortAthenaLivingWorldSoftTaggedSpawnActionClass");
static_assert(offsetof(FFortAthenaLivingWorldSoftTaggedSpawnActionClass, SpawnActionTag) == 0x000000, "Member 'FFortAthenaLivingWorldSoftTaggedSpawnActionClass::SpawnActionTag' has a wrong offset!");
static_assert(offsetof(FFortAthenaLivingWorldSoftTaggedSpawnActionClass, SpawnActionClass) == 0x000008, "Member 'FFortAthenaLivingWorldSoftTaggedSpawnActionClass::SpawnActionClass' has a wrong offset!");
