...
int32 ULineSetComponent::AddLines(const TArray<struct FVector>& InStart, const TArray<struct FVector>& InEnd, const struct FColor& InColor, const float InThickness, const float InDepthBias)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("AddLines");
...
void ULineSetComponent::SetLineMaterial(class UMaterialInterface* InLineMaterial)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetLineMaterial");
...
void UPreviewGeometry::RemoveAllTriangleSets(bool bDestroy)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RemoveAllTriangleSets");
...
bool UPreviewGeometry::RemoveTriangleSet(const class FString& TriangleSetIdentifier, bool bDestroy)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("RemoveTriangleSet");
...
// struct FColor                           InColor                                                (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   InSize                                                 (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                                   InDepthBias                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// int32                                   ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UPointSetComponent::SetPointMaterial(class UMaterialInterface* InPointMaterial)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetPointMaterial");
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct FCreateComponentParams           CreateComponentParams                                  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
struct FCreateComponentResult UModelingObjectsCreationAPI::CreateNewComponentOnActor(const struct FCreateComponentParams& CreateComponentParams)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("CreateNewComponentOnActor");
