...
public:
	TArray<struct FAssetData>                     Assets;                                            // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
	TDelegate<void(struct FAssetData& Left, struct FAssetData& Right)> SortingPredicate;                                  // 0x0010(0x000C)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EAssetRegistrySortOrder                       SortOrder;                                         // 0x001C(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AssetRegistryHelpers_SortByPredicate) == 0x000020, "Wrong size on AssetRegistryHelpers_SortByPredicate");
...
static_assert(offsetof(AssetRegistryHelpers_SortByPredicate, SortOrder) == 0x00001C, "Member 'AssetRegistryHelpers_SortByPredicate::SortOrder' has a wrong offset!");
