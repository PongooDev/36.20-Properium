...
static_assert(sizeof(UMassAgentComponent) == 0x0001B8, "Wrong size on UMassAgentComponent");
static_assert(offsetof(UMassAgentComponent, EntityConfig) == 0x000158, "Member 'UMassAgentComponent::EntityConfig' has a wrong offset!");
static_assert(offsetof(UMassAgentComponent, NetId) == 0x0001B4, "Member 'UMassAgentComponent::NetId' has a wrong offset!");
