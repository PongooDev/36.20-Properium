...
static_assert(sizeof(UMovieSceneSpawnableChaosCacheBinding) == 0x000040, "Wrong size on UMovieSceneSpawnableChaosCacheBinding");
...
static_assert(sizeof(AChaosCacheManager) == 0x000360, "Wrong size on AChaosCacheManager");
...
static_assert(sizeof(AChaosCachePlayer) == 0x000360, "Wrong size on AChaosCachePlayer");

// Class ChaosCaching.ChaosCacheData
// 0x0000 (0x0028 - 0x0028)
class IChaosCacheData final : public IInterface
{
public:
	static class UClass* StaticClass()
	{
...
static_assert(alignof(IChaosCacheData) == 0x000008, "Wrong alignment on IChaosCacheData");
static_assert(sizeof(IChaosCacheData) == 0x000028, "Wrong size on IChaosCacheData");
