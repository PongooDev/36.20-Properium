...
static_assert(sizeof(UGameInputPlatformSettings) == 0x000060, "Wrong size on UGameInputPlatformSettings");
...
static_assert(offsetof(UGameInputPlatformSettings, bProcessArcadeStick) == 0x00004C, "Member 'UGameInputPlatformSettings::bProcessArcadeStick' has a wrong offset!");
static_assert(offsetof(UGameInputPlatformSettings, bProcessFlightStick) == 0x00004D, "Member 'UGameInputPlatformSettings::bProcessFlightStick' has a wrong offset!");
static_assert(offsetof(UGameInputPlatformSettings, FlightStickPitchDeadzone) == 0x000050, "Member 'UGameInputPlatformSettings::FlightStickPitchDeadzone' has a wrong offset!");
static_assert(offsetof(UGameInputPlatformSettings, FlightStickRollDeadzone) == 0x000054, "Member 'UGameInputPlatformSettings::FlightStickRollDeadzone' has a wrong offset!");
static_assert(offsetof(UGameInputPlatformSettings, FlightStickThrottleDeadzone) == 0x000058, "Member 'UGameInputPlatformSettings::FlightStickThrottleDeadzone' has a wrong offset!");
static_assert(offsetof(UGameInputPlatformSettings, FlightStickYawDeadzone) == 0x00005C, "Member 'UGameInputPlatformSettings::FlightStickYawDeadzone' has a wrong offset!");
