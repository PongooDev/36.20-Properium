...
static_assert(sizeof(UModularSynthComponent) == 0x000FA0, "Wrong size on UModularSynthComponent");
static_assert(offsetof(UModularSynthComponent, VoiceCount) == 0x0008A0, "Member 'UModularSynthComponent::VoiceCount' has a wrong offset!");
...
{
public:
	class USoundWave*                             GranulatedSoundWave;                               // 0x08A0(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGranularSynth) == 0x000C90, "Wrong size on UGranularSynth");
static_assert(offsetof(UGranularSynth, GranulatedSoundWave) == 0x0008A0, "Member 'UGranularSynth::GranulatedSoundWave' has a wrong offset!");
...
public:
	...
	class UMonoWaveTableSynthPreset*              CurrentPreset;                                     // 0x08C0(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(USynthComponentMonoWaveTable) == 0x000FF0, "Wrong size on USynthComponentMonoWaveTable");
static_assert(offsetof(USynthComponentMonoWaveTable, OnTableAltered) == 0x0008A0, "Member 'USynthComponentMonoWaveTable::OnTableAltered' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, OnNumTablesChanged) == 0x0008B0, "Member 'USynthComponentMonoWaveTable::OnNumTablesChanged' has a wrong offset!");
static_assert(offsetof(USynthComponentMonoWaveTable, CurrentPreset) == 0x0008C0, "Member 'USynthComponentMonoWaveTable::CurrentPreset' has a wrong offset!");
...
static_assert(sizeof(USynthComponentToneGenerator) == 0x000990, "Wrong size on USynthComponentToneGenerator");
static_assert(offsetof(USynthComponentToneGenerator, Frequency) == 0x0008A0, "Member 'USynthComponentToneGenerator::Frequency' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, Volume) == 0x0008A4, "Member 'USynthComponentToneGenerator::Volume' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceAttenuationCurve) == 0x0008A8, "Member 'USynthComponentToneGenerator::DistanceAttenuationCurve' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, DistanceRange) == 0x000930, "Member 'USynthComponentToneGenerator::DistanceRange' has a wrong offset!");
static_assert(offsetof(USynthComponentToneGenerator, AttenuationDbAtMaxRange) == 0x000940, "Member 'USynthComponentToneGenerator::AttenuationDbAtMaxRange' has a wrong offset!");
...
{
public:
	class USoundWave*                             SoundWave;                                         // 0x08A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynthSamplePlayer) == 0x0009D0, "Wrong size on USynthSamplePlayer");
static_assert(offsetof(USynthSamplePlayer, SoundWave) == 0x0008A0, "Member 'USynthSamplePlayer::SoundWave' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSampleLoaded) == 0x0008A8, "Member 'USynthSamplePlayer::OnSampleLoaded' has a wrong offset!");
static_assert(offsetof(USynthSamplePlayer, OnSamplePlaybackProgress) == 0x0008B8, "Member 'USynthSamplePlayer::OnSamplePlaybackProgress' has a wrong offset!");
...
public:
	...
	TDelegate<void()>                             ValueXDelegate;                                    // 0x0160(0x000C)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TDelegate<void()>                             ValueYDelegate;                                    // 0x016C(0x000C)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_178[0x8];                                      // 0x0178(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSynth2DSliderStyle                    WidgetStyle;                                       // 0x0180(0x0390)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct FLinearColor                           SliderHandleColor;                                 // 0x0510(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IndentHandle;                                      // 0x0520(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Locked;                                            // 0x0521(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_522[0x2];                                      // 0x0522(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         StepSize;                                          // 0x0524(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsFocusable;                                       // 0x0528(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedX;                                   // 0x0570(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(float Value)>   OnValueChangedY;                                   // 0x0580(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynth2DSlider) == 0x0005A0, "Wrong size on USynth2DSlider");
...
static_assert(offsetof(USynth2DSlider, ValueYDelegate) == 0x00016C, "Member 'USynth2DSlider::ValueYDelegate' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, WidgetStyle) == 0x000180, "Member 'USynth2DSlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, SliderHandleColor) == 0x000510, "Member 'USynth2DSlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IndentHandle) == 0x000520, "Member 'USynth2DSlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, Locked) == 0x000521, "Member 'USynth2DSlider::Locked' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, StepSize) == 0x000524, "Member 'USynth2DSlider::StepSize' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, IsFocusable) == 0x000528, "Member 'USynth2DSlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureBegin) == 0x000530, "Member 'USynth2DSlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnMouseCaptureEnd) == 0x000540, "Member 'USynth2DSlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureBegin) == 0x000550, "Member 'USynth2DSlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnControllerCaptureEnd) == 0x000560, "Member 'USynth2DSlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedX) == 0x000570, "Member 'USynth2DSlider::OnValueChangedX' has a wrong offset!");
static_assert(offsetof(USynth2DSlider, OnValueChangedY) == 0x000580, "Member 'USynth2DSlider::OnValueChangedY' has a wrong offset!");
...
public:
	...
	class FText                                   ParameterName;                                     // 0x0170(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	class FText                                   ParameterUnits;                                    // 0x0180(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	...
	struct FSynthKnobStyle                        WidgetStyle;                                       // 0x01A0(0x02E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	bool                                          Locked;                                            // 0x0480(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          IsFocusable;                                       // 0x0481(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(USynthKnob) == 0x0004F0, "Wrong size on USynthKnob");
...
static_assert(offsetof(USynthKnob, Locked) == 0x000480, "Member 'USynthKnob::Locked' has a wrong offset!");
static_assert(offsetof(USynthKnob, IsFocusable) == 0x000481, "Member 'USynthKnob::IsFocusable' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureBegin) == 0x000488, "Member 'USynthKnob::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnMouseCaptureEnd) == 0x000498, "Member 'USynthKnob::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureBegin) == 0x0004A8, "Member 'USynthKnob::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnControllerCaptureEnd) == 0x0004B8, "Member 'USynthKnob::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USynthKnob, OnValueChanged) == 0x0004C8, "Member 'USynthKnob::OnValueChanged' has a wrong offset!");
