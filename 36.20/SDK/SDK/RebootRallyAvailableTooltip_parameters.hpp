...
static_assert(sizeof(RebootRallyAvailableTooltip_C_UpdateText) == 0x000058, "Wrong size on RebootRallyAvailableTooltip_C_UpdateText");
...
static_assert(offsetof(RebootRallyAvailableTooltip_C_UpdateText, CallFunc_GetCurrentInputType_ReturnValue) == 0x000020, "Member 'RebootRallyAvailableTooltip_C_UpdateText::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
static_assert(offsetof(RebootRallyAvailableTooltip_C_UpdateText, CallFunc_MakeLiteralText_ReturnValue_1) == 0x000028, "Member 'RebootRallyAvailableTooltip_C_UpdateText::CallFunc_MakeLiteralText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RebootRallyAvailableTooltip_C_UpdateText, CallFunc_MakeLiteralText_ReturnValue_2) == 0x000038, "Member 'RebootRallyAvailableTooltip_C_UpdateText::CallFunc_MakeLiteralText_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RebootRallyAvailableTooltip_C_UpdateText, K2Node_Select_Default) == 0x000048, "Member 'RebootRallyAvailableTooltip_C_UpdateText::K2Node_Select_Default' has a wrong offset!");
