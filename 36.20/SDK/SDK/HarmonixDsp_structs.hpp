...
public:
	...
	bool                                          bOverrideAdsr;                                     // 0x002C(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2D[0x3];                                       // 0x002D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FAdsrSettings                          Adsr;                                              // 0x0030(0x0120)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	float                                         FineTuneCents;                                     // 0x0150(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Gain;                                              // 0x0154(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUnpitched;                                        // 0x0158(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bVelocityToGain;                                   // 0x0159(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15A[0x6];                                      // 0x015A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimeStretchConfig                     TimeStretchConfig;                                 // 0x0160(0x0060)(Edit, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          bIsNoteOffZone;                                    // 0x01C0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C1[0x3];                                      // 0x01C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RandomWeight;                                      // 0x01C4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SampleStartOffset;                                 // 0x01C8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         SampleEndOffset;                                   // 0x01CC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FTrackChannelInfo>              TrackMap;                                          // 0x01D0(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	bool                                          UseSingletonVoicePool;                             // 0x01E0(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(FKeyzoneSettings) == 0x0001F8, "Wrong size on FKeyzoneSettings");
...
static_assert(offsetof(FKeyzoneSettings, bOverrideAdsr) == 0x00002C, "Member 'FKeyzoneSettings::bOverrideAdsr' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, Adsr) == 0x000030, "Member 'FKeyzoneSettings::Adsr' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, FineTuneCents) == 0x000150, "Member 'FKeyzoneSettings::FineTuneCents' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, Gain) == 0x000154, "Member 'FKeyzoneSettings::Gain' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, bUnpitched) == 0x000158, "Member 'FKeyzoneSettings::bUnpitched' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, bVelocityToGain) == 0x000159, "Member 'FKeyzoneSettings::bVelocityToGain' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, TimeStretchConfig) == 0x000160, "Member 'FKeyzoneSettings::TimeStretchConfig' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, bIsNoteOffZone) == 0x0001C0, "Member 'FKeyzoneSettings::bIsNoteOffZone' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, RandomWeight) == 0x0001C4, "Member 'FKeyzoneSettings::RandomWeight' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, SampleStartOffset) == 0x0001C8, "Member 'FKeyzoneSettings::SampleStartOffset' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, SampleEndOffset) == 0x0001CC, "Member 'FKeyzoneSettings::SampleEndOffset' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, TrackMap) == 0x0001D0, "Member 'FKeyzoneSettings::TrackMap' has a wrong offset!");
static_assert(offsetof(FKeyzoneSettings, UseSingletonVoicePool) == 0x0001E0, "Member 'FKeyzoneSettings::UseSingletonVoicePool' has a wrong offset!");
...
static_assert(alignof(FFusionVoiceConfig) == 0x000004, "Wrong alignment on FFusionVoiceConfig");
static_assert(sizeof(FFusionVoiceConfig) == 0x000018, "Wrong size on FFusionVoiceConfig");
static_assert(offsetof(FFusionVoiceConfig, NumTotalVoices) == 0x000000, "Member 'FFusionVoiceConfig::NumTotalVoices' has a wrong offset!");
static_assert(offsetof(FFusionVoiceConfig, SoftVoiceLimit) == 0x000004, "Member 'FFusionVoiceConfig::SoftVoiceLimit' has a wrong offset!");
static_assert(offsetof(FFusionVoiceConfig, FormantDbCorrectionPerHalfStepUp) == 0x000008, "Member 'FFusionVoiceConfig::FormantDbCorrectionPerHalfStepUp' has a wrong offset!");
static_assert(offsetof(FFusionVoiceConfig, FormantDbCorrectionPerHalfStepDown) == 0x00000C, "Member 'FFusionVoiceConfig::FormantDbCorrectionPerHalfStepDown' has a wrong offset!");
static_assert(offsetof(FFusionVoiceConfig, FormantDbCorrectionMaxUp) == 0x000010, "Member 'FFusionVoiceConfig::FormantDbCorrectionMaxUp' has a wrong offset!");
static_assert(offsetof(FFusionVoiceConfig, FormantDbCorrectionMaxDown) == 0x000014, "Member 'FFusionVoiceConfig::FormantDbCorrectionMaxDown' has a wrong offset!");
