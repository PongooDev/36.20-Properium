...
{
public:
	class UZoneGraphTestingComponent*             DebugComp;                                         // 0x02A8(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(AZoneGraphTestingActor) == 0x0002B0, "Wrong size on AZoneGraphTestingActor");
static_assert(offsetof(AZoneGraphTestingActor, DebugComp) == 0x0002A8, "Member 'AZoneGraphTestingActor::DebugComp' has a wrong offset!");
