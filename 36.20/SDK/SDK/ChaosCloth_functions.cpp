...
void UChaosClothingInteractor::SetMaterialBuckling(const struct FVector2D& BucklingRatio, const struct FVector2D& BucklingStiffness)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetMaterialBuckling");
...
// struct FVector                          MaxLinearVelocity                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// struct FVector                          MaxLinearAcceleration                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UChaosClothingInteractor::SetVelocityClamps(bool bEnableLinearVelocityClamping, const struct FVector& MaxLinearVelocity, bool bEnableLinearAccelerationClamping, const struct FVector& MaxLinearAcceleration, bool bEnableAngularVelocityClamping, float MaxAngularVelocity, bool bEnableAngularAccelerationClamping, float MaxAngularAcceleration)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetVelocityClamps");
