...
static_assert(sizeof(WBP_IslandTile_Full_C_OnTileSelectionActive) == 0x000010, "Wrong size on WBP_IslandTile_Full_C_OnTileSelectionActive");
...
static_assert(sizeof(WBP_IslandTile_Full_C_OnTileSelectionNotActive) == 0x000010, "Wrong size on WBP_IslandTile_Full_C_OnTileSelectionNotActive");
...
static_assert(sizeof(WBP_IslandTile_Full_C_ExecuteUbergraph_WBP_IslandTile_Full) == 0x000008, "Wrong size on WBP_IslandTile_Full_C_ExecuteUbergraph_WBP_IslandTile_Full");
...
static_assert(offsetof(WBP_IslandTile_Full_C_ExecuteUbergraph_WBP_IslandTile_Full, K2Node_Event_IsDesignTime) == 0x000004, "Member 'WBP_IslandTile_Full_C_ExecuteUbergraph_WBP_IslandTile_Full::K2Node_Event_IsDesignTime' has a wrong offset!");

// Function WBP_IslandTile_Full.WBP_IslandTile_Full_C.SetMobileStyle
// 0x0001 (0x0001 - 0x0000)
struct WBP_IslandTile_Full_C_SetMobileStyle final
{
public:
	bool                                          CallFunc_IsMobileGame_ReturnValue;                 // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_IslandTile_Full_C_SetMobileStyle) == 0x000001, "Wrong alignment on WBP_IslandTile_Full_C_SetMobileStyle");
static_assert(sizeof(WBP_IslandTile_Full_C_SetMobileStyle) == 0x000001, "Wrong size on WBP_IslandTile_Full_C_SetMobileStyle");
static_assert(offsetof(WBP_IslandTile_Full_C_SetMobileStyle, CallFunc_IsMobileGame_ReturnValue) == 0x000000, "Member 'WBP_IslandTile_Full_C_SetMobileStyle::CallFunc_IsMobileGame_ReturnValue' has a wrong offset!");
