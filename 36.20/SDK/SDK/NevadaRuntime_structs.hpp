...
{
public:
	uint8                                         Pad_28[0x448];                                     // 0x0028(0x0448)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FNevadaOutPersistent) == 0x000008, "Wrong alignment on FNevadaOutPersistent");
static_assert(sizeof(FNevadaOutPersistent) == 0x000470, "Wrong size on FNevadaOutPersistent");
