...
{
public:
	class AFortPlayerPawn*                        TargetPawn;                                        // 0x09C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AGCL_Cornfield_Movement_C) == 0x0009D0, "Wrong size on AGCL_Cornfield_Movement_C");
static_assert(offsetof(AGCL_Cornfield_Movement_C, TargetPawn) == 0x0009C8, "Member 'AGCL_Cornfield_Movement_C::TargetPawn' has a wrong offset!");
