...
public:
	...
	bool                                          CallFunc_IsInZone_ReturnValue;                     // 0x001D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESubGame                                      K2Node_CustomEvent_SubGame;                        // 0x0020(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_21[0x7];                                       // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FHitResult                             CallFunc_K2_SetActorTransform_SweepHitResult;      // 0x0028(0x00F8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class UFortFrontEndContext*                   CallFunc_GetContext_ReturnValue_1;                 // 0x0128(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	ESubGame                                      CallFunc_GetSubGame_ReturnValue_1;                 // 0x01A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper) == 0x0001B0, "Wrong size on VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper");
...
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, K2Node_Event_EndPlayReason) == 0x000004, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::K2Node_Event_EndPlayReason' has a wrong offset!");
...
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, K2Node_CreateDelegate_OutputDelegate) == 0x000010, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_GetSubGame_ReturnValue) == 0x00001C, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_GetSubGame_ReturnValue' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_IsInZone_ReturnValue) == 0x00001D, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_IsInZone_ReturnValue' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00001E, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_BooleanAND_ReturnValue) == 0x00001F, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, K2Node_CustomEvent_SubGame) == 0x000020, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::K2Node_CustomEvent_SubGame' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_K2_SetActorTransform_SweepHitResult) == 0x000028, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_K2_SetActorTransform_SweepHitResult' has a wrong offset!");
...
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_GetContext_ReturnValue_1) == 0x000128, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_GetContext_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_GetContext_ReturnValue_2) == 0x0001A0, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_GetContext_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, CallFunc_GetSubGame_ReturnValue_1) == 0x0001A8, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::CallFunc_GetSubGame_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper, K2Node_SwitchEnum_CmpSuccess) == 0x0001A9, "Member 'VaultCharacterPlacementHelper_C_ExecuteUbergraph_VaultCharacterPlacementHelper::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
// Function VaultCharacterPlacementHelper.VaultCharacterPlacementHelper_C.ReceiveEndPlay
// 0x0001 (0x0001 - 0x0000)
struct VaultCharacterPlacementHelper_C_ReceiveEndPlay final
{
public:
	EEndPlayReason                                EndPlayReason;                                     // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(VaultCharacterPlacementHelper_C_ReceiveEndPlay) == 0x000001, "Wrong alignment on VaultCharacterPlacementHelper_C_ReceiveEndPlay");
static_assert(sizeof(VaultCharacterPlacementHelper_C_ReceiveEndPlay) == 0x000001, "Wrong size on VaultCharacterPlacementHelper_C_ReceiveEndPlay");
static_assert(offsetof(VaultCharacterPlacementHelper_C_ReceiveEndPlay, EndPlayReason) == 0x000000, "Member 'VaultCharacterPlacementHelper_C_ReceiveEndPlay::EndPlayReason' has a wrong offset!");
...
static_assert(sizeof(VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera) == 0x000200, "Wrong size on VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera");
...
static_assert(offsetof(VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera, CallFunc_K2_SetActorTransform_ReturnValue) == 0x0001F8, "Member 'VaultCharacterPlacementHelper_C_UpdatePosition_For_Camera::CallFunc_K2_SetActorTransform_ReturnValue' has a wrong offset!");
