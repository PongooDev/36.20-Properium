...
public:
	...
	bool                                          bFactorInStackCount;                               // 0x09E3(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UGameplayEffect, bFactorInStackCount) == 0x0009E3, "Member 'UGameplayEffect::bFactorInStackCount' has a wrong offset!");
...
{
public:
	struct FSoftClassPath                         AbilitySystemGlobalsClassName;                     // 0x0030(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseDebugTargetFromHud;                            // 0x0048(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FSoftObjectPath>                GlobalAttributeSetDefaultsTableNames;              // 0x0050(0x0010)(Edit, ZeroConstructor, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        GlobalAttributeMetaDataTableName;                  // 0x0060(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftClassPath                         GlobalGameplayCueManagerClass;                     // 0x0078(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        GlobalGameplayCueManagerName;                      // 0x0090(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<class FString>                         GameplayCueNotifyPaths;                            // 0x00A8(0x0010)(Edit, ZeroConstructor, Config, DisableEditOnInstance, NativeAccessSpecifierPublic)
	struct FSoftObjectPath                        GlobalCurveTableName;                              // 0x00B8(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PredictTargetGameplayEffects;                      // 0x00D0(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReplicateActivationOwnedTags;                      // 0x00D1(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D2[0x2];                                       // 0x00D2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           ActivateFailCanActivateAbilityTag;                 // 0x00D4(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivateFailCooldownTag;                           // 0x00D8(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivateFailCostTag;                               // 0x00DC(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivateFailNetworkingTag;                         // 0x00E0(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivateFailTagsBlockedTag;                        // 0x00E4(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           ActivateFailTagsMissingTag;                        // 0x00E8(0x0004)(Edit, Config, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_EC[0x4];                                       // 0x00EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSoftObjectPath                        GameplayTagResponseTableName;                      // 0x00F0(0x0018)(Edit, ZeroConstructor, Config, DisableEditOnInstance, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bAllowGameplayModEvaluationChannels;               // 0x0108(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EGameplayModEvaluationChannel                 DefaultGameplayModEvaluationChannel;               // 0x0109(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_10A[0x2];                                      // 0x010A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   GameplayModEvaluationChannelAliases[0xA];          // 0x010C(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         MinimalReplicationTagCountBits;                    // 0x0134(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayAbilitiesDeveloperSettings) == 0x000138, "Wrong size on UGameplayAbilitiesDeveloperSettings");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, AbilitySystemGlobalsClassName) == 0x000030, "Member 'UGameplayAbilitiesDeveloperSettings::AbilitySystemGlobalsClassName' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, bUseDebugTargetFromHud) == 0x000048, "Member 'UGameplayAbilitiesDeveloperSettings::bUseDebugTargetFromHud' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GlobalAttributeSetDefaultsTableNames) == 0x000050, "Member 'UGameplayAbilitiesDeveloperSettings::GlobalAttributeSetDefaultsTableNames' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GlobalAttributeMetaDataTableName) == 0x000060, "Member 'UGameplayAbilitiesDeveloperSettings::GlobalAttributeMetaDataTableName' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GlobalGameplayCueManagerClass) == 0x000078, "Member 'UGameplayAbilitiesDeveloperSettings::GlobalGameplayCueManagerClass' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GlobalGameplayCueManagerName) == 0x000090, "Member 'UGameplayAbilitiesDeveloperSettings::GlobalGameplayCueManagerName' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GameplayCueNotifyPaths) == 0x0000A8, "Member 'UGameplayAbilitiesDeveloperSettings::GameplayCueNotifyPaths' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GlobalCurveTableName) == 0x0000B8, "Member 'UGameplayAbilitiesDeveloperSettings::GlobalCurveTableName' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, PredictTargetGameplayEffects) == 0x0000D0, "Member 'UGameplayAbilitiesDeveloperSettings::PredictTargetGameplayEffects' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ReplicateActivationOwnedTags) == 0x0000D1, "Member 'UGameplayAbilitiesDeveloperSettings::ReplicateActivationOwnedTags' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailCanActivateAbilityTag) == 0x0000D4, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailCanActivateAbilityTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailCooldownTag) == 0x0000D8, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailCooldownTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailCostTag) == 0x0000DC, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailCostTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailNetworkingTag) == 0x0000E0, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailNetworkingTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailTagsBlockedTag) == 0x0000E4, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailTagsBlockedTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, ActivateFailTagsMissingTag) == 0x0000E8, "Member 'UGameplayAbilitiesDeveloperSettings::ActivateFailTagsMissingTag' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GameplayTagResponseTableName) == 0x0000F0, "Member 'UGameplayAbilitiesDeveloperSettings::GameplayTagResponseTableName' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, bAllowGameplayModEvaluationChannels) == 0x000108, "Member 'UGameplayAbilitiesDeveloperSettings::bAllowGameplayModEvaluationChannels' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, DefaultGameplayModEvaluationChannel) == 0x000109, "Member 'UGameplayAbilitiesDeveloperSettings::DefaultGameplayModEvaluationChannel' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, GameplayModEvaluationChannelAliases) == 0x00010C, "Member 'UGameplayAbilitiesDeveloperSettings::GameplayModEvaluationChannelAliases' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesDeveloperSettings, MinimalReplicationTagCountBits) == 0x000134, "Member 'UGameplayAbilitiesDeveloperSettings::MinimalReplicationTagCountBits' has a wrong offset!");
...
{
public:
	bool                                          bIgnoreCooldowns;                                  // 0x0030(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIgnoreCosts;                                      // 0x0031(0x0001)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_32[0x2];                                       // 0x0032(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         AbilitySystemGlobalScaler;                         // 0x0034(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         DebugDrawMaxDistance;                              // 0x0038(0x0004)(Edit, ZeroConstructor, Config, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UGameplayAbilitiesEditorDeveloperSettings) == 0x000040, "Wrong size on UGameplayAbilitiesEditorDeveloperSettings");
static_assert(offsetof(UGameplayAbilitiesEditorDeveloperSettings, bIgnoreCooldowns) == 0x000030, "Member 'UGameplayAbilitiesEditorDeveloperSettings::bIgnoreCooldowns' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesEditorDeveloperSettings, bIgnoreCosts) == 0x000031, "Member 'UGameplayAbilitiesEditorDeveloperSettings::bIgnoreCosts' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesEditorDeveloperSettings, AbilitySystemGlobalScaler) == 0x000034, "Member 'UGameplayAbilitiesEditorDeveloperSettings::AbilitySystemGlobalScaler' has a wrong offset!");
static_assert(offsetof(UGameplayAbilitiesEditorDeveloperSettings, DebugDrawMaxDistance) == 0x000038, "Member 'UGameplayAbilitiesEditorDeveloperSettings::DebugDrawMaxDistance' has a wrong offset!");
...
public:
	...
	class FName                                   SectionName;                                       // 0x03B4(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<TSubclassOf<class UGameplayEffect>>    GameplayEffectClassesWhileAnimating;               // 0x03B8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, UObjectWrapper, NativeAccessSpecifierPublic)
	TArray<class UGameplayEffect*>                GameplayEffectsWhileAnimating;                     // 0x03C8(0x0010)(Edit, ZeroConstructor, DisableEditOnInstance, EditConst, UObjectWrapper, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayAbility_Montage) == 0x0003D8, "Wrong size on UGameplayAbility_Montage");
...
static_assert(offsetof(UGameplayAbility_Montage, GameplayEffectClassesWhileAnimating) == 0x0003B8, "Member 'UGameplayAbility_Montage::GameplayEffectClassesWhileAnimating' has a wrong offset!");
static_assert(offsetof(UGameplayAbility_Montage, GameplayEffectsWhileAnimating) == 0x0003C8, "Member 'UGameplayAbility_Montage::GameplayEffectsWhileAnimating' has a wrong offset!");
...
public:
	...
	TWeakObjectPtr<class UCharacterMovementComponent> MovementComponent;                                 // 0x009C(0x0008)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAbilityTask_ApplyRootMotion_Base) == 0x0000B0, "Wrong size on UAbilityTask_ApplyRootMotion_Base");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotion_Base, MovementComponent) == 0x00009C, "Member 'UAbilityTask_ApplyRootMotion_Base::MovementComponent' has a wrong offset!");
...
public:
	...
	struct FVector                                WorldDirection;                                    // 0x00C0(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Strength;                                          // 0x00D8(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         duration;                                          // 0x00DC(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsAdditive;                                       // 0x00E0(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, OnFinish) == 0x0000B0, "Member 'UAbilityTask_ApplyRootMotionConstantForce::OnFinish' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, WorldDirection) == 0x0000C0, "Member 'UAbilityTask_ApplyRootMotionConstantForce::WorldDirection' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, Strength) == 0x0000D8, "Member 'UAbilityTask_ApplyRootMotionConstantForce::Strength' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, duration) == 0x0000DC, "Member 'UAbilityTask_ApplyRootMotionConstantForce::duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionConstantForce, bIsAdditive) == 0x0000E0, "Member 'UAbilityTask_ApplyRootMotionConstantForce::bIsAdditive' has a wrong offset!");
...
public:
	TMulticastInlineDelegate<void()>              OnFinish;                                          // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnLanded;                                          // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FRotator                               Rotation;                                          // 0x00D0(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
	float                                         Distance;                                          // 0x00E8(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Height;                                            // 0x00EC(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	float                                         MinimumLandedTriggerTime;                          // 0x00F4(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bFinishOnLanded;                                   // 0x00F8(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_F9[0x7];                                       // 0x00F9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UCurveVector*                           PathOffsetCurve;                                   // 0x0100(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCurveFloat*                            TimeMappingCurve;                                  // 0x0108(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, OnFinish) == 0x0000B0, "Member 'UAbilityTask_ApplyRootMotionJumpForce::OnFinish' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, OnLanded) == 0x0000C0, "Member 'UAbilityTask_ApplyRootMotionJumpForce::OnLanded' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Rotation) == 0x0000D0, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Rotation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Distance) == 0x0000E8, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Distance' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, Height) == 0x0000EC, "Member 'UAbilityTask_ApplyRootMotionJumpForce::Height' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, duration) == 0x0000F0, "Member 'UAbilityTask_ApplyRootMotionJumpForce::duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, MinimumLandedTriggerTime) == 0x0000F4, "Member 'UAbilityTask_ApplyRootMotionJumpForce::MinimumLandedTriggerTime' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionJumpForce, bFinishOnLanded) == 0x0000F8, "Member 'UAbilityTask_ApplyRootMotionJumpForce::bFinishOnLanded' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void(bool DestinationReached, bool TimedOut, const struct FVector& FinalTargetLocation)> OnFinished;                                        // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_C0[0x8];                                       // 0x00C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector                                StartLocation;                                     // 0x00C8(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                TargetLocation;                                    // 0x00E0(0x0018)(Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AActor*                                 TargetActor;                                       // 0x00F8(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USceneComponent*                        TargetComponent;                                   // 0x0100(0x0008)(ExportObject, Net, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                TargetComponentRelativeLocation;                   // 0x0108(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector                                TargetLocationOffset;                              // 0x0120(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	ERootMotionMoveToActorTargetOffsetType        OffsetAlignment;                                   // 0x0138(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_139[0x3];                                      // 0x0139(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         duration;                                          // 0x013C(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDisableDestinationReachedInterrupt;               // 0x0140(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_141[0x3];                                      // 0x0141(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         ReachedDestinationDistance;                        // 0x0144(0x0004)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bSetNewMovementMode;                               // 0x0148(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EMovementMode                                 NewMovementMode;                                   // 0x0149(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRestrictSpeedToExpected;                          // 0x014A(0x0001)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, OnFinished) == 0x0000B0, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::OnFinished' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLocation) == 0x0000E0, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLocation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetActor) == 0x0000F8, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetActor' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetComponent) == 0x000100, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetComponent' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetComponentRelativeLocation) == 0x000108, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetComponentRelativeLocation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, TargetLocationOffset) == 0x000120, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::TargetLocationOffset' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, OffsetAlignment) == 0x000138, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::OffsetAlignment' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, duration) == 0x00013C, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::duration' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bDisableDestinationReachedInterrupt) == 0x000140, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bDisableDestinationReachedInterrupt' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, ReachedDestinationDistance) == 0x000144, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::ReachedDestinationDistance' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bSetNewMovementMode) == 0x000148, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bSetNewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, NewMovementMode) == 0x000149, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::NewMovementMode' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToActorForce, bRestrictSpeedToExpected) == 0x00014A, "Member 'UAbilityTask_ApplyRootMotionMoveToActorForce::bRestrictSpeedToExpected' has a wrong offset!");
...
{
public:
	TMulticastInlineDelegate<void()>              OnTimedOut;                                        // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnTimedOutAndDestinationReached;                   // 0x00C0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	struct FVector                                TargetLocation;                                    // 0x00E8(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, OnTimedOut) == 0x0000B0, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::OnTimedOut' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, OnTimedOutAndDestinationReached) == 0x0000C0, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::OnTimedOutAndDestinationReached' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, StartLocation) == 0x0000D0, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::StartLocation' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionMoveToForce, TargetLocation) == 0x0000E8, "Member 'UAbilityTask_ApplyRootMotionMoveToForce::TargetLocation' has a wrong offset!");
...
public:
	TMulticastInlineDelegate<void()>              OnFinish;                                          // 0x00B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	struct FVector                                Location;                                          // 0x00C0(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AActor*                                 LocationActor;                                     // 0x00D8(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class UCurveFloat*                            StrengthDistanceFalloff;                           // 0x00F0(0x0008)(Net, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FRotator                               FixedWorldDirection;                               // 0x0108(0x0018)(Net, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAbilityTask_ApplyRootMotionRadialForce) == 0x000120, "Wrong size on UAbilityTask_ApplyRootMotionRadialForce");
static_assert(offsetof(UAbilityTask_ApplyRootMotionRadialForce, OnFinish) == 0x0000B0, "Member 'UAbilityTask_ApplyRootMotionRadialForce::OnFinish' has a wrong offset!");
static_assert(offsetof(UAbilityTask_ApplyRootMotionRadialForce, Location) == 0x0000C0, "Member 'UAbilityTask_ApplyRootMotionRadialForce::Location' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_ApplyRootMotionRadialForce, FixedWorldDirection) == 0x000108, "Member 'UAbilityTask_ApplyRootMotionRadialForce::FixedWorldDirection' has a wrong offset!");
...
public:
	TMulticastInlineDelegate<void()>              OnCompleted;                                       // 0x0078(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnBlendedIn;                                       // 0x0088(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	TMulticastInlineDelegate<void()>              OnCancelled;                                       // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_C8[0x38];                                      // 0x00C8(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	class UAnimMontage*                           MontageToPlay;                                     // 0x0100(0x0008)(ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         Rate;                                              // 0x0108(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FName                                   StartSection;                                      // 0x010C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	float                                         StartTimeSeconds;                                  // 0x0114(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bStopWhenAbilityEnds;                              // 0x0118(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bAllowInterruptAfterBlendOut;                      // 0x0119(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UAbilityTask_PlayMontageAndWait) == 0x000120, "Wrong size on UAbilityTask_PlayMontageAndWait");
...
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, OnBlendedIn) == 0x000088, "Member 'UAbilityTask_PlayMontageAndWait::OnBlendedIn' has a wrong offset!");
...
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, AnimRootMotionTranslationScale) == 0x000110, "Member 'UAbilityTask_PlayMontageAndWait::AnimRootMotionTranslationScale' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, StartTimeSeconds) == 0x000114, "Member 'UAbilityTask_PlayMontageAndWait::StartTimeSeconds' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, bStopWhenAbilityEnds) == 0x000118, "Member 'UAbilityTask_PlayMontageAndWait::bStopWhenAbilityEnds' has a wrong offset!");
static_assert(offsetof(UAbilityTask_PlayMontageAndWait, bAllowInterruptAfterBlendOut) == 0x000119, "Member 'UAbilityTask_PlayMontageAndWait::bAllowInterruptAfterBlendOut' has a wrong offset!");
...
public:
	...
	static struct FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToAnyOfGameplayTagContainerChanged(class UAbilitySystemComponent* AbilitySystemComponent, const struct FGameplayTagContainer& TagContainer, TDelegate<void(struct FGameplayTag& Tag, int32 TagCount)> GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, EGameplayTagEventType TagListeningPolicy);
	static struct FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToAnyOfGameplayTagsChanged(class UAbilitySystemComponent* AbilitySystemComponent, const TArray<struct FGameplayTag>& Tags, TDelegate<void(struct FGameplayTag& Tag, int32 TagCount)> GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, EGameplayTagEventType TagListeningPolicy);
	static struct FGameplayTagChangedEventWrapperSpecHandle BindEventWrapperToGameplayTagChanged(class UAbilitySystemComponent* AbilitySystemComponent, const struct FGameplayTag& Tag, TDelegate<void(struct FGameplayTag& Tag, int32 TagCount)> GameplayTagChangedEventWrapperDelegate, bool bExecuteImmediatelyIfTagApplied, EGameplayTagEventType TagListeningPolicy);
...
public:
	...
	class FName                                   AffectedAnimInstanceTag;                           // 0x0150(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_154[0x1A4];                                    // 0x0154(0x01A4)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(UAbilitySystemComponent, ActiveGameplayCues) == 0x000B80, "Member 'UAbilitySystemComponent::ActiveGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationGameplayCues) == 0x000CA8, "Member 'UAbilitySystemComponent::MinimalReplicationGameplayCues' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, BlockedAbilityBindings) == 0x000EF8, "Member 'UAbilitySystemComponent::BlockedAbilityBindings' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, MinimalReplicationTags) == 0x001030, "Member 'UAbilitySystemComponent::MinimalReplicationTags' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, SpawnedAttributes) == 0x001098, "Member 'UAbilitySystemComponent::SpawnedAttributes' has a wrong offset!");
static_assert(offsetof(UAbilitySystemComponent, ReplicatedLooseTags) == 0x0010B8, "Member 'UAbilitySystemComponent::ReplicatedLooseTags' has a wrong offset!");
...
public:
	...
	TArray<struct FSoftObjectPath>                GlobalAttributeSetDefaultsTableNames;              // 0x0148(0x0010)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	struct FGameplayTag                           GameplayCueTag;                                    // 0x02B4(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FName                                   GameplayCueName;                                   // 0x02B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(AGameplayCueNotify_Actor, GameplayCueName) == 0x0002B8, "Member 'AGameplayCueNotify_Actor::GameplayCueName' has a wrong offset!");
...
{
public:
	struct FMovieSceneGameplayCueKey              Cue;                                               // 0x0120(0x0088)(Edit, NoDestructor, AssetRegistrySearchable, NativeAccessSpecifierPrivate)
