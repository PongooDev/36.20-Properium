...
bool UAnimSequenceSideloaded::SideloadDataFromBuffer(const TArray<uint8>& Memory)
{
	static class UFunction* Func = nullptr;
	
	if (Func == nullptr)
		Func = Class->FindFunction("SideloadDataFromBuffer");

	Params::AnimSequenceSideloaded_SideloadDataFromBuffer Parms{};
