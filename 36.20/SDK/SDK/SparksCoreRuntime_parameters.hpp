...
// Function SparksCoreRuntime.PilgrimTrackTypeUtils.IsGuitarPeripheralTrack
...
static_assert(offsetof(PilgrimTrackTypeUtils_IsGuitarPeripheralTrack, TrackType) == 0x000000, "Member 'PilgrimTrackTypeUtils_IsGuitarPeripheralTrack::TrackType' has a wrong offset!");
static_assert(offsetof(PilgrimTrackTypeUtils_IsGuitarPeripheralTrack, ReturnValue) == 0x000001, "Member 'PilgrimTrackTypeUtils_IsGuitarPeripheralTrack::ReturnValue' has a wrong offset!");

// Function SparksCoreRuntime.PilgrimTrackTypeUtils.IsTrackTypeValid
// 0x0002 (0x0002 - 0x0000)
struct PilgrimTrackTypeUtils_IsTrackTypeValid final
{
public:
	EPilgrimTrackType                             TrackType;                                         // 0x0000(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0001(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(PilgrimTrackTypeUtils_IsTrackTypeValid) == 0x000001, "Wrong alignment on PilgrimTrackTypeUtils_IsTrackTypeValid");
static_assert(sizeof(PilgrimTrackTypeUtils_IsTrackTypeValid) == 0x000002, "Wrong size on PilgrimTrackTypeUtils_IsTrackTypeValid");
static_assert(offsetof(PilgrimTrackTypeUtils_IsTrackTypeValid, TrackType) == 0x000000, "Member 'PilgrimTrackTypeUtils_IsTrackTypeValid::TrackType' has a wrong offset!");
static_assert(offsetof(PilgrimTrackTypeUtils_IsTrackTypeValid, ReturnValue) == 0x000001, "Member 'PilgrimTrackTypeUtils_IsTrackTypeValid::ReturnValue' has a wrong offset!");
...
// Function SparksCoreRuntime.SparksCore_BPFL.GetSquadMemberIndexFromPlayerUniqueNetId
// 0x0040 (0x0040 - 0x0000)
struct SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId final
{
public:
...
static_assert(alignof(SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId) == 0x000008, "Wrong alignment on SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId");
static_assert(sizeof(SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId) == 0x000040, "Wrong size on SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId");
static_assert(offsetof(SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId, WorldContextObject) == 0x000000, "Member 'SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId::WorldContextObject' has a wrong offset!");
static_assert(offsetof(SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId, PlayerNetId) == 0x000008, "Member 'SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId::PlayerNetId' has a wrong offset!");
static_assert(offsetof(SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId, ReturnValue) == 0x000038, "Member 'SparksCore_BPFL_GetSquadMemberIndexFromPlayerUniqueNetId::ReturnValue' has a wrong offset!");
