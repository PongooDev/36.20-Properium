...
static_assert(sizeof(FNeuralMorphMaskInfo) == 0x000018, "Wrong size on FNeuralMorphMaskInfo");
static_assert(offsetof(FNeuralMorphMaskInfo, BoneNames) == 0x000000, "Member 'FNeuralMorphMaskInfo::BoneNames' has a wrong offset!");
static_assert(offsetof(FNeuralMorphMaskInfo, MaskMode) == 0x000010, "Member 'FNeuralMorphMaskInfo::MaskMode' has a wrong offset!");
static_assert(offsetof(FNeuralMorphMaskInfo, VertexAttributeName) == 0x000014, "Member 'FNeuralMorphMaskInfo::VertexAttributeName' has a wrong offset!");
