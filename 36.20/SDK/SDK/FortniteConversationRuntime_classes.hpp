...
static_assert(alignof(IFortConversationGetGraphInterface) == 0x000008, "Wrong alignment on IFortConversationGetGraphInterface");
static_assert(sizeof(IFortConversationGetGraphInterface) == 0x000028, "Wrong size on IFortConversationGetGraphInterface");
...
static_assert(sizeof(UFortConversationParticipantComponent) == 0x0001A8, "Wrong size on UFortConversationParticipantComponent");
...
public:
	...
	TArray<class UFortNonPlayerConversationParticipantComponent*> ConversationParticipantsInRange;                   // 0x01B0(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	float                                         GreetSphereRadius;                                 // 0x01C0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         IconVisibilityRadius;                              // 0x01C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         AbortConversationRange;                            // 0x01C8(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FGameplayTag                           RidingOnActorTag;                                  // 0x01CC(0x0004)(Edit, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         RidingOnActorRangeMultiplierSquared;               // 0x01D0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_1D4[0x3C];                                     // 0x01D4(0x003C)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<class UFortNonPlayerConversationParticipantComponent*> IndicatedNPCConversationComponents;                // 0x0210(0x0050)(ExportObject, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
	uint8                                         Pad_260[0x8];                                      // 0x0260(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	bool                                          bMoveShouldAbortConversation;                      // 0x0268(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	bool                                          bCachedDefaultMoveShouldAbortConverationValue;     // 0x0269(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_26A[0x11E];                                    // 0x026A(0x011E)(Fixing Size After Last Property [ Dumper-7 ])
	struct FClientConversationMessagePayload      LastSanitizationMessage;                           // 0x0388(0x0068)(NativeAccessSpecifierPrivate)
...
public:
	...
	void FortConversationScreenInitialized(class UWidget* WidgetToUpdate);
...
static_assert(sizeof(UFortPlayerConversationComponent) == 0x0003F0, "Wrong size on UFortPlayerConversationComponent");
static_assert(offsetof(UFortPlayerConversationComponent, ConversationParticipantsInRange) == 0x0001B0, "Member 'UFortPlayerConversationComponent::ConversationParticipantsInRange' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, GreetSphereRadius) == 0x0001C0, "Member 'UFortPlayerConversationComponent::GreetSphereRadius' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, IconVisibilityRadius) == 0x0001C4, "Member 'UFortPlayerConversationComponent::IconVisibilityRadius' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, AbortConversationRange) == 0x0001C8, "Member 'UFortPlayerConversationComponent::AbortConversationRange' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, RidingOnActorTag) == 0x0001CC, "Member 'UFortPlayerConversationComponent::RidingOnActorTag' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, RidingOnActorRangeMultiplierSquared) == 0x0001D0, "Member 'UFortPlayerConversationComponent::RidingOnActorRangeMultiplierSquared' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, IndicatedNPCConversationComponents) == 0x000210, "Member 'UFortPlayerConversationComponent::IndicatedNPCConversationComponents' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, bMoveShouldAbortConversation) == 0x000268, "Member 'UFortPlayerConversationComponent::bMoveShouldAbortConversation' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, bCachedDefaultMoveShouldAbortConverationValue) == 0x000269, "Member 'UFortPlayerConversationComponent::bCachedDefaultMoveShouldAbortConverationValue' has a wrong offset!");
static_assert(offsetof(UFortPlayerConversationComponent, LastSanitizationMessage) == 0x000388, "Member 'UFortPlayerConversationComponent::LastSanitizationMessage' has a wrong offset!");
