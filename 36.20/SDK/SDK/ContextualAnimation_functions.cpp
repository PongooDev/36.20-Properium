...
void UContextualAnimSceneActorComponent::OnIgnoredActorEndPlay(class AActor* Actor, EEndPlayReason EndPlayReason)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("OnIgnoredActorEndPlay");
...
bool UContextualAnimSceneActorComponent::TransitionContextualAnimSceneToSpecificSet(class FName SectionName, int32 AnimSetIdx)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("TransitionContextualAnimSceneToSpecificSet");
...
const struct FContextualAnimSceneBindings UContextualAnimSceneActorComponent::GetBindings() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetBindings");
...
void UContextualAnimUtilities::BP_SceneBindingContext_GetCurrentSectionAndAnimSetNames(const struct FContextualAnimSceneBindingContext& BindingContext, class FName* SectionName, class FName* AnimSetName)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("BP_SceneBindingContext_GetCurrentSectionAndAnimSetNames");
...
const struct FContextualAnimSceneBinding UContextualAnimUtilities::BP_SceneBindings_GetPrimaryBinding(const struct FContextualAnimSceneBindings& Bindings)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("BP_SceneBindings_GetPrimaryBinding");
...
void UContextualAnimUtilities::BP_SceneBindings_GetSectionAndAnimSetNames(const struct FContextualAnimSceneBindings& Bindings, class FName* SectionName, class FName* AnimSetName)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("BP_SceneBindings_GetSectionAndAnimSetNames");
