...
static_assert(sizeof(ErrorInfoFlag_C_UpdateText) == 0x000018, "Wrong size on ErrorInfoFlag_C_UpdateText");
...
static_assert(offsetof(ErrorInfoFlag_C_UpdateText, Temp_bool_Variable) == 0x000010, "Member 'ErrorInfoFlag_C_UpdateText::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(ErrorInfoFlag_C_UpdateText, CallFunc_TextIsEmpty_ReturnValue) == 0x000011, "Member 'ErrorInfoFlag_C_UpdateText::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(ErrorInfoFlag_C_UpdateText, Temp_byte_Variable) == 0x000012, "Member 'ErrorInfoFlag_C_UpdateText::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(ErrorInfoFlag_C_UpdateText, Temp_byte_Variable_1) == 0x000013, "Member 'ErrorInfoFlag_C_UpdateText::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(ErrorInfoFlag_C_UpdateText, K2Node_Select_Default) == 0x000014, "Member 'ErrorInfoFlag_C_UpdateText::K2Node_Select_Default' has a wrong offset!");
