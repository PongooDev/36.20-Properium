...
static_assert(alignof(FNE_VolumeOverlapComponent_ComponentAddedToMinigame) == 0x000008, "Wrong alignment on FNE_VolumeOverlapComponent_ComponentAddedToMinigame");
static_assert(sizeof(FNE_VolumeOverlapComponent_ComponentAddedToMinigame) == 0x000008, "Wrong size on FNE_VolumeOverlapComponent_ComponentAddedToMinigame");
static_assert(offsetof(FNE_VolumeOverlapComponent_ComponentAddedToMinigame, Minigame) == 0x000000, "Member 'FNE_VolumeOverlapComponent_ComponentAddedToMinigame::Minigame' has a wrong offset!");
...
static_assert(sizeof(FNE_VolumeOverlapComponent_OnBeginActorOverlap) == 0x000118, "Wrong size on FNE_VolumeOverlapComponent_OnBeginActorOverlap");
...
static_assert(alignof(FNE_VolumeOverlapComponent_SetEnableOverlapBehavior) == 0x000001, "Wrong alignment on FNE_VolumeOverlapComponent_SetEnableOverlapBehavior");
static_assert(sizeof(FNE_VolumeOverlapComponent_SetEnableOverlapBehavior) == 0x000001, "Wrong size on FNE_VolumeOverlapComponent_SetEnableOverlapBehavior");
static_assert(offsetof(FNE_VolumeOverlapComponent_SetEnableOverlapBehavior, InOverlapBehavior) == 0x000000, "Member 'FNE_VolumeOverlapComponent_SetEnableOverlapBehavior::InOverlapBehavior' has a wrong offset!");
