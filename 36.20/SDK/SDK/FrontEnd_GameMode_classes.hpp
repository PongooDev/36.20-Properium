...
{
public:
	class USceneComponent*                        DefaultSceneRoot;                                  // 0x0808(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AFrontEnd_GameMode_C) == 0x000810, "Wrong size on AFrontEnd_GameMode_C");
static_assert(offsetof(AFrontEnd_GameMode_C, DefaultSceneRoot) == 0x000808, "Member 'AFrontEnd_GameMode_C::DefaultSceneRoot' has a wrong offset!");
