...
static_assert(offsetof(FortKeysAndLocksDisplayCase_NativeCalculateLockInteractStrings, NeedKey) == 0x000040, "Member 'FortKeysAndLocksDisplayCase_NativeCalculateLockInteractStrings::NeedKey' has a wrong offset!");
static_assert(offsetof(FortKeysAndLocksDisplayCase_NativeCalculateLockInteractStrings, WeaponModSetData) == 0x000050, "Member 'FortKeysAndLocksDisplayCase_NativeCalculateLockInteractStrings::WeaponModSetData' has a wrong offset!");
