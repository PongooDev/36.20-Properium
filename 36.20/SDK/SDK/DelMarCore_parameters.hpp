...
static_assert(alignof(DelMarCheckpoint_UpdateCheckpointTheme) == 0x000008, "Wrong alignment on DelMarCheckpoint_UpdateCheckpointTheme");
static_assert(sizeof(DelMarCheckpoint_UpdateCheckpointTheme) == 0x000008, "Wrong size on DelMarCheckpoint_UpdateCheckpointTheme");
static_assert(offsetof(DelMarCheckpoint_UpdateCheckpointTheme, Theme) == 0x000000, "Member 'DelMarCheckpoint_UpdateCheckpointTheme::Theme' has a wrong offset!");
...
{
public:
	struct FCheckpointTrackDistance               ReturnValue;                                       // 0x0000(0x0020)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(DelMarCheckpoint_GetFurthestAheadTrackDistance) == 0x000020, "Wrong size on DelMarCheckpoint_GetFurthestAheadTrackDistance");
...
static_assert(sizeof(DelMarCheckpoint_GetFurthestBehindTrackDistance) == 0x000020, "Wrong size on DelMarCheckpoint_GetFurthestBehindTrackDistance");
...
static_assert(sizeof(DelMarCheckpoint_GetNearestTrackData) == 0x000020, "Wrong size on DelMarCheckpoint_GetNearestTrackData");
...
public:
	...
	struct FCheckpointTrackDistance               ReturnValue;                                       // 0x0010(0x0020)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(DelMarCheckpoint_GetTrackDistanceDataForTrack) == 0x000030, "Wrong size on DelMarCheckpoint_GetTrackDistanceDataForTrack");
...
// 0x0001 (0x0001 - 0x0000)
struct DelMarCheckpoint_IsFinishLine final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarCheckpoint_IsFinishLine) == 0x000001, "Wrong alignment on DelMarCheckpoint_IsFinishLine");
static_assert(sizeof(DelMarCheckpoint_IsFinishLine) == 0x000001, "Wrong size on DelMarCheckpoint_IsFinishLine");
static_assert(offsetof(DelMarCheckpoint_IsFinishLine, ReturnValue) == 0x000000, "Member 'DelMarCheckpoint_IsFinishLine::ReturnValue' has a wrong offset!");

// Function DelMarCore.DelMarCheckpoint.IsStartingLine
// 0x0001 (0x0001 - 0x0000)
struct DelMarCheckpoint_IsStartingLine final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarCheckpoint_IsStartingLine) == 0x000001, "Wrong alignment on DelMarCheckpoint_IsStartingLine");
static_assert(sizeof(DelMarCheckpoint_IsStartingLine) == 0x000001, "Wrong size on DelMarCheckpoint_IsStartingLine");
static_assert(offsetof(DelMarCheckpoint_IsStartingLine, ReturnValue) == 0x000000, "Member 'DelMarCheckpoint_IsStartingLine::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DelMarBTTask_DriveTrack_HandleVehicleAnyWheelsOnGroundStateChanged, VehicleRef) == 0x000000, "Member 'DelMarBTTask_DriveTrack_HandleVehicleAnyWheelsOnGroundStateChanged::VehicleRef' has a wrong offset!");
static_assert(offsetof(DelMarBTTask_DriveTrack_HandleVehicleAnyWheelsOnGroundStateChanged, bAnyWheelsOnGround) == 0x000010, "Member 'DelMarBTTask_DriveTrack_HandleVehicleAnyWheelsOnGroundStateChanged::bAnyWheelsOnGround' has a wrong offset!");
...
static_assert(offsetof(DelMarPlayerPreferencesComponent_ServerUpdateVerticalKickflipInverted, bInVerticalKickflipInverted) == 0x000000, "Member 'DelMarPlayerPreferencesComponent_ServerUpdateVerticalKickflipInverted::bInVerticalKickflipInverted' has a wrong offset!");
...
static_assert(alignof(DelMarRaceManager_GetGameplayModifierComponent) == 0x000008, "Wrong alignment on DelMarRaceManager_GetGameplayModifierComponent");
static_assert(sizeof(DelMarRaceManager_GetGameplayModifierComponent) == 0x000008, "Wrong size on DelMarRaceManager_GetGameplayModifierComponent");
static_assert(offsetof(DelMarRaceManager_GetGameplayModifierComponent, ReturnValue) == 0x000000, "Member 'DelMarRaceManager_GetGameplayModifierComponent::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DelMarBlueprintLibrary_IsDelMarGFSActive, ReturnValue) == 0x000000, "Member 'DelMarBlueprintLibrary_IsDelMarGFSActive::ReturnValue' has a wrong offset!");
...
static_assert(alignof(DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist) == 0x000008, "Wrong alignment on DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist");
static_assert(sizeof(DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist) == 0x000018, "Wrong size on DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist");
static_assert(offsetof(DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist, PlaylistName) == 0x000000, "Member 'DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist::PlaylistName' has a wrong offset!");
static_assert(offsetof(DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist, ReturnValue) == 0x000010, "Member 'DelMarBlueprintLibrary_IsPlaylistNameARotationPlaylist::ReturnValue' has a wrong offset!");
...
// 0x0008 (0x0008 - 0x0000)
struct DelMarPlayspace_GetActiveRaceManager final
{
public:
...
static_assert(alignof(DelMarPlayspace_GetActiveRaceManager) == 0x000008, "Wrong alignment on DelMarPlayspace_GetActiveRaceManager");
static_assert(sizeof(DelMarPlayspace_GetActiveRaceManager) == 0x000008, "Wrong size on DelMarPlayspace_GetActiveRaceManager");
static_assert(offsetof(DelMarPlayspace_GetActiveRaceManager, ReturnValue) == 0x000000, "Member 'DelMarPlayspace_GetActiveRaceManager::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(DelMarTutorialTriggerActor_HandleColliderOverlap) == 0x000118, "Wrong size on DelMarTutorialTriggerActor_HandleColliderOverlap");
...
static_assert(sizeof(DelMarPlayerRaceDataComponent_NetMulticast_CheckpointPassed_ParallelPath) == 0x000018, "Wrong size on DelMarPlayerRaceDataComponent_NetMulticast_CheckpointPassed_ParallelPath");
...
// 0x0001 (0x0001 - 0x0000)
struct DelMarVehicle_ClientTryAutoThrottle final
{
public:
	bool                                          bValidateTouch;                                    // 0x0000(0x0001)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarVehicle_ClientTryAutoThrottle) == 0x000001, "Wrong alignment on DelMarVehicle_ClientTryAutoThrottle");
static_assert(sizeof(DelMarVehicle_ClientTryAutoThrottle) == 0x000001, "Wrong size on DelMarVehicle_ClientTryAutoThrottle");
static_assert(offsetof(DelMarVehicle_ClientTryAutoThrottle, bValidateTouch) == 0x000000, "Member 'DelMarVehicle_ClientTryAutoThrottle::bValidateTouch' has a wrong offset!");
...
static_assert(offsetof(DelMarVehicle_HandleFinishedCharacterCustomization, PlayerPawn) == 0x000000, "Member 'DelMarVehicle_HandleFinishedCharacterCustomization::PlayerPawn' has a wrong offset!");

// Function DelMarCore.DelMarVehicle.HandleFinishVehicleCosmeticsEvent
// 0x0001 (0x0001 - 0x0000)
struct DelMarVehicle_HandleFinishVehicleCosmeticsEvent final
{
public:
...
static_assert(alignof(DelMarVehicle_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong alignment on DelMarVehicle_HandleFinishVehicleCosmeticsEvent");
static_assert(sizeof(DelMarVehicle_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong size on DelMarVehicle_HandleFinishVehicleCosmeticsEvent");
static_assert(offsetof(DelMarVehicle_HandleFinishVehicleCosmeticsEvent, Payload) == 0x000000, "Member 'DelMarVehicle_HandleFinishVehicleCosmeticsEvent::Payload' has a wrong offset!");
...
static_assert(offsetof(DelMarVehicle_HandleNewPlayerState, Pawn) == 0x000000, "Member 'DelMarVehicle_HandleNewPlayerState::Pawn' has a wrong offset!");
...
{
public:
	struct FDelMarVehicleConfigOverrides          InConfigOverrides;                                 // 0x0000(0x00A0)(Parm, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarVehicle_SetConfigOverrides) == 0x000004, "Wrong alignment on DelMarVehicle_SetConfigOverrides");
static_assert(sizeof(DelMarVehicle_SetConfigOverrides) == 0x0000A0, "Wrong size on DelMarVehicle_SetConfigOverrides");
...
// 0x0001 (0x0001 - 0x0000)
struct DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent final
{
public:
	struct FVehicleCosmeticsFinishedPayload       Payload;                                           // 0x0000(0x0001)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong alignment on DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent");
static_assert(sizeof(DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong size on DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent");
static_assert(offsetof(DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent, Payload) == 0x000000, "Member 'DelMarGhostVehicle_HandleFinishVehicleCosmeticsEvent::Payload' has a wrong offset!");
...
static_assert(alignof(DelMarGhostVehicle_VehicleCosmeticsPartUpdated) == 0x000004, "Wrong alignment on DelMarGhostVehicle_VehicleCosmeticsPartUpdated");
static_assert(sizeof(DelMarGhostVehicle_VehicleCosmeticsPartUpdated) == 0x000004, "Wrong size on DelMarGhostVehicle_VehicleCosmeticsPartUpdated");
static_assert(offsetof(DelMarGhostVehicle_VehicleCosmeticsPartUpdated, PartIndex) == 0x000000, "Member 'DelMarGhostVehicle_VehicleCosmeticsPartUpdated::PartIndex' has a wrong offset!");
...
static_assert(alignof(DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged) == 0x000008, "Wrong alignment on DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged");
static_assert(sizeof(DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged) == 0x000018, "Wrong size on DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged");
static_assert(offsetof(DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged, VehicleRef) == 0x000000, "Member 'DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged::VehicleRef' has a wrong offset!");
static_assert(offsetof(DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged, bAnyWheelsOnGround) == 0x000010, "Member 'DelMarBTService_ChooseNextTrack_HandleVehicleAnyWheelsOnGroundStateChanged::bAnyWheelsOnGround' has a wrong offset!");
...
static_assert(offsetof(DelMarBTService_FindDriveGoal_HandleKickflipActivated, bLeft) == 0x000000, "Member 'DelMarBTService_FindDriveGoal_HandleKickflipActivated::bLeft' has a wrong offset!");
...
static_assert(offsetof(DelMarBTService_FindDriveGoal_HandleVehicleAnyWheelsOnGroundStateChanged, VehicleRef) == 0x000000, "Member 'DelMarBTService_FindDriveGoal_HandleVehicleAnyWheelsOnGroundStateChanged::VehicleRef' has a wrong offset!");
static_assert(offsetof(DelMarBTService_FindDriveGoal_HandleVehicleAnyWheelsOnGroundStateChanged, bAnyWheelsOnGround) == 0x000010, "Member 'DelMarBTService_FindDriveGoal_HandleVehicleAnyWheelsOnGroundStateChanged::bAnyWheelsOnGround' has a wrong offset!");
...
// 0x0018 (0x0018 - 0x0000)
struct DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged final
{
public:
	class AFortPlayerController*                  InController;                                      // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class AActor*                                 OldViewTarget;                                     // 0x0008(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged) == 0x000008, "Wrong alignment on DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged");
static_assert(sizeof(DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged) == 0x000018, "Wrong size on DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged");
static_assert(offsetof(DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged, InController) == 0x000000, "Member 'DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged::InController' has a wrong offset!");
static_assert(offsetof(DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged, OldViewTarget) == 0x000008, "Member 'DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged::OldViewTarget' has a wrong offset!");
static_assert(offsetof(DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged, NewViewTarget) == 0x000010, "Member 'DelMarSpectatorControllerComponent_HandleOnSpectatorViewTargetChanged::NewViewTarget' has a wrong offset!");
...
static_assert(offsetof(DelMarTimeManagerComponent_StartCountdownForPlayer, InPlayerState) == 0x000000, "Member 'DelMarTimeManagerComponent_StartCountdownForPlayer::InPlayerState' has a wrong offset!");
static_assert(offsetof(DelMarTimeManagerComponent_StartCountdownForPlayer, InServerCountdownStartTime) == 0x000008, "Member 'DelMarTimeManagerComponent_StartCountdownForPlayer::InServerCountdownStartTime' has a wrong offset!");
static_assert(offsetof(DelMarTimeManagerComponent_StartCountdownForPlayer, InServerRunStartTime) == 0x000010, "Member 'DelMarTimeManagerComponent_StartCountdownForPlayer::InServerRunStartTime' has a wrong offset!");
...
static_assert(offsetof(DelMarTimeManagerComponent_StartCountdownForRace, InServerCountdownStartTime) == 0x000000, "Member 'DelMarTimeManagerComponent_StartCountdownForRace::InServerCountdownStartTime' has a wrong offset!");
static_assert(offsetof(DelMarTimeManagerComponent_StartCountdownForRace, InServerRaceStartTime) == 0x000008, "Member 'DelMarTimeManagerComponent_StartCountdownForRace::InServerRaceStartTime' has a wrong offset!");
...
static_assert(offsetof(DelMarCosmeticActor_IsLocallyViewed, ReturnValue) == 0x000000, "Member 'DelMarCosmeticActor_IsLocallyViewed::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DelMarCoreOobTubePositionalRenderingComponent_HandleAIPawnSpawned, BotController) == 0x000000, "Member 'DelMarCoreOobTubePositionalRenderingComponent_HandleAIPawnSpawned::BotController' has a wrong offset!");
static_assert(offsetof(DelMarCoreOobTubePositionalRenderingComponent_HandleAIPawnSpawned, BotPawn) == 0x000008, "Member 'DelMarCoreOobTubePositionalRenderingComponent_HandleAIPawnSpawned::BotPawn' has a wrong offset!");
...
static_assert(offsetof(DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged, FortPC) == 0x000000, "Member 'DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged::FortPC' has a wrong offset!");
static_assert(offsetof(DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged, OldViewTarget) == 0x000008, "Member 'DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged::OldViewTarget' has a wrong offset!");
static_assert(offsetof(DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged, NewViewTarget) == 0x000010, "Member 'DelMarCoreOobTubePositionalRenderingComponent_HandleViewTargetChanged::NewViewTarget' has a wrong offset!");
...
static_assert(sizeof(DelMarCoreSplineMeshComponent_OnBeginActorOverlap) == 0x000118, "Wrong size on DelMarCoreSplineMeshComponent_OnBeginActorOverlap");
...
static_assert(alignof(DelMarAudioController_BP_OnIsLocalChanged) == 0x000001, "Wrong alignment on DelMarAudioController_BP_OnIsLocalChanged");
static_assert(sizeof(DelMarAudioController_BP_OnIsLocalChanged) == 0x000001, "Wrong size on DelMarAudioController_BP_OnIsLocalChanged");
static_assert(offsetof(DelMarAudioController_BP_OnIsLocalChanged, bNewValue) == 0x000000, "Member 'DelMarAudioController_BP_OnIsLocalChanged::bNewValue' has a wrong offset!");
...
static_assert(alignof(DelMarEnvironmentEffectsVolume_OnBeginOverlap) == 0x000008, "Wrong alignment on DelMarEnvironmentEffectsVolume_OnBeginOverlap");
static_assert(sizeof(DelMarEnvironmentEffectsVolume_OnBeginOverlap) == 0x000118, "Wrong size on DelMarEnvironmentEffectsVolume_OnBeginOverlap");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, OverlappedComp) == 0x000000, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::OverlappedComp' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, Other) == 0x000008, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::Other' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, OtherComp) == 0x000010, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::OtherComp' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, OtherBodyIndex) == 0x000018, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::OtherBodyIndex' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, bFromSweep) == 0x00001C, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::bFromSweep' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnBeginOverlap, SweepResult) == 0x000020, "Member 'DelMarEnvironmentEffectsVolume_OnBeginOverlap::SweepResult' has a wrong offset!");
...
static_assert(alignof(DelMarEnvironmentEffectsVolume_OnEndOverlap) == 0x000008, "Wrong alignment on DelMarEnvironmentEffectsVolume_OnEndOverlap");
static_assert(sizeof(DelMarEnvironmentEffectsVolume_OnEndOverlap) == 0x000020, "Wrong size on DelMarEnvironmentEffectsVolume_OnEndOverlap");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnEndOverlap, OverlappedComponent) == 0x000000, "Member 'DelMarEnvironmentEffectsVolume_OnEndOverlap::OverlappedComponent' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnEndOverlap, OtherActor) == 0x000008, "Member 'DelMarEnvironmentEffectsVolume_OnEndOverlap::OtherActor' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnEndOverlap, OtherComp) == 0x000010, "Member 'DelMarEnvironmentEffectsVolume_OnEndOverlap::OtherComp' has a wrong offset!");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_OnEndOverlap, OtherBodyIndex) == 0x000018, "Member 'DelMarEnvironmentEffectsVolume_OnEndOverlap::OtherBodyIndex' has a wrong offset!");
...
static_assert(alignof(DelMarEnvironmentEffectsVolume_RemoveGameplayEffect) == 0x000008, "Wrong alignment on DelMarEnvironmentEffectsVolume_RemoveGameplayEffect");
static_assert(sizeof(DelMarEnvironmentEffectsVolume_RemoveGameplayEffect) == 0x000008, "Wrong size on DelMarEnvironmentEffectsVolume_RemoveGameplayEffect");
static_assert(offsetof(DelMarEnvironmentEffectsVolume_RemoveGameplayEffect, Actor) == 0x000000, "Member 'DelMarEnvironmentEffectsVolume_RemoveGameplayEffect::Actor' has a wrong offset!");
...
static_assert(sizeof(DelMarGhostPlaybackTrigger_OnBeginOverlap) == 0x000118, "Wrong size on DelMarGhostPlaybackTrigger_OnBeginOverlap");
...
static_assert(offsetof(DelMarRequestComponent_HandleLoadoutsChangedOnServer, CosmeticLoadout) == 0x000000, "Member 'DelMarRequestComponent_HandleLoadoutsChangedOnServer::CosmeticLoadout' has a wrong offset!");

// Function DelMarCore.DelMarRequestComponent.ServerOnQuestScreenClosed
// 0x0008 (0x0008 - 0x0000)
struct DelMarRequestComponent_ServerOnQuestScreenClosed final
{
public:
	float                                         OpenedDuration;                                    // 0x0000(0x0004)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FGameplayTag                           RaceState;                                         // 0x0004(0x0004)(ConstParm, Parm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarRequestComponent_ServerOnQuestScreenClosed) == 0x000004, "Wrong alignment on DelMarRequestComponent_ServerOnQuestScreenClosed");
static_assert(sizeof(DelMarRequestComponent_ServerOnQuestScreenClosed) == 0x000008, "Wrong size on DelMarRequestComponent_ServerOnQuestScreenClosed");
static_assert(offsetof(DelMarRequestComponent_ServerOnQuestScreenClosed, OpenedDuration) == 0x000000, "Member 'DelMarRequestComponent_ServerOnQuestScreenClosed::OpenedDuration' has a wrong offset!");
static_assert(offsetof(DelMarRequestComponent_ServerOnQuestScreenClosed, RaceState) == 0x000004, "Member 'DelMarRequestComponent_ServerOnQuestScreenClosed::RaceState' has a wrong offset!");

// Function DelMarCore.DelMarRequestComponent.ServerOnQuestScreenOpened
// 0x0004 (0x0004 - 0x0000)
struct DelMarRequestComponent_ServerOnQuestScreenOpened final
{
public:
	struct FGameplayTag                           RaceState;                                         // 0x0000(0x0004)(ConstParm, Parm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarRequestComponent_ServerOnQuestScreenOpened) == 0x000004, "Wrong alignment on DelMarRequestComponent_ServerOnQuestScreenOpened");
static_assert(sizeof(DelMarRequestComponent_ServerOnQuestScreenOpened) == 0x000004, "Wrong size on DelMarRequestComponent_ServerOnQuestScreenOpened");
static_assert(offsetof(DelMarRequestComponent_ServerOnQuestScreenOpened, RaceState) == 0x000000, "Member 'DelMarRequestComponent_ServerOnQuestScreenOpened::RaceState' has a wrong offset!");
...
static_assert(alignof(DelMarRequestComponent_ServerSetLoadingScreenActive) == 0x000001, "Wrong alignment on DelMarRequestComponent_ServerSetLoadingScreenActive");
static_assert(sizeof(DelMarRequestComponent_ServerSetLoadingScreenActive) == 0x000001, "Wrong size on DelMarRequestComponent_ServerSetLoadingScreenActive");
static_assert(offsetof(DelMarRequestComponent_ServerSetLoadingScreenActive, bInLoadingScreenActive) == 0x000000, "Member 'DelMarRequestComponent_ServerSetLoadingScreenActive::bInLoadingScreenActive' has a wrong offset!");
...
static_assert(sizeof(DelMarLocalCheckpointVisibilityControllerComponent_HandleCheckpointPassed) == 0x000018, "Wrong size on DelMarLocalCheckpointVisibilityControllerComponent_HandleCheckpointPassed");
...
static_assert(alignof(DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds) == 0x000004, "Wrong alignment on DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds");
static_assert(sizeof(DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds) == 0x000004, "Wrong size on DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds");
static_assert(offsetof(DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds, InAdditionalRechargeRateSeconds) == 0x000000, "Member 'DelMarPlayerTurboManagerComponent_SetAdditiveRechargeRateModifierSeconds::InAdditionalRechargeRateSeconds' has a wrong offset!");
...
static_assert(sizeof(DelMarGuidedTutorialZoneActor_OnBeginOverlap) == 0x000118, "Wrong size on DelMarGuidedTutorialZoneActor_OnBeginOverlap");
...
static_assert(alignof(DelMarVehicleInterface_GetCurrentFastestSpeed) == 0x000004, "Wrong alignment on DelMarVehicleInterface_GetCurrentFastestSpeed");
static_assert(sizeof(DelMarVehicleInterface_GetCurrentFastestSpeed) == 0x000004, "Wrong size on DelMarVehicleInterface_GetCurrentFastestSpeed");
static_assert(offsetof(DelMarVehicleInterface_GetCurrentFastestSpeed, ReturnValue) == 0x000000, "Member 'DelMarVehicleInterface_GetCurrentFastestSpeed::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DelMarVehicleInterface_GetDraftingCurrentBonusSpeedPercentage, ReturnValue) == 0x000000, "Member 'DelMarVehicleInterface_GetDraftingCurrentBonusSpeedPercentage::ReturnValue' has a wrong offset!");
...
static_assert(offsetof(DelMarVehicleInterface_GetDraftingTargetDegrees, ReturnValue) == 0x000000, "Member 'DelMarVehicleInterface_GetDraftingTargetDegrees::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(DelMarInputModifierHazard_OnBeginOverlap) == 0x000118, "Wrong size on DelMarInputModifierHazard_OnBeginOverlap");
...
// 0x0001 (0x0001 - 0x0000)
struct DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent final
{
public:
	struct FVehicleCosmeticsFinishedPayload       Payload;                                           // 0x0000(0x0001)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong alignment on DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent");
static_assert(sizeof(DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent) == 0x000001, "Wrong size on DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent");
static_assert(offsetof(DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent, Payload) == 0x000000, "Member 'DelMarProxyGhostVisualComponent_HandleFinishVehicleCosmeticsEvent::Payload' has a wrong offset!");
...
static_assert(alignof(DelMarRaceManagerVerbComponent_HandlePlayerLapStarted) == 0x000008, "Wrong alignment on DelMarRaceManagerVerbComponent_HandlePlayerLapStarted");
static_assert(sizeof(DelMarRaceManagerVerbComponent_HandlePlayerLapStarted) == 0x000008, "Wrong size on DelMarRaceManagerVerbComponent_HandlePlayerLapStarted");
static_assert(offsetof(DelMarRaceManagerVerbComponent_HandlePlayerLapStarted, LapStartedEvent) == 0x000000, "Member 'DelMarRaceManagerVerbComponent_HandlePlayerLapStarted::LapStartedEvent' has a wrong offset!");
...
static_assert(sizeof(DelMarSpeedUpDevice_OnBeginOverlap) == 0x000118, "Wrong size on DelMarSpeedUpDevice_OnBeginOverlap");
...
static_assert(alignof(DelMarVehicleVerbComponent_HandleVehicleDemolished) == 0x000004, "Wrong alignment on DelMarVehicleVerbComponent_HandleVehicleDemolished");
static_assert(sizeof(DelMarVehicleVerbComponent_HandleVehicleDemolished) == 0x000004, "Wrong size on DelMarVehicleVerbComponent_HandleVehicleDemolished");
static_assert(offsetof(DelMarVehicleVerbComponent_HandleVehicleDemolished, CausedByTag) == 0x000000, "Member 'DelMarVehicleVerbComponent_HandleVehicleDemolished::CausedByTag' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarAttachPlayerToPlayer) == 0x000008, "Wrong alignment on DelMarCheatManager_DelMarAttachPlayerToPlayer");
static_assert(sizeof(DelMarCheatManager_DelMarAttachPlayerToPlayer) == 0x000020, "Wrong size on DelMarCheatManager_DelMarAttachPlayerToPlayer");
static_assert(offsetof(DelMarCheatManager_DelMarAttachPlayerToPlayer, PlayerName) == 0x000000, "Member 'DelMarCheatManager_DelMarAttachPlayerToPlayer::PlayerName' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarAttachPlayerToPlayer, OtherPlayerName) == 0x000010, "Member 'DelMarCheatManager_DelMarAttachPlayerToPlayer::OtherPlayerName' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarAttachToPlayer) == 0x000008, "Wrong alignment on DelMarCheatManager_DelMarAttachToPlayer");
static_assert(sizeof(DelMarCheatManager_DelMarAttachToPlayer) == 0x000010, "Wrong size on DelMarCheatManager_DelMarAttachToPlayer");
static_assert(offsetof(DelMarCheatManager_DelMarAttachToPlayer, PlayerName) == 0x000000, "Member 'DelMarCheatManager_DelMarAttachToPlayer::PlayerName' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_DelMarRespawnPointLocked, bLocked) == 0x000000, "Member 'DelMarCheatManager_DelMarRespawnPointLocked::bLocked' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds) == 0x000004, "Wrong alignment on DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds");
static_assert(sizeof(DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds) == 0x000008, "Wrong size on DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds");
static_assert(offsetof(DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds, Amount) == 0x000000, "Member 'DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds::Amount' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds, bGrantToEveryone) == 0x000004, "Member 'DelMarCheatManager_DelMarSetAdditiveRechargeRateModifierSeconds::bGrantToEveryone' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarSetGameplayModifiersEnabled) == 0x000001, "Wrong alignment on DelMarCheatManager_DelMarSetGameplayModifiersEnabled");
static_assert(sizeof(DelMarCheatManager_DelMarSetGameplayModifiersEnabled) == 0x000001, "Wrong size on DelMarCheatManager_DelMarSetGameplayModifiersEnabled");
static_assert(offsetof(DelMarCheatManager_DelMarSetGameplayModifiersEnabled, bEnabled) == 0x000000, "Member 'DelMarCheatManager_DelMarSetGameplayModifiersEnabled::bEnabled' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarSetGameplayModifiersMode) == 0x000008, "Wrong alignment on DelMarCheatManager_DelMarSetGameplayModifiersMode");
static_assert(sizeof(DelMarCheatManager_DelMarSetGameplayModifiersMode) == 0x000010, "Wrong size on DelMarCheatManager_DelMarSetGameplayModifiersMode");
static_assert(offsetof(DelMarCheatManager_DelMarSetGameplayModifiersMode, ModeName) == 0x000000, "Member 'DelMarCheatManager_DelMarSetGameplayModifiersMode::ModeName' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_DelMarSetStartlineBoostPotentialOverride, PotentialOverride) == 0x000000, "Member 'DelMarCheatManager_DelMarSetStartlineBoostPotentialOverride::PotentialOverride' has a wrong offset!");
...
static_assert(alignof(DelMarCheatManager_DelMarSetupMode) == 0x000008, "Wrong alignment on DelMarCheatManager_DelMarSetupMode");
static_assert(sizeof(DelMarCheatManager_DelMarSetupMode) == 0x000010, "Wrong size on DelMarCheatManager_DelMarSetupMode");
static_assert(offsetof(DelMarCheatManager_DelMarSetupMode, ModeName) == 0x000000, "Member 'DelMarCheatManager_DelMarSetupMode::ModeName' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_DelMarTeleportToNextCheckpoint_ParallelPath, ParallelPathIndex) == 0x000000, "Member 'DelMarCheatManager_DelMarTeleportToNextCheckpoint_ParallelPath::ParallelPathIndex' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_DelMarTeleportToPreviousCheckpoint_ParallelPath, ParallelPathIndex) == 0x000000, "Member 'DelMarCheatManager_DelMarTeleportToPreviousCheckpoint_ParallelPath::ParallelPathIndex' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_BugIt, BugName) == 0x000000, "Member 'DelMarCheatManager_BugIt::BugName' has a wrong offset!");
...
static_assert(offsetof(DelMarCheatManager_BugItGo, X) == 0x000000, "Member 'DelMarCheatManager_BugItGo::X' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_BugItGo, Y) == 0x000004, "Member 'DelMarCheatManager_BugItGo::Y' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_BugItGo, Z) == 0x000008, "Member 'DelMarCheatManager_BugItGo::Z' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_BugItGo, pitch) == 0x00000C, "Member 'DelMarCheatManager_BugItGo::pitch' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_BugItGo, Yaw) == 0x000010, "Member 'DelMarCheatManager_BugItGo::Yaw' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_BugItGo, Roll) == 0x000014, "Member 'DelMarCheatManager_BugItGo::Roll' has a wrong offset!");

// Function DelMarCore.DelMarCheatManager.DelMarBugIt
// 0x0010 (0x0010 - 0x0000)
struct DelMarCheatManager_DelMarBugIt final
{
public:
	class FString                                 BugName;                                           // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarCheatManager_DelMarBugIt) == 0x000008, "Wrong alignment on DelMarCheatManager_DelMarBugIt");
static_assert(sizeof(DelMarCheatManager_DelMarBugIt) == 0x000010, "Wrong size on DelMarCheatManager_DelMarBugIt");
static_assert(offsetof(DelMarCheatManager_DelMarBugIt, BugName) == 0x000000, "Member 'DelMarCheatManager_DelMarBugIt::BugName' has a wrong offset!");

// Function DelMarCore.DelMarCheatManager.DelMarBugItGo
// 0x0018 (0x0018 - 0x0000)
struct DelMarCheatManager_DelMarBugItGo final
{
public:
	float                                         X;                                                 // 0x0000(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Y;                                                 // 0x0004(0x0004)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(DelMarCheatManager_DelMarBugItGo) == 0x000004, "Wrong alignment on DelMarCheatManager_DelMarBugItGo");
static_assert(sizeof(DelMarCheatManager_DelMarBugItGo) == 0x000018, "Wrong size on DelMarCheatManager_DelMarBugItGo");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, X) == 0x000000, "Member 'DelMarCheatManager_DelMarBugItGo::X' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, Y) == 0x000004, "Member 'DelMarCheatManager_DelMarBugItGo::Y' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, Z) == 0x000008, "Member 'DelMarCheatManager_DelMarBugItGo::Z' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, pitch) == 0x00000C, "Member 'DelMarCheatManager_DelMarBugItGo::pitch' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, Yaw) == 0x000010, "Member 'DelMarCheatManager_DelMarBugItGo::Yaw' has a wrong offset!");
static_assert(offsetof(DelMarCheatManager_DelMarBugItGo, Roll) == 0x000014, "Member 'DelMarCheatManager_DelMarBugItGo::Roll' has a wrong offset!");
...
static_assert(alignof(DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer) == 0x000004, "Wrong alignment on DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer");
static_assert(sizeof(DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer) == 0x000008, "Wrong size on DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer");
static_assert(offsetof(DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer, PrevPlayer) == 0x000000, "Member 'DelMarPlayerAttachmentComponent_OnRep_AttachedPlayer::PrevPlayer' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled) == 0x000001, "Wrong alignment on DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled");
static_assert(sizeof(DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled) == 0x000001, "Wrong size on DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled");
static_assert(offsetof(DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled, ReturnValue) == 0x000000, "Member 'DelMarState_Gameplay_Postrace_IsNextRaceActionDisabled::ReturnValue' has a wrong offset!");
