...
static_assert(sizeof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText) == 0x000068, "Wrong size on WBP_RebootRallyPopupModal_QRCode_C_UpdateText");
...
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, Temp_text_Variable_1) == 0x000018, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::Temp_text_Variable_1' has a wrong offset!");
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, Temp_text_Variable_2) == 0x000028, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::Temp_text_Variable_2' has a wrong offset!");
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, Temp_text_Variable_3) == 0x000038, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::Temp_text_Variable_3' has a wrong offset!");
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, Temp_byte_Variable_5) == 0x000048, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::Temp_byte_Variable_5' has a wrong offset!");
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, K2Node_Select_Default) == 0x000050, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(WBP_RebootRallyPopupModal_QRCode_C_UpdateText, K2Node_Select_Default_1) == 0x000060, "Member 'WBP_RebootRallyPopupModal_QRCode_C_UpdateText::K2Node_Select_Default_1' has a wrong offset!");
