...
{
public:
	class UStaticMesh*                            StaticMesh;                                        // 0x02A8(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMaterial*                              Material;                                          // 0x02B0(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	ESplineMeshAxis                               ForwardAxis;                                       // 0x02B8(0x0001)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2B9[0x7];                                      // 0x02B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FVector_NetQuantize>            SplinePoints;                                      // 0x02C0(0x0010)(Net, ZeroConstructor, Transient, RepNotify, NativeAccessSpecifierPrivate)
	struct FVector                                SplineOffset;                                      // 0x02D0(0x0018)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         SplineColliderExtentWidth;                         // 0x02E8(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         SplineColliderExtentHeight;                        // 0x02EC(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                         LandscapeTraceBuffer;                              // 0x02F0(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2F4[0x4];                                      // 0x02F4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBoxComponent*>                  BoxColliderArray;                                  // 0x02F8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(AIceGroundPath) == 0x000308, "Wrong size on AIceGroundPath");
static_assert(offsetof(AIceGroundPath, StaticMesh) == 0x0002A8, "Member 'AIceGroundPath::StaticMesh' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, Material) == 0x0002B0, "Member 'AIceGroundPath::Material' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, ForwardAxis) == 0x0002B8, "Member 'AIceGroundPath::ForwardAxis' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, SplinePoints) == 0x0002C0, "Member 'AIceGroundPath::SplinePoints' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, SplineOffset) == 0x0002D0, "Member 'AIceGroundPath::SplineOffset' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, SplineColliderExtentWidth) == 0x0002E8, "Member 'AIceGroundPath::SplineColliderExtentWidth' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, SplineColliderExtentHeight) == 0x0002EC, "Member 'AIceGroundPath::SplineColliderExtentHeight' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, LandscapeTraceBuffer) == 0x0002F0, "Member 'AIceGroundPath::LandscapeTraceBuffer' has a wrong offset!");
static_assert(offsetof(AIceGroundPath, BoxColliderArray) == 0x0002F8, "Member 'AIceGroundPath::BoxColliderArray' has a wrong offset!");
