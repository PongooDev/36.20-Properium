...
// Function GiftingUI.AthenaGiftingScreen.HandleGrantedItemsLoaded
// 0x0010 (0x0010 - 0x0000)
struct AthenaGiftingScreen_HandleGrantedItemsLoaded final
{
public:
	TArray<class UFortItemVM*>                    GrantedItems;                                      // 0x0000(0x0010)(Parm, ZeroConstructor, NativeAccessSpecifierPublic)
};
static_assert(alignof(AthenaGiftingScreen_HandleGrantedItemsLoaded) == 0x000008, "Wrong alignment on AthenaGiftingScreen_HandleGrantedItemsLoaded");
static_assert(sizeof(AthenaGiftingScreen_HandleGrantedItemsLoaded) == 0x000010, "Wrong size on AthenaGiftingScreen_HandleGrantedItemsLoaded");
static_assert(offsetof(AthenaGiftingScreen_HandleGrantedItemsLoaded, GrantedItems) == 0x000000, "Member 'AthenaGiftingScreen_HandleGrantedItemsLoaded::GrantedItems' has a wrong offset!");
...
static_assert(offsetof(FortGiftingUserSearchWidget_HandleSearchFriendsTextEntered, CommitMethod) == 0x000010, "Member 'FortGiftingUserSearchWidget_HandleSearchFriendsTextEntered::CommitMethod' has a wrong offset!");
