...
float UMovieSceneFadeTrackTestLibrary::GetManualFadeAmount(class APlayerCameraManager* PlayerCameraManager)
{
	...
	if (Func == nullptr)
		Func = StaticClss->FindFunction("GetManualFadeAmount");
...
void UMovieSceneReplaceableActorBinding_BPBase::BP_InitReplaceableBinding(class UObject* SourceObject, class UMovieScene* OwnerMovieScene)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_InitReplaceableBinding");
...
struct FMovieSceneBindingResolveResult UMovieSceneReplaceableActorBinding_BPBase::BP_ResolveRuntimeBinding(const struct FMovieSceneBindingResolveContext& ResolveContext) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_ResolveRuntimeBinding");
...
bool UMovieSceneReplaceableActorBinding_BPBase::BP_SupportsBindingCreationFromObject(const class UObject* SourceObject) const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("BP_SupportsBindingCreationFromObject");
...
class USoundBase* UMovieSceneAudioSection::GetPlaybackSound() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetPlaybackSound");
...
void UMovieSceneDataLayerSection::SetFlushOnActivated(bool bFlushOnActivated_0)
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("SetFlushOnActivated");
...
bool UMovieSceneDataLayerSection::GetFlushOnActivated() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("GetFlushOnActivated");
...
bool UMovieSceneDataLayerSection::HasPreRoll() const
{
	...
	if (Func == nullptr)
		Func = Class->FindFunction("HasPreRoll");
