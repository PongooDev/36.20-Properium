...
enum class EFabricInteractionToolStates : uint8
{
	...
	HoveredControl                           = 1,
	HoveredDisabled                          = 2,
	HoveredValidCablePort                    = 3,
	HoveredInvalid                           = 4,
	ContinuousSelected                       = 5,
	MomentarySelected                        = 6,
	CableSelected                            = 7,
	None                                     = 8,
};
...
// Enum FabricRuntime.EFabricMetaSoundMaxAttenuation
// NumValues: 0x0005
enum class EFabricMetaSoundMaxAttenuation : uint8
{
	FullIsland                               = 0,
	ExtraLarge                               = 1,
	Large                                    = 2,
...
// Enum FabricRuntime.EFabricAnalyticsSongEndReason
// NumValues: 0x0006
enum class EFabricAnalyticsSongEndReason : uint8
{
	SongFinished                             = 0,
	SongRestarted                            = 1,
	SongStopped                              = 2,
	PlayerLeft                               = 3,
	ListeningModeParameterChanged            = 4,
	AudibleParameterChanged                  = 5,
};

// Enum FabricRuntime.EFabricAnalyticsSongAccessScope
// NumValues: 0x0004
enum class EFabricAnalyticsSongAccessScope : uint8
{
	None                                     = 0,
	Player                                   = 1,
	Party                                    = 2,
...
// Enum FabricRuntime.EFabricAnalyticsUEFNMode
// NumValues: 0x0003
enum class EFabricAnalyticsUEFNMode : uint8
{
	Play                                     = 0,
	Create                                   = 1,
	Invalid                                  = 2,
...
// Enum FabricRuntime.EFabricAnalyticsListeningMode
// NumValues: 0x0003
enum class EFabricAnalyticsListeningMode : uint8
{
	Unknown                                  = 0,
	MusicalGameplay                          = 1,
	PassiveListening                         = 2,
...
static_assert(sizeof(FFabricMetaSoundPatchWrapperBinding) == 0x000050, "Wrong size on FFabricMetaSoundPatchWrapperBinding");
...
static_assert(sizeof(FFabricMetaSoundPatchWrapperWetDryOutputBinding) == 0x0000A0, "Wrong size on FFabricMetaSoundPatchWrapperWetDryOutputBinding");
...
static_assert(offsetof(FFabricMetaSoundPatchWrapperWetDryOutputBinding, DryOutputSignalBinding) == 0x000050, "Member 'FFabricMetaSoundPatchWrapperWetDryOutputBinding::DryOutputSignalBinding' has a wrong offset!");
...
static_assert(alignof(FMusicalPosition) == 0x000004, "Wrong alignment on FMusicalPosition");
static_assert(sizeof(FMusicalPosition) == 0x000008, "Wrong size on FMusicalPosition");
...
static_assert(alignof(FFabricVFXTopperDataEntry) == 0x000008, "Wrong alignment on FFabricVFXTopperDataEntry");
static_assert(sizeof(FFabricVFXTopperDataEntry) == 0x000020, "Wrong size on FFabricVFXTopperDataEntry");
static_assert(offsetof(FFabricVFXTopperDataEntry, StaticMesh) == 0x000000, "Member 'FFabricVFXTopperDataEntry::StaticMesh' has a wrong offset!");
static_assert(offsetof(FFabricVFXTopperDataEntry, MaterialInstance) == 0x000008, "Member 'FFabricVFXTopperDataEntry::MaterialInstance' has a wrong offset!");
static_assert(offsetof(FFabricVFXTopperDataEntry, NiagaraSystem) == 0x000018, "Member 'FFabricVFXTopperDataEntry::NiagaraSystem' has a wrong offset!");
...
static_assert(sizeof(FFabricMetaSoundSpeakerPatchWrapperEqBandsBinding) == 0x000058, "Wrong size on FFabricMetaSoundSpeakerPatchWrapperEqBandsBinding");
static_assert(offsetof(FFabricMetaSoundSpeakerPatchWrapperEqBandsBinding, PrimitiveDataIndex) == 0x000050, "Member 'FFabricMetaSoundSpeakerPatchWrapperEqBandsBinding::PrimitiveDataIndex' has a wrong offset!");
...
static_assert(sizeof(FFabricProgressionPreset) == 0x000020, "Wrong size on FFabricProgressionPreset");
...
static_assert(offsetof(FFabricProgressionPreset, Interval0) == 0x000018, "Member 'FFabricProgressionPreset::Interval0' has a wrong offset!");
static_assert(offsetof(FFabricProgressionPreset, Interval1) == 0x000019, "Member 'FFabricProgressionPreset::Interval1' has a wrong offset!");
static_assert(offsetof(FFabricProgressionPreset, Interval2) == 0x00001A, "Member 'FFabricProgressionPreset::Interval2' has a wrong offset!");
static_assert(offsetof(FFabricProgressionPreset, Interval3) == 0x00001B, "Member 'FFabricProgressionPreset::Interval3' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_14[0x6C];                                      // 0x0014(0x006C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FFabricLFOGenerator) == 0x000008, "Wrong alignment on FFabricLFOGenerator");
static_assert(sizeof(FFabricLFOGenerator) == 0x000080, "Wrong size on FFabricLFOGenerator");
...
public:
	...
	float                                         Blend;                                             // 0x0018(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1C[0x4];                                       // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(offsetof(FFabricStepGenerator, Blend) == 0x000018, "Member 'FFabricStepGenerator::Blend' has a wrong offset!");
...
public:
	...
	int32                                         PhraseLengthInBars;                                // 0x000C(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(FFabricValueSetterGenerator) == 0x000068, "Wrong size on FFabricValueSetterGenerator");
static_assert(offsetof(FFabricValueSetterGenerator, PhraseLengthInBars) == 0x00000C, "Member 'FFabricValueSetterGenerator::PhraseLengthInBars' has a wrong offset!");
...
static_assert(alignof(FFabricMetaSoundMergeNode) == 0x000008, "Wrong alignment on FFabricMetaSoundMergeNode");
static_assert(sizeof(FFabricMetaSoundMergeNode) == 0x000158, "Wrong size on FFabricMetaSoundMergeNode");
static_assert(offsetof(FFabricMetaSoundMergeNode, CombinerNode) == 0x000000, "Member 'FFabricMetaSoundMergeNode::CombinerNode' has a wrong offset!");
...
static_assert(alignof(FFabricMetaSoundConnectionBuilder) == 0x000008, "Wrong alignment on FFabricMetaSoundConnectionBuilder");
static_assert(sizeof(FFabricMetaSoundConnectionBuilder) == 0x0000C0, "Wrong size on FFabricMetaSoundConnectionBuilder");
static_assert(offsetof(FFabricMetaSoundConnectionBuilder, MergeList) == 0x0000B0, "Member 'FFabricMetaSoundConnectionBuilder::MergeList' has a wrong offset!");
...
{
public:
	EFabricMetasoundPlayStrategy                  PlayStrategy;                                      // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EFabricMetasoundPlayPriority                  PlayPriority;                                      // 0x0001(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2[0x2];                                        // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   LockingAuthorityName;                              // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FFabricTransportRequestConfig) == 0x000004, "Wrong alignment on FFabricTransportRequestConfig");
static_assert(sizeof(FFabricTransportRequestConfig) == 0x000008, "Wrong size on FFabricTransportRequestConfig");
static_assert(offsetof(FFabricTransportRequestConfig, PlayStrategy) == 0x000000, "Member 'FFabricTransportRequestConfig::PlayStrategy' has a wrong offset!");
static_assert(offsetof(FFabricTransportRequestConfig, PlayPriority) == 0x000001, "Member 'FFabricTransportRequestConfig::PlayPriority' has a wrong offset!");
static_assert(offsetof(FFabricTransportRequestConfig, LockingAuthorityName) == 0x000004, "Member 'FFabricTransportRequestConfig::LockingAuthorityName' has a wrong offset!");
...
static_assert(sizeof(FFabricMetaSoundRuntimeInputInfo) == 0x000240, "Wrong size on FFabricMetaSoundRuntimeInputInfo");
...
static_assert(offsetof(FFabricMetaSoundRuntimeInputInfo, MetaSoundUserOption) == 0x000080, "Member 'FFabricMetaSoundRuntimeInputInfo::MetaSoundUserOption' has a wrong offset!");
static_assert(offsetof(FFabricMetaSoundRuntimeInputInfo, UserOptionConverterNode) == 0x000090, "Member 'FFabricMetaSoundRuntimeInputInfo::UserOptionConverterNode' has a wrong offset!");
static_assert(offsetof(FFabricMetaSoundRuntimeInputInfo, InputBuilder) == 0x000180, "Member 'FFabricMetaSoundRuntimeInputInfo::InputBuilder' has a wrong offset!");
...
{
public:
	float                                         BeatOffset;                                        // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         MSOffset;                                          // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FMidiFollowData) == 0x000004, "Wrong alignment on FMidiFollowData");
static_assert(sizeof(FMidiFollowData) == 0x000008, "Wrong size on FMidiFollowData");
static_assert(offsetof(FMidiFollowData, BeatOffset) == 0x000000, "Member 'FMidiFollowData::BeatOffset' has a wrong offset!");
static_assert(offsetof(FMidiFollowData, MSOffset) == 0x000004, "Member 'FMidiFollowData::MSOffset' has a wrong offset!");
...
static_assert(offsetof(FFabricStepTablePacked, bHasRepDelayApplied) == 0x000024, "Member 'FFabricStepTablePacked::bHasRepDelayApplied' has a wrong offset!");
