...
static_assert(offsetof(FCreativeLowMemoryFallbackUserFacingText, WarningToastTitle) == 0x000010, "Member 'FCreativeLowMemoryFallbackUserFacingText::WarningToastTitle' has a wrong offset!");
static_assert(offsetof(FCreativeLowMemoryFallbackUserFacingText, WarningToastDescription) == 0x000020, "Member 'FCreativeLowMemoryFallbackUserFacingText::WarningToastDescription' has a wrong offset!");
